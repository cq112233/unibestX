    ...
    companion object {
        ...
        var setup: (__props: GenSrcSubUviewUltraUviewUltra) -> Any? = fun(__props): Any? {
            ...
            fun gen_onScroll_fn(e: UniScrollEvent): Unit {
                ...
                console.log("scroll-view scrollTop:", currentScrollTop, " at src/sub/uview-ultra/uview-ultra.uvue:908")
            ...
            fun gen_closeDropdown_fn(refName: String): Unit {
                val refMap: UTSJSONObject = _uO("__\$originalPosition" to UTSSourceMapPosition("refMap", "src/sub/uview-ultra/uview-ultra.uvue", 965, 9), "uDropdownRef1" to uDropdownRef1.value, "uDropdownRef2" to uDropdownRef2.value, "uDropdownRef3" to uDropdownRef3.value, "uDropdownRefGrid1" to uDropdownRefGrid1.value, "uDropdownRefCard" to uDropdownRefCard.value)
            ...
            fun gen_onLazyLoadError_fn(err: UTSJSONObject): Unit {
                console.log("懒加载图片出错:", err, " at src/sub/uview-ultra/uview-ultra.uvue:1132")
            }
            ...
            fun gen_onMpHtmlLoad_fn(): Unit {
                console.log("mp-html 渲染完成", " at src/sub/uview-ultra/uview-ultra.uvue:1255")
            }
            val onMpHtmlLoad = ::gen_onMpHtmlLoad_fn
            fun gen_onMpHtmlLinktap_fn(e: UTSJSONObject): Unit {
                console.log("链接点击:", e, " at src/sub/uview-ultra/uview-ultra.uvue:1259")
            ...
            fun gen_onMpHtmlImgtap_fn(e: UTSJSONObject): Unit {
                console.log("图片点击:", e, " at src/sub/uview-ultra/uview-ultra.uvue:1268")
            }
            val onMpHtmlImgtap = ::gen_onMpHtmlImgtap_fn
            fun gen_onMpHtmlError_fn(e: UTSJSONObject): Unit {
                console.log("mp-html error:", e, " at src/sub/uview-ultra/uview-ultra.uvue:1272")
            }
            ...
            fun gen_onTabsClick_fn(e: UTSJSONObject): Unit {
                console.log("tabs click:", e, " at src/sub/uview-ultra/uview-ultra.uvue:1326")
            }
            val onTabsClick = ::gen_onTabsClick_fn
            fun gen_onTabsChange_fn(e: UTSJSONObject): Unit {
                console.log("tabs change:", e, " at src/sub/uview-ultra/uview-ultra.uvue:1330")
            }
            ...
            fun gen_onQrcodeResult_fn(e: String): Unit {
                console.log("qrcode result:", e, " at src/sub/uview-ultra/uview-ultra.uvue:1387")
            }
            ...
            fun gen_onParseImgTap_fn(e: UTSJSONObject): Unit {
                console.log("parse img tap:", e, " at src/sub/uview-ultra/uview-ultra.uvue:1401")
            }
            val onParseImgTap = ::gen_onParseImgTap_fn
            fun gen_onParseLinkTap_fn(e: UTSJSONObject): Unit {
                console.log("parse link tap:", e, " at src/sub/uview-ultra/uview-ultra.uvue:1405")
            }
            ...
            fun gen_onCodeInputChange_fn(e: String): Unit {
                console.log("code-input change:", e, " at src/sub/uview-ultra/uview-ultra.uvue:1461")
            }
                                        ...
                                        _cE("view", _uM("class" to "demo-block"), _uA(
                                            ...
                                            _cE("view", _uM("class" to "demo-row-start"), _uA(
                                                _cE("view", _uM("class" to "lazy-load-item"), _uA(
                                                    _cV(_component_up_lazy_load, _uM("image" to "https://gtd.alicdn.com/sns_logo/i1/TB124_3NXXXXXasXVXXSutbFXXX.jpg_240x240xz.jpg", "loading-img" to "/static/logo.png", "height" to 120, "border-radius" to 8, "index" to "img1", "onClick" to onLazyLoadClick, "onError" to onLazyLoadError))
                                                )),
                                                _cE("view", _uM("class" to "lazy-load-item ml-10px"), _uA(
