            ...
            fun gen_loadMockData_fn(): UTSPromise<Unit> {
                return wrapUTSPromise(suspend {
                        try {
                            ...
                            console.error("loadMockData error:", err, " at src/pages/basic/components/HttpDemoCard.uvue:185")
                        }
                })
            }
            ...
            fun gen_fetchRealApi_fn(): UTSPromise<Unit> {
                return wrapUTSPromise(suspend {
                        ...
                        try {
                            ...
                            console.log(err, "err", " at src/pages/basic/components/HttpDemoCard.uvue:205")
