                    ...
                    return _uA(
                        ...
                        _cE("view", _uM("class" to "flex-row"), _uA(
                            _cE("view", _uM("class" to "flex-1 mr-10px"), _uA(
                                _cE("button", _uM("class" to "bg-__3182ce_ text-white rounded-8px text-14px h-42px w-full", "onClick" to loadMockData), " 加载 Mock 数据 ")
                            )),
                            _cE("view", _uM("class" to "flex-1"), _uA(
                                _cE("button", _uM("disabled" to loading.value, "class" to "bg-__10b981_ text-white rounded-8px text-14px h-42px w-full", "onClick" to fetchRealApi), _tD(if (loading.value) {
                                    "请求中..."
                                } else {
                                    "真实 API 请求"
                                }
