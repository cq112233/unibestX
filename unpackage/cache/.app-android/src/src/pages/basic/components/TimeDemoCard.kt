                    ...
                    return _uA(
                        ...
                        _cE("view", _uM("class" to "bg-__f8fafc_ rounded-12px p-16px mb-16px border-width-1px border-style-solid border-color-__e2e8f0_"), _uA(
                            ...
                            _cE("view", _uM("class" to "flex-row justify-between mb-12px"), _uA(
                                _cV(_component_up_button, _uM("size" to "small", "type" to "primary", "plain" to true, "class" to "flex-1 mr-8px", "onClick" to fun(){
                                    adjustOffset(-7)
                                }
                                ...
                                _cV(_component_up_button, _uM("size" to "small", "type" to "primary", "plain" to true, "class" to "flex-1", "onClick" to fun(){
                                    adjustOffset(7)
                                }
                                ), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                                    return _uA(
