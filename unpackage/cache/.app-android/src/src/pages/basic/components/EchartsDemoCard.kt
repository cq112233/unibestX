...
open class GenSrcPagesBasicComponentsEchartsDemoCard : VueComponent {
    ...
    companion object {
        ...
        var setup: (__props: GenSrcPagesBasicComponentsEchartsDemoCard) -> Any? = fun(__props): Any? {
            ...
            val gridKey = "grid"
            val lineOption: UTSJSONObject = _uO("__\$originalPosition" to UTSSourceMapPosition("lineOption", "src/pages/basic/components/EchartsDemoCard.uvue", 84, 7), "title" to _uO("text" to "访问趋势 (折线图)", "textStyle" to _uO("fontSize" to 12, "color" to "#64748b")), "xAxis" to _uO("type" to "category", "data" to _uA(
                "周一",
                "周二",
                "周三",
                "周四",
            ...
            val barOption: UTSJSONObject = _uO("__\$originalPosition" to UTSSourceMapPosition("barOption", "src/pages/basic/components/EchartsDemoCard.uvue", 145, 7), "title" to _uO("text" to "访问分布 (柱状图)", "textStyle" to _uO("fontSize" to 12, "color" to "#64748b")), "xAxis" to _uO("type" to "category", "data" to _uA(
                "周一",
                "周二",
                "周三",
                "周四",
            ...
            val pieOption: UTSJSONObject = _uO("__\$originalPosition" to UTSSourceMapPosition("pieOption", "src/pages/basic/components/EchartsDemoCard.uvue", 192, 7), "title" to _uO("text" to "访问来源 (饼图)", "textStyle" to _uO("fontSize" to 12, "color" to "#64748b")), "series" to _uA(
                _uO("name" to "访问来源", "type" to "pie", "radius" to "65%", "center" to _uA(
                    "50%",
                    "50%"
                ), "data" to _uA(
                    _uO("value" to 1048, "name" to "搜索引擎", "itemStyle" to _uO("color" to "#3b82f6")),
                    _uO("value" to 735, "name" to "直接访问", "itemStyle" to _uO("color" to "#10b981")),
                    _uO("value" to 580, "name" to "邮件营销", "itemStyle" to _uO("color" to "#f59e0b")),
                    _uO("value" to 484, "name" to "联盟广告", "itemStyle" to _uO("color" to "#8b5cf6"))
                ))
            ))
