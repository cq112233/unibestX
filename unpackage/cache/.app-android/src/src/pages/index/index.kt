                            ...
                            return _uA(
                                _cE("view", null, _uA(
                                    ...
                                    _cE("view", _uM("class" to "content-container"), _uA(
                                        _cE("image", _uM("class" to "w-100px h-100px mx-auto mt-40px rounded-20px", "src" to "/static/logo.png")),
