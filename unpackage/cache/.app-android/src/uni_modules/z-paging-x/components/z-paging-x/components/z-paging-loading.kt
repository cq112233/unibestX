...
open class GenUniModulesZPagingXComponentsZPagingXComponentsZPagingLoading : VueComponent {
    ...
    override fun data(): Map<String, Any?> {
        return _uM("parent" to null as ComponentPublicInstance?, "parentData" to _uO(), "children" to _uA<ComponentPublicInstance>(), "childrenRefs" to _uA<String>(), "times" to 0, "element" to null as UniElement?, "base64FlowerImg" to base64Flower)
    }
