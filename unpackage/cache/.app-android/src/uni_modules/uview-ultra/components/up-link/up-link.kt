...
open class GenUniModulesUviewUltraComponentsUpLinkUpLink : VueComponent {
    ...
    companion object {
        ...
        var props = _nP(_uM("customStyle" to _uM("type" to _uA(
            "Object",
            "String"
        ), "default" to _uO()), "customClass" to _uM("type" to "String", "default" to ""), "url" to _uM("type" to "String", "default" to ""), "linkType" to _uM("type" to "String", "default" to "navigateTo"), "color" to _uM("type" to "String", "default" to crtProp__6["color"]), "fontSize" to _uM("type" to _uA(
            "String"
        ), "default" to crtProp__6["fontSize"]), "underLine" to _uM("type" to "Boolean", "default" to crtProp__6["underLine"]), "href" to _uM("type" to "String", "default" to crtProp__6["href"]), "mpTips" to _uM("type" to "String", "default" to crtProp__6["mpTips"]), "lineColor" to _uM("type" to "String", "default" to crtProp__6["lineColor"]), "text" to _uM("type" to "String", "default" to crtProp__6["text"])))
