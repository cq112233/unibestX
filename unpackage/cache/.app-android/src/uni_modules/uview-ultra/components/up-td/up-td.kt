        ...
        var setup: (__props: GenUniModulesUviewUltraComponentsUpTdUpTd) -> Any? = fun(__props): Any? {
            ...
            onMounted(fun(){
                ...
                if (parent.value != null) {
                    var style: UTSJSONObject = _uO("__\$originalPosition" to UTSSourceMapPosition("style", "uni_modules/uview-ultra/components/up-td/up-td.uvue", 63, 8))
                    var styleText: UTSJSONObject = _uO("__\$originalPosition" to UTSSourceMapPosition("styleText", "uni_modules/uview-ultra/components/up-td/up-td.uvue", 64, 8))
