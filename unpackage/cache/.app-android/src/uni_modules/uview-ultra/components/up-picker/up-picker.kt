...
open class GenUniModulesUviewUltraComponentsUpPickerUpPicker : VueComponent {
    ...
    companion object {
        ...
        var props = _nP(_uM("customStyle" to _uM("type" to _uA(
            "Object",
            "String"
        ), "default" to _uO()), "customClass" to _uM("type" to "String", "default" to ""), "url" to _uM("type" to "String", "default" to ""), "linkType" to _uM("type" to "String", "default" to "navigateTo"), "modelValue" to _uM("type" to "Array", "default" to _uA<Any>()), "hasInput" to _uM("type" to "Boolean", "default" to false), "placeholder" to _uM("type" to "String", "default" to "请选择"), "show" to _uM("type" to "Boolean", "default" to crtProp__24["show"]), "popupMode" to _uM("type" to "String", "default" to crtProp__24["popupMode"]), "showToolbar" to _uM("type" to "Boolean", "default" to crtProp__24["showToolbar"]), "title" to _uM("type" to "String", "default" to crtProp__24["title"]), "columns" to _uM("type" to "Array", "default" to crtProp__24["columns"]), "loading" to _uM("type" to "Boolean", "default" to crtProp__24["loading"]), "itemHeight" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to crtProp__24["itemHeight"]), "cancelText" to _uM("type" to "String", "default" to crtProp__24["cancelText"]), "confirmText" to _uM("type" to "String", "default" to crtProp__24["confirmText"]), "cancelColor" to _uM("type" to "String", "default" to crtProp__24["cancelColor"]), "confirmColor" to _uM("type" to "String", "default" to crtProp__24["confirmColor"]), "visibleItemCount" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to crtProp__24["visibleItemCount"]), "keyName" to _uM("type" to "String", "default" to crtProp__24["keyName"]), "closeOnClickOverlay" to _uM("type" to "Boolean", "default" to crtProp__24["closeOnClickOverlay"]), "defaultIndex" to _uM("type" to "Array", "default" to crtProp__24["defaultIndex"]), "immediateChange" to _uM("type" to "Boolean", "default" to crtProp__24["immediateChange"]), "toolbarRightSlot" to _uM("type" to "Boolean", "default" to false), "pageInline" to _uM("type" to "Boolean", "default" to crtProp__24["pageInline"])))
