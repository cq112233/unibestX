...
open class GenUniModulesUviewUltraComponentsUpStepsUpSteps : VueComponent {
    ...
    open var parentDataCpu: UTSArray<Any> by `$data`
    @Suppress("USELESS_CAST")
    override fun data(): Map<String, Any?> {
        return _uM("parent" to null as ComponentPublicInstance?, "parentData" to _uO(), "children" to _uA<ComponentPublicInstance>(), "childrenRefs" to _uA<String>(), "parentDataCpu" to computed<UTSArray<Any>>(fun(): UTSArray<Any> {
            return _uA(
                this.current,
                this.direction,
                this.activeColor,
    ...
    open var updateChildData = ::gen_updateChildData_fn
    open fun gen_updateChildData_fn() {
        this.children.map(fun(child: ComponentPublicInstance){
            child.`$callMethod`("updateFromParent")
        }
        )
    }
    open var updateFromChild = ::gen_updateFromChild_fn
    open fun gen_updateFromChild_fn() {
        this.updateChildData()
    }
    companion object {
        var name = "up-steps"
