...
open class GenUniModulesUviewUltraComponentsUpTextareaUpTextarea : VueComponent {
    ...
    override fun `$render`(): Any? {
        ...
        return _cE("view", _uM("class" to _nC(_uA(
            ...
            if (isTrue(_ctx.count)) {
                _cE("text", _uM("key" to 0, "class" to "up-textarea__count", "style" to _nS(_uM("background-color" to if (_ctx.disabled) {
                    "transparent"
                } else {
                    "#fff"
    ...
    override fun data(): Map<String, Any?> {
        return _uM("parent" to null as ComponentPublicInstance?, "parentData" to _uO(), "children" to _uA<ComponentPublicInstance>(), "childrenRefs" to _uA<String>(), "innerValue" to "", "focused" to false, "firstChange" to true, "changeFromInner" to false, "innerFormatter" to defaultFormat as Function<*>, "textareaClass" to computed<String>(fun(): String {
            ...
            val style: UTSJSONObject = _uO("__\$originalPosition" to UTSSourceMapPosition("style", "uni_modules/uview-ultra/components/up-textarea/up-textarea.uvue", 151, 19))
    ...
    companion object {
        ...
        var props = _nP(_uM("customStyle" to _uM("type" to _uA(
            "Object",
            "String"
        ), "default" to _uO()), "customClass" to _uM("type" to "String", "default" to ""), "url" to _uM("type" to "String", "default" to ""), "linkType" to _uM("type" to "String", "default" to "navigateTo"), "modelValue" to _uM("type" to "String", "default" to crtProp__22["value"]), "placeholder" to _uM("type" to _uA(
            "String"
        ), "default" to crtProp__22["placeholder"]), "placeholderClass" to _uM("type" to "String", "default" to crtPropInput["placeholderClass"]), "placeholderStyle" to _uM("type" to _uA(
            "String",
            "Object"
        ), "default" to crtPropInput["placeholderStyle"]), "height" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to crtProp__22["height"]), "confirmType" to _uM("type" to "String", "default" to crtProp__22["confirmType"]), "disabled" to _uM("type" to "Boolean", "default" to crtProp__22["disabled"]), "count" to _uM("type" to "Boolean", "default" to crtProp__22["count"]), "focus" to _uM("type" to "Boolean", "default" to crtProp__22["focus"]), "autoHeight" to _uM("type" to "Boolean", "default" to crtProp__22["autoHeight"]), "fixed" to _uM("type" to "Boolean", "default" to crtProp__22["fixed"]), "cursorSpacing" to _uM("type" to "Number", "default" to crtProp__22["cursorSpacing"]), "cursor" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to crtProp__22["cursor"]), "showConfirmBar" to _uM("type" to "Boolean", "default" to crtProp__22["showConfirmBar"]), "selectionStart" to _uM("type" to "Number", "default" to crtProp__22["selectionStart"]), "selectionEnd" to _uM("type" to "Number", "default" to crtProp__22["selectionEnd"]), "adjustPosition" to _uM("type" to "Boolean", "default" to crtProp__22["adjustPosition"]), "disableDefaultPadding" to _uM("type" to "Boolean", "default" to crtProp__22["disableDefaultPadding"]), "holdKeyboard" to _uM("type" to "Boolean", "default" to crtProp__22["holdKeyboard"]), "maxlength" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to crtProp__22["maxlength"]), "border" to _uM("type" to "String", "default" to crtProp__22["border"]), "formatter" to _uM("type" to _uA(
            "Function"
        ), "default" to crtProp__22["formatter"]), "ignoreCompositionEvent" to _uM("type" to "Boolean", "default" to true)))
