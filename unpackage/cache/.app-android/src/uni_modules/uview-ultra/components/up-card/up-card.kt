...
open class GenUniModulesUviewUltraComponentsUpCardUpCard : VueComponent {
    ...
    companion object {
        ...
        var props = _nP(_uM("customStyle" to _uM("type" to _uA(
            "Object",
            "String"
        ), "default" to _uO()), "customClass" to _uM("type" to "String", "default" to ""), "url" to _uM("type" to "String", "default" to ""), "linkType" to _uM("type" to "String", "default" to "navigateTo"), "full" to _uM("type" to "Boolean", "default" to default__97.getBoolean("card.full")), "title" to _uM("type" to "String", "default" to default__97.getString("card.title")), "titleColor" to _uM("type" to "String", "default" to default__97.getString("card.titleColor")), "titleSize" to _uM("type" to _uA(
            "Number",
            "String"
        ), "default" to default__97.getString("card.titleSize")), "subTitle" to _uM("type" to "String", "default" to default__97.getString("card.subTitle")), "subTitleColor" to _uM("type" to "String", "default" to default__97.getString("card.subTitleColor")), "subTitleSize" to _uM("type" to _uA(
            "Number",
            "String"
        ), "default" to default__97.getBoolean("card.subTitleSize")), "border" to _uM("type" to "Boolean", "default" to default__97.getBoolean("card.border")), "index" to _uM("type" to _uA(
            "Number",
            "String",
            "Object"
        ), "default" to default__97.getString("card.index")), "margin" to _uM("type" to "String", "default" to default__97.getString("card.margin")), "borderRadius" to _uM("type" to _uA(
            "Number",
            "String"
        ), "default" to default__97.getString("card.borderRadius")), "headStyle" to _uM("default" to default__97.getAny("card.headStyle") as UTSJSONObject), "bodyStyle" to _uM("default" to default__97.getAny("card.bodyStyle") as UTSJSONObject), "footStyle" to _uM("default" to default__97.getAny("card.footStyle") as UTSJSONObject), "headBorderBottom" to _uM("type" to "Boolean", "default" to default__97.getBoolean("card.headBorderBottom")), "footBorderTop" to _uM("type" to "Boolean", "default" to default__97.getBoolean("card.footBorderTop")), "thumb" to _uM("type" to "String", "default" to default__97.getString("card.thumb")), "thumbWidth" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to default__97.getString("card.thumbWidth")), "thumbCircle" to _uM("type" to "Boolean", "default" to default__97.getBoolean("card.thumbCircle")), "padding" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to default__97.getString("card.padding")), "paddingHead" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to default__97.getString("card.paddingHead")), "paddingBody" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to default__97.getString("card.paddingBody")), "paddingFoot" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to default__97.getString("card.paddingFoot")), "showHead" to _uM("type" to "Boolean", "default" to default__97.getBoolean("card.showHead")), "showFoot" to _uM("type" to "Boolean", "default" to default__97.getBoolean("card.showFoot")), "boxShadow" to _uM("type" to "String", "default" to default__97.getString("card.boxShadow"))))
