...
open class GenUniModulesUviewUltraComponentsUpGapUpGap : VueComponent {
    ...
    companion object {
        ...
        var props = _nP(_uM("customStyle" to _uM("type" to _uA(
            "Object",
            "String"
        ), "default" to _uO()), "customClass" to _uM("type" to "String", "default" to ""), "url" to _uM("type" to "String", "default" to ""), "linkType" to _uM("type" to "String", "default" to "navigateTo"), "bgColor" to _uM("type" to "String", "default" to default__7.getString("gap.bgColor")), "height" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to default__7.getNumber("gap.height")), "marginTop" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to default__7.getNumber("gap.marginTop")), "marginBottom" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to default__7.getNumber("gap.marginBottom"))))
