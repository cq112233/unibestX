...
open class GenUniModulesUviewUltraComponentsUpIndexListUpIndexList : VueComponent {
    ...
    companion object {
        ...
        var props = _nP(_uM("customStyle" to _uM("type" to _uA(
            "Object",
            "String"
        ), "default" to _uO()), "customClass" to _uM("type" to "String", "default" to ""), "url" to _uM("type" to "String", "default" to ""), "linkType" to _uM("type" to "String", "default" to "navigateTo"), "inactiveColor" to _uM("type" to "String", "default" to default__46.getString("indexList.inactiveColor")), "activeColor" to _uM("type" to "String", "default" to default__46.getString("indexList.activeColor")), "indexList" to _uM("type" to "Array", "default" to fun(): UTSArray<Any> {
            val list = _uA<Any>()
            default__46.getArray<String>("indexList.indexList")!!!!.forEach(fun(item: String){
                list.push(item)
            }
            )
            return list
        }
        ), "sticky" to _uM("type" to "Boolean", "default" to default__46.getBoolean("indexList.sticky")), "customNavHeight" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to default__46.getNumber("indexList.customNavHeight")), "safeBottomFix" to _uM("type" to "Boolean", "default" to default__46.getBoolean("indexList.safeBottomFix")), "itemMargin" to _uM("type" to _uA(
            "String"
        ), "default" to default__46.getString("indexList.itemMargin"))))
