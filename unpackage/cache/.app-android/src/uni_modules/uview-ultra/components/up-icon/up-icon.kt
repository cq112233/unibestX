    ...
    companion object {
        ...
        var setup: (__props: GenUniModulesUviewUltraComponentsUpIconUpIcon) -> Any? = fun(__props): Any? {
            ...
            val iconStyle = computed(fun(): UTSJSONObject {
                var style: UTSJSONObject = _uO("__\$originalPosition" to UTSSourceMapPosition("style", "uni_modules/uview-ultra/components/up-icon/up-icon.uvue", 159, 7), "fontSize" to addUnit(props.size.toString()), "lineHeight" to addUnit(props.size.toString()), "fontWeight" to if ((props.bold as Boolean)) {
                    "bold"
                } else {
                    "normal"
                }
            ...
            val imgStyle = computed(fun(): UTSJSONObject {
                var style: UTSJSONObject = _uO("__\$originalPosition" to UTSSourceMapPosition("style", "uni_modules/uview-ultra/components/up-icon/up-icon.uvue", 181, 7))
            ...
            val icon = computed(fun(): String {
                ...
                if (default__5["upicon-" + props.name] != null) {
                    return default__5["upicon-" + props.name] as String
                } else {
        ...
        var props = _nP(_uM("customStyle" to _uM("type" to _uA(
            ...
            return default__6.getString("icon.name")
        }
        ), "color" to _uM("type" to "String", "default" to fun(): String? {
            return default__6.getString("icon.color")
        }
        ), "size" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to fun(): String? {
            return default__6.getString("icon.size")
        }
        ), "bold" to _uM("type" to "Boolean", "default" to fun(): Boolean? {
            return default__6.getBoolean("icon.bold")
        }
        ), "index" to _uM("type" to _uA(
            "String"
        ), "default" to fun(): String? {
            return default__6.getString("icon.index")
        }
        ), "hoverClass" to _uM("type" to "String", "default" to fun(): String? {
            return default__6.getString("icon.hoverClass")
        }
        ), "customPrefix" to _uM("type" to "String", "default" to fun(): String? {
            return default__6.getString("icon.customPrefix")
        }
        ), "label" to _uM("type" to _uA(
            "String"
        ), "default" to fun(): String? {
            return default__6.getString("icon.label")
        }
        ), "labelPos" to _uM("type" to "String", "default" to fun(): String? {
            return default__6.getString("icon.labelPos")
        }
        ), "labelSize" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to fun(): String? {
            return default__6.getString("icon.labelSize")
        }
        ), "labelColor" to _uM("type" to "String", "default" to fun(): String? {
            return default__6.getString("icon.labelColor")
        }
        ), "space" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to fun(): String? {
            return default__6.getString("icon.space")
        }
        ), "imgMode" to _uM("type" to "String", "default" to fun(): String? {
            return default__6.getString("icon.imgMode")
        }
        ), "width" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to fun(): String? {
            return default__6.getString("icon.width")
        }
        ), "height" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to fun(): String? {
            return default__6.getString("icon.height")
        }
        ), "top" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to fun(): String? {
            return default__6.getString("icon.top")
        }
        ), "stop" to _uM("type" to "Boolean", "default" to fun(): Boolean? {
            return default__6.getBoolean("icon.stop")
        }
        )))
