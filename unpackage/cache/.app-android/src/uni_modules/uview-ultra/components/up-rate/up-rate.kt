...
open class GenUniModulesUviewUltraComponentsUpRateUpRate : VueComponent {
    ...
    companion object {
        ...
        var props = _nP(_uM("customStyle" to _uM("type" to _uA(
            ...
            "String",
            "Number"
        ), "default" to crtProp__21["value"]), "count" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to crtProp__21["count"]), "disabled" to _uM("type" to "Boolean", "default" to crtProp__21["disabled"]), "readonly" to _uM("type" to "Boolean", "default" to crtProp__21["readonly"]), "size" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to crtProp__21["size"]), "inactiveColor" to _uM("type" to "String", "default" to crtProp__21["inactiveColor"]), "activeColor" to _uM("type" to "String", "default" to crtProp__21["activeColor"]), "gutter" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to crtProp__21["gutter"]), "minCount" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to crtProp__21["minCount"]), "allowHalf" to _uM("type" to "Boolean", "default" to crtProp__21["allowHalf"]), "activeIcon" to _uM("type" to "String", "default" to crtProp__21["activeIcon"]), "inactiveIcon" to _uM("type" to "String", "default" to crtProp__21["inactiveIcon"]), "touchable" to _uM("type" to "Boolean", "default" to crtProp__21["touchable"])))
