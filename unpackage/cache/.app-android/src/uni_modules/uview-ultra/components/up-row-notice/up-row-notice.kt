    ...
    companion object {
        ...
        var setup: (__props: GenUniModulesUviewUltraComponentsUpRowNoticeUpRowNotice) -> Any? = fun(__props): Any? {
            ...
            val textStyle = computed(fun(): UTSJSONObject {
                var style: UTSJSONObject = _uO("__\$originalPosition" to UTSSourceMapPosition("style", "uni_modules/uview-ultra/components/up-row-notice/up-row-notice.uvue", 107, 7))
            ...
            val animationStyle = computed(fun(): UTSJSONObject {
                var style: UTSJSONObject = _uO("__\$originalPosition" to UTSSourceMapPosition("style", "uni_modules/uview-ultra/components/up-row-notice/up-row-notice.uvue", 116, 7))
