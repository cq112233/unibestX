    ...
    companion object {
        ...
        var setup: (__props: GenUniModulesUviewUltraComponentsUpDropdownUpDropdown, __setupCtx: SetupContext) -> Any? = fun(__props, __setupCtx): Any? {
            ...
            val popupStyle = computed(fun(): UTSJSONObject {
                var style: UTSJSONObject = _uO("__\$originalPosition" to UTSSourceMapPosition("style", "uni_modules/uview-ultra/components/up-dropdown/up-dropdown.uvue", 138, 7))
            ...
            fun gen_getContentTextStyle_fn(item: UPDropdownMenu, index: Number): UTSJSONObject {
                val style: UTSJSONObject = _uO("__\$originalPosition" to UTSSourceMapPosition("style", "uni_modules/uview-ultra/components/up-dropdown/up-dropdown.uvue", 288, 9))
