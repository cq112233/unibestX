...
open class GenUniModulesUviewUltraComponentsUpRadioGroupUpRadioGroup : VueComponent {
    ...
    companion object {
        ...
        var props = _nP(_uM("customStyle" to _uM("type" to _uA(
            ...
            "Number",
            "Boolean"
        ), "default" to crtProp__20["value"]), "disabled" to _uM("type" to "Boolean", "default" to crtProp__20["disabled"]), "shape" to _uM("type" to "String", "default" to crtProp__20["shape"]), "activeColor" to _uM("type" to "String", "default" to crtProp__20["activeColor"]), "inactiveColor" to _uM("type" to "String", "default" to crtProp__20["inactiveColor"]), "name" to _uM("type" to "String", "default" to crtProp__20["name"]), "size" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to crtProp__20["size"]), "placement" to _uM("type" to "String", "default" to crtProp__20["placement"]), "label" to _uM("type" to _uA(
            "String"
        ), "default" to crtProp__20["label"]), "labelColor" to _uM("type" to _uA(
            "String"
        ), "default" to crtProp__20["labelColor"]), "labelSize" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to crtProp__20["labelSize"]), "labelDisabled" to _uM("type" to "Boolean", "default" to crtProp__20["labelDisabled"]), "iconColor" to _uM("type" to "String", "default" to crtProp__20["iconColor"]), "iconSize" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to crtProp__20["iconSize"]), "borderBottom" to _uM("type" to "Boolean", "default" to crtProp__20["borderBottom"]), "iconPlacement" to _uM("type" to "String", "default" to crtPropRadio["iconPlacement"])))
