    ...
    companion object {
        ...
        var setup: (__props: GenUniModulesUviewUltraComponentsUpDividerUpDivider) -> Any? = fun(__props): Any? {
            ...
            val textStyle = computed(fun(): UTSJSONObject {
                val style: UTSJSONObject = _uO("__\$originalPosition" to UTSSourceMapPosition("style", "uni_modules/uview-ultra/components/up-divider/up-divider.uvue", 82, 9))
            ...
            val leftLineStyle = computed(fun(): UTSJSONObject {
                val style: UTSJSONObject = _uO("__\$originalPosition" to UTSSourceMapPosition("style", "uni_modules/uview-ultra/components/up-divider/up-divider.uvue", 90, 9))
            ...
            val rightLineStyle = computed(fun(): UTSJSONObject {
                val style: UTSJSONObject = _uO("__\$originalPosition" to UTSSourceMapPosition("style", "uni_modules/uview-ultra/components/up-divider/up-divider.uvue", 102, 9))
