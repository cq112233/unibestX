...
open class GenUniModulesUviewUltraComponentsUpTooltipUpTooltip : VueComponent {
    ...
    override fun data(): Map<String, Any?> {
        return _uM("parent" to null as ComponentPublicInstance?, "parentData" to _uO(), "children" to _uA<ComponentPublicInstance>(), "childrenRefs" to _uA<String>(), "showTooltip" to true, "textId" to guid(), "tooltipId" to guid(), "tooltipTop" to -10000, "tooltipInfo" to createRectInfo(), "textInfo" to createRectInfo(), "indicatorStyle" to emptyStyle(), "screenGap" to 12, "indicatorWidth" to 14, "propsChange" to computed<String>(fun(): String {
            ...
            val style: UTSJSONObject = _uO("__\$originalPosition" to UTSSourceMapPosition("style", "uni_modules/uview-ultra/components/up-tooltip/up-tooltip.uvue", 251, 11))
            ...
            val style: UTSJSONObject = _uO("__\$originalPosition" to UTSSourceMapPosition("style", "uni_modules/uview-ultra/components/up-tooltip/up-tooltip.uvue", 257, 11))
            ...
            val style: UTSJSONObject = _uO("__\$originalPosition" to UTSSourceMapPosition("style", "uni_modules/uview-ultra/components/up-tooltip/up-tooltip.uvue", 272, 11))
            style["transform"] = if (this.direction === "top") {
                "translateY(-100%)"
            } else {
                "translateY(100%)"
            }
            val sysInfo = sys() as UTSJSONObject
            val tooltipInfo = this.tooltipInfo as UTSJSONObject
            val textInfo = this.textInfo as UTSJSONObject
            ...
            val windowWidth = normalizeNumber__1((sysInfo as UTSJSONObject)["windowWidth"], 0)
