...
open class GenUniModulesUviewUltraComponentsUpModalUpModal : VueComponent {
    ...
    companion object {
        ...
        var props = _nP(_uM("customStyle" to _uM("type" to _uA(
            "Object",
            "String"
        ), "default" to _uO()), "customClass" to _uM("type" to "String", "default" to ""), "url" to _uM("type" to "String", "default" to ""), "linkType" to _uM("type" to "String", "default" to "navigateTo"), "show" to _uM("type" to "Boolean", "default" to crtProp__27["show"]), "title" to _uM("type" to "String", "default" to crtProp__27["title"]), "content" to _uM("type" to "String", "default" to crtProp__27["content"]), "confirmText" to _uM("type" to "String", "default" to crtProp__27["confirmText"]), "cancelText" to _uM("type" to "String", "default" to crtProp__27["cancelText"]), "showConfirmButton" to _uM("type" to "Boolean", "default" to crtProp__27["showConfirmButton"]), "showCancelButton" to _uM("type" to "Boolean", "default" to crtProp__27["showCancelButton"]), "confirmColor" to _uM("type" to "String", "default" to crtProp__27["confirmColor"]), "cancelColor" to _uM("type" to "String", "default" to crtProp__27["cancelColor"]), "buttonReverse" to _uM("type" to "Boolean", "default" to crtProp__27["buttonReverse"]), "zoom" to _uM("type" to "Boolean", "default" to crtProp__27["zoom"]), "asyncClose" to _uM("type" to "Boolean", "default" to crtProp__27["asyncClose"]), "closeOnClickOverlay" to _uM("type" to "Boolean", "default" to crtProp__27["closeOnClickOverlay"]), "negativeTop" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to crtProp__27["negativeTop"]), "width" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to crtProp__27["width"]), "confirmButtonShape" to _uM("type" to "String", "default" to crtProp__27["confirmButtonShape"]), "duration" to _uM("type" to "Number", "default" to crtProp__27["duration"]), "contentTextAlign" to _uM("type" to "String", "default" to crtProp__27["contentTextAlign"]), "asyncCloseTip" to _uM("type" to "String", "default" to crtProp__27["asyncCloseTip"]), "asyncCancelClose" to _uM("type" to "Boolean", "default" to crtProp__27["asyncCancelClose"]), "contentStyle" to _uM("default" to crtProp__27["contentStyle"])))
