...
import { c as curIdx, t as themeColor } from "./helper/store.js";
    ...
    return () => {
      ...
      _createSharedDataIf(() => {
        ...
        _createSharedDataIf(() => {
          ...
          const n11 = _createSharedDataComponentWithFallback(_component_uni_icons, "dc96854c", {
            type: () => {
              return getIcon();
            },
            size: 24,
...
const _style_0 = {};
const _style_1 = {};
const TabbarItem = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0, _style_1]]]);
export {
  TabbarItem as T
};
