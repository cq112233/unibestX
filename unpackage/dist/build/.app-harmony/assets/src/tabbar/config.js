import { T as TabBarConfig, C as CustomTabBarItem } from "./types.js";
const customTabbarConfig = new TabBarConfig({
   ...
   * ⚠️ 不要midButton,请勿注释下面代码，还是会同步的，直接修改名字即可：比如：midButton1
   */
  midButton1: new UTSJSONObject({
    width: "50px",
    height: "50px",
    text: "tabbar.ai",
