...
import { _ as __easycom_1$1 } from "../../../../../uni_modules/uview-ultra/components/up-notify/up-notify.js";
...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const _component_up_notify = __easycom_1$1;
      const n16 = _createSharedDataComponent(AppKu, "60fc12f3", {
        layout: "navbar",
        "show-back": true,
        "hide-navbar": false,
        "enable-pull-down-refresh": false,
        "page-style": { "navigationBarTitleText": "up-notify 消息通知", "navigationStyle": "custom" }
      }, {
        "default": _withSharedDataVaporCtx(() => {
          const n15 = _createSharedDataComponent(LayoutComponent, "124321c9", {
            "show-back": true,
            "hide-navbar": false,
            "enable-pull-down-refresh": false,
            "page-style": { "navigationBarTitleText": "up-notify 消息通知", "navigationStyle": "custom" }
            ...
            "default": _withSharedDataVaporCtx(() => {
              ...
              const n1 = _createSharedDataComponentWithFallback(_component_up_button, "12433471", {
                type: "primary",
                text: "主要通知",
                size: "mini",
                onClick: () => {
              ...
              const n3 = _createSharedDataComponentWithFallback(_component_up_button, "12433b7a", {
                type: "success",
                text: "成功通知",
                size: "mini",
                onClick: () => {
              ...
              const n7 = _createSharedDataComponentWithFallback(_component_up_button, "3620fa1c", {
                type: "warning",
                text: "警告通知",
                size: "mini",
                onClick: () => {
              ...
              const n9 = _createSharedDataComponentWithFallback(_component_up_button, "36210125", {
                type: "error",
                text: "错误通知",
                size: "mini",
                onClick: () => {
              ...
              const n13 = _createSharedDataComponentWithFallback(_component_up_notify, "3621055e");
              _setSharedData(__sharedData, 2, n13?.sharedData);
              _setTemplateRef(n13, uNotify, null, "uNotify");
            })
          });
