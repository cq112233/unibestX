...
import { _ as __easycom_2 } from "../../../../../uni_modules/uview-ultra/components/up-pdf-reader/up-pdf-reader.js";
...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const _component_up_pdf_reader = __easycom_2;
      const n14 = _createSharedDataComponent(AppKu, "181d0101", {
        layout: "navbar",
        "show-back": true,
        "hide-navbar": false,
        ...
        "default": _withSharedDataVaporCtx(() => {
          const n13 = _createSharedDataComponent(LayoutComponent, "f63e7746", {
            "show-back": true,
            "hide-navbar": false,
            "enable-pull-down-refresh": false,
            "page-style": { "navigationBarTitleText": "up-pdf-reader PDF 阅读", "navigationStyle": "custom" }
            ...
            "default": _withSharedDataVaporCtx(() => {
              const n1 = _createSharedDataComponentWithFallback(_component_up_title, "f63e5370", { class: "demo-title" }, {
                "default": () => {
                }
              });
              ...
              const n2 = _createSharedDataComponentWithFallback(_component_up_button, "f63e4470", {
                text: "高度 600px",
                type: "primary",
                plain: () => {
              ...
              const n3 = _createSharedDataComponentWithFallback(_component_up_button, "f63e3bb0", {
                text: "高度 400px",
                type: "primary",
                plain: () => {
              ...
              const n5 = _createSharedDataComponentWithFallback(_component_up_pdf_reader, "1737a914", {
                src: () => {
                  return pdfUrl;
                },
                height: () => {
              ...
              const n8 = _createSharedDataComponentWithFallback(_component_up_title, "1737ad6c", { class: "demo-title" }, {
                "default": () => {
                }
              });
...
const _style_0 = {};
const _style_1 = {};
const pdfReader = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0, _style_1]]]);
export {
