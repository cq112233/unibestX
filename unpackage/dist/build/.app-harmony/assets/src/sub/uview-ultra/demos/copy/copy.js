...
import { _ as __easycom_1$1 } from "../../../../../uni_modules/uview-ultra/components/up-copy/up-copy.js";
...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const _component_up_copy = __easycom_1$1;
      const n7 = _createSharedDataComponent(AppKu, "7048018b", {
        layout: "navbar",
        "show-back": true,
        "hide-navbar": false,
        ...
        "default": _withSharedDataVaporCtx(() => {
          const n6 = _createSharedDataComponent(LayoutComponent, "7e4dca45", {
            "show-back": true,
            "hide-navbar": false,
            "enable-pull-down-refresh": false,
            "page-style": { "navigationBarTitleText": "Copy 复制", "navigationStyle": "custom" }
            ...
            "default": _withSharedDataVaporCtx(() => {
              const n2 = _createSharedDataComponentWithFallback(_component_up_copy, "7e4ddc17", {
                ...
                "default": _withSharedDataVaporCtx(() => {
                  const n1 = _createSharedDataComponentWithFallback(_component_up_button, "7e4ddd0d", {
                    type: "primary",
                    text: "点击复制文本",
                    size: "mini"
                  });
