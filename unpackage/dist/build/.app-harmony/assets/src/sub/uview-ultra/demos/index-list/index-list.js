...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n12 = _createSharedDataComponent(AppKu, "1e43093e", {
        layout: "navbar",
        "show-back": true,
        "hide-navbar": false,
        ...
        "default": _withSharedDataVaporCtx(() => {
          const n11 = _createSharedDataComponent(LayoutComponent, "332d26b7", {
            "show-back": true,
            "hide-navbar": false,
            "enable-pull-down-refresh": false,
            "page-style": { "navigationBarTitleText": "IndexList 索引列表", "navigationStyle": "custom" }
            ...
            "default": _withSharedDataVaporCtx(() => {
              ...
              const n8 = _createSharedDataComponentWithFallback(_component_up_index_list, "332d3526", {
                style: "flex: 1",
                "index-list": () => {
                ...
                "default": _withSharedDataVaporCtx(() => {
                  _createSharedDataFor(_setSharedDataScoped(__sharedData, 3, _createSharedDataVFor(__sharedDataScope, () => {
                    ...
                    const n7 = _createSharedDataComponentWithFallback(_component_up_index_item, "332d3945-" + _for_key0.value, null, {
                      "default": _withSharedDataVaporCtx(() => {
                        const n2 = _createSharedDataComponentWithFallback(_component_up_index_anchor, "332d3c2b-" + _for_key0.value, { text: () => {
