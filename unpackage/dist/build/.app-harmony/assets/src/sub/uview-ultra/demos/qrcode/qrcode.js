import { _ as __easycom_0 } from "../../../../../uni_modules/uview-ultra/components/up-qrcode/up-qrcode.js";
...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      "raw js";
      const _component_up_qrcode = __easycom_0;
      const n12 = _createSharedDataComponent(AppKu, "086a593d", {
        layout: "navbar",
        "show-back": true,
        "hide-navbar": false,
        ...
        "default": _withSharedDataVaporCtx(() => {
          const n11 = _createSharedDataComponent(LayoutComponent, "d18e050c", {
            "show-back": true,
            "hide-navbar": false,
            "enable-pull-down-refresh": false,
            "page-style": { "navigationBarTitleText": "Qrcode 二维码", "navigationStyle": "custom" }
            ...
            "default": _withSharedDataVaporCtx(() => {
              const n1 = _createSharedDataComponentWithFallback(_component_up_qrcode, "d18de086", {
                size: "200",
                val: "https://uview-ultra.lingyun.net"
              });
              _setSharedData(__sharedData, 2, n1?.sharedData);
              const n4 = _createSharedDataComponentWithFallback(_component_up_qrcode, "d18dd07e", {
                size: "200",
                background: "#f3f4f6",
                foreground: "#2979ff",
                val: "https://uview-ultra.lingyun.net"
              ...
              const n7 = _createSharedDataComponentWithFallback(_component_up_qrcode, "4fe697b5", {
                size: "200",
