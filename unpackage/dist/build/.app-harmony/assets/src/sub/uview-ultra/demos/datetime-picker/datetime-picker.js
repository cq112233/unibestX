...
import { _ as __easycom_16 } from "../../../../../uni_modules/uview-ultra/components/up-datetime-picker/up-datetime-picker.js";
...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    const __sharedData = __sharedDataRenderer == "component" ? _withSharedDataComponent(new UniDynamicSharedDataComponent(_useSharedDataScope(), _useSharedDataComponentOptions({ bundleKey: "GenSrcSubUviewUltraDemosDatetimePickerDatetimePickerSharedData", sharedDataClassId: 0 }))) : _withSharedDataPage(new UniDynamicSharedDataPage(_useSharedDataPageId(), _useSharedDataPageOptions({ bundleKey: "GenSrcSubUviewUltraDemosDatetimePickerDatetimePickerSharedData", sharedDataClassId: 0 })));
    ...
    return () => {
      ...
      const _component_up_datetime_picker = __easycom_16;
      const n53 = _createSharedDataComponent(AppKu, "014fc333", {
        layout: "navbar",
        "show-back": true,
        "hide-navbar": false,
        ...
        "default": _withSharedDataVaporCtx(() => {
          const n52 = _createSharedDataComponent(LayoutComponent, "2728769c", {
            "show-back": true,
            "hide-navbar": false,
            "enable-pull-down-refresh": false,
            "page-style": { "navigationBarTitleText": "up-datetime-picker 时间选择", "navigationStyle": "custom" }
            ...
            "default": _withSharedDataVaporCtx(() => {
              ...
              const n1 = _createSharedDataComponentWithFallback(_component_up_button, "2728501a", {
                type: "primary",
                text: "年月日时分",
                size: "mini",
                onClick: () => {
              ...
              _setSharedData(__sharedData, 10, n1?.sharedData);
              _renderSharedDataEffect(() => {
                return _setSharedData(__sharedData, 18, _toDisplayString(formatDate(dtValue1.value)));
              });
              const _on_click1 = () => {
                return dtShow2.value = true;
              };
              const n6 = _createSharedDataComponentWithFallback(_component_up_button, "bde73c3a", {
                type: "success",
                text: "年月日",
                size: "mini",
                onClick: () => {
              ...
              _setSharedData(__sharedData, 11, n6?.sharedData);
              _renderSharedDataEffect(() => {
                return _setSharedData(__sharedData, 19, _toDisplayString(formatDateOnly(dtValue2.value)));
              });
              const _on_click2 = () => {
                return dtShow3.value = true;
              };
              const n11 = _createSharedDataComponentWithFallback(_component_up_button, "bde71836", {
                type: "warning",
                text: "年月",
                size: "mini",
                onClick: () => {
              ...
              _renderSharedDataEffect(() => {
                return _setSharedData(__sharedData, 20, _toDisplayString(formatYearMonth(dtValue3.value)));
              });
              const _on_click3 = () => {
                return dtShow4.value = true;
              };
              const n16 = _createSharedDataComponentWithFallback(_component_up_button, "bde65bc8", {
                type: "error",
                text: "时分",
                size: "mini",
                onClick: () => {
              ...
              _setSharedData(__sharedData, 13, n16?.sharedData);
              _renderSharedDataEffect(() => {
                return _setSharedData(__sharedData, 21, _toDisplayString(dtValue4.value));
              });
              const _on_click4 = () => {
                return dtShowMinMaxDate.value = true;
              };
              const n21 = _createSharedDataComponentWithFallback(_component_up_button, "bde636fa", {
                type: "primary",
                text: "选择当月日期",
                size: "mini",
                onClick: () => {
              ...
              _setSharedData(__sharedData, 14, n21?.sharedData);
              _renderSharedDataEffect(() => {
                return _setSharedData(__sharedData, 22, _toDisplayString(formatDateOnly(dtValueMinMaxDate.value)));
              });
              const _on_click5 = () => {
                return dtShowMinMaxTime.value = true;
              };
              const n26 = _createSharedDataComponentWithFallback(_component_up_button, "bde616b6", {
                type: "warning",
                text: "选择时分范围",
                size: "mini",
                onClick: () => {
              ...
              _renderSharedDataEffect(() => {
                return _setSharedData(__sharedData, 23, _toDisplayString(dtValueMinMaxTime.value));
              });
              const _on_click6 = () => {
                return dtShowStart.value = true;
              };
              const n32 = _createSharedDataComponentWithFallback(_component_up_button, "bde545f6", {
                type: "primary",
                text: "选择开始",
                size: "mini",
                onClick: () => {
              ...
              _setSharedData(__sharedData, 16, n32?.sharedData);
              _renderSharedDataEffect(() => {
                return _setSharedData(__sharedData, 24, _toDisplayString(formatDateOnly(dtValueStart.value)));
              });
              const _on_click7 = () => {
                return dtShowEnd.value = true;
              };
              const n37 = _createSharedDataComponentWithFallback(_component_up_button, "bde4833a", {
                type: "success",
                text: "选择结束",
                size: "mini",
                onClick: () => {
              ...
              _renderSharedDataEffect(() => {
                return _setSharedData(__sharedData, 25, _toDisplayString(formatDateOnly(dtValueEnd.value)));
              });
              const _on_cancel = () => {
                return dtShow1.value = false;
              };
              const n43 = _createSharedDataComponentWithFallback(_component_up_datetime_picker, "bde46cbe", {
                modelValue: () => {
              ...
              _setSharedData(__sharedData, 2, n43?.sharedData);
              const _on_cancel1 = () => {
                return dtShow2.value = false;
              };
              const n44 = _createSharedDataComponentWithFallback(_component_up_datetime_picker, "bde4643a", {
                modelValue: () => {
              ...
              const n45 = _createSharedDataComponentWithFallback(_component_up_datetime_picker, "bde45bbe", {
                modelValue: () => {
              ...
              const n46 = _createSharedDataComponentWithFallback(_component_up_datetime_picker, "bde44df6", {
                modelValue: () => {
              ...
              const n47 = _createSharedDataComponentWithFallback(_component_up_datetime_picker, "bde3a238", {
                modelValue: () => {
              ...
              const n48 = _createSharedDataComponentWithFallback(_component_up_datetime_picker, "bde38bb8", {
                modelValue: () => {
              ...
              const n49 = _createSharedDataComponentWithFallback(_component_up_datetime_picker, "bde37a90", {
                modelValue: () => {
              ...
              const n50 = _createSharedDataComponentWithFallback(_component_up_datetime_picker, "bde3653a", {
                modelValue: () => {
                  return dtValueEnd.value;
                },
                "onUpdate:modelValue": () => {
          ...
          _setSharedData(__sharedData, 1, n52.sharedData);
        })
      });
      _setSharedData(__sharedData, 0, n53.sharedData);
      return __sharedData;
    };
  }
});
