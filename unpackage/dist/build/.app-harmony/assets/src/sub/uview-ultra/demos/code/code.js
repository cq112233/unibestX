import { _ as __easycom_0 } from "../../../../../uni_modules/uview-ultra/components/up-code/up-code.js";
...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const _component_up_code = __easycom_0;
      const _component_up_button = __easycom_1;
      const n8 = _createSharedDataComponent(AppKu, "6fb7867b", {
        layout: "navbar",
        "show-back": true,
        "hide-navbar": false,
        ...
        "default": _withSharedDataVaporCtx(() => {
          const n7 = _createSharedDataComponent(LayoutComponent, "5fefd339", {
            "show-back": true,
            "hide-navbar": false,
            "enable-pull-down-refresh": false,
            "page-style": { "navigationBarTitleText": "Code 验证码倒计时", "navigationStyle": "custom" }
            ...
            "default": _withSharedDataVaporCtx(() => {
              const n1 = _createSharedDataComponentWithFallback(_component_up_code, "5fefe8c4", {
                seconds: "60",
                onChange: () => {
                  return codeChange;
                }
              ...
              _setTemplateRef(n1, uCodeRef, null, "uCodeRef");
              const n2 = _createSharedDataComponentWithFallback(_component_up_button, "5fefe9bb", {
                text: () => {
                  return tips.value;
                },
                type: "primary",
