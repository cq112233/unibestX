...
import { _ as __easycom_1$1 } from "../../../../../uni_modules/uview-ultra/components/up-toast/up-toast.js";
...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const _component_up_toast = __easycom_1$1;
      const n16 = _createSharedDataComponent(AppKu, "fbd28c7e", {
        layout: "navbar",
        "show-back": true,
        "hide-navbar": false,
        ...
        "default": _withSharedDataVaporCtx(() => {
          const n15 = _createSharedDataComponent(LayoutComponent, "574f4d16", {
            "show-back": true,
            "hide-navbar": false,
            "enable-pull-down-refresh": false,
            "page-style": { "navigationBarTitleText": "up-toast 消息提示", "navigationStyle": "custom" }
            ...
            "default": _withSharedDataVaporCtx(() => {
              ...
              const n1 = _createSharedDataComponentWithFallback(_component_up_button, "574f5fbd", {
                type: "primary",
                text: "成功提示",
                size: "mini",
                onClick: () => {
              ...
              const n3 = _createSharedDataComponentWithFallback(_component_up_button, "574f66c5", {
                type: "error",
                text: "错误提示",
                size: "mini",
                onClick: () => {
              ...
              const n7 = _createSharedDataComponentWithFallback(_component_up_button, "dacb8f1e", {
                type: "warning",
                text: "警告提示",
                size: "mini",
                onClick: () => {
              ...
              const n9 = _createSharedDataComponentWithFallback(_component_up_button, "dacb810e", {
                type: "default",
                text: "默认提示",
                size: "mini",
                onClick: () => {
              ...
              const n13 = _createSharedDataComponentWithFallback(_component_up_toast, "dacb7896");
              _setSharedData(__sharedData, 2, n13?.sharedData);
              _setTemplateRef(n13, uToast, null, "uToast");
            })
          });
