import { _ as __easycom_0 } from "../../../../../uni_modules/uview-ultra/components/up-back-top/up-back-top.js";
...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      "raw js";
      const _component_up_back_top = __easycom_0;
      const n15 = _createSharedDataComponent(AppKu, "e6fcc4be", {
        layout: "navbar",
        "show-back": true,
        "hide-navbar": false,
        "enable-pull-down-refresh": false,
        "page-style": { "navigationBarTitleText": "Back Top 返回顶部", "navigationStyle": "custom" }
      }, {
        "default": _withSharedDataVaporCtx(() => {
          const n14 = _createSharedDataComponent(LayoutComponent, "7290b8f6", {
            "show-back": true,
            "hide-navbar": false,
            "enable-pull-down-refresh": false,
            "page-style": { "navigationBarTitleText": "Back Top 返回顶部", "navigationStyle": "custom" }
            ...
            "default": _withSharedDataVaporCtx(() => {
              _renderSharedDataEffect(() => {
                _setSharedDataStyle(__sharedData, 5, { height: `${windowHeight.value}px` });
              ...
              const n12 = _createSharedDataComponentWithFallback(_component_up_back_top, "40f3414e", {
                "scroll-top": () => {
