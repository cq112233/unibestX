import { _ as __easycom_0 } from "../../../../../uni_modules/uview-ultra/components/up-search/up-search.js";
...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      "raw js";
      const _component_up_search = __easycom_0;
      const n18 = _createSharedDataComponent(AppKu, "441ec4f1", {
        layout: "navbar",
        "show-back": true,
        "hide-navbar": false,
        ...
        "default": _withSharedDataVaporCtx(() => {
          const n17 = _createSharedDataComponent(LayoutComponent, "90fd67a0", {
            "show-back": true,
            "hide-navbar": false,
            "enable-pull-down-refresh": false,
            "page-style": { "navigationBarTitleText": "up-search 搜索", "navigationStyle": "custom" }
            ...
            "default": _withSharedDataVaporCtx(() => {
              const n1 = _createSharedDataComponentWithFallback(_component_up_search, "90fd43ce", {
                modelValue: () => {
              ...
              const n4 = _createSharedDataComponentWithFallback(_component_up_search, "90fd3456", {
                modelValue: () => {
              ...
              const n7 = _createSharedDataComponentWithFallback(_component_up_search, "38a81bbb", {
                modelValue: () => {
              ...
              const n10 = _createSharedDataComponentWithFallback(_component_up_search, "38a8266a", {
                modelValue: () => {
              ...
              const n13 = _createSharedDataComponentWithFallback(_component_up_search, "38a82e0a", {
                modelValue: () => {
