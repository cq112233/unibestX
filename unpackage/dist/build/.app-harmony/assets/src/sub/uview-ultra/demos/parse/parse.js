import { _ as __easycom_0 } from "../../../../../uni_modules/uview-ultra/components/up-parse/up-parse.js";
...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      "raw js";
      const _component_up_parse = __easycom_0;
      const n12 = _createSharedDataComponent(AppKu, "76efd141", {
        layout: "navbar",
        "show-back": true,
        "hide-navbar": false,
        ...
        "default": _withSharedDataVaporCtx(() => {
          const n11 = _createSharedDataComponent(LayoutComponent, "7a40847f", {
            "show-back": true,
            "hide-navbar": false,
            "enable-pull-down-refresh": false,
            "page-style": { "navigationBarTitleText": "Parse 富文本解析", "navigationStyle": "custom" }
            ...
            "default": _withSharedDataVaporCtx(() => {
              const n1 = _createSharedDataComponentWithFallback(_component_up_parse, "7a409667", { content: () => {
                return content1.value;
              } });
              _setSharedData(__sharedData, 2, n1?.sharedData);
              const n4 = _createSharedDataComponentWithFallback(_component_up_parse, "7a409de8", {
                content: () => {
              ...
              const n7 = _createSharedDataComponentWithFallback(_component_up_parse, "64602650", {
                content: () => {
