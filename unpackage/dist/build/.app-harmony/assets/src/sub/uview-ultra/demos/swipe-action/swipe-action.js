import { _ as __easycom_0 } from "../../../../../uni_modules/uview-ultra/components/up-swipe-action-item/up-swipe-action-item.js";
import { _ as __easycom_1 } from "../../../../../uni_modules/uview-ultra/components/up-swipe-action/up-swipe-action.js";
...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      "raw js";
      const _component_up_swipe_action_item = __easycom_0;
      const _component_up_swipe_action = __easycom_1;
      const n15 = _createSharedDataComponent(AppKu, "a989d93e", {
        layout: "navbar",
        "show-back": true,
        "hide-navbar": false,
        ...
        "default": _withSharedDataVaporCtx(() => {
          const n14 = _createSharedDataComponent(LayoutComponent, "6e78828e", {
            "show-back": true,
            "hide-navbar": false,
            "enable-pull-down-refresh": false,
            "page-style": { "navigationBarTitleText": "SwipeAction 滑动操作", "navigationStyle": "custom" }
            ...
            "default": _withSharedDataVaporCtx(() => {
              const n4 = _createSharedDataComponentWithFallback(_component_up_swipe_action, "6e785eb4", null, {
                "default": _withSharedDataVaporCtx(() => {
                  const n3 = _createSharedDataComponentWithFallback(_component_up_swipe_action_item, "6e785dfe", { options: () => {
              ...
              const n10 = _createSharedDataComponentWithFallback(_component_up_swipe_action, "4fb3f713", null, {
                "default": _withSharedDataVaporCtx(() => {
                  const n9 = _createSharedDataComponentWithFallback(_component_up_swipe_action_item, "4fb3f76e", { options: () => {
