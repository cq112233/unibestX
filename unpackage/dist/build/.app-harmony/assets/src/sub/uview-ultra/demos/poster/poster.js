...
import { _ as __easycom_2 } from "../../../../../uni_modules/uview-ultra/components/up-poster/up-poster.js";
...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const _component_up_poster = __easycom_2;
      const n22 = _createSharedDataComponent(AppKu, "4f5929fb", {
        layout: "navbar",
        "show-back": true,
        "hide-navbar": false,
        ...
        "default": _withSharedDataVaporCtx(() => {
          const n21 = _createSharedDataComponent(LayoutComponent, "4492d28c", {
            "show-back": true,
            "hide-navbar": false,
            "enable-pull-down-refresh": false,
            "page-style": { "navigationBarTitleText": "up-poster 海报", "navigationStyle": "custom" }
            ...
            "default": _withSharedDataVaporCtx(() => {
              const n1 = _createSharedDataComponentWithFallback(_component_up_title, "4492b4c4", { class: "demo-title" }, {
                "default": () => {
                }
              });
              _setSharedData(__sharedData, 3, n1?.sharedData);
              _createSharedDataIf(() => {
                return _setSharedData(__sharedData, 4, _toSharedDataBoolean(posterPath.value.length > 0));
              }, () => {
                _renderSharedDataEffect(() => {
                  return _setSharedDataAttr(__sharedData, 5, _toSharedDataString(posterPath.value));
                });
              }, () => {
              }, 261);
              const n9 = _createSharedDataComponentWithFallback(_component_up_button, "4dc7b504", {
                text: "生成海报",
                type: "primary",
                size: "small",
                class: "demo-btn",
              ...
              const n10 = _createSharedDataComponentWithFallback(_component_up_button, "4dc7ad42", {
                text: "切换样式",
                type: "primary",
                plain: "",
                size: "small",
              ...
              const n15 = _createSharedDataComponentWithFallback(_component_up_title, "4dc796fc", { class: "demo-title" }, {
                "default": () => {
                }
              });
              _setSharedData(__sharedData, 8, n15?.sharedData);
              const n19 = _createSharedDataComponentWithFallback(_component_up_poster, "4dc78044", {
                json: () => {
              ...
              _setTemplateRef(n19, posterRef, null, "posterRef");
            })
          });
...
const _style_0 = {};
const _style_1 = {};
const poster = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0, _style_1]]]);
export {
  poster as default
};
