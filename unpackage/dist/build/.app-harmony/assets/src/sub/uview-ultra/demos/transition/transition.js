import { _ as __easycom_0 } from "../../../../../uni_modules/uview-ultra/components/up-transition/up-transition.js";
...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      "raw js";
      const _component_up_transition = __easycom_0;
      const _component_up_button = __easycom_1;
      const n28 = _createSharedDataComponent(AppKu, "5d80d4ea", {
        layout: "navbar",
        "show-back": true,
        "hide-navbar": false,
        ...
        "default": _withSharedDataVaporCtx(() => {
          const n27 = _createSharedDataComponent(LayoutComponent, "7fb05e60", {
            "show-back": true,
            "hide-navbar": false,
            "enable-pull-down-refresh": false,
            "page-style": { "navigationBarTitleText": "Transition 动画", "navigationStyle": "custom" }
            ...
            "default": _withSharedDataVaporCtx(() => {
              const n3 = _createSharedDataComponentWithFallback(_component_up_transition, "7fb0710b", {
                show: () => {
              ...
              const n4 = _createSharedDataComponentWithFallback(_component_up_button, "765b4c65", {
                type: "primary",
                text: () => {
              ...
              const n11 = _createSharedDataComponentWithFallback(_component_up_transition, "765b5b12", {
                show: () => {
                  return transitionShow.value;
                },
                mode: "zoom"
              ...
              const n17 = _createSharedDataComponentWithFallback(_component_up_transition, "765b6dd5", {
                show: () => {
              ...
              const n19 = _createSharedDataComponentWithFallback(_component_up_button, "765bc904", {
                type: "primary",
                text: "上滑",
                size: "mini",
              ...
              const n20 = _createSharedDataComponentWithFallback(_component_up_button, "765bcfc7", {
                type: "success",
                text: "下滑",
                size: "mini",
                "custom-style": "margin: 0 4px;",
              ...
              const n21 = _createSharedDataComponentWithFallback(_component_up_button, "765bd3ec", {
                type: "warning",
                text: "左滑",
                size: "mini",
                "custom-style": "margin: 0 4px;",
              ...
              const n22 = _createSharedDataComponentWithFallback(_component_up_button, "765bdab1", {
                type: "error",
                text: "右滑",
                size: "mini",
                "custom-style": "margin: 0 4px;",
