...
import { _ as __easycom_1 } from "../../../../../uni_modules/uview-ultra/components/up-coupon/up-coupon.js";
...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const _component_up_coupon = __easycom_1;
      const n36 = _createSharedDataComponent(AppKu, "ed0cb726", {
        layout: "navbar",
        "show-back": true,
        "hide-navbar": false,
        ...
        "default": _withSharedDataVaporCtx(() => {
          const n35 = _createSharedDataComponent(LayoutComponent, "11a23cc2", {
            "show-back": true,
            "hide-navbar": false,
            "enable-pull-down-refresh": false,
            "page-style": { "navigationBarTitleText": "up-coupon 优惠券", "navigationStyle": "custom" }
            ...
            "default": _withSharedDataVaporCtx(() => {
              const n1 = _createSharedDataComponentWithFallback(_component_up_title, "11a24ba7", { class: "demo-title" }, {
                "default": () => {
                }
              });
              _setSharedData(__sharedData, 2, n1?.sharedData);
              const n2 = _createSharedDataComponentWithFallback(_component_up_coupon, "11a25237", {
                amount: "50",
                title: "新人专享优惠券",
                desc: "满 100 元可用",
              ...
              const n5 = _createSharedDataComponentWithFallback(_component_up_title, "22a539ee", { class: "demo-title" }, {
                "default": () => {
                }
              });
              _setSharedData(__sharedData, 4, n5?.sharedData);
              const n6 = _createSharedDataComponentWithFallback(_component_up_coupon, "22a53e61", {
                amount: "20",
                title: "信封样式",
                shape: "envelope",
                onClick: () => {
              ...
              const n7 = _createSharedDataComponentWithFallback(_component_up_coupon, "22a54529", {
                class: "mt-_b12px_B",
                amount: "30",
                title: "卡片样式",
                desc: "全场通用",
              ...
              const n10 = _createSharedDataComponentWithFallback(_component_up_title, "22a54da9", { class: "demo-title" }, {
                "default": () => {
                }
              });
              _setSharedData(__sharedData, 7, n10?.sharedData);
              const n11 = _createSharedDataComponentWithFallback(_component_up_coupon, "22a55490", {
                amount: "10",
                title: "小型",
                size: "small",
                onClick: () => {
              ...
              const n12 = _createSharedDataComponentWithFallback(_component_up_coupon, "22a558c7", {
                class: "mt-_b12px_B",
                amount: "10",
                title: "中型",
                size: "medium",
              ...
              const n13 = _createSharedDataComponentWithFallback(_component_up_coupon, "22a5aea7", {
                class: "mt-_b12px_B",
                amount: "10",
                title: "大型",
                size: "large",
              ...
              const n16 = _createSharedDataComponentWithFallback(_component_up_title, "22a5b98b", { class: "demo-title" }, {
                "default": () => {
                }
              });
              _setSharedData(__sharedData, 11, n16?.sharedData);
              const n17 = _createSharedDataComponentWithFallback(_component_up_coupon, "22a5bdae", {
                amount: "99",
                title: "已失效优惠券",
                "action-text": "已过期",
                disabled: "",
              ...
              const n18 = _createSharedDataComponentWithFallback(_component_up_coupon, "22a5c4cb", {
                class: "mt-_b12px_B",
                amount: "15",
                title: "自定义背景",
                "bg-color": "#eef7ff",
              ...
              const n21 = _createSharedDataComponentWithFallback(_component_up_title, "22a5d010", { class: "demo-title" }, {
                "default": () => {
                }
              });
              _setSharedData(__sharedData, 14, n21?.sharedData);
              const n25 = _createSharedDataComponentWithFallback(_component_up_coupon, "22a62302", {
                amount: "88",
                title: "大额优惠券",
                desc: "自定义右侧按钮",
                onClick: () => {
              ...
              const n28 = _createSharedDataComponentWithFallback(_component_up_title, "22a6324a", { class: "demo-title" }, {
                "default": () => {
                }
              });
              _setSharedData(__sharedData, 16, n28?.sharedData);
              _renderSharedDataEffect(() => {
                return _setSharedData(__sharedData, 17, _toDisplayString(eventLog.value));
              });
            })
          });
...
const _style_1 = {};
const coupon = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0, _style_1]]]);
export {
  coupon as default
};
