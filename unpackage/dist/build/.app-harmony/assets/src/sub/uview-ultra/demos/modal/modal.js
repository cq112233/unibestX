...
import { _ as __easycom_1$1 } from "../../../../../uni_modules/uview-ultra/components/up-modal/up-modal.js";
...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const _component_up_modal = __easycom_1$1;
      const n18 = _createSharedDataComponent(AppKu, "0b14ad81", {
        layout: "navbar",
        "show-back": true,
        "hide-navbar": false,
        "enable-pull-down-refresh": false,
        "page-style": { "navigationBarTitleText": "up-modal 模态框", "navigationStyle": "custom" }
      }, {
        "default": _withSharedDataVaporCtx(() => {
          const n17 = _createSharedDataComponent(LayoutComponent, "cec15e80", {
            "show-back": true,
            "hide-navbar": false,
            "enable-pull-down-refresh": false,
            "page-style": { "navigationBarTitleText": "up-modal 模态框", "navigationStyle": "custom" }
            ...
            "default": _withSharedDataVaporCtx(() => {
              const n1 = _createSharedDataComponentWithFallback(_component_up_button, "cec13934", {
                type: "primary",
                text: "弹窗提示",
                size: "mini",
                onClick: () => {
              ...
              const n3 = _createSharedDataComponentWithFallback(_component_up_button, "cec12b3a", {
                type: "warning",
                text: "确认弹窗",
                size: "mini",
                onClick: () => {
              ...
              const n7 = _createSharedDataComponentWithFallback(_component_up_button, "7b4aac90", {
                type: "success",
                text: "无标题",
                size: "mini",
                onClick: () => {
              ...
              const n11 = _createSharedDataComponentWithFallback(_component_up_button, "7b4ab7f3", {
                type: "error",
                text: "长内容",
                size: "mini",
                onClick: () => {
              ...
              const n15 = _createSharedDataComponentWithFallback(_component_up_modal, "7b4abc10", {
                show: () => {
