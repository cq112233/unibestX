import { _ as __easycom_0 } from "../../../../../uni_modules/uview-ultra/components/up-collapse-item/up-collapse-item.js";
import { _ as __easycom_1 } from "../../../../../uni_modules/uview-ultra/components/up-collapse/up-collapse.js";
...
import "../../../../../uni_modules/uview-ultra/components/up-collapse/collapse-common.js";
...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      "raw js";
      const _component_up_collapse_item = __easycom_0;
      const _component_up_collapse = __easycom_1;
      const n15 = _createSharedDataComponent(AppKu, "59d01b7b", {
        layout: "navbar",
        "show-back": true,
        "hide-navbar": false,
        ...
        "default": _withSharedDataVaporCtx(() => {
          const n14 = _createSharedDataComponent(LayoutComponent, "26372853", {
            "show-back": true,
            "hide-navbar": false,
            "enable-pull-down-refresh": false,
            "page-style": { "navigationBarTitleText": "up-collapse 折叠面板", "navigationStyle": "custom" }
            ...
            "default": _withSharedDataVaporCtx(() => {
              const n5 = _createSharedDataComponentWithFallback(_component_up_collapse, "26373a40", {
                value: () => {
                ...
                "default": _withSharedDataVaporCtx(() => {
                  const n2 = _createSharedDataComponentWithFallback(_component_up_collapse_item, "26373aff", {
                    title: "第一项",
                    name: "1"
                  }, {
                    "default": () => {
                  ...
                  const n4 = _createSharedDataComponentWithFallback(_component_up_collapse_item, "2637425f", {
                    title: "第二项",
                    name: "2"
                  }, {
                    "default": () => {
              ...
              const n10 = _createSharedDataComponentWithFallback(_component_up_collapse, "bea470cc", { value: ["1"] }, {
                "default": _withSharedDataVaporCtx(() => {
                  const n9 = _createSharedDataComponentWithFallback(_component_up_collapse_item, "bea46fd6", {
                    title: "第一项",
                    name: "1",
                    icon: "star"
                  }, {
