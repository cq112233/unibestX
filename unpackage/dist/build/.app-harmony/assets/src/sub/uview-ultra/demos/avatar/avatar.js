import { _ as __easycom_2 } from "../../../../../uni_modules/uview-ultra/components/up-avatar/up-avatar.js";
...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n25 = _createSharedDataComponent(AppKu, "7aad1313", {
        layout: "navbar",
        "show-back": true,
        "hide-navbar": false,
        ...
        "default": _withSharedDataVaporCtx(() => {
          const n24 = _createSharedDataComponent(LayoutComponent, "f896cc5c", {
            "show-back": true,
            "hide-navbar": false,
            "enable-pull-down-refresh": false,
            "page-style": { "navigationBarTitleText": "up-avatar 头像", "navigationStyle": "custom" }
            ...
            "default": _withSharedDataVaporCtx(() => {
              const n1 = _createSharedDataComponentWithFallback(_component_up_avatar, "f896a710", {
                src: "/static/logo.png",
                size: "40",
                class: "mr-_b10px_B"
              });
              _setSharedData(__sharedData, 2, n1?.sharedData);
              const n2 = _createSharedDataComponentWithFallback(_component_up_avatar, "f8969fd2", {
                text: "U",
                size: "40",
                "bg-color": "#2979ff",
                class: "mr-_b10px_B"
              ...
              const n6 = _createSharedDataComponentWithFallback(_component_up_avatar, "1a42fb4e", {
                src: "/static/logo.png",
                shape: "circle",
                size: "40",
                class: "mr-_b10px_B"
              ...
              const n7 = _createSharedDataComponentWithFallback(_component_up_avatar, "1a42f3c8", {
                src: "/static/logo.png",
                shape: "square",
                size: "40"
              });
              _setSharedData(__sharedData, 5, n7?.sharedData);
              const n11 = _createSharedDataComponentWithFallback(_component_up_avatar, "1a42dd76", {
                src: "/static/logo.png",
                size: "50",
                class: "mr-_b10px_B"
              });
              _setSharedData(__sharedData, 6, n11?.sharedData);
              const n12 = _createSharedDataComponentWithFallback(_component_up_avatar, "1a42d638", {
                src: "/static/logo.png",
                size: "40",
                class: "mr-_b10px_B"
              });
              _setSharedData(__sharedData, 7, n12?.sharedData);
              const n13 = _createSharedDataComponentWithFallback(_component_up_avatar, "1a42cefa", {
                src: "/static/logo.png",
                size: "30",
                class: "mr-_b10px_B"
              });
              _setSharedData(__sharedData, 8, n13?.sharedData);
              const n17 = _createSharedDataComponentWithFallback(_component_up_avatar, "1a42b86a", {
                icon: "level",
                size: "40",
                "bg-color": "#fa3534",
                class: "mr-_b10px_B"
              ...
              const n18 = _createSharedDataComponentWithFallback(_component_up_avatar, "1a421346", {
                icon: "photo",
                size: "40",
                "bg-color": "#ff9900",
                class: "mr-_b10px_B"
              ...
              const n19 = _createSharedDataComponentWithFallback(_component_up_avatar, "1a420bf6", {
                text: "张",
                size: "40",
                "bg-color": "#19be6b"
              });
