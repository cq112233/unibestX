...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n38 = _createSharedDataComponent(AppKu, "0e2eef3e", {
        layout: "navbar",
        "show-back": true,
        "hide-navbar": false,
        ...
        "default": _withSharedDataVaporCtx(() => {
          const n37 = _createSharedDataComponent(LayoutComponent, "60e7f39f", {
            "show-back": true,
            "hide-navbar": false,
            "enable-pull-down-refresh": false,
            "page-style": { "navigationBarTitleText": "up-title 标题", "navigationStyle": "custom" }
            ...
            "default": _withSharedDataVaporCtx(() => {
              const n1 = _createSharedDataComponentWithFallback(_component_up_title, "60e80282", { class: "demo-title" }, {
                "default": () => {
                }
              });
              _setSharedData(__sharedData, 2, n1?.sharedData);
              const n3 = _createSharedDataComponentWithFallback(_component_up_title, "60e80944", null, {
                "default": () => {
                }
              });
              _setSharedData(__sharedData, 3, n3?.sharedData);
              const n6 = _createSharedDataComponentWithFallback(_component_up_title, "60e810c8", { class: "demo-title" }, {
                "default": () => {
                }
              });
              _setSharedData(__sharedData, 4, n6?.sharedData);
              const n11 = _createSharedDataComponentWithFallback(_component_up_title, "87d33be8", null, {
                "prefix": () => {
                  _renderSharedDataEffect(() => {
                    return _setSharedDataStyle(__sharedData, 6, { backgroundColor: themeColor.value });
                  });
                },
                "default": () => {
                }
              ...
              const n14 = _createSharedDataComponentWithFallback(_component_up_title, "87d31cdc", { class: "demo-title" }, {
                "default": () => {
                }
              });
              _setSharedData(__sharedData, 7, n14?.sharedData);
              const n17 = _createSharedDataComponentWithFallback(_component_up_title, "87d30f50", null, {
                "default": _withSharedDataVaporCtx(() => {
                  const n15 = _createSharedDataComponentWithFallback(_component_up_icon, "87d30ed2", {
                    name: "bell",
                    size: "18",
                    color: () => {
              ...
              const n20 = _createSharedDataComponentWithFallback(_component_up_title, "87d2f94e", { class: "demo-title" }, {
                "default": () => {
                }
              });
              _setSharedData(__sharedData, 10, n20?.sharedData);
              const n22 = _createSharedDataComponentWithFallback(_component_up_title, "87d25324", null, {
                "default": () => {
                }
              });
              _setSharedData(__sharedData, 11, n22?.sharedData);
              const n25 = _createSharedDataComponentWithFallback(_component_up_title, "87d244e0", null, {
                "default": () => {
                }
              });
              _setSharedData(__sharedData, 12, n25?.sharedData);
              const n28 = _createSharedDataComponentWithFallback(_component_up_title, "87d23c18", null, {
                "default": () => {
                }
              });
              _setSharedData(__sharedData, 13, n28?.sharedData);
              const n32 = _createSharedDataComponentWithFallback(_component_up_title, "87d22cdc", { class: "demo-title" }, {
                "default": () => {
                }
              });
...
const _style_0 = {};
const _style_1 = {};
const title = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0, _style_1]]]);
export {
  title as default
};
