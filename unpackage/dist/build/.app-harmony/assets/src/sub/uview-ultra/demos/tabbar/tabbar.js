import { _ as __easycom_0 } from "../../../../../uni_modules/uview-ultra/components/up-tabbar-item/up-tabbar-item.js";
import { _ as __easycom_1 } from "../../../../../uni_modules/uview-ultra/components/up-tabbar/up-tabbar.js";
...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      "raw js";
      const _component_up_tabbar_item = __easycom_0;
      const _component_up_tabbar = __easycom_1;
      const n22 = _createSharedDataComponent(AppKu, "c6e98246", {
        layout: "navbar",
        "show-back": true,
        "hide-navbar": false,
        ...
        "default": _withSharedDataVaporCtx(() => {
          const n21 = _createSharedDataComponent(LayoutComponent, "b29209ca", {
            "show-back": true,
            "hide-navbar": false,
            "enable-pull-down-refresh": false,
            "page-style": { "navigationBarTitleText": "Tabbar 底部导航", "navigationStyle": "custom" }
            ...
            "default": _withSharedDataVaporCtx(() => {
              const n5 = _createSharedDataComponentWithFallback(_component_up_tabbar, "b291e5fa", {
                value: () => {
                  return value1.value;
                },
                fixed: false,
                ...
                "default": _withSharedDataVaporCtx(() => {
                  const n1 = _createSharedDataComponentWithFallback(_component_up_tabbar_item, "b291de72", {
                    text: "首页",
                    icon: "home"
                  });
                  _setSharedData(__sharedData, 3, n1?.sharedData);
                  const n2 = _createSharedDataComponentWithFallback(_component_up_tabbar_item, "b291dcc8", {
                    text: "放映厅",
                    icon: "photo"
                  });
                  _setSharedData(__sharedData, 4, n2?.sharedData);
                  const n3 = _createSharedDataComponentWithFallback(_component_up_tabbar_item, "b291d604", {
                    text: "直播",
                    icon: "play-right"
                  });
                  _setSharedData(__sharedData, 5, n3?.sharedData);
                  const n4 = _createSharedDataComponentWithFallback(_component_up_tabbar_item, "b291cf38", {
                    text: "我的",
                    icon: "account"
                  });
              ...
              const n11 = _createSharedDataComponentWithFallback(_component_up_tabbar, "30284dd2", {
                value: () => {
                  return value2.value;
                },
                fixed: false,
                ...
                "default": _withSharedDataVaporCtx(() => {
                  const n8 = _createSharedDataComponentWithFallback(_component_up_tabbar_item, "30285196", {
                    text: "首页",
                    icon: "home",
                    badge: "5"
                  });
                  _setSharedData(__sharedData, 8, n8?.sharedData);
                  const n9 = _createSharedDataComponentWithFallback(_component_up_tabbar_item, "30285515", {
                    text: "消息",
                    icon: "chat",
                    dot: true
                  });
                  _setSharedData(__sharedData, 9, n9?.sharedData);
                  const n10 = _createSharedDataComponentWithFallback(_component_up_tabbar_item, "30285881", {
                    text: "我的",
                    icon: "account"
                  });
              ...
              const n17 = _createSharedDataComponentWithFallback(_component_up_tabbar, "3028605b", {
                value: () => {
                  return value3.value;
                },
                fixed: false,
                ...
                "default": _withSharedDataVaporCtx(() => {
                  const n14 = _createSharedDataComponentWithFallback(_component_up_tabbar_item, "302864b8", {
                    text: "发现",
                    icon: "search"
                  });
                  _setSharedData(__sharedData, 12, n14?.sharedData);
                  const n15 = _createSharedDataComponentWithFallback(_component_up_tabbar_item, "3028681a", {
                    text: "购物车",
                    icon: "shopping-cart"
                  });
                  _setSharedData(__sharedData, 13, n15?.sharedData);
                  const n16 = _createSharedDataComponentWithFallback(_component_up_tabbar_item, "30286b84", {
                    text: "我的",
                    icon: "account"
                  });
