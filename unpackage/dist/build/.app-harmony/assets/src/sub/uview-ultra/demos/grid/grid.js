...
import { _ as __easycom_1 } from "../../../../../uni_modules/uview-ultra/components/up-grid-item/up-grid-item.js";
import { _ as __easycom_2 } from "../../../../../uni_modules/uview-ultra/components/up-grid/up-grid.js";
...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const _component_up_grid_item = __easycom_1;
      const _component_up_grid = __easycom_2;
      const n11 = _createSharedDataComponent(AppKu, "51abafa6", {
        layout: "navbar",
        "show-back": true,
        "hide-navbar": false,
        ...
        "default": _withSharedDataVaporCtx(() => {
          const n10 = _createSharedDataComponent(LayoutComponent, "957e5f32", {
            "show-back": true,
            "hide-navbar": false,
            "enable-pull-down-refresh": false,
            "page-style": { "navigationBarTitleText": "Grid 宫格", "navigationStyle": "custom" }
            ...
            "default": _withSharedDataVaporCtx(() => {
              const n6 = _createSharedDataComponentWithFallback(_component_up_grid, "957e3b94", { border: true }, {
                "default": _withSharedDataVaporCtx(() => {
                  _createSharedDataFor(_setSharedDataScoped(__sharedData, 3, _createSharedDataVFor(__sharedDataScope, () => {
                    ...
                    const n5 = _createSharedDataComponentWithFallback(_component_up_grid_item, "957e3aa6-" + _for_item0.value, null, {
                      "default": _withSharedDataVaporCtx(() => {
                        const n3 = _createSharedDataComponentWithFallback(_component_up_icon, "957e396e-" + _for_item0.value, {
                          name: "photo",
                          size: 30
                        });
                    ...
                    _setSharedData(__sharedData_VFor0, 1, n5?.sharedData);
                    return n5;
