import { _ as __easycom_0 } from "../../../../../uni_modules/uview-ultra/components/up-upload/up-upload.js";
...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      "raw js";
      const _component_up_upload = __easycom_0;
      const _component_up_button = __easycom_1;
      const n10 = _createSharedDataComponent(AppKu, "67e80b3a", {
        layout: "navbar",
        "show-back": true,
        "hide-navbar": false,
        ...
        "default": _withSharedDataVaporCtx(() => {
          const n9 = _createSharedDataComponent(LayoutComponent, "0e1225bc", {
            "show-back": true,
            "hide-navbar": false,
            "enable-pull-down-refresh": false,
            "page-style": { "navigationBarTitleText": "up-upload 上传", "navigationStyle": "custom" }
            ...
            "default": _withSharedDataVaporCtx(() => {
              const n1 = _createSharedDataComponentWithFallback(_component_up_upload, "0e1201ea", {
                "file-list": () => {
              ...
              const n5 = _createSharedDataComponentWithFallback(_component_up_upload, "0e11ea6e", {
                "file-list": () => {
                ...
                "default": _withSharedDataVaporCtx(() => {
                  const n4 = _createSharedDataComponentWithFallback(_component_up_button, "25e69929", {
                    type: "success",
                    text: "选择文件",
                    icon: "plus",
                    size: "mini"
