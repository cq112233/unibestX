import { _ as __easycom_0 } from "../../../../../uni_modules/uview-ultra/components/up-loadmore/up-loadmore.js";
...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      "raw js";
      const _component_up_loadmore = __easycom_0;
      const n18 = _createSharedDataComponent(AppKu, "1fb86cd2", {
        layout: "navbar",
        "show-back": true,
        "hide-navbar": false,
        "enable-pull-down-refresh": false,
        "page-style": { "navigationBarTitleText": "Loadmore 加载更多", "navigationStyle": "custom" }
      }, {
        "default": _withSharedDataVaporCtx(() => {
          const n17 = _createSharedDataComponent(LayoutComponent, "7657bf6c", {
            "show-back": true,
            "hide-navbar": false,
            "enable-pull-down-refresh": false,
            "page-style": { "navigationBarTitleText": "Loadmore 加载更多", "navigationStyle": "custom" }
            ...
            "default": _withSharedDataVaporCtx(() => {
              const n1 = _createSharedDataComponentWithFallback(_component_up_loadmore, "7657d141", { status: "loadmore" });
              _setSharedData(__sharedData, 2, n1?.sharedData);
              const n4 = _createSharedDataComponentWithFallback(_component_up_loadmore, "7657d8a2", {
                status: "loading",
                "loading-text": "正在奋力加载中..."
              });
              _setSharedData(__sharedData, 3, n4?.sharedData);
              const n7 = _createSharedDataComponentWithFallback(_component_up_loadmore, "54a00cba", {
                status: "nomore",
                "nomore-text": "我是有底线的"
              });
              _setSharedData(__sharedData, 4, n7?.sharedData);
              const n10 = _createSharedDataComponentWithFallback(_component_up_loadmore, "54a01444", {
                status: "nomore",
                line: true
              });
              _setSharedData(__sharedData, 5, n10?.sharedData);
              const n13 = _createSharedDataComponentWithFallback(_component_up_loadmore, "54a01bdf", {
                status: "loading",
