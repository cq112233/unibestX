  ...
  setup(__props) {
    ...
    return () => {
      ...
      _renderSharedDataEffect(() => {
        _setSharedDataClass(__sharedData, 0, ["weapp-tw-border", _unref(flag) ? "wtu-uj646o-a wtu-v1dixk-b" : "wtu-s9xl9u-c"]);
        _setSharedDataClass(__sharedData, 1, ["weapp-tw-border", [
          _unref(extra),
          { "wtu-1l82hkd-d": _unref(toggled) }
        ]]);
        _setSharedDataClass(__sharedData, 2, ["weapp-tw-border", _unref(condition) ? "wtu-1hf1vho-e wtu-6xzka-f" : ""]);
      });
      return __sharedData;
    };
  }
...
const _style_0 = {};
const _style_1 = {};
const BindClass = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0, _style_1]]]);
export {
  BindClass as B
};
