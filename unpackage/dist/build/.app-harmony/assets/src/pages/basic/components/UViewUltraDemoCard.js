  ...
  setup(__props) {
    ...
    function navigateToShowcase() {
      uni.navigateTo({
        ...
        fail: (err) => {
          uni.__f__("error", "at src/pages/basic/components/UViewUltraDemoCard.uvue:63", "navigateToShowcase fail:", err);
        }
      });
    }
    return () => {
...
const _style_0 = {};
const _style_1 = {};
const UViewUltraDemoCard = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0, _style_1]]]);
export {
