...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n62 = _createSharedDataComponent(
        Card,
        "772f6fae",
        { title: "Lodash 工具库 (iRainna-lodash)" },
        {
          "default": _withSharedDataVaporCtx(() => {
            ...
            const n34 = _createSharedDataComponentWithFallback(_component_input, "23669208", {
              value: () => {
      ...
      _setSharedData(__sharedData, 0, n62.sharedData);
      return __sharedData;
    };
  }
});
const _style_0 = {};
const _style_1 = {};
const LodashDemoCard = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0, _style_1]]]);
export {
  LodashDemoCard as L
};
