  ...
  setup(__props) {
    ...
    function chooseImage() {
      uni.chooseImage(new UTSJSONObject({
        ...
        fail: (err) => {
          uni.__f__("error", "at src/pages/function/components/MediaCard.uvue:44", err);
        }
      }));
    }
    function scanCode() {
      uni.scanCode(new UTSJSONObject({
        ...
        fail: (err) => {
          uni.__f__("error", "at src/pages/function/components/MediaCard.uvue:55", err);
        }
      }));
    }
    return () => {
...
const _style_0 = {};
const _style_1 = {};
const MediaCard = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0, _style_1]]]);
export {
  MediaCard as M
};
