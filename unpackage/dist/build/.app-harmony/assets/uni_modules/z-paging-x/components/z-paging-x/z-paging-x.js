  ...
  setup(__props, _a) {
    ...
    return () => {
      ...
      _createSharedDataIf(() => {
        ...
        const n34 = _createSharedDataComponentWithFallback(_component_list_view, "0980359c", {
          ...
          "header": _withSharedDataVaporCtx(() => {
            ...
            _createSharedDataIf(() => {
              ...
              _createSharedDataIf(() => {
                ...
                const n10 = _createSharedDataComponent(zPagingLoadMore, "6cbc3e7a", {
                  status: () => {
                    return loadMoreStatus.value;
                  },
                  "default-text": () => {
            ...
            _createSharedDataIf(() => {
              ...
              _createSharedDataIf(() => {
                ...
                const n19 = _createSharedDataComponentWithFallback(_component_z_paging_x_empty, "6cbcba79", {
                  "empty-text": () => {
          ...
          "refresher": _withSharedDataVaporCtx(() => {
            ...
            _createSharedDataIf(() => {
              ...
              const n30 = _createSharedDataComponent(zPagingRefresher, "6cbc551c", {
                "default-text": () => {
        ...
        _createSharedDataIf(() => {
          ...
          _createSharedDataIf(() => {
            ...
            const n43 = _createSharedDataComponent(zPagingLoadMore, "6cbd3cc5", {
              status: () => {
                return loadMoreStatus.value;
              },
              "default-text": () => {
        ...
        _createSharedDataIf(() => {
          ...
          const n50 = _createSharedDataComponent(zPagingRefresher, "6cbd9ee1", {
            "default-text": () => {
              return __props.refresherDefaultText;
            },
            "pulling-text": () => {
        ...
        _renderSharedDataEffect(() => {
          return _setSharedDataClass(__sharedData, 51, ["weapp-tw-border", showEmpty.value ? "zpx-flex1" : ""]);
        });
        _createSharedDataIf(() => {
          ...
          _createSharedDataIf(() => {
            ...
            const n59 = _createSharedDataComponentWithFallback(_component_z_paging_x_empty, "6cbdb581", {
              "empty-text": () => {
                return !isLoadFailed.value ? __props.emptyText : __props.emptyErrorText;
              },
              "empty-img": () => {
            ...
            _setSharedData(__sharedData, 28, n59?.sharedData);
          }, 2821);
        });
        _createSharedDataIf(() => {
        ...
        _setSharedDataTemplateRef(__sharedData, 40, (n65) => {
          _setTemplateRef(n65, zpxList, null, "zpxList");
        });
      }, 1797);
      ...
      _createSharedDataIf(() => {
        ...
        _renderSharedDataEffect(() => {
          _setSharedDataClass(__sharedData, 56, ["weapp-tw-border", backToTopClass.value]);
      ...
      _setSharedDataClass(__sharedData, 58, ["weapp-tw-border", { "zpx-content": true }]);
      _setSharedDataTemplateRef(__sharedData, 59, (n75) => {
        _setTemplateRef(n75, zPagingX, null, "zPagingX");
      });
      return __sharedData;
    };
  }
