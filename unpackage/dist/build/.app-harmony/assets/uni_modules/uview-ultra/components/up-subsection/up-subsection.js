  ...
  setup(__props, _a) {
    ...
    return () => {
      ...
      _renderSharedDataEffect(() => {
        ...
        _setSharedDataClass(__sharedData, 2, ["weapp-tw-border up-subsection", [`up-subsection--${_mode}`]]);
        _setSharedDataStyle(__sharedData, 3, computedRootStyle.value);
        _setSharedDataStyle(__sharedData, 4, barStyle.value);
        _setSharedDataClass(__sharedData, 5, ["weapp-tw-border up-subsection__bar__inner", {
      ...
      _createSharedDataFor(_setSharedDataScoped(__sharedData, 0, _createSharedDataVFor(__sharedDataScope, () => {
        ...
        _renderSharedDataEffect(() => {
          ...
          const _list = __props.list;
          const _list_length = _list.length;
          _setSharedDataClass(__sharedData_VFor0, 6, ["weapp-tw-border up-subsection__item wtu-cqyuct-0", [
        ...
        _createSharedDataSlot("item", {
          ...
          _renderSharedDataEffect(() => {
            const _index = _for_key0.value;
            _setSharedDataClass(__sharedData_VFor0, 2, ["weapp-tw-border up-subsection__item__text", [
