      ...
      _createSharedDataSlot("button", null, null, () => {
        _createSharedDataFor(_setSharedDataScoped(__sharedData, 0, _createSharedDataVFor(__sharedDataScope, () => {
          ...
          _renderSharedDataEffect(() => {
            ...
            _setSharedDataClass(__sharedData_VFor0, 8, ["weapp-tw-border up-swipe-action-item__right__button__wrapper", {
          ...
          _createSharedDataIf(() => {
            ...
            const n6 = _createSharedDataComponentWithFallback(_component_up_icon, "091265fa-" + _for_key0.value, {
              name: () => {
