        ...
        },
        {
          "default": _withSharedDataVaporCtx(() => {
            _renderSharedDataEffect(() => {
              _setSharedDataClass(__sharedData, 5, ["weapp-tw-border up-notify", [`up-notify--${tmpConfig.value["type"]}`]]);
            ...
            _createSharedDataIf(() => {
              ...
              const n2 = _createSharedDataComponentWithFallback(_component_up_status_bar, "62ccc48e");
            ...
            _createSharedDataSlot("icon", null, null, () => {
              _createSharedDataIf(() => {
                ...
                const n7 = _createSharedDataComponentWithFallback(_component_up_icon, "62ccbbd6", {
                  name: () => {
