  ...
  setup(__props) {
    ...
    return () => {
      ...
      _renderSharedDataEffect(() => {
        _setSharedDataClass(__sharedData, 23, ["weapp-tw-border up-steps-item", [`up-steps-item--${direction.value}`]]);
      ...
      _renderSharedDataEffect(() => {
        ...
        _setSharedDataClass(__sharedData, 25, ["weapp-tw-border up-steps-item__wrapper", [`up-steps-item__wrapper--${_direction}`, isDot.value ? `up-steps-item__wrapper--${_direction}--dot` : ""]]);
      ...
      _createSharedDataSlot("icon", null, null, () => {
        _createSharedDataIf(() => {
          ...
          return _createSharedDataIf(() => {
            ...
            const n18 = _createSharedDataComponentWithFallback(_component_up_icon, "e81f38c0", {
              name: () => {
            ...
            _createSharedDataIf(() => {
              ...
              const n26 = _createSharedDataComponentWithFallback(_component_up_icon, "e81e67b4", {
                color: () => {
      ...
      _renderSharedDataEffect(() => {
        _setSharedDataClass(__sharedData, 27, ["weapp-tw-border up-steps-item__content", [`up-steps-item__content--${direction.value}`]]);
