  ...
  setup(__props, _a) {
    ...
    return () => {
      ...
      _renderSharedDataEffect(() => {
        _setSharedDataClass(__sharedData, 5, ["weapp-tw-border up-textarea", textareaClass.value]);
        _setSharedDataStyle(__sharedData, 6, textareaStyle.value);
      });
      const n0 = _createSharedDataComponentWithFallback(_component_textarea, "1b1ec708", {
