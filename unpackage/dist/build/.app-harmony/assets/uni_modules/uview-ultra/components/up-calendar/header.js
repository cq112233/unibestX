    ...
    return () => {
      ...
      _createSharedDataIf(() => {
        ...
        _createSharedDataIf(() => {
          ...
          _renderSharedDataEffect(() => {
            return _setSharedDataClass(__sharedData, 5, ["weapp-tw-border up-calendar-header__switch", { "up-calendar-header__switch--disabled": __props.prevYearDisabled }]);
          });
        });
        _createSharedDataIf(() => {
          ...
          _renderSharedDataEffect(() => {
            return _setSharedDataClass(__sharedData, 8, ["weapp-tw-border up-calendar-header__switch", { "up-calendar-header__switch--disabled": __props.prevDisabled }]);
          });
        });
        _renderSharedDataEffect(() => {
        ...
        _createSharedDataIf(() => {
          ...
          _renderSharedDataEffect(() => {
            return _setSharedDataClass(__sharedData, 11, ["weapp-tw-border up-calendar-header__switch", { "up-calendar-header__switch--disabled": __props.nextDisabled }]);
          });
        });
        _createSharedDataIf(() => {
          ...
          _renderSharedDataEffect(() => {
            return _setSharedDataClass(__sharedData, 14, ["weapp-tw-border up-calendar-header__switch", { "up-calendar-header__switch--disabled": __props.nextYearDisabled }]);
          });
        });
        _createSharedDataIf(() => {
          ...
          _renderSharedDataEffect(() => {
            _setSharedDataClass(__sharedData, 17, ["weapp-tw-border up-calendar-header__today", { "up-calendar-header__today--disabled": __props.todayDisabled }]);
...
const _style_0 = {};
const _style_1 = {};
const uHeader = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0, _style_1]]]);
export {
  uHeader as u
};
