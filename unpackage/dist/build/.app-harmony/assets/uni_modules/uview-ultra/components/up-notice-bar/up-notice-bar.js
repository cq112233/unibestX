import { _ as __easycom_0$1 } from "../up-column-notice/up-column-notice.js";
import { _ as __easycom_1 } from "../up-row-notice/up-row-notice.js";
...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props, _a) {
    ...
    return () => {
      "raw js";
      const _component_up_column_notice = __easycom_0$1;
      const _component_up_row_notice = __easycom_1;
      _createSharedDataIf(() => {
        return _setSharedData(__sharedData, 0, _toSharedDataBoolean(show.value));
      }, () => {
        _renderSharedDataEffect(() => {
          return _setSharedDataStyle(__sharedData, 4, noticeBarStyle.value);
        });
        _createSharedDataIf(() => {
          return _setSharedData(__sharedData, 1, _toSharedDataBoolean(__props.direction == "column" || __props.direction == "row" && __props.step));
        }, () => {
          const n4 = _createSharedDataComponentWithFallback(_component_up_column_notice, "565f47dc", {
            color: () => {
          ...
          const n6 = _createSharedDataComponentWithFallback(_component_up_row_notice, "565f3116", {
            color: () => {
              return __props.color;
            },
            bgColor: () => {
