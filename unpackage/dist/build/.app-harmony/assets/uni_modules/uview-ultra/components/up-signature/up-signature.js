...
import { _ as __easycom_0$1 } from "../up-slider/up-slider.js";
...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props, _a) {
    ...
    const penSizeLabel = computed(() => {
      return t("up.signature.penSize", new UTSJSONObject({}));
    });
    const penColorLabel = computed(() => {
      return t("up.signature.penColor", new UTSJSONObject({}));
    });
    ...
    return () => {
      ...
      const _component_up_slider = __easycom_0$1;
      _renderSharedDataEffect(() => {
        return _setSharedDataStyle(__sharedData, 19, canvasWrapStyle.value);
      });
      const n0 = _createSharedDataComponentWithFallback(_component_canvas, "00dcd0a0", {
      ...
      _createSharedDataIf(() => {
        ...
        const n4 = _createSharedDataComponentWithFallback(_component_up_icon, "00dcb218", {
          name: "arrow-left",
          size: "22",
          color: () => {
        ...
        const n6 = _createSharedDataComponentWithFallback(_component_up_icon, "00dca352", {
          name: "trash",
          size: "25",
          color: "#999"
        });
        ...
        const n8 = _createSharedDataComponentWithFallback(_component_up_icon, "00dc9514", {
          name: "edit-pen",
          size: "25",
          color: "#999"
        });
        ...
        const n10 = _createSharedDataComponentWithFallback(_component_up_icon, "1abd6002", {
          name: "grid",
          size: "24",
          color: "#999"
        });
        ...
        const n12 = _createSharedDataComponentWithFallback(_component_up_icon, "1abd51f8", {
          name: "checkmark",
          size: "25",
          color: () => {
        ...
        _createSharedDataIf(() => {
          ...
          const n18 = _createSharedDataComponentWithFallback(_component_up_slider, "1abd3a40", {
            modelValue: () => {
        ...
        _createSharedDataIf(() => {
          ...
          _createSharedDataFor(_setSharedDataScoped(__sharedData, 5, _createSharedDataVFor(__sharedDataScope, () => {
            ...
            _renderSharedDataEffect(() => {
              ...
              _setSharedDataClass(__sharedData_VFor0, 2, ["weapp-tw-border up-signature__color-item", lineColor.value == _color ? "up-signature__color-item--active" : ""]);
