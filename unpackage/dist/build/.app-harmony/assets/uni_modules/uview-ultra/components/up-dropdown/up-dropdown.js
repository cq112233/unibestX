  ...
  setup(__props, _a) {
    ...
    return () => {
      ...
      _renderSharedDataEffect(() => {
        ...
        _setSharedDataClass(__sharedData, 5, ["weapp-tw-border up-dropdown__menu", {
      ...
      _createSharedDataFor(_setSharedDataScoped(__sharedData, 0, _createSharedDataVFor(__sharedDataScope, () => {
        ...
        _renderSharedDataEffect(() => {
          ...
          _setSharedDataClass(__sharedData_VFor0, 3, ["weapp-tw-border up-dropdown__menu__item__text", {
          ...
          _setSharedDataClass(__sharedData_VFor0, 6, ["weapp-tw-border up-dropdown__menu__item__arrow", {
            "up-dropdown__menu__item__arrow--rotate": _index == _current
          }]);
        });
        const n3 = _createSharedDataComponentWithFallback(_component_up_icon, "7fd8c8f4-" + _for_key0.value, {
