...
import { c as bem, b as addStyle, d as deepMerge, a as addUnit, g as getPx } from "../../libs/function/index.js";
  ...
  setup(__props, _a) {
    ...
    return () => {
      ...
      _renderSharedDataEffect(() => {
        ...
        _setSharedDataClass(__sharedData, 10, ["weapp-tw-border up-button", bemClass.value]);
      ...
      _createSharedDataIf(() => {
        ...
        const n2 = _createSharedDataComponentWithFallback(_component_up_loading_icon, "64250b93", {
          mode: () => {
        ...
        _createSharedDataIf(() => {
          ...
          const n7 = _createSharedDataComponentWithFallback(_component_up_icon, "64251789", {
            name: () => {
              return __props.icon;
            },
            color: () => {
      ...
      const n11 = _createSharedDataComponentWithFallback(_component_button, "6425262e", {
        "hover-start-time": () => {
