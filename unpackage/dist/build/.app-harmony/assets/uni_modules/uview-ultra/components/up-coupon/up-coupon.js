  ...
  setup(__props, _a) {
    ...
    return () => {
      ...
      _renderSharedDataEffect(() => {
        _setSharedDataClass(__sharedData, 25, ["weapp-tw-border up-coupon", [`up-coupon--${__props.shape}`, `up-coupon--${__props.type}`, `up-coupon--${__props.size}`, { "up-coupon--disabled": __props.disabled }]]);
      ...
      _createSharedDataSlot("action", {
        ...
        const n39 = _createSharedDataComponentWithFallback(_component_up_tag, "25ed69b6", {
          type: "error",
          text: () => {
            return __props.actionText;
          },
