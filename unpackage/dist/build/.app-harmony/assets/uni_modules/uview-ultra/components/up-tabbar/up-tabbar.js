  ...
  setup(__props, _a) {
    ...
    return () => {
      ...
      _renderSharedDataEffect(() => {
        _setSharedDataClass(__sharedData, 5, ["weapp-tw-border up-tabbar__content", [__props.border ? "up-border-top" : "", __props.fixed ? "up-tabbar--fixed" : ""]]);
      ...
      _createSharedDataIf(() => {
        ...
        const n4 = _createSharedDataComponentWithFallback(_component_up_safe_bottom, "d503cbfc");
