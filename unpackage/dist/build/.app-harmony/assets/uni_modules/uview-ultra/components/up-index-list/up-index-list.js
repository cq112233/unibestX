import { _ as __easycom_0 } from "../up-index-anchor/up-index-anchor.js";
import { _ as __easycom_0$1 } from "../up-transition/up-transition.js";
import { a as addUnit, s as sleep, e as getWindowInfo, g as getPx, u as upGetRect } from "../../libs/function/index.js";
...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props, _a) {
    ...
    const indicatorTransitionStyle = computed(() => {
      return new UTSJSONObject({
        position: "absolute",
        right: "30px",
    ...
    const indicatorBoxStyle = computed(() => {
      return new UTSJSONObject({
    ...
    const setValueForTouch = async (currentIndex) => {
      ...
      if (currentIndex !== activeIndex.value) {
        ...
        uni.__f__("log", "at uni_modules/uview-ultra/components/up-index-list/up-index-list.uvue:345", scrollIntoView.value);
    ...
    return () => {
      ...
      const _component_up_transition = __easycom_0$1;
      _createSharedDataIf(() => {
        ...
        const n2 = _createSharedDataComponentWithFallback(_component_up_index_anchor, "9ac46fd2", { text: () => {
      ...
      _createSharedDataFor(_setSharedDataScoped(__sharedData, 8, _createSharedDataVFor(__sharedDataScope, () => {
        ...
        _renderSharedDataEffect(() => {
          ...
          _setSharedDataClass(__sharedData_VFor0, 1, ["weapp-tw-border up-index-list__letter__item", { "up-index-list__letter__item--active": activeIndex.value == _index && __props.activeColor == "#5677fc" }]);
      ...
      const n21 = _createSharedDataComponentWithFallback(_component_up_transition, "bdcb4cb2", {
        mode: "fade",
        show: () => {
        ...
        "default": () => {
          _setSharedDataClass(__sharedData, 3, ["weapp-tw-border up-index-list__indicator", ["up-index-list__indicator--show"]]);
          _renderSharedDataEffect(() => {
...
const _style_0 = {"absolute":{"":{"position":"absolute"}}};
const _style_1 = {};
