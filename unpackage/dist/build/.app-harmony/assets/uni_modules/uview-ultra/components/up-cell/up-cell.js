  ...
  setup(__props, _a) {
    ...
    return () => {
      ...
      _renderSharedDataEffect(() => {
        _setSharedDataClass(__sharedData, 22, ["weapp-tw-border up-cell", [__props.customClass]]);
        ...
        _setSharedDataClass(__sharedData, 25, ["weapp-tw-border up-cell__body", { "up-cell--center": __props.center, "up-cell__body--large": __props.size == "large" }]);
      });
      _createSharedDataIf(() => {
        ...
        _createSharedDataIf(() => {
          ...
          const n6 = _createSharedDataComponentWithFallback(_component_up_icon, "50dbb169", {
            name: () => {
              return __props.icon;
            },
            "custom-style": () => {
      ...
      _createSharedDataIf(() => {
        ...
        _renderSharedDataEffect(() => {
          _setSharedDataClass(__sharedData, 15, ["weapp-tw-border up-cell__title-text", { "up-cell--disabled": __props.disabled, "up-cell__title-text--large": __props.size == "large" }]);
      ...
      _createSharedDataSlot("label", null, null, () => {
        _createSharedDataIf(() => {
          ...
          _renderSharedDataEffect(() => {
            _setSharedDataClass(__sharedData, 19, ["weapp-tw-border up-cell__label", { "up-cell--disabled": __props.disabled, "up-cell__label--large": __props.size == "large" }]);
      ...
      _createSharedDataSlot("value", null, null, () => {
        _createSharedDataIf(() => {
          ...
          _renderSharedDataEffect(() => {
            _setSharedDataClass(__sharedData, 3, ["weapp-tw-border up-cell__value", { "up-cell--disabled": __props.disabled, "up-cell__value--large": __props.size == "large" }]);
      ...
      _createSharedDataIf(() => {
        ...
        _renderSharedDataEffect(() => {
          return _setSharedDataClass(__sharedData, 8, ["weapp-tw-border up-cell__right-icon-wrap", [`up-cell__right-icon-wrap--${__props.arrowDirection}`]]);
        });
        _createSharedDataSlot("right-icon", null, null, () => {
          _createSharedDataIf(() => {
            return _setSharedData(__sharedData, 6, _toSharedDataBoolean(__props.rightIcon != ""));
          }, () => {
            const n31 = _createSharedDataComponentWithFallback(_component_up_icon, "6aceb3a2", {
              name: () => {
      ...
      _createSharedDataIf(() => {
        ...
        _renderSharedDataEffect(() => {
          return _setSharedDataClass(__sharedData, 10, ["weapp-tw-border up-cell__right-icon-wrap", [`up-cell__right-icon-wrap--${__props.arrowDirection}`]]);
        });
      ...
      _createSharedDataIf(() => {
        ...
        const n40 = _createSharedDataComponentWithFallback(_component_up_line, "6acdf728");
