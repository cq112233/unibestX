import { m as error, s as sleep, u as upGetRect } from "../../libs/function/index.js";
...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props, _a) {
    ...
    const setId = function(idPam) {
      uni.__f__("log", "at uni_modules/uview-ultra/components/up-index-item/up-index-item.uvue:78", idPam);
      itemId.value = idPam;
    };
    ...
    return () => {
      ...
      _renderSharedDataEffect(() => {
        ...
        _setSharedDataClass(__sharedData, 0, ["weapp-tw-border up-index-item", ["up-index-item-" + _itemId]]);
