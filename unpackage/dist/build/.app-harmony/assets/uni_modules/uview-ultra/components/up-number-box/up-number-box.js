    ...
    return () => {
      ...
      _createSharedDataIf(() => {
        ...
        return _createSharedDataIf(() => {
          ...
          _renderSharedDataEffect(() => {
            _setSharedDataClass(__sharedData, 9, ["weapp-tw-border up-number-box__minus wtu-1pb5hvl-0", { "up-number-box__minus--disabled": isDisabled("minus") }]);
            _setSharedDataStyle(__sharedData, 10, buttonStyle("minus"));
          });
          const n5 = _createSharedDataComponentWithFallback(_component_up_icon, "74daa457", {
            name: "minus",
            color: () => {
      ...
      _createSharedDataIf(() => {
        ...
        _createSharedDataSlot("input", null, null, () => {
          const n11 = _createSharedDataComponentWithFallback(_component_input, "26771182", {
            disabled: () => {
      ...
      _createSharedDataIf(() => {
        ...
        return _createSharedDataIf(() => {
          ...
          _renderSharedDataEffect(() => {
            _setSharedDataClass(__sharedData, 22, ["weapp-tw-border up-number-box__plus wtu-1pb5hvl-0", { "up-number-box__minus--disabled": isDisabled("plus") }]);
            _setSharedDataStyle(__sharedData, 23, buttonStyle("plus"));
          });
          const n17 = _createSharedDataComponentWithFallback(_component_up_icon, "2677869e", {
            name: "plus",
            color: () => {
