      ...
      const n5 = _createSharedDataComponentWithFallback(
        ...
        },
        {
          "default": _withSharedDataVaporCtx(() => {
            const n0 = _createSharedDataComponentWithFallback(_component_up_icon, "36c67f1a", {
              name: () => {
            ...
            const n2 = _createSharedDataComponentWithFallback(_component_up_button, "36c66954", {
              size: "mini",
              text: () => {
