    ...
    return () => {
      ...
      _createSharedDataIf(() => {
        ...
        _renderSharedDataEffect(() => {
          _setSharedDataClass(__sharedData, 10, ["weapp-tw-border up-loading-icon", [__props.vertical ? "up-loading-icon--vertical" : ""]]);
        ...
        _createSharedDataIf(() => {
          ...
          _renderSharedDataEffect(() => {
            _setSharedDataClass(__sharedData, 5, ["weapp-tw-border up-loading-icon__spinner", [`up-loading-icon__spinner--${__props.mode}`]]);
          ...
          _createSharedDataIf(() => {
            ...
            _createSharedDataFor(_setSharedDataScoped(__sharedData, 3, _createSharedDataVFor(__sharedDataScope, () => {
              ...
              _renderSharedDataEffect(() => {
                _setSharedDataStyle(__sharedData_VFor0, 1, getSpinnerDotStyle(_for_key0.value));
                _setSharedDataStyle(__sharedData_VFor0, 2, dotBarStyle.value);
              });
              return null;
          ...
          _setSharedDataTemplateRef(__sharedData, 4, (n10) => {
            _setTemplateRef(n10, "ani");
          });
        });
        _createSharedDataIf(() => {
