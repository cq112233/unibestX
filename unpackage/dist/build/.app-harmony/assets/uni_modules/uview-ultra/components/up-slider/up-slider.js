  ...
  setup(__props, _a) {
    ...
    return () => {
      ...
      _createSharedDataIf(() => {
        ...
        _renderSharedDataEffect(() => {
          _setSharedDataClass(__sharedData, 33, ["weapp-tw-border up-slider-inner", [__props.disabled ? "up-slider--disabled" : ""]]);
        ...
        const n35 = _createSharedDataComponentWithFallback(_component_slider, "8cda2530", {
