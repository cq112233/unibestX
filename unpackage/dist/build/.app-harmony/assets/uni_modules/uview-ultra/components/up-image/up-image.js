    ...
    return () => {
      ...
      _createSharedDataIf(() => {
        ...
        _createSharedDataSlot("loading", null, null, () => {
          const n5 = _createSharedDataComponentWithFallback(_component_up_icon, "35b88817", {
            name: () => {
      ...
      _createSharedDataIf(() => {
        ...
        _createSharedDataSlot("error", null, null, () => {
          const n11 = _createSharedDataComponentWithFallback(_component_up_icon, "35b892df", {
            name: () => {
