  ...
  setup(__props) {
    ...
    return () => {
      ...
      _renderSharedDataEffect(() => {
        _setSharedDataClass(__sharedData, 2, ["weapp-tw-border up-td", [__props.customClass]]);
...
const _style_0 = {"flex":{"":{"display":"flex"}},"border":{"":{"borderStyle":"var(--tw-border-style)","borderWidth":1}}};
const _style_1 = {};
