  ...
  setup(__props, _a) {
    ...
    return () => {
      ...
      _renderSharedDataEffect(() => {
        _setSharedDataClass(__sharedData, 7, ["weapp-tw-border up-checkbox wtu-1s7f97t-0", [iconPlacementClass.value, borderBottomClass.value]]);
        _setSharedDataStyle(__sharedData, 8, [checkboxStyle.value]);
        _setSharedDataClass(__sharedData, 9, ["weapp-tw-border up-checkbox__icon-wrap wtu-1s7f97t-0", iconClasses.value]);
        _setSharedDataStyle(__sharedData, 10, [iconWrapStyle.value]);
      });
      _createSharedDataSlot("icon", null, null, () => {
        const n2 = _createSharedDataComponentWithFallback(_component_up_icon, "2bb6446a", {
