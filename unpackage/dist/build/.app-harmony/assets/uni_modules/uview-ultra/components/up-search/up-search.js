  ...
  setup(__props, _a) {
    ...
    return () => {
      ...
      _renderSharedDataEffect(() => {
        _setSharedDataClass(__sharedData, 9, ["weapp-tw-border up-search", [__props.iconPosition == "right" ? "up-search__reverse" : ""]]);
      ...
      const n5 = _createSharedDataComponentWithFallback(_component_up_icon, "ef0530ba", {
        onClick: () => {
          return clickIcon;
        },
        size: () => {
      ...
      const n7 = _createSharedDataComponentWithFallback(_component_input, "ef052716", {
        "confirm-type": "search",
        onBlur: () => {
          return blurFunc;
        },
      ...
      _createSharedDataIf(() => {
        ...
        const n10 = _createSharedDataComponentWithFallback(_component_up_icon, "f1a46d3e", {
          name: "close",
          size: "11",
          color: "#ffffff",
      ...
      _renderSharedDataEffect(() => {
        ...
        _setSharedDataClass(__sharedData, 13, ["weapp-tw-border up-search__action", [showActionBtn.value || show.value ? "up-search__action--active" : ""]]);
