  ...
  setup(__props, _a) {
    ...
    return () => {
      ...
      _renderSharedDataEffect(() => {
        ...
        _setSharedDataClass(__sharedData, 8, ["weapp-tw-border up-tabbar-item", [_isMidButton ? "up-tabbar-item--mid-button" : ""]]);
        _setSharedDataStyle(__sharedData, 9, customTabbarItemStyle.value);
        _setSharedDataClass(__sharedData, 10, ["weapp-tw-border up-tabbar-item__icon", [_isMidButton ? "up-tabbar-item__icon--mid-button" : ""]]);
      });
      _createSharedDataIf(() => {
      ...
      _createSharedDataIf(() => {
        ...
        const n5 = _createSharedDataComponentWithFallback(_component_up_icon, "ff2f6498", {
          name: () => {
            return __props.icon;
          },
          color: () => {
      ...
      const n13 = _createSharedDataComponentWithFallback(_component_up_badge, "ff2f4d5a", {
        absolute: "",
        offset: () => {
