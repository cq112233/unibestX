...
import { j as deepClone, k as getProperty, l as setProperty, t as toast } from "../../libs/function/index.js";
  ...
  setup(__props, _a) {
    ...
    function resetModel(obj = null) {
      children.value.map((child) => {
        ...
        try {
          ...
          uni.__f__("error", "at uni_modules/uview-ultra/components/up-form/up-form.uvue:120", "resetModel error", e);
        }
      });
    }
    ...
    function validateField(value, callback = null, event = null) {
      return new Promise((resolve, reject) => {
          ...
          return new Promise((resolveChild) => {
            ...
            if (validateProps.includes(childProps["prop"].toString())) {
              ...
              if (rule == null || rule.length == 0) {
                uni.__f__("log", "at uni_modules/uview-ultra/components/up-form/up-form.uvue:196", "rule-miss", childProps["prop"].toString(), UTSJSONObject.keys(formRules.value));
                resolveChild([]);
                return null;
              }
              let rules = [];
              ...
              for (let i = 0; i < rules.length; i++) {
                ...
                uni.__f__("log", "at uni_modules/uview-ultra/components/up-form/up-form.uvue:293", "rule-debug", childProps["prop"].toString(), UTS.JSON.stringify(normalizedRule), propertyVal);
                try {
                  ...
                  const validateRet = validator_1.validate(new UTSJSONObject({
                    ...
                    uni.__f__("log", "at uni_modules/uview-ultra/components/up-form/up-form.uvue:316", "rule-errors", childProps["prop"].toString(), errors);
                    finishRule(errors);
                  });
        ...
        Promise.all(promises).then((results = null) => {
          uni.__f__("log", "at uni_modules/uview-ultra/components/up-form/up-form.uvue:357", "errors", errorsRes.length);
          if (callback != null) {
            callback(errorsRes);
          }
          resolve(errorsRes);
    ...
    const validate = () => {
      return new Promise((resolve, reject) => {
        ...
        uni.__f__("log", "at uni_modules/uview-ultra/components/up-form/up-form.uvue:390", "formItemProps", formItemProps);
        let func = function(errors) {
          if (errors.length > 0) {
            if (props.errorType == "toast" && errors[0] != null)
              toast(errors[0]["message"].toString());
            uni.__f__("log", "at uni_modules/uview-ultra/components/up-form/up-form.uvue:395", "errors", errors.length);
            reject(errors);
          } else {
            resolve(true);
          }
...
const _style_0 = {};
const __easycom_12 = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0]]]);
export {
  __easycom_12 as _
};
