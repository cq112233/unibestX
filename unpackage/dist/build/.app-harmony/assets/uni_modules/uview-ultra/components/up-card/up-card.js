  ...
  setup(__props, _a) {
    ...
    return () => {
      ...
      _renderSharedDataEffect(() => {
        _setSharedDataClass(__sharedData, 20, ["weapp-tw-border up-card", {
      ...
      _createSharedDataIf(() => {
        ...
        _renderSharedDataEffect(() => {
          _setSharedDataClass(__sharedData, 12, ["weapp-tw-border up-card__head", {
      ...
      _createSharedDataIf(() => {
        ...
        _renderSharedDataEffect(() => {
          _setSharedDataClass(__sharedData, 16, ["weapp-tw-border up-card__foot", {
...
const _style_0 = {"up-border":{"":{"borderWidth":0.5,"borderColor":"#dadbde","borderStyle":"solid"}},"up-border-bottom":{"":{"borderBottomWidth":0.5,"borderColor":"#dadbde","borderBottomStyle":"solid"}},"up-border-top":{"":{"borderTopWidth":0.5,"borderColor":"#dadbde","borderTopStyle":"solid"}}};
const _style_1 = {};
