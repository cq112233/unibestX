...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props, _a) {
    ...
    return () => {
      "raw js";
      _renderSharedDataEffect(() => {
        return _setSharedDataClass(__sharedData, 12, ["weapp-tw-border up-icon", ["up-icon--" + __props.labelPos]]);
      });
      _createSharedDataIf(() => {
        ...
        _renderSharedDataEffect(() => {
          _setSharedDataClass(__sharedData, 4, ["weapp-tw-border up-icon__icon", uClasses.value]);
...
const _style_0 = {};
const _style_1 = {"@FONT-FACE":[{"src":"url(\"/assets/iconfont.4bc8cc97.ttf\")","fontFamily":"iconfont"}]};
