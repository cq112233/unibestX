...
import { a as addUnit, f as range, p as padZero } from "../../libs/function/index.js";
      ...
      const n15 = _createSharedDataComponentWithFallback(
        ...
        },
        {
          "default": _withSharedDataVaporCtx(() => {
            const n0 = _createSharedDataComponent(uHeader, "4e242fa0", {
              title: () => {
            ...
            _createSharedDataIf(() => {
              ...
              const n3 = _createSharedDataComponent(uMonth, "4e244a2c", {
                color: () => {
            ...
            _createSharedDataIf(() => {
              ...
              _createSharedDataSlot("footer", null, null, () => {
                const n12 = _createSharedDataComponentWithFallback(_component_up_button, "7661c856", {
                  shape: "circle",
                  text: () => {
...
const _style_0 = {};
const _style_1 = {};
const __easycom_14 = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0, _style_1]]]);
export {
  __easycom_14 as _
};
