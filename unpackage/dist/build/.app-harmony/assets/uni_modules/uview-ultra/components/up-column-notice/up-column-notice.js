    ...
    return () => {
      ...
      _createSharedDataSlot("icon", null, null, () => {
        _createSharedDataIf(() => {
          ...
          const n4 = _createSharedDataComponentWithFallback(_component_up_icon, "17ccbcfe", {
            name: () => {
              return __props.icon;
            },
            color: () => {
      ...
      const n10 = _createSharedDataComponentWithFallback(_component_swiper, "17ccc0c0", {
        "disable-touch": () => {
        ...
        "default": _withSharedDataVaporCtx(() => {
          _createSharedDataFor(_setSharedDataScoped(__sharedData, 3, _createSharedDataVFor(__sharedDataScope, () => {
            ...
            const n9 = _createSharedDataComponentWithFallback(_component_swiper_item, "17ccc827-" + _for_key0.value, { class: "up-notice__swiper__item" }, {
              "default": () => {
      ...
      _createSharedDataIf(() => {
        ...
        _createSharedDataIf(() => {
          ...
          const n15 = _createSharedDataComponentWithFallback(_component_up_icon, "17ccd6e6", {
            name: "arrow-right",
            size: 17,
            color: () => {
              return __props.color;
        ...
        _createSharedDataIf(() => {
          ...
          const n18 = _createSharedDataComponentWithFallback(_component_up_icon, "17ccdac7", {
            name: "close",
            size: 16,
            color: () => {
              return __props.color;
