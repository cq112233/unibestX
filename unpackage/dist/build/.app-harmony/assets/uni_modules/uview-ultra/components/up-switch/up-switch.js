  ...
  setup(__props, _a) {
    ...
    return () => {
      ...
      _renderSharedDataEffect(() => {
        _setSharedDataClass(__sharedData, 6, ["weapp-tw-border", switchClass.value]);
      ...
      _renderSharedDataEffect(() => {
        _setSharedDataClass(__sharedData, 8, ["weapp-tw-border up-switch__node", [__props.modelValue == __props.activeValue ? "up-switch__node--on" : ""]]);
        _setSharedDataStyle(__sharedData, 9, nodeStyle.value);
      });
      const n6 = _createSharedDataComponentWithFallback(_component_up_loading_icon, "0a5a700f", {
        show: () => {
