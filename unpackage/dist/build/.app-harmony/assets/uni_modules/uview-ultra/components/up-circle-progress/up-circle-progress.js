  ...
  setup(__props) {
    ...
    return () => {
      ...
      _createSharedDataIf(() => {
        ...
        _renderSharedDataEffect(() => {
          _setSharedDataClass(__sharedData, 1, ["weapp-tw-border up-circle-progress__fill up-circle-progress__fill--right", [isDefaultColor.value ? "up-circle-progress__fill--primary" : ""]]);
      ...
      _createSharedDataIf(() => {
        ...
        _renderSharedDataEffect(() => {
          _setSharedDataClass(__sharedData, 4, ["weapp-tw-border up-circle-progress__fill up-circle-progress__fill--left", [isDefaultColor.value ? "up-circle-progress__fill--primary" : ""]]);
          _setSharedDataStyle(__sharedData, 5, leftStyle.value);
        });
      });
      _createSharedDataSlot("default", null, null, () => {
        _renderSharedDataEffect(() => {
          _setSharedDataClass(__sharedData, 6, ["weapp-tw-border up-circle-progress__text", [isDefaultColor.value ? "up-circle-progress__text--primary" : ""]]);
