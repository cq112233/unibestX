import { _ as __easycom_0 } from "../up-steps-item/up-steps-item.js";
import { _ as __easycom_1 } from "../up-steps/up-steps.js";
import { _ as __easycom_0$1 } from "../up-tabs/up-tabs.js";
import { _ as __easycom_0$2 } from "../up-icon/up-icon.js";
import { _ as __easycom_1$1 } from "../up-cell/up-cell.js";
import { _ as __easycom_2$1 } from "../up-cell-group/up-cell-group.js";
import { _ as __easycom_1$2 } from "../up-button/up-button.js";
import { _ as __easycom_1$3 } from "../up-popup/up-popup.js";
...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props, _a) {
    ...
    const cancelText = computed(() => {
      return t("up.common.cancel", new UTSJSONObject({}));
    });
    const confirmText = computed(() => {
      return t("up.common.confirm", new UTSJSONObject({}));
    });
    const placeholderText = computed(() => {
      return t("up.common.pleaseChoose", new UTSJSONObject({}));
    });
    ...
    return () => {
      ...
      const _component_up_tabs = __easycom_0$1;
      const _component_up_icon = __easycom_0$2;
      const _component_up_cell = __easycom_1$1;
      const _component_up_cell_group = __easycom_2$1;
      const _component_up_button = __easycom_1$2;
      const _component_up_popup = __easycom_1$3;
          ...
          "default": _withSharedDataVaporCtx(() => {
            _createSharedDataIf(() => {
              ...
              _createSharedDataIf(() => {
                ...
                const n7 = _createSharedDataComponentWithFallback(_component_up_steps, "4e0ec5a8", {
                  dot: "",
                  direction: "column",
                  current: () => {
                  ...
                  "default": _withSharedDataVaporCtx(() => {
                    _createSharedDataFor(_setSharedDataScoped(__sharedData, 4, _createSharedDataVFor(__sharedDataScope, () => {
                      ...
                      const n6 = _createSharedDataComponentWithFallback(_component_up_steps_item, "4e0ec3c0-" + _for_key0.value, {
                        index: () => {
              ...
              _createSharedDataIf(() => {
                ...
                const n12 = _createSharedDataComponentWithFallback(_component_up_tabs, "4e0ead74", {
                  list: () => {
                    return genTabsList.value;
                  },
                  scrollable: true,
            ...
            _renderSharedDataEffect(() => {
              _setSharedDataClass(__sharedData, 11, ["weapp-tw-border area-box__levels", { "change": isChange.value }]);
            ...
            _createSharedDataFor(_setSharedDataScoped(__sharedData, 7, _createSharedDataVFor(__sharedDataScope, () => {
              ...
              _createSharedDataIf(() => {
                ...
                _createSharedDataIf(() => {
                  ...
                  const n28 = _createSharedDataComponentWithFallback(_component_up_cell_group, "461a26ce-" + _for_key1.value, null, {
                    "default": _withSharedDataVaporCtx(() => {
                      _createSharedDataFor(_setSharedDataScoped(__sharedData_VFor1, 4, _createSharedDataVFor(__sharedDataScope, () => {
                        ...
                        const n27 = _createSharedDataComponentWithFallback(_component_up_cell, "461a29fb-" + _for_key2.value, {
                          title: () => {
                          ...
                          "right-icon": _withSharedDataVaporCtx(() => {
                            _createSharedDataIf(() => {
                              ...
                              const n25 = _createSharedDataComponentWithFallback(_component_up_icon, "461a31bb-" + _for_key2.value, {
                                size: "17",
                                name: "checkbox-mark"
                              });
            ...
            const n35 = _createSharedDataComponentWithFallback(_component_up_button, "461a8fac", {
              onClick: () => {
                return handleCancel;
              },
              type: "default",
            ...
            const n37 = _createSharedDataComponentWithFallback(_component_up_button, "461a9ad6", {
              onClick: () => {
...
const _style_0 = {};
const _style_1 = {};
const __easycom_2 = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0, _style_1]]]);
export {
  __easycom_2 as _
};
