...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props, _a) {
    ...
    return () => {
      ...
      _renderSharedDataEffect(() => {
        return _setSharedDataClass(__sharedData, 18, ["weapp-tw-border up-navbar", [__props.customClass]]);
      });
      _createSharedDataIf(() => {
      ...
      _renderSharedDataEffect(() => {
        return _setSharedDataClass(__sharedData, 19, ["weapp-tw-border", [__props.fixed ? "up-navbar--fixed" : ""]]);
      });
      _createSharedDataIf(() => {
        return _setSharedData(__sharedData, 2, _toSharedDataBoolean(__props.safeAreaInsetTop));
      }, () => {
        const n5 = _createSharedDataComponentWithFallback(_component_up_status_bar, "05520bf8", { bgColor: () => {
          return __props.bgColor;
        } });
        _setSharedData(__sharedData, 3, n5?.sharedData);
      });
      _renderSharedDataEffect(() => {
        _setSharedDataClass(__sharedData, 20, ["weapp-tw-border up-navbar__content", [__props.border ? "up-border-bottom" : ""]]);
      ...
      _createSharedDataSlot("left", null, null, () => {
        _createSharedDataIf(() => {
          ...
          const n10 = _createSharedDataComponentWithFallback(_component_up_icon, "0551ed6e", {
            name: () => {
      ...
      _createSharedDataIf(() => {
        ...
        _createSharedDataSlot("right", null, null, () => {
          _createSharedDataIf(() => {
            ...
            const n24 = _createSharedDataComponentWithFallback(_component_up_icon, "a4f07834", {
              name: () => {
