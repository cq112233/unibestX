...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props, _a) {
    ...
    const onInput = (e) => {
      ...
      uni.__f__("log", "at uni_modules/uview-ultra/components/up-input/up-input.uvue:410", "onInput", value, innerValue.value);
    ...
    return () => {
      ...
      _renderSharedDataEffect(() => {
        _setSharedDataClass(__sharedData, 10, ["weapp-tw-border up-input", inputClass.value]);
      ...
      _createSharedDataIf(() => {
        ...
        _createSharedDataSlot("prefix", null, null, () => {
          const n4 = _createSharedDataComponentWithFallback(_component_up_icon, "3788ac2c", {
            name: () => {
      ...
      const n6 = _createSharedDataComponentWithFallback(_component_input, "3788871c", {
      ...
      _createSharedDataIf(() => {
        ...
        const n10 = _createSharedDataComponentWithFallback(_component_up_icon, "b98de6c0", {
          name: "close",
          size: "11",
          color: "#ffffff",
      ...
      _createSharedDataIf(() => {
        ...
        _createSharedDataSlot("suffix", null, null, () => {
          const n16 = _createSharedDataComponentWithFallback(_component_up_icon, "b98dc7f2", {
            name: () => {
