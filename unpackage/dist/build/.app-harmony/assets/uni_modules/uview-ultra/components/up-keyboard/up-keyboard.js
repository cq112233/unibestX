import { _ as __easycom_0$1 } from "../up-number-keyboard/up-number-keyboard.js";
import { _ as __easycom_1 } from "../up-car-keyboard/up-car-keyboard.js";
...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props, _a) {
    ...
    return () => {
      "raw js";
      const _component_up_number_keyboard = __easycom_0$1;
      const _component_up_car_keyboard = __easycom_1;
        ...
        },
        {
          "default": _withSharedDataVaporCtx(() => {
            ...
            _createSharedDataIf(() => {
              ...
              const n18 = _createSharedDataComponentWithFallback(_component_up_number_keyboard, "61ccda57", {
                random: () => {
              ...
              const n20 = _createSharedDataComponentWithFallback(_component_up_car_keyboard, "61cce4a7", {
                random: () => {
                  return __props.random;
                },
                autoChange: () => {
