    ...
    return () => {
      ...
      _createSharedDataFor(_setSharedDataScoped(__sharedData, 0, _createSharedDataVFor(__sharedDataScope, () => {
        ...
        _renderSharedDataEffect(() => {
          ...
          _setSharedDataClass(__sharedData_VFor0, 9, ["weapp-tw-border up-tree-node", getNodeClass(_item)]);
          _setSharedDataClass(__sharedData_VFor0, 10, ["weapp-tw-border up-tree-node__content", getNodeContentClass(_item)]);
        ...
        _createSharedDataIf(() => {
          ...
          const n4 = _createSharedDataComponentWithFallback(_component_up_icon, "a31d286a-" + getItemKey(_for_item0.value), {
            name: () => {
        ...
        _createSharedDataIf(() => {
          ...
          const n8 = _createSharedDataComponentWithFallback(_component_up_checkbox, "a31d18e2-" + getItemKey(_for_item0.value), {
