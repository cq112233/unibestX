    ...
    return () => {
      ...
      _createSharedDataIf(() => {
        ...
        _renderSharedDataEffect(() => {
          _setSharedDataClass(__sharedData, 1, ["weapp-tw-border up-swiper-indicator__wrapper", [`up-swiper-indicator__wrapper--${__props.indicatorMode}`]]);
      ...
      _createSharedDataIf(() => {
        ...
        _createSharedDataFor(_setSharedDataScoped(__sharedData, 5, _createSharedDataVFor(__sharedDataScope, () => {
          ...
          _renderSharedDataEffect(() => {
            ...
            _setSharedDataClass(__sharedData_VFor0, 1, ["weapp-tw-border up-swiper-indicator__wrapper__dot", [_index === parseInt(__props.current.toString()) ? "up-swiper-indicator__wrapper__dot--active" : ""]]);
