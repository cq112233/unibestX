    ...
    return () => {
      ...
      _createSharedDataIf(() => {
        ...
        _renderSharedDataEffect(() => {
          _setSharedDataClass(__sharedData, 13, ["weapp-tw-border up-pagination-btn", { "btn-disabled": __props.currentPage <= 1 }]);
        ...
        _createSharedDataIf(() => {
          ...
          const n6 = _createSharedDataComponentWithFallback(_component_up_icon, "0c80e576", {
            name: "arrow-left",
            size: "14"
          });
        ...
        _createSharedDataIf(() => {
          ...
          _createSharedDataFor(_setSharedDataScoped(__sharedData, 2, _createSharedDataVFor(__sharedDataScope, () => {
            ...
            _renderSharedDataEffect(() => {
              ...
              _setSharedDataClass(__sharedData_VFor0, 2, ["weapp-tw-border up-pagination-item", { "item-active": _page == currentPageStr.value }]);
              _setSharedDataClass(__sharedData_VFor0, 3, ["weapp-tw-border up-pagination-text", { "text-active": _page == currentPageStr.value }]);
        ...
        _renderSharedDataEffect(() => {
          _setSharedDataClass(__sharedData, 15, ["weapp-tw-border up-pagination-btn", { "btn-disabled": __props.currentPage >= totalPages.value }]);
        ...
        _createSharedDataIf(() => {
          ...
          const n22 = _createSharedDataComponentWithFallback(_component_up_icon, "3e30ccf8", {
            name: "arrow-right",
            size: "14"
          });
