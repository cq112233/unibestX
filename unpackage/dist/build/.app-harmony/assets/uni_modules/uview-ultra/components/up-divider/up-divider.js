...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props, _a) {
    ...
    return () => {
      ...
      const n0 = _createSharedDataComponentWithFallback(_component_up_line, "18ad0d98", {
        color: () => {
      ...
      const n6 = _createSharedDataComponentWithFallback(_component_up_line, "18ad1954", {
        color: () => {
          return __props.lineColor;
        },
        customStyle: () => {
