...
import { a as addUnit, s as sleep, u as upGetRect, g as getPx } from "../../libs/function/index.js";
    ...
    return () => {
      ...
      _createSharedDataSlot("icon", null, null, () => {
        _createSharedDataIf(() => {
          ...
          const n4 = _createSharedDataComponentWithFallback(_component_up_icon, "47b79868", {
            name: () => {
              return __props.icon;
            },
            color: () => {
      ...
      _createSharedDataIf(() => {
        ...
        _createSharedDataIf(() => {
          ...
          const n15 = _createSharedDataComponentWithFallback(_component_up_icon, "47b76ba0", {
            name: "arrow-right",
            size: 17,
            color: () => {
              return __props.color;
        ...
        _createSharedDataIf(() => {
          ...
          const n18 = _createSharedDataComponentWithFallback(_component_up_icon, "47b763de", {
            onClick: () => {
              return close;
            },
            name: "close",
