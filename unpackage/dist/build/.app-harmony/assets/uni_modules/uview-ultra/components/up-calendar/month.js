    ...
    return () => {
      ...
      _createSharedDataFor(_setSharedDataScoped(__sharedData, 0, _createSharedDataVFor(__sharedDataScope, () => {
        ...
        _renderSharedDataEffect(() => {
          ...
          _setSharedDataClass(__sharedData_VFor0, 6, ["weapp-tw-border", [`up-calendar-month-` + _index.toString()]]);
        ...
        _createSharedDataFor(_setSharedDataScoped(__sharedData_VFor0, 5, _createSharedDataVFor(__sharedDataScope, () => {
          ...
          _renderSharedDataEffect(() => {
            ...
            _setSharedDataClass(__sharedData_VFor1, 10, ["weapp-tw-border up-calendar-month__days__day__select", {
          ...
          _renderSharedDataEffect(() => {
            const _item1 = _for_item1.value;
            _setSharedDataClass(__sharedData_VFor1, 12, ["weapp-tw-border up-calendar-month__days__day__select__info", {
          ...
          _createSharedDataIf(() => {
            ...
            _renderSharedDataEffect(() => {
              const _item1 = _for_item1.value;
              _setSharedDataClass(__sharedData_VFor1, 4, ["weapp-tw-border up-calendar-month__days__day__select__buttom-info", { "up-calendar-month__days__day__select__buttom-info--disabled": _item1["disabled"] }]);
...
const _style_1 = {};
const uMonth = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0, _style_1]]]);
export {
  uMonth as u
};
