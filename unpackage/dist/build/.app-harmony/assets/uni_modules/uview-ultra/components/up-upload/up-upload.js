...
import { _ as __easycom_0$2 } from "../up-loading-icon/up-loading-icon.js";
import { _ as __easycom_2 } from "../up-gap/up-gap.js";
import { _ as __easycom_1 } from "../up-popup/up-popup.js";
...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props, _a) {
    ...
    function getOtherItemText(item) {
      ...
      if (isVid) {
        if (item.name != null && item.name != "")
          return item.name;
        return t("up.common.video", new UTSJSONObject({}));
      }
      if (item.name != null && item.name != "")
        return item.name;
      return t("up.common.file", new UTSJSONObject({}));
    }
    ...
    return () => {
      ...
      const _component_up_loading_icon = __easycom_0$2;
      const _component_up_gap = __easycom_2;
      const _component_video = _resolveComponent("video");
      const _component_up_popup = __easycom_1;
        ...
        _createSharedDataFor(_setSharedDataScoped(__sharedData, 4, _createSharedDataVFor(__sharedDataScope, () => {
          ...
          _createSharedDataIf(() => {
            ...
            return _createSharedDataIf(() => {
              ...
              _createSharedDataIf(() => {
                ...
                const n12 = _createSharedDataComponentWithFallback(_component_up_icon, "e8625b6e-" + _for_key0.value, {
                  color: "#80CBF9",
                  size: "26",
                  name: () => {
              ...
              _createSharedDataIf(() => {
                ...
                _createSharedDataIf(() => {
                  ...
                  const n18 = _createSharedDataComponentWithFallback(_component_up_icon, "e8623e1a-" + _for_key0.value, {
              ...
              const n22 = _createSharedDataComponentWithFallback(_component_up_icon, "e862266c-" + _for_key0.value, {
                color: "#80CBF9",
                size: "26",
                name: () => {
          ...
          _createSharedDataIf(() => {
            ...
            _createSharedDataIf(() => {
              ...
              const n29 = _createSharedDataComponentWithFallback(_component_up_icon, "e86162ec-" + _for_key0.value, {
                name: "close-circle",
                color: "#ffffff",
                size: "25"
              });
              ...
              const n31 = _createSharedDataComponentWithFallback(_component_up_loading_icon, "e8615524-" + _for_key0.value, {
                size: "22",
                mode: "circle"
              });
            ...
            const n36 = _createSharedDataComponentWithFallback(_component_up_gap, "e8614436-" + _for_key0.value, {
          ...
          _createSharedDataIf(() => {
            ...
            const n40 = _createSharedDataComponentWithFallback(_component_up_icon, "e8608940-" + _for_key0.value, {
              name: "close",
              color: "#ffffff",
              size: "10"
            });
          ...
          _createSharedDataSlot("success", null, null, () => {
            _createSharedDataIf(() => {
              ...
              const n47 = _createSharedDataComponentWithFallback(_component_up_icon, "e86071f8-" + _for_key0.value, {
                name: "checkmark",
                color: "#ffffff",
                size: "12"
              });
        ...
        _createSharedDataIf(() => {
          ...
          return _createSharedDataIf(() => {
            ...
            _renderSharedDataEffect(() => {
              ...
              _setSharedDataClass(__sharedData, 14, ["weapp-tw-border up-upload__button", [_disabled ? "up-upload__button--disabled" : ""]]);
            ...
            const n62 = _createSharedDataComponentWithFallback(_component_up_icon, "e85f91bc", {
              name: () => {
      ...
      const n72 = _createSharedDataComponentWithFallback(_component_up_popup, "e85f7be2", {
        mode: "center",
        show: () => {
        ...
        "default": _withSharedDataVaporCtx(() => {
          _createSharedDataIf(() => {
            ...
            const n71 = _createSharedDataComponentWithFallback(_component_video, "e85f7a70", {
              id: "myVideo",
              src: () => {
