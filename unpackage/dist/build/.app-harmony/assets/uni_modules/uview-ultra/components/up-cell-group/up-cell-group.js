  ...
  setup(__props) {
    ...
    return () => {
      ...
      _renderSharedDataEffect(() => {
        ...
        _setSharedDataClass(__sharedData, 5, [[__props.customClass], "weapp-tw-border up-cell-group"]);
      });
      _createSharedDataIf(() => {
      ...
      _createSharedDataIf(() => {
        ...
        const n8 = _createSharedDataComponentWithFallback(_component_up_line, "66bb7aac");
