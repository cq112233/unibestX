  ...
  setup(__props, _a) {
    ...
    return () => {
      ...
      _createSharedDataIf(() => {
        ...
        const n2 = _createSharedDataComponentWithFallback(_component_up_line, "7f25254f", {
          length: "140rpx",
          color: () => {
      ...
      _renderSharedDataEffect(() => {
        ...
        _setSharedDataClass(__sharedData, 8, [_status == "loadmore" || _status == "nomore" ? "up-more" : "", "weapp-tw-border up-loadmore__content"]);
      });
      _createSharedDataIf(() => {
        return _setSharedData(__sharedData, 4, _toSharedDataBoolean(__props.status == "loading" && __props.icon));
      }, () => {
        const n5 = _createSharedDataComponentWithFallback(_component_up_loading_icon, "657f765a", {
          color: () => {
      ...
      _renderSharedDataEffect(() => {
        _setSharedDataClass(__sharedData, 9, ["weapp-tw-border up-line-11", [__props.status == "nomore" && __props.isDot == true ? "up-loadmore__content__dot-text" : "up-loadmore__content__text"]]);
      ...
      _createSharedDataIf(() => {
        ...
        const n11 = _createSharedDataComponentWithFallback(_component_up_line, "657f8545", {
          length: "140rpx",
          color: () => {
            return __props.lineColor;
          },
