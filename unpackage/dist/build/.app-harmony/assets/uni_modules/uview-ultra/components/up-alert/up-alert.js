        ...
        },
        {
          "default": _withSharedDataVaporCtx(() => {
            _renderSharedDataEffect(() => {
              _setSharedDataClass(__sharedData, 15, ["weapp-tw-border up-alert", [`up-alert--${__props.type}--${__props.effect}`]]);
            ...
            _createSharedDataIf(() => {
              ...
              const n2 = _createSharedDataComponentWithFallback(_component_up_icon, "320783e0", {
                name: () => {
            ...
            _createSharedDataIf(() => {
              ...
              _renderSharedDataEffect(() => {
                _setSharedDataClass(__sharedData, 7, ["weapp-tw-border up-alert__content__title", [__props.effect === "dark" ? "up-alert__text--dark" : `up-alert__text--${__props.type}--light`]]);
            ...
            _createSharedDataIf(() => {
              ...
              _renderSharedDataEffect(() => {
                _setSharedDataClass(__sharedData, 11, ["weapp-tw-border up-alert__content__desc", [__props.effect === "dark" ? "up-alert__text--dark" : `up-alert__text--${__props.type}--light`]]);
            ...
            _createSharedDataIf(() => {
              ...
              const n13 = _createSharedDataComponentWithFallback(_component_up_icon, "0eea1dba", {
                name: "close",
                color: () => {
                  return iconColor.value;
                },
