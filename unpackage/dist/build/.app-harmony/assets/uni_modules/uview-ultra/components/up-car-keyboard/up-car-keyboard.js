      ...
      _createSharedDataFor(_setSharedDataScoped(__sharedData, 0, _createSharedDataVFor(__sharedDataScope, () => {
        ...
        _createSharedDataIf(() => {
          ...
          _renderSharedDataEffect(() => {
            ...
            _setSharedDataClass(__sharedData_VFor0, 3, ["weapp-tw-border up-keyboard__button__inner-wrapper__left__lang", [!_abc ? "up-keyboard__button__inner-wrapper__left__lang--active" : ""]]);
            _setSharedDataClass(__sharedData_VFor0, 4, ["weapp-tw-border up-keyboard__button__inner-wrapper__left__lang", [_abc ? "up-keyboard__button__inner-wrapper__left__lang--active" : ""]]);
          });
        });
        ...
        _createSharedDataIf(() => {
          ...
          const n16 = _createSharedDataComponentWithFallback(_component_up_icon, "bd3112f2-" + _for_key0.value, {
            size: "28",
            name: "backspace",
            color: "#303133"
          });
        ...
        _setSharedDataClass(__sharedData_VFor0, 10, ["weapp-tw-border up-keyboard__button", [_for_key0.value + 1 == 4 ? "up-keyboard__button--center" : ""]]);
        return null;
