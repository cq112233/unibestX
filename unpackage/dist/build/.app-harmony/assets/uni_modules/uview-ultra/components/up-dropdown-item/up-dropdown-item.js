    ...
    return () => {
      ...
      _createSharedDataIf(() => {
        ...
        _createSharedDataIf(() => {
          ...
          const n12 = _createSharedDataComponentWithFallback(_component_up_cell_group, "ca585c98", null, {
            "default": _withSharedDataVaporCtx(() => {
              _createSharedDataFor(_setSharedDataScoped(__sharedData, 3, _createSharedDataVFor(__sharedDataScope, () => {
                ...
                const n11 = _createSharedDataComponentWithFallback(_component_up_cell, "ca585bee-" + _for_key0.value, {
                  onClick: () => {
                    return _on_click;
                  },
                  arrow: false
                  ...
                  "title": () => {
                    _renderSharedDataEffect(() => {
                      ...
                      _setSharedDataClass(__sharedData_VFor0, 2, ["weapp-tw-border up-dropdown-item__text", {
                  ...
                  "default": _withSharedDataVaporCtx(() => {
                    _createSharedDataIf(() => {
                      ...
                      const n10 = _createSharedDataComponentWithFallback(_component_up_icon, "ca5837d6-" + _for_key0.value, {
                        name: "checkbox-mark",
                        color: () => {
