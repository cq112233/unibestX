  ...
  setup(__props, _a) {
    ...
    const summaryData = computed(() => {
      ...
      if (typeof props.summaryMethod == "function" && props.summaryMethod != null) {
        const callback = props.summaryMethod;
        const result = callback(new UTSJSONObject({
          columns: cols,
          data: rows
        }));
    ...
    function getSummaryValue(index) {
    ...
    return () => {
      ...
      _renderSharedDataEffect(() => {
        _setSharedDataClass(__sharedData, 21, ["weapp-tw-border up-table2", __props.border ? "up-table-border" : ""]);
        _setSharedDataStyle(__sharedData, 22, getScrollStyle());
        _setSharedDataStyle(__sharedData, 23, getTableContentStyle());
      });
      _createSharedDataIf(() => {
        return _setSharedData(__sharedData, 10, _toSharedDataBoolean(__props.showHeader));
      }, () => {
        _createSharedDataFor(_setSharedDataScoped(__sharedData, 11, _createSharedDataVFor(__sharedDataScope, () => {
          ...
          _renderSharedDataEffect(() => {
            ...
            _setSharedDataClass(__sharedData_VFor0, 8, ["weapp-tw-border up-table-cell up-table-header-cell", [getHeaderAlignClass(_col)]]);
          ...
          _createSharedDataIf(() => {
            ...
            const n6 = _createSharedDataComponentWithFallback(_component_checkbox, "1311afdc-" + getColumnKey(_for_item0.value, _for_key0.value), {
              checked: () => {
      ...
      _createSharedDataIf(() => {
        return _setSharedData(__sharedData, 12, _toSharedDataBoolean(hasData.value));
      }, () => {
        _renderSharedDataEffect(() => {
          return _setSharedDataStyle(__sharedData, 14, getBodyStyle());
        });
        _createSharedDataFor(_setSharedDataScoped(__sharedData, 13, _createSharedDataVFor(__sharedDataScope, () => {
          ...
          _renderSharedDataEffect(() => {
            _setSharedDataClass(__sharedData_VFor1, 3, ["weapp-tw-border up-table-row up-table-body-row", getRowClass(_for_item1.value["row"], _for_key1.value)]);
          ...
          _createSharedDataFor(_setSharedDataScoped(__sharedData_VFor1, 1, _createSharedDataVFor(__sharedDataScope, () => {
            ...
            _renderSharedDataEffect(() => {
              ...
              _setSharedDataClass(__sharedData_VFor2, 9, ["weapp-tw-border up-table-cell up-table-body-cell", [getCellAlignClass(_cell_col), getCellClassName(_item_row, _cell_col), getCellSpanClass(_item_row, _cell_col, _safeToNumber(_item["rowIndex"]), _safeToNumber(_cell["colIndex"]))]]);
            ...
            _createSharedDataIf(() => {
              ...
              const n23 = _createSharedDataComponentWithFallback(_component_checkbox, "4f218a20-" + getColumnKey(_for_item2.value["col"], safeToNumber(_for_item2.value["colIndex"])), {
                checked: () => {
      ...
      _createSharedDataIf(() => {
        return _setSharedData(__sharedData, 15, _toSharedDataBoolean(__props.showSummary && hasData.value));
      }, () => {
        _renderSharedDataEffect(() => {
          return _setSharedDataStyle(__sharedData, 17, { height: rowHeightValue.value });
        });
        _createSharedDataFor(_setSharedDataScoped(__sharedData, 16, _createSharedDataVFor(__sharedDataScope, () => {
          ...
          _renderSharedDataEffect(() => {
            ...
            _setSharedDataClass(__sharedData_VFor3, 4, ["weapp-tw-border up-table-cell up-table-footer-cell", [getCellAlignClass(_col)]]);
            _setSharedDataStyle(__sharedData_VFor3, 5, getHeaderCellStyle(_col));
          });
          _createSharedDataSlot("summary-cell", {
            column: () => {
              return _for_item3.value;
            },
            columnIndex: () => {
              return _for_key3.value;
            },
            value: () => {
              return getSummaryValue(_for_key3.value);
            }
          }, (data) => {
            return _setSharedData(__sharedData_VFor3, 1, data);
          }, () => {
            _renderSharedDataEffect(() => {
              _setSharedDataStyle(__sharedData_VFor3, 2, { textAlign: getCellAlignValue(_for_item3.value) });
              _setSharedData(__sharedData_VFor3, 3, _toDisplayString(getSummaryValue(_for_key3.value)));
            });
          });
          return null;
        }, (__sharedData_VFor3, col, colIndex) => {
          return _setSharedData(__sharedData_VFor3, 0, _toDisplayString("sum_" + getColumnKey(col, colIndex)));
        }, 1);
      }, () => {
        return _createSharedDataIf(() => {
          return _setSharedData(__sharedData, 18, _toSharedDataBoolean(!hasData.value));
        }, () => {
          _createSharedDataSlot("empty", null, null, () => {
            _renderSharedDataEffect(() => {
              return _setSharedData(__sharedData, 19, _toDisplayString(__props.emptyText));
            });
          });
        });
      }, 1797);
      _setSharedDataEvent(__sharedData, 20, onScroll);
      _createSharedDataIf(() => {
        return _setSharedData(__sharedData, 0, _toSharedDataBoolean(showFixedShadow.value));
      }, () => {
        _renderSharedDataEffect(() => {
          return _setSharedDataStyle(__sharedData, 9, getFixedShadowStyle());
        });
        _createSharedDataIf(() => {
          ...
          _createSharedDataFor(_setSharedDataScoped(__sharedData, 2, _createSharedDataVFor(__sharedDataScope, () => {
            ...
            _renderSharedDataEffect(() => {
              const _col = _for_item4.value;
              _setSharedDataClass(__sharedData_VFor4, 8, ["weapp-tw-border up-table-cell up-table-header-cell", [getHeaderAlignClass(_col)]]);
              _setSharedDataStyle(__sharedData_VFor4, 9, getFixedHeaderCellStyle(_col));
            });
            _createSharedDataIf(() => {
              return _setSharedData(__sharedData_VFor4, 1, _toSharedDataBoolean(isSelectionColumn(_for_item4.value)));
            }, () => {
              const n60 = _createSharedDataComponentWithFallback(_component_checkbox, "4f230508-" + getColumnKey(_for_item4.value, _for_key4.value), {
                checked: () => {
                  return isAllSelected();
                },
                onClick: () => {
              ...
              _setSharedData(__sharedData_VFor4, 2, n60?.sharedData);
            }, () => {
              _renderSharedDataEffect(() => {
                const _col = _for_item4.value;
                _setSharedDataStyle(__sharedData_VFor4, 5, { textAlign: getHeaderAlignValue(_col) });
                _setSharedData(__sharedData_VFor4, 6, _toDisplayString(getColumnTitle(_col)));
              });
              _createSharedDataIf(() => {
                return _setSharedData(__sharedData_VFor4, 3, _toSharedDataBoolean(isSortableColumn(_for_item4.value)));
              }, () => {
                _renderSharedDataEffect(() => {
                  return _setSharedData(__sharedData_VFor4, 4, _toDisplayString(getSortIcon(_for_item4.value)));
                });
              });
            }, 2313);
            _setSharedDataEvent(__sharedData_VFor4, 7, () => {
              return handleHeaderClick(_for_item4.value);
            });
            return null;
          }, (__sharedData_VFor4, col, fixedIndex) => {
            return _setSharedData(__sharedData_VFor4, 0, _toDisplayString(getColumnKey(col, fixedIndex)));
          }, 1);
        });
        _createSharedDataIf(() => {
          ...
          _createSharedDataFor(_setSharedDataScoped(__sharedData, 4, _createSharedDataVFor(__sharedDataScope, () => {
            ...
            _renderSharedDataEffect(() => {
              _setSharedDataClass(__sharedData_VFor5, 3, ["weapp-tw-border up-table-row up-table-body-row", getRowClass(_for_item5.value["row"], _for_key5.value)]);
              _setSharedDataStyle(__sharedData_VFor5, 4, { height: rowHeightValue.value });
            });
            _createSharedDataFor(_setSharedDataScoped(__sharedData_VFor5, 1, _createSharedDataVFor(__sharedDataScope, () => {
              return new UniDynamicSharedData(__sharedDataScope, { bundleKey: `${__className}SharedData`, sharedDataClassId: 7 });
            })), () => {
              return getFixedRowCells(_for_item5.value["row"], safeToNumber(_for_item5.value["rowIndex"]));
            }, (__sharedData_VFor6, _for_item6, _for_key6) => {
              _renderSharedDataEffect(() => {
                const _cell = _for_item6.value;
                const _item = _for_item5.value;
                const _safeToNumber = safeToNumber;
                const _cell_col = _cell["col"];
                const _item_row = _item["row"];
                _setSharedDataClass(__sharedData_VFor6, 9, ["weapp-tw-border up-table-cell up-table-body-cell", [getCellAlignClass(_cell_col), getCellClassName(_item_row, _cell_col), getCellSpanClass(_item_row, _cell_col, _safeToNumber(_item["rowIndex"]), _safeToNumber(_cell["colIndex"]))]]);
                _setSharedDataStyle(__sharedData_VFor6, 10, getFixedCellStyle(_item_row, _cell_col, _safeToNumber(_item["rowIndex"]), _safeToNumber(_cell["colIndex"]), _safeToNumber(_item["level"], 1)));
              });
              _createSharedDataIf(() => {
                return _setSharedData(__sharedData_VFor6, 1, _toSharedDataBoolean(isSelectionColumn(_for_item6.value["col"])));
              }, () => {
                const _on_click1 = () => {
                  return toggleSelect(_for_item5.value["row"]);
                };
                const n77 = _createSharedDataComponentWithFallback(_component_checkbox, "4f23f17f-" + ("fixed_" + getColumnKey(_for_item6.value["col"], safeToNumber(_for_item6.value["colIndex"]))), {
                  checked: () => {
                    return isSelected(_for_item5.value["row"]);
                  },
                  onClick: () => {
                    return _withModifiers(_on_click1, ["stop"]);
                  }
                });
                _setSharedData(__sharedData_VFor6, 2, n77?.sharedData);
              }, () => {
                _createSharedDataIf(() => {
                  return _setSharedData(__sharedData_VFor6, 3, _toSharedDataBoolean(showTreeIcon(_for_item6.value["col"], _for_item5.value["row"])));
                }, () => {
                  _setSharedDataEvent(__sharedData_VFor6, 4, () => {
                    return toggleExpand(_for_item5.value["row"]);
                  });
                  _renderSharedDataEffect(() => {
                    _setSharedDataStyle(__sharedData_VFor6, 5, { width: expandWidthValue.value });
                    _setSharedData(__sharedData_VFor6, 6, _toDisplayString(isExpanded(_for_item5.value["row"]) ? "-" : "+"));
                  });
                });
                _createSharedDataSlot("cell", {
                  row: () => {
                    return _for_item5.value["row"];
                  },
                  column: () => {
                    return _for_item6.value["col"];
                  },
                  prow: () => {
                    return getParentRow(_for_item5.value);
                  },
                  rowIndex: () => {
                    return safeToNumber(_for_item5.value["rowIndex"]);
                  },
                  columnIndex: () => {
                    return safeToNumber(_for_item6.value["colIndex"]);
                  },
                  level: () => {
                    return safeToNumber(_for_item5.value["level"], 1);
                  }
                }, (data) => {
                  return _setSharedData(__sharedData_VFor6, 7, data);
                }, () => {
                  _renderSharedDataEffect(() => {
                    return _setSharedData(__sharedData_VFor6, 8, _toDisplayString(getCellText(_for_item5.value["row"], _for_item6.value["col"])));
                  });
                });
              }, 3081);
              return null;
            }, (__sharedData_VFor6, cell, idx) => {
              return _setSharedData(__sharedData_VFor6, 0, _toDisplayString("fixed_" + getColumnKey(cell["col"], safeToNumber(cell["colIndex"]))));
            }, 1);
            _setSharedDataEvent(__sharedData_VFor5, 2, () => {
              return handleRowClick(_for_item5.value["row"]);
            });
            return null;
          }, (__sharedData_VFor5, item, flatIndex) => {
            return _setSharedData(__sharedData_VFor5, 0, _toDisplayString("fixed_" + getRowKey(item["row"], flatIndex)));
          }, 1);
        });
        _createSharedDataIf(() => {
          return _setSharedData(__sharedData, 6, _toSharedDataBoolean(__props.showSummary && hasData.value));
        }, () => {
          _renderSharedDataEffect(() => {
            return _setSharedDataStyle(__sharedData, 8, { height: rowHeightValue.value });
          });
          _createSharedDataFor(_setSharedDataScoped(__sharedData, 7, _createSharedDataVFor(__sharedDataScope, () => {
            return new UniDynamicSharedData(__sharedDataScope, { bundleKey: `${__className}SharedData`, sharedDataClassId: 8 });
          })), () => {
            return fixedLeftColumns.value;
          }, (__sharedData_VFor7, _for_item7, _for_key7) => {
            _renderSharedDataEffect(() => {
              const _col = _for_item7.value;
              _setSharedDataClass(__sharedData_VFor7, 4, ["weapp-tw-border up-table-cell up-table-footer-cell", [getCellAlignClass(_col)]]);
              _setSharedDataStyle(__sharedData_VFor7, 5, getFixedHeaderCellStyle(_col));
            });
            _createSharedDataSlot("summary-cell", {
              column: () => {
                return _for_item7.value;
              },
              columnIndex: () => {
                return getColumnIndex(_for_item7.value);
              },
              value: () => {
                return getSummaryValue(getColumnIndex(_for_item7.value));
              }
            }, (data) => {
              return _setSharedData(__sharedData_VFor7, 1, data);
            }, () => {
              _renderSharedDataEffect(() => {
                const _col = _for_item7.value;
                _setSharedDataStyle(__sharedData_VFor7, 2, { textAlign: getCellAlignValue(_col) });
                _setSharedData(__sharedData_VFor7, 3, _toDisplayString(getSummaryValue(getColumnIndex(_col))));
              });
            });
            return null;
          }, (__sharedData_VFor7, col, fixedIndex) => {
            return _setSharedData(__sharedData_VFor7, 0, _toDisplayString("fixed_sum_" + getColumnKey(col, fixedIndex)));
          }, 1);
        });
      });
      return __sharedData;
...
const _style_0 = {"fixed":{"":{"position":"fixed"}}};
const _style_1 = {};
