...
import { _ as __easycom_1$2 } from "../up-popup/up-popup.js";
...
const { useSharedDataComponentOptions: _useSharedDataComponentOptions, useSharedDataScope: _useSharedDataScope, withSharedDataComponent: _withSharedDataComponent, resolveComponent: _resolveComponent, setSharedDataStyle: _setSharedDataStyle, renderSharedDataEffect: _renderSharedDataEffect, createSharedDataSlot: _createSharedDataSlot, setSharedDataEvent: _setSharedDataEvent, setSharedData: _setSharedData, toSharedDataBoolean: _toSharedDataBoolean, setSharedDataScoped: _setSharedDataScoped, createSharedDataVFor: _createSharedDataVFor, toDisplayString: _toDisplayString, createSharedDataFor: _createSharedDataFor, createSharedDataComponentWithFallback: _createSharedDataComponentWithFallback, createSharedDataIf: _createSharedDataIf, withSharedDataVaporCtx: _withSharedDataVaporCtx } = globalThis.Vue;
...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props, _a) {
    ...
    const confirmColorComputed = computed(() => {
    ...
    function getSwitchItemStyle(index) {
    ...
    function getSwitchTextStyle(index) {
      return new UTSJSONObject({
    ...
    return () => {
      ...
      const _component_up_popup = __easycom_1$2;
      _renderSharedDataEffect(() => {
        return _setSharedDataStyle(__sharedData, 37, triggerStyle.value);
      });
      _createSharedDataSlot("default", null, null);
      _setSharedDataEvent(__sharedData, 36, open);
      const n61 = _createSharedDataComponentWithFallback(_component_up_popup, "4fd8ff6b", {
        show: () => {
          return show.value;
        },
        mode: "bottom",
        ...
        "default": _withSharedDataVaporCtx(() => {
          ...
          _renderSharedDataEffect(() => {
            const _getSwitchItemStyle = getSwitchItemStyle;
            const _getSwitchTextStyle = getSwitchTextStyle;
            _setSharedDataStyle(__sharedData, 27, _getSwitchItemStyle(0));
            _setSharedDataStyle(__sharedData, 28, _getSwitchTextStyle(0));
            _setSharedDataStyle(__sharedData, 29, _getSwitchItemStyle(1));
            _setSharedDataStyle(__sharedData, 30, _getSwitchTextStyle(1));
          });
          _createSharedDataIf(() => {
            ...
            const n16 = _createSharedDataComponentWithFallback(_component_up_button, "a9721ac0", {
              type: "primary",
              color: () => {
            ...
            const n17 = _createSharedDataComponentWithFallback(_component_up_button, "a9716f3c", {
              type: "info",
              size: "mini",
              plain: "",
              class: "up-color-picker__add-btn",
            ...
            _setSharedData(__sharedData, 4, n17?.sharedData);
          ...
          _renderSharedDataEffect(() => {
            _setSharedDataStyle(__sharedData, 31, saturationStyle.value);
            _setSharedDataStyle(__sharedData, 32, saturationPointerStyle.value);
            _setSharedDataStyle(__sharedData, 33, huePointerStyle.value);
          });
          _createSharedDataIf(() => {
          ...
          _renderSharedDataEffect(() => {
            _setSharedDataStyle(__sharedData, 34, previewStyle.value);
            _setSharedData(__sharedData, 35, _toDisplayString(displayColor.value));
          });
          const n54 = _createSharedDataComponentWithFallback(_component_up_button, "a96e8f36", {
            type: "primary",
            color: () => {
              return __props.confirmColor;
            },
          ...
          const n55 = _createSharedDataComponentWithFallback(_component_up_button, "a96e86c4", {
            type: "info",
            size: "small",
            class: "up-color-picker__btn",
            text: "取消",
          ...
          _setSharedData(__sharedData, 18, n55?.sharedData);
        })
      });
