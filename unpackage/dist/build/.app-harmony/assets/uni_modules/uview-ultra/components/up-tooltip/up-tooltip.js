import { _ as __easycom_0$1 } from "../up-overlay/up-overlay.js";
import { _ as __easycom_1 } from "../up-line/up-line.js";
import { _ as __easycom_0$2 } from "../up-transition/up-transition.js";
import { i as guid, b as addStyle, a as addUnit, z as sys, s as sleep, t as toast, u as upGetRect } from "../../libs/function/index.js";
...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props, _a) {
    ...
    return () => {
      ...
      const n0 = _createSharedDataComponentWithFallback(_component_up_overlay, "5f52cfc6", {
        show: () => {
      ...
      const n30 = _createSharedDataComponentWithFallback(_component_up_transition, "3a7c6bdb", {
        mode: "fade",
        show: () => {
        ...
        "default": _withSharedDataVaporCtx(() => {
          ...
          _createSharedDataSlot("content", null, null, () => {
            ...
            _createSharedDataIf(() => {
              ...
              const n20 = _createSharedDataComponentWithFallback(_component_up_line, "150e5ce3", {
                direction: "column",
                color: "#8d8e90",
                length: "18"
              });
            ...
            _createSharedDataFor(_setSharedDataScoped(__sharedData, 19, _createSharedDataVFor(__sharedDataScope, () => {
              ...
              _createSharedDataIf(() => {
                ...
                const n27 = _createSharedDataComponentWithFallback(_component_up_line, "150ec188-" + _for_key0.value, {
                  direction: "column",
                  color: "#8d8e90",
                  length: "18"
                });
