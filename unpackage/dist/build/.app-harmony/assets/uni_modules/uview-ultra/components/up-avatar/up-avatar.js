...
import { b as addStyle, a as addUnit, d as deepMerge, r as random } from "../../libs/function/index.js";
  ...
  setup(__props, _a) {
    ...
    return () => {
      ...
      _renderSharedDataEffect(() => {
        _setSharedDataClass(__sharedData, 10, ["weapp-tw-border up-avatar", [`up-avatar--${__props.shape}`]]);
      ...
      _createSharedDataSlot("default", null, null, () => {
        _createSharedDataIf(() => {
          ...
          const n4 = _createSharedDataComponentWithFallback(_component_up_icon, "64edced3", {
            name: () => {
              return __props.icon;
            },
            size: () => {
          ...
          return _createSharedDataIf(() => {
            ...
            const n6 = _createSharedDataComponentWithFallback(_component_up_text, "64edd59c", {
              text: () => {
                return __props.text;
              },
              size: () => {
