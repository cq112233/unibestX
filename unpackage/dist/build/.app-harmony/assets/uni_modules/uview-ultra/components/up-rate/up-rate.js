...
import { i as guid, b as addStyle, a as addUnit, q as os, s as sleep, u as upGetRect, f as range } from "../../libs/function/index.js";
  ...
  setup(__props, _a) {
    ...
    return () => {
      ...
      _createSharedDataFor(_setSharedDataScoped(__sharedData, 0, _createSharedDataVFor(__sharedDataScope, () => {
        ...
        _renderSharedDataEffect(() => {
          return _setSharedDataClass(__sharedData_VFor0, 7, ["weapp-tw-border up-rate__content__item wtu-1h9eaf1-0", [elClass.value]]);
        });
        const n2 = _createSharedDataComponentWithFallback(_component_up_icon, "4df78a52-" + _for_key0.value, {
          name: () => {
        ...
        _createSharedDataIf(() => {
          ...
          const n6 = _createSharedDataComponentWithFallback(_component_up_icon, "70f72070-" + _for_key0.value, {
            name: () => {
              return Math.floor(parseFloat(activeIndex.value.toString())) > _for_key0.value ? __props.activeIcon : __props.inactiveIcon;
            },
            color: () => {
