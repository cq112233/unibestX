        ...
        },
        {
          ...
          "default": _withSharedDataVaporCtx(() => {
            ...
            _createSharedDataIf(() => {
              ...
              const n12 = _createSharedDataComponentWithFallback(_component_up_line, "69c5f6f6");
              ...
              _createSharedDataIf(() => {
                ...
                _renderSharedDataEffect(() => {
                  _setSharedDataClass(__sharedData, 7, ["weapp-tw-border up-modal__button-group__wrapper up-modal__button-group__wrapper--cancel", [__props.showCancelButton && !__props.showConfirmButton ? "up-modal__button-group__wrapper--only-cancel" : ""]]);
              ...
              _createSharedDataIf(() => {
                ...
                const n19 = _createSharedDataComponentWithFallback(_component_up_line, "62148df0", { direction: "column" });
              ...
              _createSharedDataIf(() => {
                ...
                _renderSharedDataEffect(() => {
                  return _setSharedDataClass(__sharedData, 18, ["weapp-tw-border up-modal__button-group__wrapper up-modal__button-group__wrapper--confirm", [!__props.showCancelButton && __props.showConfirmButton ? "up-modal__button-group__wrapper--only-confirm" : ""]]);
                });
                _createSharedDataIf(() => {
                  return _setSharedData(__sharedData, 13, _toSharedDataBoolean(loading.value));
                }, () => {
                  const n24 = _createSharedDataComponentWithFallback(_component_up_loading_icon, "6213cafc");
