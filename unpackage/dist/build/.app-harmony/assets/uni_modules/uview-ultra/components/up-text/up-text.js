...
import { _ as __easycom_0$2 } from "../up-link/up-link.js";
import { a as addUnit, d as deepMerge, b as addStyle, v as priceFormat, w as timeFormat } from "../../libs/function/index.js";
...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props, _a) {
    ...
    return () => {
      ...
      const _component_up_link = __easycom_0$2;
      ...
      _createSharedDataIf(() => {
        ...
        _renderSharedDataEffect(() => {
          ...
          _setSharedDataClass(__sharedData, 17, ["weapp-tw-border up-text", [__props.customClass]]);
        ...
        _createSharedDataIf(() => {
          ...
          _renderSharedDataEffect(() => {
            _setSharedDataClass(__sharedData, 2, ["weapp-tw-border", ["up-text__price", `up-text__value--${__props.type}`]]);
        ...
        _createSharedDataIf(() => {
          ...
          const n7 = _createSharedDataComponentWithFallback(_component_up_icon, "4eee49a5", {
            name: () => {
        ...
        _createSharedDataIf(() => {
          ...
          const n11 = _createSharedDataComponentWithFallback(_component_up_link, "4eee506c", {
            class: () => {
          ...
          return _createSharedDataIf(() => {
            ...
            const n14 = _createSharedDataComponentWithFallback(_component_button, "e24e0292", {
            ...
            _renderSharedDataEffect(() => {
              _setSharedDataClass(__sharedData, 11, ["weapp-tw-border up-text__value", [
        ...
        _createSharedDataIf(() => {
          ...
          const n19 = _createSharedDataComponentWithFallback(_component_up_icon, "e24d0a9a", {
            name: () => {
