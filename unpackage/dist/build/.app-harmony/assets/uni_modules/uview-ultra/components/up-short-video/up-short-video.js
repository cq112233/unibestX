...
import { _ as __easycom_0$2 } from "../up-tabs/up-tabs.js";
import { _ as __easycom_2 } from "../up-avatar/up-avatar.js";
import { _ as __easycom_1 } from "../up-button/up-button.js";
import { _ as __easycom_4 } from "../up-action-sheet/up-action-sheet.js";
import { _ as __easycom_0$3 } from "../up-slider/up-slider.js";
import { _ as __easycom_0$4 } from "../up-tabbar-item/up-tabbar-item.js";
import { _ as __easycom_1$1 } from "../up-tabbar/up-tabbar.js";
...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props, _a) {
    ...
    return () => {
      ...
      const _component_up_tabs = __easycom_0$2;
      ...
      const _component_up_slider = __easycom_0$3;
      const _component_up_tabbar_item = __easycom_0$4;
      const _component_up_tabbar = __easycom_1$1;
      _createSharedDataSlot("menu", null, null, () => {
        const n2 = _createSharedDataComponentWithFallback(_component_up_icon, "61f2cbc0", {
          name: "grid",
          size: "24"
        });
        _setSharedData(__sharedData, 3, n2?.sharedData);
      });
      const n4 = _createSharedDataComponentWithFallback(_component_up_tabs, "61f2c4f4", {
        list: () => {
      ...
      _createSharedDataSlot("search", null, null, () => {
        const n7 = _createSharedDataComponentWithFallback(_component_up_icon, "61f298a0", {
          name: "search",
          size: "24"
        });
        _setSharedData(__sharedData, 5, n7?.sharedData);
      });
      const n40 = _createSharedDataComponentWithFallback(_component_swiper, "61f2916c", {
        vertical: true,
        autoplay: false,
        onChange: () => {
        ...
        "default": _withSharedDataVaporCtx(() => {
          _createSharedDataFor(_setSharedDataScoped(__sharedData, 1, _createSharedDataVFor(__sharedDataScope, () => {
            ...
            const n39 = _createSharedDataComponentWithFallback(_component_swiper_item, "11cc8888-" + _for_key0.value, null, {
              "default": _withSharedDataVaporCtx(() => {
                const _on_play = () => {
                ...
                const n12 = _createSharedDataComponentWithFallback(_component_video, "11cc92f2-" + _for_key0.value, {
                  id: () => {
                ...
                const n14 = _createSharedDataComponentWithFallback(_component_up_avatar, "11ccfd0b-" + _for_key0.value, {
                  src: () => {
                ...
                const n20 = _createSharedDataComponentWithFallback(_component_up_button, "11cd0f71-" + _for_key0.value, {
                  type: "primary",
                  size: "mini"
                }, {
                  "default": _withSharedDataVaporCtx(() => {
                ...
                _createSharedDataSlot("actions", {
                  ...
                  const n25 = _createSharedDataComponentWithFallback(_component_up_icon, "11cd1b14-" + _for_key0.value, {
                    color: "#eee",
                    name: () => {
                  ...
                  const n28 = _createSharedDataComponentWithFallback(_component_up_icon, "11cd786d-" + _for_key0.value, {
                    color: "#eee",
                    name: "chat",
                    size: "32px"
                  });
                  ...
                  const n31 = _createSharedDataComponentWithFallback(_component_up_icon, "11cd83ea-" + _for_key0.value, {
                    color: "#eee",
                    name: "share",
                    size: "32px"
                  });
                  ...
                  const n34 = _createSharedDataComponentWithFallback(_component_up_icon, "11cd8f53-" + _for_key0.value, {
                    color: "#eee",
                    name: () => {
      ...
      const n41 = _createSharedDataComponentWithFallback(_component_up_action_sheet, "11cde9a5", {
        show: () => {
      ...
      const n42 = _createSharedDataComponentWithFallback(_component_up_slider, "11cdf7b3", {
        "model-value": () => {
      ...
      _createSharedDataSlot("tabbar", null, null, () => {
        const n50 = _createSharedDataComponentWithFallback(_component_up_tabbar, "11ce59ab", {
          fixed: true,
          placeholder: true,
          ...
          "default": _withSharedDataVaporCtx(() => {
            ...
            const n46 = _createSharedDataComponentWithFallback(_component_up_tabbar_item, "11ce64ca", {
              onClick: () => {
                return _on_click;
              },
              text: "Home",
            ...
            const n47 = _createSharedDataComponentWithFallback(_component_up_tabbar_item, "11ce68ab", {
              text: "Discover",
              icon: "photo"
            });
            _setSharedData(__sharedData, 8, n47?.sharedData);
            const n48 = _createSharedDataComponentWithFallback(_component_up_tabbar_item, "11ce6c34", {
              text: "Live",
              icon: "play-right"
            });
            _setSharedData(__sharedData, 9, n48?.sharedData);
            const n49 = _createSharedDataComponentWithFallback(_component_up_tabbar_item, "11ce6fd3", {
              text: "Mine",
              icon: "account"
            });
