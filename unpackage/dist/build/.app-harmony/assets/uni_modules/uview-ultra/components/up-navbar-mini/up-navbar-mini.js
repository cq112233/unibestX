...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props, _a) {
    ...
    return () => {
      ...
      _renderSharedDataEffect(() => {
        _setSharedDataClass(__sharedData, 7, ["weapp-tw-border up-navbar-mini", [__props.customClass]]);
        _setSharedDataClass(__sharedData, 8, ["weapp-tw-border up-navbar-mini__inner", [__props.fixed ? "up-navbar-mini--fixed" : ""]]);
      });
      _createSharedDataIf(() => {
        return _setSharedData(__sharedData, 0, _toSharedDataBoolean(__props.safeAreaInsetTop));
      }, () => {
        const n2 = _createSharedDataComponentWithFallback(_component_up_status_bar, "4b8fb434");
      ...
      _createSharedDataSlot("left", null, null, () => {
        const n5 = _createSharedDataComponentWithFallback(_component_up_icon, "4b8fc2d8", {
          name: () => {
      ...
      const n7 = _createSharedDataComponentWithFallback(_component_up_line, "4b8fca3f", {
        direction: "col",
        color: "#fff",
        length: "16px"
      });
      ...
      _createSharedDataSlot("center", null, null, () => {
        const n11 = _createSharedDataComponentWithFallback(_component_up_icon, "4b8fd23e", {
          name: "home",
          size: () => {
            return __props.iconSize;
          },
