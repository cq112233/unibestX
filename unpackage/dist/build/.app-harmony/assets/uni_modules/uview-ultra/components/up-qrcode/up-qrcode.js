...
import { c as createQrCells, a as getQrRenderCountWithQuietZone } from "./qrcode.js";
  ...
  setup(__props, _a) {
    ...
    return () => {
      ...
      _createSharedDataIf(() => {
        ...
        const n5 = _createSharedDataComponentWithFallback(_component_canvas, "953dd8b2", {
        ...
        _createSharedDataIf(() => {
          ...
          const n11 = _createSharedDataComponentWithFallback(_component_up_loading_icon, "953db320", {
            vertical: "",
            text: () => {
