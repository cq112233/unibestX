  ...
  setup(__props, _a) {
    ...
    return () => {
      ...
      _renderSharedDataEffect(() => {
        ...
        _setSharedDataClass(__sharedData, 12, ["weapp-tw-border up-wrap", __up_lazy_item_elIndex]);
        _setSharedDataStyle(__sharedData, 13, wrapStyle.value);
        _setSharedDataClass(__sharedData, 14, ["weapp-tw-border", __up_lazy_item_elIndex]);
      });
      _createSharedDataIf(() => {
