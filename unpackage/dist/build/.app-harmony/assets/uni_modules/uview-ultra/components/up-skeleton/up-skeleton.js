      ...
      _createSharedDataIf(() => {
        ...
        _createSharedDataIf(() => {
          ...
          _renderSharedDataEffect(() => {
            _setSharedDataClass(__sharedData, 2, ["weapp-tw-border up-skeleton__wrapper__avatar", [`up-skeleton__wrapper__avatar--${__props.avatarShape}`, __props.animate ? "animate" : ""]]);
        ...
        _createSharedDataIf(() => {
          ...
          _renderSharedDataEffect(() => {
            _setSharedDataClass(__sharedData, 5, ["weapp-tw-border up-skeleton__wrapper__content__title", [__props.animate ? "animate" : ""]]);
        ...
        _createSharedDataFor(_setSharedDataScoped(__sharedData, 7, _createSharedDataVFor(__sharedDataScope, () => {
          ...
          _renderSharedDataEffect(() => {
            _setSharedDataClass(__sharedData_VFor0, 1, ["weapp-tw-border up-skeleton__wrapper__content__rows", [__props.animate ? "animate" : ""]]);
