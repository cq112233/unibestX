...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props, _a) {
    ...
    return () => {
      ...
      const n35 = _createSharedDataComponentWithFallback(_component_up_popup, "93e0ca7c", {
        show: () => {
        ...
        "default": _withSharedDataVaporCtx(() => {
          _createSharedDataIf(() => {
            ...
            const n10 = _createSharedDataComponentWithFallback(_component_up_toolbar, "93e0bafa", {
              cancelColor: () => {
          ...
          _createSharedDataIf(() => {
            ...
            const n32 = _createSharedDataComponentWithFallback(_component_up_loading_icon, "0be3ae91", { mode: "circle" });
