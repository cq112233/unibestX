...
import { _ as __easycom_0$2 } from "../up-transition/up-transition.js";
...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props, _a) {
    ...
    return () => {
      ...
      const _component_up_transition = __easycom_0$2;
        ...
        },
        {
          "default": _withSharedDataVaporCtx(() => {
            _renderSharedDataEffect(() => {
              ...
              _setSharedDataClass(__sharedData, 15, ["weapp-tw-border up-tag", [`up-tag--${__props.shape}`, !_plain ? `up-tag--${_type}` : "", _plain ? `up-tag--${_type}--plain` : "", `up-tag--${__props.size}`, _plain && __props.plainFill ? `up-tag--${_type}--plain--fill` : ""]]);
            ...
            _createSharedDataSlot("icon", null, null, () => {
              _createSharedDataIf(() => {
                ...
                _createSharedDataIf(() => {
                  ...
                  const n8 = _createSharedDataComponentWithFallback(_component_up_icon, "01ad991e", {
                    color: () => {
            ...
            _createSharedDataSlot("default", null, null, () => {
              _renderSharedDataEffect(() => {
                const _type = __props.type;
                _setSharedDataClass(__sharedData, 11, ["weapp-tw-border up-tag__text", [`up-tag__text--${_type}`, __props.plain ? `up-tag__text--${_type}--plain` : "", `up-tag__text--${__props.size}`]]);
            ...
            _createSharedDataIf(() => {
              ...
              _renderSharedDataEffect(() => {
                _setSharedDataClass(__sharedData, 4, ["weapp-tw-border up-tag__close", [`up-tag__close--${__props.size}`]]);
                _setSharedDataStyle(__sharedData, 5, closeStyle.value);
              });
              const n16 = _createSharedDataComponentWithFallback(_component_up_icon, "340a24ba", {
                name: "close",
                size: () => {
