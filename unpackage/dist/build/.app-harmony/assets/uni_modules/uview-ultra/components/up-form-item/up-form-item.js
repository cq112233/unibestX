  ...
  setup(__props, _a) {
    ...
    return () => {
      ...
      _renderSharedDataEffect(() => {
        _setSharedDataClass(__sharedData, 15, ["weapp-tw-border up-form-item", { "up-form-item--error": isErrorMessage.value }]);
      ...
      _createSharedDataSlot("label", null, null, () => {
        _createSharedDataIf(() => {
          ...
          _createSharedDataIf(() => {
            ...
            const n9 = _createSharedDataComponentWithFallback(_component_up_icon, "86e0f186", {
              name: () => {
      ...
      _createSharedDataIf(() => {
        ...
        const n31 = _createSharedDataComponentWithFallback(_component_up_line, "55436e78", {
          color: () => {
