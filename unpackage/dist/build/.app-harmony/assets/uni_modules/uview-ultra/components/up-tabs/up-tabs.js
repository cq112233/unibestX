...
import { _ as __easycom_1 } from "../up-badge/up-badge.js";
import { b as badgeProps } from "../up-badge/badge.js";
import { a as addUnit, b as addStyle, d as deepMerge, g as getPx, e as getWindowInfo, s as sleep, u as upGetRect } from "../../libs/function/index.js";
    ...
    return () => {
      ...
      _createSharedDataFor(_setSharedDataScoped(__sharedData, 0, _createSharedDataVFor(__sharedDataScope, () => {
        ...
        _renderSharedDataEffect(() => {
          ...
          _setSharedDataClass(__sharedData_VFor0, 15, ["weapp-tw-border up-tabs__wrapper__nav__item", [
        ...
        _createSharedDataIf(() => {
          ...
          _createSharedDataIf(() => {
            ...
            const n9 = _createSharedDataComponentWithFallback(_component_up_icon, "536b0b56-" + _for_key0.value, {
              name: () => {
        ...
        _createSharedDataIf(() => {
          ...
          return _createSharedDataIf(() => {
            ...
            _renderSharedDataEffect(() => {
              const _item = _for_item0.value;
              const _item_disabled = _item["disabled"];
              _setSharedDataClass(__sharedData_VFor0, 9, [[_item_disabled != null && _item_disabled ? "up-tabs__wrapper__nav__item__text--disabled" : ""], "weapp-tw-border up-tabs__wrapper__nav__item__text"]);
        ...
        const n18 = _createSharedDataComponentWithFallback(_component_up_badge, "536b7508-" + _for_key0.value, {
          show: () => {
