...
import { _ as __easycom_1 } from "../up-swiper-indicator/up-swiper-indicator.js";
import "./swiper.js";
...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props, _a) {
    ...
    return () => {
      ...
      const _component_up_swiper_indicator = __easycom_1;
      ...
      _createSharedDataIf(() => {
        ...
        const n2 = _createSharedDataComponentWithFallback(_component_up_loading_icon, "2fb7824e", { mode: "circle" });
        _setSharedData(__sharedData, 1, n2?.sharedData);
      }, () => {
        const n21 = _createSharedDataComponentWithFallback(_component_swiper, "2fb77b96", {
          ...
          "default": _withSharedDataVaporCtx(() => {
            _createSharedDataFor(_setSharedDataScoped(__sharedData, 3, _createSharedDataVFor(__sharedDataScope, () => {
              ...
              const n20 = _createSharedDataComponentWithFallback(_component_swiper_item, "2fb76b8a-" + _for_key0.value, { class: "up-swiper__wrapper__item" }, {
                "default": _withSharedDataVaporCtx(() => {
                  _createSharedDataSlot("default", {
                    ...
                    _createSharedDataIf(() => {
                      ...
                      const n14 = _createSharedDataComponentWithFallback(_component_video, "1c63893f-" + _for_key0.value, {
      ...
      _createSharedDataSlot("indicator", null, null, () => {
        _createSharedDataIf(() => {
          ...
          const n26 = _createSharedDataComponentWithFallback(_component_up_swiper_indicator, "1c63a75d", {
            indicatorActiveColor: () => {
