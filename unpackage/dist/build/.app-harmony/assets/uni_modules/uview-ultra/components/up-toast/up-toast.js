...
import { _ as __easycom_0$2 } from "../up-overlay/up-overlay.js";
...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props, _a) {
    ...
    return () => {
      ...
      const n10 = _createSharedDataComponentWithFallback(_component_up_overlay, "ef77a47e", {
        show: () => {
          return isShow.value;
        },
        zIndex: () => {
        ...
        "default": _withSharedDataVaporCtx(() => {
          _renderSharedDataEffect(() => {
            ...
            _setSharedDataClass(__sharedData, 7, ["weapp-tw-border up-toast__content", ["up-type-" + _tmpConfig_type, _tmpConfig_type === "loading" || _tmpConfig["loading"] ? "up-toast__content--loading" : ""]]);
          ...
          _createSharedDataIf(() => {
            ...
            const n2 = _createSharedDataComponentWithFallback(_component_up_loading_icon, "ff7cf15c", {
              mode: "circle",
            ...
            return _createSharedDataIf(() => {
              ...
              const n4 = _createSharedDataComponentWithFallback(_component_up_icon, "ff7ce262", {
                name: () => {
          ...
          _createSharedDataIf(() => {
            ...
            const n7 = _createSharedDataComponentWithFallback(_component_up_gap, "ff7cd392", {
              height: "12",
              bgColor: "transparent"
            });
          ...
          _renderSharedDataEffect(() => {
            const _tmpConfig = tmpConfig.value;
            _setSharedDataClass(__sharedData, 9, ["weapp-tw-border up-toast__content__text", ["up-toast__content__text--" + _tmpConfig["type"]]]);
