...
__uniRoutes.push({ path: "src/pages/index/index", component: GenSrcPagesIndexIndexClass, meta: { isQuit: true } as UniPageMeta, style: _uM([["navigationBarTitleText","首页"],["navigationStyle","custom"]]) } as UniPageRoute)
...
__uniRoutes.push({ path: "src/sub/paging/paging", component: GenSrcSubPagingPagingClass, meta: { isQuit: false } as UniPageMeta, style: _uM([["navigationBarTitleText","分页加载 (z-paging-x)"],["navigationStyle","custom"]]) } as UniPageRoute)
