...
return (): any | null => {
  ...
  return _cE("text", _uM({
    class: "weapp-tw-border uni-icons",
...
const GenUniModulesUniIconsComponentsUniIconsUniIconsStyles = [_uM([["weapp-tw-border", _pS(_uM([["borderTopWidth", 0], ["borderRightWidth", 0], ["borderBottomWidth", 0], ["borderLeftWidth", 0]]))], ["uni-icons", _pS(_uM([["fontFamily", "UniIconsFontFamily"], ["fontSize", 18], ["fontStyle", "normal"], ["color", "#333333"]]))], ["@FONT-FACE", _uM([["0", _uM([["fontFamily", "UniIconsFontFamily"], ["src", "url('/assets/uniicons.32e978a5.ttf')"]])]])]])]
