...
const _component_z_paging_x_empty = resolveEasyComponent("z-paging-x-empty",_easycom_z_paging_x_empty)
  ...
  return _cE("view", _uM({
    class: _nC(["weapp-tw-border", _uM({ 'zpx-content':true })]),
    ref_key: "zPagingX",
    ref: zPagingX,
    ...
    _ctx.listIs === 'list-view'
      ? _cE("list-view", _uM({
          ...
          _cE("list-item", _uM({ slot: "refresher" }), [
            _cE("view", _uM({
              ...
              class: "weapp-tw-border zpx-list-refresher",
      ...
      : _cE("scroll-view", _uM({
          ...
          _cE("view", _uM({
            class: _nC(["weapp-tw-border", showEmpty.value ? 'zpx-flex1' : ''])
          }), [
            isTrue(showEmpty.value)
              ? _cE(Fragment, _uM({ key: 0 }), [
                  isTrue(_ctx.$slots['empty'])
        ...
        ], 40 /* PROPS, NEED_HYDRATION */, ["id", "refresher-enabled", "refresher-threshold", "refresher-triggered", "refresher-default-style", "refresher-background", "scroll-top", "show-scrollbar", "scroll-with-animation"]),
    renderSlot(_ctx.$slots, "bottom"),
    isTrue(showBackToTopClass.value)
      ? _cE("view", _uM({
          key: 2,
          class: _nC(["weapp-tw-border", backToTopClass.value]),
