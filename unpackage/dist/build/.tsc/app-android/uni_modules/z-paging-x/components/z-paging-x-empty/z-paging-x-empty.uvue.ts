...
return (): any | null => {
  ...
  return _cE("view", _uM({
    class: _nC(["weapp-tw-border", _uM({'zpx-container':true})]),
    style: _nS([_ctx.emptyStyle]),
    onClick: emptyClick
  }), [
    _cE("view", _uM({ class: "weapp-tw-border zpx-main" }), [
