...
return (): any | null => {
  ...
  return _cE("view", _uM({
    class: "weapp-tw-border zpx-r-container",
    ...
    _cE("view", _uM({
      class: "weapp-tw-border zpx-r-text-container",
      style: _nS(_uM({marginLeft: showRefresherTimeText.value ? '25rpx' : '10rpx'}))
    }), [
      _cE("text", _uM({ class: "weapp-tw-border zpx-r-text" }), _tD(statusText.value), 1 /* TEXT */),
      isTrue(showRefresherTimeText.value)
        ? _cE("text", _uM({
            key: 0,
            class: "weapp-tw-border zpx-r-text zpx-r-time-text"
