...
return (): any | null => {
  ...
  return _cE("view", _uM({ class: "weapp-tw-border up-code-input" }), [
    _cE(Fragment, null, RenderHelpers.renderList(codeLength.value, (item, index, __index, _cached): any => {
      return _cE("view", _uM({
        class: "weapp-tw-border up-code-input__item",
        ...
        isTrue(_ctx.dot && codeArray.value.length > index)
          ? _cE("view", _uM({
              key: 0,
              class: "weapp-tw-border up-code-input__item__dot"
            }))
          : _cE("text", _uM({
              key: 1,
        ...
        _ctx.mode == 'line'
          ? _cE("view", _uM({
              key: 2,
              class: "weapp-tw-border up-code-input__item__line",
        ...
        isTrue(isFocus.value && inputLength.value == index)
          ? _cE("view", _uM({
              ...
              class: "weapp-tw-border up-code-input__item__cursor"
            }), null, 4 /* STYLE */)
          : _cC("v-if", true)
      ], 4 /* STYLE */)
    }), 128 /* KEYED_FRAGMENT */),
