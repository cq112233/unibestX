...
const _component_up_popup = resolveEasyComponent("up-popup",_easycom_up_popup)
  ...
  return _cV(_component_up_popup, _uM({
    ...
    default: withSlotCtx((): any[] => [
      _cE("view", _uM({
        class: "weapp-tw-border up-modal",
        style: _nS(modalStyle.value)
      }), [
        _ctx.title != ''
          ? _cE("view", _uM({
              key: 0,
              class: "weapp-tw-border up-modal__title"
            }), _tD(_ctx.title), 1 /* TEXT */)
          : _cC("v-if", true),
        _cE("view", _uM({
          class: "weapp-tw-border up-modal__content",
          style: _nS(contentStyleCpu.value)
        }), [
          renderSlot(_ctx.$slots, "default", {}, (): any[] => [
            _cE("text", _uM({
              class: "weapp-tw-border up-modal__content__text",
        ...
        _ctx.$slots['confirmButton'] != null
          ? _cE("view", _uM({
              key: 1,
              class: "weapp-tw-border up-modal__button-group--confirm-button"
            }), [
          ...
          : _cE(Fragment, _uM({ key: 2 }), [
              ...
              _cE("view", _uM({
                class: "weapp-tw-border up-modal__button-group",
                style: _nS(buttonGroupStyle.value)
              }), [
                isTrue(_ctx.showCancelButton)
                  ? _cE("view", _uM({
                      key: 0,
                      class: _nC(["weapp-tw-border up-modal__button-group__wrapper up-modal__button-group__wrapper--cancel", [(_ctx.showCancelButton && !_ctx.showConfirmButton) ? 'up-modal__button-group__wrapper--only-cancel' : '']]),
                      "hover-stay-time": 150,
                      "hover-class": "up-modal__button-group__wrapper--hover",
                      onClick: cancelHandler
                    }), [
                      _cE("text", _uM({
                        class: "weapp-tw-border up-modal__button-group__wrapper__text",
                ...
                isTrue(_ctx.showConfirmButton)
                  ? _cE("view", _uM({
                      key: 2,
                      class: _nC(["weapp-tw-border up-modal__button-group__wrapper up-modal__button-group__wrapper--confirm", [(!_ctx.showCancelButton && _ctx.showConfirmButton) ? 'up-modal__button-group__wrapper--only-confirm' : '']]),
                      "hover-stay-time": 150,
                      "hover-class": "up-modal__button-group__wrapper--hover",
