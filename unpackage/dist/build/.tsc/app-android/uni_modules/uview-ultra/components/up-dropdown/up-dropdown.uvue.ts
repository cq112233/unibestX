...
__ins.emit(event, ...do_not_transform_spread)
	...
	function getContentHeight() {
		...
		upGetRect('.up-dropdown__menu', false, instance?.proxy).then((res) => {
	...
	const dropdownProps = computed((): UTSJSONObject => {
		return {
...
const _component_up_icon = resolveEasyComponent("up-icon",_easycom_up_icon)
  ...
  return _cE("view", _uM({
    class: "weapp-tw-border up-dropdown",
    style: _nS(dropdownStyle.value)
  }), [
    _cE("view", _uM({
      class: _nC(["weapp-tw-border up-dropdown__menu", _uM({
      ...
      _cE(Fragment, null, RenderHelpers.renderList(menuList.value, (item, index, __index, _cached): any => {
        return _cE("view", _uM({
          class: "weapp-tw-border up-dropdown__menu__item",
          key: index,
          onClick: withModifiers(() => {menuClick(index)}, ["stop"])
        }), [
          _cE("view", _uM({ class: "weapp-tw-border up-flex up-flex-row" }), [
            _cE("text", _uM({
              class: _nC(["weapp-tw-border up-dropdown__menu__item__text", _uM({
            ...
            _cE("view", _uM({
              class: _nC(["weapp-tw-border up-dropdown__menu__item__arrow", _uM({
    ...
    _cE("view", _uM({
      class: "weapp-tw-border up-dropdown__content",
      ...
      _cE("view", _uM({
        ...
        class: "weapp-tw-border up-dropdown__content__popup",
        style: _nS(popupStyle.value)
      }), [
        renderSlot(_ctx.$slots, "default")
      ], 12 /* STYLE, PROPS */, ["onClick"]),
      _cE("view", _uM({ class: "weapp-tw-border up-dropdown__content__mask" }))
