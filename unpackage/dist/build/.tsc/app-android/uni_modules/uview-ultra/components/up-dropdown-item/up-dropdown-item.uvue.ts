...
const _component_up_cell_group = resolveEasyComponent("up-cell-group",_easycom_up_cell_group)
  ...
  return isTrue(isActive.value)
    ? _cE("view", _uM({
        key: 0,
        class: "weapp-tw-border up-dropdown-item",
        ...
        isTrue(_ctx.$slots['default'] == null && _ctx.$slots['$default'] == null)
          ? _cE("view", _uM({
              key: 0,
              class: "weapp-tw-border up-dropdown-item__scroll",
              style: _nS(scrollHeightStyle.value)
            }), [
              _cE("view", _uM({ class: "weapp-tw-border up-dropdown-item__options" }), [
                    ...
                    _cE(Fragment, null, RenderHelpers.renderList(props.options, (item, index, __index, _cached): any => {
                      return _cV(_component_up_cell, _uM({
                        ...
                        title: withSlotCtx((): any[] => [
                          _cE("text", _uM({
                            class: _nC(["weapp-tw-border up-dropdown-item__text", _uM({
									'up-dropdown-item__text--active': isItemActive(item) && activeColor.value == '#2979ff'
								})]),
                            style: _nS(getItemTextStyle(item))
                          }), _tD(item['label'] != null ? item['label']!.toString() : ''), 7 /* TEXT, CLASS, STYLE */)
                        ]),
                        default: withSlotCtx((): any[] => [
                          isTrue(isItemActive(item))
...
const GenUniModulesUviewUltraComponentsUpDropdownItemUpDropdownItemStyles = [_uM([["weapp-tw-border", _pS(_uM([["borderTopWidth", 0], ["borderRightWidth", 0], ["borderBottomWidth", 0], ["borderLeftWidth", 0]]))], ["up-dropdown-item__scroll", _pS(_uM([["backgroundImage", "none"], ["backgroundColor", "#ffffff"]]))], ["up-dropdown-item__text", _pS(_uM([["fontSize", 15]]))], ["up-dropdown-item__text--active", _pS(_uM([["color", "var(--theme-color, #0957de)"]]))]])]
