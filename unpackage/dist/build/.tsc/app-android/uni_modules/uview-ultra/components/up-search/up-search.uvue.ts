...
const _component_up_icon = resolveEasyComponent("up-icon",_easycom_up_icon)
  ...
  return _cE("view", _uM({
    class: _nC(["weapp-tw-border up-search", [_ctx.iconPosition == 'right' ? 'up-search__reverse' : '']]),
    onClick: clickHandler,
    style: _nS(searchStyle.value)
  }), [
    _cE("view", _uM({
      class: "weapp-tw-border up-search__content",
      style: _nS(contentStyle.value)
    }), [
      isTrue(_ctx.$slots['label'] != null || _ctx.label != '')
        ? renderSlot(_ctx.$slots, "label", _uM({ key: 0 }), (): any[] => [
            _cE("text", _uM({ class: "weapp-tw-border up-search__content__label" }), _tD(_ctx.label), 1 /* TEXT */)
          ])
        : _cC("v-if", true),
      _cE("view", _uM({ class: "weapp-tw-border up-search__content__icon" }), [
      ...
      isTrue(isShowClear.value)
        ? _cE("view", _uM({
            key: 1,
            class: "weapp-tw-border up-search__content__icon up-search__content__close",
            onClick: clear
          }), [
            _cV(_component_up_icon, _uM({
              name: "close",
    ...
    _cE("text", _uM({
      ...
      class: _nC(["weapp-tw-border up-search__action", [(showActionBtn.value || show.value) ? 'up-search__action--active' : '']]),
