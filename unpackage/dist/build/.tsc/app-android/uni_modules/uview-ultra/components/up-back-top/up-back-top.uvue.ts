...
const _component_up_icon = resolveEasyComponent("up-icon",_easycom_up_icon)
  ...
  return isTrue(show.value)
    ? _cE("view", _uM({
        key: 0,
        style: _nS(finalStyle.value),
        class: "weapp-tw-border up-back-top",
        onClick: backToTop
      }), [
        renderSlot(_ctx.$slots, "default", {}, (): any[] => [
          ...
          _ctx.text != ''
            ? _cE("text", _uM({
                key: 0,
                class: "weapp-tw-border up-back-top__text"
...
const GenUniModulesUviewUltraComponentsUpBackTopUpBackTopStyles = [_uM([["weapp-tw-border", _pS(_uM([["borderTopWidth", 0], ["borderRightWidth", 0], ["borderBottomWidth", 0], ["borderLeftWidth", 0]]))], ["up-back-top__text", _pS(_uM([["fontSize", 10], ["color", "#2563eb"], ["marginTop", 2]]))]])]
