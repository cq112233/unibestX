...
const _component_up_line = resolveEasyComponent("up-line",_easycom_up_line)
  ...
  return _cE("view", _uM({ class: "weapp-tw-border up-collapse-item" }), [
    ...
    _cE("view", _uM({
      class: "weapp-tw-border up-collapse-item__content",
      style: _nS(contentHeightStyle.value)
    }), [
      _cE("view", _uM({
        class: "weapp-tw-border up-collapse-item__content__text content-class",
        id: elId.value,
        ref: elId.value
      }), [
