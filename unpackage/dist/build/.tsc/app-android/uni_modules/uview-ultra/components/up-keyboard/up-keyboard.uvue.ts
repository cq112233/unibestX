...
const _component_up_popup = resolveEasyComponent("up-popup",_easycom_up_popup)
  ...
  return _cV(_component_up_popup, _uM({
    ...
    default: withSlotCtx((): any[] => [
      _cE("view", _uM({ class: "weapp-tw-border up-keyboard" }), [
        renderSlot(_ctx.$slots, "default"),
        isTrue(_ctx.tooltip)
          ? _cE("view", _uM({
              key: 0,
              class: "weapp-tw-border up-keyboard__tooltip"
            }), [
              _cE("view", _uM({
                ...
                isTrue(_ctx.showCancel)
                  ? _cE("text", _uM({
                      key: 0,
                      class: "weapp-tw-border up-keyboard__tooltip__item up-keyboard__tooltip__cancel",
                      onClick: onCancel
                    }), _tD(_ctx.cancelText), 1 /* TEXT */)
                  : _cC("v-if", true)
              ]),
              _cE("view", _uM({ class: "weapp-tw-border" }), [
                isTrue(_ctx.showTips)
                  ? _cE("text", _uM({
                      key: 0,
                      class: "weapp-tw-border up-keyboard__tooltip__item up-keyboard__tooltip__tips"
              ...
              _cE("view", _uM({
                ...
                isTrue(_ctx.showConfirm)
                  ? _cE("text", _uM({
                      key: 0,
                      onClick: onConfirm,
                      class: "weapp-tw-border up-keyboard__tooltip__item up-keyboard__tooltip__submit",
                      "hover-class": "up-hover-class"
                    }), _tD(_ctx.showConfirm ? _ctx.confirmText : ''), 1 /* TEXT */)
                  : _cC("v-if", true)
              ])
            ])
          : _cC("v-if", true),
        isTrue(_ctx.mode == 'number' || _ctx.mode == 'card')
          ? _cV(_component_up_number_keyboard, _uM({
            ...
            }), null, 8 /* PROPS */, ["random", "mode", "dotDisabled"])
          : _cV(_component_up_car_keyboard, _uM({
              ...
              onBackspace: keyboardBackspace,
              onChange: keyboardChange
            }), null, 8 /* PROPS */, ["random", "autoChange"])
      ])
    ]),
    _: 3 /* FORWARDED */
  }), 8 /* PROPS */, ["overlay", "closeOnClickOverlay", "show", "safeAreaInsetBottom", "zIndex", "customStyle"])
}
}
