...
const _component_up_icon = resolveEasyComponent("up-icon",_easycom_up_icon)
  ...
  return _cE("view", _uM({
    class: _nC(["weapp-tw-border up-input", inputClass.value]),
    style: _nS(computedWrapperStyle.value)
  }), [
    _cE("view", _uM({ class: "weapp-tw-border up-input__content" }), [
      isTrue(_ctx.prefixIcon != '' || _ctx.$slots['prefix'] != null)
        ? _cE("view", _uM({
            key: 0,
            class: "weapp-tw-border up-input__content__prefix-icon"
          }), [
        ...
        : _cC("v-if", true),
      _cE("view", _uM({
        class: "weapp-tw-border up-input__content__field-wrapper",
      ...
      isTrue(isShowClear.value)
        ? _cE("view", _uM({
            key: 1,
            class: "weapp-tw-border up-input__content__clear",
            onClick: onClear
          }), [
            _cV(_component_up_icon, _uM({
              name: "close",
      ...
      isTrue(_ctx.suffixIcon != '' || _ctx.$slots['suffix'] != null)
        ? _cE("view", _uM({
            key: 2,
            class: "weapp-tw-border up-input__content__subfix-icon"
          }), [
