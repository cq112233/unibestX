...
return (): any | null => {
  ...
  return isTrue(inited.value)
    ? _cE("view", _uM({
        key: 0,
        class: _nC(["weapp-tw-border up-transition", classes.value]),
        ref: "up-transition",
