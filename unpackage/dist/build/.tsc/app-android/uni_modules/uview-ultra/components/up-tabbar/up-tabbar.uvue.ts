...
const _component_up_safe_bottom = resolveEasyComponent("up-safe-bottom",_easycom_up_safe_bottom)
  ...
  return _cE("view", _uM({ class: "weapp-tw-border up-tabbar" }), [
    _cE("view", _uM({
      class: _nC(["weapp-tw-border up-tabbar__content", [_ctx.border ? 'up-border-top' : '', _ctx.fixed ? 'up-tabbar--fixed' : '']]),
      onTouchmove: withModifiers(noop, ["stop","prevent"]),
      style: _nS(tabbarStyle.value)
    }), [
      _cE("view", _uM({ class: "weapp-tw-border up-tabbar__content__item-wrapper" }), [
    ...
    isTrue(_ctx.placeholder && _ctx.fixed)
      ? _cE("view", _uM({
          key: 0,
          class: "weapp-tw-border up-tabbar__placeholder",
          style: _nS(_uM({
