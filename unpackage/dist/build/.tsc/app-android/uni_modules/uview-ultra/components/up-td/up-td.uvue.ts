...
return (): any | null => {
  ...
  return _cE("view", _uM({
    class: _nC(["weapp-tw-border up-td", [_ctx.customClass]]),
    style: _nS(mergedTdStyle.value)
  }), [
    renderSlot(_ctx.$slots, "default", {}, (): any[] => [
      _cE("text", _uM({
        class: "weapp-tw-border up-td__text",
...
const GenUniModulesUviewUltraComponentsUpTdUpTdStyles = [_uM([["weapp-tw-border", _pS(_uM([["borderTopWidth", 0], ["borderRightWidth", 0], ["borderBottomWidth", 0], ["borderLeftWidth", 0]]))], ["up-td", _pS(_uM([["display", "flex"], ["flexDirection", "column"], ["flexGrow", 1], ["flexShrink", 1], ["flexBasis", "0%"], ["justifyContent", "center"], ["alignSelf", "stretch"], ["boxSizing", "border-box"], ["height", "100%"]]))], ["up-td__text", _pS(_uM([["fontSize", 14], ["color", "#606266"]]))]])]
