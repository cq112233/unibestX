...
const GenUniModulesUviewUltraComponentsUpListUpListStyles = [_uM([["weapp-tw-border", _pS(_uM([["borderTopWidth", 0], ["borderRightWidth", 0], ["borderBottomWidth", 0], ["borderLeftWidth", 0]]))], ["up-list", _pS(_uM([["flexDirection", "column"]]))]])]
