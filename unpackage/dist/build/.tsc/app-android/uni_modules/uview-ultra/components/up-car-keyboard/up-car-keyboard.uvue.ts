...
const _component_up_icon = resolveEasyComponent("up-icon",_easycom_up_icon)
  ...
  return _cE("view", _uM({
    class: "weapp-tw-border up-keyboard",
    onTouchmove: withModifiers(noop, ["stop","prevent"])
  }), [
    _cE(Fragment, null, RenderHelpers.renderList(abc.value ? engKeyBoardList.value : areaList.value, (group, i, __index, _cached): any => {
      return _cE("view", _uM({
        key: i,
        class: _nC(["weapp-tw-border up-keyboard__button", [((i + 1) == 4) ? 'up-keyboard__button--center' : '']])
      }), [
        i == 3
          ? _cE("view", _uM({
              key: 0,
              class: "weapp-tw-border up-keyboard__button__inner-wrapper"
            }), [
              _cE("view", _uM({
                class: "weapp-tw-border up-keyboard__button__inner-wrapper__left",
                "hover-class": "up-hover-class",
                "hover-stay-time": 200,
                onClick: changeCarInputMode
              }), [
                _cE("text", _uM({
                  class: _nC(["weapp-tw-border up-keyboard__button__inner-wrapper__left__lang", [!abc.value ? 'up-keyboard__button__inner-wrapper__left__lang--active' : '']])
                }), "中", 2 /* CLASS */),
                _cE("text", _uM({ class: "weapp-tw-border up-keyboard__button__inner-wrapper__left__line" }), "/"),
                _cE("text", _uM({
                  class: _nC(["weapp-tw-border up-keyboard__button__inner-wrapper__left__lang", [abc.value ? 'up-keyboard__button__inner-wrapper__left__lang--active' : '']])
                }), "英", 2 /* CLASS */)
              ])
          ...
          : _cC("v-if", true),
        _cE(Fragment, null, RenderHelpers.renderList(group, (item, j, __index, _cached): any => {
          return _cE("view", _uM({
            class: "weapp-tw-border up-keyboard__button__inner-wrapper",
            key: j
          }), [
            _cE("view", _uM({
              class: "weapp-tw-border up-keyboard__button__inner-wrapper__inner",
              "hover-stay-time": 200,
              onClick: () => {carInputClick(i, j)},
              "hover-class": "up-hover-class"
            }), [
              _cE("text", _uM({ class: "weapp-tw-border up-keyboard__button__inner-wrapper__inner__text" }), _tD(item), 1 /* TEXT */)
            ], 8 /* PROPS */, ["onClick"])
          ])
        }), 128 /* KEYED_FRAGMENT */),
        i == 3
          ? _cE("view", _uM({
              key: 1,
              onTouchstart: backspaceClick,
              onTouchend: clearTimer,
              class: "weapp-tw-border up-keyboard__button__inner-wrapper"
            }), [
              _cE("view", _uM({
                class: "weapp-tw-border up-keyboard__button__inner-wrapper__right",
                "hover-class": "up-hover-class",
                "hover-stay-time": 200
              }), [
