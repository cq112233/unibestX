...
const _component_up_transition = resolveEasyComponent("up-transition",_easycom_up_transition)
  ...
  return _cV(_component_up_transition, _uM({
    ...
    default: withSlotCtx((): any[] => [
      _cE("view", _uM({ class: "weapp-tw-border up-tag-wrapper wtu-f02bob-0" }), [
        _cE("view", _uM({
          class: _nC(["weapp-tw-border up-tag", [`up-tag--${_ctx.shape}`, !_ctx.plain ? `up-tag--${_ctx.type}` : '', _ctx.plain ? `up-tag--${_ctx.type}--plain` : '', `up-tag--${_ctx.size}`, (_ctx.plain && _ctx.plainFill) ?  `up-tag--${_ctx.type}--plain--fill` : '']]),
          ...
          renderSlot(_ctx.$slots, "icon", {}, (): any[] => [
            _ctx.icon != ''
              ? _cE("view", _uM({
                  key: 0,
                  class: "weapp-tw-border up-tag__icon"
                }), [
          ...
          renderSlot(_ctx.$slots, "default", {}, (): any[] => [
            _cE("text", _uM({
              class: _nC(["weapp-tw-border up-tag__text", [`up-tag__text--${_ctx.type}`, _ctx.plain ? `up-tag__text--${_ctx.type}--plain` : '', `up-tag__text--${_ctx.size}`]]),
        ...
        isTrue(_ctx.closable)
          ? _cE("view", _uM({
              key: 0,
              class: _nC(["weapp-tw-border up-tag__close", [`up-tag__close--${_ctx.size}`]]),
