...
return (): any | null => {
  ...
  return isTrue(_ctx.show)
    ? _cE("view", _uM({
        key: 0,
        class: _nC(["weapp-tw-border up-loading-icon", [_ctx.vertical ? 'up-loading-icon--vertical' : '']]),
        style: _nS(customLoadingIconStyle.value)
      }), [
        isTrue(!webviewHide.value)
          ? _cE("view", _uM({
              key: 0,
              class: _nC(["weapp-tw-border up-loading-icon__spinner", [`up-loading-icon__spinner--${_ctx.mode}`]]),
              ref: "ani",
              style: _nS(spinnerStyle.value)
            }), [
              _ctx.mode === 'spinner'
                ? _cE(Fragment, _uM({ key: 0 }), RenderHelpers.renderList(array12, (item, index, __index, _cached): any => {
                    return _cE("view", _uM({
                      key: index,
                      class: "weapp-tw-border up-loading-icon__dot",
                      style: _nS(getSpinnerDotStyle(index))
                    }), [
                      _cE("view", _uM({
                        class: "weapp-tw-border up-loading-icon__dot-bar",
                        style: _nS(dotBarStyle.value)
                      }), null, 4 /* STYLE */)
                    ], 4 /* STYLE */)
                  }), 64 /* STABLE_FRAGMENT */)
                : _cC("v-if", true)
        ...
        _ctx.text != ''
          ? _cE("text", _uM({
              key: 1,
              class: "weapp-tw-border up-loading-icon__text",
