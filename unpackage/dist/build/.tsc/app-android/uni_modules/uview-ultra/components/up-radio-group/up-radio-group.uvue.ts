	...
	const __sfc__ = defineComponent({
		...
		methods: {
			// 将其他的radio设置为未选中的状态
			unCheckedOther(childInstance: ComponentPublicInstance) {
...
function GenUniModulesUviewUltraComponentsUpRadioGroupUpRadioGroupRender(this: InstanceType<typeof __sfc__>): any | null {
const _ctx = this
const _cache = this.$.renderCache
  return _cE("view", _uM({
    class: _nC(["up-radio-group", _ctx.bemClass])
  }), [
