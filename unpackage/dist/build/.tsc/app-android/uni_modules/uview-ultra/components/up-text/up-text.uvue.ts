...
const _component_up_link = resolveEasyComponent("up-link",_easycom_up_link)
  ...
  return isTrue(_ctx.show)
    ? _cE("view", _uM({
        key: 0,
        class: _nC(["weapp-tw-border up-text", [_ctx.customClass]]),
        style: _nS(_uM({
            margin: _ctx.margin,
        ...
        _ctx.mode === 'price'
          ? _cE("text", _uM({
              key: 0,
              class: _nC(["weapp-tw-border", ['up-text__price', `up-text__value--${_ctx.type}`]]),
        ...
        _ctx.prefixIcon != ''
          ? _cE("view", _uM({
              key: 1,
              class: "weapp-tw-border up-text__prefix-icon"
            }), [
        ...
        _ctx.mode === 'link'
          ...
          : isTrue(_ctx.openType != '' && isMp.value)
            ...
            : _cE("text", _uM({
                key: 4,
                class: _nC(["weapp-tw-border up-text__value", [
        ...
        _ctx.suffixIcon != ''
          ? _cE("view", _uM({
              key: 5,
              class: "weapp-tw-border up-text__suffix-icon"
            }), [
              _cV(_component_up_icon, _uM({
