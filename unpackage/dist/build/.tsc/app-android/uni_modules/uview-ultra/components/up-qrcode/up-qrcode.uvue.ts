...
const _component_up_loading_icon = resolveEasyComponent("up-loading-icon",_easycom_up_loading_icon)
  ...
  return _cE("view", _uM({
    class: "weapp-tw-border up-qrcode",
    ...
    error.value.length > 0
      ? _cE("view", _uM({
          key: 0,
          class: "weapp-tw-border up-qrcode__error",
          style: _nS(matrixStyle.value)
        }), [
          _cE("text", _uM({ class: "weapp-tw-border up-qrcode__error-text" }), _tD(error.value), 1 /* TEXT */)
        ], 4 /* STYLE */)
      : _cE("view", _uM({
          key: 1,
          class: "weapp-tw-border up-qrcode__matrix",
          style: _nS(matrixStyle.value)
        }), [
          _cE("canvas", _uM({
          ...
          isTrue(_ctx.showLoading && loading.value)
            ? _cE("view", _uM({
                key: 1,
                class: "weapp-tw-border up-qrcode__loading"
              }), [
