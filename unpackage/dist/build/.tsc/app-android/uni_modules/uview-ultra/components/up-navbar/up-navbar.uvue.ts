...
const _component_up_icon = resolveEasyComponent("up-icon",_easycom_up_icon)
  ...
  return _cE("view", _uM({
    class: _nC(["weapp-tw-border up-navbar", [_ctx.customClass]])
  }), [
    isTrue(_ctx.fixed && _ctx.placeholder)
      ? _cE("view", _uM({
          key: 0,
          class: "weapp-tw-border up-navbar__placeholder",
          style: _nS(placeholderStyle.value)
        }), null, 4 /* STYLE */)
      : _cC("v-if", true),
    _cE("view", _uM({
      class: _nC(["weapp-tw-border", [_ctx.fixed ? 'up-navbar--fixed' : '']])
    }), [
      isTrue(_ctx.safeAreaInsetTop)
        ...
        : _cC("v-if", true),
      _cE("view", _uM({
        class: _nC(["weapp-tw-border up-navbar__content", [_ctx.border ? 'up-border-bottom' : '']]),
        style: _nS(contentStyle.value)
      }), [
        _cE("view", _uM({
          class: "weapp-tw-border up-navbar__content__left",
          ...
          renderSlot(_ctx.$slots, "left", {}, (): any[] => [
            ...
            _ctx.leftText != ''
              ? _cE("text", _uM({
                  ...
                  class: "weapp-tw-border up-navbar__content__left__text"
        ...
        renderSlot(_ctx.$slots, "center", {}, (): any[] => [
          _cE("text", _uM({
            class: "weapp-tw-border up-line-1 up-navbar__content__title",
        ...
        isTrue(_ctx.$slots['right'] != null || _ctx.rightIcon != '' || _ctx.rightText != '')
          ? _cE("view", _uM({
              key: 0,
              class: "weapp-tw-border up-navbar__content__right",
              onClick: rightClick
            }), [
              renderSlot(_ctx.$slots, "right", {}, (): any[] => [
                ...
                _ctx.rightText != ''
                  ? _cE("text", _uM({
                      key: 1,
                      class: "weapp-tw-border up-navbar__content__right__text"
