...
return (): any | null => {
  ...
  return _cE("view", _uM({
    class: "weapp-tw-border up-gap",
    style: _nS([gapStyle.value])
  }), null, 4 /* STYLE */)
}
}
