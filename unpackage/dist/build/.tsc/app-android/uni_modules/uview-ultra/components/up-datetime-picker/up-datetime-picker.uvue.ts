...
const _component_up_picker = resolveEasyComponent("up-picker",_easycom_up_picker)
  ...
  return _cE("view", _uM({ class: "weapp-tw-border up-datetime-picker" }), [
    isTrue(_ctx.hasInput)
      ? _cE("view", _uM({
          key: 0,
          class: "weapp-tw-border up-datetime-picker__has-input",
          onClick: changeShow
        }), [
