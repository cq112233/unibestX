...
return (): any | null => {
  ...
  return _cE("view", _uM({
    class: "weapp-tw-border up-circle-progress",
    style: _nS(rootStyle.value)
  }), [
    _cE("view", _uM({
      class: "weapp-tw-border up-circle-progress__track",
      style: _nS(trackStyle.value)
    }), null, 4 /* STYLE */),
    percent.value > 0
      ? _cE("view", _uM({
          key: 0,
          class: "weapp-tw-border up-circle-progress__mask up-circle-progress__mask--right"
        }), [
          _cE("view", _uM({
            class: _nC(["weapp-tw-border up-circle-progress__fill up-circle-progress__fill--right", [isDefaultColor.value ? 'up-circle-progress__fill--primary' : '']]),
    ...
    percent.value > 50
      ? _cE("view", _uM({
          key: 1,
          class: "weapp-tw-border up-circle-progress__mask up-circle-progress__mask--left"
        }), [
          _cE("view", _uM({
            class: _nC(["weapp-tw-border up-circle-progress__fill up-circle-progress__fill--left", [isDefaultColor.value ? 'up-circle-progress__fill--primary' : '']]),
            style: _nS(leftStyle.value)
          }), null, 6 /* CLASS, STYLE */)
        ])
      : _cC("v-if", true),
    _cE("view", _uM({ class: "weapp-tw-border up-circle-progress__content" }), [
      renderSlot(_ctx.$slots, "default", {}, (): any[] => [
        _cE("text", _uM({
          class: _nC(["weapp-tw-border up-circle-progress__text", [isDefaultColor.value ? 'up-circle-progress__text--primary' : '']]),
