...
const _component_up_overlay = resolveEasyComponent("up-overlay",_easycom_up_overlay)
  ...
  return _cV(_component_up_overlay, _uM({
    ...
    default: withSlotCtx((): any[] => [
      _cE("view", _uM({ class: "weapp-tw-border up-no-network" }), [
        ...
        _cE("text", _uM({ class: "weapp-tw-border up-no-network__tips" }), _tD(_ctx.tips), 1 /* TEXT */),
        _cE("view", _uM({ class: "weapp-tw-border up-no-network__retry" }), [
