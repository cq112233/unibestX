...
const _component_up_icon = resolveEasyComponent("up-icon",_easycom_up_icon)
  ...
  return _cE("view", _uM({
    class: "weapp-tw-border up-image",
    onClick: onClick,
    ...
    isTrue(_ctx.showLoading && loading.value)
      ? _cE("view", _uM({
          key: 0,
          class: "weapp-tw-border up-image__loading",
    ...
    isTrue(_ctx.showError && isError.value && !loading.value)
      ? _cE("view", _uM({
          key: 1,
          class: "weapp-tw-border up-image__error",
