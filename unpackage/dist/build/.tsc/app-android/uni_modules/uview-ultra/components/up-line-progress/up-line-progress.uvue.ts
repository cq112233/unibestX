...
return (): any | null => {
  ...
  return _cE("view", _uM({
    class: "weapp-tw-border up-line-progress",
    style: _nS(customLineProgressStyle.value)
  }), [
    _cE("view", _uM({
      class: "weapp-tw-border up-line-progress__background",
      style: _nS(backgroundStyle.value)
    }), null, 4 /* STYLE */),
    _cE("view", _uM({
      class: "weapp-tw-border up-line-progress__line",
      style: _nS(progressStyle.value)
    }), [
      renderSlot(_ctx.$slots, "default", {}, (): any[] => [
        isTrue(_ctx.showText && percentageValue.value >= 10)
          ? _cE("text", _uM({
              key: 0,
              class: "weapp-tw-border up-line-progress__text"
            }), _tD(innerPercentage.value + '%'), 1 /* TEXT */)
          : _cC("v-if", true)
      ])
    ], 4 /* STYLE */)
  ], 4 /* STYLE */)
