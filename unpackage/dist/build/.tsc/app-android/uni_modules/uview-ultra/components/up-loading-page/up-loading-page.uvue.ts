...
const _component_up_transition = resolveEasyComponent("up-transition",_easycom_up_transition)
  ...
  return _cV(_component_up_transition, _uM({
    ...
    default: withSlotCtx((): any[] => [
      _cE("view", _uM({ class: "weapp-tw-border up-loading-page" }), [
        _cE("view", _uM({ class: "weapp-tw-border up-loading-page__warpper" }), [
          _cE("view", _uM({ class: "weapp-tw-border up-loading-page__warpper__loading-icon" }), [
            _ctx.image != ''
              ? _cE("image", _uM({
                  key: 0,
                  src: _ctx.image,
          ...
          renderSlot(_ctx.$slots, "default", {}, (): any[] => [
            _cE("text", _uM({
              class: "weapp-tw-border up-loading-page__warpper__text",
