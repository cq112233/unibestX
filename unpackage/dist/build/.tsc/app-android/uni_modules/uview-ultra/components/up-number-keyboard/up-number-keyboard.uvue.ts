...
const _component_up_icon = resolveEasyComponent("up-icon",_easycom_up_icon)
  ...
  return _cE("view", _uM({
    ...
    _cE(Fragment, null, RenderHelpers.renderList(numList.value, (item, index, __index, _cached): any => {
      return _cE("view", _uM({
        class: "weapp-tw-border up-keyboard__button-wrapper",
        key: index
      }), [
        _cE("view", _uM({
          class: "weapp-tw-border up-keyboard__button-wrapper__button",
          style: _nS([itemStyle(index)]),
          onClick: () => {keyboardClick(item)},
          "hover-class": "up-hover-class",
          "hover-stay-time": 200
        }), [
          _cE("text", _uM({ class: "weapp-tw-border up-keyboard__button-wrapper__button__text" }), _tD(item), 1 /* TEXT */)
        ], 12 /* STYLE, PROPS */, ["onClick"])
      ])
    }), 128 /* KEYED_FRAGMENT */),
    _cE("view", _uM({ class: "weapp-tw-border up-keyboard__button-wrapper" }), [
      _cE("view", _uM({
        class: "weapp-tw-border up-keyboard__button-wrapper__button up-keyboard__button-wrapper__button--gray",
        "hover-class": "up-hover-class",
        "hover-stay-time": 200,
        onTouchstart: withModifiers(backspaceClick, ["stop"]),
