...
const _component_up_icon = resolveEasyComponent("up-icon",_easycom_up_icon)
  ...
  return _cE("view", _uM({
    class: _nC(["weapp-tw-border up-steps-item", [`up-steps-item--${direction.value}`]]),
    style: _nS(itemContainerStyle.value)
  }), [
    isTrue(direction.value == 'row' && stepIndex.value > 0)
      ? _cE("view", _uM({
          key: 0,
          class: "weapp-tw-border up-steps-item__line up-steps-item__line--row-left",
    ...
    isTrue(direction.value == 'row' && (childLength.value == 0 || stepIndex.value < childLength.value - 1))
      ? _cE("view", _uM({
          key: 1,
          class: "weapp-tw-border up-steps-item__line up-steps-item__line--row-right",
    ...
    isTrue(direction.value == 'column' && stepIndex.value > 0)
      ? _cE("view", _uM({
          key: 2,
          class: "weapp-tw-border up-steps-item__line up-steps-item__line--col-top",
    ...
    isTrue(direction.value == 'column' && (childLength.value == 0 || stepIndex.value < childLength.value - 1))
      ? _cE("view", _uM({
          key: 3,
          class: "weapp-tw-border up-steps-item__line up-steps-item__line--col-bottom",
          style: _nS(lineColBottomStyle.value)
        }), null, 4 /* STYLE */)
      : _cC("v-if", true),
    _cE("view", _uM({
      class: _nC(["weapp-tw-border up-steps-item__wrapper", [`up-steps-item__wrapper--${direction.value}`, isDot.value ? `up-steps-item__wrapper--${direction.value}--dot` : '']]),
      ...
      renderSlot(_ctx.$slots, "icon", {}, (): any[] => [
        isTrue(isDot.value)
          ? _cE("view", _uM({
              key: 0,
              class: "weapp-tw-border up-steps-item__wrapper__dot",
              style: _nS(dotStyle.value)
            }), null, 4 /* STYLE */)
          : isTrue(activeIcon.value != '' || inactiveIcon.value != '')
            ? _cE("view", _uM({
                key: 1,
                class: "weapp-tw-border up-steps-item__wrapper__icon"
              }), [
            ...
            : _cE("view", _uM({
                key: 2,
                class: "weapp-tw-border up-steps-item__wrapper__circle",
                style: _nS(circleStyle.value)
              }), [
                isTrue(statusClass.value == 'process' || statusClass.value == 'wait')
                  ? _cE("text", _uM({
                      key: 0,
                      class: "weapp-tw-border up-steps-item__wrapper__circle__text",
    ...
    _cE("view", _uM({
      class: _nC(["weapp-tw-border up-steps-item__content", [`up-steps-item__content--${direction.value}`]]),
      style: _nS(contentStyle.value)
    }), [
      renderSlot(_ctx.$slots, "content", _uM({ index: stepIndex.value }), (): any[] => [
        renderSlot(_ctx.$slots, "title", {}, (): any[] => [
          _cE("text", _uM({
            class: "weapp-tw-border up-steps-item__content__title-text",
        ...
        renderSlot(_ctx.$slots, "desc", {}, (): any[] => [
          _ctx.desc.toString() != ''
            ? _cE("text", _uM({
                key: 0,
                class: "weapp-tw-border up-steps-item__content__desc-text",
