...
__ins.emit(event, ...do_not_transform_spread)
	...
	const customDividerStyle = computed((): UTSJSONObject => {
...
const _component_up_line = resolveEasyComponent("up-line",_easycom_up_line)
  ...
  return _cE("view", _uM({
    class: "weapp-tw-border up-divider",
    style: _nS(customDividerStyle.value),
    ...
    isTrue(_ctx.dot)
      ? _cE("text", _uM({
          key: 0,
          class: "weapp-tw-border up-divider__dot"
        }), "●")
      : isTrue(_ctx.text)
        ? _cE("text", _uM({
            key: 1,
            class: "weapp-tw-border up-divider__text",
