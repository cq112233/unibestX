...
const _component_up_overlay = resolveEasyComponent("up-overlay",_easycom_up_overlay)
  ...
  return _cE("view", _uM({ class: "weapp-tw-border up-toast" }), [
    _cV(_component_up_overlay, _uM({
      ...
      default: withSlotCtx((): any[] => [
        _cE("view", _uM({
          class: _nC(["weapp-tw-border up-toast__content", ['up-type-' + tmpConfig.value['type'], (tmpConfig.value['type'] === 'loading' || tmpConfig.value['loading'] as boolean) ?  'up-toast__content--loading' : '']]),
          ...
          isTrue(tmpConfig.value['type'] === 'loading' || tmpConfig.value['loading'] as boolean)
            ...
            : _cC("v-if", true),
          _cE("text", _uM({
            class: _nC(["weapp-tw-border up-toast__content__text", ['up-toast__content__text--' + tmpConfig.value['type']]]),
