...
const _component_up_swiper_indicator = resolveEasyComponent("up-swiper-indicator",_easycom_up_swiper_indicator)
  ...
  return _cE("view", _uM({
    class: "weapp-tw-border up-swiper",
    style: _nS(swiperContainerStyle.value)
  }), [
    isTrue(_ctx.loading)
      ? _cE("view", _uM({
          key: 0,
          class: "weapp-tw-border up-swiper__loading"
        }), [
          ...
          _cE(Fragment, null, RenderHelpers.renderList(_ctx.list, (item, index, __index, _cached): any => {
            return _cE("swiper-item", _uM({
              ...
              renderSlot(_ctx.$slots, "default", _uM({
                ...
                _cE("view", _uM({
                  class: "weapp-tw-border up-swiper__wrapper__item__wrapper",
                  ...
                  isTrue(isImageTitleVisible(item))
                    ? _cE("view", _uM({
                        key: 2,
                        class: "weapp-tw-border up-swiper__wrapper__item__wrapper__title"
                      }), [
                        _cE("text", _uM({ class: "weapp-tw-border up-line-1 up-swiper__wrapper__item__wrapper__title-text" }), _tD(getItemTitle(item)), 1 /* TEXT */)
                      ])
                    : _cC("v-if", true)
                ], 4 /* STYLE */)
              ])
    ...
    _cE("view", _uM({
      class: "weapp-tw-border up-swiper__indicator",
