...
const _component_up_icon = resolveEasyComponent("up-icon",_easycom_up_icon)
  ...
  return _cE("view", _uM({
    class: "weapp-tw-border up-notice",
    ...
    renderSlot(_ctx.$slots, "icon", {}, (): any[] => [
      isTrue(_ctx.icon)
        ? _cE("view", _uM({
            key: 0,
            class: "weapp-tw-border up-notice__left-icon"
          }), [
    ...
    _cE("swiper", _uM({
      ...
      _cE(Fragment, null, RenderHelpers.renderList(_ctx.text, (item, index, __index, _cached): any => {
        return _cE("swiper-item", _uM({
          ...
          _cE("text", _uM({
            class: "weapp-tw-border up-notice__swiper__item__text up-line-1",
    ...
    isTrue(['link', 'closable'].includes(_ctx.mode))
      ? _cE("view", _uM({
          key: 0,
          class: "weapp-tw-border up-notice__right-icon"
        }), [
          _ctx.mode === 'link'
            ? _cV(_component_up_icon, _uM({
                key: 0,
