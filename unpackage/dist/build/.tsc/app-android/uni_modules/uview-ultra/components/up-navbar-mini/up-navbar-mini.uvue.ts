...
const _component_up_line = resolveEasyComponent("up-line",_easycom_up_line)
  ...
  return _cE("view", _uM({
    class: _nC(["weapp-tw-border up-navbar-mini", [_ctx.customClass]])
  }), [
    _cE("view", _uM({
      class: _nC(["weapp-tw-border up-navbar-mini__inner", [_ctx.fixed ? 'up-navbar-mini--fixed' : '']])
    }), [
      isTrue(_ctx.safeAreaInsetTop)
        ? _cV(_component_up_status_bar, _uM({ key: 0 }))
        : _cC("v-if", true),
      _cE("view", _uM({
        class: "weapp-tw-border up-navbar-mini__content",
        style: _nS(contentStyle.value)
      }), [
        _cE("view", _uM({
          class: "weapp-tw-border up-navbar-mini__content__left",
        ...
        _cE("view", _uM({
          ...
          style: _nS(_uM({"padding":"10px 10px"}))
        }), [
        ...
        _cE("view", _uM({
          class: "weapp-tw-border up-navbar-mini__content__center",
          onClick: homeClick
        }), [
