...
const _component_up_icon = resolveEasyComponent("up-icon",_easycom_up_icon)
  ...
  return _cE("view", _uM({
    class: _nC(["weapp-tw-border up-radio wtu-dmb0mx-0", [iconPlacementClass.value, borderBottomClass.value]]),
    style: _nS(radioStyle.value),
    onClick: withModifiers(wrapperClickHandler, ["stop"])
  }), [
    _cE("view", _uM({
      class: _nC(["weapp-tw-border up-radio__icon-wrap wtu-dmb0mx-0", iconClasses.value]),
    ...
    renderSlot(_ctx.$slots, "label", _uM({
      ...
      _cE("text", _uM({
        class: _nC(["weapp-tw-border up-radio__label", [elDisabled.value ? 'up-radio__label--disabled' : '']]),
...
const GenUniModulesUviewUltraComponentsUpRadioUpRadioStyles = [_uM([["weapp-tw-border", _pS(_uM([["borderTopWidth", 0], ["borderRightWidth", 0], ["borderBottomWidth", 0], ["borderLeftWidth", 0]]))], ["up-radio", _pS(_uM([["display", "flex"], ["flexDirection", "row"], ["overflow", "hidden"], ["alignItems", "center"], ["marginBottom", 5], ["marginTop", 5]]))], ["up-radio-label--left", _pS(_uM([["flexDirection", "row"]]))], ["up-radio-label--right", _pS(_uM([["flexDirection", "row-reverse"], ["justifyContent", "space-between"]]))], ["up-radio__icon-wrap", _pS(_uM([["display", "flex"], ["flexDirection", "row"], ["alignItems", "center"], ["justifyContent", "center"], ["marginRight", 6], ["borderTopWidth", 1], ["borderRightWidth", 1], ["borderBottomWidth", 1], ["borderLeftWidth", 1], ["borderTopColor", "#c8c9cc"], ["borderRightColor", "#c8c9cc"], ["borderBottomColor", "#c8c9cc"], ["borderLeftColor", "#c8c9cc"], ["borderTopStyle", "solid"], ["borderRightStyle", "solid"], ["borderBottomStyle", "solid"], ["borderLeftStyle", "solid"]]))], ["up-radio__icon-wrap--circle", _pS(_uM([["borderTopLeftRadius", 100], ["borderTopRightRadius", 100], ["borderBottomRightRadius", 100], ["borderBottomLeftRadius", 100]]))], ["up-radio__icon-wrap--square", _pS(_uM([["borderTopLeftRadius", 3], ["borderTopRightRadius", 3], ["borderBottomRightRadius", 3], ["borderBottomLeftRadius", 3]]))], ["up-radio__icon-wrap--checked", _pS(_uM([["backgroundColor", "#FF0000"], ["borderTopColor", "#2979ff"], ["borderRightColor", "#2979ff"], ["borderBottomColor", "#2979ff"], ["borderLeftColor", "#2979ff"]]))], ["up-radio__icon-wrap--active", _pS(_uM([["backgroundColor", "#2979ff"], ["borderTopColor", "#2979ff"], ["borderRightColor", "#2979ff"], ["borderBottomColor", "#2979ff"], ["borderLeftColor", "#2979ff"]]))], ["up-radio__icon-wrap--disabled", _pS(_uM([["backgroundColor", "#ebedf0"]]))], ["up-radio__icon-wrap--disabled--checked", _pS(_uM([["color", "#c8c9cc"]]))], ["up-radio__label", _pS(_uM([["marginLeft", 5], ["marginRight", 12], ["color", "#606266"], ["fontSize", 15]]))], ["up-radio__label--disabled", _pS(_uM([["color", "#c8c9cc"]]))], ["wtu-dmb0mx-0", _pS(_uM([["cursor", "pointer"]]))]])]
