...
const _component_up_popup = resolveEasyComponent("up-popup",_easycom_up_popup)
  ...
  return _cV(_component_up_popup, _uM({
    ...
    default: withSlotCtx((): any[] => [
      _cE("view", _uM({ class: "weapp-tw-border up-action-sheet" }), [
        isTrue(_ctx.title)
          ? _cE("view", _uM({
              key: 0,
              class: "weapp-tw-border up-action-sheet__header"
            }), [
              _cE("text", _uM({ class: "weapp-tw-border up-action-sheet__header__title up-line-1" }), _tD(_ctx.title), 1 /* TEXT */),
              _cE("view", _uM({
                class: "weapp-tw-border up-action-sheet__header__icon-wrap",
        ...
        isTrue(_ctx.description)
          ? _cE("text", _uM({
              key: 1,
              class: "weapp-tw-border up-action-sheet__description",
              style: _nS([_uM({
        ...
        renderSlot(_ctx.$slots, "default", {}, (): any[] => [
          ...
          _cE("scroll-view", _uM({
            ...
            style: _nS(_uM({maxHeight: _ctx.wrapMaxHeight}))
          }), [
            _cE(Fragment, null, RenderHelpers.renderList(_ctx.actions, (item, index, __index, _cached): any => {
              return _cE("view", _uM({
                ...
                _cE("view", _uM({
                  class: "weapp-tw-border up-action-sheet__item-wrap__item",
                  onClick: withModifiers(() => {selectHandler(index)}, ["stop"]),
                  ...
                  isTrue(item['loading'])
                    ...
                    : _cE(Fragment, _uM({ key: 1 }), [
                        _cE("text", _uM({
                          class: "weapp-tw-border up-action-sheet__item-wrap__item__name",
                          style: _nS([itemStyle.value(index)])
                        }), _tD(item['name']), 5 /* TEXT, STYLE */),
                        item['subname'] != ''
                          ? _cE("text", _uM({
                              key: 0,
                              class: "weapp-tw-border up-action-sheet__item-wrap__item__subname"
                            }), _tD(item['subname']), 1 /* TEXT */)
                          : _cC("v-if", true)
                      ], 64 /* STABLE_FRAGMENT */)
                ], 8 /* PROPS */, ["onClick", "hover-class"]),
        ...
        isTrue(_ctx.cancelText)
          ? _cE("view", _uM({
              key: 3,
              class: "weapp-tw-border up-action-sheet__item-wrap__item up-action-sheet__cancel",
