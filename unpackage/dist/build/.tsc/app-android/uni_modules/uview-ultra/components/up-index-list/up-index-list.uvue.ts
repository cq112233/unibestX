...
const _component_up_transition = resolveEasyComponent("up-transition",_easycom_up_transition)
  ...
  return _cE("view", _uM({
    ref: "up-index-list",
    class: "weapp-tw-border up-index-list"
  }), [
    isTrue(_ctx.sticky && activeIndex.value >= 0 && activeIndex.value < uIndexList.value.length)
      ? _cE("view", _uM({
          key: 0,
          class: "weapp-tw-border up-index-list__sticky-header",
    ...
    _cE("scroll-view", _uM({
      ...
      _ctx.$slots['header'] != null
        ? _cE("view", _uM({
            key: 0,
            class: "weapp-tw-border up-index-list__header"
          }), [
      ...
      _ctx.$slots['footer'] != null
        ? _cE("view", _uM({
            key: 1,
            class: "weapp-tw-border up-index-list__footer"
          }), [
    ...
    _cE("view", _uM({
      class: "weapp-tw-border up-index-list__letter",
      ...
      _cE(Fragment, null, RenderHelpers.renderList(uIndexList.value, (item, index, __index, _cached): any => {
        return _cE("view", _uM({
          class: _nC(["weapp-tw-border up-index-list__letter__item", _uM({'up-index-list__letter__item--active': activeIndex.value == index && _ctx.activeColor == '#5677fc'})]),
          key: index,
          style: _nS(getItemStyle(index))
        }), [
          _cE("text", _uM({
            class: "weapp-tw-border up-index-list__letter__item__index",
    ...
    _cV(_component_up_transition, _uM({
      ...
      default: withSlotCtx((): any[] => [
        _cE("view", _uM({
          class: _nC(["weapp-tw-border up-index-list__indicator", ['up-index-list__indicator--show']]),
          style: _nS(indicatorBoxStyle.value)
        }), [
          _cE("text", _uM({ class: "weapp-tw-border up-index-list__indicator__text" }), _tD(activeIndex.value >= 0 ? keyVal(uIndexList.value[activeIndex.value]) : ''), 1 /* TEXT */)
        ], 4 /* STYLE */)
      ]),
      _: 1 /* STABLE */
