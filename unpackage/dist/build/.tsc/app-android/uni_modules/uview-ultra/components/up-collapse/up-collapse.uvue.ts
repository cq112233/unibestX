...
const _component_up_line = resolveEasyComponent("up-line",_easycom_up_line)
  ...
  return _cE("view", _uM({ class: "weapp-tw-border up-collapse" }), [
    isTrue(_ctx.border)
