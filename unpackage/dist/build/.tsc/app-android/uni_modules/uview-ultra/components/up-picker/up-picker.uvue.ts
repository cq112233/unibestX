...
name: 'up-picker',
  props: {
    ...
    hasInput: { type: Boolean, required: false, default: false },
    placeholder: { type: String, required: false, default: '请选择' },
    show: { type: Boolean, required: false, default: false },
    popupMode: { type: String, required: false, default: 'bottom' },
    pageInline: { type: Boolean, required: false, default: false },
    showToolbar: { type: Boolean, required: false, default: true },
    toolbarRightSlot: { type: Boolean, required: false, default: false },
    toolbarBottomSlot: { type: Boolean, required: false, default: false },
    title: { type: String, required: false, default: '' },
    columns: { type: Array as PropType<Array<Array<any>>>, required: false, default: () : Array<Array<any>> => [] },
    loading: { type: Boolean, required: false, default: false },
    itemHeight: { type: [String, Number], required: false, default: 44 },
    cancelText: { type: String, required: false, default: '取消' },
    confirmText: { type: String, required: false, default: '确定' },
    cancelColor: { type: String, required: false, default: '#909193' },
    confirmColor: { type: String, required: false, default: '#3c9cff' },
    visibleItemCount: { type: [String, Number], required: false, default: 5 },
    keyName: { type: String, required: false, default: 'text' },
    closeOnClickOverlay: { type: Boolean, required: false, default: false },
    defaultIndex: { type: Array as PropType<number[]>, required: false, default: () : number[] => [] },
    immediateChange: { type: Boolean, required: false, default: true }
  },
...
const _component_up_popup = resolveEasyComponent("up-popup",_easycom_up_popup)
  ...
  return _cE("view", _uM({ class: "weapp-tw-border up-picker-wrapper" }), [
    isTrue(_ctx.hasInput)
      ? _cE("view", _uM({
          key: 0,
          class: "weapp-tw-border up-picker-input wtu-1uhk8f1-0",
          onClick: () => {showByClickInput.value = !showByClickInput.value}
        }), [
          renderSlot(_ctx.$slots, "default", {}, (): any[] => [
            _cE("view", _uM({ class: "weapp-tw-border" }), _tD(inputLabel.value.length > 0 ? inputLabel.value.join('/') : _ctx.placeholder), 1 /* TEXT */)
          ])
        ], 8 /* PROPS */, ["onClick"])
      : _cC("v-if", true),
    _cV(_component_up_popup, _uM({
      show: _ctx.pageInline || _ctx.show || (_ctx.hasInput && showByClickInput.value),
      mode: _ctx.popupMode,
      pageInline: _ctx.pageInline,
      onClose: closeHandler
    }), _uM({
      default: withSlotCtx((): any[] => [
        _cE("view", _uM({ class: "weapp-tw-border up-picker" }), [
          ...
          isTrue(_ctx.toolbarBottomSlot)
            ...
            : _cC("v-if", true),
          _cE("view", _uM({
            class: "weapp-tw-border up-picker__body",
            style: _nS(_uM({ height: pickerViewHeight.value }))
          }), [
            _cE("view", _uM({
              class: "weapp-tw-border up-picker__indicator",
              style: _nS(indicatorStyle.value)
            }), null, 4 /* STYLE */),
            _cE("view", _uM({
              class: "weapp-tw-border up-picker__mask up-picker__mask--top",
              style: _nS(_uM({ height: indicatorTop.value }))
            }), null, 4 /* STYLE */),
            _cE("view", _uM({
              class: "weapp-tw-border up-picker__mask up-picker__mask--bottom",
              style: _nS(_uM({ height: indicatorTop.value }))
            }), null, 4 /* STYLE */),
            _cE("view", _uM({ class: "weapp-tw-border up-picker__columns" }), [
              _cE(Fragment, null, RenderHelpers.renderList(innerColumns.value, (column, colIndex, __index, _cached): any => {
                return _cE("scroll-view", _uM({
                  ...
                  _cE(Fragment, null, RenderHelpers.renderList(column, (item, itemIndex, __index, _cached): any => {
                    return _cE("view", _uM({
                      key: itemIndex,
                      class: "weapp-tw-border up-picker__item",
                      style: _nS(itemStyle.value),
                      onClick: () => {onItemClick(colIndex, itemIndex)}
                    }), [
                      _cE("text", _uM({
                        class: "weapp-tw-border up-picker__item__text",
          ...
          isTrue(_ctx.loading)
            ? _cE("view", _uM({
                key: 2,
                class: "weapp-tw-border up-picker--loading"
              }), [
