...
__ins.emit(event, ...do_not_transform_spread)
	...
	const customCellStyle = computed((): UTSJSONObject => {
...
const _component_up_line = resolveEasyComponent("up-line",_easycom_up_line)
  ...
  return _cE("view", _uM({
    class: _nC(["weapp-tw-border up-cell", [_ctx.customClass]]),
    style: _nS(customCellStyle.value),
    "hover-class": (!_ctx.disabled && (_ctx.clickable || _ctx.isLink)) ? 'up-cell--clickable' : '',
    "hover-stay-time": 250,
    onClick: clickHandler
  }), [
    _cE("view", _uM({
      class: _nC(["weapp-tw-border up-cell__body", _uM({ 'up-cell--center': _ctx.center, 'up-cell__body--large': _ctx.size == 'large' })])
    }), [
      _cE("view", _uM({ class: "weapp-tw-border up-cell__body__content" }), [
        isTrue(_ctx.$slots['icon'] != null || _ctx.icon != '')
          ? _cE("view", _uM({
              key: 0,
              class: "weapp-tw-border up-cell__left-icon-wrap"
            }), [
          ...
          : _cC("v-if", true),
        _cE("view", _uM({ class: "weapp-tw-border up-cell__title" }), [
          isTrue(_ctx.$slots['title'] != null && _ctx.title == '')
            ? renderSlot(_ctx.$slots, "title", _uM({ key: 0 }))
            : _cE("text", _uM({
                key: 1,
                class: _nC(["weapp-tw-border up-cell__title-text", _uM({ 'up-cell--disabled': _ctx.disabled, 'up-cell__title-text--large': _ctx.size == 'large' })]),
          ...
          renderSlot(_ctx.$slots, "label", {}, (): any[] => [
            _ctx.label != ''
              ? _cE("text", _uM({
                  key: 0,
                  class: _nC(["weapp-tw-border up-cell__label", _uM({ 'up-cell--disabled': _ctx.disabled, 'up-cell__label--large': _ctx.size == 'large' })])
                }), _tD(_ctx.label), 3 /* TEXT, CLASS */)
              : _cC("v-if", true)
          ])
        ])
      ]),
      renderSlot(_ctx.$slots, "value", {}, (): any[] => [
        testEmpty(_ctx.value) == false
          ? _cE("text", _uM({
              key: 0,
              class: _nC(["weapp-tw-border up-cell__value", _uM({ 'up-cell--disabled': _ctx.disabled, 'up-cell__value--large': _ctx.size == 'large' })])
            }), _tD(_ctx.value), 3 /* TEXT, CLASS */)
          : _cC("v-if", true)
      ]),
      isTrue(_ctx.$slots['right-icon'] != null || _ctx.isLink)
        ? _cE("view", _uM({
            key: 0,
            class: _nC(["weapp-tw-border up-cell__right-icon-wrap", [`up-cell__right-icon-wrap--${_ctx.arrowDirection}`]])
          }), [
