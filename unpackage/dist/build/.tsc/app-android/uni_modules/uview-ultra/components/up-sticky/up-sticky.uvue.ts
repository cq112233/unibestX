...
return (): any | null => {
  ...
  return _cE("view", _uM({
    class: "weapp-tw-border up-sticky",
    id: elId.value,
    style: _nS(wrapperStyle.value)
  }), [
    _cE("view", _uM({
      class: "weapp-tw-border up-sticky__content",
...
const GenUniModulesUviewUltraComponentsUpStickyUpStickyStyles = [_uM([["weapp-tw-border", _pS(_uM([["borderTopWidth", 0], ["borderRightWidth", 0], ["borderBottomWidth", 0], ["borderLeftWidth", 0]]))], ["up-sticky", _pS(_uM([["width", "100%"], ["boxSizing", "border-box"]]))], ["up-sticky__content", _pS(_uM([["boxSizing", "border-box"]]))]])]
