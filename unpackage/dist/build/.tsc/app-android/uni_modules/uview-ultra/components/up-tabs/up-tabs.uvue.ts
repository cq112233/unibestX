...
const _component_up_badge = resolveEasyComponent("up-badge",_easycom_up_badge)
  ...
  return _cE("view", _uM({ class: "weapp-tw-border up-tabs" }), [
    _cE("view", _uM({
      class: "weapp-tw-border up-tabs__wrapper",
      style: _nS(tabsWrapperStyle.value)
    }), [
      renderSlot(_ctx.$slots, "left"),
      _cE("view", _uM({ class: "weapp-tw-border up-tabs__wrapper__scroll-view-wrapper" }), [
        _cE("scroll-view", _uM({
          ...
          _cE("view", _uM({
            class: "weapp-tw-border up-tabs__wrapper__nav",
            ref: "up-tabs__wrapper__nav",
            style: _nS(tabsWrapperStyle.value)
          }), [
            _cE(Fragment, null, RenderHelpers.renderList(_ctx.list, (item, index, __index, _cached): any => {
              return _cE("view", _uM({
                class: _nC(["weapp-tw-border up-tabs__wrapper__nav__item", [`up-tabs__wrapper__nav__item-${index}`,
                ...
                isTrue(_ctx.$slots['icon'])
                  ...
                  : _cE(Fragment, _uM({ key: 1 }), [
                      item['icon'] != null
                        ? _cE("view", _uM({
                            key: 0,
                            class: "weapp-tw-border up-tabs__wrapper__nav__item__prefix-icon"
                          }), [
                ...
                _ctx.$slots['content'] != null
                  ...
                  : isTrue(_ctx.$slots['content'] == null && (_ctx.$slots['default'] != null || _ctx.$slots['$default'] != null))
                    ...
                    : _cE("text", _uM({
                        key: 4,
                        class: _nC([[(item['disabled'] != null && (item['disabled'] as boolean)) ? 'up-tabs__wrapper__nav__item__text--disabled' : ''], "weapp-tw-border up-tabs__wrapper__nav__item__text"]),
            ...
            _cE("view", _uM({
              class: "weapp-tw-border up-tabs__wrapper__nav__line",
