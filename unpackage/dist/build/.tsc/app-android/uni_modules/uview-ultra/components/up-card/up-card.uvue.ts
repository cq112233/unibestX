...
return (): any | null => {
  ...
  return _cE("view", _uM({
    class: _nC(["weapp-tw-border up-card", _uM({ 'up-border': _ctx.border, 'up-card-full': _ctx.full,
    ...
    isTrue(_ctx.showHead)
      ? _cE("view", _uM({
          key: 0,
          class: _nC(["weapp-tw-border up-card__head", _uM({
          ...
          _ctx.$slots['head'] == null
            ? _cE("view", _uM({
                key: 0,
                class: "weapp-tw-border up-flex up-row-between up-flex-between up-flex-items-center"
              }), [
                _ctx.title != ''
                  ? _cE("view", _uM({
                      key: 0,
                      class: "weapp-tw-border up-card__head--left up-flex up-flex-items-center up-line-11"
                    }), [
                      realThumb.value != ''
                        ? _cE("image", _uM({
                            key: 0,
                        ...
                        : _cC("v-if", true),
                      _cE("text", _uM({
                        class: "weapp-tw-border up-card__head--left__title up-line-1",
                ...
                _ctx.subTitle != ''
                  ? _cE("view", _uM({
                      key: 1,
                      class: "weapp-tw-border up-card__head--right up-line-1"
                    }), [
                      _cE("text", _uM({
                        class: "weapp-tw-border up-card__head__title__text",
    ...
    _cE("view", _uM({
      onClick: bodyClick,
      class: "weapp-tw-border up-card__body",
    ...
    isTrue(_ctx.showFoot)
      ? _cE("view", _uM({
          key: 1,
          class: _nC(["weapp-tw-border up-card__foot", _uM({
