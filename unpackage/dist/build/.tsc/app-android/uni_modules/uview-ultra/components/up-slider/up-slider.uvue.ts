...
const _component_slider = resolveComponent("slider")
  ...
  return _cE("view", _uM({
    class: "weapp-tw-border up-slider",
    ...
    isTrue(!_ctx.useNative || _ctx.isRange)
      ? _cE(Fragment, _uM({ key: 0 }), [
          _cE("view", _uM({
            ...
            class: _nC(["weapp-tw-border up-slider-inner", [_ctx.disabled ? 'up-slider--disabled' : '']]),
            onClick: onClick,
            ...
            _cE("view", _uM({
              class: "weapp-tw-border up-slider__base",
              style: _nS(baseStyleCpu.value)
            }), null, 4 /* STYLE */),
            _cE("view", _uM({
              onClick: onClick,
              class: "weapp-tw-border up-slider__gap",
              style: _nS(gapStyleCpu.value)
            }), null, 4 /* STYLE */),
            isTrue(_ctx.isRange)
              ? _cE("view", _uM({
                  key: 0,
                  class: "weapp-tw-border up-slider__gap up-slider__gap-0",
            ...
            isTrue(_ctx.isRange && _ctx.showValue)
              ? _cE("text", _uM({
                  key: 1,
                  class: "weapp-tw-border up-slider__show-range-value",
            ...
            isTrue(_ctx.isRange)
              ? _cE("view", _uM({
                  key: 3,
                  class: "weapp-tw-border up-slider__button-wrap up-slider__button-wrap-0",
          ...
          isTrue(_ctx.showValue && !_ctx.isRange)
            ? _cE("view", _uM({
                key: 0,
                class: "weapp-tw-border up-slider__show-value"
