...
return (): any | null => {
  ...
  return isTrue(_ctx.show)
    ? _cE("view", _uM({
        key: 0,
        class: "weapp-tw-border up-toolbar",
        onTouchmove: withModifiers(noop, ["stop"])
      }), [
        _cE("view", _uM({ class: "weapp-tw-border up-toolbar__left" }), [
          _cE("view", _uM({
            class: "weapp-tw-border up-toolbar__cancel__wrapper",
            "hover-class": "up-hover-class"
          }), [
            _cE("text", _uM({
              class: "weapp-tw-border up-toolbar__wrapper__cancel",
              onClick: cancel,
        ...
        _ctx.title != ''
          ? _cE("text", _uM({
              key: 0,
              class: "weapp-tw-border up-toolbar__title up-line-1"
            }), _tD(_ctx.title), 1 /* TEXT */)
          : _cC("v-if", true),
        _cE("view", _uM({ class: "weapp-tw-border up-toolbar__right" }), [
          isTrue(!_ctx.rightSlot)
            ? _cE("view", _uM({
                key: 0,
                class: "weapp-tw-border up-toolbar__confirm__wrapper",
                "hover-class": "up-hover-class"
              }), [
                _cE("text", _uM({
                  class: "weapp-tw-border up-toolbar__wrapper__confirm",
                  onClick: confirm,
