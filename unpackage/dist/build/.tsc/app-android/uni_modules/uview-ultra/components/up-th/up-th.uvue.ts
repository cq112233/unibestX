...
return (): any | null => {
  ...
  return _cE("view", _uM({
    class: _nC(["weapp-tw-border up-th", [_ctx.customClass]]),
    style: _nS(mergedThStyle.value)
  }), [
    renderSlot(_ctx.$slots, "default", {}, (): any[] => [
      _cE("text", _uM({
        class: "weapp-tw-border up-th__text",
...
const GenUniModulesUviewUltraComponentsUpThUpThStyles = [_uM([["weapp-tw-border", _pS(_uM([["borderTopWidth", 0], ["borderRightWidth", 0], ["borderBottomWidth", 0], ["borderLeftWidth", 0]]))], ["up-th", _pS(_uM([["display", "flex"], ["flexDirection", "column"], ["flexGrow", 1], ["flexShrink", 1], ["flexBasis", "0%"], ["justifyContent", "center"], ["backgroundColor", "#f5f6f8"]]))], ["up-th__text", _pS(_uM([["fontSize", 14], ["color", "#303133"], ["fontWeight", "bold"]]))]])]
