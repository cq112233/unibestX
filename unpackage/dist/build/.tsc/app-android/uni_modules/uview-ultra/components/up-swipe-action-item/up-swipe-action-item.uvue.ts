...
const _component_up_icon = resolveEasyComponent("up-icon",_easycom_up_icon)
  ...
  return _cE("view", _uM({
    class: "weapp-tw-border up-swipe-action-item",
    ref: "swipeActionItemRef"
  }), [
    _cE("view", _uM({
      class: "weapp-tw-border up-swipe-action-item__right",
      ref: "rightButtonsRef"
    }), [
      renderSlot(_ctx.$slots, "button", {}, (): any[] => [
        _cE(Fragment, null, RenderHelpers.renderList(_ctx.options, (item, index, __index, _cached): any => {
          return _cE("view", _uM({
            key: index,
            class: "weapp-tw-border up-swipe-action-item__right__button",
            style: _nS(getButtonStyle(item)),
            onClick: () => {buttonClickHandler(item, index)}
          }), [
            _cE("view", _uM({
              class: _nC(["weapp-tw-border up-swipe-action-item__right__button__wrapper", _uM({
              ...
              item['text'] != null
                ? _cE("text", _uM({
                    key: 1,
                    class: "weapp-tw-border up-swipe-action-item__right__button__wrapper__text up-line-1",
    ...
    _cE("view", _uM({
      class: "weapp-tw-border up-swipe-action-item__content",
