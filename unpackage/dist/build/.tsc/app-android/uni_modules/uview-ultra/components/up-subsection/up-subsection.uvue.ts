...
return (): any | null => {
  ...
  return _cE("view", _uM({
    class: _nC(["weapp-tw-border up-subsection", [`up-subsection--${_ctx.mode}`]]),
    ref: "upSubsectionRef",
    style: _nS(computedRootStyle.value)
  }), [
    _cE("view", _uM({
      class: "weapp-tw-border up-subsection__bar wtu-cqyuct-0",
      style: _nS(barStyle.value)
    }), [
      _cE("view", _uM({
        class: _nC(["weapp-tw-border up-subsection__bar__inner", _uM({
    ...
    _cE(Fragment, null, RenderHelpers.renderList(_ctx.list, (item, index, __index, _cached): any => {
      return _cE("view", _uM({
        class: _nC(["weapp-tw-border up-subsection__item wtu-cqyuct-0", [
        ...
        renderSlot(_ctx.$slots, "item", _uM({
          ...
          _cE("text", _uM({
            class: _nC(["weapp-tw-border up-subsection__item__text", [
