...
const _component_up_icon = resolveEasyComponent("up-icon",_easycom_up_icon)
  ...
  return _cE("view", _uM({ class: "weapp-tw-border up-number-box" }), [
    isTrue(_ctx.showMinus && !hideMinus.value && _ctx.$slots['minus'] != null)
      ? _cE("view", _uM({
          key: 0,
          class: "weapp-tw-border up-number-box__slot wtu-1pb5hvl-0",
      ...
      : isTrue(_ctx.showMinus && !hideMinus.value)
        ? _cE("view", _uM({
            key: 1,
            class: _nC(["weapp-tw-border up-number-box__minus wtu-1pb5hvl-0", _uM({'up-number-box__minus--disabled': isDisabled('minus') })]),
            onClick: withModifiers(() => {clickHandler('minus')}, ["stop"]),
            onTouchstart: () => {onTouchStart('minus')},
            onTouchend: withModifiers(clearTimeoutHandler, ["stop"]),
    ...
    isTrue(_ctx.showPlus && _ctx.$slots['plus'] != null)
      ...
      : isTrue(_ctx.showPlus)
        ? _cE("view", _uM({
            key: 4,
            class: _nC(["weapp-tw-border up-number-box__plus wtu-1pb5hvl-0", _uM({ 'up-number-box__minus--disabled': isDisabled('plus') })]),
            onClick: withModifiers(() => {clickHandler('plus')}, ["stop"]),
            onTouchstart: () => {onTouchStart('plus')},
            onTouchend: withModifiers(clearTimeoutHandler, ["stop"]),
...
const GenUniModulesUviewUltraComponentsUpNumberBoxUpNumberBoxStyles = [_uM([["weapp-tw-border", _pS(_uM([["borderTopWidth", 0], ["borderRightWidth", 0], ["borderBottomWidth", 0], ["borderLeftWidth", 0]]))], ["up-number-box", _pS(_uM([["display", "flex"], ["flexDirection", "row"], ["alignItems", "center"]]))], ["up-number-box__plus", _pS(_uM([["width", 35], ["display", "flex"], ["flexDirection", "row"], ["justifyContent", "center"], ["alignItems", "center"], ["borderTopRightRadius", 4], ["borderBottomRightRadius", 4]]))], ["up-number-box__minus", _pS(_uM([["width", 35], ["display", "flex"], ["flexDirection", "row"], ["justifyContent", "center"], ["alignItems", "center"], ["borderTopLeftRadius", 4], ["borderBottomLeftRadius", 4]]))], ["up-number-box__plus--hover", _pS(_uM([["!backgroundColor", "#E6E6E6"]]))], ["up-number-box__minus--hover", _pS(_uM([["!backgroundColor", "#E6E6E6"]]))], ["up-number-box__plus--disabled", _pS(_uM([["backgroundColor", "#f7f8fa"]]))], ["up-number-box__minus--disabled", _pS(_uM([["backgroundColor", "#f7f8fa"]]))], ["up-number-box__input", _pS(_uM([["textAlign", "center"], ["fontSize", 15], ["paddingTop", 0], ["paddingRight", 0], ["paddingBottom", 0], ["paddingLeft", 0], ["marginTop", 0], ["marginRight", 2], ["marginBottom", 0], ["marginLeft", 2]]))], ["up-number-box__input--disabled", _pS(_uM([["color", "#c8c9cc"], ["backgroundColor", "#f2f3f5"]]))], ["wtu-1pb5hvl-0", _pS(_uM([["cursor", "pointer"]]))]])]
