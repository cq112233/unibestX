...
return (): any | null => {
  ...
  return _cE("view", _uM({ class: "weapp-tw-border up-swiper-indicator" }), [
    _ctx.indicatorMode === 'line'
      ? _cE("view", _uM({
          key: 0,
          class: _nC(["weapp-tw-border up-swiper-indicator__wrapper", [`up-swiper-indicator__wrapper--${_ctx.indicatorMode}`]]),
          style: _nS(lineWrapperStyle.value)
        }), [
          _cE("view", _uM({
            class: "weapp-tw-border up-swiper-indicator__wrapper--line__bar",
    ...
    _ctx.indicatorMode === 'dot'
      ? _cE("view", _uM({
          key: 1,
          class: "weapp-tw-border up-swiper-indicator__wrapper"
        }), [
          _cE(Fragment, null, RenderHelpers.renderList(lengthArray.value, (item, index, __index, _cached): any => {
            return _cE("view", _uM({
              class: _nC(["weapp-tw-border up-swiper-indicator__wrapper__dot", [index === parseInt(_ctx.current.toString()) ? 'up-swiper-indicator__wrapper__dot--active' : '']]),
              key: index,
