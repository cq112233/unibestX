...
function getOtherItemText(item: UPUploadListItem): string {
	...
	if (isVid) {
		...
		return $t("up.common.video", {} as UTSJSONObject)
	}
	if (item.name != null && (item.name as string) != '') return item.name as string
	return $t("up.common.file", {} as UTSJSONObject)
}
            ...
            return _cE("view", _uM({
              ...
              isTrue(item.isImage || (item.type != null && item.type == 'image'))
                ...
                : isTrue((item.isVideo || (item.type != null && item.type == 'video')) && _ctx.getVideoThumb)
                  ? _cE("view", _uM({
                      key: 1,
                      class: "weapp-tw-border up-upload__wrap__preview__video",
                      style: _nS(unref(itemDimensionStyle))
                    }), [
                      isTrue(item.thumb)
                        ? _cE("image", _uM({
                      ...
                      item.status == 'success'
                        ? _cE("view", _uM({
                            key: 2,
                            class: "weapp-tw-border up-upload__wrap__play",
                            onClick: () => {onClickPreview(item, index)}
                          }), [
                  ...
                  : _cE("view", _uM({
                      key: 2,
                      class: "weapp-tw-border up-upload__wrap__preview__other",
                      onClick: () => {onClickPreview(item, index)},
                      style: _nS(unref(itemDimensionStyle))
                    }), [
                      _cV(_component_up_icon, _uM({
                      ...
                      _cE("text", _uM({ class: "weapp-tw-border up-upload__wrap__preview__other__text" }), _tD(getOtherItemText(item)), 1 /* TEXT */)
                    ], 12 /* STYLE, PROPS */, ["onClick"]),
              isTrue(item.status == 'uploading' || item.status == 'failed')
                ? _cE("view", _uM({
                    key: 3,
                    class: "weapp-tw-border up-upload__status"
                  }), [
                    _cE("view", _uM({ class: "weapp-tw-border up-upload__status__icon" }), [
                      item.status == 'failed'
                        ? _cV(_component_up_icon, _uM({
                            key: 0,
                            name: "close-circle",
                    ...
                    isTrue(item.message != null && item.message != '')
                      ? _cE("text", _uM({
                          key: 0,
                          class: "weapp-tw-border up-upload__status__message"
              ...
              isTrue(item.status != 'uploading' && (_ctx.deletable || item.deletable))
                ? _cE("view", _uM({
                    key: 4,
                    class: "weapp-tw-border up-upload__deletable",
                    onClick: withModifiers(() => {deleteItem(index)}, ["stop"])
                  }), [
                    _cE("view", _uM({ class: "weapp-tw-border up-upload__deletable__icon" }), [
                      _cV(_component_up_icon, _uM({
                        name: "close",
                        color: "#ffffff",
                        size: "10"
              ...
              renderSlot(_ctx.$slots, "success", {}, (): any[] => [
                item.status == 'success'
                  ? _cE("view", _uM({
                      key: 0,
                      class: "weapp-tw-border up-upload__success"
                    }), [
                      _cE("view", _uM({ class: "weapp-tw-border up-upload__success__icon" }), [
                        _cV(_component_up_icon, _uM({
                          name: "checkmark",
                          color: "#ffffff",
                          size: "12"
        ...
        ? _cE(Fragment, _uM({ key: 1 }), [
            _ctx.$slots['trigger'] != null
              ...
              : isTrue(_ctx.$slots['trigger'] == null && (_ctx.$slots['default'] != null || _ctx.$slots['$default'] != null))
                ...
                : _cE("view", _uM({
                    key: 2,
                    class: _nC(["weapp-tw-border up-upload__button", [_ctx.disabled ? 'up-upload__button--disabled' : '']]),
                    ...
                    _ctx.uploadText != ''
                      ? _cE("text", _uM({
                          key: 0,
                          class: "weapp-tw-border up-upload__button__text"
