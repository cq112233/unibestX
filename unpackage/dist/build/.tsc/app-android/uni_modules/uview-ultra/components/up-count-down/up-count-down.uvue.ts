...
return (): any | null => {
  ...
  return _cE("view", _uM({ class: "weapp-tw-border up-count-down" }), [
    renderSlot(_ctx.$slots, "default", {}, (): any[] => [
      _cE("text", _uM({ class: "weapp-tw-border up-count-down__text" }), _tD(formattedTime.value), 1 /* TEXT */)
    ])
  ])
}
}
