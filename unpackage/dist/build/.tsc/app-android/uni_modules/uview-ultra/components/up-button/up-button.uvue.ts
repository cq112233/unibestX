...
const textColorCom = computed<string>(() => {
    ...
    if (props.plain) {
        if (props.type == 'primary') return config.getString('color.up-primary') as string
...
const _component_up_icon = resolveEasyComponent("up-icon",_easycom_up_icon)
  ...
  return _cE("view", _uM({
    ...
    class: _nC(["weapp-tw-border up-button", bemClass.value]),
    ...
    isTrue(_ctx.loading)
      ? _cE(Fragment, _uM({ key: 0 }), [
          ...
          _cE("text", _uM({
            class: "weapp-tw-border up-button__text up-button__loading-text",
      ...
      : _cE(Fragment, _uM({ key: 1 }), [
          ...
          renderSlot(_ctx.$slots, "default", {}, (): any[] => [
            _cE("text", _uM({
              class: "weapp-tw-border up-button__text",
              style: _nS(textStyle.value)
