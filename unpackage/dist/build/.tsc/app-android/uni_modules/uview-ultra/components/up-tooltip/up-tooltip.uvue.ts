...
const _component_up_transition = resolveEasyComponent("up-transition",_easycom_up_transition)
  ...
  return _cE("view", _uM({
    class: "weapp-tw-border up-tooltip",
    ...
    _cE("view", _uM({ class: "weapp-tw-border up-tooltip__wrapper" }), [
      isTrue(hasText.value)
        ? _cE("text", _uM({
            key: 0,
            class: "weapp-tw-border up-tooltip__wrapper__text",
            id: textId.value,
            ref: textId.value,
            selectable: false,
        ...
        : _cE("view", _uM({
            key: 1,
            class: "weapp-tw-border up-tooltip__wrapper__trigger",
            id: textId.value,
            ref: textId.value,
            onLongpress: withModifiers(longpressHandler, ["stop"]),
            onClick: withModifiers(clickHandler, ["stop"])
      ...
      _cV(_component_up_transition, _uM({
        ...
        default: withSlotCtx((): any[] => [
          _cE("view", _uM({
            class: "weapp-tw-border up-tooltip__wrapper__popup",
            id: tooltipId.value,
            ref: tooltipId.value
          }), [
            isTrue(showIndicator.value)
              ? _cE("view", _uM({
                  key: 0,
                  class: "weapp-tw-border up-tooltip__wrapper__popup__indicator",
            ...
            renderSlot(_ctx.$slots, "content", {}, (): any[] => [
              _cE("view", _uM({
                class: "weapp-tw-border up-tooltip__wrapper__popup__list",
                style: _nS([popupListStyle.value])
              }), [
                isTrue(showCopyButton.value)
                  ? _cE("view", _uM({
                      key: 0,
                      class: "weapp-tw-border up-tooltip__wrapper__popup__list__btn",
                      "hover-class": "up-tooltip__wrapper__popup__list__btn--hover",
                      onClick: setClipboardData
                    }), [
                      _cE("text", _uM({ class: "weapp-tw-border up-tooltip__wrapper__popup__list__btn__text" }), "复制")
                    ])
                  : _cC("v-if", true),
                ...
                _cE(Fragment, null, RenderHelpers.renderList(buttonItems.value, (item, index, __index, _cached): any => {
                  return _cE(Fragment, _uM({ key: index }), [
                    _cE("view", _uM({
                      ...
                      _cE("text", _uM({ class: "weapp-tw-border up-tooltip__wrapper__popup__list__btn__text" }), _tD(item), 1 /* TEXT */)
                    ], 8 /* PROPS */, ["onClick"]),
