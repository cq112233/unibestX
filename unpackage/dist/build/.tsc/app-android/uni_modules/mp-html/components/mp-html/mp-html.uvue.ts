...
return (): any | null => {
  ...
  return _cE("view", _uM({ class: "weapp-tw-border _mp_root" }), [
                            ...
                            ? _cE("view", _uM({
                                ...
                                _cE(Fragment, null, RenderHelpers.renderList((n.children ?? []), (li, lii, __index, _cached): any => {
                                  return _cE("view", _uM({
                                    ...
                                    _cE("text", _uM({ class: "weapp-tw-border" }), _tD(n.name == 'ol' ? (lii + 1).toString() + '. ' : '• '), 1 /* TEXT */),
                                    _cE("text", _uM({ class: "weapp-tw-border" }), _tD(flatText(li)), 1 /* TEXT */)
                                  ], 4 /* STYLE */)
                                }), 128 /* KEYED_FRAGMENT */)
                              ], 4 /* STYLE */)
                            : _cE("view", _uM({
...
const GenUniModulesMpHtmlComponentsMpHtmlMpHtmlStyles = [_uM([["weapp-tw-border", _pS(_uM([["borderTopWidth", 0], ["borderRightWidth", 0], ["borderBottomWidth", 0], ["borderLeftWidth", 0]]))], ["_mp_root", _pS(_uM([["paddingTop", 1], ["paddingRight", 0], ["paddingBottom", 1], ["paddingLeft", 0]]))], ["mp-a", _pS(_uM([["color", "#366092"]]))]])]
