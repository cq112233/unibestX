...
return (): any | null => {
  ...
  return isTrue(unref(type) == 'font' && !unref(fontLoading))
    ? _cE("text", _uM({
        key: 0,
        class: _nC(["weapp-tw-border l-icon l-icon--font l-class", unref(classes)]),
...
const GenUniModulesLimeIconComponentsLIconLIconStyles = [_uM([["weapp-tw-border", _pS(_uM([["borderTopWidth", 0], ["borderRightWidth", 0], ["borderBottomWidth", 0], ["borderLeftWidth", 0]]))], ["l-icon--font", _pS(_uM([["fontFamily", "l"], ["textAlign", "center"]]))], ["l-icon--image", _pS(_uM([["width", "var(--l-icon-size, 16px)"], ["height", "var(--l-icon-size, 16px)"]]))], ["@FONT-FACE", _uM([["0", _uM([["fontFamily", "l"], ["src", "url(\"/uni_modules/lime-icon/static/app/t4.ttf\")"]])]])]])]
