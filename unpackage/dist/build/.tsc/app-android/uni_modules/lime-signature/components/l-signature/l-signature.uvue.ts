...
return (): any | null => {
  ...
  return _cE("view", _uM({
    class: "weapp-tw-border l-signature",
    style: _nS(unref(drawableStyle)),
    ...
    isTrue(_ctx.landscape)
      ? _cE("view", _uM({
          key: 0,
          class: "weapp-tw-border l-signature-landscape",
...
const GenUniModulesLimeSignatureComponentsLSignatureLSignatureStyles = [_uM([["weapp-tw-border", _pS(_uM([["borderTopWidth", 0], ["borderRightWidth", 0], ["borderBottomWidth", 0], ["borderLeftWidth", 0]]))], ["l-signature", _pS(_uM([["flexGrow", 1], ["flexShrink", 1], ["flexBasis", "0%"], ["width", "100%"], ["height", "100%"]]))], ["l-signature__canvas", _pS(_uM([["width", "100%"], ["height", "100%"]]))], ["l-signature-landscape", _pS(_uM([["position", "absolute"], ["pointerEvents", "none"], ["overflow", "visible"], ["left", "99.9%"]]))], ["l-signature-image", _pS(_uM([["transformOrigin", "0% 0%"]]))]])]
