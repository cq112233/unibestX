import type { CustomTabBarItem, CustomTabBarItemBadge, TabBarConfig } from '../types';
import { customTabbarConfig } from '../config';

/** 组合 list 与 midButton 供自定义 TabBar 渲染（自动将 midButton 插入居中位置） */
export function buildFullTabbarList(config: TabBarConfig): CustomTabBarItem[] {
...
/** 快捷导出供自定义 Tabbar 组件渲染的完整列表 */
export const customTabbarList: CustomTabBarItem[] = buildFullTabbarList(customTabbarConfig);
