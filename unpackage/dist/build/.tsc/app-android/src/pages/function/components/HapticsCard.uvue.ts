...
return (): any | null => {
  ...
  return _cV(unref(Card), _uM({ title: "触感与工具" }), _uM({
    default: withSlotCtx((): any[] => [
      _cE("view", _uM({ class: "weapp-tw-border wtu-1pqljrd-0 wtu-1nsrzwm-1 wtu-z7ly8f-2 wtu-cu4oh8-3 wtu-1ae0mn0-4 wtu-1dpq0lu-5" }), [
        _cE("text", _uM({ class: "weapp-tw-border wtu-1e3pw8z-6 wtu-xlfis6-7 wtu-1174kp0-8" }), "剪贴板测试文本"),
        _cE("input", _uM({
        ...
        _cE("view", _uM({
          class: "weapp-tw-border wtu-1phhh09-h wtu-14leste-9 wtu-18u1qwy-i wtu-1km86q6-j wtu-snabsj-k wtu-1e9fgzq-l wtu-15f70xm-m wtu-1kekspa-n",
          onClick: handleCopy
        }), [
          _cE("text", _uM({ class: "weapp-tw-border wtu-199nxoz-o wtu-wgd06p-e wtu-17exkt3-p" }), "复制测试文本")
        ])
      ]),
      _cE("view", _uM({
        class: "weapp-tw-border wtu-1phhh09-h wtu-1i30ucf-q wtu-18u1qwy-i wtu-nwcnqo-r wtu-snabsj-k wtu-1e9fgzq-l wtu-15f70xm-m wtu-1kekspa-n",
        onClick: triggerVibration
      }), [
        _cE("text", _uM({ class: "weapp-tw-border wtu-199nxoz-o wtu-wgd06p-e wtu-17exkt3-p" }), "短震动反馈")
      ])
    ]),
    _: 1 /* STABLE */
  }))
