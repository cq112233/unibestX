  ...
  return _cV(unref(AppKu), null, _uM({
    default: withSlotCtx((): any[] => [
      _cV(unref(LayoutComponent), _uM({
        ...
        default: withSlotCtx((): any[] => [
          _cE("view", null, [
            _cE("view", _uM({ class: "wtu-1i41ley-0 wtu-1a1clmh-1 wtu-qtpsxx-2" }), [
              _cE("text", _uM({ class: "wtu-ympeof-3 wtu-dexfdw-4 wtu-1macy2r-5" }), "设备系统信息"),
              _cE("text", _uM({ class: "wtu-1q99rg1-6 wtu-17u3i8b-7 wtu-1g5yxwv-8" }), "演示 iOS/Android 原生设备 API 调用与状态读取")
            ]),
            _cV(unref(EnvCard)),
