...
return (): any | null => {
  ...
  return _cV(unref(Card), _uM({ title: "Lodash 工具库 (iRainna-lodash)" }), _uM({
    default: withSlotCtx((): any[] => [
      _cE("view", _uM({ class: "weapp-tw-border wtu-99n919-0 wtu-15nin6-1 wtu-kwjfx7-2 wtu-1ip6ax4-3 wtu-1379u88-4 wtu-1v5vx5i-5" }), [
        _cE("text", _uM({ class: "weapp-tw-border wtu-wt9zgi-6 wtu-1u1vbk3-7 wtu-vhwil1-8 wtu-12p3ytc-9" }), "1. 数组切片去重与随机打乱 (chunk, uniq, shuffle)"),
        _cE("view", _uM({ class: "weapp-tw-border wtu-12p3ytc-9" }), [
          _cE("text", _uM({ class: "weapp-tw-border wtu-nlue1j-a wtu-g2bdc6-b" }), "原始数组 (带重复元素):"),
          _cE("text", _uM({
            class: "weapp-tw-border result-text wtu-wt9zgi-6 wtu-qhe427-c wtu-12jpf2i-d wtu-efn5x4-e",
            style: _nS(_uM({"font-family":"monospace"}))
          }), _tD(JSON.stringify(rawArray.value)), 5 /* TEXT, STYLE */)
        ]),
        _cE("view", _uM({ class: "weapp-tw-border wtu-12p3ytc-9" }), [
          _cE("text", _uM({ class: "weapp-tw-border wtu-nlue1j-a wtu-g2bdc6-b" }), "_.uniq 去重结果:"),
          _cE("text", _uM({
            class: "weapp-tw-border result-text wtu-wt9zgi-6 wtu-1u1vbk3-7 wtu-71osv8-f wtu-efn5x4-e",
            style: _nS(_uM({"font-family":"monospace"}))
          }), _tD(JSON.stringify(uniqArray.value)), 5 /* TEXT, STYLE */)
        ]),
        _cE("view", _uM({ class: "weapp-tw-border wtu-1ukgctb-g" }), [
          _cE("text", _uM({ class: "weapp-tw-border wtu-nlue1j-a wtu-g2bdc6-b" }), "_.chunk 切片结果 (每组 3 个):"),
          _cE("text", _uM({
            class: "weapp-tw-border result-text wtu-nlue1j-a wtu-qhe427-c wtu-1olf5ta-h wtu-efn5x4-e",
            style: _nS(_uM({"font-family":"monospace"}))
          }), _tD(chunkedArray.value), 5 /* TEXT, STYLE */)
        ]),
        _cE("view", _uM({
          class: "weapp-tw-border wtu-zvxz19-i wtu-1hlaid0-j wtu-kkfitq-k wtu-78ho70-l wtu-lfvf6n-m wtu-11fbh7u-n wtu-hehpb2-o wtu-ltxxn6-p",
          onClick: handleShuffle
        }), [
          _cE("text", _uM({ class: "weapp-tw-border wtu-wt9zgi-6 wtu-1u1vbk3-7 wtu-trlwv5-q" }), "点击使用 _.shuffle 打乱数组")
        ])
      ]),
      _cE("view", _uM({ class: "weapp-tw-border wtu-99n919-0 wtu-15nin6-1 wtu-kwjfx7-2 wtu-1ip6ax4-3 wtu-1379u88-4 wtu-1v5vx5i-5" }), [
        _cE("text", _uM({ class: "weapp-tw-border wtu-wt9zgi-6 wtu-1u1vbk3-7 wtu-vhwil1-8 wtu-12p3ytc-9" }), "2. 对象深拷贝与安全取值 (get, cloneDeep)"),
        _cE("view", _uM({ class: "weapp-tw-border wtu-12p3ytc-9" }), [
          _cE("text", _uM({ class: "weapp-tw-border wtu-nlue1j-a wtu-g2bdc6-b" }), "_.get(obj, 'user.info.name', '未找到'):"),
          _cE("text", _uM({
            class: "weapp-tw-border result-text wtu-wt9zgi-6 wtu-1u1vbk3-7 wtu-1olf5ta-h wtu-efn5x4-e",
            style: _nS(_uM({"font-family":"monospace"}))
          }), " \"" + _tD(getNameResult.value) + "\" ", 5 /* TEXT, STYLE */)
        ]),
        _cE("view", _uM({ class: "weapp-tw-border wtu-12p3ytc-9" }), [
          _cE("text", _uM({ class: "weapp-tw-border wtu-nlue1j-a wtu-g2bdc6-b" }), "_.get(obj, 'user.invalid.path', '安全兜底值'):"),
          _cE("text", _uM({
            class: "weapp-tw-border result-text wtu-wt9zgi-6 wtu-1u1vbk3-7 wtu-t30dgu-r wtu-efn5x4-e",
            style: _nS(_uM({"font-family":"monospace"}))
          }), " \"" + _tD(getFallbackResult.value) + "\" ", 5 /* TEXT, STYLE */)
        ]),
        _cE("view", _uM({ class: "weapp-tw-border wtu-ie0kbi-s wtu-x0rgyb-t wtu-26he62-u" })),
        _cE("view", _uM({ class: "weapp-tw-border wtu-12p3ytc-9" }), [
          _cE("text", _uM({ class: "weapp-tw-border wtu-nlue1j-a wtu-g2bdc6-b wtu-16b98e4-v" }), "深拷贝防污染对比 (点击修改深拷贝副本的值):"),
          _cE("view", _uM({ class: "weapp-tw-border wtu-11fbh7u-n wtu-20vb01-w wtu-16b98e4-v" }), [
            _cE("text", _uM({ class: "weapp-tw-border wtu-nlue1j-a wtu-trlwv5-q" }), "原对象 age:"),
            _cE("text", _uM({ class: "weapp-tw-border wtu-nlue1j-a wtu-1u1vbk3-7 wtu-12jpf2i-d" }), _tD(rawObjAge.value), 1 /* TEXT */)
          ]),
          _cE("view", _uM({ class: "weapp-tw-border wtu-11fbh7u-n wtu-20vb01-w wtu-12p3ytc-9" }), [
            _cE("text", _uM({ class: "weapp-tw-border wtu-nlue1j-a wtu-trlwv5-q" }), "副本对象 age:"),
            _cE("text", _uM({ class: "weapp-tw-border wtu-nlue1j-a wtu-1u1vbk3-7 wtu-dvbist-x" }), _tD(clonedObjAge.value), 1 /* TEXT */)
          ]),
          _cE("view", _uM({
            class: "weapp-tw-border wtu-zvxz19-i wtu-1hlaid0-j wtu-kkfitq-k wtu-15b9oe7-y wtu-lfvf6n-m wtu-11fbh7u-n wtu-hehpb2-o wtu-ltxxn6-p",
            onClick: mutateClonedObj
          }), [
            _cE("text", _uM({ class: "weapp-tw-border wtu-wt9zgi-6 wtu-1u1vbk3-7 wtu-fwu98w-z" }), "修改副本 age (+1)")
          ])
        ])
      ]),
      _cE("view", _uM({ class: "weapp-tw-border wtu-99n919-0 wtu-15nin6-1 wtu-kwjfx7-2 wtu-1ip6ax4-3 wtu-1379u88-4 wtu-1v5vx5i-5" }), [
        _cE("text", _uM({ class: "weapp-tw-border wtu-wt9zgi-6 wtu-1u1vbk3-7 wtu-vhwil1-8 wtu-12p3ytc-9" }), "3. 字符串修饰与格式化 (camelCase, kebabCase)"),
        _cE("view", _uM({ class: "weapp-tw-border wtu-1ukgctb-g" }), [
          _cE("text", _uM({ class: "weapp-tw-border wtu-nlue1j-a wtu-g2bdc6-b wtu-16b98e4-v" }), "输入文本:"),
          _cE("input", _uM({
        ...
        _cE("view", _uM({ class: "weapp-tw-border wtu-12p3ytc-9" }), [
          _cE("text", _uM({ class: "weapp-tw-border wtu-nlue1j-a wtu-g2bdc6-b" }), "_.camelCase (驼峰):"),
          _cE("text", _uM({
            class: "weapp-tw-border result-text wtu-wt9zgi-6 wtu-1u1vbk3-7 wtu-en1iwp-13 wtu-efn5x4-e",
            style: _nS(_uM({"font-family":"monospace"}))
          }), _tD(camelCaseResult.value), 5 /* TEXT, STYLE */)
        ]),
        _cE("view", _uM({ class: "weapp-tw-border wtu-12p3ytc-9" }), [
          _cE("text", _uM({ class: "weapp-tw-border wtu-nlue1j-a wtu-g2bdc6-b" }), "_.kebabCase (短横线):"),
          _cE("text", _uM({
            class: "weapp-tw-border result-text wtu-wt9zgi-6 wtu-1u1vbk3-7 wtu-1a9i6pt-14 wtu-efn5x4-e",
            style: _nS(_uM({"font-family":"monospace"}))
          }), _tD(kebabCaseResult.value), 5 /* TEXT, STYLE */)
        ]),
        _cE("view", _uM({ class: "weapp-tw-border wtu-qji53e-15" }), [
          _cE("text", _uM({ class: "weapp-tw-border wtu-nlue1j-a wtu-g2bdc6-b" }), "_.capitalize (首字母大写):"),
          _cE("text", _uM({
            class: "weapp-tw-border result-text wtu-wt9zgi-6 wtu-1u1vbk3-7 wtu-13awefi-16 wtu-efn5x4-e",
            style: _nS(_uM({"font-family":"monospace"}))
          }), _tD(capitalizeResult.value), 5 /* TEXT, STYLE */)
        ])
      ]),
      _cE("view", _uM({ class: "weapp-tw-border wtu-99n919-0 wtu-15nin6-1 wtu-1ip6ax4-3 wtu-1379u88-4 wtu-1v5vx5i-5" }), [
        _cE("text", _uM({ class: "weapp-tw-border wtu-wt9zgi-6 wtu-1u1vbk3-7 wtu-vhwil1-8 wtu-12p3ytc-9" }), "4. 防抖函数与随机数 (debounce, random)"),
        _cE("view", _uM({ class: "weapp-tw-border wtu-11fbh7u-n wtu-hehpb2-o wtu-20vb01-w wtu-1ukgctb-g" }), [
          _cE("view", _uM({ class: "weapp-tw-border wtu-1a16q90-17" }), [
            _cE("text", _uM({ class: "weapp-tw-border wtu-nlue1j-a wtu-g2bdc6-b" }), "防抖点击触发次数 (400ms):"),
            _cE("text", _uM({ class: "weapp-tw-border wtu-nlue1j-a wtu-cgohmy-18" }), "连击时仅在停止 400ms 后加 1")
          ]),
          _cE("text", _uM({ class: "weapp-tw-border wtu-vf75qw-19 wtu-1u1vbk3-7 wtu-6l0vg0-1a" }), _tD(debouncedCount.value), 1 /* TEXT */)
        ]),
        _cE("view", _uM({
          class: "weapp-tw-border wtu-zvxz19-i wtu-1hlaid0-j wtu-kkfitq-k wtu-l4ptrb-1b wtu-lfvf6n-m wtu-11fbh7u-n wtu-hehpb2-o wtu-ltxxn6-p wtu-1ukgctb-g",
          onClick: handleDebounceClick
        }), [
          _cE("text", _uM({ class: "weapp-tw-border wtu-wt9zgi-6 wtu-1u1vbk3-7 wtu-1cplfqo-1c" }), "快速连击测试防抖")
        ]),
        _cE("view", _uM({ class: "weapp-tw-border wtu-ie0kbi-s wtu-x0rgyb-t wtu-26he62-u" })),
        _cE("view", _uM({ class: "weapp-tw-border wtu-11fbh7u-n wtu-hehpb2-o wtu-20vb01-w" }), [
          _cE("text", _uM({ class: "weapp-tw-border wtu-nlue1j-a wtu-g2bdc6-b" }), "_.random(1, 100) 随机数:"),
          _cE("view", _uM({ class: "weapp-tw-border wtu-11fbh7u-n wtu-hehpb2-o" }), [
            _cE("text", _uM({ class: "weapp-tw-border wtu-ualvb1-1d wtu-1u1vbk3-7 wtu-1nj84tt-1e wtu-adf0bz-1f" }), _tD(randomValue.value), 1 /* TEXT */),
            _cE("view", _uM({
              class: "weapp-tw-border wtu-1fv5emj-1g wtu-ersrk-1h wtu-6f80ei-1i wtu-1uaoxco-1j",
              onClick: generateRandom
            }), [
              _cE("text", _uM({ class: "weapp-tw-border wtu-1m61e6s-1k wtu-1u1vbk3-7 wtu-1v1bob5-1l" }), "重新生成")
            ])
          ])
        ])
      ])
