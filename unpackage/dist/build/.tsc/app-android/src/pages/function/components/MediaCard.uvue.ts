...
return (): any | null => {
  ...
  return _cV(unref(Card), _uM({ title: "相机与多媒体" }), _uM({
    default: withSlotCtx((): any[] => [
      _cE("view", _uM({ class: "weapp-tw-border wtu-19w2j55-0 wtu-vj37ae-1 wtu-iq02sv-2 wtu-1ohql58-3 wtu-pa6ipo-4 wtu-tlxzxu-5 wtu-q8b8gq-6 wtu-b9ro1a-7" }), [
        photoUrl.value === ''
          ? _cE("text", _uM({
              key: 0,
              class: "weapp-tw-border wtu-1q5m829-8 wtu-1s564xi-9"
            }), "未选择照片")
          : _cE("image", _uM({
              key: 1,
              src: photoUrl.value,
      ...
      _cE("view", _uM({
        class: "weapp-tw-border wtu-2xyrg9-d wtu-1e3977j-e wtu-6cklr6-c wtu-1y0ezim-f wtu-xcm8yz-g wtu-y8rs9f-h wtu-kkkwyu-i wtu-q8b8gq-6 wtu-b9ro1a-7",
        onClick: chooseImage
      }), [
        _cE("text", _uM({ class: "weapp-tw-border wtu-1ra95rn-j wtu-1q5m829-8 wtu-qeuvjr-k" }), "拍摄/选择照片")
      ]),
      _cE("view", _uM({ class: "weapp-tw-border wtu-19w2j55-0 wtu-vj37ae-1 wtu-iq02sv-2 wtu-1ohql58-3 wtu-pa6ipo-4 wtu-tlxzxu-5" }), [
        _cE("text", _uM({ class: "weapp-tw-border wtu-18z544j-l wtu-1s564xi-9 wtu-1ek978k-m" }), "扫码结果"),
        _cE("text", _uM({ class: "weapp-tw-border wtu-1q5m829-8 wtu-qeuvjr-k wtu-1j4877a-n" }), _tD(scanResult.value !== '' ? scanResult.value : '暂无数据'), 1 /* TEXT */)
      ]),
      _cE("view", _uM({
        class: "weapp-tw-border wtu-2xyrg9-d wtu-1e3977j-e wtu-6cklr6-c wtu-yibfla-o wtu-y8rs9f-h wtu-kkkwyu-i wtu-q8b8gq-6 wtu-b9ro1a-7",
        onClick: scanCode
      }), [
        _cE("text", _uM({ class: "weapp-tw-border wtu-1ra95rn-j wtu-1q5m829-8 wtu-qeuvjr-k" }), "扫码测试")
      ])
    ]),
    _: 1 /* STABLE */
  }))
