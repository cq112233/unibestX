  ...
  return _cV(unref(AppKu), _uM({
    ...
    default: withSlotCtx((): any[] => [
      _cV(unref(LayoutComponent), _uM({
        ...
        default: withSlotCtx((): any[] => [
          _cE("view", _uM({ class: "weapp-tw-border page-root wtu-12mckpk-0 wtu-gwjw8e-1 wtu-1iiedf1-2" }), [
            _cE("scroll-view", _uM({
              ...
              _cE(Fragment, null, RenderHelpers.renderList(unref(messages), (msg, __key, __index, _cached): any => {
                return _cE("view", _uM({
                  key: msg.id,
                  class: "weapp-tw-border wtu-15ke1fv-5 wtu-1iiedf1-2"
                }), [
                  isTrue(isAiMessage(msg.sender))
                    ? _cE("view", _uM({
                        key: 0,
                        class: "weapp-tw-border msg-row-start"
                      }), [
                        _cE("view", _uM({ class: "weapp-tw-border wtu-8tr2im-6 wtu-7y5lr9-7 wtu-6q9kae-8 wtu-8tyvyh-9 wtu-mqpefj-a wtu-1qpn96n-b wtu-1lxf9re-c wtu-1ikrsu4-d" }), [
                          _cE("text", _uM({ class: "weapp-tw-border wtu-9vtjee-e wtu-msrkdo-f wtu-j5w2ks-g" }), "AI")
                        ]),
                        _cE("view", _uM({ class: "weapp-tw-border msg-content-left" }), [
                          _cE("view", _uM({ class: "weapp-tw-border wtu-rq9s3i-h wtu-78q8ib-i wtu-d58m5d-j wtu-5faia3-k wtu-1ikrsu4-d wtu-jpp5lf-l wtu-1nptzfn-m" }), [
                            _cE("text", _uM({ class: "weapp-tw-border wtu-1gyyuxw-n wtu-14sfh86-o wtu-1qe55dz-p" }), _tD(msg.content), 1 /* TEXT */)
                          ]),
                          _cE("text", _uM({ class: "weapp-tw-border wtu-1bj83jj-q wtu-1w0aoxm-r wtu-1rwo7k7-s wtu-34to1r-t" }), _tD(msg.time), 1 /* TEXT */)
                        ])
                      ])
                    : _cE("view", _uM({
                        key: 1,
                        class: "weapp-tw-border msg-row-end"
                      }), [
                        _cE("view", _uM({ class: "weapp-tw-border msg-content-right" }), [
                          _cE("view", _uM({ class: "weapp-tw-border wtu-b3txcv-u wtu-78q8ib-i wtu-oa4lpf-v wtu-gkh66x-w wtu-1ikrsu4-d" }), [
                            _cE("text", _uM({ class: "weapp-tw-border wtu-9vtjee-e wtu-14sfh86-o wtu-1qe55dz-p" }), _tD(msg.content), 1 /* TEXT */)
                          ]),
                          _cE("text", _uM({ class: "weapp-tw-border wtu-1bj83jj-q wtu-1w0aoxm-r wtu-1rwo7k7-s wtu-f5xa25-x" }), _tD(msg.time), 1 /* TEXT */)
                        ]),
                        _cE("view", _uM({ class: "weapp-tw-border wtu-8tr2im-6 wtu-7y5lr9-7 wtu-6q9kae-8 wtu-u5zyoi-y wtu-mqpefj-a wtu-1qpn96n-b wtu-3mj074-z wtu-1ikrsu4-d" }), [
                          _cE("text", _uM({ class: "weapp-tw-border wtu-ucxd0z-10 wtu-msrkdo-f wtu-j5w2ks-g" }), "ME")
                        ])
                      ])
                ])
              }), 128 /* KEYED_FRAGMENT */),
              isTrue(unref(isTyping))
                ? _cE("view", _uM({
                    key: 0,
                    class: "weapp-tw-border msg-row-start wtu-15ke1fv-5"
                  }), [
                    _cE("view", _uM({ class: "weapp-tw-border wtu-8tr2im-6 wtu-7y5lr9-7 wtu-6q9kae-8 wtu-8tyvyh-9 wtu-mqpefj-a wtu-1qpn96n-b wtu-1lxf9re-c wtu-1ikrsu4-d" }), [
                      _cE("text", _uM({ class: "weapp-tw-border wtu-9vtjee-e wtu-msrkdo-f wtu-j5w2ks-g" }), "AI")
                    ]),
                    _cE("view", _uM({ class: "weapp-tw-border wtu-rq9s3i-h wtu-78q8ib-i wtu-d58m5d-j wtu-5faia3-k wtu-1ikrsu4-d wtu-jpp5lf-l wtu-1nptzfn-m" }), [
                      _cE("text", _uM({ class: "weapp-tw-border wtu-ucxd0z-10 wtu-14sfh86-o" }), "AI 正在思考中...")
                    ])
                  ])
                : _cC("v-if", true),
              _cE("view", _uM({
            ...
            _cE("view", _uM({
              class: "weapp-tw-border footer-fixed wtu-rq9s3i-h wtu-r4rl0q-11 wtu-1nptzfn-m wtu-hixf31-12 wtu-1iiedf1-2",
              style: _nS(_uM({ paddingBottom: `${unref(safeAreaBottom) + 10}px` }))
            }), [
              _cE("view", _uM({ class: "weapp-tw-border wtu-on566v-13 wtu-mqpefj-a wtu-1t3d52l-14 wtu-15fkpjz-15 wtu-1owynq5-16 wtu-y3lmuv-17" }), [
                _cE("input", _uM({
                ...
                _cE("view", _uM({
                  class: "weapp-tw-border wtu-qglysi-18 wtu-ikawjt-19 wtu-vh6n5g-1a wtu-8tyvyh-9 wtu-mqpefj-a wtu-1qpn96n-b wtu-1gsk3nn-1b",
                  onClick: sendMessage
                }), [
