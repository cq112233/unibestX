...
return (): any | null => {
  ...
  return _cV(unref(Card), _uM({ title: "uview-ultra 组件库" }), _uM({
    default: withSlotCtx((): any[] => [
      _cE("view", _uM({ class: "weapp-tw-border wtu-13iqdf5-0 wtu-1d5cxys-1" }), [
        _cE("text", _uM({ class: "weapp-tw-border wtu-w1o5fx-2 wtu-1785dy7-3 wtu-pfly9v-4 wtu-1kr9ink-5" }), " uview-ultra 是一款专为 uni-app X 设计的高品质 UI 组件库，高度适配 UTS 强类型系统与原生跨端开发，包含按钮、表单、反馈等丰富且精美的组件集。 "),
        _cE("view", _uM({
          class: "weapp-tw-border wtu-1q4tojf-6 wtu-w5085f-7 wtu-16me7zd-8 wtu-430mh4-9 wtu-19kp62j-a wtu-1kr9ink-5",
          onClick: copyWebsiteUrl
        }), [
          _cE("text", _uM({ class: "weapp-tw-border wtu-1ksfa3k-b wtu-1qimyho-c wtu-4bvek0-d wtu-1ltypld-e" }), "官网："),
          _cE("text", _uM({ class: "weapp-tw-border wtu-1ksfa3k-b wtu-ficp91-f wtu-htznmv-g wtu-6q2ecc-h" }), "https://uview-ultra.lingyun.net/"),
          _cE("text", _uM({ class: "weapp-tw-border wtu-eqrddv-i wtu-1vmhsdv-j" }), "点击复制")
        ]),
        _cE("view", _uM({ class: "weapp-tw-border wtu-1q4tojf-6 wtu-w5085f-7 wtu-mjrjfl-k wtu-1r3ycv9-l" }), [
          _cE("view", _uM({ class: "weapp-tw-border wtu-1tb23ev-m wtu-mjrjfl-k wtu-ffxk5r-n wtu-loqjyq-o wtu-emxvyn-p wtu-4xy5je-q wtu-18q4kl-r wtu-1dzl0d5-s wtu-1gc7zx2-t" }), [
            _cE("text", _uM({ class: "weapp-tw-border wtu-eqrddv-i wtu-ficp91-f wtu-4bvek0-d" }), "高品质组件")
          ]),
          _cE("view", _uM({ class: "weapp-tw-border wtu-1tb23ev-m wtu-mjrjfl-k wtu-ffxk5r-n wtu-loqjyq-o wtu-emxvyn-p wtu-1s7ijmi-u wtu-18q4kl-r wtu-1dzl0d5-s wtu-1fh5oba-v" }), [
            _cE("text", _uM({ class: "weapp-tw-border wtu-eqrddv-i wtu-2n85i1-w wtu-4bvek0-d" }), "原生 UTS 支持")
          ]),
          _cE("view", _uM({ class: "weapp-tw-border wtu-mjrjfl-k wtu-ffxk5r-n wtu-loqjyq-o wtu-emxvyn-p wtu-1gfg2fq-x wtu-18q4kl-r wtu-1dzl0d5-s wtu-1y4kgb1-y" }), [
            _cE("text", _uM({ class: "weapp-tw-border wtu-eqrddv-i wtu-3gfhmb-z wtu-4bvek0-d" }), "跨端一致性")
          ])
        ])
      ]),
      _cE("view", _uM({
        class: "weapp-tw-border wtu-1qytvm8-10 wtu-15ubny6-11 wtu-1g7vkj5-12 wtu-y5c8pz-13 wtu-23qlii-14 wtu-1q4tojf-6 wtu-w5085f-7 wtu-1v0n2r7-15",
        onClick: navigateToShowcase
      }), [
        _cE("text", _uM({ class: "weapp-tw-border wtu-53w5ye-16 wtu-1o11cnm-17 wtu-moifc8-18" }), "进入 uview-ultra 示例")
      ])
    ]),
    _: 1 /* STABLE */
  }))
