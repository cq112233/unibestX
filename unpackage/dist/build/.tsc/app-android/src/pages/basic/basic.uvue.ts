  ...
  return _cV(unref(AppKu), _uM({
    ...
    default: withSlotCtx((): any[] => [
      _cV(unref(LayoutComponent), _uM({
        ...
        default: withSlotCtx((): any[] => [
          _cE("view", _uM({ class: "weapp-tw-border wtu-18katrf-0" }), [
            _cE("view", _uM({ class: "weapp-tw-border wtu-18katrf-0" }), [
              _cV(unref(LayoutDemoCard)),
...
const GenSrcPagesBasicBasicStyles = [_uM([["weapp-tw-border", _pS(_uM([["borderTopWidth", 0], ["borderRightWidth", 0], ["borderBottomWidth", 0], ["borderLeftWidth", 0]]))], ["wtu-18katrf-0", _pS(_uM([["flexDirection", "column"]]))]])]
