...
return (): any | null => {
  ...
  return _cE("view", _uM({
    class: "weapp-tw-border wtu-7ensv3-0 wtu-bpibez-1 wtu-xutmkl-2 wtu-1x9quu6-3 wtu-19r8swa-4",
    style: _nS(_uM({
      backgroundColor: 'var(--card-bg, #ffffff)',
      borderColor: 'var(--border-color, #edf2f7)'
    }))
  }), [
    _cE("view", _uM({ class: "weapp-tw-border wtu-1xzbcj9-5 wtu-ermdzg-6 wtu-1ejnel4-7 wtu-1gm6xh-8" }), [
      _cE("view", _uM({ class: "weapp-tw-border wtu-lhmr8c-9 wtu-r622l8-a wtu-1rlqhz-b wtu-1y9hy8q-c wtu-12f14oy-d" })),
      renderSlot(_ctx.$slots, "title", {}, (): any[] => [
        _cE("text", _uM({
          class: "weapp-tw-border wtu-12gzl1t-e wtu-vvdt71-f",
