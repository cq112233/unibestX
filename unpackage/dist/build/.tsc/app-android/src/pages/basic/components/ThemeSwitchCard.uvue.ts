...
return (): any | null => {
  ...
  return _cV(unref(Card), _uM({ title: themeTitle.value }), _uM({
    default: withSlotCtx((): any[] => [
      _cE("view", _uM({ class: "weapp-tw-border wtu-4hrp8k-0 wtu-fhrzwj-1 wtu-mqajtg-2 wtu-bkb5z9-3 wtu-qepy49-4 wtu-1jfhtyf-5 wtu-1vbahwj-6" }), [
        _cE("text", _uM({ class: "weapp-tw-border wtu-1guata8-7 wtu-i5demr-8 wtu-1yn2e0l-9" }), _tD(themePreview.value), 1 /* TEXT */),
        _cE("view", _uM({
          class: "weapp-tw-border wtu-15u6clw-a wtu-7gvrw-b wtu-3m5zaz-c wtu-s0orfi-d wtu-1likcy9-e wtu-27v8zu-f wtu-1q091sr-g wtu-1vbahwj-6 wtu-1r3uoj-h",
          style: _nS(_uM({ backgroundColor: currentTheme.value }))
        }), [
          _cE("text", _uM({ class: "weapp-tw-border wtu-g3vc06-i wtu-1d27acy-j" }), _tD(themeButton.value), 1 /* TEXT */)
        ], 4 /* STYLE */)
      ]),
      _cE("view", _uM({ class: "weapp-tw-border wtu-1q091sr-g wtu-1o0f0um-k wtu-1cu5goa-l" }), [
        _cE(Fragment, null, RenderHelpers.renderList(colorOptions, (item, index, __index, _cached): any => {
          return _cE("view", _uM({
            key: index,
            class: "weapp-tw-border wtu-6fkyl1-m wtu-12mu282-n wtu-ww7gtr-o wtu-1vbahwj-6 wtu-1r3uoj-h",
            style: _nS(_uM({
          ...
          borderColor: '#1e293b'
            ...
            currentTheme.value == item
              ? _cE("text", _uM({
                  key: 0,
                  class: "weapp-tw-border wtu-127on44-p wtu-19gexn6-q wtu-1x7cgzs-r"
                }), " ✓ ")
              : _cC("v-if", true)
          ], 12 /* STYLE, PROPS */, ["onClick"])
        }), 64 /* STABLE_FRAGMENT */)
      ]),
      _cE("view", _uM({ class: "weapp-tw-border wtu-1q091sr-g wtu-1o0f0um-k wtu-1vbahwj-6 wtu-15u6clw-a wtu-15ctu2r-s" }), [
        _cE("text", _uM({ class: "weapp-tw-border wtu-1d27acy-j wtu-1s8d77i-t" }), _tD(themeModeLabel.value), 1 /* TEXT */),
        _cE("view", _uM({
          class: "weapp-tw-border wtu-1q091sr-g wtu-1likcy9-e wtu-1gk50cy-u",
          style: _nS(_uM({
          borderWidth: '1px',
          borderStyle: 'solid',
          ...
          _cE(Fragment, null, RenderHelpers.renderList(themeModeOptions.value, (item, index, __index, _cached): any => {
            return _cE("view", _uM({
              key: index,
              class: "weapp-tw-border wtu-1p9z6y3-v wtu-1cuonmx-w",
              style: _nS(_uM({
            backgroundColor: unref(appStore).state.themeMode == item.value ? unref(appStore).state.theme : 'transparent'
              ...
              _cE("text", _uM({
                class: "weapp-tw-border wtu-1guata8-7",
                style: _nS(_uM({
