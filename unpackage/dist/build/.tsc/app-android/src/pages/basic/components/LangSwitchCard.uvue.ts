...
const _component_uni_icons = resolveEasyComponent("uni-icons",_easycom_uni_icons)
  ...
  return _cV(unref(Card), _uM({ title: langTitle.value }), _uM({
    default: withSlotCtx((): any[] => [
      _cE("view", _uM({ class: "weapp-tw-border wtu-zeqk4z-0 wtu-1py2ikc-1 wtu-1aqjbfx-2 wtu-w8jmyu-3 wtu-opyasy-4 wtu-13g5z0w-5" }), [
        _cE("text", _uM({ class: "weapp-tw-border wtu-1vqucrp-6 wtu-9qob8-7 wtu-1hy0bj4-8" }), _tD(langPreview.value), 1 /* TEXT */),
        _cE("text", _uM({ class: "weapp-tw-border wtu-f1cbux-9 wtu-tg5bk5-a wtu-uqoqln-b" }), _tD(welcomeText.value), 1 /* TEXT */),
        _cE("text", _uM({ class: "weapp-tw-border wtu-1wrjlrz-c wtu-apgfmb-d wtu-1nykptg-e" }), _tD(helloText.value), 1 /* TEXT */),
        _cE("view", _uM({ class: "weapp-tw-border wtu-16287mo-f wtu-u63ba2-g wtu-ui2fkq-h" })),
        _cE("view", _uM({ class: "weapp-tw-border" }), [
          _cE("text", _uM({ class: "weapp-tw-border wtu-1vqucrp-6 wtu-9qob8-7 wtu-1hy0bj4-8" }), _tD(uviewPreview.value), 1 /* TEXT */),
          _cE("view", _uM({ class: "weapp-tw-border wtu-1xpqddw-i wtu-1t7tavk-j wtu-uadth0-k" }), [
            _cE("text", _uM({ class: "weapp-tw-border wtu-3p92ns-l wtu-zus43i-m wtu-grn2i8-n wtu-j3s3ch-o wtu-1x56in2-p wtu-8n2rm8-q wtu-re8qpd-r wtu-11kd58a-s wtu-l3s08e-t" }), _tD(uViewChooseDates.value), 1 /* TEXT */),
            _cE("text", _uM({ class: "weapp-tw-border wtu-3p92ns-l wtu-6g0b4e-u wtu-en5wvg-v wtu-j3s3ch-o wtu-1x56in2-p wtu-8n2rm8-q wtu-re8qpd-r wtu-11kd58a-s wtu-l3s08e-t" }), _tD(uViewConfirm.value), 1 /* TEXT */),
            _cE("text", _uM({ class: "weapp-tw-border wtu-3p92ns-l wtu-ky8bvg-w wtu-14ion4g-x wtu-j3s3ch-o wtu-1x56in2-p wtu-8n2rm8-q wtu-re8qpd-r wtu-l3s08e-t" }), _tD(uViewStart.value) + " / " + _tD(uViewEnd.value), 1 /* TEXT */)
          ])
        ])
      ]),
      _cE("view", _uM({
        class: "weapp-tw-border wtu-1xpqddw-i wtu-1t7tavk-j wtu-1fek2j3-y wtu-17qg8e9-z",
        onClick: () => {switchLanguage('zh-CN')}
      }), [
        _cE("view", _uM({ class: "weapp-tw-border wtu-1xpqddw-i wtu-1t7tavk-j" }), [
          _cE("text", _uM({ class: "weapp-tw-border wtu-6xv57u-10 wtu-1au22ic-11 wtu-re8qpd-r" }), "简体中文")
        ]),
        _cE("view", _uM({ class: "weapp-tw-border wtu-1xpqddw-i wtu-1t7tavk-j" }), [
          isTrue(isZhCN.value)
      ...
      _cE("view", _uM({ class: "weapp-tw-border wtu-16287mo-f wtu-u63ba2-g" })),
      _cE("view", _uM({
        class: "weapp-tw-border wtu-1xpqddw-i wtu-1t7tavk-j wtu-1fek2j3-y wtu-17qg8e9-z",
        onClick: () => {switchLanguage('en-US')}
      }), [
        _cE("view", _uM({ class: "weapp-tw-border wtu-1xpqddw-i wtu-1t7tavk-j" }), [
          _cE("text", _uM({ class: "weapp-tw-border wtu-6xv57u-10 wtu-1au22ic-11 wtu-re8qpd-r" }), "English")
        ]),
        _cE("view", _uM({ class: "weapp-tw-border wtu-1xpqddw-i wtu-1t7tavk-j" }), [
          isTrue(isEnUS.value)
            ? _cV(_component_uni_icons, _uM({
