...
const _component_uni_icons = resolveEasyComponent("uni-icons",_easycom_uni_icons)
  ...
  return _cV(unref(Card), _uM({ title: langTitle.value }), _uM({
    default: withSlotCtx((): any[] => [
      ...
      _cE("view", _uM({
        class: "wtu-1xpqddw-f wtu-1t7tavk-g wtu-1fek2j3-h wtu-17qg8e9-i",
        onClick: () => {switchLanguage('zh-CN')}
      }), [
        _cE("view", _uM({ class: "wtu-1xpqddw-f wtu-1t7tavk-g" }), [
          _cE("text", _uM({ class: "wtu-6xv57u-j wtu-1au22ic-k wtu-re8qpd-l" }), "简体中文")
        ]),
        _cE("view", _uM({ class: "wtu-1xpqddw-f wtu-1t7tavk-g" }), [
          isTrue(isZhCN.value)
      ...
      _cE("view", _uM({ class: "wtu-16287mo-m wtu-u63ba2-n" })),
      _cE("view", _uM({
        class: "wtu-1xpqddw-f wtu-1t7tavk-g wtu-1fek2j3-h wtu-17qg8e9-i",
        onClick: () => {switchLanguage('en-US')}
      }), [
        _cE("view", _uM({ class: "wtu-1xpqddw-f wtu-1t7tavk-g" }), [
          _cE("text", _uM({ class: "wtu-6xv57u-j wtu-1au22ic-k wtu-re8qpd-l" }), "English")
        ]),
        _cE("view", _uM({ class: "wtu-1xpqddw-f wtu-1t7tavk-g" }), [
          isTrue(isEnUS.value)
            ? _cV(_component_uni_icons, _uM({
