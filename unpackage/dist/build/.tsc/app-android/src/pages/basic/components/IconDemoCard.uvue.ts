...
const _component_up_icon = resolveEasyComponent("up-icon",_easycom_up_icon)
  ...
  return _cV(unref(Card), _uM({ title: iconDemoTitle.value }), _uM({
    default: withSlotCtx((): any[] => [
      _cE("view", _uM({ class: "weapp-tw-border wtu-edh1ze-0 wtu-r2og8u-1 wtu-1c6w9qp-2 wtu-e32pgj-3" }), [
        _cE("view", _uM({ class: "weapp-tw-border wtu-edh1ze-0 wtu-r2og8u-1" }), [
          _cE("view", _uM({ class: "weapp-tw-border wtu-jjoyn4-4 wtu-ubwupt-5 wtu-1u0ls6d-6 wtu-1i1fm6y-7 wtu-b8dflc-8" })),
          _cE("text", _uM({ class: "weapp-tw-border wtu-kba525-9 wtu-1dcwght-a wtu-1lor33j-b" }), "uni-icon")
        ]),
        _cE("view", _uM({ class: "weapp-tw-border wtu-edh1ze-0 wtu-r2og8u-1" }), [
          ...
          _cE("text", _uM({ class: "weapp-tw-border wtu-lbze2f-c wtu-1uc842y-d" }), "contact")
        ])
      ]),
      _cE("view", _uM({ class: "weapp-tw-border wtu-3wtn0e-e wtu-u07xcs-f" })),
      _cE("view", _uM({ class: "weapp-tw-border wtu-edh1ze-0 wtu-r2og8u-1 wtu-1c6w9qp-2 wtu-e32pgj-3" }), [
        _cE("view", _uM({ class: "weapp-tw-border wtu-edh1ze-0 wtu-r2og8u-1" }), [
          _cE("view", _uM({ class: "weapp-tw-border wtu-jjoyn4-4 wtu-ubwupt-5 wtu-1u0ls6d-6 wtu-vs4ahm-g wtu-b8dflc-8" })),
          _cE("view", _uM({ class: "weapp-tw-border wtu-no3ft0-h" }), [
            _cE("text", _uM({ class: "weapp-tw-border wtu-kba525-9 wtu-1dcwght-a wtu-1lor33j-b" }), "lime-icon"),
            _cE("view", _uM({ class: "weapp-tw-border wtu-159q4wc-i wtu-1wj9wbu-j wtu-dktp6a-k wtu-vjo5gh-l wtu-bevybu-m wtu-p0dhsv-n wtu-kl7gdk-o wtu-11fbxns-p wtu-1da3t5c-q" }), [
              _cE("text", _uM({ class: "weapp-tw-border wtu-12mw64h-r wtu-nnvrio-s" }), _tD(svgAuthWarning.value), 1 /* TEXT */)
            ])
          ])
        ]),
        _cE("view", _uM({ class: "weapp-tw-border wtu-edh1ze-0 wtu-r2og8u-1" }), [
          ...
          _cE("text", _uM({ class: "weapp-tw-border wtu-lbze2f-c wtu-1uc842y-d" }), "circle")
        ])
      ]),
      _cE("view", _uM({ class: "weapp-tw-border wtu-3wtn0e-e wtu-u07xcs-f" })),
      _cE("view", _uM({ class: "weapp-tw-border wtu-edh1ze-0 wtu-r2og8u-1 wtu-1c6w9qp-2 wtu-e32pgj-3" }), [
        _cE("view", _uM({ class: "weapp-tw-border wtu-edh1ze-0 wtu-r2og8u-1" }), [
          _cE("view", _uM({ class: "weapp-tw-border wtu-jjoyn4-4 wtu-ubwupt-5 wtu-1u0ls6d-6 wtu-1fmwiif-t wtu-b8dflc-8" })),
          _cE("text", _uM({ class: "weapp-tw-border wtu-kba525-9 wtu-1dcwght-a wtu-1lor33j-b" }), "up-icon (uview-ultra)")
        ]),
        _cE("view", _uM({ class: "weapp-tw-border wtu-edh1ze-0 wtu-r2og8u-1" }), [
          ...
          _cE("text", _uM({ class: "weapp-tw-border wtu-lbze2f-c wtu-1uc842y-d" }), "setting")
        ])
      ])
    ]),
    _: 1 /* STABLE */
