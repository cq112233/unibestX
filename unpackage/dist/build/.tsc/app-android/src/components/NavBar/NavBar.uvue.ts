...
return (): any | null => {
  ...
  return _cE("view", _uM({ class: "nav-bar" }), [
    _cE("view", _uM({
      ...
      _cE("view", _uM({ class: "navbar-content" }), [
        _cE("view", _uM({ class: "navbar-left" }), [
