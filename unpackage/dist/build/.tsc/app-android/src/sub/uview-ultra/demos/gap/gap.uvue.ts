          ...
          _cE("view", _uM({ class: "weapp-tw-border page-container bg-_b_hf8fafc_B min-h-screen pb-_b30px_B" }), [
            _cE("view", _uM({ class: "weapp-tw-border p-_b16px_B" }), [
              ...
              _cE("view", _uM({ class: "weapp-tw-border demo-block mt-_b12px_B" }), [
                _cE("text", _uM({ class: "weapp-tw-border demo-label" }), "自定义高度"),
                _cV(_component_up_gap, _uM({
                  height: "50",
                  "bg-color": "#f3f4f6"
                }))
              ...
              _cE("view", _uM({ class: "weapp-tw-border demo-block mt-_b12px_B" }), [
                _cE("text", _uM({ class: "weapp-tw-border demo-label" }), "自定义背景色"),
                _cV(_component_up_gap, _uM({
                  height: "30",
                  "bg-color": "#fa3534"
                }))
              ...
              _cE("view", _uM({ class: "weapp-tw-border demo-block mt-_b12px_B" }), [
                _cE("text", _uM({ class: "weapp-tw-border demo-label" }), "自定义上下外边距"),
                _cE("view", _uM({ class: "weapp-tw-border bg-_b_h2979ff_B h-_b10px_B w-full" })),
                _cV(_component_up_gap, _uM({
                  height: "20",
                  "bg-color": "#f3f4f6",
                  "margin-top": "10",
