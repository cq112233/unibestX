          ...
          _cE("view", _uM({ class: "weapp-tw-border page-container bg-_b_hf8fafc_B min-h-screen pb-_b30px_B" }), [
            _cE("view", _uM({ class: "weapp-tw-border p-_b16px_B" }), [
              _cE("view", _uM({ class: "weapp-tw-border demo-block" }), [
                ...
                _cE("view", _uM({ class: "weapp-tw-border overflow-hidden rounded-md border-_b1px_B border-_b_heee_B border-solid" }), [
              ...
              _cE("view", _uM({ class: "weapp-tw-border demo-block mt-_b12px_B" }), [
                _cE("text", _uM({ class: "weapp-tw-border demo-label" }), "自定义插槽"),
                _cE("view", _uM({ class: "weapp-tw-border overflow-hidden rounded-md border-_b1px_B border-_b_heee_B border-solid" }), [
                  _cV(_component_up_navbar, _uM({
                    "safe-area-inset-top": false,
                    fixed: false,
                    ...
                    center: withSlotCtx((): any[] => [
                      _cE("view", _uM({
                        class: "weapp-tw-border",
                        style: _nS(_uM({"flex-direction":"row","align-items":"center","justify-content":"center","background-color":"#f3f4f6","border-radius":"15px","padding":"0 10px","height":"30px","width":"100px"}))
                      }), [
                        ...
                        _cE("text", _uM({
                          class: "weapp-tw-border",
                          style: _nS(_uM({"font-size":"12px","color":"#909399","margin-left":"4px"}))
                        }), "搜索", 4 /* STYLE */)
                      ], 4 /* STYLE */)
                    ]),
                    _: 1 /* STABLE */
