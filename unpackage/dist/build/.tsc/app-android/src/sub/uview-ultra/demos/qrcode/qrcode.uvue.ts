...
const _component_up_qrcode = resolveEasyComponent("up-qrcode",_easycom_up_qrcode)
  ...
  return _cV(unref(AppKu), _uM({
    ...
    "page-style": {'navigationBarTitleText':'Qrcode 二维码','navigationStyle':'custom'}
  }), _uM({
        ...
        default: withSlotCtx((): any[] => [
          _cE("view", _uM({ class: "weapp-tw-border page-container bg-_b_hf8fafc_B min-h-screen pb-_b30px_B" }), [
            _cE("view", _uM({ class: "weapp-tw-border p-_b16px_B" }), [
              _cE("view", _uM({ class: "weapp-tw-border demo-block flex-col items-center" }), [
                _cE("text", _uM({ class: "weapp-tw-border demo-label w-full" }), "基础用法"),
                _cV(_component_up_qrcode, _uM({
                  size: "200",
                  val: "https://uview-ultra.lingyun.net"
                }))
              ]),
              _cE("view", _uM({ class: "weapp-tw-border demo-block flex-col items-center mt-_b12px_B" }), [
                _cE("text", _uM({ class: "weapp-tw-border demo-label w-full" }), "自定义颜色"),
                _cV(_component_up_qrcode, _uM({
                  size: "200",
                  background: "#f3f4f6",
                  foreground: "#2979ff",
              ...
              _cE("view", _uM({ class: "weapp-tw-border demo-block flex-col items-center mt-_b12px_B" }), [
                _cE("text", _uM({ class: "weapp-tw-border demo-label w-full" }), "包含Logo"),
                _cV(_component_up_qrcode, _uM({
                  size: "200",
