...
const _component_up_divider = resolveEasyComponent("up-divider",_easycom_up_divider)
  ...
  return _cV(unref(AppKu), _uM({
    ...
    "page-style": {'navigationBarTitleText':'Divider 分割线','navigationStyle':'custom'}
  }), _uM({
        ...
        default: withSlotCtx((): any[] => [
          _cE("view", _uM({ class: "weapp-tw-border page-container bg-_b_hf8fafc_B min-h-screen pb-_b30px_B" }), [
            _cE("view", _uM({ class: "weapp-tw-border p-_b16px_B" }), [
              ...
              _cE("view", _uM({ class: "weapp-tw-border demo-block" }), [
                _cE("text", _uM({ class: "weapp-tw-border demo-label" }), "虚线类型"),
              ...
              _cE("view", _uM({ class: "weapp-tw-border demo-block" }), [
                _cE("text", _uM({ class: "weapp-tw-border demo-label" }), "半截分割线"),
                _cV(_component_up_divider, _uM({
                  text: "半截",
                  "half-width": ""
                }))
