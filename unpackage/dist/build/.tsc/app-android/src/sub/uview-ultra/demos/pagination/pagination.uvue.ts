...
const _component_up_pagination = resolveEasyComponent("up-pagination",_easycom_up_pagination)
  ...
  return _cV(unref(AppKu), _uM({
    ...
    "page-style": {'navigationBarTitleText':'Pagination 分页器','navigationStyle':'custom'}
  }), _uM({
          ...
          _cE("view", _uM({ class: "weapp-tw-border page-container bg-_b_hf8fafc_B min-h-screen pb-_b30px_B" }), [
            _cE("view", _uM({ class: "weapp-tw-border p-_b16px_B" }), [
              _cE("view", _uM({ class: "weapp-tw-border demo-block" }), [
                _cE("text", _uM({ class: "weapp-tw-border demo-label" }), "up-pagination"),
