          ...
          _cE("view", _uM({ class: "weapp-tw-border page-container bg-_b_hf8fafc_B min-h-screen pb-_b30px_B" }), [
            _cE("view", _uM({ class: "weapp-tw-border p-_b16px_B" }), [
              _cE("view", _uM({ class: "weapp-tw-border demo-block" }), [
                _cE("text", _uM({ class: "weapp-tw-border demo-label" }), "基础步骤条"),
                ...
                _cE("view", _uM({ class: "weapp-tw-border mt-_b12px_B flex-row justify-center" }), [
              ...
              _cE("view", _uM({ class: "weapp-tw-border demo-block mt-_b12px_B" }), [
                _cE("text", _uM({ class: "weapp-tw-border demo-label" }), "圆点模式 (dot)"),
              ...
              _cE("view", _uM({ class: "weapp-tw-border demo-block mt-_b12px_B" }), [
                _cE("text", _uM({ class: "weapp-tw-border demo-label" }), "自定义颜色与错误状态"),
                _cV(_component_up_steps, _uM({
                  current: 1,
                  "active-color": "#19be6b"
                }), _uM({
              ...
              _cE("view", _uM({ class: "weapp-tw-border demo-block mt-_b12px_B" }), [
                _cE("text", _uM({ class: "weapp-tw-border demo-label" }), "垂直方向"),
                _cV(_component_up_steps, _uM({
                  current: 1,
                  direction: "column"
                }), _uM({
