...
const _component_up_input = resolveEasyComponent("up-input",_easycom_up_input)
  ...
  return _cV(unref(AppKu), _uM({
    ...
    "page-style": {'navigationBarTitleText':'up-input 输入框','navigationStyle':'custom'}
  }), _uM({
          ...
          _cE("view", _uM({ class: "weapp-tw-border page-container bg-_b_hf8fafc_B min-h-screen pb-_b30px_B" }), [
            _cE("view", _uM({ class: "weapp-tw-border p-_b16px_B" }), [
              ...
              _cE("view", _uM({ class: "weapp-tw-border demo-block mt-_b12px_B" }), [
                _cE("text", _uM({ class: "weapp-tw-border demo-label" }), "带前后台图标"),
                _cV(_component_up_input, _uM({
                  placeholder: "请输入搜索内容",
                  "prefix-icon": "search",
                  "suffix-icon": "scan"
