...
const _component_up_action_sheet = resolveEasyComponent("up-action-sheet",_easycom_up_action_sheet)
  ...
  return _cV(unref(AppKu), _uM({
    ...
    "page-style": {'navigationBarTitleText':'Form 表单','navigationStyle':'custom'}
  }), _uM({
          ...
          _cE("view", _uM({ class: "weapp-tw-border page-container bg-_b_hf8fafc_B min-h-screen pb-_b30px_B" }), [
            _cE("view", _uM({ class: "weapp-tw-border p-_b16px_B" }), [
              _cE("view", _uM({ class: "weapp-tw-border demo-block" }), [
                _cE("text", _uM({ class: "weapp-tw-border demo-label" }), "基础表单示例"),
              ...
              _cE("view", _uM({ class: "weapp-tw-border demo-block" }), [
                _cE("text", _uM({ class: "weapp-tw-border demo-label" }), "标签上方对齐"),
                _cV(_component_up_form, _uM({
                  model: formModel2,
                  "label-position": "top",
                  "label-width": "100px"
              ...
              _cE("view", _uM({ class: "weapp-tw-border mt-_b20px_B flex-row justify-between" }), [
                _cE("view", _uM({ class: "weapp-tw-border flex-1 mr-_b10px_B" }), [
                ...
                _cE("view", _uM({ class: "weapp-tw-border flex-1 ml-_b10px_B" }), [
                  _cV(_component_up_button, _uM({
                    type: "info",
                    text: "重置表单",
                    onClick: resetForm
...
const GenSrcSubUviewUltraDemosFormFormStyles = [_uM([["weapp-tw-border", _pS(_uM([["borderTopWidth", 0], ["borderRightWidth", 0], ["borderBottomWidth", 0], ["borderLeftWidth", 0]]))], ["demo-block", _pS(_uM([["marginBottom", 12], ["paddingTop", 12], ["paddingRight", 12], ["paddingBottom", 12], ["paddingLeft", 12], ["backgroundColor", "#ffffff"], ["borderTopLeftRadius", 8], ["borderTopRightRadius", 8], ["borderBottomRightRadius", 8], ["borderBottomLeftRadius", 8]]))], ["demo-label", _pS(_uM([["fontSize", 14], ["fontWeight", "bold"], ["color", "#606266"], ["marginBottom", 10], ["paddingLeft", 4], ["borderLeftWidth", 3], ["borderLeftStyle", "solid"], ["borderLeftColor", "var(--theme-color, #0957de)"]]))], ["w-10px", _pS(_uM([["width", 10]]))], ["mt-20px", _pS(_uM([["marginTop", 20]]))], ["mr-10px", _pS(_uM([["marginRight", 10]]))], ["ml-10px", _pS(_uM([["marginLeft", 10]]))], ["flex-1", _pS(_uM([["flexGrow", 1], ["flexShrink", 1], ["flexBasis", "0%"]]))]])]
