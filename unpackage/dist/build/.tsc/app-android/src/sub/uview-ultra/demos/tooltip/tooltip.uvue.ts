          ...
          _cE("view", _uM({ class: "weapp-tw-border page-container bg-_b_hf8fafc_B min-h-screen pb-_b30px_B" }), [
            _cE("view", _uM({ class: "weapp-tw-border p-_b16px_B" }), [
              _cE("view", _uM({ class: "weapp-tw-border demo-block" }), [
                ...
                _cE("view", _uM({ class: "weapp-tw-border flex flex-row items-center flex-wrap" }), [
                  _cE("view", _uM({ class: "weapp-tw-border mr-_b12px_B mb-_b8px_B" }), [
                    _cV(_component_up_tooltip, _uM({
                      text: "长按此处复制文本",
                      direction: "top"
                    }))
                  ]),
                  _cE("view", _uM({ class: "weapp-tw-border mb-_b8px_B" }), [
                    _cV(_component_up_tooltip, _uM({
                      text: "长按显示操作",
                      direction: "top",
                      "show-copy": false,
              ...
              _cE("view", _uM({ class: "weapp-tw-border demo-block mt-_b12px_B" }), [
                _cE("text", _uM({ class: "weapp-tw-border demo-label" }), "弹出方向"),
                _cE("view", _uM({ class: "weapp-tw-border flex flex-row items-center flex-wrap" }), [
                  _cE("view", _uM({ class: "weapp-tw-border mr-_b16px_B mb-_b8px_B" }), [
                    _cV(_component_up_tooltip, _uM({
                      text: "长按文本，上方提示",
                      direction: "top"
                    }))
              ...
              _cE("view", _uM({ class: "weapp-tw-border demo-block mt-_b12px_B" }), [
                _cE("text", _uM({ class: "weapp-tw-border demo-label" }), "高亮选中文本背景色"),
              ...
              _cE("view", _uM({ class: "weapp-tw-border demo-block mt-_b12px_B" }), [
                _cE("text", _uM({ class: "weapp-tw-border demo-label" }), "扩展按钮"),
                _cE("view", _uM({ class: "weapp-tw-border flex flex-row items-center" }), [
                  _cV(_component_up_tooltip, _uM({
                    text: "显示多个扩展按钮",
                    "show-copy": true,
              ...
              _cE("view", _uM({ class: "weapp-tw-border demo-block mt-_b12px_B" }), [
                _cE("text", _uM({ class: "weapp-tw-border demo-label" }), "自定义触发器 (Slot)"),
                _cE("view", _uM({ class: "weapp-tw-border flex flex-row items-center" }), [
                  _cE("view", _uM({ class: "weapp-tw-border mr-_b16px_B" }), [
                    _cV(_component_up_tooltip, _uM({
                      "show-copy": false,
                      buttons: ['设置', '赞'],
                      direction: "top",
