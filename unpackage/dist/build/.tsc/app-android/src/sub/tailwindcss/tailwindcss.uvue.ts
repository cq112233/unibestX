        ...
        default: withSlotCtx((): any[] => [
          _cE("view", null, [
            _cE("view", _uM({
              ...
              _cE("view", _uM({ class: "template-corpus-card flex flex-col gap-3 rounded-_b28px_B border border-slate-200 bg-gradient-to-br from-slate-900 to-slate-700 p-4 text-white shadow-xl wx_cbg-blue-500 h5_cbg-green-500 harmony_cbg-_b_hc64b4b_B ios_cbg-_b_h0169f0_B android_cbg-_b_h2d6f08_B" }), [
              ...
              _cE("view", _uM({ class: "mt-_b13_d14758px_B flex flex-col items-center" }), [
                ...
                _cE("view", _uM({
                  class: _nC(["theme-mode-demo mt-4 rounded px-4 py-3", unref(isDark) ? 'bg-zinc-900 text-zinc-50' : 'bg-white text-slate-900'])
                }), [
                  _cE("text", null, "uni-app x Tailwind CSS v4 system dark"),
                  _cE("view", _uM({
                    class: _nC(["theme-dark mt-2 rounded px-3 py-2", unref(isDark) ? 'bg-zinc-950 text-zinc-50' : 'bg-white text-slate-900'])
                  }), [
