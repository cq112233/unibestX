...
return (): any | null => {
  ...
  return _cE("view", _uM({ class: "weapp-tw-border wtu-1m49j0s-0 wtu-n3ob0u-1 wtu-1vc4oyx-2 wtu-or3vkz-3" }), [
    _cE("view", _uM({ class: "weapp-tw-border issue-822-component-child wtu-12ysphb-4 wtu-rj66cr-5 wtu-79qmlq-6" }), [
      _cE("text", _uM({ class: "weapp-tw-border wtu-1qewyjj-7" }), "issue 822 component child")
    ]),
    _cE("view", _uM({ class: "weapp-tw-border wtu-hahnwa-8 wtu-79qmlq-6 wtu-1g1ucfi-9 wtu-n3ob0u-1" }), [
      _cE("text", _uM({
        class: _nC(["weapp-tw-border", unref(flag) ? 'wtu-uj646o-a wtu-v1dixk-b' : 'wtu-s9xl9u-c'])
      }), " simple ", 2 /* CLASS */),
      _cE("text", _uM({
        class: _nC(["weapp-tw-border", [
          unref(extra),
          _uM({ 'wtu-1l82hkd-d': unref(toggled) })
        ]])
      }), " complex ", 2 /* CLASS */),
      _cE("text", _uM({
        class: _nC(["weapp-tw-border", unref(condition) ? 'wtu-1hf1vho-e wtu-6xzka-f' : ''])
      }), " fallback ", 2 /* CLASS */)
    ])
  ])
}
