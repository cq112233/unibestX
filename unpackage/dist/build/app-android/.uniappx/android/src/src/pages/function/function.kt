...
open class GenSrcPagesFunctionFunction : BasePage {
    ...
    companion object {
        ...
        var setup: (__props: GenSrcPagesFunctionFunction) -> Any? = fun(__props): Any? {
            ...
            return fun(): Any? {
                return _cV(unref(GenAppkuClass), _uM("layout" to "navbar", "show-back" to false, "enable-pull-down-refresh" to true, "page-style" to _uO("navigationBarTitleText" to "功能", "navigationStyle" to "custom")), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                    return _uA(
                        _cV(unref(GenSrcLayoutsNavbarClass), _uM("show-back" to false, "enable-pull-down-refresh" to true, "page-style" to _uO("navigationBarTitleText" to "功能", "navigationStyle" to "custom")), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                            return _uA(
                                _cE("view", _uM("class" to "weapp-tw-border"), _uA(
                                    _cE("view", _uM("class" to "weapp-tw-border wtu-1i41ley-0 wtu-1a1clmh-1 wtu-qtpsxx-2"), _uA(
                                        _cE("text", _uM("class" to "weapp-tw-border wtu-ympeof-3 wtu-dexfdw-4 wtu-1macy2r-5"), "功能组件库演示"),
                                        _cE("text", _uM("class" to "weapp-tw-border wtu-1q99rg1-6 wtu-17u3i8b-7 wtu-1g5yxwv-8"), "演示原生设备 API 调用、常用工具库与组件集成")
                                    )),
