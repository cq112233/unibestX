...
open class GenSrcSubUviewUltraDemosIndexListcopyIndexList : BasePage {
    ...
    companion object {
        ...
        var setup: (__props: GenSrcSubUviewUltraDemosIndexListcopyIndexList) -> Any? = fun(__props): Any? {
            val __ins = getCurrentInstance()!!
            val _ctx = __ins.proxy as GenSrcSubUviewUltraDemosIndexListcopyIndexList
            ...
            return fun(): Any? {
                ...
                return _cV(unref(GenAppkuClass), _uM("layout" to "navbar", "show-back" to true, "hide-navbar" to false, "enable-pull-down-refresh" to false, "page-style" to _uO("navigationBarTitleText" to "IndexList 索引列表", "navigationStyle" to "custom")), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                    return _uA(
                        _cV(unref(GenSrcLayoutsNavbarClass), _uM("show-back" to true, "hide-navbar" to false, "enable-pull-down-refresh" to false, "page-style" to _uO("navigationBarTitleText" to "IndexList 索引列表", "navigationStyle" to "custom")), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                            return _uA(
                                _cE("view", _uM("class" to "weapp-tw-border page-container bg-_b_hf8fafc_B", "style" to _nS(_uM("height" to ("" + windowHeight.value + "px")))), _uA(
                                    _cE("view", _uM("class" to "weapp-tw-border flex-1 relative", "style" to _nS(_uM("flex" to "1"))), _uA(
                                                    ...
                                                    return _cV(_component_up_index_item, _uM("key" to index), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                                                        return _uA(
                                                            ...
                                                            _cE(Fragment, null, RenderHelpers.renderList(item, fun(cell, cellIndex, __index, _cached): Any {
                                                                return _cE("view", _uM("key" to cellIndex, "class" to "weapp-tw-border list-cell"), _uA(
                                                                    _cE("text", _uM("class" to "weapp-tw-border list-item-text"), _tD(cell), 1)
                                                                ))
                                                            }
                                                            ), 128)
                                                        )
