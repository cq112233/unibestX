        ...
        var setup: (__props: GenSrcSubUviewUltraDemosTabsTabs) -> Any? = fun(__props): Any? {
            ...
            return fun(): Any? {
                ...
                return _cV(unref(GenAppkuClass), null, _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                    return _uA(
                        _cV(unref(GenSrcLayoutsDefaultClass), _uM("navigation-style" to "custom", "navigation-bar-title-text" to "up-tabs 标签页"), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                            return _uA(
                                _cE("view", _uM("class" to "page-container bg-__f8fafc_ min-h-screen pb-30px"), _uA(
                                    _cV(_component_NavBar, _uM("title" to "Tabs 标签页", "auto-back" to true)),
                                    _cE("view", _uM("class" to "p-16px"), _uA(
                                        _cE("view", _uM("class" to "demo-block"), _uA(
                                            _cE("text", _uM("class" to "demo-label"), "基础用法"),
                                            _cV(_component_up_tabs, _uM("list" to _uA(
                                                _uO("name" to "关注"),
                                                _uO("name" to "推荐"),
                                                _uO("name" to "科技")
                                            )))
                                        ...
                                        _cE("view", _uM("class" to "demo-block mt-12px"), _uA(
                                            _cE("text", _uM("class" to "demo-label"), "滑块主题"),
                                            _cV(_component_up_tabs, _uM("list" to _uA(
                                                _uO("name" to "关注"),
                                                _uO("name" to "推荐"),
                                                _uO("name" to "科技")
                                            ), "line-color" to "#fa3534", "active-style" to _uO("color" to "#fa3534")))
                                        ))
                                    ))
                                ))
                            )
