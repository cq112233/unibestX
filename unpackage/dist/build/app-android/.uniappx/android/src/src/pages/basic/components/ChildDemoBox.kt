...
open class GenSrcPagesBasicComponentsChildDemoBox : VueComponent {
    ...
    companion object {
        ...
        var setup: (__props: GenSrcPagesBasicComponentsChildDemoBox) -> Any? = fun(__props): Any? {
            ...
            return fun(): Any? {
                return _cE("view", _uM("class" to "weapp-tw-border wtu-zipktt-0 wtu-1v0f2ef-1 wtu-j5w8hi-2 wtu-1oapzb6-3 wtu-efe1oe-4 wtu-6plw78-5"), _uA(
                    _cE("view", _uM("class" to "weapp-tw-border wtu-1k2269n-6"), _uA(
                        renderSlot(_ctx.`$slots`, "header", _uO(), fun(): UTSArray<Any> {
                            return _uA(
                                _cE("text", _uM("class" to "weapp-tw-border wtu-5zjli3-7 wtu-1nivbe9-8 wtu-15nsgd4-9"), "📦 " + _tD(_ctx.title) + "（默认 Header）", 1)
                            )
                        }
                        ),
                        _cE("view", _uM("class" to "weapp-tw-border wtu-1t03los-a wtu-qb9abt-b wtu-jtxdk8-c"))
                    )),
                    _cE("view", _uM("class" to "weapp-tw-border wtu-ucwwyt-d wtu-182oteh-e wtu-1kpj8o8-f wtu-1adrg6y-g wtu-1oapzb6-3 wtu-efe1oe-4 wtu-7kw8bf-h"), _uA(
                        _cE("text", _uM("class" to "weapp-tw-border wtu-1pxnoyx-i wtu-1nivbe9-8 wtu-c3ez2v-j wtu-yp9fxe-k"), "【父传子 Props 动态接收】"),
                        _cE("view", _uM("class" to "weapp-tw-border wtu-x7nkyg-l wtu-ix6v4k-m"), _uA(
                            _cE("text", _uM("class" to "weapp-tw-border wtu-1pxnoyx-i wtu-grng8o-n"), "父组件传递的 Count: "),
                            _cE("text", _uM("class" to "weapp-tw-border wtu-5zjli3-7 wtu-1nivbe9-8 wtu-18ekrle-o wtu-9yebru-p"), _tD(_ctx.count), 1)
                        ))
                    )),
                    _cE("view", _uM("class" to "weapp-tw-border wtu-ucwwyt-d wtu-182oteh-e wtu-1kpj8o8-f wtu-1adrg6y-g wtu-1oapzb6-3 wtu-efe1oe-4 wtu-7kw8bf-h"), _uA(
                        _cE("text", _uM("class" to "weapp-tw-border wtu-1pxnoyx-i wtu-1nivbe9-8 wtu-c3ez2v-j wtu-hisbzo-q"), "【具名作用域插槽 (Slot 向父组件传参)】"),
                        _cE(Fragment, null, RenderHelpers.renderList(_ctx.tags, fun(item, index, __index, _cached): Any {
                            return _cE("view", _uM("key" to index, "class" to "weapp-tw-border wtu-hisbzo-q"), _uA(
                                renderSlot(_ctx.`$slots`, "itemSlot", _uM("item" to item, "index" to index), fun(): UTSArray<Any> {
                                    return _uA(
                                        _cE("view", _uM("class" to "weapp-tw-border wtu-zipktt-0 wtu-l9uwt0-r wtu-2vrnhv-s"), _uA(
                                            _cE("text", _uM("class" to "weapp-tw-border wtu-1pxnoyx-i wtu-grng8o-n"), "Tag " + _tD(index + 1) + ": " + _tD(item), 1)
                                        ))
                                    )
                                }
                                )
                    ...
                    _cE("view", _uM("class" to "weapp-tw-border wtu-1k2269n-6 wtu-182oteh-e wtu-1kpj8o8-f wtu-1adrg6y-g wtu-1oapzb6-3 wtu-efe1oe-4 wtu-7kw8bf-h"), _uA(
                        _cE("text", _uM("class" to "weapp-tw-border wtu-1pxnoyx-i wtu-1nivbe9-8 wtu-c3ez2v-j wtu-1rszb3q-t"), "【子传父 Emits 事件触发】"),
                        _cE("view", _uM("class" to "weapp-tw-border wtu-x7nkyg-l wtu-jpge2z-u wtu-ix6v4k-m wtu-1rszb3q-t"), _uA(
                            _cE("view", _uM("class" to "weapp-tw-border wtu-812ws7-v wtu-s60y7a-w wtu-1uy7k1u-x wtu-1i4pv7e-y wtu-x7nkyg-l wtu-ix6v4k-m wtu-1pd1px4-z wtu-1udz6jo-10", "onClick" to handleAdd), _uA(
                                _cE("text", _uM("class" to "weapp-tw-border wtu-ih0clp-11 wtu-1pxnoyx-i"), "触发 Count + 1")
                            )),
                            _cE("view", _uM("class" to "weapp-tw-border wtu-812ws7-v wtu-4dipnu-12 wtu-1uy7k1u-x wtu-1i4pv7e-y wtu-x7nkyg-l wtu-ix6v4k-m wtu-1pd1px4-z wtu-9yebru-p", "onClick" to handleReset), _uA(
                                _cE("text", _uM("class" to "weapp-tw-border wtu-ih0clp-11 wtu-1pxnoyx-i"), "触发 重置事件")
                            ))
                        )),
                        _cE("view", _uM("class" to "weapp-tw-border wtu-zipktt-0 wtu-1uy7k1u-x wtu-1y1vdmh-13 wtu-1oapzb6-3 wtu-efe1oe-4 wtu-6plw78-5 wtu-x7nkyg-l wtu-ix6v4k-m wtu-jpge2z-u"), _uA(
                            ...
                            _cE("view", _uM("class" to "weapp-tw-border wtu-aufsc6-17 wtu-1uy7k1u-x wtu-8x6qng-14 wtu-xmcsy6-18 wtu-x7nkyg-l wtu-ix6v4k-m wtu-1pd1px4-z wtu-lfb8b4-19", "onClick" to handleSendMsg), _uA(
                                _cE("text", _uM("class" to "weapp-tw-border wtu-ih0clp-11 wtu-1pxnoyx-i"), "发送给父组件")
                            ))
                        ))
                    )),
                    _cE("view", _uM("class" to "weapp-tw-border wtu-1iqlyvo-1a"), _uA(
                        _cE("view", _uM("class" to "weapp-tw-border wtu-1t03los-a wtu-qb9abt-b wtu-1rszb3q-t")),
                        renderSlot(_ctx.`$slots`, "footer", _uO(), fun(): UTSArray<Any> {
                            return _uA(
                                _cE("text", _uM("class" to "weapp-tw-border wtu-1h5fdje-1b wtu-1xb3h6w-1c"), "（默认 Footer）")
                            )
                        }
                        )
                    ))
        ...
        var props = _nP(_uM("customStyle" to _uM("type" to _uA(
            "Object",
            "String"
        ), "default" to _uO()), "customClass" to _uM("type" to "String", "default" to ""), "url" to _uM("type" to "String", "default" to ""), "linkType" to _uM("type" to "String", "default" to "navigateTo"), "title" to _uM("type" to "String", "default" to "通信子组件"), "count" to _uM("type" to "Number", "default" to 0), "tags" to _uM("type" to "Array", "default" to fun(): UTSArray<String> {
