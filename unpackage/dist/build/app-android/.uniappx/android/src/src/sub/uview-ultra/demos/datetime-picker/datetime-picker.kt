...
open class GenSrcSubUviewUltraDemosDatetimePickerDatetimePicker : BasePage {
    ...
    companion object {
        ...
        var setup: (__props: GenSrcSubUviewUltraDemosDatetimePickerDatetimePicker) -> Any? = fun(__props): Any? {
            ...
            val dtShow1 = ref(false)
            val dtShow2 = ref(false)
            val dtShow3 = ref(false)
            val dtShow4 = ref(false)
            fun gen_showDt1_fn() {
                dtShow1.value = true
            }
            val showDt1 = ::gen_showDt1_fn
            fun gen_showDt2_fn() {
                dtShow2.value = true
            }
            val showDt2 = ::gen_showDt2_fn
            fun gen_showDt3_fn() {
                dtShow3.value = true
            }
            val showDt3 = ::gen_showDt3_fn
            fun gen_showDt4_fn() {
                dtShow4.value = true
            }
            val showDt4 = ::gen_showDt4_fn
            ...
            return fun(): Any? {
                ...
                return _cV(unref(GenAppkuClass), null, _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                    return _uA(
                        _cV(unref(GenSrcLayoutsDefaultClass), _uM("navigation-style" to "custom", "navigation-bar-title-text" to "up-datetime-picker 时间选择"), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                            return _uA(
                                _cE("view", _uM("class" to "page-container bg-__f8fafc_ min-h-screen pb-30px"), _uA(
                                    _cV(_component_NavBar, _uM("title" to "up-datetime-picker 时间选择", "auto-back" to true, "safe-area-inset-top" to true, "bg-color" to "#ffffff")),
                                    _cE("view", _uM("class" to "p-16px"), _uA(
                                        _cE("view", _uM("class" to "demo-block"), _uA(
                                            _cE("text", _uM("class" to "demo-label"), "完整时间"),
                                            _cE("view", _uM("class" to "flex-row items-center"), _uA(
                                                _cV(_component_up_button, _uM("type" to "primary", "text" to "年月日时分", "size" to "mini", "onClick" to showDt1))
                                            ))
                                        )),
                                        _cE("view", _uM("class" to "demo-block mt-12px"), _uA(
                                            _cE("text", _uM("class" to "demo-label"), "仅选日期"),
                                            _cE("view", _uM("class" to "flex-row items-center"), _uA(
                                                _cV(_component_up_button, _uM("type" to "success", "text" to "年月日", "size" to "mini", "onClick" to showDt2))
                                            ))
                                        )),
                                        _cE("view", _uM("class" to "demo-block mt-12px"), _uA(
                                            _cE("text", _uM("class" to "demo-label"), "年月选择"),
                                            _cE("view", _uM("class" to "flex-row items-center"), _uA(
                                                _cV(_component_up_button, _uM("type" to "warning", "text" to "年月", "size" to "mini", "onClick" to showDt3))
                                            ))
                                        )),
                                        _cE("view", _uM("class" to "demo-block mt-12px"), _uA(
                                            _cE("text", _uM("class" to "demo-label"), "仅选时间"),
                                            _cE("view", _uM("class" to "flex-row items-center"), _uA(
                                                _cV(_component_up_button, _uM("type" to "error", "text" to "时分", "size" to "mini", "onClick" to showDt4))
                                            ))
                                        ))
                                    )),
                                    _cV(_component_up_datetime_picker, _uM("show" to dtShow1.value, "mode" to "datetime", "onConfirm" to onConfirm1, "onCancel" to fun(){
                                        dtShow1.value = false
                                    }
                                    ), null, 8, _uA(
                                        "show",
                                    ...
                                    _cV(_component_up_datetime_picker, _uM("show" to dtShow2.value, "mode" to "date", "onConfirm" to onConfirm2, "onCancel" to fun(){
                                        dtShow2.value = false
                                    }
                                    ), null, 8, _uA(
                                        "show",
                                    ...
                                    _cV(_component_up_datetime_picker, _uM("show" to dtShow3.value, "mode" to "year-month", "onConfirm" to onConfirm3, "onCancel" to fun(){
                                        dtShow3.value = false
                                    }
                                    ), null, 8, _uA(
                                        "show",
                                    ...
                                    _cV(_component_up_datetime_picker, _uM("show" to dtShow4.value, "mode" to "time", "onConfirm" to onConfirm4, "onCancel" to fun(){
                                        dtShow4.value = false
                                    }
                                    ), null, 8, _uA(
                                        "show",
