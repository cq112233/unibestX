...
open class GenSrcSubUviewUltraDemosModalModal : BasePage {
    ...
    companion object {
        ...
        var setup: (__props: GenSrcSubUviewUltraDemosModalModal) -> Any? = fun(__props): Any? {
            val __ins = getCurrentInstance()!!
            val _ctx = __ins.proxy as GenSrcSubUviewUltraDemosModalModal
            ...
            fun gen_showNoTitleModal_fn() {
                modalTitle.value = ""
                modalContent.value = "这是一个没有标题的弹窗，显得更加简洁。"
                modalShowCancel.value = false
                modalShow.value = true
            }
            val showNoTitleModal = ::gen_showNoTitleModal_fn
            fun gen_showLongModal_fn() {
                modalTitle.value = "用户协议"
                modalContent.value = "1. 这是一个很长很长很长很长很长很长很长很长的内容\n2. 这是一个很长很长很长很长很长很长很长很长的内容"
                modalShowCancel.value = false
                modalShow.value = true
            }
            val showLongModal = ::gen_showLongModal_fn
            ...
            return fun(): Any? {
                ...
                return _cV(unref(GenAppkuClass), _uM("layout" to "navbar", "show-back" to true, "hide-navbar" to false, "enable-pull-down-refresh" to false, "page-style" to _uO("navigationBarTitleText" to "up-modal 模态框", "navigationStyle" to "custom")), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                    return _uA(
                        _cV(unref(GenSrcLayoutsNavbarClass), _uM("show-back" to true, "hide-navbar" to false, "enable-pull-down-refresh" to false, "page-style" to _uO("navigationBarTitleText" to "up-modal 模态框", "navigationStyle" to "custom")), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                            return _uA(
                                _cE("view", _uM("class" to "weapp-tw-border page-container bg-_b_hf8fafc_B min-h-screen pb-_b30px_B"), _uA(
                                    _cE("view", _uM("class" to "weapp-tw-border p-_b16px_B"), _uA(
                                        ...
                                        _cE("view", _uM("class" to "weapp-tw-border demo-block mt-_b12px_B"), _uA(
                                            _cE("text", _uM("class" to "weapp-tw-border demo-label"), "无标题弹窗"),
                                            _cE("view", _uM("class" to "weapp-tw-border flex-row items-center"), _uA(
                                                _cV(_component_up_button, _uM("type" to "success", "text" to "无标题", "size" to "mini", "onClick" to showNoTitleModal))
                                            ))
                                        )),
                                        _cE("view", _uM("class" to "weapp-tw-border demo-block mt-_b12px_B"), _uA(
                                            _cE("text", _uM("class" to "weapp-tw-border demo-label"), "长内容弹窗"),
                                            _cE("view", _uM("class" to "weapp-tw-border flex-row items-center"), _uA(
                                                _cV(_component_up_button, _uM("type" to "error", "text" to "长内容", "size" to "mini", "onClick" to showLongModal))
                                            ))
                                        ))
                                    )),
