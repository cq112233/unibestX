    ...
    companion object {
        ...
        var setup: (__props: GenSrcTabbarTabbarItem) -> Any? = fun(__props): Any? {
            ...
            return fun(): Any? {
                ...
                return _cE("view", _uM("class" to "weapp-tw-border tabbar-item-wrapper", "style" to _nS(_uM("width" to "100%", "height" to "100%", "align-items" to "center", "justify-content" to "center"))), _uA(
                    if (isTrue(props.isBulge)) {
                        _cE("view", _uM("key" to 0, "class" to "weapp-tw-border bulge-item"), _uA(
                            _cE("view", _uM("class" to "weapp-tw-border bulge-btn"), _uA(
                                _cE("text", _uM("class" to "weapp-tw-border ai-btn-text"), "AI")
                            ))
                        ))
                    } else {
                        _cE("view", _uM("key" to 1, "class" to "weapp-tw-border tabbar-item-inner"), _uA(
                            ...
                            if (unref(tabbarItem).iconType === "icon") {
                                _cE("view", _uM("key" to 1, "class" to "weapp-tw-border icon-normal", "style" to _nS(_uM("align-items" to "center", "justify-content" to "center"))), _uA(
                            ...
                            ,
                            _cE("text", _uM("class" to "weapp-tw-border tabbar-text", "style" to _nS(_uM("color" to getActiveColor()))), _tD(getText()), 5),
                            if (isTrue(isDotBadge())) {
                                _cE("view", _uM("key" to 2, "class" to "weapp-tw-border badge-dot"))
                            } else {
                                _cC("v-if", true)
                            }
                            ,
                            if (isTrue(isNumberBadge())) {
                                _cE("view", _uM("key" to 3, "class" to "weapp-tw-border badge-count"), _uA(
                                    _cE("text", _uM("class" to "weapp-tw-border badge-count-text"), _tD(getBadgeText()), 1)
                                ))
                            } else {
                                _cC("v-if", true)
                            }
