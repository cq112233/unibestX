...
open class GenSrcSubUviewUltraDemosFormForm : BasePage {
    ...
    companion object {
        ...
        var setup: (__props: GenSrcSubUviewUltraDemosFormForm) -> Any? = fun(__props): Any? {
            ...
            val formRules: UTSJSONObject = _uO("name" to _uA(
                _uO("required" to true, "message" to "请填写姓名", "trigger" to _uA(
                    "blur",
                    "change"
                )),
                _uO("min" to 2, "max" to 10, "message" to "姓名长度在2到10个字符", "trigger" to _uA(
                    "blur",
                    "change"
                ))
            ), "gender" to _uA(
            ...
            return fun(): Any? {
                ...
                return _cV(unref(GenAppkuClass), _uM("layout" to "navbar", "show-back" to true, "hide-navbar" to false, "enable-pull-down-refresh" to false, "page-style" to _uO("navigationBarTitleText" to "Form 表单", "navigationStyle" to "custom")), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                    return _uA(
                        _cV(unref(GenSrcLayoutsNavbarClass), _uM("show-back" to true, "hide-navbar" to false, "enable-pull-down-refresh" to false, "page-style" to _uO("navigationBarTitleText" to "Form 表单", "navigationStyle" to "custom")), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                            return _uA(
                                _cE("view", _uM("class" to "weapp-tw-border page-container bg-_b_hf8fafc_B min-h-screen pb-_b30px_B"), _uA(
                                    _cE("view", _uM("class" to "weapp-tw-border p-_b16px_B"), _uA(
                                        _cE("view", _uM("class" to "weapp-tw-border demo-block"), _uA(
                                            _cE("text", _uM("class" to "weapp-tw-border demo-label"), "基础表单示例"),
                                            _cV(_component_up_form, _uM("ref_key" to "uForm", "ref" to uForm, "model" to formModel, "rules" to formRules, "label-width" to "90px", "error-type" to "toast"), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                                                return _uA(
                                                    ...
                                                    _cV(_component_up_form_item, _uM("label" to "性别", "prop" to "gender", "border-bottom" to true, "required" to "", "onClick" to fun(){
                                                    ...
                                                    _cV(_component_up_form_item, _uM("label" to "出生日期", "prop" to "birthday", "border-bottom" to true, "required" to "", "onClick" to fun(){
                                        ...
                                        _cE("view", _uM("class" to "weapp-tw-border demo-block"), _uA(
                                            _cE("text", _uM("class" to "weapp-tw-border demo-label"), "标签上方对齐"),
                                        ...
                                        _cE("view", _uM("class" to "weapp-tw-border mt-_b20px_B flex-row justify-between"), _uA(
                                            _cE("view", _uM("class" to "weapp-tw-border flex-1 mr-_b10px_B"), _uA(
                                                _cV(_component_up_button, _uM("type" to "primary", "text" to "提交表单", "onClick" to submitForm))
                                            )),
                                            _cE("view", _uM("class" to "weapp-tw-border flex-1 ml-_b10px_B"), _uA(
