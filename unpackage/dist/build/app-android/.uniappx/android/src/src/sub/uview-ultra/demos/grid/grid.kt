        ...
        var setup: (__props: GenSrcSubUviewUltraDemosGridGrid) -> Any? = fun(__props): Any? {
            ...
            return fun(): Any? {
                ...
                return _cV(unref(GenAppkuClass), null, _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                    return _uA(
                        _cV(unref(GenSrcLayoutsDefaultClass), _uM("navigation-style" to "custom", "navigation-bar-title-text" to "up-grid 宫格"), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                            return _uA(
                                _cE("view", _uM("class" to "page-container bg-__f8fafc_ min-h-screen pb-30px"), _uA(
                                    _cV(_component_NavBar, _uM("title" to "Grid 宫格", "auto-back" to true)),
                                                    ...
                                                    _cE(Fragment, null, RenderHelpers.renderList(4, fun(i, __key, __index, _cached): Any {
                                                        return _cV(_component_up_grid_item, _uM("key" to i), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                                                            return _uA(
                                                                ...
                                                                _cE("text", _uM("style" to _nS(_uM("margin-top" to "10px", "font-size" to "14px", "color" to "#333"))), "宫格", 4)
                                                            )
                                                        }
                                                        ), "_" to 2), 1024)
                                                    }
