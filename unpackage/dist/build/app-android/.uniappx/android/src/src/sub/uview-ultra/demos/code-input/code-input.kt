...
open class GenSrcSubUviewUltraDemosCodeInputCodeInput : BasePage {
    ...
    companion object {
        ...
        var setup: (__props: GenSrcSubUviewUltraDemosCodeInputCodeInput) -> Any? = fun(__props): Any? {
            val __ins = getCurrentInstance()!!
            val _ctx = __ins.proxy as GenSrcSubUviewUltraDemosCodeInputCodeInput
            val _cache = __ins.renderCache
            val codeInputValue1 = ref("")
            val codeInputValue2 = ref("")
            val codeInputValue3 = ref("")
            fun gen_onCodeInputFinish_fn(kVal: String): Unit {
                uni_showToast(ShowToastOptions(title = "输入的验证码为: " + kVal, icon = "none"))
            }
            ...
            return fun(): Any? {
                ...
                return _cV(unref(GenAppkuClass), _uM("layout" to "navbar", "show-back" to true, "hide-navbar" to false, "enable-pull-down-refresh" to false, "page-style" to _uO("navigationBarTitleText" to "CodeInput 验证码", "navigationStyle" to "custom")), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                    return _uA(
                        _cV(unref(GenSrcLayoutsNavbarClass), _uM("show-back" to true, "hide-navbar" to false, "enable-pull-down-refresh" to false, "page-style" to _uO("navigationBarTitleText" to "CodeInput 验证码", "navigationStyle" to "custom")), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                            return _uA(
                                _cE("view", _uM("class" to "weapp-tw-border page-container bg-_b_hf8fafc_B min-h-screen pb-_b30px_B"), _uA(
                                    _cE("view", _uM("class" to "weapp-tw-border p-_b16px_B"), _uA(
                                        _cE("view", _uM("class" to "weapp-tw-border demo-block"), _uA(
                                            _cE("text", _uM("class" to "weapp-tw-border demo-label"), "up-code-input"),
                                            ...
                                            , "maxlength" to 6, "mode" to "box", "onFinish" to onCodeInputFinish), null, 8, _uA(
                                                "modelValue",
                                                "onUpdate:modelValue"
                                            ))
                                        )),
                                        _cE("view", _uM("class" to "weapp-tw-border demo-block mt-_b12px_B"), _uA(
                                            _cE("text", _uM("class" to "weapp-tw-border demo-label"), "横线模式"),
                                            ...
                                            , "maxlength" to 4, "mode" to "line"), null, 8, _uA(
                                                "modelValue",
                                                "onUpdate:modelValue"
                                            ))
                                        )),
                                        _cE("view", _uM("class" to "weapp-tw-border demo-block mt-_b12px_B"), _uA(
                                            _cE("text", _uM("class" to "weapp-tw-border demo-label"), "自定义间距与颜色"),
                                            ...
                                            , "maxlength" to 4, "mode" to "box", "space" to "10", "color" to "#2979ff", "border-color" to "#2979ff"), null, 8, _uA(
                                                "modelValue",
                                                "onUpdate:modelValue"
                                            ))
                                        ))
