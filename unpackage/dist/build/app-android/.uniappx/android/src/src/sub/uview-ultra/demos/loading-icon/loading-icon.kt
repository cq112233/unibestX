        ...
        var setup: (__props: GenSrcSubUviewUltraDemosLoadingIconLoadingIcon) -> Any? = fun(__props): Any? {
            ...
            return fun(): Any? {
                ...
                return _cV(unref(GenAppkuClass), null, _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                    return _uA(
                        _cV(unref(GenSrcLayoutsDefaultClass), _uM("navigation-style" to "custom", "navigation-bar-title-text" to "up-loading-icon 加载图标"), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                            return _uA(
                                _cE("view", _uM("class" to "page-container bg-__f8fafc_ min-h-screen pb-30px"), _uA(
                                    _cV(_component_NavBar, _uM("title" to "LoadingIcon 加载图标", "auto-back" to true)),
                                    _cE("view", _uM("class" to "p-16px"), _uA(
                                        _cE("view", _uM("class" to "demo-block"), _uA(
                                            _cE("text", _uM("class" to "demo-label"), "基础用法"),
                                            _cV(_component_up_loading_icon, _uM("class" to "my-10px"))
                                        )),
                                        _cE("view", _uM("class" to "demo-block"), _uA(
                                            _cE("text", _uM("class" to "demo-label"), "其他模式"),
                                            _cV(_component_up_loading_icon, _uM("mode" to "circle", "class" to "my-10px")),
                                            _cV(_component_up_loading_icon, _uM("mode" to "semicircle", "class" to "my-10px"))
                                        ))
                                    ))
                                ))
                            )
