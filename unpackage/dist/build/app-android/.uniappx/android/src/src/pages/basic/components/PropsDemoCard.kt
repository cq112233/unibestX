        ...
        var setup: (__props: GenSrcPagesBasicComponentsPropsDemoCard) -> Any? = fun(__props): Any? {
            ...
            return fun(): Any? {
                return _cV(unref(GenSrcPagesBasicComponentsCardClass), _uM("title" to "父子组件传参 & 具名插槽演示"), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                    return _uA(
                        _cE("view", _uM("class" to "weapp-tw-border wtu-vxgnz7-0 wtu-bzagc8-1 wtu-b66ka1-2 wtu-74ncny-3 wtu-1owovkx-4 wtu-1pdwtsl-5 wtu-cwe6v6-6"), _uA(
                            _cE("text", _uM("class" to "weapp-tw-border wtu-1a5l072-7 wtu-sv7fhw-8 wtu-44jmxl-9 wtu-bhsfe3-a"), "👨‍👩‍👧 父组件状态管理面板"),
                            _cE("view", _uM("class" to "weapp-tw-border wtu-1qcvxlr-b wtu-i6zy5z-c wtu-1vkc6z9-d"), _uA(
                                _cE("text", _uM("class" to "weapp-tw-border wtu-1hmoe0k-e wtu-1581zln-f"), "父组件 Count 变量: "),
                                _cE("text", _uM("class" to "weapp-tw-border wtu-1a5l072-7 wtu-sv7fhw-8 wtu-1cwqag0-g wtu-1cbwlqp-h"), _tD(parentCount.value), 1)
                            )),
                            _cE("view", _uM("class" to "weapp-tw-border wtu-1qcvxlr-b wtu-i6zy5z-c wtu-hqsngi-i"), _uA(
                                _cE("text", _uM("class" to "weapp-tw-border wtu-1hmoe0k-e wtu-1581zln-f"), "接收到的子组件消息: "),
                                _cE("text", _uM("class" to "weapp-tw-border wtu-1hmoe0k-e wtu-sv7fhw-8 wtu-cj9lbh-j wtu-1cbwlqp-h"), _tD(childMessage.value), 1)
                            )),
                            _cE("view", _uM("class" to "weapp-tw-border wtu-1qcvxlr-b wtu-i6zy5z-c"), _uA(
                                _cE("view", _uM("class" to "weapp-tw-border wtu-1t9ug01-k wtu-1qt2m0f-l wtu-hvwz4r-m wtu-bf75hz-n wtu-1qcvxlr-b wtu-i6zy5z-c wtu-19aj3kn-o wtu-6ebfap-p", "onClick" to addFiveFromParent), _uA(
                                    _cE("text", _uM("class" to "weapp-tw-border wtu-1c2l3ni-q wtu-1hmoe0k-e"), "父组件直接 Count + 5")
                                )),
                                _cE("view", _uM("class" to "weapp-tw-border wtu-1h73awj-r wtu-1qt2m0f-l wtu-hvwz4r-m wtu-bf75hz-n wtu-1qcvxlr-b wtu-i6zy5z-c wtu-19aj3kn-o", "onClick" to resetParent), _uA(
                                    _cE("text", _uM("class" to "weapp-tw-border wtu-1c2l3ni-q wtu-1hmoe0k-e"), "父组件重置状态")
                                ))
                            ))
                        )),
                        _cV(unref(GenSrcPagesBasicComponentsChildDemoBoxClass), _uM("title" to "组件通信演示子节点", "count" to parentCount.value, "tags" to tagList.value, "onAdd" to onChildAdd, "onReset" to onChildReset, "onSendMsg" to onChildSendMsg), _uM("header" to withSlotCtx(fun(): UTSArray<Any> {
                            return _uA(
                                _cE("view", _uM("class" to "weapp-tw-border wtu-1qcvxlr-b wtu-i6zy5z-c wtu-16203my-s"), _uA(
                                    _cE("text", _uM("class" to "weapp-tw-border wtu-1a5l072-7 wtu-sv7fhw-8 wtu-161zm7w-t"), "🏷️ 父组件填入的具名 Header 插槽"),
                                    _cE("text", _uM("class" to "weapp-tw-border wtu-1j9rfuf-u wtu-1581zln-f wtu-v9l0kh-v wtu-zb8dsk-w wtu-1y4fkff-x wtu-1jbz86x-y"), "自定义 Header")
                                ))
                            )
                        }
                            ...
                            return _uA(
                                _cE("view", _uM("class" to "weapp-tw-border wtu-1qcvxlr-b wtu-i6zy5z-c wtu-1ue7bt4-z wtu-1qt2m0f-l wtu-1932lzo-10 wtu-1owovkx-4 wtu-1pdwtsl-5 wtu-16vqpiu-11"), _uA(
                                    _cE("text", _uM("class" to "weapp-tw-border wtu-1j9rfuf-u wtu-sv7fhw-8 wtu-1gdtqyh-12 wtu-1ys92t7-13"), "#" + _tD((index as Number) + 1), 1),
                                    _cE("text", _uM("class" to "weapp-tw-border wtu-1hmoe0k-e wtu-165ep59-14 wtu-1nu791o-15"), _tD(item), 1),
                                    _cE("text", _uM("class" to "weapp-tw-border wtu-1sh719e-16 wtu-1qit6r8-17 wtu-1aizezg-18"), "具名Slot传参: " + _tD(item), 1)
                                ))
                            )
                        }
                        ), "footer" to withSlotCtx(fun(): UTSArray<Any> {
                            return _uA(
                                _cE("view", _uM("class" to "weapp-tw-border wtu-1qcvxlr-b wtu-i6zy5z-c wtu-16203my-s wtu-1y4fkff-x"), _uA(
                                    _cE("text", _uM("class" to "weapp-tw-border wtu-1hmoe0k-e wtu-ntizu3-19"), "📌 父组件填入的具名 Footer 插槽"),
                                    _cE("text", _uM("class" to "weapp-tw-border wtu-1j9rfuf-u wtu-cj9lbh-j wtu-5777z3-1a wtu-zb8dsk-w wtu-1y4fkff-x wtu-1jbz86x-y wtu-1nu791o-15"), "双向通信验证成功")
                                ))
                            )
                        }
                        ), "_" to 1), 8, _uA(
