...
open class GenSrcSubUviewUltraDemosToastToast : BasePage {
    ...
    companion object {
        ...
        var setup: (__props: GenSrcSubUviewUltraDemosToastToast) -> Any? = fun(__props): Any? {
            val __ins = getCurrentInstance()!!
            val _ctx = __ins.proxy as GenSrcSubUviewUltraDemosToastToast
            val _cache = __ins.renderCache
            val uToast = ref(null as ComponentPublicInstance?)
            fun gen_showToast_fn(type: String) {
                val toast = uToast.value
                if (toast != null) {
                    val configs: UTSJSONObject = _uO("success" to _uO("message" to "操作成功！", "type" to "success"), "error" to _uO("message" to "操作失败！", "type" to "error"), "warning" to _uO("message" to "请注意风险！", "type" to "warning"), "default" to _uO("message" to "这是一条提示", "type" to "default"))
            ...
            return fun(): Any? {
                ...
                return _cV(unref(GenAppkuClass), _uM("layout" to "navbar", "show-back" to true, "hide-navbar" to false, "enable-pull-down-refresh" to false, "page-style" to _uO("navigationBarTitleText" to "up-toast 消息提示", "navigationStyle" to "custom")), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                    return _uA(
                        _cV(unref(GenSrcLayoutsNavbarClass), _uM("show-back" to true, "hide-navbar" to false, "enable-pull-down-refresh" to false, "page-style" to _uO("navigationBarTitleText" to "up-toast 消息提示", "navigationStyle" to "custom")), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                            return _uA(
                                _cE("view", _uM("class" to "weapp-tw-border page-container bg-_b_hf8fafc_B min-h-screen pb-_b30px_B"), _uA(
                                    _cE("view", _uM("class" to "weapp-tw-border p-_b16px_B"), _uA(
                                        ...
                                        _cE("view", _uM("class" to "weapp-tw-border demo-block mt-_b12px_B"), _uA(
                                            _cE("text", _uM("class" to "weapp-tw-border demo-label"), "更多类型"),
                                            _cE("view", _uM("class" to "weapp-tw-border flex-row items-center"), _uA(
                                                ...
                                                _cE("view", _uM("class" to "weapp-tw-border w-_b10px_B")),
                                                _cV(_component_up_button, _uM("type" to "default", "text" to "默认提示", "size" to "mini", "onClick" to fun(){
                                                    showToast("default")
                                                }
                                                ), null, 8, _uA(
                                                    "onClick"
