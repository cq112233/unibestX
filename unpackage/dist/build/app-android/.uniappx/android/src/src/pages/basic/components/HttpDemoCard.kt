            ...
            return fun(): Any? {
                return _cV(unref(GenSrcPagesBasicComponentsCardClass), _uM("title" to "HTTP 请求 Demo"), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                    return _uA(
                        ...
                        _cE("view", _uM("class" to "rounded-10px p-12px mb-16px border-width-1px border-style-solid border-color-__e2e8f0_"), _uA(
