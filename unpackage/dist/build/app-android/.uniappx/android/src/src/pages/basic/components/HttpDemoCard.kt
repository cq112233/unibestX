        ...
        var setup: (__props: GenSrcPagesBasicComponentsHttpDemoCard) -> Any? = fun(__props): Any? {
            ...
            return fun(): Any? {
                return _cV(unref(GenSrcPagesBasicComponentsCardClass), _uM("title" to "HTTP 请求 Demo"), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                    return _uA(
                        _cE("view", _uM("class" to "weapp-tw-border wtu-w0ubis-0 wtu-qf0h83-1 wtu-ecdk3o-2 wtu-wfs7cl-3 wtu-16hz6cp-4 wtu-1ns4j6f-5"), _uA(
                            _cE("text", _uM("class" to "weapp-tw-border wtu-mcng40-6 wtu-pryky7-7 wtu-1vehn2-8"), " 基于 lime-request 封装的 http 请求演示，包含 Mock 数据与真实接口请求两种模式。 ")
                        )),
                        _cE("view", _uM("class" to "weapp-tw-border wtu-ecdk3o-2"), _uA(
                            _cE("view", _uM("class" to "weapp-tw-border wtu-1p3s0p7-9 wtu-or3po3-a wtu-ok6iny-b wtu-vnac5q-c"), _uA(
                                _cE("view", _uM("class" to "weapp-tw-border wtu-1p3s0p7-9 wtu-or3po3-a"), _uA(
                                    _cE("view", _uM("class" to "weapp-tw-border wtu-bx383i-d wtu-yg23h9-e wtu-1ny4yap-f wtu-1p6uh6r-g wtu-wfs7cl-3 wtu-16hz6cp-4 wtu-vuut8m-h wtu-or3po3-a wtu-ijj99f-i wtu-1hzxj1a-j"), _uA(
                                        _cE("text", _uM("class" to "weapp-tw-border wtu-mcng40-6 wtu-1gyo9ug-k wtu-1t7q418-l"), "UC")
                                    )),
                                    _cE("view", _uM("class" to "weapp-tw-border"), _uA(
                                        _cE("text", _uM("class" to "weapp-tw-border wtu-owidvm-m wtu-1gyo9ug-k wtu-tbkcso-n"), "uniCloud 云对象"),
                                        _cE("text", _uM("class" to "weapp-tw-border wtu-52xho3-o wtu-pryky7-7 wtu-1ur1rlt-p"), "user.getUserInfo")
                                    ))
                                )),
                                _cE("view", _uM("class" to _nC(_uA(
                                    "weapp-tw-border wtu-1p3s0p7-9 wtu-or3po3-a wtu-1jy1lu-q wtu-t9pnvh-r wtu-edhfgi-s",
                                    cloudStatusBgClass.value
                                ))), _uA(
                                    _cE("view", _uM("class" to _nC(_uA(
                                        "weapp-tw-border wtu-ga9uen-t wtu-1l83xre-u wtu-11tvxcq-v wtu-ofr59w-w",
                                        cloudStatusDotClass.value
                                    ))), null, 2),
                                    _cE("text", _uM("class" to _nC(_uA(
                                        "weapp-tw-border wtu-52xho3-o",
                                        cloudStatusTextClass.value
                                    ))), _tD(cloudStatusText.value), 3)
                                ), 2)
                            )),
                            _cE("view", _uM("class" to "weapp-tw-border wtu-1ny4yap-f wtu-18s889y-x wtu-wfs7cl-3 wtu-16hz6cp-4 wtu-2k7lhn-y wtu-4cqy02-z"), _uA(
                                _cE("view", _uM("class" to "weapp-tw-border wtu-2crfgb-10 wtu-ehcs6-11")),
                                _cE("view", _uM("class" to "weapp-tw-border wtu-1115s0n-12"), _uA(
                                    _cE("view", _uM("class" to "weapp-tw-border wtu-1p3s0p7-9 wtu-or3po3-a wtu-ok6iny-b wtu-1awb42t-13"), _uA(
                                        _cE("text", _uM("class" to "weapp-tw-border wtu-52xho3-o wtu-pryky7-7"), "响应数据"),
                                        _cE("text", _uM("class" to "weapp-tw-border wtu-ead332-14 wtu-6tsugz-15"), "JSON")
                                    )),
                                    if (isTrue(cloudLoading.value)) {
                                        _cE("text", _uM("key" to 0, "class" to "weapp-tw-border wtu-mcng40-6 wtu-1t7q418-l"), "正在连接云端服务...")
                                    } else {
                                        if (isTrue(hasCloudError.value)) {
                                            _cE("text", _uM("key" to 1, "class" to "weapp-tw-border wtu-mcng40-6 wtu-1ivzueh-16"), _tD(cloudErrorMsg.value), 1)
                                        } else {
                                            _cE("text", _uM("key" to 2, "class" to "weapp-tw-border wtu-mcng40-6 wtu-xg97j7-17 wtu-1vehn2-8"), _tD(userInfo.value), 1)
                                        }
                                    }
                                    ,
                                    if (isTrue(hasCloudError.value)) {
                                        _cE("view", _uM("key" to 3, "class" to "weapp-tw-border wtu-17nc15w-18 wtu-1p3s0p7-9"), _uA(
                                            _cE("view", _uM("class" to "weapp-tw-border wtu-yg23h9-e wtu-1us4hrd-19 wtu-1792i3v-1a wtu-1k2vmtw-1b wtu-or3po3-a wtu-ijj99f-i", "onClick" to getUserInfo), _uA(
                                                _cE("text", _uM("class" to "weapp-tw-border wtu-mcng40-6 wtu-155p5he-1c"), "重新获取")
                                            ))
                                        ))
                                    } else {
                                        _cC("v-if", true)
                        ...
                        _cE("view", _uM("class" to "weapp-tw-border wtu-ecdk3o-2"), _uA(
                            _cE("text", _uM("class" to "weapp-tw-border wtu-owidvm-m wtu-1gyo9ug-k wtu-1e7koem-1d wtu-vnac5q-c"), "Mock 数据列表（ID 为任意类型）"),
                            _cE(Fragment, null, RenderHelpers.renderList(mockList.value, fun(item, index, __index, _cached): Any {
                                return _cE("view", _uM("key" to index, "class" to "weapp-tw-border wtu-1p3s0p7-9 wtu-or3po3-a wtu-1lgfe3e-1e wtu-1us4hrd-19 wtu-1y83w1l-1f wtu-1ny4yap-f wtu-yqo827-1g"), _uA(
                                    _cE("view", _uM("class" to "weapp-tw-border wtu-5wqmpn-1h wtu-sz6l4-1i wtu-1v2zgda-1j wtu-1i8kliw-1k wtu-ijj99f-i wtu-or3po3-a wtu-1hzxj1a-j"), _uA(
                                        _cE("text", _uM("class" to "weapp-tw-border wtu-mcng40-6 wtu-155p5he-1c wtu-1gyo9ug-k"), _tD(item.id), 1)
                                    )),
                                    _cE("text", _uM("class" to "weapp-tw-border wtu-owidvm-m wtu-xg97j7-17"), _tD(item.name), 1)
                                ))
                            }
                            ), 128)
                        )),
                        _cE("view", _uM("class" to "weapp-tw-border wtu-edhfgi-s wtu-1115s0n-12 wtu-ecdk3o-2 wtu-wfs7cl-3 wtu-16hz6cp-4 wtu-1ns4j6f-5"), _uA(
                            _cE("view", _uM("class" to "weapp-tw-border wtu-1p3s0p7-9 wtu-ok6iny-b wtu-or3po3-a wtu-115s1if-1l"), _uA(
                                _cE("text", _uM("class" to "weapp-tw-border wtu-mdu9q5-1m wtu-pryky7-7"), "接口请求状态:"),
                                _cE("view", _uM("class" to _nC(_uA(
                                    "weapp-tw-border wtu-1jy1lu-q wtu-uaewvr-1n wtu-edhfgi-s",
                                    statusBgClass.value
                                ))), _uA(
                                    _cE("text", _uM("class" to _nC(_uA(
                                        "weapp-tw-border wtu-mcng40-6",
                                        statusTextClass.value
                                    ))), _tD(statusText.value), 3)
                                ), 2)
                            )),
                            if (isTrue(hasResponseData.value)) {
                                _cE("view", _uM("key" to 0, "class" to "weapp-tw-border wtu-kp3eq2-1o wtu-1ny4yap-f wtu-1ic2k2p-1p wtu-wfs7cl-3 wtu-16hz6cp-4 wtu-1ns4j6f-5"), _uA(
                                    _cE("text", _uM("class" to "weapp-tw-border wtu-mcng40-6 wtu-s98mzw-1q"), _tD(responseText.value), 1)
                                ))
                            } else {
                                _cC("v-if", true)
                            }
                            ...
                            if (isTrue(hasErrorMsg.value)) {
                                _cE("view", _uM("key" to 1, "class" to "weapp-tw-border wtu-snsrpe-1r wtu-1ny4yap-f wtu-1ic2k2p-1p wtu-wfs7cl-3 wtu-16hz6cp-4 wtu-1bi5jw-1s wtu-1cffqjh-1t"), _uA(
                                    _cE("text", _uM("class" to "weapp-tw-border wtu-mcng40-6 wtu-bquocn-1u"), "错误：" + _tD(errorMsg.value), 1)
                                ))
                            } else {
                                _cC("v-if", true)
                            }
                        )),
                        _cE("view", _uM("class" to "weapp-tw-border wtu-1p3s0p7-9"), _uA(
                            _cE("view", _uM("class" to "weapp-tw-border wtu-wy44gc-1v wtu-1hzxj1a-j"), _uA(
                                _cE("view", _uM("class" to "weapp-tw-border wtu-1i8kliw-1k wtu-1ny4yap-f wtu-10jafc4-1w wtu-1mbx3i8-1x wtu-io2yyi-1y wtu-1p3s0p7-9 wtu-or3po3-a wtu-ijj99f-i", "onClick" to loadMockData), _uA(
                                    _cE("text", _uM("class" to "weapp-tw-border wtu-1tndks6-1z wtu-owidvm-m"), "加载 Mock 数据")
                                ))
                            )),
                            _cE("view", _uM("class" to "weapp-tw-border wtu-wy44gc-1v"), _uA(
                                _cE("view", _uM("class" to "weapp-tw-border wtu-1dwvvaj-20 wtu-1ny4yap-f wtu-10jafc4-1w wtu-1mbx3i8-1x wtu-io2yyi-1y wtu-1p3s0p7-9 wtu-or3po3-a wtu-ijj99f-i", "onClick" to fetchRealApi), _uA(
                                    _cE("text", _uM("class" to "weapp-tw-border wtu-1tndks6-1z wtu-owidvm-m"), _tD(if (loading.value) {
                                        "请求中..."
                                    } else {
                                        "真实 API 请求"
                                    }
                        ...
                        _cE("view", _uM("class" to "weapp-tw-border wtu-1pmzy0e-21"), _uA(
                            _cE("view", _uM("class" to "weapp-tw-border wtu-1p3s0p7-9 wtu-or3po3-a wtu-vnac5q-c"), _uA(
                                _cE("view", _uM("class" to "weapp-tw-border wtu-bx383i-d wtu-yg23h9-e wtu-1ny4yap-f wtu-2bai5c-22 wtu-wfs7cl-3 wtu-16hz6cp-4 wtu-11ywkxn-23 wtu-or3po3-a wtu-ijj99f-i wtu-1hzxj1a-j"), _uA(
                                    _cE("text", _uM("class" to "weapp-tw-border wtu-mcng40-6 wtu-1gyo9ug-k wtu-wx16af-24"), "UP")
                                )),
                                _cE("view", _uM("class" to "weapp-tw-border wtu-wy44gc-1v"), _uA(
                                    _cE("text", _uM("class" to "weapp-tw-border wtu-owidvm-m wtu-1gyo9ug-k wtu-tbkcso-n"), "文件上传"),
                                    _cE("text", _uM("class" to "weapp-tw-border wtu-52xho3-o wtu-pryky7-7 wtu-1ur1rlt-p"), _tD(uploadPath.value), 1)
                                ))
                            )),
                            _cE("view", _uM("class" to "weapp-tw-border wtu-1p3s0p7-9 wtu-or3po3-a wtu-2bai5c-22 wtu-hw36l4-25 wtu-1792i3v-1a wtu-vnac5q-c wtu-wfs7cl-3 wtu-16hz6cp-4 wtu-bgknk1-26"), _uA(
                                _cE("text", _uM("class" to "weapp-tw-border wtu-52xho3-o wtu-wx16af-24 wtu-bturnd-27 wtu-wy44gc-1v"), " 💡 上传 OSS 接口地址支持直接在 .env 环境变量中配置（VITE_UPLOAD_BASEURL / VITE_UPLOAD_PATH） ")
                            )),
                            _cE("view", _uM("class" to "weapp-tw-border wtu-1ny4yap-f wtu-18s889y-x wtu-wfs7cl-3 wtu-16hz6cp-4 wtu-2k7lhn-y wtu-4cqy02-z"), _uA(
                                _cE("view", _uM("class" to "weapp-tw-border wtu-2crfgb-10 wtu-rp6t3a-28")),
                                _cE("view", _uM("class" to "weapp-tw-border wtu-1115s0n-12"), _uA(
                                    _cE("view", _uM("class" to "weapp-tw-border wtu-1p3s0p7-9 wtu-or3po3-a wtu-ok6iny-b wtu-1awb42t-13"), _uA(
                                        _cE("text", _uM("class" to "weapp-tw-border wtu-52xho3-o wtu-pryky7-7"), "上传结果"),
                                        _cE("text", _uM("class" to "weapp-tw-border wtu-ead332-14 wtu-6tsugz-15"), "POST")
                                    )),
                                    if (isTrue(uploadLoading.value)) {
                                        _cE("text", _uM("key" to 0, "class" to "weapp-tw-border wtu-mcng40-6 wtu-wx16af-24"), "正在上传...")
                                    } else {
                                        if (isTrue(hasUploadError.value)) {
                                            _cE("text", _uM("key" to 1, "class" to "weapp-tw-border wtu-mcng40-6 wtu-1ivzueh-16"), _tD(uploadError.value), 1)
                                        } else {
                                            if (isTrue(hasUploadResult.value)) {
                                                _cE("view", _uM("key" to 2, "class" to "weapp-tw-border"), _uA(
                                                    _cE("view", _uM("class" to "weapp-tw-border wtu-or3po3-a wtu-ijj99f-i wtu-1lgfe3e-1e wtu-kp3eq2-1o wtu-1ny4yap-f wtu-wfs7cl-3 wtu-16hz6cp-4 wtu-1ns4j6f-5"), _uA(
                                                        ...
                                                        _cE("text", _uM("class" to "weapp-tw-border wtu-ead332-14 wtu-6tsugz-15 wtu-1cffqjh-1t"), "点击查看大图")
                                                    )),
                                                    _cE("view", _uM("class" to "weapp-tw-border wtu-17nc15w-18 wtu-1ic2k2p-1p wtu-18s889y-x wtu-1ny4yap-f wtu-wfs7cl-3 wtu-16hz6cp-4 wtu-1ns4j6f-5"), _uA(
                                                        _cE("view", _uM("class" to "weapp-tw-border wtu-1p3s0p7-9 wtu-or3po3-a wtu-ok6iny-b wtu-115s1if-1l"), _uA(
                                                            _cE("view", _uM("class" to "weapp-tw-border wtu-1p3s0p7-9 wtu-or3po3-a"), _uA(
                                                                _cE("view", _uM("class" to "weapp-tw-border wtu-x3m0ie-2b wtu-1rl0xbz-2c wtu-rp6t3a-28 wtu-zn5xf3-2d wtu-q2u73r-2e")),
                                                                _cE("text", _uM("class" to "weapp-tw-border wtu-52xho3-o wtu-1gyo9ug-k wtu-s98mzw-1q"), "OSS 链接地址")
                                                            )),
                                                            _cE("view", _uM("class" to "weapp-tw-border wtu-1jy1lu-q wtu-13huiaq-2f wtu-ymgoet-2g wtu-naxge4-2h wtu-1p3s0p7-9 wtu-or3po3-a", "onClick" to copyUploadUrl), _uA(
                                                                _cE("text", _uM("class" to "weapp-tw-border wtu-ead332-14 wtu-155p5he-1c wtu-1xw5jy8-2i"), "复制链接")
                                                            ))
                                                        )),
                                                        _cE("text", _uM("class" to "weapp-tw-border oss-url-text wtu-52xho3-o wtu-xg97j7-17 wtu-8o3aer-2j", "selectable" to true), _tD(uploadResultText.value), 1)
                                                    ))
                                                ))
                                            } else {
                                                _cE("text", _uM("key" to 3, "class" to "weapp-tw-border wtu-mcng40-6 wtu-6tsugz-15"), "未选择文件")
                                            }
                                        }
                                    }
                                ))
                            )),
                            _cE("view", _uM("class" to "weapp-tw-border wtu-17nc15w-18"), _uA(
                                _cE("view", _uM("class" to "weapp-tw-border wtu-rp6t3a-28 wtu-1ny4yap-f wtu-10jafc4-1w wtu-1mbx3i8-1x wtu-io2yyi-1y wtu-1p3s0p7-9 wtu-or3po3-a wtu-ijj99f-i", "onClick" to chooseAndUpload), _uA(
                                    _cE("text", _uM("class" to "weapp-tw-border wtu-1tndks6-1z wtu-owidvm-m"), _tD(if (uploadLoading.value) {
                                        "上传中..."
                                    } else {
                                        "选择图片并上传"
                                    }
