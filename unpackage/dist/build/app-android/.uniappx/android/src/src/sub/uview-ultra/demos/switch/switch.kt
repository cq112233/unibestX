        ...
        var setup: (__props: GenSrcSubUviewUltraDemosSwitchSwitch) -> Any? = fun(__props): Any? {
            ...
            return fun(): Any? {
                ...
                return _cV(unref(GenAppkuClass), null, _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                    return _uA(
                        _cV(unref(GenSrcLayoutsDefaultClass), _uM("navigation-style" to "custom", "navigation-bar-title-text" to "up-switch 开关"), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                            return _uA(
                                _cE("view", _uM("class" to "page-container bg-__f8fafc_ min-h-screen pb-30px"), _uA(
                                    _cV(_component_NavBar, _uM("title" to "up-switch 开关", "auto-back" to true, "safe-area-inset-top" to true, "bg-color" to "#ffffff")),
                                    _cE("view", _uM("class" to "p-16px"), _uA(
                                        _cE("view", _uM("class" to "demo-block"), _uA(
                                            ...
                                            _cE("view", _uM("class" to "flex-row items-center"), _uA(
                                                ...
                                                _cE("text", _uM("class" to "text-14px ml-10px"), _tD(if (switchValue1.value) {
                                                    "已开启"
                                                } else {
                                                    "已关闭"
                                                }
                                        ...
                                        _cE("view", _uM("class" to "demo-block mt-12px"), _uA(
                                            ...
                                            _cE("view", _uM("class" to "flex-row items-center"), _uA(
                                                ...
                                                , "size" to "20", "class" to "mr-10px"), null, 8, _uA(
                                                    "modelValue",
                                                    "onUpdate:modelValue"
                                                )),
                                                _cV(_component_up_switch, _uM("modelValue" to switchValue5.value, "onUpdate:modelValue" to fun(`$event`: Boolean){
