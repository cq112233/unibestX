        ...
        var setup: (__props: GenSrcPagesBasicComponentsTailwindcssDemoCard) -> Any? = fun(__props): Any? {
            ...
            return fun(): Any? {
                return _cV(unref(GenSrcPagesBasicComponentsCardClass), _uM("title" to "weapp-tailwindcss Demo"), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                    return _uA(
                        _cE("view", _uM("class" to "weapp-tw-border wtu-10fxz8g-0 wtu-n07vof-1"), _uA(
                            _cE("text", _uM("class" to "weapp-tw-border wtu-1swt5i6-2 wtu-7ut3h6-3 wtu-v1603q-4 wtu-1k2vr17-5"), " 项目已接入 Tailwind CSS v4 + weapp-tailwindcss，支持方括号任意值（如 text-[14px]、mt-[12px]）、dark: 暗黑变体与多端平台变体，一套类名全端生效，写法与 Web 端完全一致。 "),
                            _cE("view", _uM("class" to "weapp-tw-border wtu-1ue8wuu-6 wtu-ugr1m2-7 wtu-64j6tc-8 wtu-7jd6f-9 wtu-ln8km0-a wtu-1k2vr17-5", "onClick" to copyWebsiteUrl), _uA(
                                _cE("text", _uM("class" to "weapp-tw-border wtu-1jpdk37-b wtu-1lxv8cd-c wtu-p1t5tf-d wtu-pgoxso-e"), "官网："),
                                _cE("text", _uM("class" to "weapp-tw-border wtu-1jpdk37-b wtu-155roug-f wtu-1klokvc-g wtu-1vk0on5-h"), "https://tw.icebreaker.top/zh-cn/"),
                                _cE("text", _uM("class" to "weapp-tw-border wtu-9ng6ts-i wtu-17ue17q-j"), "点击复制")
                            )),
                            _cE("view", _uM("class" to "weapp-tw-border wtu-1ue8wuu-6 wtu-ugr1m2-7 wtu-8yh2zy-k"), _uA(
                                _cE("view", _uM("class" to "weapp-tw-border wtu-3xj2e-l wtu-1s0c5bc-m wtu-1qnaxng-n wtu-1smlacz-o wtu-s74oky-p wtu-rwf26b-q wtu-6u6y64-r wtu-1rjkyp8-s wtu-9gow7j-t"), _uA(
                                    _cE("text", _uM("class" to "weapp-tw-border wtu-9ng6ts-i wtu-155roug-f wtu-p1t5tf-d"), "Tailwind CSS v4")
                                )),
                                _cE("view", _uM("class" to "weapp-tw-border wtu-3xj2e-l wtu-1s0c5bc-m wtu-1qnaxng-n wtu-1smlacz-o wtu-s74oky-p wtu-1796l3j-u wtu-6u6y64-r wtu-1rjkyp8-s wtu-173g5br-v"), _uA(
                                    _cE("text", _uM("class" to "weapp-tw-border wtu-9ng6ts-i wtu-itbynk-w wtu-p1t5tf-d"), "方括号任意值")
                                )),
                                _cE("view", _uM("class" to "weapp-tw-border wtu-1s0c5bc-m wtu-1qnaxng-n wtu-1smlacz-o wtu-s74oky-p wtu-1v1k4mz-x wtu-6u6y64-r wtu-1rjkyp8-s wtu-h6hcp8-y"), _uA(
                                    _cE("text", _uM("class" to "weapp-tw-border wtu-9ng6ts-i wtu-1cm941u-z wtu-p1t5tf-d"), "dark: 暗黑变体")
                                ))
                            ))
                        )),
                        _cE("view", _uM("class" to "weapp-tw-border wtu-1bmc39l-10 wtu-1tf82vj-11 wtu-12wk9v6-12 wtu-13en0gu-13 wtu-vx8l1f-14 wtu-1ue8wuu-6 wtu-ugr1m2-7 wtu-xicm2m-15", "onClick" to navigateToDemo), _uA(
                            _cE("text", _uM("class" to "weapp-tw-border wtu-jq9nhf-16 wtu-kasb8h-17 wtu-1w3ascn-18"), "进入 weapp-tailwindcss 示例")
                        ))
                    )
                }
                ), "_" to 1))
