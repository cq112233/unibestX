...
open class GenSrcSubUviewUltraDemosKeyboardKeyboard : BasePage {
    ...
    companion object {
        ...
        var setup: (__props: GenSrcSubUviewUltraDemosKeyboardKeyboard) -> Any? = fun(__props): Any? {
            ...
            val valNumber = ref("")
            fun gen_onNumberChange_fn(kVal: String) {
                valNumber.value += kVal
            }
            val onNumberChange = ::gen_onNumberChange_fn
            fun gen_onNumberBackspace_fn() {
                if (valNumber.value.length > 0) {
                    valNumber.value = valNumber.value.substring(0, valNumber.value.length - 1)
                }
            }
            val onNumberBackspace = ::gen_onNumberBackspace_fn
            val showCard = ref(false)
            val valCard = ref("")
            fun gen_onCardChange_fn(kVal: String) {
                valCard.value += kVal
            }
            val onCardChange = ::gen_onCardChange_fn
            fun gen_onCardBackspace_fn() {
                if (valCard.value.length > 0) {
                    valCard.value = valCard.value.substring(0, valCard.value.length - 1)
                }
            }
            val onCardBackspace = ::gen_onCardBackspace_fn
            val showCar = ref(false)
            val valCar = ref("")
            fun gen_onCarChange_fn(kVal: String) {
                valCar.value += kVal
            }
            val onCarChange = ::gen_onCarChange_fn
            fun gen_onCarBackspace_fn() {
                if (valCar.value.length > 0) {
                    valCar.value = valCar.value.substring(0, valCar.value.length - 1)
                }
            }
            val onCarBackspace = ::gen_onCarBackspace_fn
            return fun(): Any? {
                val _component_up_keyboard = resolveEasyComponent("up-keyboard", GenUniModulesUviewUltraComponentsUpKeyboardUpKeyboardClass)
                return _cV(unref(GenAppkuClass), _uM("layout" to "navbar", "show-back" to true, "hide-navbar" to false, "enable-pull-down-refresh" to false, "page-style" to _uO("navigationBarTitleText" to "Keyboard 键盘", "navigationStyle" to "custom")), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                    return _uA(
                        _cV(unref(GenSrcLayoutsNavbarClass), _uM("show-back" to true, "hide-navbar" to false, "enable-pull-down-refresh" to false, "page-style" to _uO("navigationBarTitleText" to "Keyboard 键盘", "navigationStyle" to "custom")), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                            return _uA(
                                _cE("view", _uM("class" to "weapp-tw-border page-container bg-_b_hf8fafc_B min-h-screen pb-_b30px_B"), _uA(
                                    _cE("view", _uM("class" to "weapp-tw-border p-_b16px_B"), _uA(
                                        _cE("view", _uM("class" to "weapp-tw-border demo-block"), _uA(
                                            _cE("text", _uM("class" to "weapp-tw-border demo-label"), "数字键盘"),
                                            _cE("view", _uM("class" to "weapp-tw-border mock-input", "onClick" to fun(){
                                        ...
                                        _cE("view", _uM("class" to "weapp-tw-border demo-block"), _uA(
                                            _cE("text", _uM("class" to "weapp-tw-border demo-label"), "身份证键盘"),
                                            _cE("view", _uM("class" to "weapp-tw-border mock-input", "onClick" to fun(){
                                                showCard.value = true
                                            }
                                            ), _uA(
                                        ...
                                        _cE("view", _uM("class" to "weapp-tw-border demo-block"), _uA(
                                            _cE("text", _uM("class" to "weapp-tw-border demo-label"), "车牌号键盘"),
                                            _cE("view", _uM("class" to "weapp-tw-border mock-input", "onClick" to fun(){
                                                showCar.value = true
                                            }
                                            ), _uA(
