...
open class GenSrcSubUviewUltraDemosImageImage : BasePage {
    ...
    companion object {
        ...
        var setup: (__props: GenSrcSubUviewUltraDemosImageImage) -> Any? = fun(__props): Any? {
            val __ins = getCurrentInstance()!!
            val _ctx = __ins.proxy as GenSrcSubUviewUltraDemosImageImage
            val _cache = __ins.renderCache
            return fun(): Any? {
                val _component_up_image = resolveEasyComponent("up-image", GenUniModulesUviewUltraComponentsUpImageUpImageClass)
                return _cV(unref(GenAppkuClass), _uM("layout" to "navbar", "show-back" to true, "hide-navbar" to false, "enable-pull-down-refresh" to false, "page-style" to _uO("navigationBarTitleText" to "Image 图片", "navigationStyle" to "custom")), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                    return _uA(
                        _cV(unref(GenSrcLayoutsNavbarClass), _uM("show-back" to true, "hide-navbar" to false, "enable-pull-down-refresh" to false, "page-style" to _uO("navigationBarTitleText" to "Image 图片", "navigationStyle" to "custom")), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                            return _uA(
                                _cE("view", _uM("class" to "weapp-tw-border page-container bg-_b_hf8fafc_B min-h-screen pb-_b30px_B"), _uA(
                                    _cE("view", _uM("class" to "weapp-tw-border p-_b16px_B"), _uA(
                                        _cE("view", _uM("class" to "weapp-tw-border demo-block"), _uA(
                                            _cE("text", _uM("class" to "weapp-tw-border demo-label"), "基础图片"),
                                            _cE("view", _uM("class" to "weapp-tw-border flex-row items-center"), _uA(
                                                ...
                                                _cE("view", _uM("class" to "weapp-tw-border w-_b15px_B")),
                                        ...
                                        _cE("view", _uM("class" to "weapp-tw-border demo-block mt-_b12px_B"), _uA(
                                            _cE("text", _uM("class" to "weapp-tw-border demo-label"), "不同裁切模式"),
                                            _cE("view", _uM("class" to "weapp-tw-border flex-row items-center"), _uA(
                                                _cV(_component_up_image, _uM("src" to "/static/logo.png", "width" to "80px", "height" to "60px", "mode" to "aspectFit")),
                                                _cE("view", _uM("class" to "weapp-tw-border w-_b15px_B")),
                                                _cV(_component_up_image, _uM("src" to "/static/logo.png", "width" to "80px", "height" to "60px", "mode" to "scaleToFill"))
                                            ))
                                        ))
                                    ))
                                ))
