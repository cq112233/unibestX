    ...
    companion object {
        ...
        var setup: (__props: GenSrcSubUviewUltraDemosBadgeBadge) -> Any? = fun(__props): Any? {
            ...
            return fun(): Any? {
                ...
                return _cV(unref(GenAppkuClass), _uM("layout" to "navbar", "show-back" to true, "hide-navbar" to false, "enable-pull-down-refresh" to false, "page-style" to _uO("navigationBarTitleText" to "up-badge 徽标", "navigationStyle" to "custom")), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                    return _uA(
                        _cV(unref(GenSrcLayoutsNavbarClass), _uM("show-back" to true, "hide-navbar" to false, "enable-pull-down-refresh" to false, "page-style" to _uO("navigationBarTitleText" to "up-badge 徽标", "navigationStyle" to "custom")), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                            return _uA(
                                    ...
                                    _cE("view", _uM("class" to "weapp-tw-border p-_b16px_B"), _uA(
                                        _cE("view", _uM("class" to "weapp-tw-border demo-block"), _uA(
                                            ...
                                            _cE("view", _uM("class" to "weapp-tw-border flex-row items-center"), _uA(
                                                _cV(_component_up_badge, _uM("type" to "error", "value" to 9, "class" to "mr-_b20px_B")),
                                                _cV(_component_up_badge, _uM("type" to "warning", "value" to 99, "class" to "mr-_b20px_B")),
                                        ...
                                        _cE("view", _uM("class" to "weapp-tw-border demo-block mt-_b12px_B"), _uA(
                                            _cE("text", _uM("class" to "weapp-tw-border demo-label"), "小圆点"),
                                            _cE("view", _uM("class" to "weapp-tw-border flex-row items-center"), _uA(
                                        ...
                                        _cE("view", _uM("class" to "weapp-tw-border demo-block mt-_b12px_B"), _uA(
                                            ...
                                            _cE("view", _uM("class" to "weapp-tw-border flex-row items-center"), _uA(
                                                _cV(_component_up_badge, _uM("value" to "新", "bg-color" to "#8a2be2", "color" to "#ffffff", "class" to "mr-_b20px_B")),
                                                _cV(_component_up_badge, _uM("value" to "热", "bg-color" to "#ff9900", "color" to "#ffffff", "class" to "mr-_b20px_B")),
                                                _cV(_component_up_badge, _uM("is-dot" to true, "bg-color" to "#000000", "class" to "mr-_b20px_B"))
                                            ))
                                        )),
                                        _cE("view", _uM("class" to "weapp-tw-border demo-block mt-_b12px_B"), _uA(
                                            _cE("text", _uM("class" to "weapp-tw-border demo-label"), "绝对定位"),
                                            _cE("view", _uM("class" to "weapp-tw-border flex-row items-center"), _uA(
                                                _cE("view", _uM("class" to "weapp-tw-border relative w-_b40px_B h-_b40px_B bg-_b_he5e5e5_B rounded-_b4px_B"), _uA(
