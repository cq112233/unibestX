        ...
        var setup: (__props: GenSrcPagesFunctionComponentsEchartsDemoCard) -> Any? = fun(__props): Any? {
            ...
            return fun(): Any? {
                ...
                return _cV(unref(GenSrcPagesBasicComponentsCardClass), _uM("title" to echartTitle.value), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                    return _uA(
                        _cE("view", _uM("class" to "weapp-tw-border wtu-1gus49c-0 wtu-fven52-1 wtu-15g7x2s-2"), _uA(
                        ...
                        _cE("view", _uM("class" to "weapp-tw-border wtu-mcij7f-4 wtu-z7dd2m-5 wtu-1d3bbdp-6"), _uA(
                            _cE("view", _uM("class" to "weapp-tw-border wtu-1jofu1o-7 wtu-s54k3p-8"), _uA(
                                _cE("view", _uM("class" to _nC(_uA(
                                    "weapp-tw-border wtu-1gus49c-0 wtu-utvssx-9 wtu-1gx3c6p-a wtu-1xomkve-b wtu-mcij7f-4 wtu-1vz4tc3-c wtu-80iwab-d",
                                    ...
                                    _cE("text", _uM("class" to _nC(_uA(
                                        "weapp-tw-border wtu-esa49s-g wtu-100960-h",
                                        if (currentType.value !== "line") {
                                            "wtu-ecywtr-i"
                                        } else {
                                            "wtu-1y2qqu-j"
                            ...
                            _cE("view", _uM("class" to "weapp-tw-border wtu-1jofu1o-7"), _uA(
                                _cE("view", _uM("class" to _nC(_uA(
                                    "weapp-tw-border wtu-1gus49c-0 wtu-utvssx-9 wtu-1gx3c6p-a wtu-1xomkve-b wtu-mcij7f-4 wtu-1vz4tc3-c wtu-80iwab-d",
