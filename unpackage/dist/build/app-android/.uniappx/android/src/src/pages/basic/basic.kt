...
open class GenSrcPagesBasicBasic : BasePage {
    ...
    companion object {
        ...
        var setup: (__props: GenSrcPagesBasicBasic) -> Any? = fun(__props): Any? {
            ...
            return fun(): Any? {
                return _cV(unref(GenAppkuClass), _uM("layout" to "navbar", "show-back" to false, "enable-pull-down-refresh" to true, "page-style" to _uO("navigationBarTitleText" to "基础", "navigationStyle" to "custom")), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                    return _uA(
                        _cV(unref(GenSrcLayoutsNavbarClass), _uM("show-back" to false, "enable-pull-down-refresh" to true, "page-style" to _uO("navigationBarTitleText" to "基础", "navigationStyle" to "custom")), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                            return _uA(
                                _cE("view", _uM("class" to "weapp-tw-border wtu-18katrf-0"), _uA(
                                    _cE("view", _uM("class" to "weapp-tw-border wtu-18katrf-0"), _uA(
                                        _cV(unref(GenSrcPagesBasicComponentsLayoutDemoCardClass)),
        ...
        val styles0: Map<String, Map<String, Map<String, Any>>>
            get() {
                return _uM("weapp-tw-border" to _pS(_uM("borderTopWidth" to 0, "borderRightWidth" to 0, "borderBottomWidth" to 0, "borderLeftWidth" to 0)), "wtu-18katrf-0" to _pS(_uM("flexDirection" to "column")))
            }
