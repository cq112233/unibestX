...
open class GenSrcPagesBasicComponentsUViewUltraDemoCard : VueComponent {
    ...
    companion object {
                ...
                return _cV(unref(GenSrcPagesBasicComponentsCardClass), _uM("title" to "uview-ultra 组件库"), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                    return _uA(
                        _cE("view", _uM("class" to "flex-col mb-16px"), _uA(
                            ...
                            _cE("view", _uM("class" to "flex-row items-center bg-__f1f5f9_ p-8px rounded-6px mb-12px", "onClick" to copyWebsiteUrl), _uA(
                                _cE("text", _uM("class" to "text-12px text-__475569_ font-medium mr-4px"), "官网："),
                                _cE("text", _uM("class" to "text-12px text-__2563eb_ underline flex-1"), "https://uview-ultra.lingyun.net/"),
                                _cE("text", _uM("class" to "text-11px text-__94a3b8_"), "点击复制")
                            )),
        ...
        val styles0: Map<String, Map<String, Map<String, Any>>>
            get() {
                return _uM("bg-__3b82f6_" to _pS(_uM("backgroundImage" to "none", "backgroundColor" to "#3b82f6")), "bg-__d1fae5_" to _pS(_uM("backgroundImage" to "none", "backgroundColor" to "#d1fae5")), "bg-__e0edff_" to _pS(_uM("backgroundImage" to "none", "backgroundColor" to "#e0edff")), "bg-__f1f5f9_" to _pS(_uM("backgroundImage" to "none", "backgroundColor" to "#f1f5f9")), "bg-__fef3c7_" to _pS(_uM("backgroundImage" to "none", "backgroundColor" to "#fef3c7")), "border-color-__a7f3d0_" to _pS(_uM("borderTopColor" to "#a7f3d0", "borderRightColor" to "#a7f3d0", "borderBottomColor" to "#a7f3d0", "borderLeftColor" to "#a7f3d0")), "border-color-__bfdbfe_" to _pS(_uM("borderTopColor" to "#bfdbfe", "borderRightColor" to "#bfdbfe", "borderBottomColor" to "#bfdbfe", "borderLeftColor" to "#bfdbfe")), "border-color-__fde68a_" to _pS(_uM("borderTopColor" to "#fde68a", "borderRightColor" to "#fde68a", "borderBottomColor" to "#fde68a", "borderLeftColor" to "#fde68a")), "border-style-solid" to _pS(_uM("borderTopStyle" to "solid", "borderRightStyle" to "solid", "borderBottomStyle" to "solid", "borderLeftStyle" to "solid")), "border-width-1px" to _pS(_uM("borderTopWidth" to 1, "borderRightWidth" to 1, "borderBottomWidth" to 1, "borderLeftWidth" to 1)), "flex" to _pS(_uM("display" to "flex")), "flex-1" to _pS(_uM("flexGrow" to 1, "flexShrink" to 1, "flexBasis" to "0%")), "flex-col" to _pS(_uM("flexDirection" to "column")), "flex-row" to _pS(_uM("flexDirection" to "row")), "flex-wrap" to _pS(_uM("flexWrap" to "wrap")), "font-bold" to _pS(_uM("fontWeight" to 700)), "font-medium" to _pS(_uM("fontWeight" to 500)), "h-44px" to _pS(_uM("height" to 44)), "items-center" to _pS(_uM("alignItems" to "center")), "justify-center" to _pS(_uM("justifyContent" to "center")), "leading-18px" to _pS(_uM("lineHeight" to "18px")), "mb-12px" to _pS(_uM("marginBottom" to 12)), "mb-16px" to _pS(_uM("marginBottom" to 16)), "mb-4px" to _pS(_uM("marginBottom" to 4)), "mr-4px" to _pS(_uM("marginRight" to 4)), "mr-6px" to _pS(_uM("marginRight" to 6)), "none" to _pS(_uM("display" to "none")), "p-8px" to _pS(_uM("paddingTop" to 8, "paddingRight" to 8, "paddingBottom" to 8, "paddingLeft" to 8)), "px-10px" to _pS(_uM("paddingLeft" to 10, "paddingRight" to 10)), "py-3px" to _pS(_uM("paddingTop" to 3, "paddingBottom" to 3)), "rounded-20px" to _pS(_uM("borderTopLeftRadius" to 20, "borderTopRightRadius" to 20, "borderBottomRightRadius" to 20, "borderBottomLeftRadius" to 20)), "rounded-6px" to _pS(_uM("borderTopLeftRadius" to 6, "borderTopRightRadius" to 6, "borderBottomRightRadius" to 6, "borderBottomLeftRadius" to 6)), "rounded-8px" to _pS(_uM("borderTopLeftRadius" to 8, "borderTopRightRadius" to 8, "borderBottomRightRadius" to 8, "borderBottomLeftRadius" to 8)), "text-__059669_" to _pS(_uM("color" to "#059669")), "text-__2563eb_" to _pS(_uM("color" to "#2563eb")), "text-__475569_" to _pS(_uM("color" to "#475569")), "text-__64748b_" to _pS(_uM("color" to "#64748b")), "text-__94a3b8_" to _pS(_uM("color" to "#94a3b8")), "text-__d97706_" to _pS(_uM("color" to "#d97706")), "text-__ffffff_" to _pS(_uM("color" to "#ffffff")), "text-11px" to _pS(_uM("fontSize" to 11)), "text-12px" to _pS(_uM("fontSize" to 12)), "text-13px" to _pS(_uM("fontSize" to 13)), "text-14px" to _pS(_uM("fontSize" to 14)), "underline" to _pS(_uM("textDecorationLine" to "underline")), "w-full" to _pS(_uM("width" to "100%")))
            }
