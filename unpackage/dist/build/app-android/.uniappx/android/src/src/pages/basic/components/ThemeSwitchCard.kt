        ...
        var setup: (__props: GenSrcPagesBasicComponentsThemeSwitchCard) -> Any? = fun(__props): Any? {
            ...
            return fun(): Any? {
                return _cV(unref(GenSrcPagesBasicComponentsCardClass), _uM("title" to themeTitle.value), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                    return _uA(
                        _cE("view", _uM("class" to "weapp-tw-border wtu-4hrp8k-0 wtu-fhrzwj-1 wtu-mqajtg-2 wtu-bkb5z9-3 wtu-qepy49-4 wtu-1jfhtyf-5 wtu-1vbahwj-6"), _uA(
                            _cE("text", _uM("class" to "weapp-tw-border wtu-1guata8-7 wtu-i5demr-8 wtu-1yn2e0l-9"), _tD(themePreview.value), 1),
                            _cE("view", _uM("class" to "weapp-tw-border wtu-15u6clw-a wtu-7gvrw-b wtu-3m5zaz-c wtu-s0orfi-d wtu-1likcy9-e wtu-27v8zu-f wtu-1q091sr-g wtu-1vbahwj-6 wtu-1r3uoj-h", "style" to _nS(_uM("backgroundColor" to currentTheme.value))), _uA(
                                _cE("text", _uM("class" to "weapp-tw-border wtu-g3vc06-i wtu-1d27acy-j"), _tD(themeButton.value), 1)
                            ), 4)
                        )),
                        _cE("view", _uM("class" to "weapp-tw-border wtu-1q091sr-g wtu-1o0f0um-k wtu-1cu5goa-l"), _uA(
                            _cE(Fragment, null, RenderHelpers.renderList(colorOptions, fun(item, index, __index, _cached): Any {
                                return _cE("view", _uM("key" to index, "class" to "weapp-tw-border wtu-6fkyl1-m wtu-12mu282-n wtu-ww7gtr-o wtu-1vbahwj-6 wtu-1r3uoj-h", "style" to _nS(_uM("backgroundColor" to item, "borderWidth" to if (currentTheme.value == item) {
                                    "3px"
                                } else {
                                    "0px"
                                }
                                , "borderStyle" to "solid", "borderColor" to "#1e293b")), "onClick" to fun(){
                                    ...
                                    if (currentTheme.value == item) {
                                        _cE("text", _uM("key" to 0, "class" to "weapp-tw-border wtu-127on44-p wtu-19gexn6-q wtu-1x7cgzs-r"), " ✓ ")
                                    } else {
                                        _cC("v-if", true)
                                    }
                                ), 12, _uA(
                        ...
                        _cE("view", _uM("class" to "weapp-tw-border wtu-1q091sr-g wtu-1o0f0um-k wtu-1vbahwj-6 wtu-15u6clw-a wtu-15ctu2r-s"), _uA(
                            _cE("text", _uM("class" to "weapp-tw-border wtu-1d27acy-j wtu-1s8d77i-t"), _tD(themeModeLabel.value), 1),
                            _cE("view", _uM("class" to "weapp-tw-border wtu-1q091sr-g wtu-1likcy9-e wtu-1gk50cy-u", "style" to _nS(_uM("borderWidth" to "1px", "borderStyle" to "solid", "borderColor" to "var(--border-color, #e2e8f0)"))), _uA(
                                _cE(Fragment, null, RenderHelpers.renderList(themeModeOptions.value, fun(item, index, __index, _cached): Any {
                                    return _cE("view", _uM("key" to index, "class" to "weapp-tw-border wtu-1p9z6y3-v wtu-1cuonmx-w", "style" to _nS(_uM("backgroundColor" to if (unref(appStore).state.themeMode == item.value) {
                                        ...
                                        _cE("text", _uM("class" to "weapp-tw-border wtu-1guata8-7", "style" to _nS(_uM("color" to if (unref(appStore).state.themeMode == item.value) {
                                            "#ffffff"
                                        } else {
