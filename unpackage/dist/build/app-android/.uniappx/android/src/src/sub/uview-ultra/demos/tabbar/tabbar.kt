        ...
        var setup: (__props: GenSrcSubUviewUltraDemosTabbarTabbar) -> Any? = fun(__props): Any? {
            ...
            return fun(): Any? {
                ...
                return _cV(unref(GenAppkuClass), null, _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                    return _uA(
                        _cV(unref(GenSrcLayoutsDefaultClass), _uM("navigation-style" to "custom", "navigation-bar-title-text" to "up-tabbar 底部导航"), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                            return _uA(
                                _cE("view", _uM("class" to "page-container bg-__f8fafc_ min-h-screen pb-30px"), _uA(
                                    _cV(_component_NavBar, _uM("title" to "Tabbar 底部导航", "auto-back" to true)),
                                    _cE("view", _uM("class" to "p-16px"), _uA(
                                        _cE("view", _uM("class" to "demo-block"), _uA(
                                            _cE("text", _uM("class" to "demo-label"), "基础用法"),
                                            _cV(_component_up_tabbar, _uM("value" to 0, "fixed" to false, "safe-area-inset-bottom" to false), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                                                return _uA(
                                        ...
                                        _cE("view", _uM("class" to "demo-block mt-12px"), _uA(
                                            ...
                                            _cV(_component_up_tabbar, _uM("value" to 0, "fixed" to false, "safe-area-inset-bottom" to false, "active-color" to "#fa3534"), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                                                return _uA(
