        ...
        var setup: (__props: GenSrcSubUviewUltraDemosPopupPopup) -> Any? = fun(__props): Any? {
            ...
            return fun(): Any? {
                ...
                return _cV(unref(GenAppkuClass), null, _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                    return _uA(
                        _cV(unref(GenSrcLayoutsDefaultClass), _uM("navigation-style" to "custom", "navigation-bar-title-text" to "up-popup 弹出层"), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                            return _uA(
                                _cE("view", _uM("class" to "page-container bg-__f8fafc_ min-h-screen pb-30px"), _uA(
                                    _cV(_component_NavBar, _uM("title" to "up-popup 弹出层", "auto-back" to true, "safe-area-inset-top" to true, "bg-color" to "#ffffff")),
                                    _cE("view", _uM("class" to "p-16px"), _uA(
                                        ...
                                        _cE("view", _uM("class" to "demo-block mt-12px"), _uA(
                                            _cE("text", _uM("class" to "demo-label"), "更多方向弹出"),
                                            _cE("view", _uM("class" to "flex-row items-center"), _uA(
                                                _cV(_component_up_button, _uM("type" to "success", "text" to "左侧弹出", "size" to "mini", "onClick" to fun(){
                                                    openPopup("left")
                                                }
                                                ), null, 8, _uA(
                                                    "onClick"
                                                ...
                                                _cE("view", _uM("class" to "w-10px")),
                                                _cV(_component_up_button, _uM("type" to "success", "text" to "右侧弹出", "size" to "mini", "onClick" to fun(){
                                                    openPopup("right")
                                                }
                                                ), null, 8, _uA(
                                                    "onClick"
                                                ...
                                                _cE("view", _uM("class" to "w-10px")),
                                                _cV(_component_up_button, _uM("type" to "success", "text" to "居中弹出", "size" to "mini", "onClick" to fun(){
                                                    openPopup("center")
                                                }
                                                ), null, 8, _uA(
                                                    "onClick"
