        ...
        var setup: (__props: GenSrcPagesFunctionComponentsTimeDemoCard) -> Any? = fun(__props): Any? {
            ...
            return fun(): Any? {
                return _cV(unref(GenSrcPagesBasicComponentsCardClass), _uM("title" to "时间日期操作 (lime-dayuts)"), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                    return _uA(
                        _cE("view", _uM("class" to "weapp-tw-border wtu-4kmwrd-0 wtu-1jdh43a-1 wtu-dtibgf-2 wtu-1h5kt0c-3 wtu-4rnkc-4 wtu-11f339e-5"), _uA(
                            _cE("text", _uM("class" to "weapp-tw-border wtu-1iqtm2m-6 wtu-1oju4iv-7 wtu-115tbw1-8 wtu-c3b92s-9"), "实时高精度时钟 (更新于每一百毫秒)"),
                            _cE("text", _uM("class" to "weapp-tw-border wtu-110ukgw-a wtu-1oju4iv-7 wtu-i1z22m-b wtu-1mdi86u-c", "style" to _nS(_uM("font-family" to "monospace"))), _tD(currentFullTime.value), 5),
                            _cE("text", _uM("class" to "weapp-tw-border wtu-19je0nn-d wtu-1bwkk92-e"), " 格式模板: YYYY-MM-DD HH:mm:ss.SSS dddd ")
                        )),
                        _cE("view", _uM("class" to "weapp-tw-border wtu-4kmwrd-0 wtu-1jdh43a-1 wtu-dtibgf-2 wtu-1h5kt0c-3 wtu-4rnkc-4 wtu-11f339e-5"), _uA(
                            _cE("text", _uM("class" to "weapp-tw-border wtu-1iqtm2m-6 wtu-1oju4iv-7 wtu-115tbw1-8 wtu-136pgjf-f"), "日期偏移操作"),
                            _cE("view", _uM("class" to "weapp-tw-border wtu-av7f06-g wtu-484t6y-h wtu-avfu85-i wtu-136pgjf-f"), _uA(
                                _cE("text", _uM("class" to "weapp-tw-border wtu-2fc1j5-j wtu-v9onga-k"), "当前偏移天数:"),
                                _cE("text", _uM("class" to "weapp-tw-border wtu-1r68wxj-l wtu-1oju4iv-7 wtu-lavu4m-m"), _tD(if (offsetDays.value > 0) {
                                    "+"
                                } else {
                                    ""
                                }
                            ...
                            _cE("view", _uM("class" to "weapp-tw-border wtu-av7f06-g wtu-avfu85-i wtu-136pgjf-f"), _uA(
                                _cE("view", _uM("class" to "weapp-tw-border wtu-1qpd44h-n wtu-1oyi3ms-o"), _uA(
                                    _cE("view", _uM("class" to "weapp-tw-border wtu-173zvjd-p wtu-t2tdnc-q wtu-1qs4qj6-r wtu-16xqvqb-s wtu-1jd3mn7-t wtu-av7f06-g wtu-484t6y-h wtu-7vso4e-u", "onClick" to fun(){
                                        adjustOffset(-7)
                                    }
                                    ), _uA(
                                        _cE("text", _uM("class" to "weapp-tw-border wtu-ee1xhe-v wtu-19je0nn-d wtu-1oju4iv-7"), "-7 天")
                                    ), 8, _uA(
                                        "onClick"
                                    ))
                                )),
                                _cE("view", _uM("class" to "weapp-tw-border wtu-1qpd44h-n wtu-1oyi3ms-o"), _uA(
                                    _cE("view", _uM("class" to "weapp-tw-border wtu-173zvjd-p wtu-t2tdnc-q wtu-1qs4qj6-r wtu-16xqvqb-s wtu-1jd3mn7-t wtu-av7f06-g wtu-484t6y-h wtu-7vso4e-u", "onClick" to fun(){
                                        ...
                                        _cE("text", _uM("class" to "weapp-tw-border wtu-ee1xhe-v wtu-19je0nn-d wtu-1oju4iv-7"), "-1 天")
                                    ), 8, _uA(
                                        "onClick"
                                    ))
                                )),
                                ...
                                _cE("view", _uM("class" to "weapp-tw-border wtu-1qpd44h-n"), _uA(
                                    _cE("view", _uM("class" to "weapp-tw-border wtu-173zvjd-p wtu-t2tdnc-q wtu-1qs4qj6-r wtu-16xqvqb-s wtu-1jd3mn7-t wtu-av7f06-g wtu-484t6y-h wtu-7vso4e-u", "onClick" to fun(){
                                        adjustOffset(7)
                                    }
                                    ), _uA(
                            ...
                            _cE("view", _uM("class" to "weapp-tw-border wtu-1xfhmhe-w wtu-lhlnxb-x wtu-vpqmae-y")),
                            _cE("view", _uM("class" to "weapp-tw-border"), _uA(
                                _cE("text", _uM("class" to "weapp-tw-border wtu-19je0nn-d wtu-1bwkk92-e wtu-c0eg5k-z"), "计算得到的目标时间:"),
                                _cE("text", _uM("class" to "weapp-tw-border wtu-2fc1j5-j wtu-1oju4iv-7 wtu-lavu4m-m"), _tD(targetOffsetTime.value), 1)
                            ))
                        )),
                        _cE("view", _uM("class" to "weapp-tw-border wtu-4kmwrd-0 wtu-1jdh43a-1 wtu-1h5kt0c-3 wtu-4rnkc-4 wtu-11f339e-5"), _uA(
                            _cE("text", _uM("class" to "weapp-tw-border wtu-1iqtm2m-6 wtu-1oju4iv-7 wtu-115tbw1-8 wtu-136pgjf-f"), "常用日期边界与区间计算"),
                            _cE("view", _uM("class" to "weapp-tw-border wtu-av7f06-g wtu-avfu85-i wtu-c3b92s-9"), _uA(
                                _cE("text", _uM("class" to "weapp-tw-border wtu-2fc1j5-j wtu-v9onga-k"), "本月第一天"),
                                _cE("text", _uM("class" to "weapp-tw-border wtu-2fc1j5-j wtu-quefir-10 wtu-lavu4m-m"), _tD(startOfMonth.value), 1)
                            )),
                            _cE("view", _uM("class" to "weapp-tw-border wtu-av7f06-g wtu-avfu85-i wtu-c3b92s-9"), _uA(
                                _cE("text", _uM("class" to "weapp-tw-border wtu-2fc1j5-j wtu-v9onga-k"), "本月最后一天"),
                                _cE("text", _uM("class" to "weapp-tw-border wtu-2fc1j5-j wtu-quefir-10 wtu-lavu4m-m"), _tD(endOfMonth.value), 1)
                            )),
                            _cE("view", _uM("class" to "weapp-tw-border wtu-av7f06-g wtu-avfu85-i wtu-c3b92s-9"), _uA(
                                _cE("text", _uM("class" to "weapp-tw-border wtu-2fc1j5-j wtu-v9onga-k"), "今年天数"),
                                _cE("text", _uM("class" to "weapp-tw-border wtu-2fc1j5-j wtu-quefir-10 wtu-lavu4m-m"), _tD(if (isLeapYear.value) {
                                    "366天 (闰年)"
                                } else {
                                    "365天 (平年)"
                                }
                            ...
                            _cE("view", _uM("class" to "weapp-tw-border wtu-av7f06-g wtu-avfu85-i"), _uA(
                                _cE("text", _uM("class" to "weapp-tw-border wtu-2fc1j5-j wtu-v9onga-k"), "距离今年底倒计时"),
                                _cE("text", _uM("class" to "weapp-tw-border wtu-2fc1j5-j wtu-1oju4iv-7 wtu-kluce4-11"), _tD(daysToYearEnd.value) + " 天", 1)
                            ))
                        ))
                    )
                }
