        ...
        var setup: (__props: GenSrcPagesFunctionComponentsToastCard) -> Any? = fun(__props): Any? {
            ...
            return fun(): Any? {
                return _cV(unref(GenSrcPagesBasicComponentsCardClass), _uM("title" to "全局 Toast 提示调用"), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                    return _uA(
                        _cE("view", _uM("class" to "wtu-mnbm96-0 wtu-1bq9shh-1 wtu-13ryylq-2 wtu-33hvuz-3 wtu-4tuys3-4 wtu-8r66y1-5"), _uA(
                            _cE("text", _uM("class" to "wtu-3i3gs6-6 wtu-1pd9yl-7 wtu-aahijk-8"), " 演示从功能页调用全局封装的 toast 工具函数，支持自定义消息与状态反馈。 ")
                        )),
                        _cE("view", _uM("class" to "wtu-4tpahe-9"), _uA(
                            _cE("text", _uM("class" to "wtu-3i3gs6-6 wtu-b5uul9-a wtu-9szial-b"), "自定义 Toast 内容"),
                        ...
                        _cE("view", _uM("class" to "wtu-1yca3x4-j wtu-clldfh-k"), _uA(
                            _cE("view", _uM("class" to "wtu-bte5oa-l wtu-nw1q8k-m wtu-zsktp1-n wtu-13pz9mv-o wtu-1b6qia0-p wtu-1yca3x4-j wtu-clldfh-k wtu-xpmuf1-q wtu-164irp9-r", "onClick" to showCustomToast), _uA(
                                _cE("text", _uM("class" to "wtu-pubmk8-s wtu-1tbrxcb-t wtu-bj9ji2-u"), "弹出自定义 Toast")
                            )),
                            _cE("view", _uM("class" to "wtu-bte5oa-l wtu-zhey3t-v wtu-13pz9mv-o wtu-1b6qia0-p wtu-1yca3x4-j wtu-clldfh-k wtu-xpmuf1-q wtu-164irp9-r", "onClick" to showSuccessToast), _uA(
                                _cE("text", _uM("class" to "wtu-pubmk8-s wtu-1tbrxcb-t wtu-bj9ji2-u"), "弹出成功 Toast")
                            ))
                        ))
                    )
                }
