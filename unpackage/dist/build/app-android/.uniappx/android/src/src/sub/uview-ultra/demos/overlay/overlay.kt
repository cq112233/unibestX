    ...
    companion object {
        ...
        var setup: (__props: GenSrcSubUviewUltraDemosOverlayOverlay) -> Any? = fun(__props): Any? {
            ...
            return fun(): Any? {
                ...
                return _cV(unref(GenAppkuClass), _uM("layout" to "navbar", "show-back" to true, "hide-navbar" to false, "enable-pull-down-refresh" to false, "page-style" to _uO("navigationBarTitleText" to "up-overlay 遮罩层", "navigationStyle" to "custom")), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                    return _uA(
                        _cV(unref(GenSrcLayoutsNavbarClass), _uM("show-back" to true, "hide-navbar" to false, "enable-pull-down-refresh" to false, "page-style" to _uO("navigationBarTitleText" to "up-overlay 遮罩层", "navigationStyle" to "custom")), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                            return _uA(
                                _cE("view", _uM("class" to "weapp-tw-border page-container bg-_b_hf8fafc_B min-h-screen pb-_b30px_B"), _uA(
                                    ...
                                    _cV(_component_up_overlay, _uM("show" to overlayShow.value, "opacity" to overlayOpacity.value, "onClick" to fun(){
                                        ...
                                        return _uA(
                                            _cE("view", _uM("class" to "weapp-tw-border flex-1 items-center justify-center"), _uA(
                                                _cE("view", _uM("class" to "weapp-tw-border bg-white rounded-_b8px_B p-_b20px_B items-center", "onClick" to withModifiers(fun(){}, _uA(
                                                    "stop"
                                                ))), _uA(
                                                    _cV(_component_up_loading_icon, _uM("mode" to "circle")),
                                                    _cE("text", _uM("class" to "weapp-tw-border text-_b14px_B text-_b_h303133_B mt-_b10px_B"), "加载中，点击遮罩关闭")
                                                ), 8, _uA(
                                                    "onClick"
                                                ))
                                            ))
