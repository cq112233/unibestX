...
open class GenSrcSubUviewUltraDemosCollapseCollapse : BasePage {
    ...
    companion object {
        ...
        var setup: (__props: GenSrcSubUviewUltraDemosCollapseCollapse) -> Any? = fun(__props): Any? {
            val __ins = getCurrentInstance()!!
            val _ctx = __ins.proxy as GenSrcSubUviewUltraDemosCollapseCollapse
            ...
            return fun(): Any? {
                ...
                return _cV(unref(GenAppkuClass), _uM("layout" to "navbar", "show-back" to true, "hide-navbar" to false, "enable-pull-down-refresh" to false, "page-style" to _uO("navigationBarTitleText" to "up-collapse 折叠面板", "navigationStyle" to "custom")), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                    return _uA(
                        _cV(unref(GenSrcLayoutsNavbarClass), _uM("show-back" to true, "hide-navbar" to false, "enable-pull-down-refresh" to false, "page-style" to _uO("navigationBarTitleText" to "up-collapse 折叠面板", "navigationStyle" to "custom")), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                            return _uA(
                                _cE("view", _uM("class" to "weapp-tw-border page-container bg-_b_hf8fafc_B min-h-screen pb-_b30px_B"), _uA(
                                    _cE("view", _uM("class" to "weapp-tw-border p-_b16px_B"), _uA(
                                            ...
                                            _cV(_component_up_collapse, _uM("value" to collapseValue.value, "accordion" to true), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                                                return _uA(
                                                    _cV(_component_up_collapse_item, _uM("title" to "第一项", "name" to "1"), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                                                        return _uA(
                                                            _cE("text", _uM("class" to "weapp-tw-border collapse-text"), "uview-ultra 是基于 uview-plus 修改的 uni-app-x 版本")
                                                        )
                                                    }
                                                    ), "_" to 1)),
                                                    _cV(_component_up_collapse_item, _uM("title" to "第二项", "name" to "2"), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                                                        return _uA(
                                                            _cE("text", _uM("class" to "weapp-tw-border collapse-text"), "支持 iOS、Android、H5、小程序等多端")
                                                        )
                                                    }
                                                    ), "_" to 1))
                                                )
                                        ...
                                        _cE("view", _uM("class" to "weapp-tw-border demo-block mt-_b12px_B"), _uA(
                                            _cE("text", _uM("class" to "weapp-tw-border demo-label"), "自定义图标"),
                                            _cV(_component_up_collapse, _uM("value" to _uA(
                                                "1"
                                            )), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                                                return _uA(
                                                    _cV(_component_up_collapse_item, _uM("title" to "第一项", "name" to "1", "icon" to "star"), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                                                        return _uA(
                                                            _cE("text", _uM("class" to "weapp-tw-border collapse-text"), "带有星星图标的面板")
                                                        )
                                                    }
                                                    ), "_" to 1))
                                                )
