        ...
        var setup: (__props: GenSrcSubUviewUltraDemosCollapseCollapse) -> Any? = fun(__props): Any? {
            ...
            return fun(): Any? {
                ...
                return _cV(unref(GenAppkuClass), null, _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                    return _uA(
                        _cV(unref(GenSrcLayoutsDefaultClass), _uM("navigation-style" to "custom", "navigation-bar-title-text" to "up-collapse 折叠面板"), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                            return _uA(
                                _cE("view", _uM("class" to "page-container bg-__f8fafc_ min-h-screen pb-30px"), _uA(
                                    _cV(_component_NavBar, _uM("title" to "up-collapse 折叠面板", "auto-back" to true, "safe-area-inset-top" to true, "bg-color" to "#ffffff")),
                                            ...
                                            _cV(_component_up_collapse, _uM("value" to _uA(
                                                ...
                                                return _uA(
                                                    _cV(_component_up_collapse_item, _uM("title" to "第一项", "name" to "1", "icon" to "star"), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                                                        return _uA(
                                                            _cE("text", _uM("class" to "collapse-text"), "带有星星图标的面板")
                                                        )
                                                    }
                                                    ), "_" to 1))
                                                )
