...
open class GenSrcSubTailwindcssComponentsWeappTailwindcss : VueComponent {
    ...
    override fun `$render`(): Any? {
        ...
        return _cE("view", _uM("class" to "weapp-tw-border wtu-gifzto-0"), _uA(
            ...
            _cE("view", _uM("class" to "weapp-tw-border"), _uA(
                _cE("text", _uM("class" to "weapp-tw-border wtu-16dgrlp-3 wtu-1ps2q5z-4 wtu-8rd55c-5"), " tw.icebreaker.top ")
            )),
            _cE("view", _uM("class" to "weapp-tw-border"), _uA(
                _cE("text", _uM("class" to "weapp-tw-border wtu-s3p7ug-6 wtu-1c5mft6-7"), "你可以在上方的官网上，找到大量的提效解决方案")
            ))
        ))
    }
