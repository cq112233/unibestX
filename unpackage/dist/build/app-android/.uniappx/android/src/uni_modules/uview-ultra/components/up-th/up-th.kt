...
open class GenUniModulesUviewUltraComponentsUpThUpTh : VueComponent {
    ...
    companion object {
        ...
        var setup: (__props: GenUniModulesUviewUltraComponentsUpThUpTh) -> Any? = fun(__props): Any? {
            ...
            val mergedThStyle = computed(fun(): UTSJSONObject {
                val custom = addStyle(props.customStyle) as UTSJSONObject
                val th = thStyle.value
            ...
            return fun(): Any? {
                return _cE("view", _uM("class" to _nC(_uA(
                    "weapp-tw-border up-th",
                    _uA(
                        _ctx.customClass
                    )
                )), "style" to _nS(mergedThStyle.value)), _uA(
                    renderSlot(_ctx.`$slots`, "default", _uO(), fun(): UTSArray<Any> {
                        return _uA(
                            _cE("text", _uM("class" to "weapp-tw-border up-th__text", "style" to _nS(thTextStyle.value)), _tD(_ctx.text), 5)
                        )
                    }
                    )
                ), 6)
        ...
        val styles0: Map<String, Map<String, Map<String, Any>>>
            get() {
                return _uM("weapp-tw-border" to _pS(_uM("borderTopWidth" to 0, "borderRightWidth" to 0, "borderBottomWidth" to 0, "borderLeftWidth" to 0)), "up-th" to _pS(_uM("display" to "flex", "flexDirection" to "column", "flexGrow" to 1, "flexShrink" to 1, "flexBasis" to "0%", "justifyContent" to "center", "backgroundColor" to "#f5f6f8")), "up-th__text" to _pS(_uM("fontSize" to 14, "color" to "#303133", "fontWeight" to "bold")))
            }
