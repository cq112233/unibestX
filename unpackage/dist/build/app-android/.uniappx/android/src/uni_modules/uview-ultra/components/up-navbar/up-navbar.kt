...
open class GenUniModulesUviewUltraComponentsUpNavbarUpNavbar : VueComponent {
    ...
    companion object {
        ...
        var props = _nP(_uM("customStyle" to _uM("type" to _uA(
            "Object",
            "String"
        ), "default" to _uO()), "customClass" to _uM("type" to "String", "default" to ""), "url" to _uM("type" to "String", "default" to ""), "linkType" to _uM("type" to "String", "default" to "navigateTo"), "safeAreaInsetTop" to _uM("type" to "Boolean", "default" to crtProp__24["safeAreaInsetTop"]), "placeholder" to _uM("type" to "Boolean", "default" to crtProp__24["placeholder"]), "fixed" to _uM("type" to "Boolean", "default" to crtProp__24["fixed"]), "border" to _uM("type" to "Boolean", "default" to crtProp__24["border"]), "leftIcon" to _uM("type" to "String", "default" to crtProp__24["leftIcon"]), "leftText" to _uM("type" to "String", "default" to crtProp__24["leftText"]), "rightText" to _uM("type" to "String", "default" to crtProp__24["rightText"]), "rightIcon" to _uM("type" to "String", "default" to crtProp__24["rightIcon"]), "title" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to crtProp__24["title"]), "bgColor" to _uM("type" to "String", "default" to crtProp__24["bgColor"]), "titleWidth" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to crtProp__24["titleWidth"]), "height" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to crtProp__24["height"]), "leftIconSize" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to crtProp__24["leftIconSize"]), "leftIconColor" to _uM("type" to "String", "default" to crtProp__24["leftIconColor"]), "autoBack" to _uM("type" to "Boolean", "default" to crtProp__24["autoBack"]), "titleStyle" to _uM("type" to _uA(
            "Object"
        ), "default" to crtProp__24["titleStyle"])))
