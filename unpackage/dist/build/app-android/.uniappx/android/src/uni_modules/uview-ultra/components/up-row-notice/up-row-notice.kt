...
open class GenUniModulesUviewUltraComponentsUpRowNoticeUpRowNotice : VueComponent {
    ...
    companion object {
        ...
        var setup: (__props: GenUniModulesUviewUltraComponentsUpRowNoticeUpRowNotice) -> Any? = fun(__props): Any? {
            ...
            val startScroll = fun(): UTSPromise<Unit> {
                return wrapUTSPromise(suspend {
                        ...
                        await(sleep(10))
                        val textRect = await(uni.UNIB120614.upGetRect(".up-notice__content__text", false, instance)) as NodeInfo
                        val containerRect = await(uni.UNIB120614.upGetRect(".up-notice__content", false, instance)) as NodeInfo
            ...
            return fun(): Any? {
                ...
                return _cE("view", _uM("class" to "weapp-tw-border up-notice", "onClick" to clickHandler), _uA(
                    renderSlot(_ctx.`$slots`, "icon", _uO(), fun(): UTSArray<Any> {
                        return _uA(
                            if (isTrue(_ctx.icon)) {
                                _cE("view", _uM("key" to 0, "class" to "weapp-tw-border up-notice__left-icon"), _uA(
                    ...
                    _cE("view", _uM("class" to "weapp-tw-border up-notice__content", "ref" to "up-notice__content"), _uA(
                        _cE("view", _uM("ref" to "up-notice__content__text", "class" to "weapp-tw-border up-notice__content__text", "style" to _nS(_uA(
                            animationStyle.value
                        ))), _uA(
                            _cE(Fragment, null, RenderHelpers.renderList(innerText.value, fun(item, index, __index, _cached): Any {
                                return _cE("text", _uM("class" to "weapp-tw-border", "key" to index, "style" to _nS(_uA(
                                    textStyle.value
                                ))), _tD(item), 5)
                            }
                            ), 128)
                    ...
                    if (isTrue(_uA(
                        ...
                        _cE("view", _uM("key" to 0, "class" to "weapp-tw-border up-notice__right-icon"), _uA(
                            if (_ctx.mode === "link") {
        ...
        var props = _nP(_uM("customStyle" to _uM("type" to _uA(
            "Object",
            "String"
        ), "default" to _uO()), "customClass" to _uM("type" to "String", "default" to ""), "url" to _uM("type" to "String", "default" to ""), "linkType" to _uM("type" to "String", "default" to "navigateTo"), "text" to _uM("type" to "String", "default" to default__46.getString("rowNotice.text")), "icon" to _uM("type" to "String", "default" to default__46.getString("rowNotice.icon")), "mode" to _uM("type" to "String", "default" to default__46.getString("rowNotice.mode")), "color" to _uM("type" to "String", "default" to default__46.getString("rowNotice.color")), "bgColor" to _uM("type" to "String", "default" to default__46.getString("rowNotice.bgColor")), "fontSize" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to default__46.getNumber("rowNotice.fontSize")), "speed" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to default__46.getNumber("rowNotice.speed"))))
