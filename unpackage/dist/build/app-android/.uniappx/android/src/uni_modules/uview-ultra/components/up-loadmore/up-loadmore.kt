...
open class GenUniModulesUviewUltraComponentsUpLoadmoreUpLoadmore : VueComponent {
    ...
    companion object {
        ...
        var props = _nP(_uM("customStyle" to _uM("type" to _uA(
            "Object",
            "String"
        ), "default" to _uO()), "customClass" to _uM("type" to "String", "default" to ""), "url" to _uM("type" to "String", "default" to ""), "linkType" to _uM("type" to "String", "default" to "navigateTo"), "status" to _uM("type" to "String", "default" to crtProp__27["status"]), "bgColor" to _uM("type" to "String", "default" to crtProp__27["bgColor"]), "icon" to _uM("type" to "Boolean", "default" to crtProp__27["icon"]), "fontSize" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to crtProp__27["fontSize"]), "iconSize" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to crtProp__27["iconSize"]), "color" to _uM("type" to "String", "default" to crtProp__27["color"]), "loadingIcon" to _uM("type" to "String", "default" to crtProp__27["loadingIcon"]), "loadmoreText" to _uM("type" to "String", "default" to crtProp__27["loadmoreText"]), "loadingText" to _uM("type" to "String", "default" to crtProp__27["loadingText"]), "nomoreText" to _uM("type" to "String", "default" to crtProp__27["nomoreText"]), "isDot" to _uM("type" to "Boolean", "default" to crtProp__27["isDot"]), "iconColor" to _uM("type" to "String", "default" to crtProp__27["iconColor"]), "marginTop" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to crtProp__27["marginTop"]), "marginBottom" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to crtProp__27["marginBottom"]), "height" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to crtProp__27["height"]), "line" to _uM("type" to "Boolean", "default" to crtProp__27["line"]), "lineColor" to _uM("type" to "String", "default" to crtProp__27["lineColor"]), "dashed" to _uM("type" to "Boolean", "default" to crtProp__27["dashed"])))
