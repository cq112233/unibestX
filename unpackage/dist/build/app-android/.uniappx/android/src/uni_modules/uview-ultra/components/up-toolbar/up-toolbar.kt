...
open class GenUniModulesUviewUltraComponentsUpToolbarUpToolbar : VueComponent {
            ...
            _cE("view", _uM("key" to 0, "class" to "up-toolbar", "onTouchmove" to withModifiers(_ctx.noop, _uA(
                ...
                _cE("view", _uM("class" to "up-toolbar__left"), _uA(
                    _cE("view", _uM("class" to "up-toolbar__cancel__wrapper", "hover-class" to "up-hover-class"), _uA(
                        _cE("text", _uM("class" to "up-toolbar__wrapper__cancel", "onClick" to _ctx.cancel, "style" to _nS(_uM("color" to _ctx.cancelColor))), _tD(_ctx.elCancelText), 13, _uA(
                            "onClick"
                        ))
                    ))
                )),
                ...
                _cE("view", _uM("class" to "up-toolbar__right"), _uA(
                    if (isTrue(!_ctx.rightSlot)) {
                        _cE("view", _uM("key" to 0, "class" to "up-toolbar__confirm__wrapper", "hover-class" to "up-hover-class"), _uA(
                            _cE("text", _uM("class" to "up-toolbar__wrapper__confirm", "onClick" to _ctx.confirm, "style" to _nS(_uM("color" to _ctx.elConfirmColor))), _tD(_ctx.elConfirmText), 13, _uA(
                                "onClick"
                            ))
                        ))
                    } else {
    ...
    override fun data(): Map<String, Any?> {
        return _uM("parent" to null as ComponentPublicInstance?, "parentData" to _uO(), "children" to _uA<ComponentPublicInstance>(), "childrenRefs" to _uA<String>(), "elCancelText" to computed<String>(fun(): String {
        ...
        ), "elConfirmColor" to computed<String>(fun(): String {
    ...
    companion object {
        ...
        var props = _nP(_uM("customStyle" to _uM("type" to _uA(
            "Object",
            "String"
        ), "default" to _uO()), "customClass" to _uM("type" to "String", "default" to ""), "url" to _uM("type" to "String", "default" to ""), "linkType" to _uM("type" to "String", "default" to "navigateTo"), "show" to _uM("type" to "Boolean", "default" to crtProp__15["show"]), "cancelText" to _uM("type" to "String", "default" to crtProp__15["cancelText"]), "confirmText" to _uM("type" to "String", "default" to crtProp__15["confirmText"]), "cancelColor" to _uM("type" to "String", "default" to crtProp__15["cancelColor"]), "confirmColor" to _uM("type" to "String", "default" to crtProp__15["confirmColor"]), "title" to _uM("type" to "String", "default" to crtProp__15["title"]), "rightSlot" to _uM("type" to "Boolean", "default" to false)))
