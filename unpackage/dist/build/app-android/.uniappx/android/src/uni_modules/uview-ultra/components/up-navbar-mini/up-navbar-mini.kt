...
open class GenUniModulesUviewUltraComponentsUpNavbarMiniUpNavbarMini : VueComponent {
    ...
    companion object {
        ...
        var props = _nP(_uM("customStyle" to _uM("type" to _uA(
            "Object",
            "String"
        ), "default" to _uO()), "customClass" to _uM("type" to "String", "default" to ""), "url" to _uM("type" to "String", "default" to ""), "linkType" to _uM("type" to "String", "default" to "navigateTo"), "safeAreaInsetTop" to _uM("type" to "Boolean", "default" to crtProp__26["safeAreaInsetTop"]), "fixed" to _uM("type" to "Boolean", "default" to crtProp__26["fixed"]), "leftIcon" to _uM("type" to "String", "default" to crtProp__26["leftIcon"]), "bgColor" to _uM("type" to "String", "default" to crtProp__26["bgColor"]), "height" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to crtProp__26["height"]), "iconSize" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to crtProp__26["iconSize"]), "iconColor" to _uM("type" to "String", "default" to crtProp__26["iconColor"]), "autoBack" to _uM("type" to "Boolean", "default" to crtProp__26["autoBack"]), "homeUrl" to _uM("type" to "String", "default" to crtProp__26["homeUrl"])))
