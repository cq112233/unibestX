...
open class GenUniModulesUviewUltraComponentsUpSearchUpSearch : VueComponent {
    ...
    companion object {
        ...
        var props = _nP(_uM("customStyle" to _uM("type" to _uA(
            ...
            "String",
            "Number"
        ), "default" to crtProp__17["value"]), "shape" to _uM("type" to "String", "default" to crtProp__17["shape"]), "bgColor" to _uM("type" to "String", "default" to crtProp__17["bgColor"]), "placeholder" to _uM("type" to "String", "default" to crtProp__17["placeholder"]), "clearabled" to _uM("type" to "Boolean", "default" to crtProp__17["clearabled"]), "onlyClearableOnFocused" to _uM("type" to "Boolean", "default" to true), "focus" to _uM("type" to "Boolean", "default" to crtProp__17["focus"]), "showAction" to _uM("type" to "Boolean", "default" to crtProp__17["showAction"]), "actionText" to _uM("type" to "String", "default" to crtProp__17["actionText"]), "label" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to crtProp__17["label"]), "inputAlign" to _uM("type" to "String", "default" to crtProp__17["inputAlign"]), "disabled" to _uM("type" to "Boolean", "default" to crtProp__17["disabled"]), "animation" to _uM("type" to "Boolean", "default" to crtProp__17["animation"]), "borderColor" to _uM("type" to "String", "default" to crtProp__17["borderColor"]), "searchIconColor" to _uM("type" to "String", "default" to crtProp__17["searchIconColor"]), "searchIconSize" to _uM("type" to _uA(
            "Number",
            "String"
        ), "default" to crtProp__17["searchIconSize"]), "color" to _uM("type" to "String", "default" to crtProp__17["color"]), "placeholderColor" to _uM("type" to "String", "default" to crtProp__17["placeholderColor"]), "searchIcon" to _uM("type" to "String", "default" to crtProp__17["searchIcon"]), "margin" to _uM("type" to "String", "default" to crtProp__17["margin"]), "iconPosition" to _uM("type" to "String", "default" to crtProp__17["iconPosition"]), "maxlength" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to crtProp__17["maxlength"]), "height" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to crtProp__17["height"]), "adjustPosition" to _uM("type" to "Boolean", "default" to crtProp__17["adjustPosition"]), "autoBlur" to _uM("type" to "Boolean", "default" to crtProp__17["autoBlur"]), "inputStyle" to _uM("type" to "UTSJSONObject", "default" to crtProp__17["inputStyle"]), "actionStyle" to _uM("type" to "UTSJSONObject", "default" to crtProp__17["actionStyle"])))
