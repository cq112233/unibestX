...
open class GenUniModulesUviewUltraComponentsUpCodeUpCode : VueComponent {
    ...
    companion object {
        ...
        var setup: (__props: GenUniModulesUviewUltraComponentsUpCodeUpCode, __setupCtx: SetupContext) -> Any? = fun(__props, __setupCtx): Any? {
            ...
            return fun(): Any? {
                return _cE("view", _uM("class" to "weapp-tw-border up-code"))
            }
        }
        var name = "up-code"
        ...
        var props = _nP(_uM("customStyle" to _uM("type" to _uA(
            ...
            "String",
            "Number"
        ), "default" to 60), "startText" to _uM("type" to "String", "default" to "获取验证码"), "changeText" to _uM("type" to "String", "default" to "X秒重新获取"), "endText" to _uM("type" to "String", "default" to "重新获取"), "keepRunning" to _uM("type" to "Boolean", "default" to false), "uniqueKey" to _uM("type" to "String", "default" to "")))
