...
open class GenUniModulesUviewUltraComponentsUpCarKeyboardUpCarKeyboard : VueComponent {
    ...
    companion object {
        ...
        var props = _nP(_uM("customStyle" to _uM("type" to _uA(
            "Object",
            "String"
        ), "default" to _uO()), "customClass" to _uM("type" to "String", "default" to ""), "url" to _uM("type" to "String", "default" to ""), "linkType" to _uM("type" to "String", "default" to "navigateTo"), "random" to _uM("type" to "Boolean", "default" to default__82.getBoolean("carKeyboard.random")), "autoChange" to _uM("type" to "Boolean", "default" to default__82.getBoolean("carKeyboard.autoChange"))))
