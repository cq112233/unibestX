...
open class GenUniModulesUviewUltraComponentsUpCarKeyboardUpCarKeyboard : VueComponent {
    ...
    companion object {
                ...
                return _cE("view", _uM("class" to "weapp-tw-border up-keyboard", "onTouchmove" to withModifiers(noop, _uA(
                    ...
                    , fun(group, i, __index, _cached): Any {
                        return _cE("view", _uM("key" to i, "class" to _nC(_uA(
                            "weapp-tw-border up-keyboard__button",
                            _uA(
                                if (((i + 1) == 4)) {
                            ...
                            if (i == 3) {
                                _cE("view", _uM("key" to 0, "class" to "weapp-tw-border up-keyboard__button__inner-wrapper"), _uA(
                                    _cE("view", _uM("class" to "weapp-tw-border up-keyboard__button__inner-wrapper__left", "hover-class" to "up-hover-class", "hover-stay-time" to 200, "onClick" to changeCarInputMode), _uA(
                                        _cE("text", _uM("class" to _nC(_uA(
                                            "weapp-tw-border up-keyboard__button__inner-wrapper__left__lang",
                                            _uA(
                                                if (!abc.value) {
                                        ...
                                        _cE("text", _uM("class" to "weapp-tw-border up-keyboard__button__inner-wrapper__left__line"), "/"),
                                        _cE("text", _uM("class" to _nC(_uA(
                                            "weapp-tw-border up-keyboard__button__inner-wrapper__left__lang",
                                            _uA(
                                                if (abc.value) {
                            ...
                            _cE(Fragment, null, RenderHelpers.renderList(group, fun(item, j, __index, _cached): Any {
                                return _cE("view", _uM("class" to "weapp-tw-border up-keyboard__button__inner-wrapper", "key" to j), _uA(
                                    _cE("view", _uM("class" to "weapp-tw-border up-keyboard__button__inner-wrapper__inner", "hover-stay-time" to 200, "onClick" to fun(){
                                        carInputClick(i, j)
                                    }
                                    , "hover-class" to "up-hover-class"), _uA(
                                        _cE("text", _uM("class" to "weapp-tw-border up-keyboard__button__inner-wrapper__inner__text"), _tD(item), 1)
                                    ), 8, _uA(
                                        "onClick"
                                    ))
                                ))
                            ...
                            if (i == 3) {
                                _cE("view", _uM("key" to 1, "onTouchstart" to backspaceClick, "onTouchend" to clearTimer, "class" to "weapp-tw-border up-keyboard__button__inner-wrapper"), _uA(
                                    _cE("view", _uM("class" to "weapp-tw-border up-keyboard__button__inner-wrapper__right", "hover-class" to "up-hover-class", "hover-stay-time" to 200), _uA(
        ...
        var props = _nP(_uM("customStyle" to _uM("type" to _uA(
            "Object",
            "String"
        ), "default" to _uO()), "customClass" to _uM("type" to "String", "default" to ""), "url" to _uM("type" to "String", "default" to ""), "linkType" to _uM("type" to "String", "default" to "navigateTo"), "random" to _uM("type" to "Boolean", "default" to default__44.getBoolean("carKeyboard.random")), "autoChange" to _uM("type" to "Boolean", "default" to default__44.getBoolean("carKeyboard.autoChange"))))
