...
open class GenUniModulesUviewUltraComponentsUpSwipeActionItemUpSwipeActionItem : VueComponent {
    ...
    open fun gen_getOptionStyle_fn(item: UTSJSONObject): UTSJSONObject? {
        ...
        try {
            val obj = style as UTSJSONObject
            if (obj != null) {
                return obj
            }
        }
    ...
    companion object {
        ...
        var props = _nP(_uM("customStyle" to _uM("type" to _uA(
            "Object",
            "String"
        ), "default" to _uO()), "customClass" to _uM("type" to "String", "default" to ""), "url" to _uM("type" to "String", "default" to ""), "linkType" to _uM("type" to "String", "default" to "navigateTo"), "show" to _uM("type" to "Boolean", "default" to crtProp__21["show"]), "closeOnClick" to _uM("type" to "Boolean", "default" to crtProp__21["closeOnClick"]), "name" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to crtProp__21["name"]), "disabled" to _uM("type" to "Boolean", "default" to crtProp__21["disabled"]), "autoClose" to _uM("type" to "Boolean", "default" to crtProp__21["autoClose"]), "threshold" to _uM("type" to "Number", "default" to crtProp__21["threshold"]), "options" to _uM("type" to "Array", "default" to crtProp__21["options"]), "duration" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to crtProp__21["duration"])))
