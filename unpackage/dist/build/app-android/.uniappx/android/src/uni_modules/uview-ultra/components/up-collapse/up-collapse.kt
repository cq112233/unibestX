...
open class GenUniModulesUviewUltraComponentsUpCollapseUpCollapse : VueComponent {
    ...
    companion object {
        ...
        var props = _nP(_uM("customStyle" to _uM("type" to _uA(
            ...
            return default__70.getString("collapse.value")
        }
        ), "accordion" to _uM("type" to "Boolean", "default" to default__70.getBoolean("collapse.accordion")), "border" to _uM("type" to "Boolean", "default" to default__70.getBoolean("collapse.border"))))
