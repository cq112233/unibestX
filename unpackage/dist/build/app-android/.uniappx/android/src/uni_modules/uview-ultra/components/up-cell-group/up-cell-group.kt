...
open class GenUniModulesUviewUltraComponentsUpCellGroupUpCellGroup : VueComponent {
    ...
    companion object {
            ...
            return fun(): Any? {
                ...
                return _cE("view", _uM("style" to _nS(_uA(
                    ...
                    if (isTrue(_ctx.title)) {
                        _cE("view", _uM("key" to 0, "class" to "up-cell-group__title"), _uA(
                            renderSlot(_ctx.`$slots`, "title", _uO(), fun(): UTSArray<Any> {
                                return _uA(
                                    _cE("text", _uM("class" to "up-cell-group__title__text"), _tD(_ctx.title), 1)
                                )
                            })
                        ))
                    } else {
                    ...
                    ,
                    _cE("view", _uM("class" to "up-cell-group__wrapper"), _uA(
        ...
        var props = _nP(_uM("customStyle" to _uM("type" to _uA(
            "Object",
            "String"
        ), "default" to _uO()), "customClass" to _uM("type" to "String", "default" to ""), "url" to _uM("type" to "String", "default" to ""), "linkType" to _uM("type" to "String", "default" to "navigateTo"), "title" to _uM("type" to "String", "default" to default__23.getString("cellGroup.title")), "border" to _uM("type" to "Boolean", "default" to default__23.getBoolean("cellGroup.border"))))
