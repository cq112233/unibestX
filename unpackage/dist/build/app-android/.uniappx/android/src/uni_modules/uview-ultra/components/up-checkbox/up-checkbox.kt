    ...
    companion object {
        ...
        var setup: (__props: GenUniModulesUviewUltraComponentsUpCheckboxUpCheckbox, __setupCtx: SetupContext) -> Any? = fun(__props, __setupCtx): Any? {
            ...
            val elDisabled = computed(fun(): Boolean {
                var disabledVal = props.disabled
            ...
            val elLabelDisabled = computed(fun(): Boolean {
                var labelDisabledVal = props.labelDisabled
        ...
        var props = _nP(_uM("customClass" to _uM("type" to "String", "default" to ""), "url" to _uM("type" to "String", "default" to ""), "linkType" to _uM("type" to "String", "default" to "navigateTo"), "name" to _uM("type" to _uA(
            ...
            "Number",
            "Boolean"
        ), "default" to default__45.getAny("checkbox.name")), "shape" to _uM("type" to "String", "default" to default__45.getString("checkbox.shape")), "size" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to default__45.getAny("checkbox.size")), "checked" to _uM("type" to "Boolean", "default" to default__45.getBoolean("checkbox.checked")), "disabled" to _uM("type" to _uA(
            "String",
            "Boolean"
        ), "default" to default__45.getAny("checkbox.disabled")), "activeColor" to _uM("type" to "String", "default" to default__45.getString("checkbox.activeColor")), "inactiveColor" to _uM("type" to "String", "default" to default__45.getString("checkbox.inactiveColor")), "iconSize" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to default__45.getAny("checkbox.iconSize")), "iconColor" to _uM("type" to "String", "default" to default__45.getString("checkbox.iconColor")), "label" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to default__45.getAny("checkbox.label")), "labelColor" to _uM("type" to "String", "default" to default__45.getString("checkbox.labelColor")), "labelSize" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to default__45.getAny("checkbox.labelSize")), "labelDisabled" to _uM("type" to _uA(
            "String",
            "Boolean"
        ), "default" to default__45.getAny("checkbox.labelDisabled")), "customStyle" to _uM("default" to fun(): UTSJSONObject {
            return (_uO())
        }
