...
open class GenUniModulesUviewUltraComponentsUpCheckboxUpCheckbox : VueComponent {
    ...
    companion object {
        ...
        var setup: (__props: GenUniModulesUviewUltraComponentsUpCheckboxUpCheckbox, __setupCtx: SetupContext) -> Any? = fun(__props, __setupCtx): Any? {
            ...
            val group = inject<CheckboxGroupProvide?>(CHECKBOX_GROUP_KEY, null)
            val selfChecked = ref<Boolean>(props.checked)
            ...
            val isChecked = computed<Boolean>(fun(): Boolean {
                val kVal = fromGroup("modelValue")
                if (kVal != null) {
                    val arr = kVal as UTSArray<Any>
                    if (props.name != null) {
                        run {
                            var i: Number = 0
                            while(i < arr.length){
            ...
            val iconWrapStyle = computed<UTSJSONObject>(fun(): UTSJSONObject {
                ...
                style["borderRadius"] = if (elShape.value == "circle") {
                    "100px"
                } else {
                    "3px"
                }
                ...
                val iconPlacement = fromGroup("iconPlacement")
            ...
            val checkboxStyle = computed<UTSJSONObject>(fun(): UTSJSONObject {
                val style: UTSJSONObject = _uO()
                style["display"] = "flex"
                style["flexDirection"] = if (iconPlacementClass.value == "up-checkbox-label--right") {
                    "row-reverse"
                } else {
                    "row"
                }
            ...
            fun gen_setCheckboxStatus_fn() {
                val targetChecked = !isChecked.value
                if (!props.usedAlone && group != null) {
                    group!!.toggle(if (props.name != null) {
                        props.name!!.toString()
                    } else {
                        ""
                    }, targetChecked)
            ...
            val setCheckboxStatus = ::gen_setCheckboxStatus_fn
            ...
            return fun(): Any? {
                ...
                return _cE("view", _uM("class" to _nC(_uA(
                    "weapp-tw-border up-checkbox wtu-1s7f97t-0",
                    _uA(
                        iconPlacementClass.value,
                        borderBottomClass.value
                    )
                )), "style" to _nS(checkboxStyle.value), "onClick" to withModifiers(wrapperClickHandler, _uA(
                    "stop"
                ))), _uA(
                    _cE("view", _uM("class" to _nC(_uA(
                        "weapp-tw-border up-checkbox__icon-wrap wtu-1s7f97t-0",
                        iconClasses.value
                    )), "onClick" to withModifiers(iconClickHandler, _uA(
                        "stop"
                    )), "style" to _nS(iconWrapStyle.value)), _uA(
                    ...
                    renderSlot(_ctx.`$slots`, "label", _uM("label" to _ctx.label, "elDisabled" to elDisabled.value), fun(): UTSArray<Any> {
                        return _uA(
                            _cE("text", _uM("class" to _nC(_uA(
                                "weapp-tw-border up-checkbox__label",
                                _uA(
                                    if (elDisabled.value) {
                                        "up-checkbox__label--disabled"
                                    } else {
                                        ""
                                    }
                                )
        ...
        val styles0: Map<String, Map<String, Map<String, Any>>>
            get() {
                return _uM("weapp-tw-border" to _pS(_uM("borderTopWidth" to 0, "borderRightWidth" to 0, "borderBottomWidth" to 0, "borderLeftWidth" to 0)), "up-checkbox" to _pS(_uM("display" to "flex", "flexDirection" to "row", "alignItems" to "center", "marginBottom" to 5, "marginTop" to 5)), "up-checkbox-label--left" to _pS(_uM("flexDirection" to "row")), "up-checkbox-label--right" to _pS(_uM("flexDirection" to "row-reverse", "justifyContent" to "space-between")), "up-checkbox__icon-wrap" to _pS(_uM("display" to "flex", "flexDirection" to "row", "alignItems" to "center", "justifyContent" to "center", "marginRight" to 6, "borderTopWidth" to 1, "borderRightWidth" to 1, "borderBottomWidth" to 1, "borderLeftWidth" to 1, "borderTopColor" to "#c8c9cc", "borderRightColor" to "#c8c9cc", "borderBottomColor" to "#c8c9cc", "borderLeftColor" to "#c8c9cc", "borderTopStyle" to "solid", "borderRightStyle" to "solid", "borderBottomStyle" to "solid", "borderLeftStyle" to "solid")), "up-checkbox__icon-wrap--circle" to _pS(_uM("borderTopLeftRadius" to 100, "borderTopRightRadius" to 100, "borderBottomRightRadius" to 100, "borderBottomLeftRadius" to 100)), "up-checkbox__icon-wrap--square" to _pS(_uM("borderTopLeftRadius" to 3, "borderTopRightRadius" to 3, "borderBottomRightRadius" to 3, "borderBottomLeftRadius" to 3)), "up-checkbox__icon-wrap--checked" to _pS(_uM("backgroundColor" to "#FF0000", "borderTopColor" to "#2979ff", "borderRightColor" to "#2979ff", "borderBottomColor" to "#2979ff", "borderLeftColor" to "#2979ff")), "up-checkbox__icon-wrap--active" to _pS(_uM("backgroundColor" to "#2979ff", "borderTopColor" to "#2979ff", "borderRightColor" to "#2979ff", "borderBottomColor" to "#2979ff", "borderLeftColor" to "#2979ff")), "up-checkbox__icon-wrap--disabled" to _pS(_uM("backgroundColor" to "#ebedf0")), "up-checkbox__icon-wrap--disabled--checked" to _pS(_uM("color" to "#c8c9cc")), "up-checkbox__label" to _pS(_uM("color" to "#606266", "fontSize" to 15)), "up-checkbox__label--disabled" to _pS(_uM("color" to "#c8c9cc")), "wtu-1s7f97t-0" to _pS(_uM("cursor" to "pointer")))
            }
        ...
        var props = _nP(_uM("customClass" to _uM("type" to "String", "default" to ""), "url" to _uM("type" to "String", "default" to ""), "linkType" to _uM("type" to "String", "default" to "navigateTo"), "name" to _uM("type" to _uA(
            ...
            "Number",
            "Boolean"
        ), "required" to false, "default" to ""), "shape" to _uM("type" to "String", "required" to false, "default" to ""), "size" to _uM("type" to _uA(
            "String",
            "Number"
        ), "required" to false, "default" to ""), "checked" to _uM("type" to "Boolean", "required" to false, "default" to false), "disabled" to _uM("type" to _uA(
            "String",
            "Boolean"
            ...
            "String",
            "Number"
        ), "required" to false, "default" to ""), "iconColor" to _uM("type" to "String", "required" to false, "default" to ""), "label" to _uM("type" to _uA(
            "String",
            "Number"
        ), "required" to false, "default" to ""), "labelColor" to _uM("type" to "String", "required" to false, "default" to ""), "labelSize" to _uM("type" to _uA(
            "String",
            "Number"
        ), "required" to false, "default" to ""), "labelDisabled" to _uM("type" to _uA(
            "String",
            "Boolean"
        ), "required" to false, "default" to ""), "customStyle" to _uM("type" to "UTSJSONObject", "required" to false, "default" to fun(): UTSJSONObject {
            return (_uO())
        }
