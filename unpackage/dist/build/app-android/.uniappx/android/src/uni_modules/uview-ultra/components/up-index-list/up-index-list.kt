...
open class GenUniModulesUviewUltraComponentsUpIndexListUpIndexList : VueComponent {
    ...
    companion object {
        ...
        var setup: (__props: GenUniModulesUviewUltraComponentsUpIndexListUpIndexList, __setupCtx: SetupContext) -> Any? = fun(__props, __setupCtx): Any? {
            ...
            val getIndexListLetterRect = fun(): UTSPromise<NodeInfo> {
                return UTSPromise(fun(resolve, _reject){
                    uni.UNIB120614.upGetRect(".up-index-list__letter", false, instance).then(fun(size: NodeInfo){
                        resolve(size)
                    }
                    )
                }
            ...
            val letterStyle = computed(fun(): UTSJSONObject {
                val topVal = if (letterInfo.value["top"] != null) {
                    letterInfo.value["top"]!!.toString(10)
                } else {
                    ""
                }
                return _uO("top" to if (topVal != "") {
                    addUnit(topVal)
                } else {
                    ""
                }
            ...
            val indicatorTransitionStyle = computed(fun(): UTSJSONObject {
                return _uO("position" to "absolute", "right" to "30px", "top" to addUnit(indicatorTop.value, "px"), "width" to addUnit(indicatorHeight.value + 10), "zIndex" to 3)
            }
            )
            val indicatorBoxStyle = computed(fun(): UTSJSONObject {
                return _uO("height" to addUnit(indicatorHeight.value), "width" to addUnit(indicatorHeight.value))
            }
            )
            fun gen_getItemTextStyle_fn(index: Number): UTSJSONObject {
                return _uO("color" to if (activeIndex.value == index) {
                    "#fff"
                } else {
                    props.inactiveColor
                }
            ...
            fun gen_getIndexListRect_fn(): UTSPromise<NodeInfo> {
                return UTSPromise(fun(resolve, _reject){
                    uni.UNIB120614.upGetRect(".up-index-list__scroll-view", false, instance).then(fun(size: NodeInfo){
                        resolve(size)
                    }
                    )
                }
            ...
            val getHeaderRect = fun(): UTSPromise<NodeInfo> {
                return UTSPromise(fun(resolve, _reject){
                    ...
                    uni.UNIB120614.upGetRect(".up-index-list__header", false, instance).then(fun(size: NodeInfo){
                        resolve(size)
                    }
                    )
                }
                ...
                return wrapUTSPromise(suspend {
                        if (currentIndex !== activeIndex.value) {
                            ...
                            var childrenItems = children.value.map(fun(item: ComponentPublicInstance, index: Number): UTSJSONObject {
                                ...
                                val child: UTSJSONObject = _uO("height" to childHeight, "top" to top)
                                top = top + childHeight
                                return child
                            }
                            )
            ...
            return fun(): Any? {
                ...
                return _cE("view", _uM("ref" to "up-index-list", "class" to "weapp-tw-border up-index-list"), _uA(
                    if (isTrue(_ctx.sticky && activeIndex.value >= 0 && activeIndex.value < uIndexList.value.length)) {
                        _cE("view", _uM("key" to 0, "class" to "weapp-tw-border up-index-list__sticky-header", "style" to _nS(_uM("position" to "absolute", "top" to "0", "left" to "0", "right" to "0", "z-index" to "2"))), _uA(
                            _cV(_component_up_index_anchor, _uM("text" to keyVal(uIndexList.value[activeIndex.value])), null, 8, _uA(
                                "text"
                            ))
                        ), 4)
                    } else {
                    ...
                    ,
                    _cE("scroll-view", _uM("scroll-top" to scrollTop.value, "scroll-into-view" to scrollIntoView.value, "style" to _nS(_uM("flex" to 1)), "direction" to "vertical", "onScroll" to scrollHandler, "ref" to "up-index-list__scroll-view", "class" to "up-index-list__scroll-view"), _uA(
                        if (_ctx.`$slots`["header"] != null) {
                            _cE("view", _uM("key" to 0, "class" to "weapp-tw-border up-index-list__header"), _uA(
                        ...
                        if (_ctx.`$slots`["footer"] != null) {
                            _cE("view", _uM("key" to 1, "class" to "weapp-tw-border up-index-list__footer"), _uA(
                    ...
                    _cE("view", _uM("class" to "weapp-tw-border up-index-list__letter", "ref" to "up-index-list__letter", "style" to _nS(letterStyle.value), "onTouchstart" to touchStart, "onTouchmove" to touchMove, "onTouchend" to touchEnd, "onTouchcancel" to touchEnd), _uA(
                        _cE(Fragment, null, RenderHelpers.renderList(uIndexList.value, fun(item, index, __index, _cached): Any {
                            return _cE("view", _uM("class" to _nC(_uA(
                                "weapp-tw-border up-index-list__letter__item",
                                ...
                                _cE("text", _uM("class" to "weapp-tw-border up-index-list__letter__item__index", "style" to _nS(getItemTextStyle(index))), _tD(keyVal(item)), 5)
                            ), 6)
                        }
                        ), 128)
                    ), 36),
                    _cV(_component_up_transition, _uM("mode" to "fade", "show" to touching.value, "customStyle" to indicatorTransitionStyle.value), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                        return _uA(
                            _cE("view", _uM("class" to _nC(_uA(
                                "weapp-tw-border up-index-list__indicator",
                                _uA(
                                    "up-index-list__indicator--show"
                                )
                            )), "style" to _nS(indicatorBoxStyle.value)), _uA(
                                _cE("text", _uM("class" to "weapp-tw-border up-index-list__indicator__text"), _tD(if (activeIndex.value >= 0) {
        ...
        var props = _nP(_uM("customStyle" to _uM("type" to _uA(
            "Object",
            "String"
        ), "default" to _uO()), "customClass" to _uM("type" to "String", "default" to ""), "url" to _uM("type" to "String", "default" to ""), "linkType" to _uM("type" to "String", "default" to "navigateTo"), "inactiveColor" to _uM("type" to "String", "default" to default__43.getString("indexList.inactiveColor")), "activeColor" to _uM("type" to "String", "default" to default__43.getString("indexList.activeColor")), "indexList" to _uM("type" to "Array", "default" to fun(): UTSArray<Any> {
            val list = _uA<Any>()
            default__43.getArray<String>("indexList.indexList")!!!!.forEach(fun(item: String){
                list.push(item)
            }
            )
            return list
        }
        ), "sticky" to _uM("type" to "Boolean", "default" to default__43.getBoolean("indexList.sticky")), "customNavHeight" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to default__43.getNumber("indexList.customNavHeight")), "safeBottomFix" to _uM("type" to "Boolean", "default" to default__43.getBoolean("indexList.safeBottomFix")), "itemMargin" to _uM("type" to _uA(
            "String"
        ), "default" to default__43.getString("indexList.itemMargin"))))
