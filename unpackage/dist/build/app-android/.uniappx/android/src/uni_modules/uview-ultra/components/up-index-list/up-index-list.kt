...
open class GenUniModulesUviewUltraComponentsUpIndexListUpIndexList : VueComponent {
    ...
    companion object {
            ...
            return fun(): Any? {
                ...
                return _cE("view", _uM("ref" to "up-index-list", "class" to "up-index-list"), _uA(
                    if (isTrue(_ctx.sticky && activeIndex.value >= 0 && activeIndex.value < uIndexList.value.length)) {
                        _cE("view", _uM("key" to 0, "class" to "up-index-list__sticky-header", "style" to _nS(_uM("position" to "absolute", "top" to "0", "left" to "0", "right" to "0", "z-index" to "2"))), _uA(
                    ...
                    ,
                    _cE("scroll-view", _uM("scroll-top" to scrollTop.value, "scroll-into-view" to scrollIntoView.value, "style" to _nS(_uM("flex" to 1)), "direction" to "vertical", "scroll-y" to true, "onScroll" to scrollHandler, "ref" to "up-index-list__scroll-view", "class" to "up-index-list__scroll-view"), _uA(
        ...
        var props = _nP(_uM("customStyle" to _uM("type" to _uA(
            "Object",
            "String"
        ), "default" to _uO()), "customClass" to _uM("type" to "String", "default" to ""), "url" to _uM("type" to "String", "default" to ""), "linkType" to _uM("type" to "String", "default" to "navigateTo"), "inactiveColor" to _uM("type" to "String", "default" to default__96.getString("indexList.inactiveColor")), "activeColor" to _uM("type" to "String", "default" to default__96.getString("indexList.activeColor")), "indexList" to _uM("type" to "Array", "default" to fun(): UTSArray<Any> {
            val list = _uA<Any>()
            default__96.getArray<String>("indexList.indexList")!!!!.forEach(fun(item: String){
                list.push(item)
            }
            )
            return list
        }
        ), "sticky" to _uM("type" to "Boolean", "default" to default__96.getBoolean("indexList.sticky")), "customNavHeight" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to default__96.getNumber("indexList.customNavHeight")), "safeBottomFix" to _uM("type" to "Boolean", "default" to default__96.getBoolean("indexList.safeBottomFix")), "itemMargin" to _uM("type" to _uA(
            "String"
        ), "default" to default__96.getString("indexList.itemMargin"))))
