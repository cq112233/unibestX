...
open class GenUniModulesUviewUltraComponentsUpCalendarUpCalendar : VueComponent {
                ...
                _cE("view", _uM("class" to "up-calendar"), _uA(
                    ...
                    if (isTrue(!_ctx.monthSwitch)) {
                        _cE("scroll-view", _uM("key" to 0, "style" to _nS(_uM("height" to _ctx.addUnit(_ctx.listHeight))), "direction" to "vertical", "onScroll" to _ctx.onScroll, "scroll-top" to _ctx.scrollTop, "scrollIntoView" to _ctx.scrollIntoView), _uA(
                            _cV(_component_uMonth, _uM("color" to _ctx.color, "rowHeight" to _ctx.rowHeight, "showMark" to _ctx.showMark, "months" to _ctx.months, "mode" to _ctx.mode, "maxCount" to _ctx.maxCount, "startText" to _ctx.elStartText, "endText" to _ctx.elEndText, "defaultDate" to _ctx.defaultDate, "minDate" to _ctx.innerMinDate, "maxDate" to _ctx.innerMaxDate, "maxMonth" to _ctx.monthNum, "readonly" to _ctx.readonly, "maxRange" to _ctx.maxRange, "rangePrompt" to _ctx.rangePrompt, "showRangePrompt" to _ctx.showRangePrompt, "allowSameDay" to _ctx.allowSameDay, "todayDate" to _ctx.todayDate, "ref" to "month", "onMonthSelected" to _ctx.monthSelectedM, "onUpdateMonthTop" to _ctx.onUpdateMonthTopM), null, 8, _uA(
                                "color",
                                "rowHeight",
                                "showMark",
                                "months",
                        ...
                        _cE("view", _uM("key" to 1, "style" to _nS(_uM("height" to _ctx.addUnit(_ctx.listHeight)))), _uA(
                            _cV(_component_uMonth, _uM("color" to _ctx.color, "rowHeight" to _ctx.rowHeight, "showMark" to _ctx.showMark, "months" to _ctx.currentMonths, "mode" to _ctx.mode, "maxCount" to _ctx.maxCount, "startText" to _ctx.elStartText, "endText" to _ctx.elEndText, "defaultDate" to _ctx.defaultDate, "minDate" to _ctx.innerMinDate, "maxDate" to _ctx.innerMaxDate, "maxMonth" to _ctx.monthNum, "readonly" to _ctx.readonly, "maxRange" to _ctx.maxRange, "rangePrompt" to _ctx.rangePrompt, "showRangePrompt" to _ctx.showRangePrompt, "allowSameDay" to _ctx.allowSameDay, "todayDate" to _ctx.todayDate, "ref" to "month", "onMonthSelected" to _ctx.monthSelectedM, "onUpdateMonthTop" to _ctx.onUpdateMonthTopM), null, 8, _uA(
                                "color",
                                "rowHeight",
                                "showMark",
                                "months",
    ...
    open var elTitle: String by `$data`
    open var elConfirmText: String by `$data`
    open var elConfirmDisabledText: String by `$data`
    open var elStartText: String by `$data`
    open var elEndText: String by `$data`
    ...
    override fun data(): Map<String, Any?> {
        ...
        , "innerMaxDate" to computed<String>(fun(): String {
        ...
        ), "elTitle" to computed<String>(fun(): String {
            ...
            if (this.months.length > 0) {
                ...
                val item = this.months[monthIndex] as monthsItem
    ...
    companion object {
        ...
        var props = _nP(_uM("customStyle" to _uM("type" to _uA(
            ...
            "Number",
            "String"
        ), "default" to 3), "monthSwitch" to _uM("type" to "Boolean", "default" to calendarProp__2["monthSwitch"]), "showToday" to _uM("type" to "Boolean", "default" to calendarProp__2["showToday"]), "safeAreaInsetBottom" to _uM("type" to "Boolean", "default" to (calendarProp__2["safeAreaInsetBottom"] ?: true) as Boolean)))
