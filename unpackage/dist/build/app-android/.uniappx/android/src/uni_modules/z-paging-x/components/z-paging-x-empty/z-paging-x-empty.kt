        ...
        var setup: (__props: GenUniModulesZPagingXComponentsZPagingXEmptyZPagingXEmpty) -> Any? = fun(__props): Any? {
            ...
            return fun(): Any? {
                return _cE("view", _uM("class" to _nC(_uA(
                    "weapp-tw-border",
                    _uM("zpx-container" to true)
                )), "style" to _nS(_uA(
                    _ctx.emptyStyle
                )), "onClick" to emptyClick), _uA(
                    _cE("view", _uM("class" to "weapp-tw-border zpx-main"), _uA(
                        ...
                        ,
                        _cE("text", _uM("class" to "weapp-tw-border zpx-main-title", "style" to _nS(_uA(
                            _ctx.emptyTitleStyle
                        ))), _tD(_ctx.emptyText), 5),
                        if (isTrue(_ctx.showEmptyReload)) {
                            _cE("text", _uM("key" to 2, "class" to "weapp-tw-border zpx-main-error-btn", "style" to _nS(_uA(
