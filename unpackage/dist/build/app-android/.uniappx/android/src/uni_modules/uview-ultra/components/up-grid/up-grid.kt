...
open class GenUniModulesUviewUltraComponentsUpGridUpGrid : VueComponent {
    ...
    open var childClick: (name: Any) -> Unit
        get() {
            return unref(this.`$exposed`["childClick"]) as (name: Any) -> Unit
        }
        set(value) {
            setRefValue(this.`$exposed`, "childClick", value)
        }
    ...
    companion object {
        ...
        var setup: (__props: GenUniModulesUviewUltraComponentsUpGridUpGrid, __setupCtx: SetupContext) -> Any? = fun(__props, __setupCtx): Any? {
            val __expose = __setupCtx.expose
            val __ins = getCurrentInstance()!!
            val _ctx = __ins.proxy as GenUniModulesUviewUltraComponentsUpGridUpGrid
            ...
            val parentDataCpu = computed(fun(): UTSJSONObject {
                return _uO("col" to props.col, "border" to props.border, "align" to props.align)
            }
            )
            val gridStyle = computed(fun(): UTSJSONObject {
            ...
            val getWidth = fun(){
                uni.UNIB120614.upGetRect(".up-grid", false, instance).then(fun(size: NodeInfo){
                    if (size.width != null) {
            ...
            val childClick = fun(name: Any){
                emit("click", name)
            }
            watch(parentDataCpu, fun(){
            ...
            val getRefs = fun(): UTSJSONObject {
                return _uO("width" to width.value)
            }
            __expose(_uM("childClick" to childClick, "getChildren" to getChildren, "addChild" to addChild, "children" to children, "getProps" to getProps, "getRefs" to getRefs))
            return fun(): Any? {
                return _cE("view", _uM("class" to "weapp-tw-border up-grid", "ref" to "up-grid", "style" to _nS(_uA(
                    gridStyle.value
                ))), _uA(
        ...
        var props = _nP(_uM("customStyle" to _uM("type" to _uA(
            ...
            "String",
            "Number"
        ), "default" to default__40.getNumber("grid.col")), "border" to _uM("type" to "Boolean", "default" to default__40.getBoolean("grid.border")), "align" to _uM("type" to "String", "default" to default__40.getString("grid.align"))))
