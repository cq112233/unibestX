...
open class GenUniModulesUviewUltraComponentsUpGridUpGrid : VueComponent {
    ...
    companion object {
        ...
        var setup: (__props: GenUniModulesUviewUltraComponentsUpGridUpGrid, __setupCtx: SetupContext) -> Any? = fun(__props, __setupCtx): Any? {
            ...
            val getWidth = fun(){
                uni.UNI5198058.upGetRect(".up-grid", false, instance).then(fun(size: NodeInfo){
                    if (size.width != null) {
            ...
            return fun(): Any? {
                return _cE("view", _uM("class" to "up-grid", "ref" to "up-grid", "style" to _nS(_uA(
                    gridStyle.value
                ))), _uA(
        ...
        var props = _nP(_uM("customStyle" to _uM("type" to _uA(
            ...
            "String",
            "Number"
        ), "default" to default__76.getNumber("grid.col")), "border" to _uM("type" to "Boolean", "default" to default__76.getBoolean("grid.border")), "align" to _uM("type" to "String", "default" to default__76.getString("grid.align"))))
