...
open class GenUniModulesUviewUltraComponentsUpAlbumUpAlbum : VueComponent {
    ...
    companion object {
        ...
        var setup: (__props: GenUniModulesUviewUltraComponentsUpAlbumUpAlbum) -> Any? = fun(__props): Any? {
            ...
            val getComponentWidth = fun(): UTSPromise<Unit> {
                return wrapUTSPromise(suspend {
                        sleep(30).then(fun(){
                            uni.UNIB120614.upGetRect(".up-album__row", false, instance).then(fun(res: Any){
            ...
            fun gen_getImageStyle_fn(index1: Number, index2: Number): UTSJSONObject {
            ...
            val imageBorderRadius = computed(fun(): String {
                return if (props.shape == "circle") {
                    "10000px"
                } else {
            ...
            val moreBorderRadius = computed(fun(): String {
                return if (props.shape == "circle") {
                    "50%"
                } else {
                    addUnit(props.radius)
            ...
            val rowWrapStyle = computed(fun(): UTSJSONObject {
                return _uO("flexWrap" to if (props.autoWrap) {
                    "wrap"
                } else {
                    "nowrap"
                }
            ...
            val imageStyleComputed = computed(fun(): UTSJSONObject {
                return _uO("width" to imageWidth.value, "height" to imageHeight.value, "borderRadius" to imageBorderRadius.value)
            }
            )
            val imageModeComputed = computed(fun(): String {
                if (props.urls.length == 1) {
                    return if ((imageHeight.value != "0px" && imageHeight.value != "0rpx")) {
                        props.singleMode
                    } else {
                        "widthFix"
                    }
            ...
            return fun(): Any? {
                ...
                return _cE("view", _uM("class" to "weapp-tw-border up-album"), _uA(
                    _cE(Fragment, null, RenderHelpers.renderList(showUrls.value, fun(arr, index, __index, _cached): Any {
                        return _cE("view", _uM("class" to "weapp-tw-border up-album__row", "ref_for" to true, "ref" to "up-album__row", "key" to index, "style" to _nS(rowWrapStyle.value)), _uA(
                            _cE(Fragment, null, RenderHelpers.renderList(arr, fun(item, index1, __index, _cached): Any {
                                return _cE("view", _uM("class" to "weapp-tw-border up-album__row__wrapper", "key" to index1, "style" to _nS(getImageStyle(index + 1, index1 + 1)), "onClick" to fun(`$event`: Any){
                                    onPreviewTap(`$event`, getSrc(item))
                                }
                                ), _uA(
                                    _cE("image", _uM("src" to getSrc(item), "mode" to imageModeComputed.value, "style" to _nS(imageStyleComputed.value)), null, 12, _uA(
                                        "src",
                                        "mode"
                                    )),
                                    if (isTrue(_ctx.showMore && _ctx.urls.length > parseInt(_ctx.rowCount.toString()) * showUrls.value.length && index === showUrls.value.length - 1 && index1 === showUrls.value[showUrls.value.length - 1].length - 1)) {
                                        _cE("view", _uM("key" to 0, "class" to "weapp-tw-border up-album__row__wrapper__text", "style" to _nS(_uM("borderRadius" to moreBorderRadius.value))), _uA(
        ...
        ), "customClass" to _uM("type" to "String", "default" to ""), "urls" to _uM("type" to "Array", "default" to default__24.getArray<Any>("album.urls")), "keyName" to _uM("type" to "String", "default" to default__24.getString("album.keyName")), "singleSize" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to default__24.getNumber("album.singleSize")), "multipleSize" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to default__24.getNumber("album.multipleSize")), "space" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to default__24.getNumber("album.space")), "singleMode" to _uM("type" to "String", "default" to default__24.getString("album.singleMode")), "multipleMode" to _uM("type" to "String", "default" to default__24.getString("album.multipleMode")), "maxCount" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to default__24.getNumber("album.maxCount")), "previewFullImage" to _uM("type" to "Boolean", "default" to default__24.getBoolean("album.previewFullImage")), "rowCount" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to default__24.getNumber("album.rowCount")), "showMore" to _uM("type" to "Boolean", "default" to default__24.getBoolean("album.showMore")), "shape" to _uM("type" to "String", "default" to default__25.getString("image.shape")), "radius" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to default__25.getNumber("image.radius")), "autoWrap" to _uM("type" to "Boolean", "default" to default__24.getBoolean("album.autoWrap")), "unit" to _uM("type" to "String", "default" to default__24.getString("album.unit")), "stop" to _uM("type" to "Boolean", "default" to default__24.getBoolean("album.stop"))))
