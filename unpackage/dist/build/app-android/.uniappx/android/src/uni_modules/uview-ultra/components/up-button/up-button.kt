    ...
    companion object {
        ...
        var setup: (__props: GenUniModulesUviewUltraComponentsUpButtonUpButton) -> Any? = fun(__props): Any? {
            ...
            val bemClass = computed(fun(): String {
                var ret = ""
                if (props.color == "") {
                    ret = uni.UNIB120614.bem("button", _uA(
                        props.type,
                        props.shape,
                        props.size
                    ), _uA(
            ...
            val textColorCom = computed<String>(fun(): String {
                if (props.color != "") {
                    return if (props.plain) {
                        props.color
                    } else {
                        "#ffffff"
                    }
            ...
            val loadingColor = computed(fun(): String {
                if (props.plain) {
                    return if (props.color != "") {
                        ...
                        default__11.getString("color.up-" + props.type) as String
                    }
                }
                if (props.type == "info") {
                    return "#c9c9c9"
            ...
            val buttonRootStyle = computed(fun(): UTSJSONObject {
                val custom = addStyle(props.customStyle) as UTSJSONObject
                return deepMerge(baseColor.value, custom) as UTSJSONObject
            }
            )
            val loadingIconSize = computed(fun(): String {
                return addUnit(props.loadingSize * 1.15)
            }
            )
            val textStyle = computed(fun(): UTSJSONObject {
                return _uO("fontSize" to (textSize.value + "px"), "color" to textColorCom.value)
            }
            )
            val iconSizeComputed = computed(fun(): String {
            ...
            return fun(): Any? {
                ...
                return _cE("view", _uM("style" to _nS(_uA(
                    ...
                    buttonRootStyle.value
                )), "class" to _nC(_uA(
                    "weapp-tw-border up-button",
                    bemClass.value
                    ...
                    if (isTrue(_ctx.loading)) {
                        _cE(Fragment, _uM("key" to 0), _uA(
                            _cV(_component_up_loading_icon, _uM("mode" to _ctx.loadingMode, "size" to loadingIconSize.value, "color" to loadingColor.value), null, 8, _uA(
                                "mode",
                                "size",
                                "color"
                            )),
                            _cE("text", _uM("class" to "weapp-tw-border up-button__text up-button__loading-text", "style" to _nS(textStyle.value)), _tD(if (_ctx.loadingText != "") {
                                _ctx.loadingText
                            } else {
                                _ctx.text
                            }), 5)
                        ...
                        _cE(Fragment, _uM("key" to 1), _uA(
                            if (_ctx.icon != "") {
                                _cV(_component_up_icon, _uM("key" to 0, "name" to _ctx.icon, "color" to iconColorCom.value, "size" to iconSizeComputed.value, "customStyle" to _uO("marginRight" to "2px")), null, 8, _uA(
                                    "name",
                                    "color",
                                    "size"
                                ))
                            ...
                            renderSlot(_ctx.`$slots`, "default", _uO(), fun(): UTSArray<Any> {
                                return _uA(
                                    _cE("text", _uM("class" to "weapp-tw-border up-button__text", "style" to _nS(textStyle.value)), _tD(_ctx.text), 5)
                                )
                            }
                            )
                        ), 64)
        ...
        var props = _nP(_uM("customClass" to _uM("type" to "String", "default" to ""), "url" to _uM("type" to "String", "default" to ""), "linkType" to _uM("type" to "String", "default" to "navigateTo"), "hairline" to _uM("type" to "Boolean", "default" to false), "type" to _uM("type" to "String", "default" to "info"), "size" to _uM("type" to "String", "default" to "normal"), "shape" to _uM("type" to "String", "default" to "square"), "plain" to _uM("type" to "Boolean", "default" to false), "disabled" to _uM("type" to "Boolean", "default" to false), "loading" to _uM("type" to "Boolean", "default" to false), "loadingText" to _uM("type" to "String", "default" to ""), "loadingMode" to _uM("type" to "String", "default" to "spinner"), "loadingSize" to _uM("type" to "Number", "default" to 15), "openType" to _uM("type" to "String", "default" to ""), "formType" to _uM("type" to "String", "default" to ""), "appParameter" to _uM("type" to "String", "default" to ""), "hoverStopPropagation" to _uM("type" to "Boolean", "default" to false), "lang" to _uM("type" to "String", "default" to "en"), "sessionFrom" to _uM("type" to "String", "default" to ""), "sendMessageTitle" to _uM("type" to "String", "default" to ""), "sendMessagePath" to _uM("type" to "String", "default" to ""), "sendMessageImg" to _uM("type" to "String", "default" to ""), "showMessageCard" to _uM("type" to "Boolean", "default" to false), "dataName" to _uM("type" to "String", "default" to ""), "throttleTime" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to 0), "hoverStartTime" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to 20), "hoverStayTime" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to 70), "text" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to ""), "icon" to _uM("type" to "String", "default" to ""), "iconColor" to _uM("type" to "String", "default" to ""), "color" to _uM("type" to "String", "default" to ""), "customStyle" to _uM("default" to fun(): UTSJSONObject {
            return (_uO())
        }
        )))
