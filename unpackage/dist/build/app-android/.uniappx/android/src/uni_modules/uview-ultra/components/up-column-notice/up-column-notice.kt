...
open class GenUniModulesUviewUltraComponentsUpColumnNoticeUpColumnNotice : VueComponent {
    ...
    companion object {
        ...
        var props = _nP(_uM("customStyle" to _uM("type" to _uA(
            ...
            return default__67.getString("columnNotice.icon")
        }
        ), "mode" to _uM("type" to "String", "default" to fun(): String? {
            return default__67.getString("columnNotice.mode")
        }
        ), "color" to _uM("type" to "String", "default" to fun(): String? {
            return default__67.getString("columnNotice.color")
        }
        ), "bgColor" to _uM("type" to "String", "default" to fun(): String? {
            return default__67.getString("columnNotice.bgColor")
        }
        ), "fontSize" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to fun(): Number? {
            return default__67.getNumber("columnNotice.fontSize")
        }
        ), "speed" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to fun(): Number? {
            return default__67.getNumber("columnNotice.speed")
        }
        ), "step" to _uM("type" to "Boolean", "default" to fun(): Boolean? {
            return default__67.getBoolean("columnNotice.step")
        }
        ), "duration" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to fun(): Number? {
            return default__67.getNumber("columnNotice.duration")
        }
        ), "disableTouch" to _uM("type" to "Boolean", "default" to fun(): Boolean? {
            return default__67.getBoolean("columnNotice.disableTouch")
        }
        )))
