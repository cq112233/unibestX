...
open class GenUniModulesUviewUltraComponentsUpFormItemUpFormItem : VueComponent {
    ...
    companion object {
        ...
        var setup: (__props: GenUniModulesUviewUltraComponentsUpFormItemUpFormItem, __setupCtx: SetupContext) -> Any? = fun(__props, __setupCtx): Any? {
            ...
            val bodyStyle = computed(fun(): UTSJSONObject {
                val custom = addStyle(props.customStyle) as UTSJSONObject
                val parentPos = if (parentData.value != null) {
                    (parentData.value["labelPosition"] as String?)
                } else {
                    null
                }
                val pos = if (props.labelPosition != "") {
                    props.labelPosition
                } else {
                    (parentPos ?: "left")
                }
                val base: UTSJSONObject = _uO("flexDirection" to if (pos == "left") {
                    "row"
                } else {
                    "column"
                }
            ...
            val labelWrapperStyle = computed(fun(): UTSJSONObject {
                val parentPos = if (parentData.value != null) {
                    (parentData.value["labelPosition"] as String?)
                } else {
                    null
                ...
                val parentWidth = if (parentData.value != null) {
                    (parentData.value["labelWidth"] ?: 45)
                } else {
                    45
                }
                val widthVal = if (props.labelWidth != null && props.labelWidth != "") {
                    props.labelWidth
                } else {
                    parentWidth
                }
                return _uO("width" to addUnit(widthVal), "marginBottom" to if (pos == "left") {
                    "0px"
                } else {
                    "5px"
                }
            ...
            val labelAlignStyle = computed(fun(): UTSJSONObject {
                val align = if (parentData.value != null) {
                    (parentData.value["labelAlign"] as String?)
                } else {
                    null
                }
                return _uO("justifyContent" to if (align == "left") {
                    "flex-start"
                } else {
                    if (align == "center") {
                        "center"
            ...
            val labelCustomStyle = computed(fun(): UTSJSONObject {
                if (parentData.value != null && parentData.value["labelStyle"] != null) {
                    return parentData.value["labelStyle"] as UTSJSONObject
                }
                return _uO()
            }
            )
            val messageStyle = computed(fun(): UTSJSONObject {
                ...
                return _uO("marginLeft" to left)
            }
            )
            val isErrorMessage = computed(fun(): Boolean {
                val errorType = if (parentData.value != null) {
                    (parentData.value["errorType"] as String?)
                } else {
                    null
                }
            ...
            val lineColor = computed(fun(): String {
                val errorType = if (parentData.value != null) {
                    (parentData.value["errorType"] as String?)
                } else {
                    null
                }
                return if (message.value != "" && errorType == "border-bottom") {
                    (color["error"] as String)
                } else {
                    ((default__17["color"] ?: "#d6d7d9") as String)
                }
            }
            )
            val lineStyle = computed(fun(): UTSJSONObject {
                return _uO("marginTop" to if (isErrorMessage.value) {
                    "5px"
                } else {
                    "0px"
                }
            ...
            return fun(): Any? {
                ...
                return _cE("view", _uM("class" to _nC(_uA(
                    "weapp-tw-border up-form-item",
                    _uM("up-form-item--error" to isErrorMessage.value)
                ))), _uA(
                    _cE("view", _uM("class" to "weapp-tw-border up-form-item__body", "onClick" to clickHandler, "style" to _nS(bodyStyle.value)), _uA(
                        renderSlot(_ctx.`$slots`, "label", _uO(), fun(): UTSArray<Any> {
                            return _uA(
                                if (isTrue((if (isTruthy(_ctx.required)) {
                                    ...
                                    _cE("view", _uM("key" to 0, "class" to "weapp-tw-border up-form-item__body__left", "style" to _nS(labelWrapperStyle.value)), _uA(
                                        _cE("view", _uM("class" to "weapp-tw-border up-form-item__body__left__content"), _uA(
                                            if (isTrue(_ctx.required)) {
                                                _cE("text", _uM("key" to 0, "class" to "weapp-tw-border up-form-item__body__left__content__required"), "*")
                                            } else {
                                                _cC("v-if", true)
                                            },
                                            if (_ctx.leftIcon != "") {
                                                _cE("view", _uM("key" to 1, "class" to "weapp-tw-border up-form-item__body__left__content__icon"), _uA(
                                            ...
                                            _cE("view", _uM("class" to "weapp-tw-border up-form-item__body__left__content__label", "style" to _nS(labelAlignStyle.value)), _uA(
                                                _cE("text", _uM("class" to "weapp-tw-border up-form-item__body__left__content__label__text", "style" to _nS(labelCustomStyle.value)), _tD(_ctx.label), 5)
                                            ), 4)
                                        ))
                                    ), 4)
                                } else {
                        ...
                        _cE("view", _uM("class" to "weapp-tw-border up-form-item__body__right"), _uA(
                            _cE("view", _uM("class" to "weapp-tw-border up-form-item__body__right__content"), _uA(
                                _cE("view", _uM("class" to "weapp-tw-border up-form-item__body__right__content__slot"), _uA(
                                    renderSlot(_ctx.`$slots`, "default")
                                )),
                                if (_ctx.`$slots`["right"] != null) {
                                    _cE("view", _uM("key" to 0, "class" to "weapp-tw-border item__body__right__content__icon"), _uA(
                    ...
                    renderSlot(_ctx.`$slots`, "error", _uO(), fun(): UTSArray<Any> {
                        return _uA(
                            if (isTrue(isErrorMessage.value)) {
                                _cE("text", _uM("key" to 0, "class" to "weapp-tw-border up-form-item__body__right__message", "style" to _nS(messageStyle.value)), _tD(message.value), 5)
                            } else {
                                _cC("v-if", true)
                            }
                        )
                    ...
                    if (isTrue(_ctx.borderBottom)) {
                        _cV(_component_up_line, _uM("key" to 0, "color" to lineColor.value, "customStyle" to lineStyle.value), null, 8, _uA(
                            "color",
                            "customStyle"
                        ))
                    } else {
