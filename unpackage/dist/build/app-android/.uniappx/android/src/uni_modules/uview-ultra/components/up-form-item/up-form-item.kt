...
open class GenUniModulesUviewUltraComponentsUpFormItemUpFormItem : VueComponent {
    ...
    companion object {
        ...
        var props = _nP(_uM("customStyle" to _uM("type" to _uA(
            "Object",
            "String"
        ), "default" to _uO()), "customClass" to _uM("type" to "String", "default" to ""), "url" to _uM("type" to "String", "default" to ""), "linkType" to _uM("type" to "String", "default" to "navigateTo"), "label" to _uM("type" to "String", "default" to default__42.getString("formItem.label")), "prop" to _uM("type" to "String", "default" to default__42.getString("formItem.prop")), "rules" to _uM("type" to _uA(
            "UTSJSONObject",
            "Array"
        ), "default" to default__42.getAny("formItem.rules") as UTSJSONObject), "borderBottom" to _uM("type" to _uA(
            "String",
            "Boolean"
        ), "default" to default__42.getString("formItem.borderBottom")), "labelPosition" to _uM("type" to "String", "default" to default__42.getString("formItem.labelPosition")), "labelWidth" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to default__42.getString("formItem.labelWidth")), "rightIcon" to _uM("type" to "String", "default" to default__42.getString("formItem.rightIcon")), "leftIcon" to _uM("type" to "String", "default" to default__42.getString("formItem.leftIcon")), "required" to _uM("type" to "Boolean", "default" to default__42.getBoolean("formItem.required")), "leftIconStyle" to _uM("type" to _uA(
            "String",
            "UTSJSONObject"
        ), "default" to default__42.getString("formItem.leftIconStyle"))))
