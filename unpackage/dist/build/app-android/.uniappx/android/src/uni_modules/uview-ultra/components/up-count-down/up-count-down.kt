...
open class GenUniModulesUviewUltraComponentsUpCountDownUpCountDown : VueComponent {
    ...
    companion object {
        ...
        var setup: (__props: GenUniModulesUviewUltraComponentsUpCountDownUpCountDown, __setupCtx: SetupContext) -> Any? = fun(__props, __setupCtx): Any? {
            ...
            return fun(): Any? {
                return _cE("view", _uM("class" to "weapp-tw-border up-count-down"), _uA(
                    renderSlot(_ctx.`$slots`, "default", _uO(), fun(): UTSArray<Any> {
                        return _uA(
                            _cE("text", _uM("class" to "weapp-tw-border up-count-down__text"), _tD(formattedTime.value), 1)
                        )
                    }
                    )
                ))
        ...
        var props = _nP(_uM("customStyle" to _uM("type" to _uA(
            ...
            "String",
            "Number"
        ), "default" to 0), "format" to _uM("type" to "String", "default" to "HH:mm:ss"), "autoStart" to _uM("type" to "Boolean", "default" to true), "millisecond" to _uM("type" to "Boolean", "default" to false)))
