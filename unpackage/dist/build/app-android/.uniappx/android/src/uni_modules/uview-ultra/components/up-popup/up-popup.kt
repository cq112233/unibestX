...
open class GenUniModulesUviewUltraComponentsUpPopupUpPopup : VueComponent {
    ...
    companion object {
        ...
        var props = _nP(_uM("customStyle" to _uM("type" to _uA(
            "Object",
            "String"
        ), "default" to _uO()), "customClass" to _uM("type" to "String", "default" to ""), "url" to _uM("type" to "String", "default" to ""), "linkType" to _uM("type" to "String", "default" to "navigateTo"), "show" to _uM("type" to "Boolean", "default" to crtProp__12["show"]), "overlay" to _uM("type" to "Boolean", "default" to crtProp__12["overlay"]), "mode" to _uM("type" to "String", "default" to crtProp__12["mode"]), "duration" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to crtProp__12["duration"]), "closeable" to _uM("type" to "Boolean", "default" to crtProp__12["closeable"]), "overlayStyle" to _uM("type" to _uA(
            "Object",
            "String"
        ), "default" to crtProp__12["overlayStyle"]), "closeOnClickOverlay" to _uM("type" to "Boolean", "default" to crtProp__12["closeOnClickOverlay"]), "zIndex" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to crtProp__12["zIndex"]), "safeAreaInsetBottom" to _uM("type" to "Boolean", "default" to crtProp__12["safeAreaInsetBottom"]), "safeAreaInsetTop" to _uM("type" to "Boolean", "default" to crtProp__12["safeAreaInsetTop"]), "closeIconPos" to _uM("type" to "String", "default" to crtProp__12["closeIconPos"]), "round" to _uM("type" to _uA(
            "Boolean",
            "String",
            "Number"
        ), "default" to crtProp__12["round"]), "zoom" to _uM("type" to "Boolean", "default" to crtProp__12["zoom"]), "bgColor" to _uM("type" to "String", "default" to crtProp__12["bgColor"]), "overlayOpacity" to _uM("type" to _uA(
            "Number",
            "String"
        ), "default" to crtProp__12["overlayOpacity"]), "pageInline" to _uM("type" to "Boolean", "default" to crtProp__12["pageInline"])))
