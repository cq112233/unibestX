...
open class GenUniModulesUviewUltraComponentsUpStepsItemUpStepsItem : VueComponent {
    ...
    companion object {
        ...
        var props = _nP(_uM("customStyle" to _uM("type" to _uA(
            ...
            "String",
            "Number"
        ), "default" to crtProp__6["title"]), "desc" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to crtProp__6["desc"]), "iconSize" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to crtProp__6["iconSize"]), "error" to _uM("type" to "Boolean", "default" to crtProp__6["error"]), "itemStyle" to _uM("type" to _uA(
            "UTSJSONObject"
        ), "default" to _uO())))
