...
open class GenUniModulesUviewUltraComponentsUpRadioUpRadio : VueComponent {
    ...
    companion object {
        ...
        var props = _nP(_uM("customStyle" to _uM("type" to _uA(
            ...
            "Number",
            "Boolean"
        ), "default" to crtProp__8["name"]), "shape" to _uM("type" to "String", "default" to crtProp__8["shape"]), "disabled" to _uM("type" to _uA(
            "String",
            "Boolean"
        ), "default" to crtProp__8["disabled"]), "labelDisabled" to _uM("type" to _uA(
            "String",
            "Boolean"
        ), "default" to crtProp__8["labelDisabled"]), "activeColor" to _uM("type" to "String", "default" to crtProp__8["activeColor"]), "inactiveColor" to _uM("type" to "String", "default" to crtProp__8["inactiveColor"]), "iconSize" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to crtProp__8["iconSize"]), "labelSize" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to crtProp__8["labelSize"]), "label" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to crtProp__8["label"]), "size" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to crtProp__8["size"]), "color" to _uM("type" to "String", "default" to crtProp__8["color"]), "labelColor" to _uM("type" to "String", "default" to crtProp__8["labelColor"]), "iconColor" to _uM("type" to "String", "default" to crtProp__8["iconColor"])))
