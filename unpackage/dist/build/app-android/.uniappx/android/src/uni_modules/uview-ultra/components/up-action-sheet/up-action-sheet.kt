        ...
        var setup: (__props: GenUniModulesUviewUltraComponentsUpActionSheetUpActionSheet) -> Any? = fun(__props): Any? {
            ...
            return fun(): Any? {
                ...
                return _cV(_component_up_popup, _uM("show" to _ctx.show, "mode" to "bottom", "onClose" to closeHandler, "safeAreaInsetBottom" to _ctx.safeAreaInsetBottom, "round" to _ctx.round), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                    return _uA(
                        _cE("view", _uM("class" to "weapp-tw-border up-action-sheet"), _uA(
                            if (isTrue(_ctx.title)) {
                                _cE("view", _uM("key" to 0, "class" to "weapp-tw-border up-action-sheet__header"), _uA(
                                    _cE("text", _uM("class" to "weapp-tw-border up-action-sheet__header__title up-line-1"), _tD(_ctx.title), 1),
                                    _cE("view", _uM("class" to "weapp-tw-border up-action-sheet__header__icon-wrap", "onClick" to withModifiers(cancel, _uA(
                                        "stop"
                                    ))), _uA(
                            ...
                            if (isTrue(_ctx.description)) {
                                _cE("text", _uM("key" to 1, "class" to "weapp-tw-border up-action-sheet__description", "style" to _nS(_uA(
                            ...
                            renderSlot(_ctx.`$slots`, "default", _uO(), fun(): UTSArray<Any> {
                                return _uA(
                                    ...
                                    ,
                                    _cE("scroll-view", _uM("direction" to "vertical", "class" to "up-action-sheet__item-wrap", "style" to _nS(_uM("maxHeight" to _ctx.wrapMaxHeight))), _uA(
                                        _cE(Fragment, null, RenderHelpers.renderList(_ctx.actions, fun(item, index, __index, _cached): Any {
                                            return _cE("view", _uM("class" to "weapp-tw-border", "key" to index), _uA(
                                                _cE("view", _uM("class" to "weapp-tw-border up-action-sheet__item-wrap__item", "onClick" to withModifiers(fun(){
                                                    selectHandler(index)
                                                }
                                                , _uA(
                                                    "stop"
                                                ...
                                                , "hover-stay-time" to 150), _uA(
                                                    if (isTrue(item["loading"])) {
                                                        ...
                                                        _cE(Fragment, _uM("key" to 1), _uA(
                                                            _cE("text", _uM("class" to "weapp-tw-border up-action-sheet__item-wrap__item__name", "style" to _nS(_uA(
                                                                itemStyle.value(index)
                                                            ))), _tD(item["name"]), 5),
                                                            if (item["subname"] != "") {
                                                                _cE("text", _uM("key" to 0, "class" to "weapp-tw-border up-action-sheet__item-wrap__item__subname"), _tD(item["subname"]), 1)
                                                            } else {
                                                                _cC("v-if", true)
                                                            }
                                                        ), 64)
                            ...
                            ,
                            if (isTrue(_ctx.cancelText)) {
                                _cE("view", _uM("key" to 3, "class" to "weapp-tw-border up-action-sheet__item-wrap__item up-action-sheet__cancel", "hover-class" to "up-action-sheet--hover", "onClick" to cancel), _uA(
                                    _cE("text", _uM("onTouchmove" to withModifiers(fun(){}, _uA(
                                        "stop"
                                    )), "hover-stay-time" to 150, "class" to "weapp-tw-border up-action-sheet__cancel-text"), _tD(_ctx.cancelText), 41, _uA(
                                        "onTouchmove"
                                    ))
                                ))
                            } else {
