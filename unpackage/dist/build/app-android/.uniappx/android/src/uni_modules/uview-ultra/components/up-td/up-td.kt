...
open class GenUniModulesUviewUltraComponentsUpTdUpTd : VueComponent {
    ...
    companion object {
        ...
        var setup: (__props: GenUniModulesUviewUltraComponentsUpTdUpTd) -> Any? = fun(__props): Any? {
            ...
            val mergedTdStyle = computed(fun(): UTSJSONObject {
                val custom = addStyle(props.customStyle) as UTSJSONObject
                val td = tdStyle.value
                return deepMerge(td, custom) as UTSJSONObject
            }
            )
            onMounted(fun(){
                ...
                if (parent.value != null) {
                    ...
                    val isBorder = parentProps.getBoolean("border") ?: true
                    if (isBorder) {
            ...
            return fun(): Any? {
                return _cE("view", _uM("class" to _nC(_uA(
                    "weapp-tw-border up-td",
                    _uA(
                        _ctx.customClass
                    )
                )), "style" to _nS(mergedTdStyle.value)), _uA(
                    renderSlot(_ctx.`$slots`, "default", _uO(), fun(): UTSArray<Any> {
                        return _uA(
                            _cE("text", _uM("class" to "weapp-tw-border up-td__text", "style" to _nS(tdTextStyle.value)), _tD((if (_ctx.text != null && _ctx.text != "") {
                                _ctx.text
                            } else {
                                _ctx.label
                            }
        ...
        val styles0: Map<String, Map<String, Map<String, Any>>>
            get() {
                return _uM("weapp-tw-border" to _pS(_uM("borderTopWidth" to 0, "borderRightWidth" to 0, "borderBottomWidth" to 0, "borderLeftWidth" to 0)), "up-td" to _pS(_uM("display" to "flex", "flexDirection" to "column", "flexGrow" to 1, "flexShrink" to 1, "flexBasis" to "0%", "justifyContent" to "center", "alignSelf" to "stretch", "boxSizing" to "border-box", "height" to "100%")), "up-td__text" to _pS(_uM("fontSize" to 14, "color" to "#606266")))
            }
        ...
        ), "customClass" to _uM("type" to "String", "default" to ""), "text" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to ""), "label" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to ""), "width" to _uM("type" to _uA(
            "String"
        ), "default" to "auto"), "textAlign" to _uM("type" to "String", "default" to ""), "fontSize" to _uM("type" to "String", "default" to ""), "borderColor" to _uM("type" to "String", "default" to ""), "color" to _uM("type" to "String", "default" to "")))
