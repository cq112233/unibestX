                ...
                return _cE("view", _uM("mode" to "fade", "show" to show.value, "duration" to if (isTruthy(_ctx.fade)) {
                    ...
                    _cE("view", _uM("class" to "up-image", "onClick" to onClick, "style" to _nS(_uA(
                        ...
                        if (isTrue(if (isTruthy(_ctx.showLoading)) {
                            ...
                            _cE("view", _uM("key" to 0, "class" to "up-image__loading", "style" to _nS(loadingStyle.value)), _uA(
                        ...
                        if (isTrue((if (isTruthy(_ctx.showError)) {
                            ...
                            _cE("view", _uM("key" to 1, "class" to "up-image__error", "style" to _nS(errorStyle.value)), _uA(
