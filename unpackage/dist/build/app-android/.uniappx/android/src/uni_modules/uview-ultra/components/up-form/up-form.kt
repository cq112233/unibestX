...
open class GenUniModulesUviewUltraComponentsUpFormUpForm : VueComponent {
    ...
    companion object {
        ...
        var setup: (__props: GenUniModulesUviewUltraComponentsUpFormUpForm, __setupCtx: SetupContext) -> Any? = fun(__props, __setupCtx): Any? {
            ...
            fun validateField(value: Any, callback: ((errors: UTSArray<UTSJSONObject>) -> Unit)? = null, event: String? = null): UTSPromise<*> {
                return UTSPromise(fun(resolve, reject){
                    ...
                    val modelSnapshot = JSON.parse(JSON.stringify(props.model)) as UTSJSONObject
        ...
        var props = _nP(_uM("customStyle" to _uM("type" to _uA(
            "Object",
            "String"
        ), "default" to _uO()), "customClass" to _uM("type" to "String", "default" to ""), "url" to _uM("type" to "String", "default" to ""), "linkType" to _uM("type" to "String", "default" to "navigateTo"), "model" to _uM("default" to default__54.getArray("form.model")), "rules" to _uM("type" to "Object", "default" to default__54.getArray("form.rules")), "errorType" to _uM("type" to "String", "default" to default__54.getString("form.errorType")), "borderBottom" to _uM("type" to "Boolean", "default" to default__54.getBoolean("form.borderBottom")), "labelPosition" to _uM("type" to "String", "default" to default__54.getString("form.labelPosition")), "labelWidth" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to default__54.getNumber("form.labelWidth")), "labelAlign" to _uM("type" to "String", "default" to default__54.getString("form.labelAlign")), "labelStyle" to _uM("type" to "Object", "default" to default__54.getArray("form.labelStyle"))))
