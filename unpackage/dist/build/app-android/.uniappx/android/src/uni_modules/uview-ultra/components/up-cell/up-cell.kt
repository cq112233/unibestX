...
open class GenUniModulesUviewUltraComponentsUpCellUpCell : VueComponent {
    ...
    companion object {
        ...
        var props = _nP(_uM("customStyle" to _uM("type" to _uA(
            "Object",
            "String"
        ), "default" to _uO()), "customClass" to _uM("type" to "String", "default" to ""), "title" to _uM("type" to "String", "default" to default__22.getString("cell.title")), "label" to _uM("type" to "String", "default" to default__22.getString("cell.label")), "value" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to default__22.getString("cell.value")), "icon" to _uM("type" to "String", "default" to default__22.getString("cell.icon")), "iconStyle" to _uM("type" to _uA(
            "String",
            "Object"
        ), "default" to default__22.getAny("cell.iconStyle")), "rightIcon" to _uM("type" to "String", "default" to default__22.getString("cell.rightIcon")), "rightIconStyle" to _uM("type" to _uA(
            "String",
            "Object"
        ), "default" to default__22.getAny("cell.rightIconStyle")), "size" to _uM("type" to "String", "default" to default__22.getString("cell.size")), "center" to _uM("type" to "Boolean", "default" to default__22.getBoolean("cell.center")), "url" to _uM("type" to "String", "default" to default__22.getString("cell.url")), "name" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to default__22.getString("cell.name")), "linkType" to _uM("type" to "String", "default" to default__22.getString("cell.linkType")), "clickable" to _uM("type" to "Boolean", "default" to default__22.getBoolean("cell.clickable")), "isLink" to _uM("type" to "Boolean", "default" to default__22.getBoolean("cell.isLink")), "arrowDirection" to _uM("type" to "String", "default" to default__22.getString("cell.arrowDirection")), "border" to _uM("type" to "Boolean", "default" to default__22.getBoolean("cell.border")), "disabled" to _uM("type" to "Boolean", "default" to default__22.getBoolean("cell.disabled")), "titleStyle" to _uM("default" to default__22.getAny("cell.titleStyle"))))
