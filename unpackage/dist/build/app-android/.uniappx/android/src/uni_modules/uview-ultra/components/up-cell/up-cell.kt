...
open class GenUniModulesUviewUltraComponentsUpCellUpCell : VueComponent {
    ...
    companion object {
        ...
        var setup: (__props: GenUniModulesUviewUltraComponentsUpCellUpCell, __setupCtx: SetupContext) -> Any? = fun(__props, __setupCtx): Any? {
            ...
            val customCellStyle = computed(fun(): UTSJSONObject {
            ...
            return fun(): Any? {
                ...
                return _cE("view", _uM("class" to _nC(_uA(
                    "weapp-tw-border up-cell",
                    _uA(
                        _ctx.customClass
                    )
                )), "style" to _nS(customCellStyle.value), "hover-class" to if ((!isTruthy(_ctx.disabled) && (isTruthy(_ctx.clickable) || isTruthy(_ctx.isLink)))) {
                    "up-cell--clickable"
                } else {
                    ""
                }
                , "hover-stay-time" to 250, "onClick" to clickHandler), _uA(
                    _cE("view", _uM("class" to _nC(_uA(
                        "weapp-tw-border up-cell__body",
                        _uM("up-cell--center" to _ctx.center, "up-cell__body--large" to (_ctx.size == "large"))
                    ))), _uA(
                        _cE("view", _uM("class" to "weapp-tw-border up-cell__body__content"), _uA(
                            if (isTrue(_ctx.`$slots`["icon"] != null || _ctx.icon != "")) {
                                _cE("view", _uM("key" to 0, "class" to "weapp-tw-border up-cell__left-icon-wrap"), _uA(
                            ...
                            ,
                            _cE("view", _uM("class" to "weapp-tw-border up-cell__title"), _uA(
                                if (isTrue(_ctx.`$slots`["title"] != null && _ctx.title == "")) {
                                    renderSlot(_ctx.`$slots`, "title", _uM("key" to 0))
                                } else {
                                    _cE("text", _uM("key" to 1, "class" to _nC(_uA(
                                        "weapp-tw-border up-cell__title-text",
                                        _uM("up-cell--disabled" to _ctx.disabled, "up-cell__title-text--large" to (_ctx.size == "large"))
                                    )), "style" to _nS(titleTextStyle.value)), _tD(_ctx.title), 7)
                                }
                                ,
                                    ...
                                    return _uA(
                                        if (_ctx.label != "") {
                                            _cE("text", _uM("key" to 0, "class" to _nC(_uA(
                                                "weapp-tw-border up-cell__label",
                                                _uM("up-cell--disabled" to _ctx.disabled, "up-cell__label--large" to (_ctx.size == "large"))
                                            ))), _tD(_ctx.label), 3)
                                        } else {
                                            _cC("v-if", true)
                                        }
                        ...
                        renderSlot(_ctx.`$slots`, "value", _uO(), fun(): UTSArray<Any> {
                            return _uA(
                                if (testEmpty(_ctx.value) == false) {
                                    _cE("text", _uM("key" to 0, "class" to _nC(_uA(
                                        "weapp-tw-border up-cell__value",
                                        _uM("up-cell--disabled" to _ctx.disabled, "up-cell__value--large" to (_ctx.size == "large"))
                                    ))), _tD(_ctx.value), 3)
                                } else {
                                    _cC("v-if", true)
                                }
                        ...
                        if (isTrue(_ctx.`$slots`["right-icon"] != null || _ctx.isLink)) {
                            _cE("view", _uM("key" to 0, "class" to _nC(_uA(
                                "weapp-tw-border up-cell__right-icon-wrap",
                                _uA(
        ...
        ), "customClass" to _uM("type" to "String", "default" to ""), "title" to _uM("type" to "String", "default" to default__28.getString("cell.title")), "label" to _uM("type" to "String", "default" to default__28.getString("cell.label")), "value" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to default__28.getString("cell.value")), "icon" to _uM("type" to "String", "default" to default__28.getString("cell.icon")), "iconStyle" to _uM("type" to _uA(
            "String",
            "Object"
        ), "default" to default__28.getAny("cell.iconStyle")), "rightIcon" to _uM("type" to "String", "default" to default__28.getString("cell.rightIcon")), "rightIconStyle" to _uM("type" to _uA(
            "String",
            "Object"
        ), "default" to default__28.getAny("cell.rightIconStyle")), "size" to _uM("type" to "String", "default" to default__28.getString("cell.size")), "center" to _uM("type" to "Boolean", "default" to default__28.getBoolean("cell.center")), "url" to _uM("type" to "String", "default" to default__28.getString("cell.url")), "name" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to default__28.getString("cell.name")), "linkType" to _uM("type" to "String", "default" to default__28.getString("cell.linkType")), "clickable" to _uM("type" to "Boolean", "default" to default__28.getBoolean("cell.clickable")), "isLink" to _uM("type" to "Boolean", "default" to default__28.getBoolean("cell.isLink")), "arrowDirection" to _uM("type" to "String", "default" to default__28.getString("cell.arrowDirection")), "border" to _uM("type" to "Boolean", "default" to default__28.getBoolean("cell.border")), "disabled" to _uM("type" to "Boolean", "default" to default__28.getBoolean("cell.disabled")), "titleStyle" to _uM("default" to default__28.getAny("cell.titleStyle"))))
