...
open class GenUniModulesUviewUltraComponentsUpDatetimePickerUpDatetimePicker : VueComponent {
    ...
    companion object {
        ...
        var props = _nP(_uM("customStyle" to _uM("type" to _uA(
            "Object",
            "String"
        ), "default" to _uO()), "customClass" to _uM("type" to "String", "default" to ""), "url" to _uM("type" to "String", "default" to ""), "linkType" to _uM("type" to "String", "default" to "navigateTo"), "hasInput" to _uM("type" to "Boolean", "default" to default__58.getBoolean("datetimePicker.hasInput")), "placeholder" to _uM("type" to "String", "default" to default__58.getString("datetimePicker.placeholder")), "format" to _uM("type" to "String", "default" to default__58.getString("datetimePicker.format")), "show" to _uM("type" to "Boolean", "default" to default__58.getBoolean("datetimePicker.show")), "pageInline" to _uM("type" to "Boolean", "default" to default__58.getBoolean("datetimePicker.pageInline")), "popupMode" to _uM("type" to "String", "default" to default__58.getString("datetimePicker.popupMode")), "showToolbar" to _uM("type" to "Boolean", "default" to default__58.getBoolean("datetimePicker.showToolbar")), "toolbarRightSlot" to _uM("type" to "Boolean", "default" to default__58.getBoolean("datetimePicker.toolbarRightSlot")), "modelValue" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to default__58.getString("datetimePicker.value")), "title" to _uM("type" to "String", "default" to default__58.getString("datetimePicker.title")), "mode" to _uM("type" to "String", "default" to default__58.getString("datetimePicker.mode")), "maxDate" to _uM("type" to "Number", "default" to default__58.getNumber("datetimePicker.maxDate")), "minDate" to _uM("type" to "Number", "default" to default__58.getNumber("datetimePicker.minDate")), "minHour" to _uM("type" to "Number", "default" to default__58.getNumber("datetimePicker.minHour")), "maxHour" to _uM("type" to "Number", "default" to default__58.getNumber("datetimePicker.maxHour")), "minMinute" to _uM("type" to "Number", "default" to default__58.getNumber("datetimePicker.minMinute")), "maxMinute" to _uM("type" to "Number", "default" to default__58.getNumber("datetimePicker.maxMinute")), "minSecond" to _uM("type" to "Number", "default" to default__58.getNumber("datetimePicker.minSecond")), "maxSecond" to _uM("type" to "Number", "default" to default__58.getNumber("datetimePicker.maxSecond")), "filter" to _uM("default" to null), "formatter" to _uM("default" to null), "loading" to _uM("type" to "Boolean", "default" to default__58.getBoolean("datetimePicker.loading")), "itemHeight" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to default__58.getNumber("datetimePicker.itemHeight")), "cancelText" to _uM("type" to "String", "default" to default__58.getString("datetimePicker.cancelText")), "confirmText" to _uM("type" to "String", "default" to default__58.getString("datetimePicker.confirmText")), "cancelColor" to _uM("type" to "String", "default" to default__58.getString("datetimePicker.cancelColor")), "confirmColor" to _uM("type" to "String", "default" to default__58.getString("datetimePicker.confirmColor")), "visibleItemCount" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to default__58.getNumber("datetimePicker.visibleItemCount")), "closeOnClickOverlay" to _uM("type" to "Boolean", "default" to default__58.getBoolean("datetimePicker.closeOnClickOverlay")), "defaultIndex" to _uM("type" to "Array", "default" to fun(): UTSArray<Number> {
            return default__58.getArray<Number>("datetimePicker.defaultIndex")!!
        }
        )))
