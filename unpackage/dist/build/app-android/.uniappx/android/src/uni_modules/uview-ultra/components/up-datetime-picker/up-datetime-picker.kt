...
open class GenUniModulesUviewUltraComponentsUpDatetimePickerUpDatetimePicker : VueComponent {
    ...
    companion object {
        ...
        var setup: (__props: GenUniModulesUviewUltraComponentsUpDatetimePickerUpDatetimePicker) -> Any? = fun(__props): Any? {
            ...
            fun gen_updateIndexs_fn(value: Any) {
                ...
                if (props.mode === "time" || props.mode === "timesecond") {
                    ...
                    val hourVal = if (timeArr.length > 0) {
                        timeArr[0]
                    } else {
                        "00"
                    }
                    val minuteVal = if (timeArr.length > 1) {
                        timeArr[1]
                    } else {
                        "00"
                    }
                    val secondVal = if (timeArr.length > 2) {
                        timeArr[2]
                    } else {
                        "00"
                    }
                    values = _uA(
                        formatterFunc("hour", hourVal),
                        formatterFunc("minute", minuteVal)
                    )
                    if (props.mode === "timesecond") {
                        values.push(formatterFunc("second", secondVal))
                    }
                } else {
                    val date = if (UTSAndroid.`typeof`(value) === "number") {
                        Date(value as Number)
                    } else {
                        Date(value.toString())
                    }
                    val validDate = if (isNaN(date.getTime())) {
                        Date()
                    } else {
                        date
                    }
                ...
                columns.value.forEach(fun(column: UTSArray<String>, index: Number){
                    val targetVal = if (index < values.length) {
                        values[index]
                    } else {
                        ""
                    }
            ...
            fun correctValue(kVal: Any?): Any {
                ...
                if (!isDateMode) {
                    ...
                    var hour = if (timeArr.length > 0) {
                        timeArr[0]
                    } else {
                        "00"
                    }
                    var minute = if (timeArr.length > 1) {
                        timeArr[1]
                    } else {
                        "00"
                    }
                    var second = if (timeArr.length > 2) {
                        timeArr[2]
                    } else {
                        "00"
                    }
            ...
            fun gen_change_fn(e: UTSJSONObject) {
                ...
                var selectValue: Any = ""
                if (props.mode === "time" || props.mode === "timesecond") {
                    val idx0 = if (indexs.length > 0) {
                        indexs[0]
                    } else {
                        0
                    }
                    val idx1 = if (indexs.length > 1) {
                        indexs[1]
                    } else {
                        0
                    }
                    val idx2 = if (indexs.length > 2) {
                        indexs[2]
                    } else {
                        0
                    }
                    val hourText = safeColumnValue(values, 0, idx0, padZero(props.minHour))
                    val minuteText = safeColumnValue(values, 1, idx1, padZero(props.minMinute))
                    val secondText = safeColumnValue(values, 2, idx2, padZero(props.minSecond))
                    ...
                    val yearText = safeColumnValue(values, 0, idx0, currentYear.toString(10))
                    val monthText = safeColumnValue(values, 1, idx1, padZero(currentMonth))
                    ...
                    val dayText = safeColumnValue(values, 2, idx2, padZero(Math.min(currentDate, maxDate)))
                    ...
                    if (props.mode === "datehour" || props.mode === "datetime" || props.mode === "datetimesecond") {
                        val idx3 = if (indexs.length > 3) {
                            indexs[3]
                        } else {
                            0
                        }
                        val hourText = safeColumnValue(values, 3, idx3, padZero(currentHour))
                        hour = range(0, 23, toInt(intercept(hourText), currentHour))
                    }
                    if (props.mode === "datetime" || props.mode === "datetimesecond") {
                        val idx4 = if (indexs.length > 4) {
                            indexs[4]
                        } else {
                            0
                        }
                        val minuteText = safeColumnValue(values, 4, idx4, padZero(currentMinute))
                        minute = range(0, 59, toInt(intercept(minuteText), currentMinute))
                    }
                    if (props.mode === "datetimesecond") {
                        val idx5 = if (indexs.length > 5) {
                            indexs[5]
                        } else {
                            0
                        }
                        val secondText = safeColumnValue(values, 5, idx5, padZero(currentSecond))
            ...
            return fun(): Any? {
                ...
                return _cE("view", _uM("class" to "weapp-tw-border up-datetime-picker"), _uA(
                    if (isTrue(_ctx.hasInput)) {
                        _cE("view", _uM("key" to 0, "class" to "weapp-tw-border up-datetime-picker__has-input", "onClick" to changeShow), _uA(
        ...
        var props = _nP(_uM("customStyle" to _uM("type" to _uA(
            "Object",
            "String"
        ), "default" to _uO()), "customClass" to _uM("type" to "String", "default" to ""), "url" to _uM("type" to "String", "default" to ""), "linkType" to _uM("type" to "String", "default" to "navigateTo"), "hasInput" to _uM("type" to "Boolean", "default" to default__33.getBoolean("datetimePicker.hasInput")), "placeholder" to _uM("type" to "String", "default" to default__33.getString("datetimePicker.placeholder")), "format" to _uM("type" to "String", "default" to default__33.getString("datetimePicker.format")), "show" to _uM("type" to "Boolean", "default" to default__33.getBoolean("datetimePicker.show")), "pageInline" to _uM("type" to "Boolean", "default" to default__33.getBoolean("datetimePicker.pageInline")), "popupMode" to _uM("type" to "String", "default" to default__33.getString("datetimePicker.popupMode")), "showToolbar" to _uM("type" to "Boolean", "default" to default__33.getBoolean("datetimePicker.showToolbar")), "toolbarRightSlot" to _uM("type" to "Boolean", "default" to default__33.getBoolean("datetimePicker.toolbarRightSlot")), "modelValue" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to default__33.getString("datetimePicker.value")), "title" to _uM("type" to "String", "default" to default__33.getString("datetimePicker.title")), "mode" to _uM("type" to "String", "default" to default__33.getString("datetimePicker.mode")), "maxDate" to _uM("type" to "Number", "default" to default__33.getNumber("datetimePicker.maxDate")), "minDate" to _uM("type" to "Number", "default" to default__33.getNumber("datetimePicker.minDate")), "minHour" to _uM("type" to "Number", "default" to default__33.getNumber("datetimePicker.minHour")), "maxHour" to _uM("type" to "Number", "default" to default__33.getNumber("datetimePicker.maxHour")), "minMinute" to _uM("type" to "Number", "default" to default__33.getNumber("datetimePicker.minMinute")), "maxMinute" to _uM("type" to "Number", "default" to default__33.getNumber("datetimePicker.maxMinute")), "minSecond" to _uM("type" to "Number", "default" to default__33.getNumber("datetimePicker.minSecond")), "maxSecond" to _uM("type" to "Number", "default" to default__33.getNumber("datetimePicker.maxSecond")), "filter" to _uM("default" to null), "formatter" to _uM("default" to null), "loading" to _uM("type" to "Boolean", "default" to default__33.getBoolean("datetimePicker.loading")), "itemHeight" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to default__33.getNumber("datetimePicker.itemHeight")), "cancelText" to _uM("type" to "String", "default" to default__33.getString("datetimePicker.cancelText")), "confirmText" to _uM("type" to "String", "default" to default__33.getString("datetimePicker.confirmText")), "cancelColor" to _uM("type" to "String", "default" to default__33.getString("datetimePicker.cancelColor")), "confirmColor" to _uM("type" to "String", "default" to default__33.getString("datetimePicker.confirmColor")), "visibleItemCount" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to default__33.getNumber("datetimePicker.visibleItemCount")), "closeOnClickOverlay" to _uM("type" to "Boolean", "default" to default__33.getBoolean("datetimePicker.closeOnClickOverlay")), "defaultIndex" to _uM("type" to "Array", "default" to fun(): UTSArray<Number> {
            return default__33.getArray<Number>("datetimePicker.defaultIndex")!!
        }
        )))
