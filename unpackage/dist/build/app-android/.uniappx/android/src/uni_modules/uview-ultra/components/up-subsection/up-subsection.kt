...
open class GenUniModulesUviewUltraComponentsUpSubsectionUpSubsection : VueComponent {
    ...
    companion object {
        ...
        var props = _nP(_uM("customStyle" to _uM("type" to _uA(
            "Object",
            "String"
        ), "default" to _uO()), "customClass" to _uM("type" to "String", "default" to ""), "url" to _uM("type" to "String", "default" to ""), "linkType" to _uM("type" to "String", "default" to "navigateTo"), "list" to _uM("type" to "Array", "default" to crtProp__25["list"]), "current" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to crtProp__25["current"]), "activeColor" to _uM("type" to "String", "default" to crtProp__25["activeColor"]), "inactiveColor" to _uM("type" to "String", "default" to crtProp__25["inactiveColor"]), "mode" to _uM("type" to "String", "default" to crtProp__25["mode"]), "fontSize" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to crtProp__25["fontSize"]), "bold" to _uM("type" to "Boolean", "default" to crtProp__25["bold"]), "bgColor" to _uM("type" to "String", "default" to crtProp__25["bgColor"]), "keyName" to _uM("type" to "String", "default" to crtProp__25["keyName"]), "activeColorKeyName" to _uM("type" to "String", "default" to crtProp__25["activeColorKeyName"]), "inactiveColorKeyName" to _uM("type" to "String", "default" to crtProp__25["inactiveColorKeyName"]), "disabled" to _uM("type" to "Boolean", "default" to crtProp__25["disabled"])))
