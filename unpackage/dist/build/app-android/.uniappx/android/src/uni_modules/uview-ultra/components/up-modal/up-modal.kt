...
open class GenUniModulesUviewUltraComponentsUpModalUpModal : VueComponent {
                            ...
                            _cE("view", _uM("class" to "up-modal__button-group", "style" to _nS(_uM("flexDirection" to if (isTruthy(_ctx.buttonReverse)) {
                                ...
                                if (isTrue(_ctx.showCancelButton)) {
                                    _cE("view", _uM("key" to 0, "class" to _nC(_uA(
                                        ...
                                        _cE("text", _uM("class" to "up-modal__button-group__wrapper__text", "style" to _nS(_uM("color" to _ctx.cancelColor))), _tD(_ctx.elCancelText), 5)
                                    ), 10, _uA(
                                        "onClick"
                                    ))
                                } else {
                                ...
                                if (isTrue(_ctx.showConfirmButton)) {
                                    _cE("view", _uM("key" to 2, "class" to _nC(_uA(
                                        ...
                                        if (isTrue(_ctx.loading)) {
                                            ...
                                            _cE("text", _uM("key" to 1, "class" to "up-modal__button-group__wrapper__text", "style" to _nS(_uM("color" to _ctx.confirmColor))), _tD(_ctx.elConfirmText), 5)
                                        }
                                    ), 10, _uA(
                                        "onClick"
                                    ))
    ...
    open var elCancelText: String by `$data`
    open var elConfirmText: String by `$data`
    open var contentStyleCpu: UTSJSONObject by `$data`
    @Suppress("USELESS_CAST")
    override fun data(): Map<String, Any?> {
        return _uM("parent" to null as ComponentPublicInstance?, "parentData" to _uO(), "children" to _uA<ComponentPublicInstance>(), "childrenRefs" to _uA<String>(), "loading" to false, "elCancelText" to computed<String>(fun(): String {
            if (this.cancelText == "取消" || this.cancelText == "") {
                return t("up_common_cancel", _uO())
            }
            return this.cancelText
        }
        ), "elConfirmText" to computed<String>(fun(): String {
            if (this.confirmText == "确认" || this.confirmText == "确定" || this.confirmText == "") {
                return t("up_common_confirm", _uO())
            }
            return this.confirmText
        }
        ), "contentStyleCpu" to computed<UTSJSONObject>(fun(): UTSJSONObject {
    ...
    companion object {
        ...
        var props = _nP(_uM("customStyle" to _uM("type" to _uA(
            "Object",
            "String"
        ), "default" to _uO()), "customClass" to _uM("type" to "String", "default" to ""), "url" to _uM("type" to "String", "default" to ""), "linkType" to _uM("type" to "String", "default" to "navigateTo"), "show" to _uM("type" to "Boolean", "default" to crtProp__20["show"]), "title" to _uM("type" to "String", "default" to crtProp__20["title"]), "content" to _uM("type" to "String", "default" to crtProp__20["content"]), "confirmText" to _uM("type" to "String", "default" to crtProp__20["confirmText"]), "cancelText" to _uM("type" to "String", "default" to crtProp__20["cancelText"]), "showConfirmButton" to _uM("type" to "Boolean", "default" to crtProp__20["showConfirmButton"]), "showCancelButton" to _uM("type" to "Boolean", "default" to crtProp__20["showCancelButton"]), "confirmColor" to _uM("type" to "String", "default" to crtProp__20["confirmColor"]), "cancelColor" to _uM("type" to "String", "default" to crtProp__20["cancelColor"]), "buttonReverse" to _uM("type" to "Boolean", "default" to crtProp__20["buttonReverse"]), "zoom" to _uM("type" to "Boolean", "default" to crtProp__20["zoom"]), "asyncClose" to _uM("type" to "Boolean", "default" to crtProp__20["asyncClose"]), "closeOnClickOverlay" to _uM("type" to "Boolean", "default" to crtProp__20["closeOnClickOverlay"]), "negativeTop" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to crtProp__20["negativeTop"]), "width" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to crtProp__20["width"]), "confirmButtonShape" to _uM("type" to "String", "default" to crtProp__20["confirmButtonShape"]), "duration" to _uM("type" to "Number", "default" to crtProp__20["duration"]), "contentTextAlign" to _uM("type" to "String", "default" to crtProp__20["contentTextAlign"]), "asyncCloseTip" to _uM("type" to "String", "default" to crtProp__20["asyncCloseTip"]), "asyncCancelClose" to _uM("type" to "Boolean", "default" to crtProp__20["asyncCancelClose"]), "contentStyle" to _uM("default" to crtProp__20["contentStyle"])))
