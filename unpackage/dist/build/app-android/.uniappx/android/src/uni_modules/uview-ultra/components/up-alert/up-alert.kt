...
open class GenUniModulesUviewUltraComponentsUpAlertUpAlert : VueComponent {
    ...
    companion object {
        ...
        var setup: (__props: GenUniModulesUviewUltraComponentsUpAlertUpAlert) -> Any? = fun(__props): Any? {
            ...
            val show = ref(true)
            val alertStyle = computed(fun(): UTSJSONObject {
                ...
                return _cV(_component_up_transition, _uM("mode" to "fade", "show" to show.value), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                    return _uA(
                        _cE("view", _uM("class" to _nC(_uA(
                            "weapp-tw-border up-alert",
                            _uA(
                                "up-alert--" + _ctx.type + "--" + _ctx.effect
                            )
                        )), "onClick" to withModifiers(clickHandler, _uA(
                            "stop"
                        )), "style" to _nS(alertStyle.value)), _uA(
                            if (isTrue(_ctx.showIcon)) {
                                _cE("view", _uM("key" to 0, "class" to "weapp-tw-border up-alert__icon"), _uA(
                            ...
                            ,
                            _cE("view", _uM("class" to "weapp-tw-border up-alert__content", "style" to _nS(_uM("paddingRight" to if (_ctx.closable) {
                                "20px"
                            } else {
                                "0px"
                            }
                                ...
                                if (isTrue(_ctx.title)) {
                                    _cE("text", _uM("key" to 0, "class" to _nC(_uA(
                                        "weapp-tw-border up-alert__content__title",
                                        _uA(
                                            if (_ctx.effect === "dark") {
                                                "up-alert__text--dark"
                                            } else {
                                    ...
                                    )), "style" to _nS(style1.value)), _tD(_ctx.title), 7)
                                } else {
                                    _cC("v-if", true)
                                }
                                ,
                                if (isTrue(_ctx.description)) {
                                    _cE("text", _uM("key" to 1, "class" to _nC(_uA(
                                        "weapp-tw-border up-alert__content__desc",
                                        _uA(
                                            if (_ctx.effect === "dark") {
                                                "up-alert__text--dark"
                                            } else {
                                    ...
                                    )), "style" to _nS(style1.value)), _tD(_ctx.description), 7)
                                } else {
                                    _cC("v-if", true)
                                }
                            ), 4),
                            if (isTrue(_ctx.closable)) {
                                _cE("view", _uM("key" to 1, "class" to "weapp-tw-border up-alert__close", "onClick" to withModifiers(closeHandler, _uA(
                                    "stop"
                                ))), _uA(
        ...
        var props = _nP(_uM("customClass" to _uM("type" to "String", "default" to ""), "url" to _uM("type" to "String", "default" to ""), "linkType" to _uM("type" to "String", "default" to "navigateTo"), "type" to _uM("type" to "String", "default" to default__26.getString("alert.type")), "description" to _uM("type" to "String", "default" to default__26.getString("alert.description")), "closable" to _uM("type" to "Boolean", "default" to default__26.getBoolean("alert.closable")), "showIcon" to _uM("type" to "Boolean", "default" to default__26.getBoolean("alert.showIcon")), "effect" to _uM("type" to "String", "default" to default__26.getString("alert.effect")), "center" to _uM("type" to "Boolean", "default" to default__26.getBoolean("alert.center")), "fontSize" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to default__26.getNumber("alert.fontSize")), "customStyle" to _uM("default" to fun(): UTSJSONObject {
            return (_uO())
        }
        ), "title" to _uM("type" to "String", "default" to default__26.getString("alert.title", ""))))
