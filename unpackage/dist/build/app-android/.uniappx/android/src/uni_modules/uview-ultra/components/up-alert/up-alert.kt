...
open class GenUniModulesUviewUltraComponentsUpAlertUpAlert : VueComponent {
    ...
    companion object {
        ...
        var props = _nP(_uM("customClass" to _uM("type" to "String", "default" to ""), "url" to _uM("type" to "String", "default" to ""), "linkType" to _uM("type" to "String", "default" to "navigateTo"), "type" to _uM("type" to "String", "default" to default__65.getString("alert.type")), "description" to _uM("type" to "String", "default" to default__65.getString("alert.description")), "closable" to _uM("type" to "Boolean", "default" to default__65.getBoolean("alert.closable")), "showIcon" to _uM("type" to "Boolean", "default" to default__65.getBoolean("alert.showIcon")), "effect" to _uM("type" to "String", "default" to default__65.getString("alert.effect")), "center" to _uM("type" to "Boolean", "default" to default__65.getBoolean("alert.center")), "fontSize" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to default__65.getNumber("alert.fontSize")), "customStyle" to _uM("default" to fun(): UTSJSONObject {
            return (_uO())
        }
        ), "title" to _uM("type" to "String", "default" to default__65.getString("alert.title", ""))))
