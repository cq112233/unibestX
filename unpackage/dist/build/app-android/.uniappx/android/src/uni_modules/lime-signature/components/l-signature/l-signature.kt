...
open class GenUniModulesLimeSignatureComponentsLSignatureLSignature : VueComponent {
    ...
    companion object {
        ...
        var setup: (__props: GenUniModulesLimeSignatureComponentsLSignatureLSignature, __setupCtx: SetupContext) -> Any? = fun(__props, __setupCtx): Any? {
            ...
            onUnmounted(fun(){})
            return fun(): Any? {
                return _cE("view", _uM("class" to "weapp-tw-border l-signature", "style" to _nS(unref(drawableStyle)), "onTouchstart" to withModifiers(onAppTouchStart, _uA(
                    "stop",
                    "prevent"
                    ...
                    _cE("canvas", _uM("id" to "l-signature-native", "ref_key" to "signatureRef", "ref" to signatureRef, "disable-scroll" to "true", "style" to _nS(_uM("width" to "100%", "height" to "100%")), "onTouchstart" to withModifiers(onAppTouchStart, _uA(
                        "stop",
                        "prevent"
                    )), "onTouchmove" to withModifiers(onAppTouchMove, _uA(
                        "stop",
                    ...
                    if (isTrue(_ctx.landscape)) {
                        _cE("view", _uM("key" to 0, "class" to "weapp-tw-border l-signature-landscape", "ref_key" to "signatureLandscapeRef", "ref" to signatureLandscapeRef, "style" to _nS(_uA(
        ...
        val styles0: Map<String, Map<String, Map<String, Any>>>
            get() {
                return _uM("weapp-tw-border" to _pS(_uM("borderTopWidth" to 0, "borderRightWidth" to 0, "borderBottomWidth" to 0, "borderLeftWidth" to 0)), "l-signature" to _pS(_uM("flexGrow" to 1, "flexShrink" to 1, "flexBasis" to "0%", "width" to "100%", "height" to "100%")), "l-signature__canvas" to _pS(_uM("width" to "100%", "height" to "100%")), "l-signature-landscape" to _pS(_uM("position" to "absolute", "pointerEvents" to "none", "overflow" to "visible", "left" to "99.9%")), "l-signature-image" to _pS(_uM("transformOrigin" to "0% 0%")))
            }
