    ...
    companion object {
        ...
        var setup: (__props: GenUniModulesUviewUltraComponentsUpGridItemUpGridItem, __setupCtx: SetupContext) -> Any? = fun(__props, __setupCtx): Any? {
            ...
            val itemStyle = computed(fun(): UTSJSONObject {
                val style: UTSJSONObject = _uO("background" to props.bgColor)
        ...
        var props = _nP(_uM("customStyle" to _uM("type" to _uA(
            ...
            "String",
            "Number"
        ), "default" to default__39.getArray("grid-item.name")), "bgColor" to _uM("type" to "String", "default" to default__39.getString("grid-item.bgColor"))))
