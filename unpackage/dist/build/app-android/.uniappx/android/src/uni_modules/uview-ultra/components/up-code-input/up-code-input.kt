...
open class GenUniModulesUviewUltraComponentsUpCodeInputUpCodeInput : VueComponent {
    ...
    companion object {
        ...
        var setup: (__props: GenUniModulesUviewUltraComponentsUpCodeInputUpCodeInput) -> Any? = fun(__props): Any? {
            ...
            val codeTextStyle = computed(fun(): UTSJSONObject {
                return _uO("fontSize" to addUnit(props.fontSize), "fontWeight" to if (props.bold) {
                    "bold"
                } else {
                    "normal"
                }
                , "color" to props.color)
            }
            )
            val cursorStyle = computed(fun(): UTSJSONObject {
                return _uO("backgroundColor" to props.color, "opacity" to cursorOpacity.value)
            }
            )
            val inputStyle = computed(fun(): UTSJSONObject {
                return _uO("height" to addUnit(props.size))
            }
            )
            ...
            val itemStyle = fun(index: Number): UTSJSONObject {
                val style: UTSJSONObject = _uO("width" to addUnit(props.size), "height" to addUnit(props.size))
                if (props.mode == "box") {
            ...
            return fun(): Any? {
                return _cE("view", _uM("class" to "weapp-tw-border up-code-input"), _uA(
                    _cE(Fragment, null, RenderHelpers.renderList(codeLength.value, fun(item, index, __index, _cached): Any {
                        return _cE("view", _uM("class" to "weapp-tw-border up-code-input__item", "style" to _nS(itemStyle(index)), "key" to index), _uA(
                            if (isTrue(_ctx.dot && codeArray.value.length > index)) {
                                _cE("view", _uM("key" to 0, "class" to "weapp-tw-border up-code-input__item__dot"))
                            } else {
                                _cE("text", _uM("key" to 1, "class" to "weapp-tw-border", "style" to _nS(codeTextStyle.value)), _tD(getCodeValue(index)), 5)
                            }
                            ,
                            if (_ctx.mode == "line") {
                                _cE("view", _uM("key" to 2, "class" to "weapp-tw-border up-code-input__item__line", "style" to _nS(lineStyle.value)), null, 4)
                            } else {
                                _cC("v-if", true)
                            }
                            ,
                            if (isTrue(isFocus.value && inputLength.value == index)) {
                                _cE("view", _uM("key" to 3, "style" to _nS(cursorStyle.value), "class" to "weapp-tw-border up-code-input__item__cursor"), null, 4)
                            } else {
                                _cC("v-if", true)
                            }
                        ), 4)
                    ...
                    _cE("input", _uM("disabled" to _ctx.disabledKeyboard, "type" to "number", "focus" to _ctx.focus, "value" to inputValue.value, "maxlength" to _ctx.maxlength, "adjustPosition" to _ctx.adjustPosition, "class" to "up-code-input__input", "onInput" to inputHandler, "style" to _nS(inputStyle.value), "onFocus" to fun(){
                        isFocus.value = true
                    }
                    , "onBlur" to fun(){
                        isFocus.value = false
        ...
        ), "customClass" to _uM("type" to "String", "default" to ""), "adjustPosition" to _uM("type" to "Boolean", "default" to default__30.getBoolean("codeInput.adjustPosition")), "maxlength" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to default__30.getNumber("codeInput.maxlength")), "dot" to _uM("type" to "Boolean", "default" to default__30.getBoolean("codeInput.dot")), "mode" to _uM("type" to "String", "default" to default__30.getString("codeInput.mode")), "hairline" to _uM("type" to "Boolean", "default" to default__30.getBoolean("codeInput.hairline")), "space" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to default__30.getNumber("codeInput.space")), "modelValue" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to default__30.getString("codeInput.value")), "focus" to _uM("type" to "Boolean", "default" to default__30.getBoolean("codeInput.focus")), "bold" to _uM("type" to "Boolean", "default" to default__30.getBoolean("codeInput.bold")), "color" to _uM("type" to "String", "default" to default__30.getString("codeInput.color")), "fontSize" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to default__30.getNumber("codeInput.fontSize")), "size" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to default__30.getNumber("codeInput.size")), "disabledKeyboard" to _uM("type" to "Boolean", "default" to default__30.getBoolean("codeInput.disabledKeyboard")), "borderColor" to _uM("type" to "String", "default" to default__30.getString("codeInput.borderColor")), "disabledDot" to _uM("type" to "Boolean", "default" to default__30.getBoolean("codeInput.disabledDot"))))
