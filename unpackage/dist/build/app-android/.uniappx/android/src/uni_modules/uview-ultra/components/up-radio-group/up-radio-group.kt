...
open class GenUniModulesUviewUltraComponentsUpRadioGroupUpRadioGroup : VueComponent {
    ...
    companion object {
        ...
        var setup: (__props: GenUniModulesUviewUltraComponentsUpRadioGroupUpRadioGroup) -> Any? = fun(__props): Any? {
            val __ins = getCurrentInstance()!!
            val _ctx = __ins.proxy as GenUniModulesUviewUltraComponentsUpRadioGroupUpRadioGroup
            val _cache = __ins.renderCache
            val props = __props
            fun emit(event: String, vararg do_not_transform_spread: Any?) {
                __ins.emit(event, *do_not_transform_spread)
            }
            val modelValue = computed<RadioValue>(fun(): RadioValue {
                return props.modelValue
            }
            )
            val select = fun(name: RadioValue){
                if (name == null) {
            ...
            provide(RADIO_GROUP_KEY, RadioGroupProvide(modelValue = modelValue, shape = computed(fun(): String {
                return props.shape
            }
            ...
            val bemClass = computed(fun(): String {
                return uni.UNIB120614.bem("radio-group", _uA(
                    props.placement
                ), _uA())
            }
            )
            ...
            return fun(): Any? {
                return _cE("view", _uM("class" to _nC(_uA(
                    "weapp-tw-border up-radio-group",
                    bemClass.value
        ...
        val styles0: Map<String, Map<String, Map<String, Any>>>
            get() {
                return _uM("weapp-tw-border" to _pS(_uM("borderTopWidth" to 0, "borderRightWidth" to 0, "borderBottomWidth" to 0, "borderLeftWidth" to 0)), "up-radio-group" to _pS(_uM("flexGrow" to 1, "flexShrink" to 1, "flexBasis" to "0%")), "up-radio-group--row" to _pS(_uM("display" to "flex", "flexDirection" to "row", "flexWrap" to "wrap", "alignItems" to "center")), "up-radio-group--column" to _pS(_uM("display" to "flex", "flexDirection" to "column")))
            }
        ...
        var props = _nP(_uM("customStyle" to _uM("type" to _uA(
            "Object",
            "String"
        ), "default" to _uO()), "customClass" to _uM("type" to "String", "default" to ""), "url" to _uM("type" to "String", "default" to ""), "linkType" to _uM("type" to "String", "default" to "navigateTo"), "name" to _uM("type" to "String", "required" to false, "default" to ""), "modelValue" to _uM("type" to _uA(
            "String",
            "Number",
            "Boolean"
        ), "required" to false, "default" to ""), "shape" to _uM("type" to "String", "required" to false, "default" to "circle"), "disabled" to _uM("type" to "Boolean", "required" to false, "default" to false), "activeColor" to _uM("type" to "String", "required" to false, "default" to "#2979ff"), "inactiveColor" to _uM("type" to "String", "required" to false, "default" to "#c8c9cc"), "size" to _uM("type" to _uA(
            "String",
            "Number"
