...
open class GenUniModulesUniIconsComponentsUniIconsUniIcons : VueComponent {
    ...
    companion object {
        ...
        var setup: (__props: GenUniModulesUniIconsComponentsUniIconsUniIcons) -> Any? = fun(__props): Any? {
            ...
            return fun(): Any? {
                return _cE("text", _uM("class" to "weapp-tw-border uni-icons", "style" to _nS(styleObj.value)), _tD(unicode.value), 5)
            }
        }
        var name = "uni-icons"
        ...
        val styles0: Map<String, Map<String, Map<String, Any>>>
            get() {
                return _uM("weapp-tw-border" to _pS(_uM("borderTopWidth" to 0, "borderRightWidth" to 0, "borderBottomWidth" to 0, "borderLeftWidth" to 0)), "uni-icons" to _pS(_uM("fontFamily" to "UniIconsFontFamily", "fontSize" to 18, "fontStyle" to "normal", "color" to "#333333")), "@FONT-FACE" to _uM("0" to _uM("fontFamily" to "UniIconsFontFamily", "src" to "url('/assets/uniicons.32e978a5.ttf')")))
            }
        ...
        var props = _nP(_uM("customStyle" to _uM("type" to _uA(
            "Object",
            "String"
        ), "default" to _uO()), "customClass" to _uM("type" to "String", "default" to ""), "url" to _uM("type" to "String", "default" to ""), "linkType" to _uM("type" to "String", "default" to "navigateTo"), "type" to _uM("type" to "String", "default" to ""), "color" to _uM("type" to "String", "default" to "#333333"), "size" to _uM("type" to _uA(
            "Number",
            "String"
