...
open class GenUniModulesUviewUltraComponentsUpCalendarHeader : VueComponent {
    ...
    override fun `$render`(): Any? {
        ...
        return _cE("view", _uM("class" to "up-calendar-header up-border-bottom"), _uA(
            ...
            _cE("view", _uM("class" to "up-calendar-header__weekdays"), _uA(
                _cE("text", _uM("class" to "up-calendar-header__weekdays__weekday"), _tD(_ctx.t("up_week_one")), 1),
                _cE("text", _uM("class" to "up-calendar-header__weekdays__weekday"), _tD(_ctx.t("up_week_two")), 1),
                _cE("text", _uM("class" to "up-calendar-header__weekdays__weekday"), _tD(_ctx.t("up_week_three")), 1),
                _cE("text", _uM("class" to "up-calendar-header__weekdays__weekday"), _tD(_ctx.t("up_week_four")), 1),
                _cE("text", _uM("class" to "up-calendar-header__weekdays__weekday"), _tD(_ctx.t("up_week_five")), 1),
                _cE("text", _uM("class" to "up-calendar-header__weekdays__weekday"), _tD(_ctx.t("up_week_six")), 1),
                _cE("text", _uM("class" to "up-calendar-header__weekdays__weekday"), _tD(_ctx.t("up_week_seven")), 1)
            ))
        ))
    }
    ...
    open fun gen_t_fn(key: String): String {
        return uni.UNI5198058.t(key, _uO())
    }
