...
open class GenUniModulesUviewUltraComponentsUpCountToUpCountTo : VueComponent {
    ...
    companion object {
        ...
        var props = _nP(_uM("customStyle" to _uM("type" to _uA(
            ...
            "String",
            "Number"
        ), "default" to default__88.getNumber("countTo.startVal")), "endVal" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to default__88.getNumber("countTo.endVal")), "duration" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to default__88.getNumber("countTo.duration")), "autoplay" to _uM("type" to "Boolean", "default" to default__88.getBoolean("countTo.autoplay")), "decimals" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to default__88.getNumber("countTo.decimals")), "useEasing" to _uM("type" to "Boolean", "default" to default__88.getBoolean("countTo.useEasing")), "decimal" to _uM("type" to "String", "default" to default__88.getString("countTo.decimal")), "color" to _uM("type" to "String", "default" to default__88.getString("countTo.color")), "fontSize" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to default__88.getNumber("countTo.fontSize")), "bold" to _uM("type" to "Boolean", "default" to default__88.getBoolean("countTo.bold")), "separator" to _uM("type" to "String", "default" to default__88.getString("countTo.separator"))))
