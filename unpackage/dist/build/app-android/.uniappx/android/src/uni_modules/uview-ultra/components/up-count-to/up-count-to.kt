...
open class GenUniModulesUviewUltraComponentsUpCountToUpCountTo : VueComponent {
    ...
    companion object {
        ...
        var setup: (__props: GenUniModulesUviewUltraComponentsUpCountToUpCountTo, __setupCtx: SetupContext) -> Any? = fun(__props, __setupCtx): Any? {
            ...
            val countStyle = computed(fun(): UTSJSONObject {
            ...
            return fun(): Any? {
                return _cE("text", _uM("class" to "weapp-tw-border up-count-num", "style" to _nS(countStyle.value)), _tD(unref(displayValue)), 5)
            }
        }
        ...
        var props = _nP(_uM("customStyle" to _uM("type" to _uA(
            ...
            "String",
            "Number"
        ), "default" to 0), "endVal" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to 0), "duration" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to 2000), "autoplay" to _uM("type" to "Boolean", "default" to true), "decimals" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to 0), "useEasing" to _uM("type" to "Boolean", "default" to true), "decimal" to _uM("type" to "String", "default" to "."), "color" to _uM("type" to "String", "default" to "#606266"), "fontSize" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to 22), "bold" to _uM("type" to "Boolean", "default" to false), "separator" to _uM("type" to "String", "default" to "")))
