...
open class GenUniModulesUviewUltraComponentsUpPickerUpPicker : VueComponent {
    ...
    companion object {
        ...
        var props = _nP(_uM("customStyle" to _uM("type" to _uA(
            "Object",
            "String"
        ), "default" to _uO()), "customClass" to _uM("type" to "String", "default" to ""), "url" to _uM("type" to "String", "default" to ""), "linkType" to _uM("type" to "String", "default" to "navigateTo"), "modelValue" to _uM("type" to "Array", "default" to _uA<Any>()), "hasInput" to _uM("type" to "Boolean", "default" to false), "placeholder" to _uM("type" to "String", "default" to "请选择"), "show" to _uM("type" to "Boolean", "default" to crtProp__14["show"]), "popupMode" to _uM("type" to "String", "default" to crtProp__14["popupMode"]), "showToolbar" to _uM("type" to "Boolean", "default" to crtProp__14["showToolbar"]), "title" to _uM("type" to "String", "default" to crtProp__14["title"]), "columns" to _uM("type" to "Array", "default" to crtProp__14["columns"]), "loading" to _uM("type" to "Boolean", "default" to crtProp__14["loading"]), "itemHeight" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to crtProp__14["itemHeight"]), "cancelText" to _uM("type" to "String", "default" to crtProp__14["cancelText"]), "confirmText" to _uM("type" to "String", "default" to crtProp__14["confirmText"]), "cancelColor" to _uM("type" to "String", "default" to crtProp__14["cancelColor"]), "confirmColor" to _uM("type" to "String", "default" to crtProp__14["confirmColor"]), "visibleItemCount" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to crtProp__14["visibleItemCount"]), "keyName" to _uM("type" to "String", "default" to crtProp__14["keyName"]), "closeOnClickOverlay" to _uM("type" to "Boolean", "default" to crtProp__14["closeOnClickOverlay"]), "defaultIndex" to _uM("type" to "Array", "default" to crtProp__14["defaultIndex"]), "immediateChange" to _uM("type" to "Boolean", "default" to crtProp__14["immediateChange"]), "toolbarRightSlot" to _uM("type" to "Boolean", "default" to false), "pageInline" to _uM("type" to "Boolean", "default" to crtProp__14["pageInline"])))
