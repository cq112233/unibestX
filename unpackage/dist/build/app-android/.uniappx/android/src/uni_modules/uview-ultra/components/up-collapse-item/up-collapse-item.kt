...
open class GenUniModulesUviewUltraComponentsUpCollapseItemUpCollapseItem : VueComponent {
    ...
    companion object {
        ...
        var props = _nP(_uM("customStyle" to _uM("type" to _uA(
            ...
            "String"
        ), "default" to default__69.getString("collapseItem.title")), "value" to _uM("type" to _uA(
            "String"
        ), "default" to default__69.getString("collapseItem.value")), "label" to _uM("type" to _uA(
            "String"
        ), "default" to default__69.getString("collapseItem.label")), "disabled" to _uM("type" to _uA(
            "Boolean"
        ), "default" to default__69.getBoolean("collapseItem.disabled")), "isLink" to _uM("type" to _uA(
            "Boolean"
        ), "default" to default__69.getBoolean("collapseItem.isLink")), "clickable" to _uM("type" to _uA(
            "Boolean"
        ), "default" to default__69.getBoolean("collapseItem.clickable")), "border" to _uM("type" to _uA(
            "Boolean"
        ), "default" to default__69.getBoolean("collapseItem.border")), "align" to _uM("type" to _uA(
            "String"
        ), "default" to default__69.getString("collapseItem.align")), "name" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to default__69.getString("collapseItem.name")), "icon" to _uM("type" to _uA(
            "String"
        ), "default" to default__69.getString("collapseItem.icon")), "duration" to _uM("type" to _uA(
            "Number",
            "String"
        ), "default" to default__69.getNumber("collapseItem.duration")), "showRight" to _uM("type" to _uA(
            "Boolean"
        ), "default" to default__69.getBoolean("collapseItem.showRight"))))
