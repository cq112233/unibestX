...
open class GenUniModulesUviewUltraComponentsUpCollapseItemUpCollapseItem : VueComponent {
    ...
    companion object {
        ...
        var setup: (__props: GenUniModulesUviewUltraComponentsUpCollapseItemUpCollapseItem, __setupCtx: SetupContext) -> Any? = fun(__props, __setupCtx): Any? {
            ...
            val contentHeightStyle = computed(fun(): UTSJSONObject {
                return _uO("height" to addUnit(height.value))
            }
            )
            fun gen_setContentAnimate_fn(expandedFrom: Boolean): UTSPromise<Unit> {
                return wrapUTSPromise(suspend {
                        expanded.value = expandedFrom
                        val rect: NodeInfo = await(uni.UNIB120614.upGetRect("#" + elId.value, false, instance))
            ...
            return fun(): Any? {
                ...
                return _cE("view", _uM("class" to "weapp-tw-border up-collapse-item"), _uA(
                    _cV(_component_up_cell, _uM("title" to titleCpu.value, "value" to _ctx.value, "label" to _ctx.label, "icon" to _ctx.icon, "isLink" to _ctx.isLink, "clickable" to _ctx.clickable, "border" to (_ctx.border && showBorder.value), "onClick" to clickHandler, "customStyle" to _uO("padding" to "10px 0")), _uM("title" to withSlotCtx(fun(): UTSArray<Any> {
                        return _uA(
                            renderSlot(_ctx.`$slots`, "title", _uO(), fun(): UTSArray<Any> {
                                return _uA(
                                    if (isTrue(_ctx.`$slots`["title"] != null && _ctx.title != "")) {
                                        _cE("text", _uM("key" to 0, "class" to "weapp-tw-border"), _tD(_ctx.title), 1)
                                    } else {
                                        _cC("v-if", true)
                                    }
                                )
                            ...
                            renderSlot(_ctx.`$slots`, "icon", _uO(), fun(): UTSArray<Any> {
                                return _uA(
                                    if (isTrue(_ctx.`$slots`["icon"] != null && _ctx.icon != "")) {
                                        _cE("text", _uM("key" to 0, "class" to "weapp-tw-border"), _tD(_ctx.icon), 1)
                                    } else {
                                        _cC("v-if", true)
                                    }
                                )
                            ...
                            renderSlot(_ctx.`$slots`, "value", _uO(), fun(): UTSArray<Any> {
                                return _uA(
                                    if (isTrue(_ctx.`$slots`["value"] != null && _ctx.value != "")) {
                                        _cE("text", _uM("key" to 0, "class" to "weapp-tw-border"), _tD(_ctx.value), 1)
                                    } else {
                                        _cC("v-if", true)
                                    }
                                )
                    ...
                    _cE("view", _uM("class" to "weapp-tw-border up-collapse-item__content", "style" to _nS(contentHeightStyle.value)), _uA(
                        _cE("view", _uM("class" to "weapp-tw-border up-collapse-item__content__text content-class", "id" to elId.value, "ref" to elId.value), _uA(
                            renderSlot(_ctx.`$slots`, "default")
                        ), 8, _uA(
                            "id"
                        ))
                    ), 4),
                    if (isTrue(unref(parentData)["border"] != null && (unref(parentData)["border"] as Boolean))) {
        ...
        var props = _nP(_uM("customStyle" to _uM("type" to _uA(
            "Object",
            "String"
        ), "default" to _uO()), "customClass" to _uM("type" to "String", "default" to ""), "url" to _uM("type" to "String", "default" to ""), "linkType" to _uM("type" to "String", "default" to "navigateTo"), "title" to _uM("type" to "String", "default" to ""), "value" to _uM("type" to "String", "default" to ""), "label" to _uM("type" to "String", "default" to ""), "disabled" to _uM("type" to "Boolean", "default" to false), "isLink" to _uM("type" to "Boolean", "default" to true), "clickable" to _uM("type" to "Boolean", "default" to true), "border" to _uM("type" to "Boolean", "default" to true), "align" to _uM("type" to "String", "default" to "left"), "name" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to ""), "icon" to _uM("type" to "String", "default" to ""), "duration" to _uM("type" to _uA(
            "Number",
            "String"
        ), "default" to 300), "showRight" to _uM("type" to "Boolean", "default" to true)))
