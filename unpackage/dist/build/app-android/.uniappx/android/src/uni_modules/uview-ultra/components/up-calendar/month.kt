...
open class GenUniModulesUviewUltraComponentsUpCalendarMonth : VueComponent {
                ...
                return _cE("view", _uM("key" to index, "class" to _nC(_uA(
                    ...
                    if (index != 0) {
                        _cE("view", _uM("key" to 0, "class" to "up-calendar-month__title"), _uA(
                            _cE("text", _uM("class" to "up-calendar-month__title-text"), _tD(_ctx.getMonthTitle(item)), 1)
                        ))
                    } else {
                        _cC("v-if", true)
                    }
    ...
    open var getMonthTitle = ::gen_getMonthTitle_fn
    open fun gen_getMonthTitle_fn(item: monthsItem): String {
