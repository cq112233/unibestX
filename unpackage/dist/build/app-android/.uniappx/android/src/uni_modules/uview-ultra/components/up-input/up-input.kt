...
open class GenUniModulesUviewUltraComponentsUpInputUpInput : VueComponent {
    ...
    companion object {
        ...
        var setup: (__props: GenUniModulesUviewUltraComponentsUpInputUpInput) -> Any? = fun(__props): Any? {
            ...
            val computedWrapperStyle = computed(fun(): UTSJSONObject {
            ...
            return fun(): Any? {
                ...
                return _cE("view", _uM("class" to _nC(_uA(
                    "weapp-tw-border up-input",
                    inputClass.value
                )), "style" to _nS(computedWrapperStyle.value)), _uA(
                    _cE("view", _uM("class" to "weapp-tw-border up-input__content"), _uA(
                        if (isTrue(_ctx.prefixIcon != "" || _ctx.`$slots`["prefix"] != null)) {
                            _cE("view", _uM("key" to 0, "class" to "weapp-tw-border up-input__content__prefix-icon"), _uA(
                        ...
                        ,
                        _cE("view", _uM("class" to "weapp-tw-border up-input__content__field-wrapper", "onClick" to clickHandler), _uA(
                            _cE("input", _uM("ref_key" to "inputNativeRef", "ref" to inputNativeRef, "class" to "up-input__content__field-wrapper__field", "style" to _nS(inputStyle.value), "type" to _ctx.type, "focus" to _ctx.focus, "cursor" to _ctx.cursor, "value" to innerValue.value, "auto-blur" to _ctx.autoBlur, "disabled" to (_ctx.disabled || _ctx.readonly), "maxlength" to _ctx.maxlength, "placeholder" to _ctx.placeholder, "placeholder-style" to _ctx.placeholderStyle, "placeholder-class" to _ctx.placeholderClass, "confirm-type" to _ctx.confirmType, "confirm-hold" to _ctx.confirmHold, "hold-keyboard" to _ctx.holdKeyboard, "cursor-spacing" to _ctx.cursorSpacing, "adjust-position" to _ctx.adjustPosition, "selection-end" to _ctx.selectionEnd, "selection-start" to _ctx.selectionStart, "password" to (_ctx.password || _ctx.type === "password" || false), "ignoreCompositionEvent" to _ctx.ignoreCompositionEvent, "onInput" to onInput, "onBlur" to onBlur, "onFocus" to onFocus, "onConfirm" to onConfirm, "onKeyboardheightchange" to onkeyboardheightchange), null, 44, _uA(
                                "type",
                                "focus",
                                "cursor",
                                "value",
                        ...
                        if (isTrue(isShowClear.value)) {
                            _cE("view", _uM("key" to 1, "class" to "weapp-tw-border up-input__content__clear", "onClick" to onClear), _uA(
                        ...
                        if (isTrue(_ctx.suffixIcon != "" || _ctx.`$slots`["suffix"] != null)) {
                            _cE("view", _uM("key" to 2, "class" to "weapp-tw-border up-input__content__subfix-icon"), _uA(
