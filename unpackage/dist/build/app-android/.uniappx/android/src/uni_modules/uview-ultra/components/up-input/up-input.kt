    ...
    companion object {
        ...
        var setup: (__props: GenUniModulesUviewUltraComponentsUpInputUpInput) -> Any? = fun(__props): Any? {
            ...
            val inputStyle = computed(fun(): UTSJSONObject {
                val style: UTSJSONObject = _uO("color" to props.color, "fontSize" to addUnit(props.fontSize), "textAlign" to props.inputAlign)
                return style
            }
            )
        ...
        var props = _nP(_uM("customStyle" to _uM("type" to _uA(
            ...
            "String",
            "Number"
        ), "default" to default__41.getString("input.value")), "type" to _uM("type" to "String", "default" to default__41.getString("input.type")), "fixed" to _uM("type" to "Boolean", "default" to default__41.getBoolean("input.fixed")), "disabled" to _uM("type" to "Boolean", "default" to default__41.getBoolean("input.disabled")), "disabledColor" to _uM("type" to "String", "default" to default__41.getString("input.disabledColor")), "clearable" to _uM("type" to "Boolean", "default" to default__41.getBoolean("input.clearable")), "password" to _uM("type" to "Boolean", "default" to default__41.getBoolean("input.password")), "maxlength" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to default__41.getNumber("input.maxlength")), "placeholder" to _uM("type" to "String", "default" to default__41.getString("input.placeholder")), "placeholderClass" to _uM("type" to "String", "default" to default__41.getString("input.placeholderClass")), "placeholderStyle" to _uM("type" to _uA(
            "String",
            "Object"
        ), "default" to default__41.getString("input.placeholderStyle")), "showWordLimit" to _uM("type" to "Boolean", "default" to default__41.getBoolean("input.showWordLimit")), "confirmType" to _uM("type" to "String", "default" to default__41.getString("input.confirmType")), "confirmHold" to _uM("type" to "Boolean", "default" to default__41.getBoolean("input.confirmHold")), "holdKeyboard" to _uM("type" to "Boolean", "default" to default__41.getBoolean("input.holdKeyboard")), "focus" to _uM("type" to "Boolean", "default" to default__41.getBoolean("input.focus")), "autoBlur" to _uM("type" to "Boolean", "default" to default__41.getBoolean("input.autoBlur")), "disableDefaultPadding" to _uM("type" to "Boolean", "default" to default__41.getBoolean("input.disableDefaultPadding")), "cursor" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to default__41.getNumber("input.cursor")), "cursorSpacing" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to default__41.getNumber("input.cursorSpacing")), "selectionStart" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to default__41.getNumber("input.selectionStart")), "selectionEnd" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to default__41.getNumber("input.selectionEnd")), "adjustPosition" to _uM("type" to "Boolean", "default" to default__41.getBoolean("input.adjustPosition")), "inputAlign" to _uM("type" to "String", "default" to default__41.getString("input.inputAlign")), "fontSize" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to default__41.getString("input.fontSize")), "color" to _uM("type" to "String", "default" to default__41.getString("input.color")), "prefixIcon" to _uM("type" to "String", "default" to default__41.getString("input.prefixIcon")), "prefixIconStyle" to _uM("type" to _uA(
            "String",
            "Object"
        ), "default" to default__41.getString("input.prefixIconStyle")), "suffixIcon" to _uM("type" to "String", "default" to default__41.getString("input.suffixIcon")), "suffixIconStyle" to _uM("type" to _uA(
            "String",
            "Object"
        ), "default" to default__41.getString("input.suffixIconStyle")), "border" to _uM("type" to "String", "default" to default__41.getString("input.border")), "readonly" to _uM("type" to "Boolean", "default" to default__41.getBoolean("input.readonly")), "shape" to _uM("type" to "String", "default" to default__41.getString("input.shape")), "formatter" to _uM("type" to _uA(
            "Function"
        ...
        ), "ignoreCompositionEvent" to _uM("type" to "Boolean", "default" to default__41.getBoolean("input.ignoreCompositionEvent"))))
