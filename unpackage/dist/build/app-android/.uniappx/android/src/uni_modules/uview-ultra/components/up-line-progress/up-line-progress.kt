...
open class GenUniModulesUviewUltraComponentsUpLineProgressUpLineProgress : VueComponent {
    ...
    override fun data(): Map<String, Any?> {
        return _uM("parent" to null as ComponentPublicInstance?, "parentData" to _uO(), "children" to _uA<ComponentPublicInstance>(), "childrenRefs" to _uA<String>(), "lineWidth" to "0px", "percentageValue" to computed<Number>(fun(): Number {
            return normalizeNumber__1(this.percentage, 0)
        }
    ...
    companion object {
        ...
        var props = _nP(_uM("customStyle" to _uM("type" to _uA(
            "Object",
            "String"
        ), "default" to _uO()), "customClass" to _uM("type" to "String", "default" to ""), "url" to _uM("type" to "String", "default" to ""), "linkType" to _uM("type" to "String", "default" to "navigateTo"), "activeColor" to _uM("type" to "String", "default" to crtProp__23["activeColor"]), "inactiveColor" to _uM("type" to "String", "default" to crtProp__23["inactiveColor"]), "percentage" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to crtProp__23["percentage"]), "showText" to _uM("type" to "Boolean", "default" to crtProp__23["showText"]), "height" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to crtProp__23["height"])))
