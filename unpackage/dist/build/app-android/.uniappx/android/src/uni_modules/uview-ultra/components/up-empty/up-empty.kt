...
open class GenUniModulesUviewUltraComponentsUpEmptyUpEmpty : VueComponent {
    ...
    companion object {
        ...
        var setup: (__props: GenUniModulesUviewUltraComponentsUpEmptyUpEmpty) -> Any? = fun(__props): Any? {
            ...
            val props = __props
            val icons = computed(fun(): UTSJSONObject {
                return _uO("car" to t("up.empty.car", _uO()), "page" to t("up.empty.page", _uO()), "search" to t("up.empty.search", _uO()), "address" to t("up.empty.address", _uO()), "wifi" to t("up.empty.wifi", _uO()), "order" to t("up.empty.order", _uO()), "coupon" to t("up.empty.coupon", _uO()), "favor" to t("up.empty.favor", _uO()), "permission" to t("up.empty.permission", _uO()), "history" to t("up.empty.history", _uO()), "news" to t("up.empty.news", _uO()), "message" to t("up.empty.message", _uO()), "list" to t("up.empty.list", _uO()), "data" to t("up.empty.data", _uO()), "comment" to t("up.empty.comment", _uO()))
            }
            )
            ...
            val mergedEmptyStyle = computed(fun(): UTSJSONObject {
                val custom = addStyle(props.customStyle) as UTSJSONObject
                val empty = emptyStyle.value as UTSJSONObject
                return deepMerge(empty, custom) as UTSJSONObject
            }
            )
            val imageDimensionStyle = computed(fun(): UTSJSONObject {
            ...
            return fun(): Any? {
                ...
                return if (isTrue(_ctx.show)) {
                    _cE("view", _uM("key" to 0, "class" to "weapp-tw-border up-empty", "style" to _nS(mergedEmptyStyle.value)), _uA(
                        if (isTrue(!isSrc.value)) {
                            ...
                            _cE("image", _uM("key" to 1, "style" to _nS(imageDimensionStyle.value), "src" to _ctx.icon, "mode" to "widthFix"), null, 12, _uA(
                                "src"
                            ))
                        },
                        _cE("text", _uM("class" to "weapp-tw-border up-empty__text", "style" to _nS(textStyle.value)), _tD(if (_ctx.text != "") {
                            _ctx.text
                        } else {
                            icons.value[_ctx.mode]
                        }), 5),
                        if (isTrue(_ctx.`$slots`["default"] != null || _ctx.`$slots`["\$default"] != null)) {
                            _cE("view", _uM("key" to 2, "class" to "weapp-tw-border up-empty__wrap"), _uA(
        ...
        ), "customClass" to _uM("type" to "String", "default" to ""), "icon" to _uM("type" to "String", "default" to default__36.getString("empty.icon")), "text" to _uM("type" to "String", "default" to default__36.getString("empty.text")), "textColor" to _uM("type" to "String", "default" to default__36.getString("empty.textColor")), "textSize" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to default__36.getNumber("empty.textSize")), "iconColor" to _uM("type" to "String", "default" to default__36.getString("empty.iconColor")), "iconSize" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to default__36.getNumber("empty.iconSize")), "mode" to _uM("type" to "String", "default" to default__36.getString("empty.mode")), "width" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to default__36.getNumber("empty.width")), "height" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to default__36.getNumber("empty.height")), "show" to _uM("type" to "Boolean", "default" to default__36.getBoolean("empty.show")), "marginTop" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to default__36.getNumber("empty.marginTop"))))
