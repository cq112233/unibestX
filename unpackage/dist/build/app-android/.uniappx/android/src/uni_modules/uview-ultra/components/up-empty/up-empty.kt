...
open class GenUniModulesUviewUltraComponentsUpEmptyUpEmpty : VueComponent {
    ...
    companion object {
        ...
        var props = _nP(_uM("customStyle" to _uM("type" to _uA(
            "Object",
            "String"
        ), "default" to _uO()), "customClass" to _uM("type" to "String", "default" to ""), "url" to _uM("type" to "String", "default" to ""), "linkType" to _uM("type" to "String", "default" to "navigateTo"), "icon" to _uM("type" to "String", "default" to default__27.getString("empty.icon")), "text" to _uM("type" to "String", "default" to default__27.getString("empty.text")), "textColor" to _uM("type" to "String", "default" to default__27.getString("empty.textColor")), "textSize" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to default__27.getNumber("empty.textSize")), "iconColor" to _uM("type" to "String", "default" to default__27.getString("empty.iconColor")), "iconSize" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to default__27.getNumber("empty.iconSize")), "mode" to _uM("type" to "String", "default" to default__27.getString("empty.mode")), "width" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to default__27.getNumber("empty.width")), "height" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to default__27.getNumber("empty.height")), "show" to _uM("type" to "Boolean", "default" to default__27.getBoolean("empty.show")), "marginTop" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to default__27.getNumber("empty.marginTop"))))
