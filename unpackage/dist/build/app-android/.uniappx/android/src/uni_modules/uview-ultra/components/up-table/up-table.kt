    ...
    companion object {
        ...
        var setup: (__props: GenUniModulesUviewUltraComponentsUpTableUpTable, __setupCtx: SetupContext) -> Any? = fun(__props, __setupCtx): Any? {
            ...
            val getProps = fun(): UTSJSONObject {
                return _uO("border" to props.border, "borderColor" to props.borderColor, "align" to props.align, "padding" to props.padding, "fontSize" to props.fontSize, "color" to props.color, "thStyle" to props.thStyle, "bgColor" to props.bgColor)
            }
            ...
            return fun(): Any? {
                return _cE("view", _uM("class" to "weapp-tw-border up-table", "style" to _nS(_uA(
                    tableStyle.value
                ))), _uA(
        ...
        ), "customClass" to _uM("type" to "String", "default" to ""), "border" to _uM("type" to "Boolean", "default" to true), "borderColor" to _uM("type" to "String", "default" to default__48.getString("table.borderColor")), "align" to _uM("type" to "String", "default" to default__48.getString("table.align")), "padding" to _uM("type" to "String", "default" to default__48.getString("table.padding")), "fontSize" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to default__48.getNumber("table.fontSize")), "color" to _uM("type" to "String", "default" to default__48.getString("table.color")), "thStyle" to _uM("default" to fun(): UTSJSONObject {
            return default__48.getAny("table.thStyle") as UTSJSONObject
        }
        ), "bgColor" to _uM("type" to "String", "default" to default__48.getString("table.bgColor"))))
