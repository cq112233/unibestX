...
open class GenUniModulesUviewUltraComponentsUpTableUpTable : VueComponent {
    ...
    companion object {
        ...
        var props = _nP(_uM("customStyle" to _uM("type" to _uA(
            "Object",
            "String"
        ), "default" to _uO()), "customClass" to _uM("type" to "String", "default" to ""), "url" to _uM("type" to "String", "default" to ""), "linkType" to _uM("type" to "String", "default" to "navigateTo"), "borderColor" to _uM("type" to "String", "default" to default__40.getString("table.borderColor")), "align" to _uM("type" to "String", "default" to default__40.getString("table.align")), "padding" to _uM("type" to "String", "default" to default__40.getString("table.padding")), "fontSize" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to default__40.getNumber("table.fontSize")), "color" to _uM("type" to "String", "default" to default__40.getString("table.color")), "thStyle" to _uM("default" to fun(): UTSJSONObject {
            return default__40.getAny("table.thStyle") as UTSJSONObject
        }
        ), "bgColor" to _uM("type" to "String", "default" to default__40.getString("table.bgColor"))))
