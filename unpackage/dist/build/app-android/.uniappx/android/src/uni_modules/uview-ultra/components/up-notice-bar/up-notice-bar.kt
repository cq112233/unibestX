...
open class GenUniModulesUviewUltraComponentsUpNoticeBarUpNoticeBar : VueComponent {
    ...
    companion object {
        ...
        var props = _nP(_uM("customStyle" to _uM("type" to _uA(
            ...
            "Array",
            "String"
        ), "default" to crtProp__18["text"]), "direction" to _uM("type" to "String", "default" to crtProp__18["direction"]), "step" to _uM("type" to "Boolean", "default" to crtProp__18["step"]), "icon" to _uM("type" to "String", "default" to crtProp__18["icon"]), "mode" to _uM("type" to "String", "default" to crtProp__18["mode"]), "color" to _uM("type" to "String", "default" to crtProp__18["color"]), "bgColor" to _uM("type" to "String", "default" to crtProp__18["bgColor"]), "speed" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to crtProp__18["speed"]), "fontSize" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to crtProp__18["fontSize"]), "duration" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to crtProp__18["duration"]), "disableTouch" to _uM("type" to "Boolean", "default" to crtProp__18["disableTouch"]), "url" to _uM("type" to "String", "default" to crtProp__18["url"]), "linkType" to _uM("type" to "String", "default" to crtProp__18["linkType"])))
