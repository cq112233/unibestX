...
open class GenUniModulesLimeIconComponentsLIconLIcon : VueComponent, IconProps {
    ...
    companion object {
            ...
            return fun(): Any? {
                return if (isTrue(unref(type) == "font" && !unref(fontLoading))) {
                    _cE("text", _uM("key" to 0, "class" to _nC(_uA(
                        "weapp-tw-border l-icon l-icon--font l-class",
                        unref(classes)
        ...
        val styles0: Map<String, Map<String, Map<String, Any>>>
            get() {
                return _uM("weapp-tw-border" to _pS(_uM("borderTopWidth" to 0, "borderRightWidth" to 0, "borderBottomWidth" to 0, "borderLeftWidth" to 0)), "l-icon--font" to _pS(_uM("fontFamily" to "l", "textAlign" to "center")), "l-icon--image" to _pS(_uM("width" to "var(--l-icon-size, 16px)", "height" to "var(--l-icon-size, 16px)")), "@FONT-FACE" to _uM("0" to _uM("fontFamily" to "l", "src" to "url(\"/uni_modules/lime-icon/static/app/t4.ttf\")")))
            }
