...
open class GenUniModulesUviewUltraComponentsUpGapUpGap : VueComponent {
    ...
    companion object {
        ...
        var setup: (__props: GenUniModulesUviewUltraComponentsUpGapUpGap) -> Any? = fun(__props): Any? {
            val __ins = getCurrentInstance()!!
            val _ctx = __ins.proxy as GenUniModulesUviewUltraComponentsUpGapUpGap
            val _cache = __ins.renderCache
            val props = __props
            val gapStyle = computed(fun(): UTSJSONObject {
                return _uO("backgroundColor" to props.bgColor, "height" to addUnit(props.height), "marginTop" to addUnit(props.marginTop), "marginBottom" to addUnit(props.marginBottom))
            }
            )
            return fun(): Any? {
                return _cE("view", _uM("class" to "up-gap", "style" to _nS(_uA(
                    gapStyle.value
                ))), null, 4)
            }
        }
        ...
        var props = _nP(_uM("customStyle" to _uM("type" to _uA(
            "Object",
            "String"
        ), "default" to _uO()), "customClass" to _uM("type" to "String", "default" to ""), "url" to _uM("type" to "String", "default" to ""), "linkType" to _uM("type" to "String", "default" to "navigateTo"), "bgColor" to _uM("type" to "String", "default" to default__16.getString("gap.bgColor")), "height" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to default__16.getNumber("gap.height")), "marginTop" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to default__16.getNumber("gap.marginTop")), "marginBottom" to _uM("type" to _uA(
            "String",
            "Number"
        ), "default" to default__16.getNumber("gap.marginBottom"))))
