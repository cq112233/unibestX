...
function populateParameters(fromRes, toRes) {
  ...
  {
    try {
      parameters.uniCompilerVersionCode = parseFloat("5.15");
      parameters.uniRuntimeVersionCode = parseFloat("5.15");
    } catch (error) {
    }
  }
...
function initRuntimeSocketService() {
  const hosts = "127.0.0.1,192.168.100.123,198.18.0.1,10.8.0.11,10.211.55.2,10.37.129.2";
  const port = "8090";
  const id = "mp-weixin_yxYdYa";
...
exports.normalizeClass = normalizeClass$1;
