...
function populateParameters(fromRes, toRes) {
  ...
  {
    try {
      parameters.uniCompilerVersionCode = parseFloat("5.24");
      parameters.uniRuntimeVersionCode = parseFloat("5.24");
    } catch (error) {
    }
  }
...
function initRuntimeSocketService() {
  const hosts = "127.0.0.1,192.168.31.152,198.18.0.1,10.211.55.2,10.8.0.2,10.37.129.2";
  const port = "8090";
  const id = "mp-weixin_ymI04t";
