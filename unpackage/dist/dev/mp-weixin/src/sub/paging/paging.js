...
if (!Math) {
  (_easycom_NavBar + _easycom_z_paging_x + common_vendor.unref(AppKu))();
}
      ...
      const __returned__ = {
        ...
        b: common_vendor.f(tabList, (tab, index, i0) => {
          return {
            ...
            b: tabIndex.value === index ? "var(--theme-color, #845ec2)" : "#64748b",
            c: index,
        ...
        d: common_vendor.sr(pagingX, "0ef71e88-2,0ef71e88-0", {
          "k": "pagingX"
        }),
        e: common_vendor.o(onUpdateModelValue, "42"),
        f: common_vendor.o(onQuery, "a6"),
        g: common_vendor.p({
