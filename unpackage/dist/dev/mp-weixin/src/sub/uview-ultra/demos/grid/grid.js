...
if (!Math) {
  (_easycom_NavBar + _easycom_up_icon + _easycom_up_grid_item + _easycom_up_grid + common_vendor.unref(AppKu))();
}
    ...
    return (_ctx, _cache) => {
      ...
      const __returned__ = {
        ...
        b: common_vendor.f(4, (i, k0, i0) => {
          return {
            a: "75f5808e-4-" + i0 + "," + ("75f5808e-3-" + i0),
            b: i,
            c: "75f5808e-3-" + i0 + ",75f5808e-2"
          };
        }),
        c: common_vendor.p({
          name: "photo",
