...
if (!Math) {
  (_easycom_NavBar + _easycom_up_button + _easycom_up_modal + common_vendor.unref(AppKu))();
}
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      const __returned__ = {
        ...
        b: common_vendor.o(showModal, "bf"),
        c: common_vendor.p({
          type: "primary",
          text: "弹窗提示",
          size: "mini",
        ...
        d: common_vendor.o(showConfirmModal, "66"),
        e: common_vendor.p({
          type: "warning",
          text: "确认弹窗",
          size: "mini",
        ...
        f: common_vendor.o(showNoTitleModal, "79"),
        g: common_vendor.p({
          type: "success",
          text: "无标题",
          size: "mini",
        ...
        h: common_vendor.o(showLongModal, "ff"),
        i: common_vendor.p({
          type: "error",
          text: "长内容",
          size: "mini",
        ...
        j: common_vendor.o(onModalConfirm, "af"),
        k: common_vendor.o(onModalClose, "74"),
        l: common_vendor.p({
