...
if (!Math) {
  (_easycom_NavBar + _easycom_up_tooltip + _easycom_up_button + common_vendor.unref(AppKu))();
}
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      const __returned__ = {
        ...
        c: common_vendor.o(handleBtnClick, "33"),
        d: common_vendor.p({
          text: "长按显示操作",
          direction: "top",
          ["show-copy"]: false,
        ...
        h: common_vendor.o(handleBtnClick, "2f"),
        i: common_vendor.p({
          text: "显示多个扩展按钮",
          ["show-copy"]: true,
        ...
        k: common_vendor.o(handleBtnClick, "3e"),
        l: common_vendor.p({
          ["show-copy"]: false,
          buttons: ["设置", "赞"],
          direction: "top",
        ...
        n: common_vendor.o(handleBtnClick, "04"),
        o: common_vendor.p({
          ["show-copy"]: true,
          buttons: ["自定义操作"],
          direction: "bottom",
