...
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent({
  ...
  setup(__props) {
    ...
    function onConfirm1(e) {
      common_vendor.index.__f__("log", "at src/sub/uview-ultra/demos/calendar/calendar.uvue:69", "single", e);
      calendarShow1.value = false;
    }
    function onConfirm2(e) {
      common_vendor.index.__f__("log", "at src/sub/uview-ultra/demos/calendar/calendar.uvue:73", "multiple", e);
      calendarShow2.value = false;
    }
    function onConfirm3(e) {
      common_vendor.index.__f__("log", "at src/sub/uview-ultra/demos/calendar/calendar.uvue:77", "range", e);
      calendarShow3.value = false;
    }
    function onConfirm4(e) {
      common_vendor.index.__f__("log", "at src/sub/uview-ultra/demos/calendar/calendar.uvue:81", "custom color", e);
    ...
    return (_ctx, _cache) => {
      ...
      const __returned__ = {
        ...
        b: common_vendor.o(showCalendar1, "17"),
        c: common_vendor.p({
          type: "primary",
          text: "单选模式",
          size: "mini",
        ...
        d: common_vendor.o(showCalendar2, "ed"),
        e: common_vendor.p({
          type: "success",
          text: "多选日期",
          size: "mini",
        ...
        f: common_vendor.o(showCalendar3, "55"),
        g: common_vendor.p({
          type: "warning",
          text: "范围选择",
          size: "mini",
        ...
        h: common_vendor.o(showCalendar4, "25"),
        i: common_vendor.p({
          type: "error",
          text: "自定义颜色",
          size: "mini",
        ...
        j: common_vendor.o(onConfirm1, "0f"),
        ...
        m: common_vendor.o(onConfirm2, "3c"),
        ...
        p: common_vendor.o(onConfirm3, "8b"),
        ...
        s: common_vendor.o(onConfirm4, "8b"),
