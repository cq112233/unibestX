...
if (!Math) {
  (_easycom_NavBar + _easycom_up_button + _easycom_up_calendar + common_vendor.unref(AppKu))();
}
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      const __returned__ = {
        ...
        b: common_vendor.o(showCalendar1, "7a"),
        c: common_vendor.p({
          type: "primary",
          text: "单选模式",
          size: "mini",
        ...
        d: common_vendor.o(showCalendar2, "fd"),
        e: common_vendor.p({
          type: "success",
          text: "多选日期",
          size: "mini",
        ...
        f: common_vendor.o(showCalendar3, "16"),
        g: common_vendor.p({
          type: "warning",
          text: "范围选择",
          size: "mini",
        ...
        h: common_vendor.o(showCalendar4, "34"),
        i: common_vendor.p({
          type: "error",
          text: "自定义颜色",
          size: "mini",
        ...
        j: common_vendor.o(onConfirm1, "16"),
        ...
        m: common_vendor.o(onConfirm2, "ca"),
        ...
        p: common_vendor.o(onConfirm3, "86"),
        ...
        s: common_vendor.o(onConfirm4, "14"),
