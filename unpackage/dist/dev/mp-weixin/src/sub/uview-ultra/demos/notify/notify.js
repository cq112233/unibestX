...
if (!Math) {
  (_easycom_NavBar + _easycom_up_button + _easycom_up_notify + common_vendor.unref(AppKu))();
}
...
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent({
  ...
  setup(__props) {
    ...
    function showNotify(type) {
      ...
      if (notify != null) {
        const msgs = new common_vendor.UTSJSONObject({
          primary: "主要通知消息",
          success: "操作成功通知",
          warning: "请注意安全通知",
          error: "发生错误通知"
        });
        notify.$callMethod("show", new common_vendor.UTSJSONObject({
          message: msgs[type],
          type
        }));
      }
    ...
    return (_ctx, _cache) => {
      ...
      const __returned__ = {
        ...
        j: common_vendor.sr(uNotify, "2a34887b-6,2a34887b-0", {
          "k": "uNotify"
        }),
        k: common_vendor.p({
