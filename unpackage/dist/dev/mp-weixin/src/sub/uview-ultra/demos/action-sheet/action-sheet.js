...
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent({
  ...
  setup(__props) {
    ...
    const actionList = common_vendor.ref([
      new common_vendor.UTSJSONObject({ name: "拍照" }),
      new common_vendor.UTSJSONObject({ name: "从相册选择" })
    ]);
    const actionListComplex = common_vendor.ref([
      new common_vendor.UTSJSONObject({ name: "着色选项", color: "#ffaa33" }),
      new common_vendor.UTSJSONObject({ name: "禁用选项", disabled: true }),
      new common_vendor.UTSJSONObject({ name: "带副标题选项", subname: "我是副标题" })
    ]);
    function onActionSelect(e) {
      common_vendor.index.__f__("log", "at src/sub/uview-ultra/demos/action-sheet/action-sheet.uvue:75", "action select", e);
    ...
    return (_ctx, _cache) => {
      ...
      const __returned__ = {
        ...
        i: common_vendor.o(onActionSelect, "ca"),
        j: common_vendor.p({
        ...
        l: common_vendor.o(onActionSelect, "62"),
        m: common_vendor.p({
        ...
        o: common_vendor.o(onActionSelect, "73"),
        p: common_vendor.p({
