...
if (!Math) {
  (_easycom_NavBar + _easycom_up_button + _easycom_up_action_sheet + common_vendor.unref(AppKu))();
}
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      const __returned__ = {
        ...
        i: common_vendor.o(onActionSelect, "40"),
        j: common_vendor.p({
        ...
        l: common_vendor.o(onActionSelect, "b1"),
        m: common_vendor.p({
        ...
        o: common_vendor.o(onActionSelect, "3b"),
        p: common_vendor.p({
