...
if (!Math) {
  (_easycom_NavBar + _easycom_up_button + _easycom_up_datetime_picker + common_vendor.unref(AppKu))();
}
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      const __returned__ = {
        ...
        j: common_vendor.o(onConfirm1, "3d"),
        ...
        m: common_vendor.o(onConfirm2, "0a"),
        ...
        p: common_vendor.o(onConfirm3, "24"),
        ...
        s: common_vendor.o(onConfirm4, "2e"),
