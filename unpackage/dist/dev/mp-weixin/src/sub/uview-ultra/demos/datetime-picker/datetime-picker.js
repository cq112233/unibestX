  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      const __returned__ = {
        ...
        A: common_vendor.o(onConfirm1, "bc"),
        B: common_vendor.o(($event) => {
        ...
        E: common_vendor.o(onConfirm2, "8d"),
        ...
        I: common_vendor.o(onConfirm3, "b2"),
        ...
        M: common_vendor.o(onConfirm4, "b7"),
        N: common_vendor.o(($event) => {
        ...
        Q: common_vendor.o(onConfirmMinMaxDate, "99"),
        ...
        U: common_vendor.o(onConfirmMinMaxTime, "84"),
        ...
        Y: common_vendor.o(onConfirmStart, "03"),
        ...
        ac: common_vendor.o(onConfirmEnd, "94"),
