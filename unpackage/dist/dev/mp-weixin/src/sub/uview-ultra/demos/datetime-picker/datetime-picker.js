...
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent({
  ...
  setup(__props) {
    ...
    const dtValue1 = common_vendor.ref(Number(new Date(2026, 7, 10, 8, 30)));
    const dtValue2 = common_vendor.ref(Number(new Date(2026, 7, 10)));
    const dtValue3 = common_vendor.ref(Number(new Date(2026, 7, 10)));
    ...
    const dtValueMinMaxDate = common_vendor.ref(Number(new Date(2026, 7, 10)));
    const dtValueMinMaxTime = common_vendor.ref("09:30");
    const dtValueStart = common_vendor.ref(Number(new Date(2026, 7, 10)));
    const dtValueEnd = common_vendor.ref(Number(new Date(2026, 7, 20)));
