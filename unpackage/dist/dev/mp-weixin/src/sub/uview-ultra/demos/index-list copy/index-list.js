    ...
    return (_ctx, _cache) => {
      ...
      const __returned__ = {
        a: common_vendor.p({
          ...
          ["auto-back"]: true,
          class: "data-v-59e652d4"
        }),
        b: common_vendor.f(itemArr.value, (item, index, i0) => {
          return {
            a: "59e652d4-5-" + i0 + "," + ("59e652d4-4-" + i0),
            b: common_vendor.p({
        ...
        f: common_vendor.p({
          ...
          ["navigation-bar-title-text"]: "IndexList 索引列表",
          class: "data-v-59e652d4"
        }),
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-59e652d4"]]);
wx.createPage(MiniProgramPage);
//# sourceMappingURL=../../../../../../.sourcemap/mp-weixin/src/sub/uview-ultra/demos/index-list copy/index-list.js.map
