  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      const __returned__ = {
        ...
        e: common_vendor.o(onNumberChange, "70"),
        f: common_vendor.o(onNumberBackspace, "d9"),
        ...
        n: common_vendor.o(onCardChange, "20"),
        o: common_vendor.o(onCardBackspace, "65"),
        ...
        x: common_vendor.o(onCarChange, "4e"),
        ...
        D: common_vendor.p({
          ...
          ["navigation-bar-title-text"]: "Keyboard 键盘",
          class: "data-v-6e648c8f"
        }),
