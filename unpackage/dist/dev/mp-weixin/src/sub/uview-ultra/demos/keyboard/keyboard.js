  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      const __returned__ = {
        ...
        e: common_vendor.o(onNumberChange, "5f"),
        f: common_vendor.o(onNumberBackspace, "a0"),
        ...
        n: common_vendor.o(onCardChange, "58"),
        o: common_vendor.o(onCardBackspace, "ce"),
        ...
        x: common_vendor.o(onCarChange, "0a"),
        y: common_vendor.o(onCarBackspace, "b9"),
