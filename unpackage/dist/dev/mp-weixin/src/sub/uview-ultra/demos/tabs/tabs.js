...
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent({
  ...
  setup(__props) {
    ...
    function onLongChange(item) {
      common_vendor.index.__f__("log", "at src/sub/uview-ultra/demos/tabs/tabs.uvue:146", "超长Tabs切换:", item);
    }
    function onBaseChange(item) {
      common_vendor.index.__f__("log", "at src/sub/uview-ultra/demos/tabs/tabs.uvue:150", "基础Tabs切换:", item);
    }
    return (_ctx, _cache) => {
      "raw js";
      const __returned__ = {
        ...
        b: common_vendor.o(onLongChange, "d2"),
        ...
        g: common_vendor.o(onBaseChange, "4b"),
