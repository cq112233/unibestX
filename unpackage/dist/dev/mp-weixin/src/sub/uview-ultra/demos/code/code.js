...
if (!Math) {
  (_easycom_NavBar + _easycom_up_code + _easycom_up_button + common_vendor.unref(AppKu))();
}
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      const __returned__ = {
        ...
        b: common_vendor.sr(uCodeRef, "a71ac0ed-2,a71ac0ed-0", {
          "k": "uCodeRef"
        }),
        c: common_vendor.o(codeChange, "92"),
        d: common_vendor.p({
          seconds: "60",
          class: "r data-v-a71ac0ed"
        }),
        e: common_vendor.o(getCode, "ef"),
        f: common_vendor.p({
          text: tips.value,
          type: "primary",
          size: "small",
