...
if (!Math) {
  (_easycom_NavBar + _easycom_up_radio + _easycom_up_radio_group + common_vendor.unref(AppKu))();
}
...
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent({
  ...
  setup(__props) {
    ...
    const radioValue4 = common_vendor.ref("1");
    function radioChange(n) {
      common_vendor.index.__f__("log", "at src/sub/uview-ultra/demos/radio/radio.uvue:49", "radio change", n);
    }
    return (_ctx, _cache) => {
      "raw js";
      const __returned__ = {
        ...
        d: common_vendor.o(radioChange, "93"),
