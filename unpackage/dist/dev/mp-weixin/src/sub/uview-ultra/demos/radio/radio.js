...
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent({
  ...
  setup(__props) {
    ...
    function radioChange(n) {
      common_vendor.index.__f__("log", "at src/sub/uview-ultra/demos/radio/radio.uvue:56", "radio change", n);
    }
    return (_ctx, _cache) => {
      "raw js";
      const __returned__ = {
        ...
        b: common_vendor.p({
          name: "apple",
          label: "苹果",
          class: "mb-_b10px_B mr-_b20px_B data-v-26d4c8ed"
        }),
        c: common_vendor.p({
          name: "banana",
          label: "香蕉",
        ...
        d: common_vendor.o(radioChange, "d1"),
