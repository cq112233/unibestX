...
if (!Math) {
  (_easycom_NavBar + _easycom_up_input + _easycom_up_form_item + _easycom_up_icon + _easycom_up_radio + _easycom_up_radio_group + _easycom_up_checkbox + _easycom_up_checkbox_group + _easycom_up_switch + _easycom_up_rate + _easycom_up_number_box + _easycom_up_slider + _easycom_up_textarea + _easycom_up_upload + _easycom_up_form + _easycom_up_button + _easycom_up_calendar + _easycom_up_picker + _easycom_up_datetime_picker + _easycom_up_action_sheet + common_vendor.unref(AppKu))();
}
const AppKu = () => "../../../../../App.ku.js";
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent({
  __name: "form",
  setup(__props) {
    const formModel = common_vendor.reactive(new common_vendor.UTSJSONObject({
      name: "",
      gender: "",
      birthday: "",
      country: "",
    ...
    const formModel2 = common_vendor.reactive(new common_vendor.UTSJSONObject({
      name: "",
      detail: ""
    }));
    const formRules = new common_vendor.UTSJSONObject({
      name: [
    ...
    const genderActions = common_vendor.ref([
      new common_vendor.UTSJSONObject({ name: "男" }),
      new common_vendor.UTSJSONObject({ name: "女" }),
      new common_vendor.UTSJSONObject({ name: "保密" })
    ]);
    ...
    function onUploadAfterRead(e) {
      const file = e["file"];
      file.forEach((item) => {
        uploadList.value.push(common_vendor.UTSJSONObject.assign(new common_vendor.UTSJSONObject({}), item));
      });
    ...
    return (_ctx, _cache) => {
      ...
      const __returned__ = {
        ...
        aa: common_vendor.o(onUploadAfterRead, "36"),
        ab: common_vendor.o(onUploadDelete, "86"),
        ac: common_vendor.p({
        ...
        ae: common_vendor.sr(uForm, "a419e6dd-2,a419e6dd-0", {
          "k": "uForm"
        }),
        af: common_vendor.p({
          model: formModel,
        ...
        an: common_vendor.o(submitForm, "09"),
        ao: common_vendor.p({
          type: "primary",
          text: "提交表单",
          class: "data-v-a419e6dd"
        }),
        ap: common_vendor.o(resetForm, "1c"),
        aq: common_vendor.p({
          type: "info",
          text: "重置表单",
          class: "data-v-a419e6dd"
        }),
        ar: common_vendor.o(onCalendarConfirm, "dd"),
        ...
        av: common_vendor.o(onPickerConfirm, "3e"),
        ...
        az: common_vendor.o(onDatetimePickerConfirm, "0f"),
        ...
        aE: common_vendor.o(onGenderSelect, "a8"),
