  ...
  setup(__props) {
    ...
    function submitForm() {
      ...
      if (form != null) {
        form.$callMethod("validate").then((res = null) => {
          ...
          common_vendor.index.__f__("log", "at src/sub/uview-ultra/demos/form/form.uvue:261", "提交的数据：", formModel);
        }).catch((err = null) => {
          common_vendor.index.__f__("log", "at src/sub/uview-ultra/demos/form/form.uvue:263", "验证失败:", err);
          common_vendor.index.showToast({
            title: "请检查必填项",
            icon: "error"
          });
    ...
    return (_ctx, _cache) => {
      ...
      const __returned__ = {
        ...
        aa: common_vendor.o(onUploadAfterRead, "9f"),
        ab: common_vendor.o(onUploadDelete, "44"),
        ac: common_vendor.p({
        ...
        an: common_vendor.o(submitForm, "d0"),
        ao: common_vendor.p({
          type: "primary",
          text: "提交表单",
          class: "data-v-a419e6dd"
        }),
        ap: common_vendor.o(resetForm, "d1"),
        aq: common_vendor.p({
          type: "info",
          text: "重置表单",
          class: "data-v-a419e6dd"
        }),
        ar: common_vendor.o(onCalendarConfirm, "1e"),
        ...
        av: common_vendor.o(onPickerConfirm, "b0"),
        ...
        az: common_vendor.o(onDatetimePickerConfirm, "17"),
        ...
        aE: common_vendor.o(onGenderSelect, "31"),
