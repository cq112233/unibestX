  ...
  setup(__props) {
    ...
    function submitForm() {
      ...
      if (form != null) {
        form.$callMethod("validate").then((res = null) => {
          ...
          common_vendor.index.__f__("log", "at src/sub/uview-ultra/demos/form/form.uvue:269", "提交的数据：", formModel);
        }).catch((err = null) => {
          common_vendor.index.__f__("log", "at src/sub/uview-ultra/demos/form/form.uvue:271", "验证失败:", err);
          common_vendor.index.showToast({
            title: "请检查必填项",
            icon: "error"
          });
    ...
    return (_ctx, _cache) => {
      ...
      const __returned__ = {
        ...
        aa: common_vendor.o(onUploadAfterRead, "f2"),
        ab: common_vendor.o(onUploadDelete, "17"),
        ac: common_vendor.p({
        ...
        an: common_vendor.o(submitForm, "89"),
        ao: common_vendor.p({
          type: "primary",
          text: "提交表单",
          class: "data-v-a419e6dd"
        }),
        ap: common_vendor.o(resetForm, "78"),
        aq: common_vendor.p({
          type: "info",
          text: "重置表单",
          class: "data-v-a419e6dd"
        }),
        ar: common_vendor.o(onCalendarConfirm, "32"),
        ...
        av: common_vendor.o(onPickerConfirm, "48"),
        ...
        az: common_vendor.o(onDatetimePickerConfirm, "54"),
        ...
        aE: common_vendor.o(onGenderSelect, "18"),
        ...
        aH: common_vendor.p({
          ...
          ["navigation-bar-title-text"]: "Form 表单",
          class: "data-v-a419e6dd"
        }),
