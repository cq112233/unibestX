  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      const __returned__ = {
        ...
        aa: common_vendor.o(onUploadAfterRead, "49"),
        ab: common_vendor.o(onUploadDelete, "27"),
        ac: common_vendor.p({
        ...
        an: common_vendor.o(submitForm, "7b"),
        ao: common_vendor.p({
          type: "primary",
          text: "提交表单",
          class: "data-v-a419e6dd"
        }),
        ap: common_vendor.o(resetForm, "2b"),
        aq: common_vendor.p({
          type: "info",
          text: "重置表单",
          class: "data-v-a419e6dd"
        }),
        ar: common_vendor.o(onCalendarConfirm, "fb"),
        ...
        av: common_vendor.o(onPickerConfirm, "50"),
        ...
        az: common_vendor.o(onDatetimePickerConfirm, "ba"),
        ...
        aE: common_vendor.o(onGenderSelect, "c0"),
