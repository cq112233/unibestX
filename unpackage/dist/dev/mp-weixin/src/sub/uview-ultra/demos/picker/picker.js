...
if (!Math) {
  (_easycom_NavBar + _easycom_up_button + _easycom_up_picker + common_vendor.unref(AppKu))();
}
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      const __returned__ = {
        ...
        b: common_vendor.o(showPicker1, "04"),
        c: common_vendor.p({
          type: "primary",
          text: "单列选择",
          size: "mini",
        ...
        d: common_vendor.o(showPicker2, "95"),
        e: common_vendor.p({
          type: "success",
          text: "多列选择",
          size: "mini",
        ...
        f: common_vendor.o(showPicker3, "2d"),
        g: common_vendor.p({
          type: "warning",
          text: "加载中选择",
          size: "mini",
        ...
        h: common_vendor.o(onConfirm1, "d4"),
        ...
        k: common_vendor.o(onConfirm2, "c9"),
        ...
        n: common_vendor.o(onConfirm3, "80"),
