...
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent({
  ...
  setup(__props) {
    ...
    function onConfirm1(e) {
      common_vendor.index.__f__("log", "at src/sub/uview-ultra/demos/picker/picker.uvue:66", "picker 1 confirm", e);
      pickerShow1.value = false;
    }
    function onConfirm2(e) {
      common_vendor.index.__f__("log", "at src/sub/uview-ultra/demos/picker/picker.uvue:70", "picker 2 confirm", e);
      pickerShow2.value = false;
    }
    function onConfirm3(e) {
      common_vendor.index.__f__("log", "at src/sub/uview-ultra/demos/picker/picker.uvue:74", "picker 3 confirm", e);
    ...
    return (_ctx, _cache) => {
      ...
      const __returned__ = {
        ...
        b: common_vendor.o(showPicker1, "9f"),
        c: common_vendor.p({
          type: "primary",
          text: "单列选择",
          size: "mini",
        ...
        d: common_vendor.o(showPicker2, "c7"),
        e: common_vendor.p({
          type: "success",
          text: "多列选择",
          size: "mini",
        ...
        f: common_vendor.o(showPicker3, "64"),
        g: common_vendor.p({
          type: "warning",
          text: "加载中选择",
          size: "mini",
        ...
        h: common_vendor.o(onConfirm1, "77"),
        ...
        k: common_vendor.o(onConfirm2, "ee"),
        ...
        n: common_vendor.o(onConfirm3, "00"),
