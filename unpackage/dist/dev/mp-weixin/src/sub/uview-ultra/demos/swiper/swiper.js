...
if (!Math) {
  (_easycom_NavBar + _easycom_up_swiper + common_vendor.unref(AppKu))();
}
...
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent({
  ...
  setup(__props) {
    const swiperList = common_vendor.ref([
      new common_vendor.UTSJSONObject({ image: "/static/logo.png", title: "uview-ultra 组件演示" }),
      new common_vendor.UTSJSONObject({ image: "/static/logo.png", title: "高品质 UI 组件库" }),
      new common_vendor.UTSJSONObject({ image: "/static/logo.png", title: "多端适配 · 开箱即用" })
    ]);
    return (_ctx, _cache) => {
      "raw js";
      const __returned__ = {
