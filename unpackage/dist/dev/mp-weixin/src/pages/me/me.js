...
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent({
  ...
  setup(__props) {
    ...
    common_vendor.onShow(() => {
      common_vendor.index.__f__("log", "at src/pages/me/me.uvue:90", "All storage keys:", common_vendor.index.getStorageInfoSync().keys);
      common_vendor.index.__f__("log", "at src/pages/me/me.uvue:91", "pinia:token:", common_vendor.index.getStorageSync("pinia:token"));
      common_vendor.index.__f__("log", "at src/pages/me/me.uvue:92", "pinia:user:", common_vendor.index.getStorageSync("pinia:user"));
    });
    ...
    return (_ctx, _cache) => {
      ...
      const __returned__ = common_vendor.e({
        ...
        f: common_vendor.n(common_vendor.unref(tokenStore).hasValidLogin() ? "wtu-1x8u93y-w wtu-1obvnxf-x" : "wtu-11a9dql-y wtu-1ya1no3-n"),
        ...
        i: common_vendor.o(handleLogout, "bd")
      } : {
        j: common_vendor.o(handleLogin, "40")
      }, {
