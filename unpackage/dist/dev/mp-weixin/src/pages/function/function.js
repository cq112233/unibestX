...
if (!Math) {
  (common_vendor.unref(EnvCard) + common_vendor.unref(SystemInfoCard) + common_vendor.unref(HapticsCard) + common_vendor.unref(MediaCard) + common_vendor.unref(LayoutComponent) + common_vendor.unref(AppKu))();
}
