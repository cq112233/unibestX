...
if (!Math) {
  (common_vendor.unref(UViewUltraDemoCard) + common_vendor.unref(TailwindcssDemoCard) + common_vendor.unref(ThemeSwitchCard) + common_vendor.unref(RouterDemoCard) + common_vendor.unref(LangSwitchCard) + common_vendor.unref(IconDemoCard) + common_vendor.unref(HttpDemoCard) + common_vendor.unref(ToastDemoCard) + common_vendor.unref(PropsDemoCard) + common_vendor.unref(SystemInfoDemoCard) + common_vendor.unref(AppKu))();
}
...
const TailwindcssDemoCard = () => "./components/TailwindcssDemoCard.js";
