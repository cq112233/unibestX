...
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      "raw js";
      const __returned__ = {
        a: common_vendor.t(common_vendor.unref(src_utils_i18n.$t)("basic.themePreview")),
        b: common_vendor.t(common_vendor.unref(src_utils_i18n.$t)("basic.themeButton")),
        c: common_vendor.unref(currentTheme),
        d: common_vendor.f(colorOptions, (item, index, i0) => {
          return common_vendor.e({
            a: common_vendor.unref(currentTheme) == item
          }, common_vendor.unref(currentTheme) == item ? {} : {}, {
            b: index,
            c: item,
            d: common_vendor.unref(currentTheme) == item ? "3px" : "0px",
        ...
        f: common_vendor.p({
          title: common_vendor.unref(src_utils_i18n.$t)("basic.themeTitle"),
