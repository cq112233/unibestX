...
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      "raw js";
      const __returned__ = {
        a: common_vendor.o(handleDefaultToast, "2e"),
        b: common_vendor.o(handleSuccessToast, "ca"),
        c: common_vendor.o(handleErrorToast, "e3"),
        d: common_vendor.o(handleWarningToast, "78"),
