  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      const __returned__ = common_vendor.e({
        a: common_vendor.t(common_vendor.unref(src_utils_i18n.$t)("basic.langPreview")),
        b: common_vendor.t(common_vendor.unref(src_utils_i18n.$t)("message.welcome")),
        c: common_vendor.t(common_vendor.unref(src_utils_i18n.$t)("message.hello", {
          msg: "hi"
        })),
        d: common_vendor.t(common_vendor.unref(src_utils_i18n.$t)("basic.uviewPreview")),
        ...
        p: common_vendor.p({
          title: common_vendor.unref(src_utils_i18n.$t)("basic.langTitle"),
