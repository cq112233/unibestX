  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      const __returned__ = {
        ...
        b: common_vendor.o(initEchart, "f6"),
        c: common_vendor.p({
          class: "w-full i_h-full r"
        }),
        d: common_vendor.n(currentType.value !== "line" ? "text-__3b82f6_" : "text-__ffffff_"),
        e: common_vendor.n(currentType.value !== "line" ? "bg-__e0edff_" : "bg-__3b82f6_"),
        f: common_vendor.o(changeToLine, "e8"),
        g: common_vendor.n(currentType.value !== "bar" ? "text-__10b981_" : "text-__ffffff_"),
        h: common_vendor.n(currentType.value !== "bar" ? "bg-__d1fae5_" : "bg-__10b981_"),
        i: common_vendor.o(changeToBar, "9b"),
        j: common_vendor.n(currentType.value !== "pie" ? "text-__f59e0b_" : "text-__ffffff_"),
        k: common_vendor.n(currentType.value !== "pie" ? "bg-__fef3c7_" : "bg-__f59e0b_"),
        l: common_vendor.o(changeToPie, "9a"),
