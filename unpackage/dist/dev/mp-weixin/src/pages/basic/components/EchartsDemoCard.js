  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      const __returned__ = {
        ...
        b: common_vendor.o(initEchart, "c2"),
        c: common_vendor.p({
          height: "280px",
          class: "w-full h-full r"
        }),
        d: common_vendor.t(common_vendor.unref(src_utils_i18n.$t)("basic.echartLine")),
        ...
        g: common_vendor.o(changeToLine, "6c"),
        h: common_vendor.t(common_vendor.unref(src_utils_i18n.$t)("basic.echartBar")),
        ...
        k: common_vendor.o(changeToBar, "5f"),
        l: common_vendor.t(common_vendor.unref(src_utils_i18n.$t)("basic.echartPie")),
        ...
        o: common_vendor.o(changeToPie, "d6"),
        p: common_vendor.gei(_ctx, ""),
        q: common_vendor.p({
          title: common_vendor.unref(src_utils_i18n.$t)("basic.echartTitle"),
