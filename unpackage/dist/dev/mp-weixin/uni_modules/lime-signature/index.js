...
class LimeSignatureToFileSuccess extends common_vendor.UTS.UTSType {
...
class LimeSignatureToTempFilePathOptions extends common_vendor.UTS.UTSType {
  static get$UTSMetadata$() {
    return {
      kind: 2,
      get fields() {
...
class LimeSignatureOptions extends common_vendor.UTS.UTSType {
  static get$UTSMetadata$() {
    return {
      kind: 2,
      get fields() {
...
class LimeSignaturePoint extends common_vendor.UTS.UTSType {
  static get$UTSMetadata$() {
    return {
      kind: 2,
      get fields() {
...
exports.LimeSignatureOptions = LimeSignatureOptions;
exports.LimeSignatureToFileSuccess = LimeSignatureToFileSuccess;
exports.LimeSignatureToTempFilePathOptions = LimeSignatureToTempFilePathOptions;
//# sourceMappingURL=../../../.sourcemap/mp-weixin/uni_modules/lime-signature/index.js.map
