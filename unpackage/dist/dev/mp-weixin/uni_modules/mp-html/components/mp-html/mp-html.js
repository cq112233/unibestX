...
class HtmlNode extends common_vendor.UTS.UTSType {
    ...
    return {
      ...
      get fields() {
        return {
          ...
          children: { type: common_vendor.UTS.UTSType.withGenerics(Array, [HtmlNode]), optional: true },
...
const _sfc_main = common_vendor.defineComponent({
  ...
  methods: {
    ...
    headingStyle(name) {
      var _a;
      const sz = new common_vendor.UTSJSONObject({ h1: "2em", h2: "1.5em", h3: "1.17em", h4: "1em", h5: "0.83em", h6: "0.67em" });
    ...
    onLinkTap(n) {
      ...
      this.$emit("linktap", (_b = n.attrs) !== null && _b !== void 0 ? _b : new common_vendor.UTSJSONObject({}));
      if (href.length > 0 && href.includes("://")) {
        common_vendor.index.setClipboardData({ data: href, success: () => {
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  "raw js";
  return {
    a: common_vendor.f($data.localNodes, (n, i, i0) => {
      return common_vendor.e({
        a: n.type == "text"
      }, n.type == "text" ? {
        b: common_vendor.t(n.text)
      } : n.name == "br" ? {} : n.name == "img" ? {
        e: n.attrs != null ? n.attrs["src"] ?? "" : ""
      } : n.name == "a" ? {
        g: common_vendor.t($options.flatText(n)),
        h: common_vendor.o(($event) => $options.onLinkTap(n), i)
      } : $options.isInline(n.name ?? "") ? {
        j: common_vendor.t($options.flatText(n)),
        k: common_vendor.s($options.inlineStyle(n.name ?? ""))
      } : n.name == "h1" || n.name == "h2" || n.name == "h3" || n.name == "h4" || n.name == "h5" || n.name == "h6" ? {
        m: common_vendor.t($options.flatText(n)),
        n: common_vendor.s($options.headingStyle(n.name ?? ""))
      } : n.name == "pre" || n.name == "code" ? {
        p: common_vendor.t($options.flatText(n))
      } : n.name == "hr" ? {} : n.name == "table" ? {
        s: common_vendor.f(n.children ?? [], (row, ri, i1) => {
          return {
            a: common_vendor.f(row.children ?? [], (cell, ci, i2) => {
              return {
                a: common_vendor.t($options.flatText(cell)),
                b: ci,
                c: common_vendor.s((cell.name == "th" ? "font-weight:bold;background-color:#f5f5f5;" : "") + "flex:1;padding:4px 8px;border-width:1px;border-color:#d0d0d0;border-style:solid")
              };
            }),
            b: ri
          };
        ...
        v: common_vendor.f(n.children ?? [], (li, lii, i1) => {
          return {
            a: common_vendor.t(n.name == "ol" ? (lii + 1).toString() + ". " : "• "),
            b: common_vendor.t($options.flatText(li)),
            c: lii
          };
        })
      } : {
        w: common_vendor.f(n.children ?? [], (cn, ci, i1) => {
          return common_vendor.e({
            a: cn.type == "text"
          }, cn.type == "text" ? {
            b: common_vendor.t(cn.text)
          } : cn.name == "br" ? {} : cn.name == "img" ? {
            e: cn.attrs != null ? cn.attrs["src"] ?? "" : ""
          } : cn.name == "a" ? {
            g: common_vendor.t($options.flatText(cn)),
            h: common_vendor.o(($event) => $options.onLinkTap(cn), ci)
          } : $options.isInline(cn.name ?? "") ? {
            j: common_vendor.t($options.flatText(cn)),
            k: common_vendor.s($options.inlineStyle(cn.name ?? ""))
          } : {
            l: common_vendor.t($options.flatText(cn))
          }, {
            c: cn.name == "br",
            d: cn.name == "img",
            f: cn.name == "a",
            i: $options.isInline(cn.name ?? ""),
            m: ci
          });
        })
      }, {
        ...
        d: n.name == "img",
        f: n.name == "a",
        i: $options.isInline(n.name ?? ""),
        l: n.name == "h1" || n.name == "h2" || n.name == "h3" || n.name == "h4" || n.name == "h5" || n.name == "h6",
        o: n.name == "pre" || n.name == "code",
        q: n.name == "hr",
        r: n.name == "table",
        t: n.name == "ul" || n.name == "ol",
        x: i
      });
    }),
