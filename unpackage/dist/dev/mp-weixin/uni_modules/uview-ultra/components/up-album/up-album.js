...
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent(Object.assign({
  ...
  shape: {
    type: String,
    default: uni_modules_uviewUltra_components_upImage_image.defProps.getString("image.shape")
  },
  // 圆角，单位任意
  radius: {
    type: [String, Number],
    default: uni_modules_uviewUltra_components_upImage_image.defProps.getNumber("image.radius")
  },
  // 自适应换行
  autoWrap: {
    type: Boolean,
