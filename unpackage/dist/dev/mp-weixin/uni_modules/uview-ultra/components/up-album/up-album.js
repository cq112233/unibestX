  ...
  return (_ctx, _cache) => {
    ...
    const __returned__ = {
        ...
        return {
          a: common_vendor.f(arr, (item, index1, i1) => {
            return common_vendor.e({
              ...
              e: __props.shape == "circle" ? "50%" : common_vendor.unref(uni_modules_uviewUltra_libs_function_index.addUnit)(__props.radius)
            } : {}, {
              f: index1,
      ...
      c: common_vendor.s({
        ...
        borderRadius: __props.shape == "circle" ? "10000px" : common_vendor.unref(uni_modules_uviewUltra_libs_function_index.addUnit)(__props.radius)
      }),
