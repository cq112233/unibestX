...
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent(Object.assign({
  ...
  const imageSizeStyle = common_vendor.computed(() => {
    return new common_vendor.UTSJSONObject({
      width: uni_modules_uviewUltra_libs_function_index.addUnit(props.iconSize),
      height: uni_modules_uviewUltra_libs_function_index.addUnit(props.iconSize)
    });
  });
  const formattedIconSize = common_vendor.computed(() => {
  ...
  return (_ctx, _cache) => {
    ...
    const __returned__ = common_vendor.e({
      ...
      b: __props.image,
      c: common_vendor.s(imageSizeStyle.value)
    } : {
      d: common_vendor.p({
      ...
      e: common_vendor.t(__props.loadingText),
