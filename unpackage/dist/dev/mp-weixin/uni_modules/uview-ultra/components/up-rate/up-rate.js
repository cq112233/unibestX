...
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent(Object.assign({
  ...
  const customRateStyle = common_vendor.computed(() => {
    return uni_modules_uviewUltra_libs_function_index.addStyle(props.customStyle);
  });
  const iconPaddingStyle = common_vendor.computed(() => {
    return new common_vendor.UTSJSONObject({
      padding: `0 ${uni_modules_uviewUltra_libs_function_index.addUnit(parseInt(props.gutter.toString()) / 2)}`
    });
  });
  const halfWidthStyle = common_vendor.computed(() => {
    return new common_vendor.UTSJSONObject({
      width: uni_modules_uviewUltra_libs_function_index.addUnit(rateWidth.value / 2)
    });
  });
    ...
    const __returned__ = {
      a: common_vendor.f(parseInt(__props.count.toString()), (_, index, i0) => {
        return common_vendor.e({
          ...
          g: common_vendor.s(halfWidthStyle.value)
        } : {}, {
          h: index
        });
      }),
      ...
      d: common_vendor.o(touchMove, "55"),
      e: common_vendor.o(touchEnd, "8b"),
      f: common_vendor.sei(common_vendor.gei(_ctx, elId.value), "view"),
      g: common_vendor.s(customRateStyle.value),
      h: common_vendor.s({
