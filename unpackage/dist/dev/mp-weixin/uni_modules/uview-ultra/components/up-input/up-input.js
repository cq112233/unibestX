...
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent(Object.assign({
  ...
  const onInput = (e) => {
    ...
    common_vendor.index.__f__("log", "at uni_modules/uview-ultra/components/up-input/up-input.uvue:399", "onInput", value, innerValue.value);
  ...
  return (_ctx, _cache) => {
    ...
    const __returned__ = common_vendor.e({
      ...
      y: common_vendor.o(onInput, "c7"),
      z: common_vendor.o(onBlur, "f4"),
      A: common_vendor.o(onFocus, "06"),
      B: common_vendor.o(onConfirm, "fa"),
      C: common_vendor.o(onkeyboardheightchange, "22"),
      D: common_vendor.o(clickHandler, "f4"),
      E: isShowClear.value
    }, isShowClear.value ? {
      F: common_vendor.p({
        name: "close",
