    ...
    const __returned__ = common_vendor.e({
      ...
      b: common_vendor.f(lists.value, (item, index, i0) => {
        return common_vendor.e({
          ...
          e: common_vendor.s({
            width: common_vendor.unref(uni_modules_uviewUltra_libs_function_index.addUnit)(__props.width),
          ...
          s: common_vendor.unref(uni_modules_uviewUltra_libs_function_index.addUnit)(__props.width),
          t: common_vendor.unref(uni_modules_uviewUltra_libs_function_index.addUnit)(__props.height)
        }) : {
          v: "bac2b514-2-" + i0,
          w: common_vendor.p({
            color: "#80CBF9",
          ...
          x: common_vendor.t(item.isVideo || item.type != null && item.type === "video" ? item.name != null ? item.name : common_vendor.unref(uni_modules_uviewUltra_libs_i18n_index.t)("up.common.video") : item.name != null ? item.name : common_vendor.unref(uni_modules_uviewUltra_libs_i18n_index.t)("up.common.file")),
          ...
          L: item.status !== "uploading" && (__props.deletable || item.deletable)
      ...
      l: common_vendor.o(onChooseTap, "2b"),
      ...
      r: common_vendor.o(videoErrorCallback, "e0"),
      ...
      x: common_vendor.s(common_vendor.unref(uni_modules_uviewUltra_libs_function_index.addStyle)(__props.customStyle)),
      y: common_vendor.s({
