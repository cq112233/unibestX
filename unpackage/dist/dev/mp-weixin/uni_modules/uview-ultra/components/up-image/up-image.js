...
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent({
  ...
  props: {
    src: {
      type: String,
      default: () => {
        return uni_modules_uviewUltra_components_upImage_image.defProps.getString("image.src");
      }
    },
    mode: {
      type: String,
      default: () => {
        return uni_modules_uviewUltra_components_upImage_image.defProps.getString("image.mode");
      }
    },
    width: {
      type: String,
      default: () => {
        return uni_modules_uviewUltra_components_upImage_image.defProps.getString("image.width");
      }
    },
    height: {
      type: String,
      default: () => {
        return uni_modules_uviewUltra_components_upImage_image.defProps.getString("image.height");
      }
    },
    shape: {
      type: String,
      default: () => {
        return uni_modules_uviewUltra_components_upImage_image.defProps.getString("image.shape");
      }
    },
    radius: {
      type: String,
      default: () => {
        return uni_modules_uviewUltra_components_upImage_image.defProps.getString("image.radius");
      }
    },
    lazyLoad: {
      type: Boolean,
      default: () => {
        return uni_modules_uviewUltra_components_upImage_image.defProps.getBoolean("image.lazyLoad");
      }
    },
    showMenuByLongpress: {
      type: Boolean,
      default: () => {
        return uni_modules_uviewUltra_components_upImage_image.defProps.getBoolean("image.showMenuByLongpress");
      }
    },
    loadingIcon: {
      type: String,
      default: () => {
        return uni_modules_uviewUltra_components_upImage_image.defProps.getString("image.loadingIcon");
      }
    },
    errorIcon: {
      type: String,
      default: () => {
        return uni_modules_uviewUltra_components_upImage_image.defProps.getString("image.errorIcon");
      }
    },
    showLoading: {
      type: Boolean,
      default: () => {
        return uni_modules_uviewUltra_components_upImage_image.defProps.getBoolean("image.showLoading");
      }
    },
    showError: {
      type: Boolean,
      default: () => {
        return uni_modules_uviewUltra_components_upImage_image.defProps.getBoolean("image.showError");
      }
    },
    fade: {
      type: Boolean,
      default: () => {
        return uni_modules_uviewUltra_components_upImage_image.defProps.getBoolean("image.fade");
      }
    },
    webp: {
      type: Boolean,
      default: () => {
        return uni_modules_uviewUltra_components_upImage_image.defProps.getBoolean("image.webp");
      }
    },
    duration: {
      type: Number,
      default: () => {
        return uni_modules_uviewUltra_components_upImage_image.defProps.getNumber("image.duration");
      }
    },
    bgColor: {
      type: String,
      default: () => {
        return uni_modules_uviewUltra_components_upImage_image.defProps.getString("image.bgColor");
      }
    },
    customStyle: {
      type: [Object, String],
  ...
  setup(__props, _a) {
    ...
    common_vendor.ref(1);
    const backgroundStyle = common_vendor.ref(new common_vendor.UTSJSONObject({}));
    ...
    const removeBgColor = () => {
      backgroundStyle.value = new common_vendor.UTSJSONObject({
