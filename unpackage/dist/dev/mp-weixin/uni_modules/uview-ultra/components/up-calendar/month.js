  ...
  return {
    a: common_vendor.f($data.monthsInner, (item, index, i0) => {
      return common_vendor.e({
        ...
        f: common_vendor.sei(`month-` + index.toString() !== "" ? `month-` + index.toString() : "r0-35c61338-index", "view", `up-calendar-month-` + index.toString(), {
          "f": 1
        }),
        g: index,
        h: common_vendor.n(`up-calendar-month-` + index.toString()),
        i: `up-calendar-month-` + index.toString()
      });
    }),
    b: $props.showMark,
