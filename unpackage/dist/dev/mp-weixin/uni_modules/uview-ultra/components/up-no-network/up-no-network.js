    ...
    retry() {
      common_vendor.index.getNetworkType(new common_vendor.UTSJSONObject({
        success: (res) => {
          ...
          this.emitEvent(this.networkType);
          if (res.networkType == "none") {
            uni_modules_uviewUltra_libs_function_index.toast(uni_modules_uviewUltra_libs_i18n_index.t("up.noNetwork.disconnect", new common_vendor.UTSJSONObject({})));
            this.isConnected = false;
          } else {
            uni_modules_uviewUltra_libs_function_index.toast(uni_modules_uviewUltra_libs_i18n_index.t("up.noNetwork.connect", new common_vendor.UTSJSONObject({})));
            this.isConnected = true;
          }
        }
      }));
