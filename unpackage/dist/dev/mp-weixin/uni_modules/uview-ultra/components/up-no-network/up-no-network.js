...
const _sfc_main = common_vendor.defineComponent({
  ...
  methods: {
    t(s) {
      return uni_modules_uviewUltra_libs_i18n_index.t(s, new UTSJSONObject({}));
    },
    retry() {
      common_vendor.index.getNetworkType(new UTSJSONObject({
        success: (res) => {
          ...
          this.emitEvent(this.networkType);
          if (res.networkType == "none") {
            uni_modules_uviewUltra_libs_function_index.toast(uni_modules_uviewUltra_libs_i18n_index.t("up.noNetwork.disconnect", new UTSJSONObject({})));
            this.isConnected = false;
          } else {
            uni_modules_uviewUltra_libs_function_index.toast(uni_modules_uviewUltra_libs_i18n_index.t("up.noNetwork.connect", new UTSJSONObject({})));
            this.isConnected = true;
          }
        }
      }));
