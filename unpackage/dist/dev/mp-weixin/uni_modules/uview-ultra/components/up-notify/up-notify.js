...
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent(Object.assign({
  ...
  return (_ctx, _cache) => {
    ...
    const __returned__ = common_vendor.e({
      ...
      c: ["success", "warning", "error"].includes(tmpConfig.value["type"].toString())
    }, ["success", "warning", "error"].includes(tmpConfig.value["type"].toString()) ? {
      d: common_vendor.p({
        name: tmpConfig.value["icon"],
        color: tmpConfig.value["color"],
        size: 1.3 * parseFloat(common_vendor.unref(uni_modules_uviewUltra_libs_function_index.getPx)(tmpConfig.value["fontSize"] ?? "0").toString()),
        customStyle: {
          marginRight: "4px"
        },
        class: "data-v-21e8743e"
      ...
      f: common_vendor.unref(uni_modules_uviewUltra_libs_function_index.addUnit)(tmpConfig.value["fontSize"] ?? "0"),
      g: tmpConfig.value["color"] ?? "",
      h: common_vendor.n(`up-notify--${tmpConfig.value["type"]}`),
      i: common_vendor.s(backgroundColor.value),
