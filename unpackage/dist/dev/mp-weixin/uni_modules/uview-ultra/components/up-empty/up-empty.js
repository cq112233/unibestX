...
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent(Object.assign({
  ...
  const props = __props;
  const icons = common_vendor.computed(() => {
    return new UTSJSONObject({
      car: uni_modules_uviewUltra_libs_i18n_index.t("up.empty.car", new UTSJSONObject({})),
      page: uni_modules_uviewUltra_libs_i18n_index.t("up.empty.page", new UTSJSONObject({})),
      search: uni_modules_uviewUltra_libs_i18n_index.t("up.empty.search", new UTSJSONObject({})),
      address: uni_modules_uviewUltra_libs_i18n_index.t("up.empty.address", new UTSJSONObject({})),
      wifi: uni_modules_uviewUltra_libs_i18n_index.t("up.empty.wifi", new UTSJSONObject({})),
      order: uni_modules_uviewUltra_libs_i18n_index.t("up.empty.order", new UTSJSONObject({})),
      coupon: uni_modules_uviewUltra_libs_i18n_index.t("up.empty.coupon", new UTSJSONObject({})),
      favor: uni_modules_uviewUltra_libs_i18n_index.t("up.empty.favor", new UTSJSONObject({})),
      permission: uni_modules_uviewUltra_libs_i18n_index.t("up.empty.permission", new UTSJSONObject({})),
      history: uni_modules_uviewUltra_libs_i18n_index.t("up.empty.history", new UTSJSONObject({})),
      news: uni_modules_uviewUltra_libs_i18n_index.t("up.empty.news", new UTSJSONObject({})),
      message: uni_modules_uviewUltra_libs_i18n_index.t("up.empty.message", new UTSJSONObject({})),
      list: uni_modules_uviewUltra_libs_i18n_index.t("up.empty.list", new UTSJSONObject({})),
      data: uni_modules_uviewUltra_libs_i18n_index.t("up.empty.data", new UTSJSONObject({})),
      comment: uni_modules_uviewUltra_libs_i18n_index.t("up.empty.comment", new UTSJSONObject({}))
    });
  });
