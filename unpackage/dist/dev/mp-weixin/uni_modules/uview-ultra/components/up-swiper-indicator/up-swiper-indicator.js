...
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent(Object.assign({
  ...
  const lineWrapperStyle = common_vendor.computed(() => {
    return new common_vendor.UTSJSONObject({
      width: uni_modules_uviewUltra_libs_function_index.addUnit(lineWidth.value * parseInt(props.length.toString())),
  ...
  return (_ctx, _cache) => {
    ...
    const __returned__ = common_vendor.e({
      ...
      d: common_vendor.s(lineWrapperStyle.value)
    } : {}, {
      e: __props.indicatorMode === "dot"
    }, __props.indicatorMode === "dot" ? {
      f: common_vendor.f(lengthArray.value, (item, index, i0) => {
        return {
          a: index,
