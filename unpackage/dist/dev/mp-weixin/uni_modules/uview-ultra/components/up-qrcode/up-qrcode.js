...
const _sfc_main = common_vendor.defineComponent({
  ...
  computed: {
    ...
    cellSize() {
      return this.sizeLocal / uni_modules_uviewUltra_components_upQrcode_qrcode.getQrRenderCountWithQuietZone(this.val, this.lv, this.quietZone);
    },
    canvasStyle() {
      return new UTSJSONObject({
        width: this.sizeLocal.toString() + this.unit,
  ...
  methods: {
    makeCode() {
      ...
      try {
        this.loading = true;
        this.error = "";
        this.cells = uni_modules_uviewUltra_components_upQrcode_qrcode.createQrCells(this.val, this.foreground, this.background, this.pdground, this.lv, this.quietZone);
    ...
    drawQrToCanvas() {
      ...
      const count = uni_modules_uviewUltra_components_upQrcode_qrcode.getQrRenderCountWithQuietZone(this.val, this.lv, this.quietZone);
