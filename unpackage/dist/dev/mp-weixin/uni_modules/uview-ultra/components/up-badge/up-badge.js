...
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent(Object.assign({
  ...
  isDot: {
    type: Boolean,
    default: uni_modules_uviewUltra_components_upBadge_badge.defProps.getBoolean("badge.isDot")
  },
  // 显示的内容
  value: {
    type: [Number, String],
    default: uni_modules_uviewUltra_components_upBadge_badge.defProps.getString("badge.value")
  },
  // 显示的内容
  modelValue: {
    type: [Number, String],
    default: uni_modules_uviewUltra_components_upBadge_badge.defProps.getString("badge.modelValue")
  },
  // 是否显示
  show: {
    type: Boolean,
    default: uni_modules_uviewUltra_components_upBadge_badge.defProps.getBoolean("badge.show")
  },
  // 最大值，超过最大值会显示 '{max}+'
  max: {
    type: [Number, String],
    default: uni_modules_uviewUltra_components_upBadge_badge.defProps.getNumber("badge.max")
  },
  // 主题类型，error|warning|success|primary
  type: {
    type: String,
    default: uni_modules_uviewUltra_components_upBadge_badge.defProps.getString("badge.type")
  },
  // 当数值为 0 时，是否展示 Badge
  showZero: {
    type: Boolean,
    default: uni_modules_uviewUltra_components_upBadge_badge.defProps.getBoolean("badge.showZero")
  },
  // 背景颜色，优先级比type高，如设置，type参数会失效
  bgColor: {
    type: String,
    default: uni_modules_uviewUltra_components_upBadge_badge.defProps.getString("badge.bgColor")
  },
  // 字体颜色
  color: {
    type: String,
    default: uni_modules_uviewUltra_components_upBadge_badge.defProps.getString("badge.color")
  },
  // 徽标形状，circle-四角均为圆角，horn-左下角为直角
  shape: {
    type: String,
    default: uni_modules_uviewUltra_components_upBadge_badge.defProps.getString("badge.shape")
  },
  ...
  numberType: {
    type: String,
    default: uni_modules_uviewUltra_components_upBadge_badge.defProps.getString("badge.numberType")
  },
  // 设置badge的位置偏移，格式为 [x, y]，也即设置的为top和right的值，absolute为true时有效
  offset: {
    type: Array,
    default: uni_modules_uviewUltra_components_upBadge_badge.defProps.getArray("badge.offset")
  },
  // 是否反转背景和字体颜色
  inverted: {
    type: Boolean,
    default: uni_modules_uviewUltra_components_upBadge_badge.defProps.getBoolean("badge.inverted")
  },
  // 是否绝对定位
  absolute: {
    type: Boolean,
    default: uni_modules_uviewUltra_components_upBadge_badge.defProps.getBoolean("badge.absolute")
  }
}, setup(__props) {
  const props = __props;
