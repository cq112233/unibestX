...
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent(Object.assign({
  ...
  const spinnerStyle = common_vendor.ref([
  ...
  const otherBorderColor = common_vendor.computed(() => {
    const lightColor = uni_modules_uviewUltra_libs_function_colorGradient.colorGradient(props.color, "#ffffff", 100)[80];
  ...
  return (_ctx, _cache) => {
    ...
    const __returned__ = common_vendor.e({
      ...
      d: common_vendor.f(array12, (item, index, i0) => {
        return {
          a: index,
          b: common_vendor.s(spinnerStyle.value[index]),
          c: common_vendor.s(getSpinnerDotStyle(index))
        };
      })
    } : {}, {
      ...
      g: transform.value,
      h: common_vendor.unref(uni_modules_uviewUltra_libs_function_index.addUnit)(__props.size),
      i: common_vendor.unref(uni_modules_uviewUltra_libs_function_index.addUnit)(__props.size),
      j: __props.color,
      k: otherBorderColor.value,
      l: otherBorderColor.value,
      m: otherBorderColor.value
    }) : {}, {
      n: __props.text != ""
    }, __props.text != "" ? {
      o: common_vendor.t(__props.text),
      p: common_vendor.unref(uni_modules_uviewUltra_libs_function_index.addUnit)(__props.textSize),
      q: __props.textColor
    } : {}, {
      r: common_vendor.sei(common_vendor.gei(_ctx, ""), "view"),
      s: common_vendor.s(common_vendor.unref(uni_modules_uviewUltra_libs_function_index.addStyle)(__props.customStyle)),
      t: common_vendor.s({
        "--status-bar-height": `${_ctx.u_s_b_h}px`,
        "--uni-safe-area-inset-bottom": `${_ctx.u_s_a_i_b}px`
      }),
      v: common_vendor.n(__props.vertical ? "up-loading-icon--vertical" : ""),
