...
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent(Object.assign({
  ...
  const contentHeightStyle = common_vendor.computed(() => {
    return new common_vendor.UTSJSONObject({ height: uni_modules_uviewUltra_libs_function_index.addUnit(height.value) });
  });
  ...
  return (_ctx, _cache) => {
    ...
    const __returned__ = common_vendor.e({
      ...
      m: elId.value,
      n: common_vendor.s(contentHeightStyle.value),
