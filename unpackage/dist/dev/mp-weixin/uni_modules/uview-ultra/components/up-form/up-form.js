...
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent(Object.assign({
  ...
  const props = __props;
  const formRules = common_vendor.ref(new UTSJSONObject({}));
  const validator = common_vendor.ref(new uni_modules_uviewUltra_libs_util_asyncValidator.Schema(new UTSJSONObject({})));
        ...
        return new Promise((resolveChild) => {
          ...
          if (validateProps.includes(childProps["prop"].toString())) {
            ...
            if (rule == null || rule.length == 0) {
              common_vendor.index.__f__("log", "at uni_modules/uview-ultra/components/up-form/up-form.uvue:191", "rule-miss", childProps["prop"].toString(), UTSJSONObject.keys(formRules.value));
              resolveChild([]);
              return null;
            }
            let rules = [];
            ...
            for (let i = 0; i < rules.length; i++) {
              ...
              executeRuleCount += 1;
              const validator_1 = new uni_modules_uviewUltra_libs_util_asyncValidator.Schema(new UTSJSONObject({
