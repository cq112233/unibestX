  ...
  return (_ctx, _cache) => {
    ...
    const __returned__ = common_vendor.e({
      ...
      b: common_vendor.p({
        ...
        size: common_vendor.unref(uni_modules_uviewUltra_libs_function_index.addUnit)(__props.loadingSize * 1.15),
      ...
      f: common_vendor.p({
        ...
        size: common_vendor.unref(uni_modules_uviewUltra_libs_function_index.addUnit)(parseInt(common_vendor.unref(uni_modules_uviewUltra_libs_function_index.getPx)(textSize.value)) * 1.35),
        customStyle: {
          marginRight: "2px"
        },
        class: "data-v-0816b018"
      ...
      w: common_vendor.o(getphonenumber, "91"),
      x: common_vendor.o(getuserinfo, "35"),
      y: common_vendor.o(error, "aa"),
      z: common_vendor.o(opensetting, "15"),
      A: common_vendor.o(launchapp, "51"),
      B: __props.loading,
