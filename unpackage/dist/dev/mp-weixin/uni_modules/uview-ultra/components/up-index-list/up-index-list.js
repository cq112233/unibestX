...
if (!Array) {
  ...
  (_easycom_up_index_anchor_1 + _easycom_up_transition_1)();
}
const _easycom_up_index_anchor = () => "../up-index-anchor/up-index-anchor.js";
const _easycom_up_transition = () => "../up-transition/up-transition.js";
if (!Math) {
  (_easycom_up_index_anchor + _easycom_up_transition)();
}
...
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent(Object.assign({
  ...
  const letterInfo = common_vendor.ref(new common_vendor.UTSJSONObject({
    height: 0,
    itemHeight: 0,
    top: 0
  }));
    ...
    return common_vendor.__awaiter(this, void 0, void 0, function* () {
      ...
      if (currentIndex !== activeIndex.value) {
        ...
        let childrenItems = children.value.map((item, index) => {
          ...
          const child = new common_vendor.UTSJSONObject(
            {
              height: childHeight,
              top: top_1
            }
  ...
  return (_ctx, _cache) => {
    ...
    const __returned__ = common_vendor.e({
      a: __props.sticky && activeIndex.value >= 0 && activeIndex.value < uIndexList.value.length
    }, __props.sticky && activeIndex.value >= 0 && activeIndex.value < uIndexList.value.length ? {
      b: common_vendor.p({
        text: keyVal(uIndexList.value[activeIndex.value]),
        class: "data-v-12381c23"
      })
    } : {}, {
      c: _ctx.$slots["header"] != null
    }, _ctx.$slots["header"] != null ? {} : {}, {
      d: _ctx.$slots["footer"] != null
      ...
      k: common_vendor.unref(uni_modules_uviewUltra_libs_function_index.addUnit)(letterInfo.value["top"] ?? ""),
      l: common_vendor.o(touchStart, "37"),
      m: common_vendor.o(touchMove, "95"),
      n: common_vendor.o(touchEnd, "96"),
      o: common_vendor.o(touchEnd, "68"),
      p: common_vendor.t(activeIndex.value >= 0 ? keyVal(uIndexList.value[activeIndex.value]) : ""),
      q: common_vendor.unref(uni_modules_uviewUltra_libs_function_index.addUnit)(indicatorHeight.value),
      r: common_vendor.unref(uni_modules_uviewUltra_libs_function_index.addUnit)(indicatorHeight.value),
      s: common_vendor.p({
        mode: "fade",
        show: touching.value,
        customStyle: {
          position: "absolute",
          right: "30px",
          top: common_vendor.unref(uni_modules_uviewUltra_libs_function_index.addUnit)(indicatorTop.value, "px"),
          width: common_vendor.unref(uni_modules_uviewUltra_libs_function_index.addUnit)(indicatorHeight.value + 10),
          zIndex: 3
        },
        class: "data-v-12381c23"
      }),
