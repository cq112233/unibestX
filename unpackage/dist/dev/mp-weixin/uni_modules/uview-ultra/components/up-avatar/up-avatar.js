...
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent(Object.assign({
  ...
  return (_ctx, _cache) => {
    ...
    const __returned__ = common_vendor.e({
      ...
      g: __props.mode,
      h: common_vendor.o(errorHandler, "90"),
      i: common_vendor.s({
        width: common_vendor.unref(uni_modules_uviewUltra_libs_function_index.addUnit)(__props.size),
        height: common_vendor.unref(uni_modules_uviewUltra_libs_function_index.addUnit)(__props.size)
      })
    }, {
      c: __props.text != "",
      ...
      p: common_vendor.o(clickHandler, "1f")
    });
    return __returned__;
  };
} }));
