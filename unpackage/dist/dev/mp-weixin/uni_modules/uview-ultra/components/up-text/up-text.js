...
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent(Object.assign({
  ...
  const customIconStyle = common_vendor.computed(() => {
  ...
  return (_ctx, _cache) => {
    ...
    const __returned__ = common_vendor.e({
      ...
      q: __props.openType,
      r: common_vendor.o(onGetUserInfo, "70"),
      s: common_vendor.o(onContact, "84"),
      t: common_vendor.o(onGetPhoneNumber, "a8"),
      v: common_vendor.o(onError, "0a"),
      w: common_vendor.o(onLaunchApp, "4c"),
      x: common_vendor.o(onOpenSetting, "59"),
      y: __props.lang,
