...
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent(Object.assign({
  ...
  const tagMergedStyle = common_vendor.computed(() => {
    const marginObj = new common_vendor.UTSJSONObject({
      marginRight: props.closable ? "10px" : "0px",
      marginTop: props.closable ? "10px" : "0px"
    });
    return uni_modules_uviewUltra_libs_function_index.deepMerge(marginObj, style.value);
  });
  ...
  const isImageIcon = common_vendor.computed(() => {
    return uni_modules_uviewUltra_libs_function_test.image(props.icon);
  });
  ...
  return (_ctx, _cache) => {
    ...
    const __returned__ = common_vendor.e({
      ...
      q: common_vendor.s(tagMergedStyle.value),
      r: __props.closable
    }, __props.closable ? {
      s: common_vendor.p({
        name: "close",
      ...
      t: common_vendor.n(`up-tag__close--${__props.size}`),
      v: common_vendor.o(closeHandler, "7f"),
      w: common_vendor.s(closeStyle.value)
    } : {}, {
