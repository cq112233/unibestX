...
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent(Object.assign({
  ...
  return (_ctx, _cache) => {
    ...
    const __returned__ = common_vendor.e({
      ...
      c: common_vendor.o(close, "03"),
      d: common_vendor.o(click, "1a"),
      e: common_vendor.p({
        color: __props.color,
      ...
      f: common_vendor.o(close, "14"),
      g: common_vendor.o(click, "97"),
      h: common_vendor.p({
        color: __props.color,
        bgColor: __props.bgColor,
        text: __props.text,
      ...
      k: common_vendor.s(common_vendor.unref(uni_modules_uviewUltra_libs_function_index.addStyle)(__props.customStyle)),
      l: common_vendor.s({
