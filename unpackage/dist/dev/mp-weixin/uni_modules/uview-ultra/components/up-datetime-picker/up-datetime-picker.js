...
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent({
  ...
  setup(__props, _a) {
    ...
    function change(e) {
      ...
      let selectValue = "";
      if (props.mode === "time" || props.mode === "timesecond") {
        const hourText = safeColumnValue(values, 0, indexs[0], uni_modules_uviewUltra_libs_function_index.padZero(props.minHour));
        const minuteText = safeColumnValue(values, 1, indexs[1], uni_modules_uviewUltra_libs_function_index.padZero(props.minMinute));
        const secondText = safeColumnValue(values, 2, indexs[2], uni_modules_uviewUltra_libs_function_index.padZero(props.minSecond));
        ...
        const monthText = safeColumnValue(values, 1, indexs[1], uni_modules_uviewUltra_libs_function_index.padZero(currentMonth));
        ...
        const dayText = safeColumnValue(values, 2, indexs[2], uni_modules_uviewUltra_libs_function_index.padZero(Math.min(currentDate, maxDate)));
        ...
        if (props.mode === "datehour" || props.mode === "datetime" || props.mode === "datetimesecond") {
          const hourText = safeColumnValue(values, 3, indexs[3], uni_modules_uviewUltra_libs_function_index.padZero(currentHour));
          hour = uni_modules_uviewUltra_libs_function_index.range(0, 23, toInt(intercept(hourText), currentHour));
        }
        if (props.mode === "datetime" || props.mode === "datetimesecond") {
          const minuteText = safeColumnValue(values, 4, indexs[4], uni_modules_uviewUltra_libs_function_index.padZero(currentMinute));
          minute = uni_modules_uviewUltra_libs_function_index.range(0, 59, toInt(intercept(minuteText), currentMinute));
        }
        if (props.mode === "datetimesecond") {
          const secondText = safeColumnValue(values, 5, indexs[5], uni_modules_uviewUltra_libs_function_index.padZero(currentSecond));
