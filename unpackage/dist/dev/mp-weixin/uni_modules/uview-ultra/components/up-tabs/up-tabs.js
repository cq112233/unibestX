...
const _sfc_main = common_vendor.defineComponent({
  ...
  methods: {
    ...
    clickHandler(item = null, index) {
      this.$emit("click", new common_vendor.UTSJSONObject(Object.assign(Object.assign({}, item), { index })), index);
      ...
      this.$emit("change", new common_vendor.UTSJSONObject(Object.assign(Object.assign({}, item), { index })), index);
    },
    // 长按事件
    longPressHandler(item, index) {
      this.$emit("longPress", new common_vendor.UTSJSONObject(Object.assign(Object.assign({}, item), { index })));
    },
    init() {
      this.retryCount = 0;
