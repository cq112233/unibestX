...
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent(Object.assign({
  ...
  const tabsWrapperStyle = common_vendor.computed(() => {
    return new common_vendor.UTSJSONObject({
      height: uni_modules_uviewUltra_libs_function_index.addUnit(props.height)
    });
  });
  const iconCustomStyle = common_vendor.computed(() => {
    return uni_modules_uviewUltra_libs_function_index.addStyle(props.iconStyle);
  });
  ...
  function getItemStyle() {
    const custom = uni_modules_uviewUltra_libs_function_index.addStyle(props.itemStyle);
  ...
  function getTabsRect() {
    return uni_modules_uviewUltra_libs_function_index.upGetRect(".up-tabs__wrapper__scroll-view", false, instance === null || instance === void 0 ? null : instance.proxy);
  }
  function getAllItemRect() {
    return new Promise((resolve) => {
      ...
      for (let i = 0; i < total; i++) {
        const idx = i;
        uni_modules_uviewUltra_libs_function_index.upGetRect(`.up-tabs__wrapper__nav__item-${idx}`, false, instance === null || instance === void 0 ? null : instance.proxy).then((size) => {
          results.push(size);
          count++;
          if (count == total) {
            resolve(results);
  ...
  function setScrollLeft() {
    ...
    nextScrollLeft = Math.min(nextScrollLeft, scrollViewWidth.value - ((_g = tabsRect.value.width) !== null && _g !== void 0 ? _g : 0));
  ...
  function resize() {
    ...
    getTabsRect().then((tRect) => {
      getAllItemRect().then((iRect) => {
        var _a2, _b, _c, _d, _g, _h, _j, _k, _l, _m;
        ...
        if (((_b = tRect.left) !== null && _b !== void 0 ? _b : 0) > ((_c = tRect.width) !== null && _c !== void 0 ? _c : 0)) {
          tRect.right = ((_d = tRect.right) !== null && _d !== void 0 ? _d : 0) - Math.floor(((_g = tRect.left) !== null && _g !== void 0 ? _g : 0) / ((_h = tRect.width) !== null && _h !== void 0 ? _h : 0)) * ((_j = tRect.width) !== null && _j !== void 0 ? _j : 0);
        ...
        for (let i = 0; i < iRect.length; i++) {
          const item = iRect[i];
          if (item != null) {
            scrollViewWidth.value = scrollViewWidth.value + ((_m = item.width) !== null && _m !== void 0 ? _m : 0);
          }
        }
        setLineLeft();
        setScrollLeft();
  ...
  return (_ctx, _cache) => {
    ...
    const __returned__ = {
      ...
      e: common_vendor.s(getItemStyle()),
      f: common_vendor.sei("r1-518f641c", "view", "up-tabs__wrapper__nav__line"),
      g: common_vendor.s(lineStyle.value),
      h: common_vendor.sei("r2-518f641c", "view", "up-tabs__wrapper__nav"),
      i: common_vendor.s(tabsWrapperStyle.value),
      j: common_vendor.sei("r3-518f641c", "scroll-view", "up-tabs__wrapper__scroll-view"),
      k: scrollLeft.value,
      l: common_vendor.s(tabsWrapperStyle.value),
      m: (__props.scrollable ? "horizontal" : "none") === "horizontal" || (__props.scrollable ? "horizontal" : "none") === "all",
      n: !(__props.scrollable ? "horizontal" : "none") || (__props.scrollable ? "horizontal" : "none") === "vertical" || (__props.scrollable ? "horizontal" : "none") === "all",
      o: common_vendor.s(tabsWrapperStyle.value),
