  ...
  computed: {
    ...
    webMpStyle() {
      ...
      if (!this.disabled) {
        ...
        const top_1 = parseFloat(uni_modules_uviewUltra_libs_function_index.getPx(this.offsetTop)) + parseFloat(uni_modules_uviewUltra_libs_function_index.getPx(this.customNavHeight));
        style["top"] = top_1 + "px";
        style["zIndex"] = this.uZindex;
      } else {
