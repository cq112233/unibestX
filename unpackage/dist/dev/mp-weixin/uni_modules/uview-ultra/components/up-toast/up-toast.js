...
const _sfc_main = common_vendor.defineComponent({
  ...
  data() {
    return {
      ...
      tmpConfig: new common_vendor.UTSJSONObject({
        message: "",
        type: "",
        zIndex: 10090,
        duration: 2e3,
  ...
  computed: {
    ...
    // 内容盒子的样式
    contentStyle() {
      const windowHeight = uni_modules_uviewUltra_libs_function_index.getWindowInfo().windowHeight, style = new common_vendor.UTSJSONObject({});
      let value = 0;
  ...
  methods: {
    primary(message) {
      this.show(new common_vendor.UTSJSONObject({
        type: "primary",
        message
      }));
    },
