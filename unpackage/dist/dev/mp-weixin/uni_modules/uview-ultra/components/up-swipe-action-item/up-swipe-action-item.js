...
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent(Object.assign({
  ...
  return (_ctx, _cache) => {
    ...
    const __returned__ = {
      ...
      c: common_vendor.o(clickHandler, "a5"),
      d: common_vendor.o(touchstart, "16"),
      e: common_vendor.o(touchmove, "14"),
      f: common_vendor.o(touchend, "ca"),
      g: common_vendor.o(touchcancel, "c9"),
