...
const _sfc_main = common_vendor.defineComponent({
  ...
  data() {
    return {
      // 按钮的尺寸信息
      size: new common_vendor.UTSJSONObject({}),
      ...
      status: "",
      sliderStyle: new common_vendor.UTSJSONObject({}),
      state: new common_vendor.UTSJSONObject({
        moving: false,
        startX: 0,
        startY: 0,
        buttonsWidth: 0
  ...
  methods: {
    ...
    getOptionStyle(item) {
      ...
      try {
        const m = style;
        const obj = new common_vendor.UTSJSONObject({});
    ...
    openSwipeAction() {
      ...
      this.sliderStyle = new common_vendor.UTSJSONObject({
