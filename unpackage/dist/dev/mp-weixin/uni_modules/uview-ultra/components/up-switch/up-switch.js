...
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent(Object.assign({
  ...
  const loadingIconSize = common_vendor.computed(() => {
    return parseInt(uni_modules_uviewUltra_libs_function_index.getPx(props.size)) * 0.6;
  });
  ...
  const mergedSwitchStyle = common_vendor.computed(() => {
    return uni_modules_uviewUltra_libs_function_index.deepMerge(switchStyle.value, uni_modules_uviewUltra_libs_function_index.addStyle(props.customStyle));
  });
  ...
  return (_ctx, _cache) => {
    ...
    const __returned__ = common_vendor.e({
      ...
      k: common_vendor.s(mergedSwitchStyle.value),
      l: common_vendor.s({
        "--status-bar-height": `${_ctx.u_s_b_h}px`,
        "--uni-safe-area-inset-bottom": `${_ctx.u_s_a_i_b}px`
      }),
      m: common_vendor.o(clickHandler, "cd")
    });
    return __returned__;
  };
} }));
