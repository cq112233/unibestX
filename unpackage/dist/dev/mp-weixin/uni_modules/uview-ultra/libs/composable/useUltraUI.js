...
new common_vendor.UTSJSONObject({
  ...
  customStyle: new common_vendor.UTSJSONObject({
    type: [common_vendor.UTSJSONObject, String],
    default: new common_vendor.UTSJSONObject({})
  }),
  customClass: new common_vendor.UTSJSONObject({
    type: String,
    default: ""
  }),
  // 跳转的页面路径
  url: new common_vendor.UTSJSONObject({
    type: String,
    default: ""
  }),
  // 页面跳转的类型
  linkType: new common_vendor.UTSJSONObject({
    type: String,
    default: "navigateTo"
  })
});
class UPUseUltraUIType extends common_vendor.UTS.UTSType {
...
function useUltraUI(parentDataInit = new common_vendor.UTSJSONObject({})) {
  const parent = common_vendor.ref(null);
  const parentData = common_vendor.ref(parentDataInit);
  const children = common_vendor.ref([]);
  const childrenRefs = common_vendor.ref([]);
  ...
  const getParent = function(name, instance) {
    let parentTmp = uni_modules_uviewUltra_libs_function_index.getParentFunc(name, instance);
  ...
  const getParentData = function(parentName, instance, refMode) {
    ...
    if (parentIns != null) {
      ...
      common_vendor.UTSJSONObject.keys(parentData.value).map((key) => {
        const propsData = parentIns === null || parentIns === void 0 ? null : parentIns.$callMethod("getProps");
        if (propsData != null && common_vendor.UTSJSONObject.keys(propsData).includes(key)) {
          parentData.value[key] = propsData[key];
        }
        const refsData = parentIns === null || parentIns === void 0 ? null : parentIns.$callMethod("getRefs");
        if (refsData != null && common_vendor.UTSJSONObject.keys(refsData).includes(key)) {
...
exports.useUltraUI = useUltraUI;
//# sourceMappingURL=../../../../../.sourcemap/mp-weixin/uni_modules/uview-ultra/libs/composable/useUltraUI.js.map
