...
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent({
  ...
  props: {
    ...
    listIs: {
      type: String,
      default: uni_modules_zPagingX_components_zPagingX_config_index.gc("list-is", "list-view")
    },
    /**
     * @description list的id
     * @default ''
    ...
    customNestedScroll: {
      type: Boolean,
      default: uni_modules_zPagingX_components_zPagingX_config_index.gc("custom-nested-scroll", false)
    },
    /**
    ...
    startNestedScroll: {
      type: Boolean,
      default: uni_modules_zPagingX_components_zPagingX_config_index.gc("start-nested-scroll", false)
    },
    /**
