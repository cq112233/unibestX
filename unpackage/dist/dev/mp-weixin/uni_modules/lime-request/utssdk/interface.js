...
class LimeRequestSource extends common_vendor.UTS.UTSType {
...
class LimeRequestFail extends common_vendor.UTS.UTSType {
  static get$UTSMetadata$() {
    return {
      kind: 2,
      get fields() {
...
class LimeRequestHandler extends common_vendor.UTS.UTSType {
...
class LimeReducerFactoryResult extends common_vendor.UTS.UTSType {
  static get$UTSMetadata$(T) {
    return {
      kind: 2,
      get fields() {
...
class LimeInterceptors extends common_vendor.UTS.UTSType {
  static get$UTSMetadata$(T, U) {
    return {
      kind: 2,
      get fields() {
        return {
          request: { type: common_vendor.UTS.UTSType.withGenerics(LimeReducerFactoryResult, ["Unknown"]), optional: false },
          response: { type: common_vendor.UTS.UTSType.withGenerics(LimeReducerFactoryResult, ["Unknown"]), optional: false }
        };
      },
...
class LimeRequestConfig extends common_vendor.UTS.UTSType {
  static get$UTSMetadata$() {
    return {
      kind: 2,
      get fields() {
        return {
          ...
          files: { type: common_vendor.UTS.UTSType.withGenerics(Array, ["Unknown"]), optional: true },
...
exports.LimeInterceptors = LimeInterceptors;
exports.LimeReducerFactoryResult = LimeReducerFactoryResult;
exports.LimeRequestConfig = LimeRequestConfig;
exports.LimeRequestFail = LimeRequestFail;
exports.LimeRequestHandler = LimeRequestHandler;
//# sourceMappingURL=../../../../.sourcemap/mp-weixin/uni_modules/lime-request/utssdk/interface.js.map
