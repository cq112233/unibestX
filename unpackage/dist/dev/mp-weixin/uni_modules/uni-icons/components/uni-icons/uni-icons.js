...
const _sfc_main = common_vendor.defineComponent({
  ...
  computed: {
    ...
    styleObj() {
      if (this.fontFamily !== "") {
        return new common_vendor.UTSJSONObject({ color: this.color, fontSize: this.iconSize, fontFamily: this.fontFamily });
      }
      return new common_vendor.UTSJSONObject({ color: this.color, fontSize: this.iconSize });
    }
  },
  created() {
  },
