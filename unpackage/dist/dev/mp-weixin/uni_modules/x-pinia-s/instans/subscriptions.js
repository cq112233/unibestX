  ...
  trigger(mutation, state) {
    ...
    for (let i = 0; i < snapshot.length; i++) {
      try {
        ...
        common_vendor.index.__f__("warn", "at uni_modules/x-pinia-s/instans/subscriptions.uts:54", "[x-pinia-s] state subscription error:", e);
      }
    }
  }
  /** 清空全部订阅 */
  ...
  trigger(ctx) {
    ...
    for (let i = 0; i < snapshot.length; i++) {
      try {
        ...
        common_vendor.index.__f__("warn", "at uni_modules/x-pinia-s/instans/subscriptions.uts:118", "[x-pinia-s] action subscription error:", e);
      }
    }
...
class ActionTriggerResult extends common_vendor.UTS.UTSType {
...
exports.ActionSubscriptionList = ActionSubscriptionList;
exports.StateSubscriptionList = StateSubscriptionList;
//# sourceMappingURL=../../../../.sourcemap/mp-weixin/uni_modules/x-pinia-s/instans/subscriptions.js.map
