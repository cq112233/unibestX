...
class SubsectionItemRect extends common_vendor.UTS.UTSType {
...
class SubsectionProps extends common_vendor.UTS.UTSType {
  static get$UTSMetadata$() {
    return {
      kind: 2,
      get fields() {
        return {
          list: { type: common_vendor.UTS.UTSType.withGenerics(Array, [String]), optional: false },
...
exports.SubsectionItemRect = SubsectionItemRect;
//# sourceMappingURL=../../../../../.sourcemap/mp-weixin/uni_modules/rice-ui/components/rice-subsection/type.js.map
