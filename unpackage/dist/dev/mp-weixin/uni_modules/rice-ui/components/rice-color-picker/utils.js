...
const clampInt = (value, minValue, maxValue) => {
  return Math.round(uni_modules_riceUi_libs_utils_basic.clamp(value, minValue, maxValue));
};
const clampAlpha = (value) => {
  return uni_modules_riceUi_libs_utils_basic.clamp(Math.round(value * 100) / 100, 0, 1);
};
...
const rgbaToHex = (r, g, b, a = null) => {
  const rgbHex = `#${uni_modules_riceUi_libs_utils_basic.padZero(r.toString(16))}${uni_modules_riceUi_libs_utils_basic.padZero(g.toString(16))}${uni_modules_riceUi_libs_utils_basic.padZero(b.toString(16))}`;
  if (a == null || clampAlpha(a) >= 1) {
    return rgbHex;
  }
  const alphaHex = uni_modules_riceUi_libs_utils_basic.padZero(clampInt(clampAlpha(a) * 255, 0, 255).toString(16));
...
const rgbToHsv = (r, g, b) => {
  ...
  return new uni_modules_riceUi_components_riceColorPicker_type.ColorPickerHSV({
    h: Math.round(hue),
...
const hsvToRgb = (h, s, v) => {
  ...
  const saturation = uni_modules_riceUi_libs_utils_basic.clamp(s, 0, 100) / 100;
  const value = uni_modules_riceUi_libs_utils_basic.clamp(v, 0, 100) / 100;
  ...
  return new uni_modules_riceUi_components_riceColorPicker_type.ColorPickerRGB({
...
exports.formatAlpha = formatAlpha;
exports.hsvToRgb = hsvToRgb;
exports.parseColor = parseColor;
exports.parseHexColor = parseHexColor;
exports.parseNumber = parseNumber;
exports.percentToAlpha = percentToAlpha;
exports.rgbToHsv = rgbToHsv;
exports.rgbaToHex = rgbaToHex;
//# sourceMappingURL=../../../../../.sourcemap/mp-weixin/uni_modules/rice-ui/components/rice-color-picker/utils.js.map
