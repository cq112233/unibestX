...
class ColorPickerColorState extends common_vendor.UTS.UTSType {
...
class ColorPickerHSV extends common_vendor.UTS.UTSType {
  static get$UTSMetadata$() {
    return {
      kind: 2,
      get fields() {
...
class ColorPickerRGB extends common_vendor.UTS.UTSType {
  static get$UTSMetadata$() {
    return {
      kind: 2,
      get fields() {
...
class ParsedColorResult extends common_vendor.UTS.UTSType {
  static get$UTSMetadata$() {
    return {
      kind: 2,
      get fields() {
...
class ColorPickerProps extends common_vendor.UTS.UTSType {
  static get$UTSMetadata$() {
    return {
      kind: 2,
      get fields() {
        return {
          presetColors: { type: common_vendor.UTS.UTSType.withGenerics(Array, [String]), optional: true },
...
exports.ColorPickerColorState = ColorPickerColorState;
exports.ColorPickerHSV = ColorPickerHSV;
exports.ColorPickerRGB = ColorPickerRGB;
//# sourceMappingURL=../../../../../.sourcemap/mp-weixin/uni_modules/rice-ui/components/rice-color-picker/type.js.map
