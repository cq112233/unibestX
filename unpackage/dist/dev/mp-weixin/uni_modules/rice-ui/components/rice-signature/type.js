...
class SignatureCanvasSize extends common_vendor.UTS.UTSType {
  static get$UTSMetadata$() {
    return {
      kind: 2,
      get fields() {
...
class SignatureProps extends common_vendor.UTS.UTSType {
  static get$UTSMetadata$() {
    return {
      kind: 2,
      get fields() {
...
exports.SignatureCanvasSize = SignatureCanvasSize;
exports.SignaturePoint = SignaturePoint;
//# sourceMappingURL=../../../../../.sourcemap/mp-weixin/uni_modules/rice-ui/components/rice-signature/type.js.map
