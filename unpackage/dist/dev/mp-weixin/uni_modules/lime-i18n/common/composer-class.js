...
class ComposerClass {
  ...
  _initMethods() {
    ...
    this._interpolate = (key, locale = null, values = null, visitedLinkStack, interpolateMode) => {
      ...
      let ret = (_b = UTSJSONObject.assign(new UTSJSONObject({}), (_a = common_vendor.UTS.mapGet(this.messages.value, ___locale)) !== null && _a !== void 0 ? _a : new UTSJSONObject({}))) === null || _b === void 0 ? null : _b.getString(key);
  ...
  tc(key, choice = null, values = null, locale = null) {
    ...
    const predefined = values == null ? _obj : common_vendor.UTS.isInstanceOf(values, UTSJSONObject) ? UTSJSONObject.assign(_obj, values) : values;
  ...
  d(date = null, key = null, locale = null, options = null) {
    ...
    const format = (_a = formats.getJSON(key)) !== null && _a !== void 0 ? _a : new UTSJSONObject({});
    if (options != null) {
      formatter = new Intl.DateTimeFormat(__locale, Object.assign(new UTSJSONObject({}), format, options));
    } else {
  ...
  n(number, key = null, locale = null, options = null) {
    ...
    if (options != null) {
      formatter = new Intl.NumberFormat(__locale, Object.assign(new UTSJSONObject({}), format, options));
    } else {
  ...
  getLocaleMessage(locale) {
    var _a;
    return (_a = common_vendor.UTS.mapGet(this.messages.value, locale)) !== null && _a !== void 0 ? _a : new UTSJSONObject({});
  }
  /**
   * 合并语言消息
   * @param locale 语言
  ...
  getDateTimeFormat(locale) {
    var _a;
    return (_a = common_vendor.UTS.mapGet(this._datetimeFormats.value, locale)) !== null && _a !== void 0 ? _a : new UTSJSONObject({});
  }
  /**
   * 合并日期时间格式
   * @param locale 语言
  ...
  getNumberFormat(locale) {
    var _a;
    return (_a = common_vendor.UTS.mapGet(this._numberFormats.value, locale)) !== null && _a !== void 0 ? _a : new UTSJSONObject({});
  }
  /**
   * 合并数字格式
   * @param locale 语言
