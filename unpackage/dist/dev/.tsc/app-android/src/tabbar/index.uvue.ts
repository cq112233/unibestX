...
return (): any | null => {
  ...
  return _cE("view", _uM({
    ...
    style: _nS(_uM({ height: `${TABBAR_HEIGHT + unref(safeAreaBottom)}px` }))
  }), [
    _cE("view", _uM({
      ...
      _cE("view", _uM({
        class: "safe-area-bg",
        style: _nS(_uM({ height: `${unref(safeAreaBottom)}px` }))
      }), null, 4 /* STYLE */)
    ], 4 /* STYLE */)
  ], 4 /* STYLE */)
}
...
const GenSrcTabbarIndexStyles = [_uM([["tabbar-container", _pS(_uM([["position", "fixed"], ["bottom", 0], ["left", 0], ["right", 0], ["zIndex", 1], ["backgroundColor", "rgba(0,0,0,0)"], ["flexDirection", "column"]]))], ["tabbar-bg", _pS(_uM([["position", "absolute"], ["bottom", 0], ["left", 0], ["right", 0], ["backgroundColor", "#ffffff"], ["borderTopWidth", "1rpx"], ["borderTopStyle", "solid"], ["borderTopColor", "#eeeeee"], ["zIndex", 1]]))], ["tabbar-inner", _pS(_uM([["flexDirection", "row"], ["height", 80], ["alignItems", "flex-end"], ["zIndex", 2]]))], ["tabbar-item", _pS(_uM([["flexGrow", 1], ["flexShrink", 1], ["flexBasis", "0%"], ["alignItems", "center"], ["justifyContent", "center"], ["height", 50]]))], ["tabbar-item-bulge", _pS(_uM([["height", 80]]))], ["safe-area-bg", _pS(_uM([["zIndex", 1], ["backgroundColor", "#ffffff"]]))]])]
