...
function onLongChange(item: UTSJSONObject) {
  console.log('超长Tabs切换:', item, " at src/sub/uview-ultra/demos/tabs/tabs.uvue:156");
}

function onBaseChange(item: UTSJSONObject) {
  console.log('基础Tabs切换:', item, " at src/sub/uview-ultra/demos/tabs/tabs.uvue:160");
}
          ...
          _cE("view", _uM({ class: "page-container bg-_b_hf8fafc_B min-h-screen pb-_b30px_B" }), [
            ...
            _cE("view", _uM({ class: "p-_b16px_B" }), [
              _cE("view", _uM({ class: "demo-block" }), [
                ...
                _cE("view", _uM({ class: "content-box mt-_b10px_B" }), [
