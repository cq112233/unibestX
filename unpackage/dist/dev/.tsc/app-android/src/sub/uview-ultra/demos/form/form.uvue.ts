...
const formRules = { __$originalPosition: new UTSSourceMapPosition("formRules", "src/sub/uview-ultra/demos/form/form.uvue", 222, 7), 
  name: [
    {
      required: true,
      message: '请填写姓名',
...
function submitForm() {
  ...
  if (form != null) {
    (form.$callMethod('validate') as Promise<any>).then((res: any) => {
      ...
      console.log('提交的数据：', formModel, " at src/sub/uview-ultra/demos/form/form.uvue:272");
    }).catch((err: any | null) => {
      console.log('验证失败:', err, " at src/sub/uview-ultra/demos/form/form.uvue:274");
      uni.showToast({
        title: '请检查必填项',
        icon: 'error'
      });
        ...
        default: withSlotCtx((): any[] => [
          _cE("view", _uM({ class: "page-container bg-_b_hf8fafc_B min-h-screen pb-_b30px_B" }), [
            ...
            _cE("view", _uM({ class: "p-_b16px_B" }), [
              ...
              _cE("view", _uM({ class: "mt-_b20px_B flex-row justify-between" }), [
                _cE("view", _uM({ class: "flex-1 mr-_b10px_B" }), [
                ...
                _cE("view", _uM({ class: "flex-1 ml-_b10px_B" }), [
                  _cV(_component_up_button, _uM({
                    type: "info",
                    text: "重置表单",
                    onClick: resetForm
...
const GenSrcSubUviewUltraDemosFormFormStyles = [_uM([["demo-block", _pS(_uM([["marginBottom", 12], ["paddingTop", 12], ["paddingRight", 12], ["paddingBottom", 12], ["paddingLeft", 12], ["backgroundColor", "#ffffff"], ["borderTopLeftRadius", 8], ["borderTopRightRadius", 8], ["borderBottomRightRadius", 8], ["borderBottomLeftRadius", 8]]))], ["demo-label", _pS(_uM([["fontSize", 14], ["fontWeight", "bold"], ["color", "#606266"], ["marginBottom", 10], ["paddingLeft", 4], ["borderLeftWidth", 3], ["borderLeftStyle", "solid"], ["borderLeftColor", "#2979ff"]]))], ["w-10px", _pS(_uM([["width", 10]]))], ["mt-20px", _pS(_uM([["marginTop", 20]]))], ["mr-10px", _pS(_uM([["marginRight", 10]]))], ["ml-10px", _pS(_uM([["marginLeft", 10]]))], ["flex-1", _pS(_uM([["flexGrow", 1], ["flexShrink", 1], ["flexBasis", "0%"]]))]])]
