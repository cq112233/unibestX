...
function showNotify(type: string) {
  ...
  if (notify != null) {
    const msgs = { __$originalPosition: new UTSSourceMapPosition("msgs", "src/sub/uview-ultra/demos/notify/notify.uvue", 52, 11), 
      primary: '主要通知消息',
      success: '操作成功通知',
      warning: '请注意安全通知',
      error: '发生错误通知',
