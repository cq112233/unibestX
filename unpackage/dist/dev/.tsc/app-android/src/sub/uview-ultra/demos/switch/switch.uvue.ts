            ...
            _cE("view", _uM({ class: "p-_b16px_B" }), [
              _cE("view", _uM({ class: "demo-block" }), [
                ...
                _cE("view", _uM({ class: "flex-row items-center" }), [
                  ...
                  _cE("text", _uM({ class: "text-_b14px_B ml-_b10px_B" }), _tD(switchValue1.value ? '已开启' : '已关闭'), 1 /* TEXT */)
                ])
              ]),
