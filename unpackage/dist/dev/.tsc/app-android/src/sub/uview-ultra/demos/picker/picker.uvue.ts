...
function onConfirm1(e: UTSJSONObject) {
  console.log('picker 1 confirm', e, " at src/sub/uview-ultra/demos/picker/picker.uvue:72")
  pickerShow1.value = false
}
function onConfirm2(e: UTSJSONObject) {
  console.log('picker 2 confirm', e, " at src/sub/uview-ultra/demos/picker/picker.uvue:76")
  pickerShow2.value = false
}
function onConfirm3(e: UTSJSONObject) {
  console.log('picker 3 confirm', e, " at src/sub/uview-ultra/demos/picker/picker.uvue:80")
