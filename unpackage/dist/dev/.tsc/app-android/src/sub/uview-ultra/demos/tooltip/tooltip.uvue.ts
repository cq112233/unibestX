...
const multiButtons = ref(['转发', '收藏', '删除'] as string[])
          ...
          _cE("view", _uM({ class: "page-container bg-__f8fafc_ min-h-screen pb-30px" }), [
            ...
            _cE("view", _uM({ class: "p-16px" }), [
              _cE("view", _uM({ class: "demo-block" }), [
                ...
                _cE("view", _uM({ class: "flex flex-row items-center flex-wrap" }), [
                  _cE("view", _uM({ class: "mr-12px mb-8px" }), [
              ...
              _cE("view", _uM({ class: "demo-block mt-12px" }), [
                _cE("text", _uM({ class: "demo-label" }), "弹出方向"),
                _cE("view", _uM({ class: "flex flex-row items-center flex-wrap" }), [
                  _cE("view", _uM({ class: "mr-16px mb-8px" }), [
                    _cV(_component_up_tooltip, _uM({
                      text: "长按文本，上方提示",
                      direction: "top"
                    }))
              ...
              _cE("view", _uM({ class: "demo-block mt-12px" }), [
                _cE("text", _uM({ class: "demo-label" }), "高亮选中文本背景色"),
                _cE("view", _uM({ class: "flex flex-row items-center" }), [
                  _cV(_component_up_tooltip, _uM({
                    text: "长按文本，显示背景色",
                    "bg-color": "#d1fae5",
                    direction: "top"
              ...
              _cE("view", _uM({ class: "demo-block mt-12px" }), [
                _cE("text", _uM({ class: "demo-label" }), "扩展按钮"),
                _cE("view", _uM({ class: "flex flex-row items-center" }), [
                  _cV(_component_up_tooltip, _uM({
                    text: "显示多个扩展按钮",
                    "show-copy": true,
              ...
              _cE("view", _uM({ class: "demo-block mt-12px" }), [
                _cE("text", _uM({ class: "demo-label" }), "自定义触发器 (Slot)"),
                _cE("view", _uM({ class: "flex flex-row items-center" }), [
                  _cE("view", _uM({ class: "mr-16px" }), [
                    _cV(_component_up_tooltip, _uM({
                      "show-copy": false,
                      buttons: ['设置', '赞'],
                      direction: "top",
