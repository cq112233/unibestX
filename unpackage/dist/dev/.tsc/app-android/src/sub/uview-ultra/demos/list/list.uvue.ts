          ...
          _cE("view", _uM({ class: "page-container bg-_b_hf8fafc_B flex flex-col flex-1 h-full" }), [
            ...
            _cE("scroll-view", _uM({
              ...
              _cE("nested-scroll-header", null, [
                _cE("view", _uM({ class: "p-_b12px_B pb-0" }), [
                  _cE("text", _uM({ class: "text-_b14px_B font-bold text-_b_h2979ff_B mb-_b8px_B" }), "列表 1：动态加载列表 (高度 380px)"),
                    ...
                    default: withSlotCtx((): any[] => [
                      _cE(Fragment, null, RenderHelpers.renderList(listItems.value, (item, idx, __index, _cached): any => {
                        return _cE("view", _uM({
                          ...
                          _cE("view", _uM({ class: "demo-list-cell-content" }), [
                            _cE("text", _uM({ class: "text-_b14px_B font-_b500_B text-_b_h303133_B" }), _tD(item.title as string), 1 /* TEXT */),
                            _cE("text", _uM({ class: "text-_b12px_B text-_b_h909399_B mt-_b4px_B" }), _tD(item.desc as string), 1 /* TEXT */)
                          ])
                        ])
                      }), 128 /* KEYED_FRAGMENT */),
                      isTrue(listLoading.value)
                        ? _cE("view", _uM({
                            ...
                            _cE("text", _uM({ class: "text-_b12px_B text-_b_h909399_B ml-_b8px_B" }), "加载中...")
                          ])
                        : _cC("v-if", true)
                    ]),
                    _: 1 /* STABLE */
              ...
              _cE("nested-scroll-header", null, [
                _cE("view", _uM({ class: "p-_b12px_B pb-_b24px_B" }), [
                  _cE("text", _uM({ class: "text-_b14px_B font-bold text-_b_h19be6b_B mb-_b8px_B" }), "列表 2：静态展示列表 (高度 280px)"),
                  _cV(_component_up_list, _uM({
                    height: 280,
                    class: "bg-white rounded-_b8px_B shadow-xs"
                  }), _uM({
                    default: withSlotCtx((): any[] => [
                      _cE(Fragment, null, RenderHelpers.renderList(staticListItems.value, (item, idx, __index, _cached): any => {
                        return _cE("view", _uM({
                          ...
                          _cE("view", _uM({ class: "w-_b8px_B h-_b8px_B rounded-_b4px_B bg-_b_h19be6b_B mr-_b10px_B" })),
                          _cE("view", _uM({ class: "demo-list-cell-content" }), [
                            _cE("text", _uM({ class: "text-_b14px_B font-_b500_B text-_b_h303133_B" }), _tD(item.title as string), 1 /* TEXT */),
                            _cE("text", _uM({ class: "text-_b12px_B text-_b_h909399_B mt-_b4px_B" }), _tD(item.desc as string), 1 /* TEXT */)
                          ])
