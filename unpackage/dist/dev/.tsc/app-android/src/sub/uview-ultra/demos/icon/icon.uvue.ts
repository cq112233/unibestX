          ...
          _cE("view", _uM({ class: "page-container bg-_b_hf8fafc_B min-h-screen pb-_b30px_B" }), [
            ...
            _cE("view", _uM({ class: "p-_b16px_B" }), [
              _cE("view", _uM({ class: "demo-block" }), [
                ...
                _cE("view", _uM({ class: "flex-row flex-wrap" }), [
              ...
              _cE("view", _uM({ class: "demo-block" }), [
                _cE("text", _uM({ class: "demo-label" }), "颜色定制"),
                _cE("view", _uM({ class: "flex-row flex-wrap" }), [
                  _cV(_component_up_icon, _uM({
                    name: "heart-fill",
                    color: "#fa3534",
...
const GenSrcSubUviewUltraDemosIconIconStyles = [_uM([["demo-block", _pS(_uM([["marginBottom", 12], ["paddingTop", 12], ["paddingRight", 12], ["paddingBottom", 12], ["paddingLeft", 12], ["backgroundColor", "#ffffff"], ["borderTopLeftRadius", 8], ["borderTopRightRadius", 8], ["borderBottomRightRadius", 8], ["borderBottomLeftRadius", 8]]))], ["demo-label", _pS(_uM([["fontSize", 14], ["fontWeight", "bold"], ["color", "#606266"], ["marginBottom", 10], ["paddingLeft", 4], ["borderLeftWidth", 3], ["borderLeftStyle", "solid"], ["borderLeftColor", "#2979ff"]]))]])]
