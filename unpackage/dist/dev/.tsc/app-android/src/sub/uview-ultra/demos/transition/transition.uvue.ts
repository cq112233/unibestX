                  ...
                  _cV(_component_up_transition, _uM({
                    ...
                    default: withSlotCtx((): any[] => [
                      _cE("view", _uM({ class: "transition-demo-box transition-demo-blue" }), [
                        _cE("text", _uM({ class: "text-_b14px_B text-white font-_b500_B" }), "fade 淡入淡出")
                      ])
                    ]),
                    _: 1 /* STABLE */
                  }), 8 /* PROPS */, ["show"]),
                  _cE("view", _uM({ class: "mt-_b10px_B" }), [
                  ...
                  _cV(_component_up_transition, _uM({
                    ...
                    default: withSlotCtx((): any[] => [
                      _cE("view", _uM({ class: "transition-demo-box bg-_b_h19be6b_B" }), [
                        _cE("text", _uM({ class: "text-_b14px_B text-white font-_b500_B" }), "zoom 缩放")
                      ])
                    ]),
                    _: 1 /* STABLE */
                  }), 8 /* PROPS */, ["show"])
                  ...
                  _cV(_component_up_transition, _uM({
                    ...
                    default: withSlotCtx((): any[] => [
                      _cE("view", _uM({ class: "transition-demo-box bg-_b_hf56c6c_B" }), [
                        _cE("text", _uM({ class: "text-_b14px_B text-white font-_b500_B" }), "slide 滑动")
                      ])
                    ]),
                    _: 1 /* STABLE */
                  }), 8 /* PROPS */, ["show", "mode"])
                ]),
                _cE("view", _uM({ class: "flex-row items-center justify-around mt-_b10px_B" }), [
                  _cV(_component_up_button, _uM({
                    type: "primary",
                    text: "上滑",
                    size: "mini",
