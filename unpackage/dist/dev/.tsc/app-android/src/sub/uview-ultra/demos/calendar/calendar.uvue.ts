...
function onConfirm1(e: string[]) {
  console.log('single', e, " at src/sub/uview-ultra/demos/calendar/calendar.uvue:80")
  calendarShow1.value = false
}
function onConfirm2(e: string[]) {
  console.log('multiple', e, " at src/sub/uview-ultra/demos/calendar/calendar.uvue:84")
  calendarShow2.value = false
}
function onConfirm3(e: string[]) {
  console.log('range', e, " at src/sub/uview-ultra/demos/calendar/calendar.uvue:88")
  calendarShow3.value = false
}
function onConfirm4(e: string[]) {
  console.log('custom color', e, " at src/sub/uview-ultra/demos/calendar/calendar.uvue:92")
