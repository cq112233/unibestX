...
function onConfirm1(e: string[]) {
  console.log('single', e, " at src/sub/uview-ultra/demos/calendar/calendar.uvue:72")
  calendarShow1.value = false
}
function onConfirm2(e: string[]) {
  console.log('multiple', e, " at src/sub/uview-ultra/demos/calendar/calendar.uvue:76")
  calendarShow2.value = false
}
function onConfirm3(e: string[]) {
  console.log('range', e, " at src/sub/uview-ultra/demos/calendar/calendar.uvue:80")
  calendarShow3.value = false
}
function onConfirm4(e: string[]) {
  console.log('custom color', e, " at src/sub/uview-ultra/demos/calendar/calendar.uvue:84")
          ...
          _cE("view", _uM({ class: "page-container bg-_b_hf8fafc_B min-h-screen pb-30px" }), [
            ...
            _cE("view", _uM({ class: "p-16px" }), [
              ...
              _cE("view", _uM({ class: "demo-block mt-12px" }), [
                _cE("text", _uM({ class: "demo-label" }), "多选模式"),
                _cE("view", _uM({ class: "flex-row items-center" }), [
                  _cV(_component_up_button, _uM({
                    type: "success",
                    text: "多选日期",
              ...
              _cE("view", _uM({ class: "demo-block mt-12px" }), [
                _cE("text", _uM({ class: "demo-label" }), "范围选择"),
                _cE("view", _uM({ class: "flex-row items-center" }), [
                  _cV(_component_up_button, _uM({
                    type: "warning",
                    text: "范围选择",
              ...
              _cE("view", _uM({ class: "demo-block mt-12px" }), [
                _cE("text", _uM({ class: "demo-label" }), "自定义主题颜色"),
                _cE("view", _uM({ class: "flex-row items-center" }), [
                  _cV(_component_up_button, _uM({
                    type: "error",
                    text: "自定义颜色",
