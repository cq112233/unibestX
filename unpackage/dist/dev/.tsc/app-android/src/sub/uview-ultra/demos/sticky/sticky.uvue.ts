          ...
          _cE("view", _uM({
            ...
            _cE("scroll-view", _uM({
              ...
              _cE("view", _uM({ class: "bg-white rounded-8px p-12px mb-12px shadow-xs" }), [
                ...
                _cE("text", _uM({ class: "text-13px text-__64748b_ leading-20px" }), " 向上滑动页面，当下面的操作栏滚动到顶部时，会触发 up-sticky 组件吸顶悬浮固定。 ")
              ]),
