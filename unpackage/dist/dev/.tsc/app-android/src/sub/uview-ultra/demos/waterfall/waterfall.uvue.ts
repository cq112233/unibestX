                  ...
                  return [
                    _cE(Fragment, null, RenderHelpers.renderList((colList as UTSJSONObject[]), (item, idx, __index, _cached): any => {
                      return _cE("view", _uM({
                        ...
                        _cE("view", _uM({ class: "bg-_b_hf1f5f9_B rounded-_b8px_B overflow-hidden p-_b8px_B mb-_b8px_B" }), [
                          _cE("image", _uM({
                            src: "/static/logo.png",
                            mode: "aspectFit",
                            style: _nS(_uM({ width: '100%', height: (item as UTSJSONObject).getString('imgHeight') ?? '100px', borderRadius: '6px', backgroundColor: '#ffffff' }))
                          }), null, 4 /* STYLE */),
                          _cE("text", _uM({ class: "text-_b14px_B font-bold text-_b_h334155_B mt-_b6px_B" }), _tD((item as UTSJSONObject).getString('title')), 1 /* TEXT */),
                          _cE("text", _uM({ class: "text-_b12px_B text-_b_h94a3b8_B mt-_b2px_B" }), _tD((item as UTSJSONObject).getString('desc')), 1 /* TEXT */),
                          _cE("text", _uM({ class: "text-_b14px_B text-_b_he11d48_B mt-_b4px_B font-bold" }), "￥" + _tD((item as UTSJSONObject).getNumber('price')), 1 /* TEXT */)
                        ])
                      ])
                    }), 128 /* KEYED_FRAGMENT */)
                  ]}),
