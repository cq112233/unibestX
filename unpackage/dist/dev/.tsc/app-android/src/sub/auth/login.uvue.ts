        ...
        default: withSlotCtx((): any[] => [
          _cE("view", _uM({ class: "flex-1 p-_b30px_B items-center justify-center" }), [
            _cE("view", _uM({ class: "mb-_b30px_B" }), [
              _cE("text", _uM({ class: "text-_b20px_B font-bold text-_b_h1e293b_B" }), "登录页")
            ]),
            _cE("view", _uM({
              class: "w-_b200px_B h-_b44px_B rounded-_b8px_B bg-_b_h3b82f6_B flex flex-row items-center justify-center",
              onClick: doLogin
            }), [
              _cE("text", _uM({ class: "text-_b_hffffff_B text-_b14px_B font-bold" }), "点击模拟登录")
            ])
          ])
        ]),
        _: 1 /* STABLE */
