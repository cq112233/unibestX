...
return (): any | null => {
  ...
  return _cE("view", _uM({ class: "wtu-1hu0utr-0 wtu-y55q6h-1 wtu-ivhrpw-2 wtu-19wcvi6-3" }), [
    ...
    _cE("view", _uM({ class: "wtu-1elh8h7-8 wtu-3c9fnx-6 wtu-vlijqx-9 wtu-y55q6h-1" }), [
      _cE("text", _uM({
        class: _nC(unref(flag) ? 'wtu-6mro4v-a wtu-g3slxv-b' : 'wtu-zbeef1-c')
      }), " simple ", 2 /* CLASS */),
      _cE("text", _uM({
        class: _nC([
          unref(extra),
          _uM({ 'wtu-c5hw0m-d': unref(toggled) })
        ])
      }), " complex ", 2 /* CLASS */),
      _cE("text", _uM({
        class: _nC(unref(condition) ? 'wtu-2jxb3j-e wtu-9251zl-f' : '')
      }), " fallback ", 2 /* CLASS */)
    ])
  ])
}
