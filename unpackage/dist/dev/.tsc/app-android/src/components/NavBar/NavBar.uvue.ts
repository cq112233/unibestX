...
function handleBack() {
  uni.navigateBack({
    success() {
      console.log('返回成功', " at src/components/NavBar/NavBar.uvue:86")
    },
    fail() {
...
const GenSrcComponentsNavBarNavBarStyles = [_uM([["navbar-container", _pS(_uM([["width", "100%"], ["display", "flex"], ["flexDirection", "column"]]))], ["navbar-fixed", _pS(_uM([["position", "fixed"], ["top", 0], ["left", 0], ["right", 0], ["zIndex", 999]]))], ["navbar-content", _pS(_uM([["height", 44], ["display", "flex"], ["flexDirection", "row"], ["alignItems", "center"], ["justifyContent", "center"], ["position", "relative"], ["width", "100%"]]))], ["navbar-left", _pS(_uM([["position", "absolute"], ["left", 0], ["top", 0], ["bottom", 0], ["width", 60], ["display", "flex"], ["flexDirection", "row"], ["alignItems", "center"], ["justifyContent", "flex-start"], ["zIndex", 10]]))], ["back-btn-wrapper", _pS(_uM([["paddingTop", 10], ["paddingRight", 15], ["paddingBottom", 10], ["paddingLeft", 15], ["display", "flex"], ["flexDirection", "row"], ["alignItems", "center"], ["justifyContent", "center"]]))], ["back-arrow", _pS(_uM([["width", 10], ["height", 10], ["borderLeftWidth", 2], ["borderLeftStyle", "solid"], ["borderLeftColor", "#1e293b"], ["borderBottomWidth", 2], ["borderBottomStyle", "solid"], ["borderBottomColor", "#1e293b"], ["WebkitTransform", "rotate(45deg)"], ["transform", "rotate(45deg)"]]))], ["navbar-title", _pS(_uM([["display", "flex"], ["flexDirection", "row"], ["alignItems", "center"], ["justifyContent", "center"], ["flexGrow", 1], ["flexShrink", 1], ["flexBasis", "0%"], ["height", "100%"], ["paddingLeft", 60], ["paddingRight", 60]]))], ["title-text", _pS(_uM([["fontSize", 16], ["fontWeight", 700], ["textOverflow", "ellipsis"], ["overflow", "hidden"], ["whiteSpace", "nowrap"]]))], ["navbar-right", _pS(_uM([["position", "absolute"], ["right", 0], ["top", 0], ["bottom", 0], ["width", 60], ["display", "flex"], ["flexDirection", "row"], ["alignItems", "center"], ["justifyContent", "flex-end"], ["zIndex", 10], ["paddingRight", 15]]))]])]
