...
const _component_z_paging_x = resolveEasyComponent("z-paging-x",_easycom_z_paging_x)
  ...
  return _cV(unref(Card), _uM({ title: "数据分页列表 (z-paging-x)" }), _uM({
    default: withSlotCtx((): any[] => [
      _cE("view", _uM({ class: "wtu-363vo5-0 mb-12px" }), [
        _cE("text", _uM({ class: "text-13px wtu-k196jf-1 leading-18px mb-8px" }), " 在卡片中直接体验实时分页，支持触底加载、下拉刷新以及各种状态切换。 "),
        _cE("view", _uM({ class: "wtu-13t3cxb-2 mb-12px" }), [
          _cE("view", _uM({ class: "wtu-13lz6jk-3 mr-8px" }), [
            _cE("view", _uM({
              class: "wtu-1q4uxtw-4 h-36px rounded-8px wtu-11r5j79-5 wtu-cab7ja-6 wtu-13t3cxb-2 wtu-99t06f-7 wtu-1a6bk3r-8",
              onClick: triggerError
            }), [
              _cE("text", _uM({ class: "wtu-1q1c76l-9 text-12px wtu-vbfg4k-a" }), "模拟加载错误")
            ])
          ]),
          _cE("view", _uM({ class: "wtu-13lz6jk-3" }), [
            _cE("view", _uM({
              class: "wtu-1q4uxtw-4 h-36px rounded-8px wtu-1vy0ete-b wtu-cab7ja-6 wtu-13t3cxb-2 wtu-99t06f-7 wtu-1a6bk3r-8",
              onClick: triggerClear
            }), [
              _cE("text", _uM({ class: "wtu-12jt6bz-c text-12px wtu-vbfg4k-a" }), "清空数据")
            ])
          ])
        ])
      ]),
      _cE("view", _uM({
        ...
        _cE("view", _uM({ class: "wtu-13t3cxb-2 wtu-9b5i85-e rounded-8px p-2px" }), [
        ...
        default: withSlotCtx((): any[] => [
          _cE(Fragment, null, RenderHelpers.renderList(dataList.value, (item, __key, __index, _cached): any => {
            return _cE("view", _uM({
              ...
              _cE("view", _uM({ class: "mx-12px my-8px p-12px wtu-1vo8z52-d rounded-8px border-width-1px border-style-solid border-color-[#edf2f7]" }), [
                _cE("view", _uM({ class: "wtu-13t3cxb-2 wtu-1d8uwje-f wtu-99t06f-7 mb-6px" }), [
                  _cE("view", _uM({
                  ...
                  _cE("text", _uM({ class: "text-11px wtu-1oi0tuv-g" }), "#" + _tD(item.id), 1 /* TEXT */)
                ]),
                _cE("text", _uM({ class: "text-14px wtu-vbfg4k-a wtu-fw3sss-h mb-4px" }), _tD(item.title), 1 /* TEXT */),
                _cE("text", _uM({ class: "text-12px wtu-k196jf-1 leading-16px" }), _tD(item.summary), 1 /* TEXT */)
              ])
            ])
          }), 128 /* KEYED_FRAGMENT */)
        ]),
...
const GenSrcPagesFunctionComponentsZPagingDemoCardStyles = [_uM([["wtu-363vo5-0", _pS(_uM([["flexDirection", "column"]]))], ["wtu-k196jf-1", _pS(_uM([["color", "#64748b"]]))], ["wtu-13t3cxb-2", _pS(_uM([["flexDirection", "row"]]))], ["wtu-13lz6jk-3", _pS(_uM([["flexGrow", 1], ["flexShrink", 1], ["flexBasis", "0%"]]))], ["wtu-1q4uxtw-4", _pS(_uM([["width", "100%"]]))], ["wtu-11r5j79-5", _pS(_uM([["backgroundColor", "#fee2e2"]]))], ["wtu-cab7ja-6", _pS(_uM([["display", "flex"]]))], ["wtu-99t06f-7", _pS(_uM([["alignItems", "center"]]))], ["wtu-1a6bk3r-8", _pS(_uM([["justifyContent", "center"]]))], ["wtu-1q1c76l-9", _pS(_uM([["color", "#dc2626"]]))], ["wtu-vbfg4k-a", _pS(_uM([["--tw-font-weight", "var(--font-weight-bold, 700)"], ["fontWeight", 700]]))], ["wtu-1vy0ete-b", _pS(_uM([["backgroundColor", "#fef3c7"]]))], ["wtu-12jt6bz-c", _pS(_uM([["color", "#d97706"]]))], ["wtu-1vo8z52-d", _pS(_uM([["backgroundColor", "#ffffff"]]))], ["wtu-9b5i85-e", _pS(_uM([["backgroundColor", "#f1f5f9"]]))], ["wtu-1d8uwje-f", _pS(_uM([["justifyContent", "space-between"]]))], ["wtu-1oi0tuv-g", _pS(_uM([["color", "#94a3b8"]]))], ["wtu-fw3sss-h", _pS(_uM([["color", "#1e293b"]]))]])]
