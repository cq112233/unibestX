...
const GenSrcPagesFunctionComponentsHapticsCardStyles = [_uM([["wtu-xlfis6-0", _pS(_uM([["color", "#94a3b8"]]))], ["wtu-44c3cb-1", _pS(_uM([["backgroundColor", "#ffffff"]]))], ["wtu-lwq7o6-2", _pS(_uM([["color", "#334155"]]))], ["wtu-1phhh09-3", _pS(_uM([["width", "100%"]]))], ["wtu-1km86q6-4", _pS(_uM([["backgroundColor", "#10b981"]]))], ["wtu-snabsj-5", _pS(_uM([["display", "flex"]]))], ["wtu-1e9fgzq-6", _pS(_uM([["flexDirection", "row"]]))], ["wtu-15f70xm-7", _pS(_uM([["alignItems", "center"]]))], ["wtu-1kekspa-8", _pS(_uM([["justifyContent", "center"]]))], ["wtu-199nxoz-9", _pS(_uM([["color", "#ffffff"]]))], ["wtu-17exkt3-a", _pS(_uM([["--tw-font-weight", "var(--font-weight-bold, 700)"], ["fontWeight", 700]]))], ["wtu-nwcnqo-b", _pS(_uM([["backgroundColor", "#f59e0b"]]))]])]
