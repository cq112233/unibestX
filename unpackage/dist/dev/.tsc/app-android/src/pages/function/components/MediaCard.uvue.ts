...
const GenSrcPagesFunctionComponentsMediaCardStyles = [_uM([["wtu-q8b8gq-0", _pS(_uM([["alignItems", "center"]]))], ["wtu-b9ro1a-1", _pS(_uM([["justifyContent", "center"]]))], ["wtu-1s564xi-2", _pS(_uM([["color", "#94a3b8"]]))], ["wtu-2xyrg9-3", _pS(_uM([["width", "100%"]]))], ["wtu-1y0ezim-4", _pS(_uM([["backgroundColor", "#3b82f6"]]))], ["wtu-y8rs9f-5", _pS(_uM([["display", "flex"]]))], ["wtu-kkkwyu-6", _pS(_uM([["flexDirection", "row"]]))], ["wtu-1ra95rn-7", _pS(_uM([["color", "#ffffff"]]))], ["wtu-qeuvjr-8", _pS(_uM([["--tw-font-weight", "var(--font-weight-bold, 700)"], ["fontWeight", 700]]))], ["wtu-1j4877a-9", _pS(_uM([["color", "#334155"]]))], ["wtu-yibfla-a", _pS(_uM([["backgroundColor", "#10b981"]]))]])]
