  ...
  return _cV(unref(AppKu), null, _uM({
    default: withSlotCtx((): any[] => [
      _cV(unref(LayoutComponent), _uM({ "navigation-bar-title-text": '功能' }), _uM({
        default: withSlotCtx((): any[] => [
          _cE("scroll-view", _uM({ class: "flex-1" }), [
