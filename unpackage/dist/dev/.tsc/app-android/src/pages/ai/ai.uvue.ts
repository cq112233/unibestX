...
type ChatMessage = { __$originalPosition?: UTSSourceMapPosition<"ChatMessage", "src/pages/ai/ai.uvue", 140, 6>;
  id: string
  sender: string
  content: string
  time: string
  ...
  return _cV(unref(AppKu), null, _uM({
    default: withSlotCtx((): any[] => [
      _cV(unref(LayoutComponent), _uM({
        ...
        default: withSlotCtx((): any[] => [
          _cE("view", _uM({ class: "page-root bg-__f8fafc_" }), [
