  ...
  return _cV(unref(AppKu), null, _uM({
    default: withSlotCtx((): any[] => [
      _cV(unref(LayoutComponent), _uM({
        ...
        default: withSlotCtx((): any[] => [
          _cE("view", _uM({ class: "flex-1 flex-col pb-30px" }), [
...
const GenSrcPagesBasicBasicStyles = [_uM([["flex-1", _pS(_uM([["flexGrow", 1], ["flexShrink", 1], ["flexBasis", "0%"]]))], ["flex-col", _pS(_uM([["flexDirection", "column"]]))], ["pb-30px", _pS(_uM([["paddingBottom", 30]]))]])]
