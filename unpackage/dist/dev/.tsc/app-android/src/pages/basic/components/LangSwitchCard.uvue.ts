  ...
  return _cV(unref(Card), _uM({ title: langTitle.value }), _uM({
    default: withSlotCtx((): any[] => [
      _cE("view", _uM({ class: "rounded-12px p-16px mb-16px border-width-1px border-style-solid border-color-__e2e8f0_" }), [
        _cE("text", _uM({ class: "text-12px text-__94a3b8_ mb-6px" }), _tD(langPreview.value), 1 /* TEXT */),
        _cE("text", _uM({ class: "text-16px font-bold text-__1e293b_" }), _tD(welcomeText.value), 1 /* TEXT */),
        _cE("text", _uM({ class: "text-14px text-__475569_ mt-8px" }), _tD(helloText.value), 1 /* TEXT */),
        _cE("view", _uM({ class: "mt-12px pt-12px border-top-width-1px border-top-style-solid border-top-color-__f1f5f9_" }), [
          _cE("text", _uM({ class: "text-12px text-__94a3b8_ mb-6px" }), _tD(uviewPreview.value), 1 /* TEXT */),
          _cE("view", _uM({ class: "flex-row items-center flex-wrap" }), [
            _cE("text", _uM({ class: "text-13px text-__2563eb_ bg-__eff6ff_ px-8px py-4px rounded-4px font-medium mr-8px mb-4px" }), _tD(uViewChooseDates.value), 1 /* TEXT */),
            _cE("text", _uM({ class: "text-13px text-__059669_ bg-__ecfdf5_ px-8px py-4px rounded-4px font-medium mr-8px mb-4px" }), _tD(uViewConfirm.value), 1 /* TEXT */),
            _cE("text", _uM({ class: "text-13px text-__d97706_ bg-__fffbe2_ px-8px py-4px rounded-4px font-medium mb-4px" }), _tD(uViewStart.value) + " / " + _tD(uViewEnd.value), 1 /* TEXT */)
          ])
        ])
      ]),
      _cE("view", _uM({
