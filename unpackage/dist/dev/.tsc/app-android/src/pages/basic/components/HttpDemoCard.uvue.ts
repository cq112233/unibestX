...
return (): any | null => {
  ...
  return _cV(unref(Card), _uM({ title: "HTTP 请求 Demo" }), _uM({
    default: withSlotCtx((): any[] => [
      ...
      _cE("view", _uM({ class: "bg-__f8fafc_ rounded-10px p-12px mb-16px border-width-1px border-style-solid border-color-__e2e8f0_" }), [
