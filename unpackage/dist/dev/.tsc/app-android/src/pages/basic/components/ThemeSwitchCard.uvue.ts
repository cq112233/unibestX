...
type ThemeModeOption = { __$originalPosition?: UTSSourceMapPosition<"ThemeModeOption", "src/pages/basic/components/ThemeSwitchCard.uvue", 113, 6>;
  value: string;
  label: string;
};
  ...
  return _cV(unref(Card), _uM({ title: themeTitle.value }), _uM({
    default: withSlotCtx((): any[] => [
      _cE("view", _uM({ class: "rounded-12px p-16px mb-16px border-width-1px border-style-solid border-color-__e2e8f0_ items-center" }), [
        _cE("text", _uM({ class: "text-12px text-__94a3b8_ mb-8px" }), _tD(themePreview.value), 1 /* TEXT */),
        _cE("view", _uM({
          ...
          _cE("text", _uM({ class: "text-__ffffff_ text-14px" }), _tD(themeButton.value), 1 /* TEXT */)
        ], 4 /* STYLE */)
      ]),
      ...
      _cE("view", _uM({ class: "flex-row justify-between items-center mt-10px pt-10px" }), [
        _cE("text", _uM({ class: "text-14px text-__2d3748_" }), _tD(themeModeLabel.value), 1 /* TEXT */),
        _cE("view", _uM({
