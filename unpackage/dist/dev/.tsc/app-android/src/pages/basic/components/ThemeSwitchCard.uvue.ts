...
return (): any | null => {
  ...
  return _cV(unref(Card), _uM({ title: "主题设置" }), _uM({
    default: withSlotCtx((): any[] => [
      _cE("view", _uM({ class: "bg-__f8fafc_ rounded-12px p-16px mb-16px border-width-1px border-style-solid border-color-__e2e8f0_ items-center" }), [
