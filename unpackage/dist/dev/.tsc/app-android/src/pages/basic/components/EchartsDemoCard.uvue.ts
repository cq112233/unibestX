...
const lineOption = { __$originalPosition: new UTSSourceMapPosition("lineOption", "src/pages/basic/components/EchartsDemoCard.uvue", 96, 7), 
  title: {
    text: '访问趋势 (折线图)',
    textStyle: {
      fontSize: 12,
...
const barOption = { __$originalPosition: new UTSSourceMapPosition("barOption", "src/pages/basic/components/EchartsDemoCard.uvue", 157, 7), 
  title: {
    text: '访问分布 (柱状图)',
    textStyle: {
      fontSize: 12,
...
const pieOption = { __$originalPosition: new UTSSourceMapPosition("pieOption", "src/pages/basic/components/EchartsDemoCard.uvue", 204, 7), 
  title: {
    text: '访问来源 (饼图)',
    textStyle: {
      fontSize: 12,
