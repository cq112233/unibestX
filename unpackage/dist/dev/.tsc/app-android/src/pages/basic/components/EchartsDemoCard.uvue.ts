...
const lineOption = { __$originalPosition: new UTSSourceMapPosition("lineOption", "src/pages/basic/components/EchartsDemoCard.uvue", 90, 7), 
  title: {
    text: '访问趋势 (折线图)',
    textStyle: {
      fontSize: 12,
...
const barOption = { __$originalPosition: new UTSSourceMapPosition("barOption", "src/pages/basic/components/EchartsDemoCard.uvue", 151, 7), 
  title: {
    text: '访问分布 (柱状图)',
    textStyle: {
      fontSize: 12,
...
const pieOption = { __$originalPosition: new UTSSourceMapPosition("pieOption", "src/pages/basic/components/EchartsDemoCard.uvue", 198, 7), 
  title: {
    text: '访问来源 (饼图)',
    textStyle: {
      fontSize: 12,
