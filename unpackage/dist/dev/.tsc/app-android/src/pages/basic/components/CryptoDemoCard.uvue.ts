...
async function handleRsaGenerateKeyPair() {
  try {
    ...
    try {
      ...
      const keyData = UTSAndroid.consoleDebugError(JSON.parse(jsonStr), " at src/pages/basic/components/CryptoDemoCard.uvue:413") as UTSJSONObject
      ...
      console.error('Failed to parse RSA keypair:', err, " at src/pages/basic/components/CryptoDemoCard.uvue:425")
    }
  }
  catch (e : any) {
