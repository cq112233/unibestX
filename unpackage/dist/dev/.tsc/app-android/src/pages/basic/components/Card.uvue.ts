...
const GenSrcPagesBasicComponentsCardStyles = [_uM([["font-bold", _pS(_uM([["--tw-font-weight", "700"], ["fontWeight", 700]]))], ["wtu-1ldduh1-0", _pS(_uM([["backgroundColor", "#ffffff"]]))], ["wtu-1xzbcj9-1", _pS(_uM([["display", "flex"]]))], ["wtu-ermdzg-2", _pS(_uM([["flexDirection", "row"]]))], ["wtu-1ejnel4-3", _pS(_uM([["alignItems", "center"]]))], ["wtu-1rlqhz-4", _pS(_uM([["backgroundColor", "#3182ce"]]))], ["wtu-vvdt71-5", _pS(_uM([["--tw-font-weight", "700"], ["fontWeight", 700]]))], ["wtu-6hzxf1-6", _pS(_uM([["color", "#2d3748"]]))]])]
