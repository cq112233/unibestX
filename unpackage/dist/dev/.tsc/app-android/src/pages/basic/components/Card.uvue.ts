...
return (): any | null => {
  ...
  return _cE("view", _uM({ class: "bg-white rounded-16px p-20px m-16px border-width-1px border-style-solid border-color-__edf2f7_" }), [
    _cE("view", _uM({ class: "flex flex-row items-center mb-16px" }), [
      ...
      renderSlot(_ctx.$slots, "title", {}, (): any[] => [
        _cE("text", _uM({ class: "text-16px font-bold text-__2d3748_" }), _tD(_ctx.title), 1 /* TEXT */)
      ])
    ]),
