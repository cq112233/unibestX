...
function navigateToShowcase() {
  uni.navigateTo({
    ...
    fail: (err) => {
      console.error('navigateToShowcase fail:', err, " at src/pages/basic/components/UViewUltraDemoCard.uvue:106")
    },
  })
}
    ...
    default: withSlotCtx((): any[] => [
      _cE("view", _uM({ class: "flex-col mb-16px" }), [
        ...
        _cE("view", _uM({
          ...
          _cE("text", _uM({ class: "text-12px text-__475569_ font-medium mr-4px" }), "官网："),
          _cE("text", _uM({ class: "text-12px text-__2563eb_ underline flex-1" }), "https://uview-ultra.lingyun.net/"),
          _cE("text", _uM({ class: "text-11px text-__94a3b8_" }), "点击复制")
        ]),
...
const GenSrcPagesBasicComponentsUViewUltraDemoCardStyles = [_uM([["bg-__3b82f6_", _pS(_uM([["backgroundImage", "none"], ["backgroundColor", "#3b82f6"]]))], ["bg-__d1fae5_", _pS(_uM([["backgroundImage", "none"], ["backgroundColor", "#d1fae5"]]))], ["bg-__e0edff_", _pS(_uM([["backgroundImage", "none"], ["backgroundColor", "#e0edff"]]))], ["bg-__f1f5f9_", _pS(_uM([["backgroundImage", "none"], ["backgroundColor", "#f1f5f9"]]))], ["bg-__fef3c7_", _pS(_uM([["backgroundImage", "none"], ["backgroundColor", "#fef3c7"]]))], ["border-color-__a7f3d0_", _pS(_uM([["borderTopColor", "#a7f3d0"], ["borderRightColor", "#a7f3d0"], ["borderBottomColor", "#a7f3d0"], ["borderLeftColor", "#a7f3d0"]]))], ["border-color-__bfdbfe_", _pS(_uM([["borderTopColor", "#bfdbfe"], ["borderRightColor", "#bfdbfe"], ["borderBottomColor", "#bfdbfe"], ["borderLeftColor", "#bfdbfe"]]))], ["border-color-__fde68a_", _pS(_uM([["borderTopColor", "#fde68a"], ["borderRightColor", "#fde68a"], ["borderBottomColor", "#fde68a"], ["borderLeftColor", "#fde68a"]]))], ["border-style-solid", _pS(_uM([["borderTopStyle", "solid"], ["borderRightStyle", "solid"], ["borderBottomStyle", "solid"], ["borderLeftStyle", "solid"]]))], ["border-width-1px", _pS(_uM([["borderTopWidth", 1], ["borderRightWidth", 1], ["borderBottomWidth", 1], ["borderLeftWidth", 1]]))], ["flex", _pS(_uM([["display", "flex"]]))], ["flex-1", _pS(_uM([["flexGrow", 1], ["flexShrink", 1], ["flexBasis", "0%"]]))], ["flex-col", _pS(_uM([["flexDirection", "column"]]))], ["flex-row", _pS(_uM([["flexDirection", "row"]]))], ["flex-wrap", _pS(_uM([["flexWrap", "wrap"]]))], ["font-bold", _pS(_uM([["fontWeight", 700]]))], ["font-medium", _pS(_uM([["fontWeight", 500]]))], ["h-44px", _pS(_uM([["height", 44]]))], ["items-center", _pS(_uM([["alignItems", "center"]]))], ["justify-center", _pS(_uM([["justifyContent", "center"]]))], ["leading-18px", _pS(_uM([["lineHeight", "18px"]]))], ["mb-12px", _pS(_uM([["marginBottom", 12]]))], ["mb-16px", _pS(_uM([["marginBottom", 16]]))], ["mb-4px", _pS(_uM([["marginBottom", 4]]))], ["mr-4px", _pS(_uM([["marginRight", 4]]))], ["mr-6px", _pS(_uM([["marginRight", 6]]))], ["none", _pS(_uM([["display", "none"]]))], ["p-8px", _pS(_uM([["paddingTop", 8], ["paddingRight", 8], ["paddingBottom", 8], ["paddingLeft", 8]]))], ["px-10px", _pS(_uM([["paddingLeft", 10], ["paddingRight", 10]]))], ["py-3px", _pS(_uM([["paddingTop", 3], ["paddingBottom", 3]]))], ["rounded-20px", _pS(_uM([["borderTopLeftRadius", 20], ["borderTopRightRadius", 20], ["borderBottomRightRadius", 20], ["borderBottomLeftRadius", 20]]))], ["rounded-6px", _pS(_uM([["borderTopLeftRadius", 6], ["borderTopRightRadius", 6], ["borderBottomRightRadius", 6], ["borderBottomLeftRadius", 6]]))], ["rounded-8px", _pS(_uM([["borderTopLeftRadius", 8], ["borderTopRightRadius", 8], ["borderBottomRightRadius", 8], ["borderBottomLeftRadius", 8]]))], ["text-__059669_", _pS(_uM([["color", "#059669"]]))], ["text-__2563eb_", _pS(_uM([["color", "#2563eb"]]))], ["text-__475569_", _pS(_uM([["color", "#475569"]]))], ["text-__64748b_", _pS(_uM([["color", "#64748b"]]))], ["text-__94a3b8_", _pS(_uM([["color", "#94a3b8"]]))], ["text-__d97706_", _pS(_uM([["color", "#d97706"]]))], ["text-__ffffff_", _pS(_uM([["color", "#ffffff"]]))], ["text-11px", _pS(_uM([["fontSize", 11]]))], ["text-12px", _pS(_uM([["fontSize", 12]]))], ["text-13px", _pS(_uM([["fontSize", 13]]))], ["text-14px", _pS(_uM([["fontSize", 14]]))], ["underline", _pS(_uM([["textDecorationLine", "underline"]]))], ["w-full", _pS(_uM([["width", "100%"]]))]])]
