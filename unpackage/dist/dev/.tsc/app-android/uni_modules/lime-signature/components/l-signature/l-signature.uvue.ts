...
const GenUniModulesLimeSignatureComponentsLSignatureLSignatureStyles = [_uM([["l-signature", _pS(_uM([["flexGrow", 1], ["flexShrink", 1], ["flexBasis", "0%"]]))], ["l-signature__canvas", _pS(_uM([["width", "100%"], ["height", "100%"]]))], ["l-signature-landscape", _pS(_uM([["position", "absolute"], ["pointerEvents", "none"], ["overflow", "visible"], ["left", "99.9%"]]))], ["l-signature-image", _pS(_uM([["transformOrigin", "0% 0%"]]))]])]
