...
export default class WebviewEchart {
    ...
    onWebviewMsg(e: UniWebViewMessageEvent){
        __f__('log','at uni_modules/e-chart/components/e-chart/uts/WebviewEchart.uts:51','onWebviewMsg', e.detail.data)
