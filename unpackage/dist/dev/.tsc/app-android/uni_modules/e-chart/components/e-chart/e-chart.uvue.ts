...
const __sfc__ = defineComponent({
  ...
  methods: {
    ...
    initAPP(option: UTSJSONObject){
      ...
      if(ctx == null){
          console.error('初始化echart的webview失败', " at uni_modules/e-chart/components/e-chart/e-chart.uvue:172")
          return null;
      }
   ...
   onWebviewError(e: UniWebViewErrorEvent){
     console.error('onWebviewError:', e, " at uni_modules/e-chart/components/e-chart/e-chart.uvue:453")
   }
