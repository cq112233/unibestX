...
type HtmlNode = { __$originalPosition?: UTSSourceMapPosition<"HtmlNode", "uni_modules/mp-html/components/mp-html/mp-html.uvue", 44, 6>;
  name?: string
  attrs?: UTSJSONObject
  children?: HtmlNode[]
  type?: string
...
const __sfc__ = defineComponent({
  ...
  methods: {
    ...
    parseAttrs(tag: string): UTSJSONObject {
      const attrs: UTSJSONObject = { __$originalPosition: new UTSSourceMapPosition("attrs", "uni_modules/mp-html/components/mp-html/mp-html.uvue", 226, 13), } as UTSJSONObject
      // 跳过标签名
      let i = 0
    ...
    headingStyle(name: string): string {
      const sz: UTSJSONObject = {__$originalPosition: new UTSSourceMapPosition("sz", "uni_modules/mp-html/components/mp-html/mp-html.uvue", 383, 13), h1: '2em', h2: '1.5em', h3: '1.17em', h4: '1em', h5: '0.83em', h6: '0.67em' }
