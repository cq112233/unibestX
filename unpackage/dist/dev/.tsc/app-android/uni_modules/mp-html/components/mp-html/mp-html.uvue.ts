...
const __sfc__ = defineComponent({
  ...
  methods: {
    ...
    headingStyle(name: string): string {
      const sz: UTSJSONObject = {__$originalPosition: new UTSSourceMapPosition("sz", "uni_modules/mp-html/components/mp-html/mp-html.uvue", 387, 13), h1: '2em', h2: '1.5em', h3: '1.17em', h4: '1em', h5: '0.83em', h6: '0.67em' }
