...
type HtmlNode = { __$originalPosition?: UTSSourceMapPosition<"HtmlNode", "uni_modules/mp-html/components/mp-html/mp-html.uvue", 46, 6>;
  name?: string
  attrs?: UTSJSONObject
  children?: HtmlNode[]
  type?: string
...
function headingStyle(name: string): string {
  const sz: UTSJSONObject = {__$originalPosition: new UTSSourceMapPosition("sz", "uni_modules/mp-html/components/mp-html/mp-html.uvue", 139, 9), h1: '2em', h2: '1.5em', h3: '1.17em', h4: '1em', h5: '0.83em', h6: '0.67em' }
  return 'font-size:' + ((sz[name] as string) ?? '1em') + ';font-weight:bold'
}

function parseAttrs(tag: string): UTSJSONObject {
  const attrs: UTSJSONObject = { __$originalPosition: new UTSSourceMapPosition("attrs", "uni_modules/mp-html/components/mp-html/mp-html.uvue", 144, 9), } as UTSJSONObject
  let i = 0
...
return (): any | null => {
  ...
  return _cE("view", _uM({ class: "_mp_root" }), [
    _cE(Fragment, null, RenderHelpers.renderList(localNodes.value, (n, i, __index, _cached): any => {
      return _cE(Fragment, _uM({ key: i }), [
        n.type == 'text'
          ? _cE("text", _uM({ key: 0 }), _tD(n.text), 1 /* TEXT */)
          : n.name == 'br'
            ? _cE("text", _uM({ key: 1 }), "\n")
            : n.name == 'img'
              ? _cE("image", _uM({
              ...
              : n.name == 'a'
                ? _cE("text", _uM({
                    ...
                    class: "mp-a",
                    onClick: () => {onLinkTap(n)}
                  }), _tD(flatText(n)), 9 /* TEXT, PROPS */, ["onClick"])
                : isTrue(isInline(n.name ?? ''))
                  ? _cE("text", _uM({
                      key: 4,
                      style: _nS(inlineStyle(n.name ?? ''))
                    }), _tD(flatText(n)), 5 /* TEXT, STYLE */)
                  : isTrue(n.name == 'h1' || n.name == 'h2' || n.name == 'h3' || n.name == 'h4' || n.name == 'h5' || n.name == 'h6')
                    ? _cE("text", _uM({
                        key: 5,
                        style: _nS(headingStyle(n.name ?? ''))
                      }), _tD(flatText(n)), 5 /* TEXT, STYLE */)
                              ...
                              _cE(Fragment, null, RenderHelpers.renderList((n.children ?? []), (row, ri, __index, _cached): any => {
                                return _cE("view", _uM({
                                  ...
                                  _cE(Fragment, null, RenderHelpers.renderList((row.children ?? []), (cell, ci, __index, _cached): any => {
                                    return _cE("view", _uM({
                                      key: ci,
                                      style: _nS((cell.name == 'th' ? 'background-color:#f5f5f5;' : '') + 'flex:1;padding:4px 8px;border-width:1px;border-color:#d0d0d0;border-style:solid')
                                    }), [
                                      _cE("text", _uM({
                                        style: _nS(cell.name == 'th' ? 'font-weight:bold;' : '')
                                      }), _tD(flatText(cell)), 5 /* TEXT, STYLE */)
                                    ], 4 /* STYLE */)
                                  }), 128 /* KEYED_FRAGMENT */)
                                ], 4 /* STYLE */)
                              }), 128 /* KEYED_FRAGMENT */)
                            ...
                            ? _cE("view", _uM({
                                ...
                                _cE(Fragment, null, RenderHelpers.renderList((n.children ?? []), (li, lii, __index, _cached): any => {
                                  return _cE("view", _uM({
                                    ...
                                    _cE("text", null, _tD(flatText(li)), 1 /* TEXT */)
                                  ], 4 /* STYLE */)
                                }), 128 /* KEYED_FRAGMENT */)
                              ], 4 /* STYLE */)
                            : _cE("view", _uM({ key: 10 }), [
                                _cE(Fragment, null, RenderHelpers.renderList((n.children ?? []), (cn, ci, __index, _cached): any => {
                                  return _cE(Fragment, _uM({ key: ci }), [
                                    cn.type == 'text'
                                      ? _cE("text", _uM({ key: 0 }), _tD(cn.text), 1 /* TEXT */)
                                      : cn.name == 'br'
                                        ? _cE("text", _uM({ key: 1 }), "\n")
                                        : cn.name == 'img'
                                          ? _cE("image", _uM({
                                          ...
                                          : cn.name == 'a'
                                            ? _cE("text", _uM({
                                                key: 3,
                                                class: "mp-a",
                                                onClick: () => {onLinkTap(cn)}
                                              }), _tD(flatText(cn)), 9 /* TEXT, PROPS */, ["onClick"])
                                            : isTrue(isInline(cn.name ?? ''))
                                              ? _cE("text", _uM({
                                                  key: 4,
                                                  style: _nS(inlineStyle(cn.name ?? ''))
                                                }), _tD(flatText(cn)), 5 /* TEXT, STYLE */)
                                              : _cE("text", _uM({ key: 5 }), _tD(flatText(cn)), 1 /* TEXT */)
                                  ], 64 /* STABLE_FRAGMENT */)
                                }), 128 /* KEYED_FRAGMENT */)
                              ])
      ], 64 /* STABLE_FRAGMENT */)
