...
const GenUniModulesZPagingXComponentsZPagingXComponentsZPagingRefresherStyles = [_uM([["zpx-r-container", _pS(_uM([["height", 40], ["flexDirection", "row"], ["alignItems", "center"], ["justifyContent", "center"]]))], ["zpx-r-image", _pS(_uM([["width", "34rpx"], ["height", "34rpx"], ["transitionDuration", ".2s"], ["transitionProperty", "transform"], ["WebkitTransform", "rotate(0deg)"], ["transform", "rotate(0deg)"]]))], ["zpx-r-arrow-top", _pS(_uM([["WebkitTransform", "rotate(0deg)"], ["transform", "rotate(0deg)"]]))], ["zpx-r-arrow-down", _pS(_uM([["WebkitTransform", "rotate(180deg)"], ["transform", "rotate(180deg)"]]))], ["zpx-r-text-container", _pS(_uM([["flexDirection", "column"], ["alignItems", "center"]]))], ["zpx-r-text", _pS(_uM([["color", "#808080"], ["fontSize", "28rpx"]]))], ["zpx-r-time-text", _pS(_uM([["fontSize", "26rpx"], ["marginTop", "10rpx"]]))], ["@TRANSITION", _uM([["zpx-r-image", _uM([["duration", ".2s"], ["property", "transform"]])]])]])]
