...
export function error(err: string): void {
    ...
    if (process.env.NODE_ENV === 'development') {
        __f__('error','at uni_modules/uview-ultra/libs/function/index.uts:357',`uview-plus提示：${err}`)
    }
}
 ...
 */
 export function timeFormat(dateTime: any|null = 0, formatStr: string = 'yyyy-mm-dd'): string {
  ...
  // __f__('log','at uni_modules/uview-ultra/libs/function/index.uts:446',timeSource)
  for (const key in timeSource) {
    const ret = new RegExp(`${key}+`).exec(formatStr)
    if (ret != null && ret[0] != null) {
	  // __f__('log','at uni_modules/uview-ultra/libs/function/index.uts:450','ret', ret)
	  // 年可能只需展示两位
	  ...
	  if (timeSource[key] != null
		...
		// __f__('log','at uni_modules/uview-ultra/libs/function/index.uts:457','timeSourceKey', typeof timeSourceKey)
...
export function getParentDataFunc(that: any, parentName: string): any {
	__f__('log','at uni_modules/uview-ultra/libs/function/index.uts:880','that', JSON.stringify(that))
    ...
    // __f__('log','at uni_modules/uview-ultra/libs/function/index.uts:888','that.parent', that.parent)
    // todo
