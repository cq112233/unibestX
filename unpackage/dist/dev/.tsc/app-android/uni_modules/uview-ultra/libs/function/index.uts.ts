		...
		if (all == true) {
			uni.createSelectorQuery()
				...
				.boundingClientRect((res) => {
					...
					const nodeInfoArrayItem = nodeInfoArray != null && nodeInfoArray.length > 0 ? nodeInfoArray[0] : ({} as NodeInfo)
...
export function error(err: string): void {
    ...
    if (process.env.NODE_ENV === 'development') {
        __f__('error','at uni_modules/uview-ultra/libs/function/index.uts:321',`uview-plus提示：${err}`)
    }
}
 ...
 */
 export function timeFormat(dateTime: any|null = 0, formatStr: string = 'yyyy-mm-dd'): string {
  ...
  // __f__('log','at uni_modules/uview-ultra/libs/function/index.uts:410',timeSource)
  for (const key in timeSource) {
    const ret = new RegExp(`${key}+`).exec(formatStr)
    if (ret != null && ret[0] != null) {
	  // __f__('log','at uni_modules/uview-ultra/libs/function/index.uts:414','ret', ret)
	  // 年可能只需展示两位
	  ...
	  if (timeSource[key] != null
		...
		// __f__('log','at uni_modules/uview-ultra/libs/function/index.uts:421','timeSourceKey', typeof timeSourceKey)
...
export function getParentDataFunc(that: any, parentName: string): any {
	__f__('log','at uni_modules/uview-ultra/libs/function/index.uts:844','that', JSON.stringify(that))
    ...
    // __f__('log','at uni_modules/uview-ultra/libs/function/index.uts:852','that.parent', that.parent)
    // todo
