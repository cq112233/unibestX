...
export function colorGradient(startColor: string = 'rgb(0, 0, 0)',
	...
	// __f__('log','at uni_modules/uview-ultra/libs/function/colorGradient.uts:9','startColor', startColor)
...
export function hexToRgb(sColor: string, str: boolean = true): any {
    ...
    if (sColor != ''  && reg.test(sColor)
        ...
        for (let i = 1; i < 7; i += 2) {
			// __f__('log','at uni_modules/uview-ultra/libs/function/colorGradient.uts:221','###',sColor.slice(i, i + 2), '###')
			// __f__('log','at uni_modules/uview-ultra/libs/function/colorGradient.uts:222',parseInt(`0x${sColor.slice(i, i + 2)}`))
            sColorChange.push(parseInt(`0x${sColor.slice(i, i + 2)}`))
        }
        if (str == false) {
			// __f__('log','at uni_modules/uview-ultra/libs/function/colorGradient.uts:226','strtrue', sColorChange)
            return sColorChange
        }
