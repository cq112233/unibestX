...
const getModeStyle = function (mode: string, state: string): UTSJSONObject {
	...
	if (state === 'enter' || state === 'leave-to') {
		if (mode === 'fade') {
			...
			style['wtu-18cmtt9-0'] = 'scale(0.95)'
		} else if (mode === 'fade-zoom') {
			style['wtu-18cmtt9-0'] = 'scale(0.95)'
			style['opacity'] = 0
		} else if (mode === 'fade-up') {
			style['wtu-18cmtt9-0'] = 'translateY(100%)'
			style['opacity'] = 0
		} else if (mode === 'fade-down') {
			style['wtu-18cmtt9-0'] = 'translateY(-100%)'
			style['opacity'] = 0
		} else if (mode === 'fade-left') {
			style['wtu-18cmtt9-0'] = 'translateX(-100%)'
			style['opacity'] = 0
		...
		if (mode === 'fade') {
			...
			style['wtu-18cmtt9-0'] = 'translate(0, 0)'
