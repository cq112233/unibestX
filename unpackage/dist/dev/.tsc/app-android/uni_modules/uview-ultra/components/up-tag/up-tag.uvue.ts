	...
	const __sfc__ = defineComponent({
		...
		computed: {
			style(): any {
				const style = {__$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uview-ultra/components/up-tag/up-tag.uvue", 100, 11),}
				if (this.bgColor != '') {
			...
			// nvue下，文本颜色无法继承父元素
			textColor(): any {
				const style = {__$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uview-ultra/components/up-tag/up-tag.uvue", 114, 11),}
				if (this.color != '') {
					style['color'] = this.color
				}
				return style
