	...
	const __sfc__ = defineComponent({
		...
		methods: {
			...
			resizeProgressWidth() {
				upGetRect('.up-line-progress__background', false, this).then((size: NodeInfo) => {
...
function GenUniModulesUviewUltraComponentsUpLineProgressUpLineProgressRender(this: InstanceType<typeof __sfc__>): any | null {
const _ctx = this
const _cache = this.$.renderCache
  return _cE("view", _uM({
    ...
    _cE("view", _uM({
      ...
      style: _nS([_ctx.backgroundStyle])
    }), null, 4 /* STYLE */),
    _cE("view", _uM({
      ...
      renderSlot(_ctx.$slots, "default", {}, (): any[] => [
        isTrue(_ctx.showText && _ctx.percentageValue >= 10)
          ? _cE("text", _uM({
              key: 0,
              class: "up-line-progress__text"
            }), _tD(_ctx.innerPercentage + '%'), 1 /* TEXT */)
          : _cC("v-if", true)
      ])
    ], 4 /* STYLE */)
  ], 4 /* STYLE */)
