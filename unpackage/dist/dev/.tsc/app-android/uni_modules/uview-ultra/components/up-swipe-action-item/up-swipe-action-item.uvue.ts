	...
	const __sfc__ = defineComponent({
		...
		methods: {
			...
			openSwipeAction() {
				...
				this.sliderStyle = {
					'transition': 'wtu-8adrbp-0 ' + duration,
					'wtu-8adrbp-0': 'translateX(' + buttonsWidth + 'px)',
...
const GenUniModulesUviewUltraComponentsUpSwipeActionItemUpSwipeActionItemStyles = [_uM([["up-swipe-action-item", _pS(_uM([["position", "relative"], ["overflow", "hidden"], ["display", "flex"], ["flexDirection", "column"]]))], ["up-swipe-action-item__content", _pS(_uM([["WebkitTransform", "translateX(0px)"], ["transform", "translateX(0px)"], ["backgroundColor", "#FFFFFF"], ["zIndex", 10], ["width", "100%"], ["flexGrow", 1], ["flexShrink", 1], ["flexBasis", "0%"]]))], ["up-swipe-action-item__right", _pS(_uM([["position", "absolute"], ["top", 0], ["bottom", 0], ["right", 0], ["display", "flex"], ["flexDirection", "row"], ["zIndex", 1]]))], ["up-swipe-action-item__right__button", _pS(_uM([["display", "flex"], ["flexDirection", "row"], ["justifyContent", "center"], ["overflow", "hidden"], ["alignItems", "center"]]))], ["up-swipe-action-item__right__button__wrapper", _pS(_uM([["display", "flex"], ["flexDirection", "row"], ["alignItems", "center"], ["justifyContent", "center"], ["paddingTop", 0], ["paddingRight", 15], ["paddingBottom", 0], ["paddingLeft", 15]]))], ["up-swipe-action-item__right__button__wrapper--primary", _pS(_uM([["backgroundColor", "var(--theme-color)"]]))], ["up-swipe-action-item__right__button__wrapper__text", _pS(_uM([["color", "#FFFFFF"], ["fontSize", 15], ["textAlign", "center"]]))], ["wtu-8adrbp-0", _pS(_uM([["WebkitTransform", ""], ["transform", ""]]))]])]
