		...
		computed: {
			...
			finalStyle(): any {
				...
				const style = { __$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uview-ultra/components/up-back-top/up-back-top.uvue", 95, 11), 
					position: 'wtu-165s31r-0',
					bottom: bVal,
					right: rVal,
					width: '44px',
					height: '44px',
					zIndex: isNaN(zVal) ? 999 : zVal,
					display: 'wtu-imxsgk-1',
...
const GenUniModulesUviewUltraComponentsUpBackTopUpBackTopStyles = [_uM([["up-back-top__text", _pS(_uM([["fontSize", 10], ["color", "#2563eb"], ["marginTop", 2]]))], ["wtu-165s31r-0", _pS(_uM([["position", "fixed"]]))], ["wtu-imxsgk-1", _pS(_uM([["display", "flex"]]))]])]
