	...
	import { propsNavbarMini } from './props';
...
function GenUniModulesUviewUltraComponentsUpNavbarMiniUpNavbarMiniRender(this: InstanceType<typeof __sfc__>): any | null {
const _ctx = this
...
const _component_up_line = resolveEasyComponent("up-line",_easycom_up_line)
  ...
  return _cE("view", _uM({
    class: _nC(["up-navbar-mini", [_ctx.customClass]])
  }), [
    _cE("view", _uM({
      class: _nC(["up-navbar-mini__inner", [_ctx.fixed ? 'up-navbar-mini--fixed' : '']])
    }), [
