...
const textareaStyle = computed<UTSJSONObject>(() => {
  const style = { __$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uview-ultra/components/up-textarea/up-textarea.uvue", 188, 9), } as UTSJSONObject
...
return (): any | null => {
  ...
  return _cE("view", _uM({
    class: _nC(["up-textarea", textareaClass.value]),
    style: _nS(textareaStyle.value)
  }), [
    _cE("textarea", _uM({
      ...
      "placeholder-style": placeholderStyleStr.value,
    ...
    }), null, 44 /* STYLE, PROPS, NEED_HYDRATION */, ["value", "placeholder", "placeholder-style", "placeholder-class", "disabled", "focus", "autoHeight", "fixed", "cursorSpacing", "cursor", "showConfirmBar", "selectionStart", "selectionEnd", "adjustPosition", "disableDefaultPadding", "holdKeyboard", "maxlength", "confirm-type", "ignoreCompositionEvent"]),
    isTrue(_ctx.count)
      ? _cE("text", _uM({
          key: 0,
        ...
        }), _tD(innerValue.value.length) + "/" + _tD(_ctx.maxlength), 5 /* TEXT, STYLE */)
      : _cC("v-if", true)
  ], 6 /* CLASS, STYLE */)
}
}
