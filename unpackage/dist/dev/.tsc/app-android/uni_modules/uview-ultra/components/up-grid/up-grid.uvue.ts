...
__ins.emit(event, ...do_not_transform_spread)
	...
	const gridStyle = computed(() => {
		let style = {__$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uview-ultra/components/up-grid/up-grid.uvue", 62, 7),};
		switch (props.align) {
			case 'left':
