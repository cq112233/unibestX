...
function getImageStyle(index1: number, index2: number): UTSJSONObject {
    ...
    const style = { __$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uview-ultra/components/up-album/up-album.uvue", 266, 11), 
...
const _component_up_text = resolveEasyComponent("up-text",_easycom_up_text)
  ...
  return _cE("view", _uM({ class: "up-album" }), [
