...
const imageStyle = computed(() => {
    return (index1: number, index2: number) => {
        ...
        const style = {__$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uview-ultra/components/up-album/up-album.uvue", 268, 15),
  ...
  return _cE("view", _uM({ class: "up-album" }), [
    _cE(Fragment, null, RenderHelpers.renderList(showUrls.value, (arr, index, __index, _cached): any => {
      return _cE("view", _uM({
        ...
        ref_for: true,
        ref: "up-album__row",
        forComputedUse: albumWidth.value,
        key: index,
        style: _nS(_uM({flexWrap: _ctx.autoWrap ? 'wrap' : 'nowrap'}))
      }), [
        _cE(Fragment, null, RenderHelpers.renderList(arr, (item, index1, __index, _cached): any => {
          return _cE("view", _uM({
            class: "up-album__row__wrapper",
            key: index1,
            style: _nS([imageStyle.value(index + 1, index1 + 1)]),
            ...
            _cE("image", _uM({
              ...
              mode: 
                        _ctx.urls.length == 1
                            ? (imageHeight.value != '0px' && imageHeight.value != '0rpx')
                                ? _ctx.singleMode
                                : 'widthFix'
                            : _ctx.multipleMode
                    ,
              style: _nS([
                        _uM({
                            ...
                            borderRadius: _ctx.shape == 'circle' ? '10000px' : _ctx.$upAddUnit(_ctx.radius)
                        })
                    ])
            ...
            isTrue(
              ...
              ? _cE("view", _uM({
                  ...
                  style: _nS(_uM({
					    borderRadius: _ctx.shape == 'circle' ? '50%' : _ctx.$upAddUnit(_ctx.radius),
				    }))
                }), [
