	...
	const __sfc__ = defineComponent({
		...
		computed: {
			...
			// 指示器为线型的样式
			lineStyle(): any {
				let style = {__$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uview-ultra/components/up-swiper-indicator/up-swiper-indicator.uvue", 68, 9),}
				style['width'] = addUnit(this.lineWidth)
				style['wtu-1t80l2d-0'] = `translateX(${ addUnit(this.current as number * this.lineWidth) })`
		...
		methods: {
			...
			dotStyle(index: number): any {
				let style = {__$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uview-ultra/components/up-swiper-indicator/up-swiper-indicator.uvue", 81, 9),}
