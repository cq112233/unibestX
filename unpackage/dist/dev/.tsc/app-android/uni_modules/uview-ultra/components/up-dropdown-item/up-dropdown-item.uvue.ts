...
__ins.emit(event, ...do_not_transform_spread)
	...
	function getItemTextStyle(item: UTSJSONObject): UTSJSONObject {
		const style = { __$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uview-ultra/components/up-dropdown-item/up-dropdown-item.uvue", 163, 9), } as UTSJSONObject
...
const GenUniModulesUviewUltraComponentsUpDropdownItemUpDropdownItemStyles = [_uM([["up-dropdown-item__scroll", _pS(_uM([["backgroundImage", "none"], ["backgroundColor", "#ffffff"]]))], ["up-dropdown-item__text", _pS(_uM([["fontSize", 15]]))], ["up-dropdown-item__text--active", _pS(_uM([["color", "var(--theme-color)"]]))]])]
