...
__ins.emit(event, ...do_not_transform_spread)
	...
	function getItemTextStyle(item: UTSJSONObject): UTSJSONObject {
		const style = { __$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uview-ultra/components/up-dropdown-item/up-dropdown-item.uvue", 136, 9), } as UTSJSONObject
