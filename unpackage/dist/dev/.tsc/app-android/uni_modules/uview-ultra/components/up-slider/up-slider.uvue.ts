	 ...
	 */
	type barStyleType = { __$originalPosition?: UTSSourceMapPosition<"barStyleType", "uni_modules/uview-ultra/components/up-slider/up-slider.uvue", 108, 7>;
		width : string,
		transition ?: string
	}
	type sliderRectType = { __$originalPosition?: UTSSourceMapPosition<"sliderRectType", "uni_modules/uview-ultra/components/up-slider/up-slider.uvue", 112, 7>;
		left: number,
		width : number
	}
	const __sfc__ = defineComponent({
		...
		computed: {
			...
			blockStyleCpu(): UTSJSONObject {
				let style = { __$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uview-ultra/components/up-slider/up-slider.uvue", 183, 9), } as UTSJSONObject;
			...
			gapStyleCpu(): UTSJSONObject {
				let style = { __$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uview-ultra/components/up-slider/up-slider.uvue", 199, 9), } as UTSJSONObject;
