	...
	const __sfc__ = defineComponent({
		...
		computed: {
			...
			switchStyle(): UTSJSONObject {
				let style = {__$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uview-ultra/components/up-switch/up-switch.uvue", 96, 9),}
			...
			bgActiveStyle(): UTSJSONObject {
				let style = {__$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uview-ultra/components/up-switch/up-switch.uvue", 120, 9),}
				// @ts-ignore
				style['width'] = addUnit(parseInt(this.size.toString()) * 2 + 2)
				// @ts-ignore
				style['height'] = addUnit(parseInt(this.size.toString()) + 2)
			...
			nodeStyle(): UTSJSONObject {
				let style = {__$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uview-ultra/components/up-switch/up-switch.uvue", 131, 9),}
				...
				style['wtu-enqrlt-0'] = `translateX(-${translateX})`
				return style
			},
			bgStyle(): UTSJSONObject {
				let style = {__$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uview-ultra/components/up-switch/up-switch.uvue", 142, 9),}
				...
				// 打开时，让此元素收缩，否则反之
				style['wtu-enqrlt-0'] = `scale(${this.isActive ? 0 : 1})`
				return style
			},
...
function GenUniModulesUviewUltraComponentsUpSwitchUpSwitchRender(this: InstanceType<typeof __sfc__>): any | null {
const _ctx = this
const _cache = this.$.renderCache
const _component_up_loading_icon = resolveEasyComponent("up-loading-icon",_easycom_up_loading_icon)

  return _cE("view", _uM({
    class: _nC(_ctx.switchClass),
    style: _nS([_ctx.switchStyle, _ctx.addStyle(_ctx.customStyle)]),
    onClick: _ctx.clickHandler
  }), [
    isTrue(_ctx.isActive)
      ? _cE("view", _uM({
          key: 0,
          class: "up-switch__bg-active",
          style: _nS([_ctx.bgActiveStyle])
        }), null, 4 /* STYLE */)
      : _cC("v-if", true),
    isTrue(!_ctx.isActive)
      ? _cE("view", _uM({
    ...
    _cE("view", _uM({
      ...
      _cV(_component_up_loading_icon, _uM({
        ...
        size: parseInt(_ctx.getPx(_ctx.size)) * 0.6
