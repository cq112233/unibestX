...
const switchStyle = computed<UTSJSONObject>(() => {
  let style = { __$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uview-ultra/components/up-switch/up-switch.uvue", 128, 7), } as UTSJSONObject
...
const nodeStyle = computed<UTSJSONObject>(() => {
  let style = { __$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uview-ultra/components/up-switch/up-switch.uvue", 160, 7), } as UTSJSONObject
...
const bgStyle = computed<UTSJSONObject>(() => {
  let style = { __$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uview-ultra/components/up-switch/up-switch.uvue", 171, 7), } as UTSJSONObject
