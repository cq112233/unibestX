...
function itemStyle(index: number): UTSJSONObject {
	let style = { __$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uview-ultra/components/up-number-keyboard/up-number-keyboard.uvue", 97, 6), } as UTSJSONObject
