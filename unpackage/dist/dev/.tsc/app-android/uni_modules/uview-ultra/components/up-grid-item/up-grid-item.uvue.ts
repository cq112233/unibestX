...
__ins.emit(event, ...do_not_transform_spread)
	...
	const itemStyle = computed(() => {
		const style = {__$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uview-ultra/components/up-grid-item/up-grid-item.uvue", 64, 9),
	...
	const gridItemClasses = () => {
		if(parentData.value['wtu-vujn1n-0'] as boolean) {
