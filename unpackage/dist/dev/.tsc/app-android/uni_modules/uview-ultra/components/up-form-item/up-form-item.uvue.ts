...
__ins.emit(event, ...do_not_transform_spread)
	...
	const bodyStyle = computed((): UTSJSONObject => {
		...
		const base = { __$originalPosition: new UTSSourceMapPosition("base", "uni_modules/uview-ultra/components/up-form-item/up-form-item.uvue", 172, 9), 
...
const _component_up_line = resolveEasyComponent("up-line",_easycom_up_line)
  ...
  return _cE("view", _uM({
    class: _nC(["up-form-item", _uM({'up-form-item--error': isErrorMessage.value})])
  }), [
    _cE("view", _uM({
