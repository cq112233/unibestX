...
__ins.emit(event, ...do_not_transform_spread)
	...
	const iconWrapStyle = computed((): any => {
		// checkbox的整体样式
		const style = {__$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uview-ultra/components/up-checkbox/up-checkbox.uvue", 271, 9),};
	...
	const checkboxStyle = computed((): any => {
		const style = {__$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uview-ultra/components/up-checkbox/up-checkbox.uvue", 294, 9),};
