...
import { addStyle, addUnit, deepMerge, formValidate, sleep, os } from '../../libs/function/index.uts'
...
const wrapperStyle = computed(() => {
    const style = {__$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uview-ultra/components/up-input/up-input.uvue", 368, 11),};
    // 禁用状态下，被背景色加上对应的样式
    if (props.disabled) {
...
const computedWrapperStyle = computed((): UTSJSONObject => {
...
const inputStyle = computed(() => {
    const style = {__$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uview-ultra/components/up-input/up-input.uvue", 393, 11),
        color: props.color,
...
const onInput = (e: UniInputEvent) => {
    ...
    console.log('onInput', value, innerValue.value, " at uni_modules/uview-ultra/components/up-input/up-input.uvue:405")
...
const _component_up_icon = resolveEasyComponent("up-icon",_easycom_up_icon)
  ...
  return _cE("view", _uM({
    class: _nC(["up-input", inputClass.value]),
    style: _nS(computedWrapperStyle.value)
  }), [
    _cE("view", _uM({ class: "up-input__content" }), [
      isTrue(_ctx.prefixIcon != '' || _ctx.$slots['prefix'] != null)
        ? _cE("view", _uM({
            key: 0,
      ...
      _cE("view", _uM({
        ...
        }), null, 44 /* STYLE, PROPS, NEED_HYDRATION */, ["type", "focus", "cursor", "value", "auto-blur", "disabled", "maxlength", "placeholder", "placeholder-style", "placeholder-class", "confirm-type", "confirm-hold", "hold-keyboard", "cursor-spacing", "adjust-position", "selection-end", "selection-start", "password", "ignoreCompositionEvent"])
      ]),
      isTrue(isShowClear.value)
        ...
        : _cC("v-if", true),
      isTrue(_ctx.suffixIcon != '' || _ctx.$slots['suffix'] != null)
        ? _cE("view", _uM({
            key: 2,
