...
const wrapperStyle = computed(() => {
    const style = {__$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uview-ultra/components/up-input/up-input.uvue", 360, 11),};
    // 禁用状态下，被背景色加上对应的样式
    if (props.disabled) {
...
const inputStyle = computed(() => {
    const style = {__$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uview-ultra/components/up-input/up-input.uvue", 379, 11),
        color: props.color,
...
const _component_up_icon = resolveEasyComponent("up-icon",_easycom_up_icon)
  ...
  return _cE("view", _uM({
    ...
    style: _nS([wrapperStyle.value, _ctx.$up.addStyle(_ctx.customStyle)])
  }), [
