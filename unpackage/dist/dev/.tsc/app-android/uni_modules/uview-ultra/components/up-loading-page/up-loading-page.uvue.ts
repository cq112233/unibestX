...
const formattedIconSize = computed((): string => {
...
const transitionStyle = computed<UTSJSONObject>(() => {
  const base = { __$originalPosition: new UTSSourceMapPosition("base", "uni_modules/uview-ultra/components/up-loading-page/up-loading-page.uvue", 109, 9), 
    position: 'fixed',
    top: 0,
    left: 0,
    right: 0,
...
const _component_up_transition = resolveEasyComponent("up-transition",_easycom_up_transition)
  ...
  return _cV(_component_up_transition, _uM({
    ...
    default: withSlotCtx((): any[] => [
      _cE("view", _uM({ class: "up-loading-page" }), [
        _cE("view", _uM({ class: "up-loading-page__warpper" }), [
          _cE("view", _uM({ class: "up-loading-page__warpper__loading-icon" }), [
            _ctx.image != ''
              ? _cE("image", _uM({
                  key: 0,
                  src: _ctx.image,
