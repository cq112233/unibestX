...
return (): any | null => {
  ...
  return _cE("view", _uM({
    class: _nC(["up-index-item", ['up-index-item-' + itemId.value]]),
    id: 'up-index-item-' + itemId.value
  }), [
