import type { PropType } from 'vue'
	...
	type UPFormRules = { __$originalPosition?: UTSSourceMapPosition<"UPFormRules", "uni_modules/uview-ultra/components/up-form/up-form.uvue", 19, 7>;
...
__ins.emit(event, ...do_not_transform_spread)
	...
	function validateField(value: Array<string>|string,
		...
		return new Promise((resolve, reject) => {
			...
			const modelSnapshot = UTSAndroid.consoleDebugError(JSON.parse(JSON.stringify(props.model)), " at uni_modules/uview-ultra/components/up-form/up-form.uvue:145") as UTSJSONObject
			// 如果为字符串，转为数组
