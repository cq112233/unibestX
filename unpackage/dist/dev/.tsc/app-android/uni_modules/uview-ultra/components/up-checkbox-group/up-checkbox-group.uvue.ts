import { computed, ref, watch, provide, getCurrentInstance } from 'vue'
...
__ins.emit(event, ...do_not_transform_spread)
	...
	function toggleCheckbox(childName: string, childChecked: boolean) {
	...
	// 将其他的checkbox设置为未选中的状态 (兼容旧版 VDOM 模式)
