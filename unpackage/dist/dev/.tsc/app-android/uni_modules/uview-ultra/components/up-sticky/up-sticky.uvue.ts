	...
	const __sfc__ = defineComponent({
		...
		computed: {
			// 组件样式
			style(): any {
				const style = {__$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uview-ultra/components/up-sticky/up-sticky.uvue", 59, 11),}
				if(!this.disabled) {
			...
			// 吸顶内容的样式
			stickyContent(): any {
				const style = {__$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uview-ultra/components/up-sticky/up-sticky.uvue", 71, 11),}
				if (!this.cssSticky) {
