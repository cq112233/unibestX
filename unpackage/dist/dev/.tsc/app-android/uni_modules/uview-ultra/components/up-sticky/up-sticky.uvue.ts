	...
	const __sfc__ = defineComponent({
		...
		computed: {
			...
			webMpStyle(): any {
				const style = { __$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uview-ultra/components/up-sticky/up-sticky.uvue", 58, 11), } as UTSJSONObject
				if (!this.disabled) {
			...
			wrapperStyle(): any {
				const style = { __$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uview-ultra/components/up-sticky/up-sticky.uvue", 89, 11), } as UTSJSONObject
