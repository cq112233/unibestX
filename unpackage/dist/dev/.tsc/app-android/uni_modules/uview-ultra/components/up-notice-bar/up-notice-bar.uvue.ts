	...
	import { propsNoticeBar } from './props';
...
function GenUniModulesUviewUltraComponentsUpNoticeBarUpNoticeBarRender(this: InstanceType<typeof __sfc__>): any | null {
const _ctx = this
    ...
    ? _cE("view", _uM({
        ...
        isTrue(_ctx.direction === 'column' || (_ctx.direction === 'row' && _ctx.step))
          ? _cV(_component_up_column_notice, _uM({
              ...
              onClose: _ctx.close,
              onClick: _ctx.click
            }), null, 8 /* PROPS */, ["color", "bgColor", "text", "mode", "step", "icon", "disable-touch", "fontSize", "duration", "onClose", "onClick"])
