...
__ins.emit(event, ...do_not_transform_spread)
	...
	const textStyle = computed(() => {
		let style = {__$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uview-ultra/components/up-row-notice/up-row-notice.uvue", 107, 7),}
	...
	const animationStyle = computed(() => {
		let style = {__$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uview-ultra/components/up-row-notice/up-row-notice.uvue", 116, 7),}
		style['wtu-1uucr1x-0'] = transform.value
