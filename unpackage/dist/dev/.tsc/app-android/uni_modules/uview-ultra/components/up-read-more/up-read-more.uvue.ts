	...
	const __sfc__ = defineComponent({
		...
		computed: {
			...
			innerShadowStyle() {
				...
				const appStyle = { __$originalPosition: new UTSSourceMapPosition("appStyle", "uni_modules/uview-ultra/components/up-read-more/up-read-more.uvue", 87, 11), } as UTSJSONObject
...
function GenUniModulesUviewUltraComponentsUpReadMoreUpReadMoreRender(this: InstanceType<typeof __sfc__>): any | null {
const _ctx = this
...
const _component_up_icon = resolveEasyComponent("up-icon",_easycom_up_icon)
  ...
  return _cE("view", _uM({ class: "up-read-more" }), [
    _cE("view", _uM({
      class: "up-read-more__content",
      style: _nS(_uM({
				height: _ctx.isLongContent && _ctx.status === 'close' ? _ctx.addUnit(_ctx.showHeight) : 'auto'
			}))
    }), [
      _cE("view", _uM({
        class: _nC(["up-read-more__content__inner", [_ctx.elId]]),
        ref: "up-read-more__content__inner"
      }), [
        renderSlot(_ctx.$slots, "default")
      ], 2 /* CLASS */)
    ], 4 /* STYLE */),
    isTrue(_ctx.isLongContent)
      ? _cE("view", _uM({
          key: 0,
          class: "up-read-more__toggle",
          style: _nS([_ctx.innerShadowStyle])
        }), [
          renderSlot(_ctx.$slots, "toggle", {}, (): any[] => [
            _cE("view", _uM({
              class: "up-read-more__toggle__text",
              onClick: _ctx.toggleReadMore
            }), [
              _cV(_component_up_text, _uM({
                text: _ctx.status === 'close' ? _ctx.closeText : _ctx.openText,
                color: _ctx.color,
                size: _ctx.fontSize,
                lineHeight: _ctx.fontSize,
                margin: "0 5px 0 0"
              }), null, 8 /* PROPS */, ["text", "color", "size", "lineHeight"]),
              _cE("view", _uM({ class: "up-read-more__toggle__icon" }), [
                _cV(_component_up_icon, _uM({
                  color: _ctx.color,
                  size: parseInt(_ctx.getPx(_ctx.fontSize)) + 2,
                  name: _ctx.status === 'close' ? 'arrow-down' : 'arrow-up'
...
export type UpReadMoreComponentPublicInstance = InstanceType<typeof __sfc__>;
const GenUniModulesUviewUltraComponentsUpReadMoreUpReadMoreStyles = [_uM([["up-read-more__content", _pS(_uM([["overflow", "hidden"]]))], ["up-read-more__toggle", _pS(_uM([["display", "flex"], ["flexDirection", "row"], ["justifyContent", "center"], ["position", "relative"]]))], ["up-read-more__toggle__text", _pS(_uM([["display", "flex"], ["flexDirection", "row"], ["alignItems", "center"], ["justifyContent", "center"], ["marginTop", 5]]))]])]
