...
const _cache = __ins.renderCache;
	...
	const badgeStyle = computed(() => {
		const style: UTSJSONObject = {__$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uview-ultra/components/up-badge/up-badge.uvue", 124, 9),}
		if(props.color != '') {
