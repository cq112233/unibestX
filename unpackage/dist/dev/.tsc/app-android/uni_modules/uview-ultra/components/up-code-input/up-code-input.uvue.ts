...
__ins.emit(event, ...do_not_transform_spread)
	...
	const codeTextStyle = computed((): UTSJSONObject => {
		return {
	...
	const cursorStyle = computed((): UTSJSONObject => {
		return {
	...
	const lineStyle = computed((): UTSJSONObject => {
		const style = { __$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uview-ultra/components/up-code-input/up-code-input.uvue", 186, 9), } as UTSJSONObject
	...
	// 根据索引获取对应项的样式
	const itemStyle = (index: number): UTSJSONObject => {
		const style = { __$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uview-ultra/components/up-code-input/up-code-input.uvue", 238, 9), 
