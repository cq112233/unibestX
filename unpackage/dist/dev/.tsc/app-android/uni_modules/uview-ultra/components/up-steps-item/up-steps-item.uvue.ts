	...
	const __sfc__ = defineComponent({
		...
		computed: {
			...
			lineStyle() {
				...
				if (parent != null) {
					const children = parent.$data['children'] as ComponentPublicInstance[] | null
			...
			dotStyle(): any {
				const style = { __$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uview-ultra/components/up-steps-item/up-steps-item.uvue", 208, 11), } as UTSJSONObject
			...
			circleStyle(): any {
				const style = { __$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uview-ultra/components/up-steps-item/up-steps-item.uvue", 220, 11), } as UTSJSONObject
				const activeColor = this.parentData['activeColor'] as string
			...
			circleTextStyle(): any {
				const style = { __$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uview-ultra/components/up-steps-item/up-steps-item.uvue", 242, 11), } as UTSJSONObject
				const activeColor = this.parentData['activeColor'] as string
				const inactiveColor = this.parentData['inactiveColor'] as string
				if (activeColor != '#3c9cff' || inactiveColor != '#969799') {
					if (this.statusClass === 'process') {
			...
			contentStyle(): any {
				const style = {__$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uview-ultra/components/up-steps-item/up-steps-item.uvue", 295, 11),}
				// @ts-ignore
		...
		methods: {
			init() {
				...
				const children = parent.$data['children'] as ComponentPublicInstance[] | null
				if (children != null) {
					children.forEach((child: ComponentPublicInstance, index: number) => {
						if (child == this) {
							this.index = index
						}
					})
