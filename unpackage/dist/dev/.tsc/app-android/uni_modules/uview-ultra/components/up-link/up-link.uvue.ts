	...
	const __sfc__ = defineComponent({
		...
		computed: {
			linkStyle(): any{
				const style = {__$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uview-ultra/components/up-link/up-link.uvue", 35, 11),
					color: this.color,
					fontSize: addUnit(this.fontSize),
					// line-height设置为比字体大小多2px
					lineHeight: addUnit(parseInt(getPx(this.fontSize)) + 2),
					textDecoration: this.underLine ? 'wtu-1v1jlf5-0' : 'none'
				}
				// if (this.underLine) {
