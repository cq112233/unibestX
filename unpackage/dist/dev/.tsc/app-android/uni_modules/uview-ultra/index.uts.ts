...
export function loadFont() {
	uni.loadFontFace({
	  ...
	  success() {
		__f__('log','at uni_modules/uview-ultra/index.uts:32','global loadFontFace uni.ttf success')
	  },
	  fail(error) {
		__f__('warn','at uni_modules/uview-ultra/index.uts:35','global loadFontFace uni.ttf fail', error.errMsg)
	  }
	})
}
