...
const _component_up_toast = resolveEasyComponent("up-toast",_easycom_up_toast)
  ...
  return _cE("view", _uM({
    ...
    style: _nS([_uM({"flex":"1"}), _uM({ '--theme-color': unref(appStore).state.theme })])
  }), [
    _cE("scroll-view", _uM({
      direction: "vertical",
      class: "flex-1",
...
const GenAppkuStyles = [_uM([["flex", _pS(_uM([["display", "flex"]]))], ["flex-col", _pS(_uM([["flexDirection", "column"]]))], ["flex-1", _pS(_uM([["flexGrow", 1], ["flexShrink", 1], ["flexBasis", "0%"]]))]])]
