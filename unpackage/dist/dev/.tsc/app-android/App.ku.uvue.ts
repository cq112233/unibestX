...
watch((): boolean => appStore.state.isDark, (isDark: boolean) => {
...
const _component_up_toast = resolveEasyComponent("up-toast",_easycom_up_toast)
  ...
  return _cE("view", _uM({
    class: _nC(["root-container flex flex-col flex-1", _uM({ 'dark': unref(appStore).state.isDark, 'theme-dark': unref(appStore).state.isDark })]),
