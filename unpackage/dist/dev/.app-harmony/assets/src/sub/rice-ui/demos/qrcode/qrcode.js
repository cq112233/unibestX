...
import { _ as __easycom_1 } from "../../../../../uni_modules/rice-ui/components/rice-qrcode/rice-qrcode.js";
...
import "../../../../../uni_modules/rice-ui/components/rice-qrcode/utils.js";
...
const __className = "GenSrcSubRiceUiDemosQrcodeQrcode";
const { computed } = globalThis.Vue;
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  __dynamicSharedData: true,
  __hash: "e57d732e",
  __className,
  __filename: "src/sub/rice-ui/demos/qrcode/qrcode.uvue",
  __name: "qrcode",
  setup(__props) {
    const __sharedDataRenderer = _useSharedDataRenderer();
    const __sharedData = __sharedDataRenderer == "component" ? _withSharedDataComponent(new UniDynamicSharedDataComponent(_useSharedDataScope(), _useSharedDataComponentOptions({ bundleKey: "GenSrcSubRiceUiDemosQrcodeQrcodeSharedData", sharedDataClassId: 0 }))) : _withSharedDataPage(new UniDynamicSharedDataPage(_useSharedDataPageId(), _useSharedDataPageOptions({ bundleKey: "GenSrcSubRiceUiDemosQrcodeQrcodeSharedData", sharedDataClassId: 0 })));
    ...
    return () => {
      ...
      const _component_rice_qrcode = __easycom_1;
      const n9 = _createSharedDataComponent(_sfc_main$1, "d08eef7c", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "5f5880cb", {
            title: "QRCode 二维码",
            "auto-back": true,
          ...
          const n2 = _createSharedDataComponentWithFallback(_component_rice_qrcode, "e890ecae", {
