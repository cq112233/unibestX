...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n28 = _createSharedDataComponent(_sfc_main$1, "5d80d4ea", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "56b31ca2", {
            title: "Transition 动画",
            "auto-back": true,
          ...
          const n4 = _createSharedDataComponentWithFallback(_component_up_transition, "7fb06550", {
            show: () => {
          ...
          const n5 = _createSharedDataComponentWithFallback(_component_up_button, "7fb07070", {
            type: "primary",
            text: () => {
          ...
          const n12 = _createSharedDataComponentWithFallback(_component_up_transition, "7fb07bf5", {
            show: () => {
              return transitionShow.value;
            },
            mode: "zoom"
          ...
          const n18 = _createSharedDataComponentWithFallback(_component_up_transition, "765b5806", {
            show: () => {
          ...
          _setSharedData(__sharedData, 5, n18?.sharedData);
          const _on_click1 = () => {
            return triggerSlide("slide-up");
          };
          const n20 = _createSharedDataComponentWithFallback(_component_up_button, "765b638e", {
            type: "primary",
            text: "上滑",
            size: "mini",
            onClick: () => {
          ...
          _setSharedData(__sharedData, 6, n20?.sharedData);
          const _on_click2 = () => {
            return triggerSlide("slide-down");
          };
          const n21 = _createSharedDataComponentWithFallback(_component_up_button, "765b6a51", {
            type: "success",
            text: "下滑",
            size: "mini",
            onClick: () => {
          ...
          const n22 = _createSharedDataComponentWithFallback(_component_up_button, "765b6e8b", {
            type: "warning",
            text: "左滑",
            size: "mini",
            onClick: () => {
          ...
          _setSharedData(__sharedData, 8, n22?.sharedData);
          const _on_click4 = () => {
            return triggerSlide("slide-right");
          };
          const n23 = _createSharedDataComponentWithFallback(_component_up_button, "765bc185", {
            type: "error",
            text: "右滑",
            size: "mini",
            onClick: () => {
