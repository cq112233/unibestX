...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n12 = _createSharedDataComponent(_sfc_main$1, "497d0bfe", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "e6247228", {
            title: "CodeInput 验证码",
            "auto-back": true,
          ...
          const n2 = _createSharedDataComponentWithFallback(_component_up_code_input, "10cb03c8", {
            modelValue: () => {
          ...
          const n5 = _createSharedDataComponentWithFallback(_component_up_code_input, "10cb0b87", {
            modelValue: () => {
          ...
          const n8 = _createSharedDataComponentWithFallback(_component_up_code_input, "10cb1305", {
            modelValue: () => {
