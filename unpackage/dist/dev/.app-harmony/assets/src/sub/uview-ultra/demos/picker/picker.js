...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n18 = _createSharedDataComponent(_sfc_main$1, "b01eb986", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "5623c530", {
            title: "up-picker 选择器",
            "auto-back": true,
          ...
          const n2 = _createSharedDataComponentWithFallback(_component_up_button, "6e54ce7e", {
            type: "primary",
            text: "单列选择",
            size: "mini",
            onClick: () => {
          ...
          const n6 = _createSharedDataComponentWithFallback(_component_up_button, "6e54d940", {
            type: "success",
            text: "多列选择",
            size: "mini",
            onClick: () => {
          ...
          const n10 = _createSharedDataComponentWithFallback(_component_up_button, "6e54e162", {
            type: "warning",
            text: "加载中选择",
            size: "mini",
            onClick: () => {
          ...
          const n14 = _createSharedDataComponentWithFallback(_component_up_picker, "6e54e59b", {
            show: () => {
          ...
          const n15 = _createSharedDataComponentWithFallback(_component_up_picker, "5c440cf6", {
            show: () => {
          ...
          const n16 = _createSharedDataComponentWithFallback(_component_up_picker, "5c4410f5", {
            show: () => {
