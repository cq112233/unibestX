...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n29 = _createSharedDataComponent(_sfc_main$1, "5e96e385", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "74458de8", {
            title: "up-button 按钮",
            "auto-back": true,
          ...
          const n2 = _createSharedDataComponentWithFallback(_component_up_button, "146c1c6d", {
            type: "primary",
            text: "主要按钮"
          });
          _setSharedData(__sharedData, 2, n2?.sharedData);
          const n4 = _createSharedDataComponentWithFallback(_component_up_button, "146c200d", {
            type: "success",
            text: "成功按钮"
          });
          _setSharedData(__sharedData, 3, n4?.sharedData);
          const n6 = _createSharedDataComponentWithFallback(_component_up_button, "146c2122", {
            type: "info",
            text: "信息按钮"
          });
          _setSharedData(__sharedData, 4, n6?.sharedData);
          const n8 = _createSharedDataComponentWithFallback(_component_up_button, "146c24bf", {
            type: "warning",
            text: "警告按钮"
          });
          _setSharedData(__sharedData, 5, n8?.sharedData);
          const n10 = _createSharedDataComponentWithFallback(_component_up_button, "146c284a", {
            type: "error",
            text: "危险按钮"
          });
          _setSharedData(__sharedData, 6, n10?.sharedData);
          const n14 = _createSharedDataComponentWithFallback(_component_up_button, "146c2f8c", {
            type: "primary",
            text: "主要按钮",
            plain: true
          });
          _setSharedData(__sharedData, 7, n14?.sharedData);
          const n18 = _createSharedDataComponentWithFallback(_component_up_button, "791684a9", {
            type: "primary",
            text: "大尺寸",
            size: "large"
          });
          _setSharedData(__sharedData, 8, n18?.sharedData);
          const n20 = _createSharedDataComponentWithFallback(_component_up_button, "79168b73", {
            type: "primary",
            text: "普通尺寸",
            size: "normal"
          });
          _setSharedData(__sharedData, 9, n20?.sharedData);
          const n22 = _createSharedDataComponentWithFallback(_component_up_button, "79168fb4", {
            type: "primary",
            text: "小尺寸",
            size: "small"
          });
          _setSharedData(__sharedData, 10, n22?.sharedData);
          const n24 = _createSharedDataComponentWithFallback(_component_up_button, "79169693", {
            type: "primary",
            text: "迷你尺寸",
            size: "mini"
          });
