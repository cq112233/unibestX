...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return _openBlock(), _createBlock($setup["Card"], {
    title: $setup.$t("basic.echartTitle")
  }, {
    default: _withCtx(() => [
          ...
          _createElementVNode(
            ...
            [
              _createElementVNode(
                ...
                _toDisplayString($setup.$t("basic.echartLine")),
                3
                /* TEXT, CLASS */
              )
            ],
          ...
          _createElementVNode(
            ...
            [
              _createElementVNode(
                ...
                _toDisplayString($setup.$t("basic.echartBar")),
                3
                /* TEXT, CLASS */
              )
            ],
          ...
          _createElementVNode(
            ...
            [
              _createElementVNode(
                ...
                _toDisplayString($setup.$t("basic.echartPie")),
                3
                /* TEXT, CLASS */
              )
            ],
