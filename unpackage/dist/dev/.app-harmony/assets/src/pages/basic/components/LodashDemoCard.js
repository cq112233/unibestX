...
const __className = "GenSrcPagesBasicComponentsLodashDemoCard";
...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    const __sharedData = _withSharedDataComponent(new UniDynamicSharedDataComponent(__sharedDataScope, _useSharedDataComponentOptions({ bundleKey: "GenSrcPagesBasicComponentsLodashDemoCardSharedData", sharedDataClassId: 0 })));
      ...
      const n60 = _createSharedDataComponent(
        ...
        { title: "Lodash 工具库 (iRainna-lodash)" },
        {
          "default": _withSharedDataVaporCtx(() => {
            ...
            const n33 = _createSharedDataComponentWithFallback(_component_input, "c4d6d3fa", {
              value: () => {
