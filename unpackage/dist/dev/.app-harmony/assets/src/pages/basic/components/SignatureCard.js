...
const __className = "GenSrcPagesBasicComponentsSignatureCard";
...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    const __sharedData = _withSharedDataComponent(new UniDynamicSharedDataComponent(__sharedDataScope, _useSharedDataComponentOptions({ bundleKey: "GenSrcPagesBasicComponentsSignatureCardSharedData", sharedDataClassId: 0 })));
      ...
      const n34 = _createSharedDataComponent(
        ...
        { title: "签名板 lime-signature" },
        {
          "default": _withSharedDataVaporCtx(() => {
            const n0 = _createSharedDataComponentWithFallback(_component_l_signature, "8f6c008e", {
              "pen-color": () => {
            ...
            const n23 = _createSharedDataFor(_setSharedDataScoped(__sharedData, 5, _createSharedDataVFor(__sharedDataScope, () => {
              ...
              _renderSharedDataEffect(() => {
                _setSharedDataClass(__sharedData_VFor1, 2, ["flex-1 h-32px rounded-6px flex flex-row items-center justify-center", _for_key1.value < penSizeOptions.length - 1 ? "mr-6px" : ""]);
