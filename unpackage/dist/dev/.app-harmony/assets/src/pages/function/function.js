import ohos_vibrator from '@ohos.vibrator';import { _ as _sfc_main$1 } from "../../../App.ku.js";
...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      "raw js";
      const n9 = _createSharedDataComponent(_sfc_main$1, "13021a83", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n8 = _createSharedDataComponent(_sfc_main$2, "4d4135d3", { "navigation-bar-title-text": "功能" }, {
            "default": _withSharedDataVaporCtx(() => {
              const n3 = _createSharedDataComponent(EnvCard, "5ae58c64");
              _setSharedData(__sharedData, 2, n3.sharedData);
              const n4 = _createSharedDataComponent(SystemInfoCard, "5ae58cdd");
              _setSharedData(__sharedData, 3, n4.sharedData);
              const n5 = _createSharedDataComponent(HapticsCard, "5ae58fe9");
              _setSharedData(__sharedData, 4, n5.sharedData);
              const n6 = _createSharedDataComponent(MediaCard, "5ae5907d");
