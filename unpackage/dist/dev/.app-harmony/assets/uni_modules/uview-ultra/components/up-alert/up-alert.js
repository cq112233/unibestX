        ...
        },
        {
          "default": _withSharedDataVaporCtx(() => {
            _renderSharedDataEffect(() => {
              ...
              _setSharedDataStyle(__sharedData, 16, [$upAddStyle(__props.customStyle)]);
            });
            _createSharedDataIf(() => {
              return _setSharedData(__sharedData, 1, _toSharedDataBoolean(__props.showIcon));
            }, () => {
              const n2 = _createSharedDataComponentWithFallback(_component_up_icon, "3207842a", {
                name: () => {
            ...
            _createSharedDataIf(() => {
              ...
              const n13 = _createSharedDataComponentWithFallback(_component_up_icon, "0eea24bc", {
                name: "close",
                color: () => {
                  return iconColor.value;
                },
