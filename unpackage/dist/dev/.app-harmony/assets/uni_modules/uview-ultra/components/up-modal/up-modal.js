        ...
        "72641a11",
        {
          ...
          customStyle: () => {
            return {
              borderRadius: "6px",
              overflow: "hidden",
              marginTop: `-${_unref(addUnit)(__props.negativeTop)}`
            };
          },
          closeOnClickOverlay: () => {
        ...
        },
        {
          ...
          "default": _withSharedDataVaporCtx(() => {
            _renderSharedDataEffect(() => {
              return _setSharedDataStyle(__sharedData, 22, {
                width: _unref(addUnit)(__props.width)
              });
            });
            _createSharedDataIf(() => {
            ...
            _createSharedDataSlot("default", null, null, () => {
              _renderSharedDataEffect(() => {
                _setSharedDataStyle(__sharedData, 20, { textAlign: __props.contentTextAlign });
            ...
            _createSharedDataIf(() => {
              ...
              const n12 = _createSharedDataComponentWithFallback(_component_up_line, "69c5f757");
              _setSharedData(__sharedData, 4, n12?.sharedData);
              _renderSharedDataEffect(() => {
                return _setSharedDataStyle(__sharedData, 19, {
                  flexDirection: __props.buttonReverse ? "row-reverse" : "row"
                });
              });
              _createSharedDataIf(() => {
              ...
              _createSharedDataIf(() => {
                ...
                const n19 = _createSharedDataComponentWithFallback(_component_up_line, "62148c7e", { direction: "column" });
              ...
              _createSharedDataIf(() => {
                ...
                _createSharedDataIf(() => {
                  ...
                  const n24 = _createSharedDataComponentWithFallback(_component_up_loading_icon, "6213c9fe");
