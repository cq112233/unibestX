  ...
  setup(__props, _a) {
    ...
    return () => {
      ...
      _createSharedDataIf(() => {
        ...
        _setSharedDataEvent(__sharedData, 3, (e) => {
        ...
        return _createSharedDataIf(() => {
          ...
          const n5 = _createSharedDataComponentWithFallback(_component_up_icon, "74daa3b4", {
            name: "minus",
            color: () => {
          ...
          _setSharedDataEvent(__sharedData, 8, (e) => {
            return clearTimeout(e);
          });
        });
      }, 261);
      _createSharedDataIf(() => {
        ...
        _createSharedDataSlot("input", null, null, () => {
          const n11 = _createSharedDataComponentWithFallback(_component_input, "74daabb8", {
            disabled: () => {
      ...
      _createSharedDataIf(() => {
        ...
        _setSharedDataEvent(__sharedData, 16, (e) => {
          return clearTimeout(e);
        });
      }, () => {
        return _createSharedDataIf(() => {
          ...
          const n17 = _createSharedDataComponentWithFallback(_component_up_icon, "2677340a", {
            name: "plus",
            color: () => {
          ...
          _setSharedDataEvent(__sharedData, 21, (e) => {
            return clearTimeout(e);
          });
        });
      }, 1029);
