...
import { p as propsTabs } from "./props.js";
...
import { a as addUnit, b as addStyle, d as deepMerge, g as getPx, s as sleep, e as getWindowInfo } from "../../libs/function/index.js";
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return _openBlock(), _createElementBlock(
    "view",
    {
      class: _normalizeClass(["up-tabs", [_ctx.customClass]])
    },
    [
      _createElementVNode(
        "view",
        {
          ...
          style: _normalizeStyle({ height: $options.addUnit(_ctx.height) })
        },
        [
                  ...
                  (_openBlock(true), _createElementBlock(
                    ...
                    _renderList(_ctx.list, (item, index) => {
                      return _openBlock(), _createElementBlock("view", {
                        ...
                        style: _normalizeStyle([$options.addStyle(_ctx.itemStyle), { flex: _ctx.scrollable ? "none" : "1" }])
                      }, [
                        ...
                        _ctx.$slots["content"] != null ? _renderSlot(_ctx.$slots, "content", {
                          ...
                          "text",
                          {
                            ...
                            style: _normalizeStyle([$options.textStyle(index)])
                          },
                          _toDisplayString(item[_ctx.keyName]),
                          7
                          /* TEXT, CLASS, STYLE */
                        )),
