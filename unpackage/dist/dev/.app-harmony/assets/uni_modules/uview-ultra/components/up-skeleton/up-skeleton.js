      ...
      _createSharedDataIf(() => {
        ...
        _createSharedDataIf(() => {
          ...
          _renderSharedDataEffect(() => {
            ...
            const _avatarSize = __props.avatarSize;
            ...
            _setSharedDataStyle(__sharedData, 3, {
              height: _addUnit(_avatarSize),
              width: _addUnit(_avatarSize)
            });
          });
        });
        _createSharedDataIf(() => {
          ...
          _renderSharedDataEffect(() => {
            ...
            _setSharedDataStyle(__sharedData, 6, {
              ...
              height: _unref(addUnit)(__props.titleHeight)
            });
          });
        });
