...
import { p as propsSearch } from "./props.js";
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return _openBlock(), _createElementBlock(
    "view",
    {
      class: _normalizeClass(["up-search", [_ctx.iconPosition === "right" ? "up-search__reverse" : ""]]),
    ...
    [
      _createElementVNode(
        ...
        [
          _ctx.$slots["label"] != null || _ctx.label !== null ? _renderSlot(_ctx.$slots, "label", { key: 0 }, () => [
            _createElementVNode(
              "text",
          ...
          $options.isShowClear ? (_openBlock(), _createElementBlock("view", {
            key: 1,
      ...
      _createElementVNode(
        "text",
        {
          ...
          class: _normalizeClass(["up-search__action", [$options.showActionBtn || $data.show ? "up-search__action--active" : ""]]),
          onClick: _cache[5] || (_cache[5] = _withModifiers((...args) => $options.custom && $options.custom(...args), ["stop", "prevent"]))
        },
        _toDisplayString(_ctx.actionText),
        7
        /* TEXT, CLASS, STYLE */
      )
    ],
