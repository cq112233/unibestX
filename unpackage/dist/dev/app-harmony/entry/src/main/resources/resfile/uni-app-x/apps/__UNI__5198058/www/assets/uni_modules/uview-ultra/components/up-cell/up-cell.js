...
const _sfc_main = /* @__PURE__ */ _defineComponent({
  ...
  setup(__props, _a) {
    ...
    const __returned__ = { props, emits, testEmpty, titleTextStyle, clickHandler, get addStyle() {
      return addStyle;
    } };
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return _openBlock(), _createElementBlock("view", {
    ...
    _createElementVNode(
      "view",
      {
        class: _normalizeClass(["up-cell__body", [$props.center && "up-cell--center", $props.size === "large" && "up-cell__body--large"]])
      },
      [
        _createElementVNode("view", { class: "up-cell__body__content" }, [
          ...
          _createElementVNode("view", { class: "up-cell__title" }, [
            _ctx.$slots["title"] != null && $props.title == "" ? _renderSlot(_ctx.$slots, "title", { key: 0 }) : (_openBlock(), _createElementBlock(
              ...
              {
                key: 1,
                class: _normalizeClass(["up-cell__title-text", [$props.disabled && "up-cell--disabled", $props.size === "large" && "up-cell__title-text--large"]]),
            ...
            _renderSlot(_ctx.$slots, "label", {}, () => [
              $props.label ? (_openBlock(), _createElementBlock(
                ...
                {
                  key: 0,
                  class: _normalizeClass(["up-cell__label", [$props.disabled && "up-cell--disabled", $props.size === "large" && "up-cell__label--large"]])
                },
        ...
        _renderSlot(_ctx.$slots, "value", {}, () => [
          $setup.testEmpty($props.value) == false ? (_openBlock(), _createElementBlock(
            ...
            {
              key: 0,
              class: _normalizeClass(["up-cell__value", [$props.disabled && "up-cell--disabled", $props.size === "large" && "up-cell__value--large"]])
            },
