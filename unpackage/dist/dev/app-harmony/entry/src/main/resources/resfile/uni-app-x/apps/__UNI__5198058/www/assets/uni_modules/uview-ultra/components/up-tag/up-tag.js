...
import { p as propsTag } from "./props.js";
...
const { renderSlot: _renderSlot, normalizeStyle: _normalizeStyle, openBlock: _openBlock, createElementBlock: _createElementBlock, createCommentVNode: _createCommentVNode, resolveComponent: _resolveComponent, createBlock: _createBlock, toDisplayString: _toDisplayString, createTextVNode: _createTextVNode, normalizeClass: _normalizeClass, createElementVNode: _createElementVNode, withModifiers: _withModifiers, createVNode: _createVNode, withCtx: _withCtx } = globalThis.Vue;
    ...
    default: _withCtx(() => [
      _createElementVNode("view", { class: "up-tag-wrapper cursor-pointer" }, [
        _createElementVNode(
          "view",
          {
            class: _normalizeClass(["up-tag", [`up-tag--${_ctx.shape}`, !_ctx.plain ? `up-tag--${_ctx.type}` : "", _ctx.plain ? `up-tag--${_ctx.type}--plain` : "", `up-tag--${_ctx.size}`, _ctx.plain && _ctx.plainFill ? `up-tag--${_ctx.type}--plain--fill` : ""]]),
            onClick: _cache[0] || (_cache[0] = _withModifiers((...args) => $options.clickHandler && $options.clickHandler(...args), ["stop"])),
          ...
          [
            _renderSlot(_ctx.$slots, "icon", {}, () => [
              _ctx.icon ? (_openBlock(), _createElementBlock("view", {
                key: 0,
                class: "up-tag__icon"
              }, [
                $options.testImage(_ctx.icon) ? (_openBlock(), _createElementBlock("image", {
                  key: 0,
                  src: _ctx.icon,
            ...
            _createElementVNode(
              "text",
              {
                class: _normalizeClass(["up-tag__text", [`up-tag__text--${_ctx.type}`, _ctx.plain ? `up-tag__text--${_ctx.type}--plain` : "", `up-tag__text--${_ctx.size}`]]),
                style: _normalizeStyle([$options.textColor])
              },
              [
        ...
        _ctx.closable ? (_openBlock(), _createElementBlock(
          ...
          {
            key: 0,
            class: _normalizeClass(["up-tag__close", [`up-tag__close--${_ctx.size}`]]),
            onClick: _cache[1] || (_cache[1] = _withModifiers((...args) => $options.closeHandler && $options.closeHandler(...args), ["stop"])),
            style: _normalizeStyle({ backgroundColor: _ctx.closeColor })
          },
          [
