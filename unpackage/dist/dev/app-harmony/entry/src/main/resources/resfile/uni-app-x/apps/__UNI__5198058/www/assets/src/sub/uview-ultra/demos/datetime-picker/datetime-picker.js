...
const _style_0 = { "bg-__f8fafc_": { "": { "backgroundImage": "none", "backgroundColor": "#f8fafc" } }, "flex-row": { "": { "flexDirection": "row" } }, "items-center": { "": { "alignItems": "center" } }, "justify-between": { "": { "justifyContent": "space-between" } }, "mb-8px": { "": { "marginBottom": 8 } }, "ml-10px": { "": { "marginLeft": 10 } }, "mt-12px": { "": { "marginTop": 12 } }, "p-16px": { "": { "paddingTop": 16, "paddingRight": 16, "paddingBottom": 16, "paddingLeft": 16 } }, "pb-30px": { "": { "paddingBottom": 30 } }, "text-13px": { "": { "fontSize": 13 } }, "text-gray-500": { "": { "color": "rgba(128,128,128,var(--un-color-opacity,5))" } }, "text-gray-700": { "": { "color": "rgba(128,128,128,var(--un-color-opacity,7))" } } };
          ...
          _createElementVNode("view", { class: "page-container bg-__f8fafc_ min-h-screen pb-30px" }, [
            ...
            _createElementVNode("view", { class: "p-16px" }, [
              ...
              _createElementVNode("view", { class: "demo-block mt-12px" }, [
                ...
                _createElementVNode("view", { class: "flex-row items-center justify-between mb-8px" }, [
                  _createElementVNode("text", { class: "text-13px text-gray-700" }, "开始日期："),
                  _createElementVNode("view", { class: "flex-row items-center" }, [
                    ...
                    _createElementVNode(
                      "text",
                      { class: "ml-10px text-13px text-gray-500" },
                ...
                _createElementVNode("view", { class: "flex-row items-center justify-between" }, [
                  _createElementVNode("text", { class: "text-13px text-gray-700" }, "结束日期："),
                  _createElementVNode("view", { class: "flex-row items-center" }, [
                    _createVNode(_component_up_button, {
                      type: "success",
                      text: "选择结束",
