...
const _sfc_main = /* @__PURE__ */ _defineComponent({
  ...
  setup(__props, _a) {
    ...
    const __returned__ = { props, emit, loading, elCancelText, elConfirmText, contentStyleCpu, confirmHandler, cancelHandler, clickHandler, get addUnit() {
      return addUnit;
    } };
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return _openBlock(), _createBlock(_component_up_popup, {
    ...
    customStyle: {
      borderRadius: "6px",
      overflow: "hidden",
      marginTop: `-${$setup.addUnit($props.negativeTop)}`
    },
              ...
              _renderSlot(_ctx.$slots, "default", {}, () => [
                _createElementVNode(
                  "text",
                  {
                    ...
                    style: _normalizeStyle({ textAlign: $props.contentTextAlign })
                  },
