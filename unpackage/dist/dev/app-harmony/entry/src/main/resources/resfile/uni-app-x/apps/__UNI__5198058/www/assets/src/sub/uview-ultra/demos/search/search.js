      ...
      const n19 = _createSharedDataComponent(AppKu, "441ec4f1", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n18 = _createSharedDataComponent(LayoutComponent, "3fb9d925", {
            ...
            "default": _withSharedDataVaporCtx(() => {
              const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "90fd67ac", {
                title: "up-search 搜索",
                "auto-back": true,
              ...
              const n2 = _createSharedDataComponentWithFallback(_component_up_search, "90fd5318", {
                modelValue: () => {
              ...
              const n5 = _createSharedDataComponentWithFallback(_component_up_search, "90fd499e", {
                modelValue: () => {
              ...
              const n8 = _createSharedDataComponentWithFallback(_component_up_search, "90fd3a62", {
                modelValue: () => {
              ...
              const n11 = _createSharedDataComponentWithFallback(_component_up_search, "38a81b08", {
                modelValue: () => {
              ...
              const n14 = _createSharedDataComponentWithFallback(_component_up_search, "38a81fbe", {
                modelValue: () => {
...
const _style_0 = {};
const search = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0]]]);
export {
  search as default
};
