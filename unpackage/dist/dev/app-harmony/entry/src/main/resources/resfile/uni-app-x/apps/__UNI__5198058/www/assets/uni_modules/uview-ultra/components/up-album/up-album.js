            ...
            _setSharedDataStyle(__sharedData_VFor1, 7, [
              {
                ...
                height: _imageHeight,
                borderRadius: __props.shape == "circle" ? "10000px" : $upAddUnit(__props.radius)
              }
            ]);
          });
          _createSharedDataIf(() => {
            ...
            _renderSharedDataEffect(() => {
              return _setSharedDataStyle(__sharedData_VFor1, 2, {
                borderRadius: __props.shape == "circle" ? "50%" : $upAddUnit(__props.radius)
              });
            });
            const n7 = _createSharedDataComponentWithFallback(_component_up_text, "661a3729-" + _for_key1.value, {
              text: () => {
