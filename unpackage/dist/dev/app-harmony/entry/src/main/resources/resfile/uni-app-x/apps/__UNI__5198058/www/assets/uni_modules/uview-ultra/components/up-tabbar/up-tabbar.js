...
import { p as propsTabbar } from "./props.js";
import { m as mpMixin } from "../../libs/mixin/mpMixin.js";
import { m as mixin } from "../../libs/mixin/mixin.js";
import { d as deepMerge, b as addStyle, s as sleep } from "../../libs/function/index.js";
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return _openBlock(), _createElementBlock("view", { class: "up-tabbar" }, [
    _createElementVNode(
      "view",
      {
        class: _normalizeClass(["up-tabbar__content", [_ctx.border ? "up-border-top" : "", _ctx.fixed ? "up-tabbar--fixed" : ""]]),
        ref: "up-tabbar__content",
        onTouchmove: _cache[0] || (_cache[0] = _withModifiers((...args) => $options.noop && $options.noop(...args), ["stop", "prevent"])),
        style: _normalizeStyle([$options.tabbarStyle])
      },
      [
        _createElementVNode("view", { class: "up-tabbar__content__item-wrapper" }, [
          _renderSlot(_ctx.$slots, "default")
        ]),
        _ctx.safeAreaInsetBottom ? (_openBlock(), _createBlock(_component_up_safe_bottom, { key: 0 })) : _createCommentVNode("v-if", true)
      ],
      38
      /* CLASS, STYLE, NEED_HYDRATION */
    ),
    _ctx.placeholder ? (_openBlock(), _createElementBlock(
      "view",
      {
        key: 0,
