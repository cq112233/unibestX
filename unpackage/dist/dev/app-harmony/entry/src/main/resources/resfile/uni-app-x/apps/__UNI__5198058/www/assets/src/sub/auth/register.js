        ...
        default: withCtx(() => [
          createElementVNode("view", { class: "flex-1 p-30px items-center justify-center bg-__f8fafc_" }, [
            ...
            createElementVNode("button", {
              class: "w-200px bg-__10b981_ text-white rounded-8px",
