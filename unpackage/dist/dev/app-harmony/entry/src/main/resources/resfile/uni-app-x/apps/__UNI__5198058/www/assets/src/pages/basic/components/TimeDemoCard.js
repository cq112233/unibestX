...
const { defineComponent, ref, computed, onMounted, onUnmounted, resolveDynamicComponent, openBlock, createBlock, withCtx, createCommentVNode, createElementVNode, toDisplayString, createVNode, createTextVNode } = globalThis.Vue
