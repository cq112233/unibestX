    ...
    default: _withCtx(() => [
      _createElementVNode("view", { class: "rounded-12px p-16px mb-16px border-width-1px border-style-solid border-color-__e2e8f0_" }, [
        _createElementVNode("view", { class: "flex-row justify-between mb-10px" }, [
          _createElementVNode("text", { class: "text-14px text-__718096_" }, "手机品牌"),
          _createElementVNode(
            "text",
        ...
        _createElementVNode("view", { class: "flex-row justify-between mb-10px" }, [
          _createElementVNode("text", { class: "text-14px text-__718096_" }, "手机型号"),
          _createElementVNode(
            "text",
            { class: "text-14px font-bold text-__2d3748_" },
        ...
        _createElementVNode("view", { class: "flex-row justify-between mb-10px" }, [
          _createElementVNode("text", { class: "text-14px text-__718096_" }, "操作系统"),
          _createElementVNode(
            "text",
            { class: "text-14px font-bold text-__2d3748_" },
        ...
        _createElementVNode("view", { class: "flex-row justify-between" }, [
          _createElementVNode("text", { class: "text-14px text-__718096_" }, "运行平台"),
          _createElementVNode(
            "text",
            { class: "text-14px font-bold text-__2d3748_" },
      ...
      _createElementVNode("view", {
        ...
        _createElementVNode("text", { class: "text-__ffffff_ text-14px font-bold" }, "获取系统信息")
      ])
    ]),
    _: 1
    /* STABLE */
