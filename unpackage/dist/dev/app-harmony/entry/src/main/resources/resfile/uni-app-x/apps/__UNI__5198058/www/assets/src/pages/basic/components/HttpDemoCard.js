  ...
  setup(__props, _a) {
    ...
    async function loadMockData() {
      try {
        ...
        uni.__f__("error", "at src/pages/basic/components/HttpDemoCard.uvue:136", "loadMockData error:", err);
      }
    }
    async function fetchRealApi() {
      ...
      try {
        ...
        uni.__f__("log", "at src/pages/basic/components/HttpDemoCard.uvue:156", err, "err");
      ...
      createElementVNode("view", { class: "flex-row" }, [
        createElementVNode("view", { class: "flex-1 mr-10px" }, [
          createElementVNode("button", {
            class: "bg-__3182ce_ text-white rounded-8px text-14px h-42px w-full",
        ...
        createElementVNode("view", { class: "flex-1" }, [
          createElementVNode("button", {
            ...
            class: "bg-__10b981_ text-white rounded-8px text-14px h-42px w-full",
            onClick: $setup.fetchRealApi
          }, toDisplayString($setup.loading ? "请求中..." : "真实 API 请求"), 9, ["disabled"])
        ])
      ])
    ]),
    _: 1
