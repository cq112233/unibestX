    ...
    default: withCtx(() => [
      ...
      createElementVNode("view", { class: "flex-row justify-between" }, [
        createElementVNode("button", {
          class: "flex-1 bg-__3182ce_ text-white rounded-8px text-14px h-42px",
          onClick: $setup.jumpToTest
        }, " 跳转 Test 页 (传参) "),
        createElementVNode("button", {
          class: "flex-1 ml-12px bg-__ef4444_ text-white rounded-8px text-14px h-42px",
