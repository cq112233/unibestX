...
import { _ as __easycom_1 } from "../../../../../uni_modules/rice-ui/components/rice-code-input/rice-code-input.js";
...
const __className = "GenSrcSubRiceUiDemosCodeInputCodeInput";
...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  __hash: "3039fc74",
  __className,
  __filename: "src/sub/rice-ui/demos/code-input/code-input.uvue",
  __name: "code-input",
  setup(__props) {
    const __sharedDataRenderer = _useSharedDataRenderer();
    const __sharedData = __sharedDataRenderer == "component" ? _withSharedDataComponent(new UniDynamicSharedDataComponent(_useSharedDataScope(), _useSharedDataComponentOptions({ bundleKey: "GenSrcSubRiceUiDemosCodeInputCodeInputSharedData", sharedDataClassId: 0 }))) : _withSharedDataPage(new UniDynamicSharedDataPage(_useSharedDataPageId(), _useSharedDataPageOptions({ bundleKey: "GenSrcSubRiceUiDemosCodeInputCodeInputSharedData", sharedDataClassId: 0 })));
    ...
    const code1 = ref("");
    const code2 = ref("123");
    const code3 = ref("8888");
    return () => {
      "raw js";
      const _component_NavBar = __easycom_0;
      const _component_rice_code_input = __easycom_1;
      const n19 = _createSharedDataComponent(_sfc_main$1, "f520dd74", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "28829847", {
            title: "CodeInput 验证码",
            "auto-back": true,
          ...
          const n2 = _createSharedDataComponentWithFallback(_component_rice_code_input, "305f3c68", {
            modelValue: () => {
              return _unref(code1);
            },
            "onUpdate:modelValue": () => {
              return (_value) => {
                return _isRef(code1) ? code1.value = _value : null;
              };
            },
            maxlength: 4,
            color: () => {
          ...
          _renderSharedDataEffect(() => {
            _setSharedData(__sharedData, 6, _toDisplayString(_unref(code1)));
            _setSharedDataStyle(__sharedData, 7, { borderLeftColor: currentTheme.value });
          });
          const n8 = _createSharedDataComponentWithFallback(_component_rice_code_input, "305f1cee", {
            modelValue: () => {
              return _unref(code2);
            },
            "onUpdate:modelValue": () => {
              return (_value) => {
                return _isRef(code2) ? code2.value = _value : null;
              };
            },
            maxlength: 6,
            color: () => {
          ...
          _renderSharedDataEffect(() => {
            _setSharedData(__sharedData, 8, _toDisplayString(_unref(code2)));
            _setSharedDataStyle(__sharedData, 9, { borderLeftColor: currentTheme.value });
          });
          const n14 = _createSharedDataComponentWithFallback(_component_rice_code_input, "123a7e31", {
            modelValue: () => {
              return _unref(code3);
            },
            "onUpdate:modelValue": () => {
              return (_value) => {
                return _isRef(code3) ? code3.value = _value : null;
              };
            },
            maxlength: 4,
            color: () => {
