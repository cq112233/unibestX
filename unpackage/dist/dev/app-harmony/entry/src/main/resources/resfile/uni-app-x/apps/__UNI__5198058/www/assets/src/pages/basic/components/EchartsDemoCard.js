...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return _openBlock(), _createBlock($setup["Card"], {
    ...
    default: _withCtx(() => [
      _createElementVNode("view", { class: "w-full h-260px mt-10px" }, [
        _createVNode(
          _component_e_chart,
          {
            ref: "echartRef",
          ...
          _createElementVNode(
            ...
            [
              _createElementVNode(
                ...
                _toDisplayString(_ctx.$t("basic.echartLine")),
                3
                /* TEXT, CLASS */
              )
            ],
          ...
          _createElementVNode(
            ...
            [
              _createElementVNode(
                ...
                _toDisplayString(_ctx.$t("basic.echartBar")),
                3
                /* TEXT, CLASS */
              )
            ],
          ...
          _createElementVNode(
            ...
            [
              _createElementVNode(
                ...
                _toDisplayString(_ctx.$t("basic.echartPie")),
                3
                /* TEXT, CLASS */
              )
            ],
