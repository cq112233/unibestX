...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock(), _createElementBlock("view", { class: "_mp_root" }, [
    (_openBlock(true), _createElementBlock(
      _Fragment,
      null,
      _renderList($data.localNodes, (n, i) => {
        return _openBlock(), _createElementBlock(
          ...
          [
            n.type == "text" ? (_openBlock(), _createElementBlock(
            ...
            }, _toDisplayString($options.flatText(n)), 9, ["onClick"])) : $options.isInline(n.name ?? "") ? (_openBlock(), _createElementBlock(
              "text",
              {
                key: 4,
                style: _normalizeStyle($options.inlineStyle(n.name ?? "")),
                decode: true
              },
              _toDisplayString($options.flatText(n)),
              5
              /* TEXT, STYLE */
              ...
              {
                key: 5,
                style: _normalizeStyle($options.headingStyle(n.name ?? "")),
                decode: true
              },
              _toDisplayString($options.flatText(n)),
              5
                    ...
                    (_openBlock(true), _createElementBlock(
                      ...
                      _renderList(row.children ?? [], (cell, ci) => {
                        return _openBlock(), _createElementBlock(
                          ...
                          {
                            key: ci,
                            style: _normalizeStyle((cell.name == "th" ? "font-weight:bold;background-color:#f5f5f5;" : "") + "flex:1;padding:4px 8px;border-width:1px;border-color:#d0d0d0;border-style:solid")
                          },
                          [
                            _createElementVNode(
                              "text",
                              { decode: true },
                              _toDisplayString($options.flatText(cell)),
                              1
                              /* TEXT */
                            )
                          ],
                ...
                _renderList(n.children ?? [], (li, lii) => {
                  return _openBlock(), _createElementBlock("view", {
                    ...
                    _createElementVNode(
                      "text",
                      { decode: true },
                      _toDisplayString($options.flatText(li)),
                      1
                      /* TEXT */
                    )
                  ]);
                ...
                _renderList(n.children ?? [], (cn, ci) => {
                  return _openBlock(), _createElementBlock(
                    ...
                    [
                      ...
                      }, _toDisplayString($options.flatText(cn)), 9, ["onClick"])) : $options.isInline(cn.name ?? "") ? (_openBlock(), _createElementBlock(
                        "text",
                        {
                          key: 4,
                          style: _normalizeStyle($options.inlineStyle(cn.name ?? "")),
                          decode: true
                        },
                        _toDisplayString($options.flatText(cn)),
                        5
                        /* TEXT, STYLE */
