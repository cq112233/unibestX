...
const _sfc_main = /* @__PURE__ */ _defineComponent({
  ...
  setup(__props, _a) {
    ...
    const __returned__ = { preventEvent, props, emit, uClasses, iconStyle, isImg, imgStyle, icon, clickHandler, get addUnit() {
      return addUnit;
    }, get addStyle() {
      return addStyle;
    } };
  ...
  return _openBlock(), _createElementBlock(
    ...
    [
      $setup.isImg ? (_openBlock(), _createElementBlock("image", {
        ...
        style: _normalizeStyle([$setup.imgStyle, $setup.addStyle($props.customStyle)])
      }, null, 12, ["src", "mode"])) : (_openBlock(), _createElementBlock("text", {
        key: 1,
        class: _normalizeClass(["up-icon__icon", $setup.uClasses]),
        style: _normalizeStyle([$setup.iconStyle, $setup.addStyle($props.customStyle)]),
      ...
      $props.label !== "" ? (_openBlock(), _createElementBlock(
        "text",
        {
          ...
          style: _normalizeStyle({
            ...
            fontSize: $setup.addUnit($props.labelSize),
            marginLeft: $props.labelPos == "right" ? $setup.addUnit($props.space) : 0,
            marginTop: $props.labelPos == "bottom" ? $setup.addUnit($props.space) : 0,
            marginRight: $props.labelPos == "left" ? $setup.addUnit($props.space) : 0,
            marginBottom: $props.labelPos == "top" ? $setup.addUnit($props.space) : 0
          })
        },
