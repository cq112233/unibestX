...
import { a as systemInfo, s as safeAreaInsets } from "../../../utils/systemInfo.js";
  ...
  return _openBlock(), _createBlock($setup["Card"], { title: "系统与安全区域信息" }, {
    default: _withCtx(() => [
      _createElementVNode("view", { class: "rounded-12px p-16px mb-16px border-width-1px border-style-solid border-color-__e2e8f0_" }, [
        _createElementVNode("text", { class: "text-13px font-bold text-__1e293b_ mb-12px" }, "安全区域内边距 (SafeAreaInsets)"),
        _createElementVNode("view", { class: "flex-row justify-between mb-8px" }, [
          _createElementVNode("text", { class: "text-14px text-__64748b_" }, "Top (顶部距离)"),
          _createElementVNode(
            "text",
        ...
        _createElementVNode("view", { class: "flex-row justify-between mb-8px" }, [
          _createElementVNode("text", { class: "text-14px text-__64748b_" }, "Bottom (底部距离)"),
          _createElementVNode(
            "text",
            { class: "text-14px font-bold text-__334155_" },
        ...
        _createElementVNode("view", { class: "flex-row justify-between mb-8px" }, [
          _createElementVNode("text", { class: "text-14px text-__64748b_" }, "Left (左侧距离)"),
          _createElementVNode(
            "text",
            { class: "text-14px font-bold text-__334155_" },
        ...
        _createElementVNode("view", { class: "flex-row justify-between" }, [
          _createElementVNode("text", { class: "text-14px text-__64748b_" }, "Right (右侧距离)"),
          _createElementVNode(
            "text",
            { class: "text-14px font-bold text-__334155_" },
      ...
      _createElementVNode("view", { class: "rounded-12px p-16px border-width-1px border-style-solid border-color-__e2e8f0_" }, [
        _createElementVNode("text", { class: "text-13px font-bold text-__1e293b_ mb-12px" }, "设备窗口规格 (WindowInfo)"),
        _createElementVNode("view", { class: "flex-row justify-between mb-8px" }, [
          _createElementVNode("text", { class: "text-14px text-__64748b_" }, "屏幕宽度"),
          _createElementVNode(
            "text",
            { class: "text-14px font-bold text-__334155_" },
        ...
        _createElementVNode("view", { class: "flex-row justify-between mb-8px" }, [
          _createElementVNode("text", { class: "text-14px text-__64748b_" }, "屏幕高度"),
          _createElementVNode(
            "text",
            { class: "text-14px font-bold text-__334155_" },
        ...
        _createElementVNode("view", { class: "flex-row justify-between mb-8px" }, [
          _createElementVNode("text", { class: "text-14px text-__64748b_" }, "可用窗口宽度"),
          _createElementVNode(
            "text",
            { class: "text-14px font-bold text-__334155_" },
        ...
        _createElementVNode("view", { class: "flex-row justify-between mb-8px" }, [
          _createElementVNode("text", { class: "text-14px text-__64748b_" }, "可用窗口高度"),
          _createElementVNode(
            "text",
            { class: "text-14px font-bold text-__334155_" },
        ...
        _createElementVNode("view", { class: "flex-row justify-between mb-8px" }, [
          _createElementVNode("text", { class: "text-14px text-__64748b_" }, "状态栏高度 (statusBarHeight)"),
          _createElementVNode(
            "text",
            { class: "text-14px font-bold text-__334155_" },
        ...
        _createElementVNode("view", { class: "flex-row justify-between" }, [
          _createElementVNode("text", { class: "text-14px text-__64748b_" }, "设备像素比 (pixelRatio)"),
          _createElementVNode(
            "text",
            { class: "text-14px font-bold text-__334155_" },
