...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n32 = _createSharedDataComponent(_sfc_main$1, "584b9f21", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "9daf7468", {
            title: "up-tag 标签",
            "auto-back": true,
          ...
          const n2 = _createSharedDataComponentWithFallback(_component_up_tag, "73e0617d", {
            text: "标签",
            type: "primary",
            size: "normal",
          ...
          const n3 = _createSharedDataComponentWithFallback(_component_up_tag, "73e06520", {
            text: "成功",
            type: "success",
            size: "normal",
            class: "mr-10px mb-10px"
          ...
          const n4 = _createSharedDataComponentWithFallback(_component_up_tag, "73e068c3", {
            text: "警告",
            type: "warning",
            size: "normal",
            class: "mr-10px mb-10px"
          ...
          const n5 = _createSharedDataComponentWithFallback(_component_up_tag, "73e06c66", {
            text: "危险",
            type: "error",
            size: "normal",
            class: "mr-10px mb-10px"
          ...
          const n9 = _createSharedDataComponentWithFallback(_component_up_tag, "73e074bd", {
            text: "镂空",
            type: "primary",
            plain: true,
            size: "normal",
          ...
          const n10 = _createSharedDataComponentWithFallback(_component_up_tag, "73e07866", {
            text: "镂空",
            type: "success",
            plain: true,
            size: "normal",
          ...
          const n14 = _createSharedDataComponentWithFallback(_component_up_tag, "082adad3", {
            text: "大尺寸",
            size: "large",
            type: "primary",
            class: "mr-10px"
          ...
          const n15 = _createSharedDataComponentWithFallback(_component_up_tag, "082ade59", {
            text: "普通",
            size: "normal",
            type: "success",
            class: "mr-10px"
          ...
          const n16 = _createSharedDataComponentWithFallback(_component_up_tag, "082ae1f4", {
            text: "迷你",
            size: "mini",
            type: "warning",
            class: "mr-10px"
          ...
          const n20 = _createSharedDataComponentWithFallback(_component_up_tag, "082aea13", {
            text: "半圆角",
            shape: "circle",
            type: "primary",
            class: "mr-10px"
          ...
          const n21 = _createSharedDataComponentWithFallback(_component_up_tag, "082aed9b", {
            text: "直角",
            shape: "square",
            type: "primary",
            class: "mr-10px"
          ...
          _createSharedDataIf(() => {
            ...
            const n27 = _createSharedDataComponentWithFallback(_component_up_tag, "082b4733", {
              text: "点击关闭",
              type: "primary",
              closable: "",
              onClose: () => {
            ...
            _setSharedData(__sharedData, 14, n27?.sharedData);
          });
        })
      });
