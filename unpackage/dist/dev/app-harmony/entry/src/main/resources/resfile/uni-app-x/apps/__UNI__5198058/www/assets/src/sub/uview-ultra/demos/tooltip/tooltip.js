...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n34 = _createSharedDataComponent(_sfc_main$1, "2c37d7fe", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "529e6cec", {
          ...
          const n2 = _createSharedDataComponentWithFallback(_component_up_tooltip, "012f21c4", {
            text: "长按此处复制文本",
            direction: "top"
          });
          _setSharedData(__sharedData, 2, n2?.sharedData);
          const n4 = _createSharedDataComponentWithFallback(_component_up_tooltip, "012f25c3", {
            text: "长按显示操作",
            direction: "top",
            "show-copy": false,
            buttons: () => {
          ...
          const n9 = _createSharedDataComponentWithFallback(_component_up_tooltip, "012f34a9", {
            text: "长按文本，上方提示",
            direction: "top"
          });
          _setSharedData(__sharedData, 4, n9?.sharedData);
          const n11 = _createSharedDataComponentWithFallback(_component_up_tooltip, "24b3b272", {
            text: "长按文本，下方提示",
            direction: "bottom"
          });
          _setSharedData(__sharedData, 5, n11?.sharedData);
          const n16 = _createSharedDataComponentWithFallback(_component_up_tooltip, "24b3bd92", {
            text: "长按文本，显示背景色",
            "bg-color": "#d1fae5",
            direction: "top"
          });
          _setSharedData(__sharedData, 6, n16?.sharedData);
          const n20 = _createSharedDataComponentWithFallback(_component_up_tooltip, "24b3c87d", {
            text: "显示多个扩展按钮",
            "show-copy": true,
            buttons: () => {
          ...
          const n25 = _createSharedDataComponentWithFallback(_component_up_tooltip, "24b3d477", {
            "show-copy": false,
            buttons: ["设置", "赞"],
            direction: "top",
            onClick: () => {
            ...
            "default": _withSharedDataVaporCtx(() => {
              const n24 = _createSharedDataComponentWithFallback(_component_up_button, "24b4272b", {
                type: "primary",
                size: "small",
                text: "点击/长按触发"
              });
          ...
          _setSharedData(__sharedData, 8, n25?.sharedData);
          const n28 = _createSharedDataComponentWithFallback(_component_up_tooltip, "24b42df3", {
            "show-copy": true,
            buttons: ["自定义操作"],
            direction: "bottom",
            onClick: () => {
            ...
            "default": _withSharedDataVaporCtx(() => {
              const n27 = _createSharedDataComponentWithFallback(_component_up_button, "24b431d2", {
                type: "warning",
                size: "small",
                text: "下方弹出"
              });
              _setSharedData(__sharedData, 11, n27?.sharedData);
            })
          });
          _setSharedData(__sharedData, 10, n28?.sharedData);
        })
      });
