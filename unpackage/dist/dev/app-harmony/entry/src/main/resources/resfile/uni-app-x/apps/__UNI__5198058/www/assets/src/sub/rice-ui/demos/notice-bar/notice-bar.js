...
import { _ as __easycom_1 } from "../../../../../uni_modules/rice-ui/components/rice-notice-bar/rice-notice-bar.js";
...
import "../../../../../uni_modules/rice-ui/components/rice-notice-bar/type.js";
...
const __className = "GenSrcSubRiceUiDemosNoticeBarNoticeBar";
const { computed } = globalThis.Vue;
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  __dynamicSharedData: true,
  __hash: "0be6047c",
  __className,
  __filename: "src/sub/rice-ui/demos/notice-bar/notice-bar.uvue",
  __name: "notice-bar",
  setup(__props) {
    const __sharedDataRenderer = _useSharedDataRenderer();
    const __sharedData = __sharedDataRenderer == "component" ? _withSharedDataComponent(new UniDynamicSharedDataComponent(_useSharedDataScope(), _useSharedDataComponentOptions({ bundleKey: "GenSrcSubRiceUiDemosNoticeBarNoticeBarSharedData", sharedDataClassId: 0 }))) : _withSharedDataPage(new UniDynamicSharedDataPage(_useSharedDataPageId(), _useSharedDataPageOptions({ bundleKey: "GenSrcSubRiceUiDemosNoticeBarNoticeBarSharedData", sharedDataClassId: 0 })));
    ...
    return () => {
      ...
      const _component_rice_notice_bar = __easycom_1;
      const n14 = _createSharedDataComponent(_sfc_main$1, "14dd8706", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "f2594af2", {
            title: "NoticeBar 公告栏",
            "auto-back": true,
          ...
          const n2 = _createSharedDataComponentWithFallback(_component_rice_notice_bar, "5397e445", {
          ...
          const n5 = _createSharedDataComponentWithFallback(_component_rice_notice_bar, "5397f30c", {
            type: "primary",
            color: () => {
              return currentTheme.value;
            },
          ...
          const n7 = _createSharedDataComponentWithFallback(_component_rice_notice_bar, "5397f74a", {
            type: "success",
            message: "您提交的申请已审批通过。"
          });
          _setSharedData(__sharedData, 4, n7?.sharedData);
          const n9 = _createSharedDataComponentWithFallback(_component_rice_notice_bar, "1f63a4ae", {
            type: "error",
