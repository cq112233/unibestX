...
import "./types.js";
import { t as touchMixin } from "../../libs/mixin/touch.js";
import { p as propsSwipeActionItem } from "./props.js";
import { m as mpMixin } from "../../libs/mixin/mpMixin.js";
import { m as mixin } from "../../libs/mixin/mixin.js";
import { s as sleep, a as addUnit, g as getPx } from "../../libs/function/index.js";
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return _openBlock(), _createElementBlock(
    ...
    [
      _createElementVNode("view", { class: "up-swipe-action-item__right" }, [
        _renderSlot(_ctx.$slots, "button", {}, () => [
          (_openBlock(true), _createElementBlock(
            _Fragment,
            null,
            _renderList(_ctx.options, (item, index) => {
              return _openBlock(), _createElementBlock("view", {
                ...
                style: _normalizeStyle([$options.getButtonStyle(item)]),
                ...
                _createElementVNode(
                  "view",
                  {
                    ...
                    style: _normalizeStyle([$options.getWrapperStyle(item)])
                  },
                  [
                    item["icon"] ? (_openBlock(), _createBlock(_component_up_icon, {
                      key: 0,
                      name: item["icon"],
                    ...
                    item["text"] ? (_openBlock(), _createElementBlock(
                      "text",
                      {
                        key: 1,
                        class: "up-swipe-action-item__right__button__wrapper__text up-line-1",
                        style: _normalizeStyle([$options.getTextStyle(item)])
                      },
      ...
      _createElementVNode(
        "view",
        {
          ...
          style: _normalizeStyle($data.sliderStyle)
        },
        [
