class ActionSheetAction extends UTS.UTSType {
...
class ActionSheetProps extends UTS.UTSType {
  static get$UTSMetadata$() {
    return {
      kind: 2,
      get fields() {
        return {
          actions: { type: UTS.UTSType.withGenerics(Array, [ActionSheetAction]), optional: true },
...
export {
  ActionSheetAction as A,
  ActionSheetProps as a
};
