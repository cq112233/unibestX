...
import { _ as __easycom_2 } from "../../../../uni_modules/uview-ultra/components/up-icon/up-icon.js";
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  const _component_up_icon = resolveEasycom(resolveDynamicComponent("up-icon"), __easycom_2);
