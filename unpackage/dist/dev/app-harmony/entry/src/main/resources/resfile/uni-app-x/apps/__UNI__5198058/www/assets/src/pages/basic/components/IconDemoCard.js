...
import { _ as __easycom_0 } from "../../../../uni_modules/rice-ui/components/rice-icon/rice-icon.js";
      ...
      const n24 = _createSharedDataComponent(
        ...
        } },
        {
          "default": _withSharedDataVaporCtx(() => {
            const n3 = _createSharedDataComponentWithFallback(_component_uni_icons, "f7cb04de", {
              type: "contact",
              size: "26",
            ...
            const n13 = _createSharedDataComponentWithFallback(_component_l_icon, "01987644", {
              name: "circle",
              size: "24",
              style: "color: #10b981; margin-right: 8px;"
            });
            _setSharedData(__sharedData, 2, n13?.sharedData);
            const n20 = _createSharedDataComponentWithFallback(_component_rice_icon, "01984936", {
              name: "search",
              size: "24px",
              color: "#a855f7",
