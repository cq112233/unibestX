...
const _style_0 = { "flex-1": { "": { "flexGrow": 1, "flexShrink": 1, "flexBasis": "0%" } }, "flex-col": { "": { "flexDirection": "column" } }, "pb-30px": { "": { "paddingBottom": 30 } } };
  ...
  return _openBlock(), _createBlock($setup["AppKu"], null, {
    default: _withCtx(() => [
      _createVNode($setup["LayoutComponent"], {
        ...
        default: _withCtx(() => [
          _createElementVNode("view", { class: "flex-1 flex-col pb-30px" }, [
