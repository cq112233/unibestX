...
const _style_0 = { "bg-__f8fafc_": { "": { "backgroundImage": "none", "backgroundColor": "#f8fafc" } }, "flex-1": { "": { "flexGrow": 1, "flexShrink": 1, "flexBasis": "0%" } }, "flex-col": { "": { "flexDirection": "column" } }, "h-0": { "": { "height": 0 } }, "h-full": { "": { "height": "100%" } } };
  ...
  return openBlock(), createBlock($setup["AppKu"], null, {
    default: withCtx(() => [
      createVNode($setup["LayoutComponent"], {
        ...
        default: withCtx(() => [
          createElementVNode("view", { class: "flex-1 flex-col h-full bg-__f8fafc_" }, [
            createCommentVNode(" 基础滚动外层容器 "),
