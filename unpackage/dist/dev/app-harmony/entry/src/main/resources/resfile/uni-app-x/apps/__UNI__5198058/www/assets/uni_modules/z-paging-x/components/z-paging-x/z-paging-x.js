import { _ as __easycom_0 } from "../z-paging-x-empty/z-paging-x-empty.js";
...
const { renderSlot: _renderSlot, createCommentVNode: _createCommentVNode, openBlock: _openBlock, createBlock: _createBlock, Fragment: _Fragment, createElementBlock: _createElementBlock, createElementVNode: _createElementVNode, normalizeStyle: _normalizeStyle, resolveComponent: _resolveComponent, normalizeClass: _normalizeClass, withModifiers: _withModifiers } = globalThis.Vue;
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_z_paging_x_empty = resolveEasycom(__resolveDynamicComponent("z-paging-x-empty"), __easycom_0);
  return _openBlock(), _createElementBlock(
    "view",
    {
      ref: "zPagingX",
      class: _normalizeClass({ "zpx-content": true }),
      style: _normalizeStyle([$props.pagingStyle])
    },
    [
      _renderSlot(_ctx.$slots, "top"),
      $props.listIs === "list-view" ? (_openBlock(), _createElementBlock("list-view", {
        key: 0,
        ref: "zpxList",
        ...
        _createElementVNode("list-item", null, [
          $setup.showLoadMore ? (_openBlock(), _createElementBlock(
            _Fragment,
            { key: 0 },
            [
              _ctx.$slots["loadMore"] ? _renderSlot(_ctx.$slots, "loadMore", {
                key: 0,
                loadMoreStatus: $setup.loadMoreStatus
              }) : (_openBlock(), _createBlock($setup["zPagingLoadMore"], {
                key: 1,
        ...
        _createElementVNode("list-item", { slot: "refresher" }, [
          _createElementVNode(
            "view",
            {
              ref: "zpxListRefresher",
              class: "zpx-list-refresher",
              style: _normalizeStyle({ width: $setup.contentWidth + "px" })
            },
            [
              _ctx.$slots["refresher"] ? _renderSlot(_ctx.$slots, "refresher", {
                key: 0,
                refresherStatus: $setup.refresherStatus
              }) : (_openBlock(), _createBlock($setup["zPagingRefresher"], {
                key: 1,
                ref: "commonRefresher",
        ...
        _createElementVNode(
          "list-item",
          {
            class: _normalizeClass($setup.showEmpty ? "zpx-flex1" : "")
          },
          [
            $setup.showEmpty ? (_openBlock(), _createElementBlock(
              _Fragment,
              { key: 0 },
              [
                _ctx.$slots["empty"] ? _renderSlot(_ctx.$slots, "empty", {
                  key: 0,
                  isLoadFailed: $setup.isLoadFailed
                }) : (_openBlock(), _createBlock(_component_z_paging_x_empty, {
                  key: 1,
            ...
            $setup.showLoading ? _renderSlot(_ctx.$slots, "loading", { key: 1 }) : _createCommentVNode("v-if", true)
          ],
          2
          /* CLASS */
        )
      ], 40, ["id", "refresher-enabled", "refresher-threshold", "refresher-triggered", "refresher-default-style", "custom-nested-scroll", "refresher-background", "rebound", "scroll-top", "show-scrollbar", "scroll-with-animation"])) : (_openBlock(), _createElementBlock("scroll-view", {
        key: 1,
        ref: "zpxList",
        class: "zpx-list-view zpx-flex1",
        id: $props.listId,
        ...
        _createElementVNode("view", { slot: "refresher" }, [
          _createElementVNode(
            "view",
            {
              ref: "zpxListRefresher",
      ...
      ], 40, ["id", "refresher-enabled", "refresher-threshold", "refresher-triggered", "refresher-default-style", "refresher-background", "scroll-top", "show-scrollbar", "scroll-with-animation"])),
      _renderSlot(_ctx.$slots, "bottom"),
      $setup.showBackToTopClass ? (_openBlock(), _createElementBlock(
        "view",
        {
          key: 2,
          class: _normalizeClass($setup.backToTopClass),
          style: _normalizeStyle([$props.backToTopStyle]),
          onClick: _withModifiers($setup._onBackToTopClick, ["stop"])
        },
        [
          _ctx.$slots["backToTop"] ? _renderSlot(_ctx.$slots, "backToTop", { key: 0 }) : (_openBlock(), _createElementBlock("image", {
            key: 1,
