...
import { _ as __easycom_5 } from "../../../../uni_modules/uview-ultra/components/up-tooltip/up-tooltip.js";
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  const _component_up_tooltip = resolveEasycom(resolveDynamicComponent("up-tooltip"), __easycom_5);
  ...
  return openBlock(), createElementBlock("view", null, [
      ...
      createVNode(_component_up_collapse, {
        ...
        default: withCtx(() => [
          ...
          createVNode(_component_up_collapse_item, {
            ...
            default: withCtx(() => [
              createElementVNode("text", { class: "collapse-text" }, "高度适配 UTS 强类型系统与原生跨端开发")
            ]),
            _: 1
            /* STABLE */
          })
    ...
    createElementVNode("view", { class: "demo-block" }, [
      ...
      createElementVNode("view", { class: "demo-row" }, [
        createVNode(_component_up_button, {
          ...
          text: "主要通知",
          size: "mini",
          onClick: _cache[4] || (_cache[4] = ($event) => $setup.showNotify("primary"))
        }),
        createVNode(_component_up_button, {
          type: "success",
          text: "成功通知",
          size: "mini",
          onClick: _cache[5] || (_cache[5] = ($event) => $setup.showNotify("success"))
        }),
        createVNode(_component_up_button, {
          type: "warning",
          text: "警告通知",
          size: "mini",
          onClick: _cache[6] || (_cache[6] = ($event) => $setup.showNotify("warning"))
        }),
        createVNode(_component_up_button, {
          type: "error",
          text: "错误通知",
          size: "mini",
          onClick: _cache[7] || (_cache[7] = ($event) => $setup.showNotify("error"))
        })
      ])
    ]),
    ...
    createElementVNode("view", { class: "demo-block" }, [
      ...
      createElementVNode("view", { class: "demo-row" }, [
        createVNode(_component_up_button, {
          ...
          text: "显示遮罩",
          size: "mini",
          onClick: _cache[8] || (_cache[8] = ($event) => $setup.overlayShow = true)
        }),
        createVNode(_component_up_button, {
          type: "warning",
          text: "半透明遮罩",
    ...
    createElementVNode("view", { class: "demo-block" }, [
      ...
      createElementVNode("view", { class: "demo-row" }, [
        createVNode(_component_up_button, {
          ...
          text: "顶部弹出",
          size: "mini",
          onClick: _cache[10] || (_cache[10] = ($event) => $setup.openPopup("top"))
        }),
        createVNode(_component_up_button, {
          type: "primary",
          text: "底部弹出",
          size: "mini",
          onClick: _cache[11] || (_cache[11] = ($event) => $setup.openPopup("bottom"))
        }),
        createVNode(_component_up_button, {
          type: "primary",
          text: "左侧弹出",
          size: "mini",
          onClick: _cache[12] || (_cache[12] = ($event) => $setup.openPopup("left"))
        }),
        createVNode(_component_up_button, {
          type: "primary",
          text: "右侧弹出",
          size: "mini",
          onClick: _cache[13] || (_cache[13] = ($event) => $setup.openPopup("right"))
        }),
        createVNode(_component_up_button, {
          type: "primary",
          text: "居中弹出",
          size: "mini",
          onClick: _cache[14] || (_cache[14] = ($event) => $setup.openPopup("center"))
        })
      ])
    ]),
    ...
    createElementVNode("view", { class: "demo-block" }, [
      ...
      createElementVNode("view", { class: "demo-row-start" }, [
        ...
        createElementVNode("view", { class: "w-30px" }),
        createVNode(_component_up_tooltip, {
          text: "长按显示操作",
          direction: "top",
          "show-copy": false,
    ...
    createVNode(_component_up_overlay, {
      ...
      onClick: _cache[16] || (_cache[16] = ($event) => $setup.overlayShow = false)
    }, {
      default: withCtx(() => [
