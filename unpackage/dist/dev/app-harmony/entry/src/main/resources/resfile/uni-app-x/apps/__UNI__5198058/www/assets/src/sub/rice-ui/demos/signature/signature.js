...
import { _ as __easycom_1 } from "../../../../../uni_modules/rice-ui/components/rice-signature/rice-signature.js";
...
import "../../../../../uni_modules/rice-ui/components/rice-signature/type.js";
...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  __hash: "09a3ea0c",
  __className,
  __filename: "src/sub/rice-ui/demos/signature/signature.uvue",
  __name: "signature",
  setup(__props) {
    const __sharedDataRenderer = _useSharedDataRenderer();
    const __sharedData = __sharedDataRenderer == "component" ? _withSharedDataComponent(new UniDynamicSharedDataComponent(_useSharedDataScope(), _useSharedDataComponentOptions({ bundleKey: "GenSrcSubRiceUiDemosSignatureSignatureSharedData", sharedDataClassId: 0 }))) : _withSharedDataPage(new UniDynamicSharedDataPage(_useSharedDataPageId(), _useSharedDataPageOptions({ bundleKey: "GenSrcSubRiceUiDemosSignatureSignatureSharedData", sharedDataClassId: 0 })));
    ...
    return () => {
      ...
      const _component_rice_signature = __easycom_1;
      const n12 = _createSharedDataComponent(_sfc_main$1, "965900b4", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "34c71432", {
            title: "Signature 签名",
            "auto-back": true,
          ...
          const n2 = _createSharedDataComponentWithFallback(_component_rice_signature, "641b8eb0", {
            tips: "请在上方空白区域书写您的签名",
            "pen-color": () => {
          ...
          _createSharedDataIf(() => {
            return _setSharedData(__sharedData, 2, _toSharedDataBoolean(_unref(signatureImg) != ""));
          }, () => {
            _renderSharedDataEffect(() => {
              return _setSharedDataAttr(__sharedData, 3, _toSharedDataString(_unref(signatureImg)));
            });
          });
        })
      });
