...
const { defineComponent, ref, resolveDynamicComponent, openBlock, createBlock, withCtx, createCommentVNode, createElementVNode, withDirectives, vModelText, createVNode, createTextVNode } = globalThis.Vue
    ...
    default: withCtx(() => [
      ...
      createElementVNode("view", { class: "bg-__f8fafc_ rounded-12px p-16px mb-16px border-width-1px border-style-solid border-color-__e2e8f0_" }, [
        ...
        createVNode(_component_up_button, {
          ...
          default: withCtx(() => [
            createTextVNode(" 复制测试文本 ")
          ]),
          _: 1
          /* STABLE */
        })
      ]),
      createCommentVNode(" 短震动 "),
      createVNode(_component_up_button, {
        type: "warning",
        onClick: $setup.triggerVibration
      }, {
        default: withCtx(() => [
          createTextVNode(" 短震动反馈 ")
        ]),
        _: 1
        /* STABLE */
      })
