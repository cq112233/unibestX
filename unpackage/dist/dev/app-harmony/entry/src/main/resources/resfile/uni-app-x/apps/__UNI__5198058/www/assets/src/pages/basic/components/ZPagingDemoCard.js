...
const { defineComponent, ref, resolveDynamicComponent, openBlock, createBlock, withCtx, createElementVNode, createCommentVNode, createVNode, createTextVNode, createElementBlock, Fragment, renderList, normalizeStyle, toDisplayString } = globalThis.Vue
  ...
  return openBlock(), createBlock($setup["Card"], { title: "数据分页列表 (z-paging-x)" }, {
    default: withCtx(() => [
      createElementVNode("view", { class: "flex-col mb-12px" }, [
        ...
        createCommentVNode(" 快捷操作栏：用 margin-right 代替 gap "),
          ...
          (openBlock(true), createElementBlock(
            ...
            renderList($setup.dataList, (item) => {
              return openBlock(), createElementBlock("view", {
                key: item.id,
                class: "mx-12px my-8px p-12px bg-white rounded-8px border-width-1px border-style-solid border-color-__edf2f7_"
              }, [
