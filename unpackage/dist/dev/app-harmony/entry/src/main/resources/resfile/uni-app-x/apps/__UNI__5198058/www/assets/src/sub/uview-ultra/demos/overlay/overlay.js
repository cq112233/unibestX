...
const _style_0 = {"demo-block":{"":{"marginBottom":12,"paddingTop":12,"paddingRight":12,"paddingBottom":12,"paddingLeft":12,"backgroundColor":"#ffffff","borderTopLeftRadius":8,"borderTopRightRadius":8,"borderBottomRightRadius":8,"borderBottomLeftRadius":8}},"demo-label":{"":{"fontSize":14,"fontWeight":"bold","color":"#606266","marginBottom":10,"paddingLeft":4,"borderLeftWidth":3,"borderLeftStyle":"solid","borderLeftColor":"#2979ff"}},"bg-_b_hf8fafc_B":{"":{"backgroundColor":"#f8fafc"}},"flex-row":{"":{"flexDirection":"row"}},"items-center":{"":{"alignItems":"center"}},"flex-1":{"":{"flexGrow":1,"flexShrink":1,"flexBasis":"0%","flex":"1"}},"justify-center":{"":{"justifyContent":"center"}},"bg-white":{"":{"backgroundColor":"var(--color-white)"}},"flex":{"":{"display":"flex"}}};
              ...
              default: _withCtx(() => [
                _createElementVNode("view", { class: "flex-1 items-center justify-center" }, [
                  _createElementVNode("view", {
                    ...
                    _createElementVNode("text", { class: "text-14px text-_b_h303133_B mt-10px" }, "加载中，点击遮罩关闭")
                  ])
                ])
              ]),
              _: 1
