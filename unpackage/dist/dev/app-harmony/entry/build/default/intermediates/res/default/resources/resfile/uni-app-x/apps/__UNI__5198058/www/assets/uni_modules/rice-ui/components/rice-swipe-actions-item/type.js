class SwipeActionsMenu extends UTS.UTSType {
...
class SwipeActionsState extends UTS.UTSType {
  static get$UTSMetadata$() {
    return {
      kind: 2,
      get fields() {
...
class SwipeActionsMenuRect extends UTS.UTSType {
  static get$UTSMetadata$() {
    return {
      kind: 2,
      get fields() {
        return {
          rightMenuDom: { type: UTS.UTSType.withGenerics(Array, ["Unknown"]), optional: false },
          rightMenuOffset: { type: UTS.UTSType.withGenerics(Array, [Number]), optional: false },
          leftMenuOffset: { type: UTS.UTSType.withGenerics(Array, [Number]), optional: false },
          leftMenuDom: { type: UTS.UTSType.withGenerics(Array, ["Unknown"]), optional: false }
        };
      },
...
class SwipeActionsItemClick extends UTS.UTSType {
  static get$UTSMetadata$() {
    return {
      kind: 2,
      get fields() {
...
class SwipeActionsItemOpen extends UTS.UTSType {
  static get$UTSMetadata$() {
    return {
      kind: 2,
      get fields() {
...
class SwipeActionsItemClose extends UTS.UTSType {
  static get$UTSMetadata$() {
    return {
      kind: 2,
      get fields() {
...
class SwipeActionsItemProps extends UTS.UTSType {
  static get$UTSMetadata$() {
    return {
      kind: 2,
      get fields() {
        return {
          name: { type: "Unknown", optional: true },
          leftMenu: { type: UTS.UTSType.withGenerics(Array, [SwipeActionsMenu]), optional: true },
          rightMenu: { type: UTS.UTSType.withGenerics(Array, [SwipeActionsMenu]), optional: true },
...
export {
  SwipeActionsMenu as S,
  SwipeActionsState as a,
  SwipeActionsMenuRect as b,
  SwipeActionsItemClose as c,
  SwipeActionsItemClick as d,
  SwipeActionsItemOpen as e
};
