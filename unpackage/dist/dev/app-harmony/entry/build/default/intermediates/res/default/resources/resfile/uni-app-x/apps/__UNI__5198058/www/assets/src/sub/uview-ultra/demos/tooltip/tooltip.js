...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n35 = _createSharedDataComponent(AppKu, "2c37d7fe", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n34 = _createSharedDataComponent(LayoutComponent, "529e6c15", {
            "navigation-style": "custom",
            "navigation-bar-title-text": "up-tooltip 长按提示"
          }, {
            "default": _withSharedDataVaporCtx(() => {
              const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "012f173d", {
              ...
              const n2 = _createSharedDataComponentWithFallback(_component_up_tooltip, "012f25bf", {
                text: "长按此处复制文本",
                direction: "top"
              });
              _setSharedData(__sharedData, 3, n2?.sharedData);
              const n4 = _createSharedDataComponentWithFallback(_component_up_tooltip, "012f29c2", {
                text: "长按显示操作",
                direction: "top",
                "show-copy": false,
                buttons: () => {
              ...
              const n9 = _createSharedDataComponentWithFallback(_component_up_tooltip, "24b3b292", {
                text: "长按文本，上方提示",
                direction: "top"
              });
              _setSharedData(__sharedData, 5, n9?.sharedData);
              const n11 = _createSharedDataComponentWithFallback(_component_up_tooltip, "24b3b6ab", {
                text: "长按文本，下方提示",
                direction: "bottom"
              });
              _setSharedData(__sharedData, 6, n11?.sharedData);
              const n16 = _createSharedDataComponentWithFallback(_component_up_tooltip, "24b3c1cf", {
                text: "长按文本，显示背景色",
                "bg-color": "#d1fae5",
                direction: "top"
              });
              _setSharedData(__sharedData, 7, n16?.sharedData);
              const n20 = _createSharedDataComponentWithFallback(_component_up_tooltip, "24b3ccd3", {
                text: "显示多个扩展按钮",
                "show-copy": true,
                buttons: () => {
              ...
              const n25 = _createSharedDataComponentWithFallback(_component_up_tooltip, "24b42a35", {
                "show-copy": false,
                buttons: ["设置", "赞"],
                direction: "top",
                onClick: () => {
                ...
                "default": _withSharedDataVaporCtx(() => {
                  const n24 = _createSharedDataComponentWithFallback(_component_up_button, "24b42e14", {
                    type: "primary",
                    size: "small",
                    text: "点击/长按触发"
                  });
              ...
              const n28 = _createSharedDataComponentWithFallback(_component_up_tooltip, "24b43251", {
                "show-copy": true,
                buttons: ["自定义操作"],
                direction: "bottom",
                onClick: () => {
                ...
                "default": _withSharedDataVaporCtx(() => {
                  const n27 = _createSharedDataComponentWithFallback(_component_up_button, "24b43630", {
                    type: "warning",
                    size: "small",
                    text: "下方弹出"
                  });
...
const _style_0 = {};
const tooltip = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0]]]);
export {
  tooltip as default
};
