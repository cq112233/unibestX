...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n12 = _createSharedDataComponent(_sfc_main$1, "086a593d", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "04e0cf30", {
            title: "Qrcode 二维码",
            "auto-back": true
          });
          _setSharedData(__sharedData, 1, n0?.sharedData);
          const n2 = _createSharedDataComponentWithFallback(_component_up_qrcode, "d18dfdd0", {
            size: "200",
            val: "https://uview-ultra.lingyun.net"
          });
          _setSharedData(__sharedData, 2, n2?.sharedData);
          const n5 = _createSharedDataComponentWithFallback(_component_up_qrcode, "d18dee88", {
            size: "200",
            background: "#f3f4f6",
            foreground: "#2979ff",
            val: "https://uview-ultra.lingyun.net"
          ...
          const n8 = _createSharedDataComponentWithFallback(_component_up_qrcode, "d18dd902", {
            size: "200",
