  ...
  return _openBlock(), _createBlock($setup["AppKu"], null, {
    default: _withCtx(() => [
      _createVNode($setup["LayoutComponent"], {
        ...
        default: _withCtx(() => [
          _createElementVNode("view", { class: "page-container bg-_b_hf8fafc_B pb-50px" }, [
            ...
            _createElementVNode("view", { class: "p-16px bg-white mb-12px shadow-xs flex-row items-center" }, [
              ...
              _createElementVNode("view", { class: "flex-1" }, [
                _createElementVNode("text", { class: "text-16px font-bold text-_b_h1e293b_B" }, "uview-ultra 组件库"),
                _createElementVNode("text", { class: "text-12px text-_b_h64748b_B mt-4px" }, "已收录 " + _toDisplayString($setup.demoCount) + " 个组件 Demo"),
                _createElementVNode("text", { class: "text-12px text-_b_h64748b_B mt-4px" }, "点击下方任意功能组件，进入独立页面进行演示")
              ])
            ]),
