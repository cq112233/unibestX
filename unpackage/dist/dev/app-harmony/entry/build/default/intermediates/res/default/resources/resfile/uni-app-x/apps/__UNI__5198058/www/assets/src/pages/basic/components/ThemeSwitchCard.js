const { defineComponent, computed, openBlock, createBlock, withCtx, createCommentVNode, createElementVNode, toDisplayString, normalizeStyle, createElementBlock, Fragment, renderList } = globalThis.Vue
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, _a) {
    ...
    const __returned__ = { appStore, currentTheme, colorOptions, changeTheme, get Card() {
      return Card;
    } };
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createBlock($setup["Card"], {
    ...
    default: withCtx(() => [
      ...
      createElementVNode("view", { class: "rounded-12px p-16px mb-16px border-width-1px border-style-solid border-color-__e2e8f0_ items-center" }, [
        createElementVNode(
          "text",
          { class: "text-12px text-__94a3b8_ mb-8px" },
          toDisplayString(_ctx.$t("basic.themePreview")),
          1
          /* TEXT */
        ),
        createElementVNode(
          "view",
          {
            ...
            style: normalizeStyle({ backgroundColor: $setup.currentTheme })
          },
          [
            createElementVNode(
              "text",
              { class: "text-__ffffff_ text-14px" },
              toDisplayString(_ctx.$t("basic.themeButton")),
              1
              /* TEXT */
            )
          ],
        ...
        (openBlock(), createElementBlock(
          ...
          renderList($setup.colorOptions, (item, index) => {
            return createElementVNode("view", {
              ...
              $setup.currentTheme == item ? (openBlock(), createElementBlock("text", {
                key: 0,
