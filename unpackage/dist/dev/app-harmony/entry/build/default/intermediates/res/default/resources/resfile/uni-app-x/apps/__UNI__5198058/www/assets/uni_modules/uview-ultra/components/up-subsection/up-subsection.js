import { s as subsectionProps } from "./props.js";
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock(), _createElementBlock(
    "view",
    {
      class: _normalizeClass(["up-subsection", [`up-subsection--${_ctx.mode}`]]),
      ref: "up-subsection",
      style: _normalizeStyle([$options.addStyle(_ctx.customStyle), $options.wrapperStyle])
    },
    [
      _createElementVNode(
        "view",
        ...
        [
          _createElementVNode(
            "view",
            {
              ...
              style: _normalizeStyle($options.innerBarStyle)
            },
            null,
            6
            /* CLASS, STYLE */
          ...
          return _openBlock(), _createElementBlock("view", {
            ...
            _renderSlot(_ctx.$slots, "item", {
              ...
              _createElementVNode(
                ...
                _toDisplayString($options.getText(item)),
                7
                /* TEXT, CLASS, STYLE */
              )
            ])
