...
import { _ as __easycom_2 } from "../../../../../uni_modules/uview-ultra/components/up-modal/up-modal.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, _a) {
    ...
    const __returned__ = { modalShow, modalTitle, modalContent, modalShowCancel, showModal, showConfirmModal, onModalConfirm, onModalClose, get AppKu() {
      return AppKu;
    }, get LayoutComponent() {
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  const _component_up_modal = resolveEasycom(resolveDynamicComponent("up-modal"), __easycom_2);
