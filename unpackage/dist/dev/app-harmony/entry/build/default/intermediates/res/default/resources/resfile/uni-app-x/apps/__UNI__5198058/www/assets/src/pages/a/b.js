...
const _style_0 = { "b": { "": { "borderTopWidth": "var(--un-line-width-default,1px)", "borderRightWidth": "var(--un-line-width-default,1px)", "borderBottomWidth": "var(--un-line-width-default,1px)", "borderLeftWidth": "var(--un-line-width-default,1px)" } } };
const _style_1 = {};
  ...
  return openBlock(), createBlock($setup["AppKu"], null, {
    default: withCtx(() => [
      createVNode($setup["LayoutComponent"], null, {
        default: withCtx(() => [
          createElementVNode("view", { class: "" }, " b ")
        ]),
        _: 1
        /* STABLE */
      })
...
const b = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["styles", [_style_0, _style_1]], ["__file", "/Users/chenqi/Documents/chenqi-front/unibestX/src/pages/a/b.uvue"]]);
export {
  b as default
};
