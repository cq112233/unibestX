...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n10 = _createSharedDataComponent(_sfc_main$1, "282c037e", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "dd546aa8", {
            title: "LoadingIcon 加载图标",
            "auto-back": true
          });
          _setSharedData(__sharedData, 1, n0?.sharedData);
          const n2 = _createSharedDataComponentWithFallback(_component_up_loading_icon, "cd39167a", { class: "my-10px" });
          _setSharedData(__sharedData, 2, n2?.sharedData);
          const n5 = _createSharedDataComponentWithFallback(_component_up_loading_icon, "cd390dbe", {
            mode: "circle",
            class: "my-10px"
          });
          _setSharedData(__sharedData, 3, n5?.sharedData);
          const n6 = _createSharedDataComponentWithFallback(_component_up_loading_icon, "cd3906c4", {
            mode: "semicircle",
            class: "my-10px"
          });
