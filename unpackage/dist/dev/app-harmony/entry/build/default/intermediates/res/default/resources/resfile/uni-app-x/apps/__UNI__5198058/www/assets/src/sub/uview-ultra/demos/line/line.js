...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n21 = _createSharedDataComponent(AppKu, "aaed78ee", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n20 = _createSharedDataComponent(LayoutComponent, "b2c1a4e6", {
            "navigation-style": "custom",
            "navigation-bar-title-text": "up-line 线条"
          }, {
            "default": _withSharedDataVaporCtx(() => {
              const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "2d4684c0", {
                title: "Line 线条",
                "auto-back": true
              });
              _setSharedData(__sharedData, 2, n0?.sharedData);
              const n2 = _createSharedDataComponentWithFallback(_component_up_line, "2d468bc6", {
                color: "#2979ff",
                length: "100%"
              });
              _setSharedData(__sharedData, 3, n2?.sharedData);
              const n5 = _createSharedDataComponentWithFallback(_component_up_line, "2d4692cb", {
                color: "#2979ff",
                length: "100%",
                dashed: ""
              });
              _setSharedData(__sharedData, 4, n5?.sharedData);
              const n8 = _createSharedDataComponentWithFallback(_component_up_line, "2d46974f", {
                color: "#fa3534",
                length: "50%"
              });
              _setSharedData(__sharedData, 5, n8?.sharedData);
              const n10 = _createSharedDataComponentWithFallback(_component_up_line, "2d469b0e", {
                color: "#19be6b",
                length: "80%"
              });
              _setSharedData(__sharedData, 6, n10?.sharedData);
              const n14 = _createSharedDataComponentWithFallback(_component_up_line, "7b89f569", {
                color: "#909399",
                direction: "col",
                length: "20px",
                margin: "0 10px"
...
const _style_0 = {};
const line = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0]]]);
export {
  line as default
};
