import { p as propsToolbar } from "./props.js";
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return _ctx.show ? (_openBlock(), _createElementBlock(
    "view",
    {
      key: 0,
      class: "up-toolbar",
      onTouchmove: _cache[2] || (_cache[2] = _withModifiers((...args) => _ctx.noop && _ctx.noop(...args), ["stop"]))
    },
    [
      ...
      _createElementVNode("view", { class: "up-toolbar__right" }, [
        !_ctx.rightSlot ? (_openBlock(), _createElementBlock("view", {
          key: 0,
