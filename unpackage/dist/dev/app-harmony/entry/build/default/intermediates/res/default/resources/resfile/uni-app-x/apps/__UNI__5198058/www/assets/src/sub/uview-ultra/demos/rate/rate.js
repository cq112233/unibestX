...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, _a) {
    ...
    const __returned__ = { rateValue, customRateValue, get AppKu() {
      return AppKu;
    }, get LayoutComponent() {
            ...
            createElementVNode("view", { class: "p-16px" }, [
              createElementVNode("view", { class: "demo-block" }, [
                ...
                createVNode(_component_up_rate, {
                  ...
                  "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => $setup.rateValue = $event),
                  count: 5
                }, null, 8, ["modelValue"])
              ]),
              createElementVNode("view", { class: "demo-block mt-12px" }, [
                ...
                createVNode(_component_up_rate, {
                  modelValue: $setup.customRateValue,
                  "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => $setup.customRateValue = $event),
                  count: 5,
