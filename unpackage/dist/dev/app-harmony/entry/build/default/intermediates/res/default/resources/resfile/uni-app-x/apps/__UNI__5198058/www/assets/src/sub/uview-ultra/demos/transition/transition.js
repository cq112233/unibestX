...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n29 = _createSharedDataComponent(AppKu, "5d80d4ea", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n28 = _createSharedDataComponent(LayoutComponent, "56b31bcb", {
            "navigation-style": "custom",
            "navigation-bar-title-text": "up-transition 动画"
          }, {
            "default": _withSharedDataVaporCtx(() => {
              const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "7fb05e48", {
                title: "Transition 动画",
                "auto-back": true,
              ...
              const n4 = _createSharedDataComponentWithFallback(_component_up_transition, "7fb0692f", {
                show: () => {
              ...
              const n5 = _createSharedDataComponentWithFallback(_component_up_button, "7fb07470", {
                type: "primary",
                text: () => {
              ...
              const n12 = _createSharedDataComponentWithFallback(_component_up_transition, "765b4d03", {
                show: () => {
                  return transitionShow.value;
                },
                mode: "zoom"
              ...
              const n18 = _createSharedDataComponentWithFallback(_component_up_transition, "765b5ece", {
                show: () => {
              ...
              const n20 = _createSharedDataComponentWithFallback(_component_up_button, "765b6a8f", {
                type: "primary",
                text: "上滑",
                size: "mini",
              ...
              const n21 = _createSharedDataComponentWithFallback(_component_up_button, "765b6eb2", {
                type: "success",
                text: "下滑",
                size: "mini",
                "custom-style": "margin: 0 4px;",
              ...
              const n22 = _createSharedDataComponentWithFallback(_component_up_button, "765bc44c", {
                type: "warning",
                text: "左滑",
                size: "mini",
                "custom-style": "margin: 0 4px;",
              ...
              const n23 = _createSharedDataComponentWithFallback(_component_up_button, "765bc886", {
                type: "error",
                text: "右滑",
                size: "mini",
                "custom-style": "margin: 0 4px;",
...
const _style_0 = {};
const transition = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0]]]);
export {
