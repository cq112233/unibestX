class CascaderOption extends UTS.UTSType {
    ...
    return {
      ...
      get fields() {
        return {
          ...
          children: { type: UTS.UTSType.withGenerics(Array, [CascaderOption]), optional: true },
...
class CascaderEvent extends UTS.UTSType {
  static get$UTSMetadata$() {
    return {
      kind: 2,
      get fields() {
        return {
          value: { type: "Unknown", optional: false },
          selectedOptions: { type: UTS.UTSType.withGenerics(Array, [CascaderOption]), optional: false },
...
class CascaderClickDisabledEvent extends UTS.UTSType {
  static get$UTSMetadata$() {
    return {
      kind: 2,
      get fields() {
...
class CascaderProps extends UTS.UTSType {
  static get$UTSMetadata$() {
    return {
      kind: 2,
      get fields() {
        return {
          options: { type: UTS.UTSType.withGenerics(Array, [CascaderOption]), optional: true },
...
export {
  CascaderOption as C,
  CascaderClickDisabledEvent as a,
  CascaderEvent as b
};
