  ...
  return _openBlock(), _createBlock($setup["Card"], { title: "父子组件传参 & 具名插槽演示" }, {
    default: _withCtx(() => [
      ...
      _createVNode($setup["ChildDemoBox"], {
        ...
        footer: _withCtx(() => [
          _createElementVNode("view", { class: "wtu-1qcvxlr-b wtu-i6zy5z-c wtu-16203my-s" }, [
            _createElementVNode("text", { class: "wtu-1j9rfuf-u wtu-ntizu3-19" }, "📌 父组件填入的具名 Footer 插槽"),
            _createElementVNode("text", { class: "wtu-1j9rfuf-u wtu-1eoi3xb-1a" }, "双向通信验证成功")
          ])
        ]),
        _: 1
        /* STABLE */
