...
import { p as propsNoticeBar } from "./props.js";
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return $data.show ? (_openBlock(), _createElementBlock(
    "view",
    {
      key: 0,
      class: "up-notice-bar",
    ...
    [
      _ctx.direction === "column" || _ctx.direction === "row" && _ctx.step ? (_openBlock(), _createBlock(_component_up_column_notice, {
        key: 0,
        color: _ctx.color,
      ...
      }, null, 8, ["color", "bgColor", "text", "mode", "step", "icon", "disable-touch", "fontSize", "duration", "onClose", "onClick"])) : (_openBlock(), _createBlock(_component_up_row_notice, {
        key: 1,
        color: _ctx.color,
        bgColor: _ctx.bgColor,
        text: _ctx.text,
