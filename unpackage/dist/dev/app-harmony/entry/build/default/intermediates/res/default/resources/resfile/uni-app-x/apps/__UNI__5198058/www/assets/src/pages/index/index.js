...
const { onBackPress, ref, computed } = globalThis.Vue;
const _sfc_main = /* @__PURE__ */ _defineComponent({
  ...
  setup(__props, _a) {
    ...
    const __returned__ = { themeSwitchVal, themeSwitchVal2, checkboxValue, radioValue, sliderValue, rateValue, isBg, switchBg, goToUiTest, type, title, get AppKu() {
      return AppKu;
    }, get LayoutComponent() {
...
const _style_0 = { "h-100px": { "": { "height": 100 } }, "m-auto": { "": { "marginTop": "auto", "marginRight": "auto", "marginBottom": "auto", "marginLeft": "auto" } }, "mt-10px": { "": { "marginTop": 10 } }, "mt-15px": { "": { "marginTop": 15 } }, "mt-20px": { "": { "marginTop": 20 } }, "mx-30px": { "": { "marginLeft": 30, "marginRight": 30 } }, "mx-auto": { "": { "marginLeft": "auto", "marginRight": "auto" } }, "px-20px": { "": { "paddingLeft": 20, "paddingRight": 20 } }, "px-30px": { "": { "paddingLeft": 30, "paddingRight": 30 } }, "py-15px": { "": { "paddingTop": 15, "paddingBottom": 15 } }, "rounded-12px": { "": { "borderTopLeftRadius": 12, "borderTopRightRadius": 12, "borderBottomRightRadius": 12, "borderBottomLeftRadius": 12 } }, "rounded-20px": { "": { "borderTopLeftRadius": 20, "borderTopRightRadius": 20, "borderBottomRightRadius": 20, "borderBottomLeftRadius": 20 } }, "text-__d14328_": { "": { "color": "#d14328" } }, "text-14px": { "": { "fontSize": 14 } }, "text-16px": { "": { "fontSize": 16 } }, "text-25px": { "": { "fontSize": 25 } }, "text-32px": { "": { "fontSize": 32 } }, "text-center": { "": { "textAlign": "center" } }, "w-100px": { "": { "width": 100 } } };
        ...
        default: _withCtx(() => [
          _createElementVNode("view", null, [
            ...
            _createElementVNode("view", { class: "content-container" }, [
              ...
              _createElementVNode("text", { class: "text-32px text-bold mx-auto mt-10px text-__d14328_" }, " unibestX "),
              _createElementVNode("text", { class: "text-center text-25px mt-10px" }, " 最好用的 uni-appX 开发模板 "),
              _createElementVNode("text", { class: "mt-10px m-auto px-30px text-justify text-16px text-bold" }, " 　　unibestX 是一个集成了多种工具与技术的 uni-appX 开发模板，由 uni-appX + Vue3 + Ts + UnoCss + VSCode 构建，模板具有代码提示、自动格式化、统一配置、代码片段等功能，并内置了许多常用的基本组件和基本功能，让你编写 uni-appX 拥有 best 体验。 "),
