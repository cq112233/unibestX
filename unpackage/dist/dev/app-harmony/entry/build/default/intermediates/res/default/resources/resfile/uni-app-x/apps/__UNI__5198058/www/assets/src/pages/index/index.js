        ...
        default: _withCtx(() => [
          _createElementVNode("view", null, [
            ...
            _createElementVNode("view", { class: "content-container" }, [
              ...
              _createElementVNode("text", { class: "mt-10px m-auto px-30px text-justify text-16px text-bold" }, " 　　unibestX 是一个集成了多种工具与技术的 uni-appX 开发模板，由 uni-appX + Vue3 + Ts + UnoCss + VSCode 构建，模板具有代码提示、自动格式化、统一配置、代码片段等功能，并内置了 ECharts 图表、主题配置、加密方式配置等常用功能与基本组件，让你编写 uni-appX 拥有 best 体验。 "),
