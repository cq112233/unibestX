        ...
        default: _withCtx(() => [
          _createElementVNode("view", null, [
            ...
            _createElementVNode("view", { class: "content-container" }, [
              ...
              _createElementVNode("text", { class: "wtu-1ni8q32-7 wtu-jfopje-b wtu-f2chv7-c wtu-154bqnl-d wtu-1tftg3e-e wtu-oogtoa-6" }, " 　　unibestX 是一个集成了多种工具与技术的 uni-appX 开发模板，由 uni-appX + Vue3 + Ts + weapp-tailwindcss + VSCode 构建，模板具有代码提示、自动格式化、统一配置、代码片段等功能，并内置了 ECharts 图表、主题配置、加密方式配置等常用功能与基本组件，让你编写 uni-appX 拥有 best 体验。 "),
              _createElementVNode("view", {
                class: "wtu-1wmf5qf-f wtu-1059bec-g wtu-6ezqn4-h wtu-byz6wt-i wtu-ejnzxm-j",
                style: { "background-color": "rgba(55, 194, 188, 0.08)" }
              }, [
                _createElementVNode("text", {
                  class: "wtu-k8abjg-k wtu-oogtoa-6",
                  style: { "color": "#0f8f8a" }
