import { g as getPx, u as upGetRect, b as addStyle } from "../../libs/function/index.js";
...
const _sfc_main = /* @__PURE__ */ _defineComponent({
  ...
  setup(__props, _a) {
    ...
    const __returned__ = { props, emit, instance, startX, status, newValue, distanceX, startValue0, startValue, barStyle0, barStyle, sliderRect, innerStyleCpu, blockStyleCpu, gapStyleCpu, format, updateValue, init, changingHandler, changeHandler, onTouchStart, onTouchMove, onTouchEnd, onTouchStart2, onTouchMove2, onTouchEnd2, onClick, get addStyle() {
      return addStyle;
    }, get getPx() {
      return getPx;
    } };
  ...
  return _openBlock(), _createElementBlock(
    ...
    [
      !$props.useNative || $props.isRange ? (_openBlock(), _createElementBlock(
            ...
            [
              ...
              $props.isRange ? (_openBlock(), _createElementBlock(
                "view",
                {
                  ...
                  style: _normalizeStyle({
                    width: $setup.barStyle0.width,
                    transition: $setup.barStyle0.transition,
                    height: $props.height,
              ...
              $props.isRange && $props.showValue ? (_openBlock(), _createElementBlock(
                "text",
                {
                  ...
                  style: _normalizeStyle({ left: parseFloat($setup.getPx($setup.barStyle0.width)) + parseFloat($setup.getPx($props.blockSize)) / 2 + "px" })
                },
              ...
              $props.isRange && $props.showValue ? (_openBlock(), _createElementBlock(
                "text",
                {
                  key: 2,
                  class: "up-slider__show-range-value",
                  style: _normalizeStyle({ left: parseFloat($setup.getPx($setup.barStyle.width)) + parseFloat($setup.getPx($props.blockSize)) / 2 + "px" })
                },
              ...
              $props.isRange ? (_openBlock(), _createElementBlock(
                "view",
                {
                  ...
                  style: _normalizeStyle({ left: (parseFloat($setup.getPx($setup.barStyle0.width)) + parseFloat($setup.getPx($props.blockSize)) / 2).toString() + "px" })
                },
                [
        ...
        backgroundColor: $props.inactiveColor,
        blockSize: parseFloat($setup.getPx($props.blockSize)),
