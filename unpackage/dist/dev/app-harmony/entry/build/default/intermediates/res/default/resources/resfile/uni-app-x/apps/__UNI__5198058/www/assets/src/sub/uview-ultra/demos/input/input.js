...
const _sfc_main = /* @__PURE__ */ _defineComponent({
  ...
  setup(__props, _a) {
    ...
    const __returned__ = { inputValue, get AppKu() {
      return AppKu;
    }, get LayoutComponent() {
          ...
          _createElementVNode("view", { class: "page-container bg-__f8fafc_ min-h-screen pb-30px" }, [
            ...
            _createElementVNode("view", { class: "p-16px" }, [
              ...
              _createElementVNode("view", { class: "demo-block mt-12px" }, [
                _createElementVNode("text", { class: "demo-label" }, "带前后台图标"),
                _createVNode(_component_up_input, {
                  placeholder: "请输入搜索内容",
                  "prefix-icon": "search",
                  "suffix-icon": "scan"
...
const input = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["styles", [_style_0, _style_1]], ["__file", "/Users/chenqi/Documents/chenqi-front/unibestX/src/sub/uview-ultra/demos/input/input.uvue"]]);
export {
  input as default
};
