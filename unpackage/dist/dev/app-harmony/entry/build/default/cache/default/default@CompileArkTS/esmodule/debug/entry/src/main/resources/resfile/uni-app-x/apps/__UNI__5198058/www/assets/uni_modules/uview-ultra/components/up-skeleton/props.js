...
import { d as defProps } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/components/up-skeleton/skeleton&";
let skProp = defProps["skeleton"];
const propsSkeleton = {
  props: {
    // 是否展示骨架组件
    loading: {
