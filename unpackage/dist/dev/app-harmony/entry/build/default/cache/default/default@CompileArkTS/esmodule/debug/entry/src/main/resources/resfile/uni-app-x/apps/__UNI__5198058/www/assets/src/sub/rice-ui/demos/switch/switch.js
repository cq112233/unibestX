...
import { _ as __easycom_2 } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/rice-ui/components/rice-switch/rice-switch&";
...
const __className = "GenSrcSubRiceUiDemosSwitchSwitch";
...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  __hash: "0731142f",
  __className,
  __filename: "src/sub/rice-ui/demos/switch/switch.uvue",
  __name: "switch",
  setup(__props) {
    const __sharedDataRenderer = _useSharedDataRenderer();
    const __sharedData = __sharedDataRenderer == "component" ? _withSharedDataComponent(new UniDynamicSharedDataComponent(_useSharedDataScope(), _useSharedDataComponentOptions({ bundleKey: "GenSrcSubRiceUiDemosSwitchSwitchSharedData", sharedDataClassId: 0 }))) : _withSharedDataPage(new UniDynamicSharedDataPage(_useSharedDataPageId(), _useSharedDataPageOptions({ bundleKey: "GenSrcSubRiceUiDemosSwitchSwitchSharedData", sharedDataClassId: 0 })));
    ...
    return () => {
      ...
      const n24 = _createSharedDataComponent(_sfc_main$1, "7425cfe4", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "10942b02", {
            title: "Switch 开关",
            "auto-back": true,
          ...
          const n3 = _createSharedDataComponentWithFallback(_component_rice_switch, "01f1516c", {
            modelValue: () => {
              return _unref(switchVal1);
            },
            "onUpdate:modelValue": () => {
              return (_value) => {
                return _isRef(switchVal1) ? switchVal1.value = _value : null;
              };
            },
            "active-color": () => {
          ...
          const n8 = _createSharedDataComponentWithFallback(_component_rice_switch, "01f133d4", {
            modelValue: () => {
              return _unref(switchVal2);
            },
            "onUpdate:modelValue": () => {
              return (_value) => {
                return _isRef(switchVal2) ? switchVal2.value = _value : null;
              };
            },
            "active-color": () => {
              return currentTheme.value;
          ...
          const n11 = _createSharedDataComponentWithFallback(_component_rice_switch, "3c3bd0c4", {
            modelValue: () => {
              return _unref(switchVal3);
            },
            "onUpdate:modelValue": () => {
              return (_value) => {
                return _isRef(switchVal3) ? switchVal3.value = _value : null;
              };
            },
            size: "20px",
            "active-color": () => {
          ...
          const n16 = _createSharedDataComponentWithFallback(_component_rice_switch, "3c3bb2f4", {
            "model-value": true,
            disabled: true,
            "active-color": () => {
              return currentTheme.value;
          ...
          const n19 = _createSharedDataComponentWithFallback(_component_rice_switch, "3c3b9e22", {
            "model-value": true,
            loading: true,
            "active-color": () => {
              return currentTheme.value;
