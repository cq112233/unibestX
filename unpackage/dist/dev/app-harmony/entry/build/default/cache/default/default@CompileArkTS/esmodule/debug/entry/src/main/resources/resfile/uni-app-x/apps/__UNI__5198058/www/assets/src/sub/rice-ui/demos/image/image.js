...
import { _ as __easycom_1 } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/rice-ui/components/rice-image/rice-image&";
...
const __className = "GenSrcSubRiceUiDemosImageImage";
const { computed } = globalThis.Vue;
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  __dynamicSharedData: true,
  __hash: "26f4e598",
  __className,
  __filename: "src/sub/rice-ui/demos/image/image.uvue",
  __name: "image",
  setup(__props) {
    const __sharedDataRenderer = _useSharedDataRenderer();
    const __sharedData = __sharedDataRenderer == "component" ? _withSharedDataComponent(new UniDynamicSharedDataComponent(_useSharedDataScope(), _useSharedDataComponentOptions({ bundleKey: "GenSrcSubRiceUiDemosImageImageSharedData", sharedDataClassId: 0 }))) : _withSharedDataPage(new UniDynamicSharedDataPage(_useSharedDataPageId(), _useSharedDataPageOptions({ bundleKey: "GenSrcSubRiceUiDemosImageImageSharedData", sharedDataClassId: 0 })));
    ...
    return () => {
      ...
      const _component_rice_image = __easycom_1;
      const n28 = _createSharedDataComponent(_sfc_main$1, "6cceb2f4", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "697c2b07", {
            title: "Image 图片",
            "auto-back": true,
          ...
          const n2 = _createSharedDataComponentWithFallback(_component_rice_image, "73edb224", {
            src: "/static/logo.png",
            width: "80px",
            height: "80px"
          });
          ...
          const n6 = _createSharedDataComponentWithFallback(_component_rice_image, "73ed9a30", {
            src: "/static/logo.png",
            width: "70px",
            height: "70px",
            radius: "12px"
          ...
          const n9 = _createSharedDataComponentWithFallback(_component_rice_image, "09cb559c", {
            src: "/static/logo.png",
            width: "70px",
            height: "70px",
            round: true
          ...
          const n15 = _createSharedDataComponentWithFallback(_component_rice_image, "09cb35b0", {
            src: "/static/logo.png",
            width: "70px",
            height: "70px",
            mode: "scaleToFill",
          ...
          _setSharedData(__sharedData, 5, n15?.sharedData);
          const n18 = _createSharedDataComponentWithFallback(_component_rice_image, "09cb205e", {
            src: "/static/logo.png",
            width: "70px",
            height: "70px",
            mode: "aspectFit",
          ...
          const n21 = _createSharedDataComponentWithFallback(_component_rice_image, "09cb1054", {
            src: "/static/logo.png",
            width: "70px",
            height: "70px",
            mode: "aspectFill",
          ...
          _setSharedData(__sharedData, 7, n21?.sharedData);
        })
      });
...
const _style_0 = {};
const _style_1 = {};
const image = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0, _style_1]]]);
export {
  image as default
};
