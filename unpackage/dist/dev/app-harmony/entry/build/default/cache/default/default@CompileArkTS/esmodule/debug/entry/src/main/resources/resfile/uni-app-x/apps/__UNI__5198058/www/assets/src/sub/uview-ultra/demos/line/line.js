...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n21 = _createSharedDataComponent(_sfc_main$1, "aaed78ee", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n20 = _createSharedDataComponent(_sfc_main$2, "b2c1a4e6", {
            "navigation-style": "custom",
            "navigation-bar-title-text": "up-line 线条"
          }, {
            "default": _withSharedDataVaporCtx(() => {
              const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "2d4684a4", {
                title: "Line 线条",
                "auto-back": true
              });
              _setSharedData(__sharedData, 2, n0?.sharedData);
              const n2 = _createSharedDataComponentWithFallback(_component_up_line, "2d468ba6", {
                color: "#2979ff",
                length: "100%"
              });
              _setSharedData(__sharedData, 3, n2?.sharedData);
              const n5 = _createSharedDataComponentWithFallback(_component_up_line, "2d469007", {
                color: "#2979ff",
                length: "100%",
                dashed: ""
              });
              _setSharedData(__sharedData, 4, n5?.sharedData);
              const n8 = _createSharedDataComponentWithFallback(_component_up_line, "2d469727", {
                color: "#fa3534",
                length: "50%"
              });
              _setSharedData(__sharedData, 5, n8?.sharedData);
              const n10 = _createSharedDataComponentWithFallback(_component_up_line, "2d469acd", {
                color: "#19be6b",
                length: "80%"
              });
              _setSharedData(__sharedData, 6, n10?.sharedData);
              const n14 = _createSharedDataComponentWithFallback(_component_up_line, "2d46a2c7", {
                color: "#909399",
                direction: "col",
                length: "20px",
                margin: "0 10px"
          ...
          _setSharedData(__sharedData, 1, n20.sharedData);
        })
      });
