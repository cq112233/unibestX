...
import { Colour, CurrentColor, Length, Unit } from "@normalized:N&&&@ohos/svg/src/main/ets/components/utils/SVGBase&2.2.2";
import type { SvgPaint } from "@normalized:N&&&@ohos/svg/src/main/ets/components/utils/SVGBase&2.2.2";
