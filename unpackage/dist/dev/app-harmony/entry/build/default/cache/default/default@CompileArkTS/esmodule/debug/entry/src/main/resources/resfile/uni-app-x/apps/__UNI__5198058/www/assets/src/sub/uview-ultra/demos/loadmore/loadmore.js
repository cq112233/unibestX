...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n18 = _createSharedDataComponent(_sfc_main$1, "1fb86cd2", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "14556a16", {
            title: "Loadmore 加载更多",
            "auto-back": true
          });
          _setSharedData(__sharedData, 1, n0?.sharedData);
          const n2 = _createSharedDataComponentWithFallback(_component_up_loadmore, "7657c296", { status: "loadmore" });
          _setSharedData(__sharedData, 2, n2?.sharedData);
          const n5 = _createSharedDataComponentWithFallback(_component_up_loadmore, "7657c6f4", {
            status: "loading",
            "loading-text": "正在奋力加载中..."
          });
          _setSharedData(__sharedData, 3, n5?.sharedData);
          const n8 = _createSharedDataComponentWithFallback(_component_up_loadmore, "7657ce37", {
            status: "nomore",
            "nomore-text": "我是有底线的"
          });
          _setSharedData(__sharedData, 4, n8?.sharedData);
          const n11 = _createSharedDataComponentWithFallback(_component_up_loadmore, "7657d55e", {
            status: "nomore",
            line: true
          });
          _setSharedData(__sharedData, 5, n11?.sharedData);
          const n14 = _createSharedDataComponentWithFallback(_component_up_loadmore, "7657dc81", {
            status: "loading",
