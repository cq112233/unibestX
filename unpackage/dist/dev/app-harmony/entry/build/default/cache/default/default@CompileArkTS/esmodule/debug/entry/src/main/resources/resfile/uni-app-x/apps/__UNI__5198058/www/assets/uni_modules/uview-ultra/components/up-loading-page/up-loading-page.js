...
const { useSharedDataComponentOptions: _useSharedDataComponentOptions, useSharedDataScope: _useSharedDataScope, withSharedDataComponent: _withSharedDataComponent, resolveComponent: _resolveComponent, setSharedData: _setSharedData, toSharedDataBoolean: _toSharedDataBoolean, unref: _unref, setSharedDataAttr: _setSharedDataAttr, toSharedDataString: _toSharedDataString, setSharedDataStyle: _setSharedDataStyle, renderSharedDataEffect: _renderSharedDataEffect, createSharedDataComponentWithFallback: _createSharedDataComponentWithFallback, createSharedDataIf: _createSharedDataIf, toDisplayString: _toDisplayString, createSharedDataSlot: _createSharedDataSlot, withSharedDataVaporCtx: _withSharedDataVaporCtx } = globalThis.Vue;
          ...
          "default": _withSharedDataVaporCtx(() => {
            _createSharedDataIf(() => {
              ...
              _renderSharedDataEffect(() => {
                ...
                const _iconSize = __props.iconSize;
                _setSharedDataAttr(__sharedData, 4, _toSharedDataString(__props.image));
                _setSharedDataStyle(__sharedData, 5, {
                  width: _addUnit(_iconSize),
                  height: _addUnit(_iconSize)
                });
              });
            }, () => {
              const n4 = _createSharedDataComponentWithFallback(_component_up_loading_icon, "7e37ebbc", {
                mode: () => {
                  return __props.loadingMode;
                },
                size: () => {
                  return _unref(addUnit)(__props.iconSize);
                },
                color: () => {
