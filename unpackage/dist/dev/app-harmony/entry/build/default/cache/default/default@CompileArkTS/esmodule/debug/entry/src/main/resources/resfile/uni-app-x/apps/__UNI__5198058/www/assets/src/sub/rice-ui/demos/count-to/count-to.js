...
import { _ as __easycom_1 } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/rice-ui/components/rice-count-to/rice-count-to&";
...
const __className = "GenSrcSubRiceUiDemosCountToCountTo";
const { computed } = globalThis.Vue;
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  __dynamicSharedData: true,
  __hash: "595ec982",
  __className,
  __filename: "src/sub/rice-ui/demos/count-to/count-to.uvue",
  __name: "count-to",
  setup(__props) {
    const __sharedDataRenderer = _useSharedDataRenderer();
    const __sharedData = __sharedDataRenderer == "component" ? _withSharedDataComponent(new UniDynamicSharedDataComponent(_useSharedDataScope(), _useSharedDataComponentOptions({ bundleKey: "GenSrcSubRiceUiDemosCountToCountToSharedData", sharedDataClassId: 0 }))) : _withSharedDataPage(new UniDynamicSharedDataPage(_useSharedDataPageId(), _useSharedDataPageOptions({ bundleKey: "GenSrcSubRiceUiDemosCountToCountToSharedData", sharedDataClassId: 0 })));
    ...
    return () => {
      ...
      const _component_rice_count_to = __easycom_1;
      const n11 = _createSharedDataComponent(_sfc_main$1, "4919abe6", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "4bc85cb2", {
            title: "CountTo 数字滚动",
            "auto-back": true,
          ...
          const n2 = _createSharedDataComponentWithFallback(_component_rice_count_to, "695e542f", {
            "start-val": 0,
            "end-val": 12345,
            "font-size": "32px",
            color: () => {
          ...
          const n6 = _createSharedDataComponentWithFallback(_component_rice_count_to, "695e5fee", {
            "start-val": 0,
            "end-val": 3688.88,
            decimals: 2,
            duration: 2500,
...
const _style_0 = {};
const _style_1 = {};
const countTo = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0, _style_1]]]);
export {
  countTo as default
};
