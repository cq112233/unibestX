...
import { _ as __easycom_0$2 } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/components/up-safe-bottom/up-safe-bottom&";
...
import { d as deepMerge, a as addUnit, b as addStyle } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/libs/function/index&";
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return _openBlock(), _createElementBlock(
    "view",
    {
      class: _normalizeClass(["up-popup", [_ctx.customClass]])
    },
    [
      _ctx.overlay && !_ctx.pageInline ? (_openBlock(), _createBlock(_component_up_overlay, {
        key: 0,
      ...
      }, null, 8, ["show", "onClick", "zIndex", "duration", "customStyle", "opacity"])) : _createCommentVNode("v-if", true),
        ...
        default: _withCtx(() => [
          _createElementVNode(
            "view",
            {
              ...
              onClick: _cache[1] || (_cache[1] = _withModifiers((...args) => _ctx.noop && _ctx.noop(...args), ["stop"]))
            },
            [
              ...
              _ctx.closeable ? (_openBlock(), _createElementBlock(
                "view",
                {
                  ...
                  class: _normalizeClass(["up-popup__content__close", ["up-popup__content__close--" + _ctx.closeIconPos]]),
              ...
              _ctx.safeAreaInsetBottom ? (_openBlock(), _createBlock(_component_up_safe_bottom, { key: 2 })) : _createCommentVNode("v-if", true)
            ],
            4
            /* STYLE */
          )
