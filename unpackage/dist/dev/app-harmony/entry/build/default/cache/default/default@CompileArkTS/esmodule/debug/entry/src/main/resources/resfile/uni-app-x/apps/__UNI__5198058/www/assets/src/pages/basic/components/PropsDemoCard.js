...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock(), _createBlock($setup["Card"], { title: "父子组件传参 & 具名插槽演示" }, {
    default: _withCtx(() => [
      _createElementVNode("view", { class: "bg-__eff6ff_ rounded-12px p-14px mb-14px border-width-1px border-style-solid border-color-__bfdbfe_" }, [
        _createElementVNode("text", { class: "text-14px font-bold text-__1e40af_ mb-6px" }, "👨‍👩‍👧 父组件状态管理面板"),
        _createElementVNode("view", { class: "flex-row items-center mb-4px" }, [
          _createElementVNode("text", { class: "text-12px text-__3b82f6_" }, "父组件 Count 变量: "),
          _createElementVNode(
            "text",
        ...
        _createElementVNode("view", { class: "flex-row items-center mb-10px" }, [
          _createElementVNode("text", { class: "text-12px text-__3b82f6_" }, "接收到的子组件消息: "),
          _createElementVNode(
            "text",
        ...
        _createElementVNode("view", { class: "flex-row items-center" }, [
          _createElementVNode("view", {
            ...
            _createElementVNode("text", { class: "text-white text-12px" }, "父组件直接 Count + 5")
          ]),
          _createElementVNode("view", {
            class: "bg-__64748b_ rounded-6px px-10px h-30px flex-row items-center justify-center",
            onClick: $setup.resetParent
          }, [
            _createElementVNode("text", { class: "text-white text-12px" }, "父组件重置状态")
          ])
        ])
      ]),
      _createVNode($setup["ChildDemoBox"], {
        ...
        header: _withCtx(() => [
          _createElementVNode("view", { class: "flex-row items-center justify-between" }, [
            _createElementVNode("text", { class: "text-14px font-bold text-__1e293b_" }, "🏷️ 父组件填入的具名 Header 插槽"),
            _createElementVNode("text", { class: "text-11px text-__3b82f6_ bg-__dbeafe_ px-6px py-2px rounded-4px" }, "自定义 Header")
          ])
        ]),
        itemSlot: _withCtx(({ item, index }) => [
          _createElementVNode("view", { class: "flex-row items-center bg-__f0fdf4_ rounded-6px p-8px border-width-1px border-style-solid border-color-__bbf7d0_" }, [
            _createElementVNode(
              "text",
        ...
        footer: _withCtx(() => [
          _createElementVNode("view", { class: "flex-row items-center justify-between" }, [
            _createElementVNode("text", { class: "text-11px text-__64748b_" }, "📌 父组件填入的具名 Footer 插槽"),
            _createElementVNode("text", { class: "text-11px text-__10b981_" }, "双向通信验证成功")
          ])
        ]),
        _: 1
        /* STABLE */
