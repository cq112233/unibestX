...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n11 = _createSharedDataComponent(_sfc_main$1, "282c037e", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n10 = _createSharedDataComponent(_sfc_main$2, "dd546c56", {
            "navigation-style": "custom",
            "navigation-bar-title-text": "up-loading-icon 加载图标"
          }, {
            "default": _withSharedDataVaporCtx(() => {
              const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "cd391d0a", {
                title: "LoadingIcon 加载图标",
                "auto-back": true
              });
              _setSharedData(__sharedData, 2, n0?.sharedData);
              const n2 = _createSharedDataComponentWithFallback(_component_up_loading_icon, "cd390ef4", { class: "my-10px" });
              _setSharedData(__sharedData, 3, n2?.sharedData);
              const n5 = _createSharedDataComponentWithFallback(_component_up_loading_icon, "cd3900f8", {
                mode: "circle",
                class: "my-10px"
              });
              _setSharedData(__sharedData, 4, n5?.sharedData);
              const n6 = _createSharedDataComponentWithFallback(_component_up_loading_icon, "cd38ff3e", {
                mode: "semicircle",
                class: "my-10px"
              });
