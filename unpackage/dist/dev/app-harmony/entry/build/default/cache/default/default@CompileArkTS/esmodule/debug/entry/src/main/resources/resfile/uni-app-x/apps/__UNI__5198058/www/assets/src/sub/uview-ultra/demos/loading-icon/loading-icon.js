...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n11 = _createSharedDataComponent(AppKu, "282c037e", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n10 = _createSharedDataComponent(LayoutComponent, "dd546c56", {
            "navigation-style": "custom",
            "navigation-bar-title-text": "up-loading-icon 加载图标"
          }, {
            "default": _withSharedDataVaporCtx(() => {
              const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "cd391cd2", {
                title: "LoadingIcon 加载图标",
                "auto-back": true
              });
              _setSharedData(__sharedData, 2, n0?.sharedData);
              const n2 = _createSharedDataComponentWithFallback(_component_up_loading_icon, "cd390e8a", { class: "my-_b10px_B" });
              _setSharedData(__sharedData, 3, n2?.sharedData);
              const n5 = _createSharedDataComponentWithFallback(_component_up_loading_icon, "cd3900b0", {
                mode: "circle",
                class: "my-_b10px_B"
              });
              _setSharedData(__sharedData, 4, n5?.sharedData);
              const n6 = _createSharedDataComponentWithFallback(_component_up_loading_icon, "cd38fec4", {
                mode: "semicircle",
                class: "my-_b10px_B"
              });
...
const _style_0 = {"my-_b10px_B":{"":{"marginBlock":10}}};
const loadingIcon = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0]]]);
export {
