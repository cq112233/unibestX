...
import { _ as __easycom_2 } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/components/up-datetime-picker/up-datetime-picker&";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, _a) {
    ...
    function onDatetimeConfirm(e) {
      uni.__f__("log", "at src/sub/uview-ultra/demos/datetime-picker/datetime-picker.uvue:27", "datetime confirm", e);
      datetimeShow.value = false;
    }
    const __returned__ = { datetimeShow, onDatetimeConfirm, get AppKu() {
      return AppKu;
    }, get LayoutComponent() {
...
const _style_0 = { "bg-__f8fafc_": { "": { "backgroundImage": "none", "backgroundColor": "#f8fafc" } }, "flex-row": { "": { "flexDirection": "row" } }, "items-center": { "": { "alignItems": "center" } }, "p-16px": { "": { "paddingTop": 16, "paddingRight": 16, "paddingBottom": 16, "paddingLeft": 16 } }, "pb-30px": { "": { "paddingBottom": 30 } } };
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  const _component_up_datetime_picker = resolveEasycom(resolveDynamicComponent("up-datetime-picker"), __easycom_2);
              ...
              createElementVNode("view", { class: "demo-block" }, [
                ...
                createElementVNode("view", { class: "flex-row items-center" }, [
                  createVNode(_component_up_button, {
                    ...
                    text: "选择时间",
                    size: "mini",
                    onClick: _cache[0] || (_cache[0] = ($event) => $setup.datetimeShow = true)
                  })
                ])
              ])
            ]),
            createVNode(_component_up_datetime_picker, {
              show: $setup.datetimeShow,
              mode: "datetime",
              onConfirm: $setup.onDatetimeConfirm,
              onCancel: _cache[1] || (_cache[1] = ($event) => $setup.datetimeShow = false)
            }, null, 8, ["show"])
          ])
        ]),
        _: 1
