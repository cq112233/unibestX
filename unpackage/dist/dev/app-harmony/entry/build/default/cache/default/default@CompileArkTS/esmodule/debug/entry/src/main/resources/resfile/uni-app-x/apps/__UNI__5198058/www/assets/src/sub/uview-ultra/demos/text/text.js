...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n15 = _createSharedDataComponent(_sfc_main$1, "317f74fb", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "0321a99c", {
            title: "Text 文本",
            "auto-back": true
          });
          _setSharedData(__sharedData, 1, n0?.sharedData);
          const n2 = _createSharedDataComponentWithFallback(_component_up_text, "6113b642", {
            text: "主色文本",
            type: "primary",
            class: "mb-10px"
          });
          _setSharedData(__sharedData, 2, n2?.sharedData);
          const n3 = _createSharedDataComponentWithFallback(_component_up_text, "6113af78", {
            text: "成功文本",
            type: "success",
            class: "mb-10px"
          });
          _setSharedData(__sharedData, 3, n3?.sharedData);
          const n4 = _createSharedDataComponentWithFallback(_component_up_text, "6113ad9a", {
            text: "警告文本",
            type: "warning",
            class: "mb-10px"
          });
          _setSharedData(__sharedData, 4, n4?.sharedData);
          const n5 = _createSharedDataComponentWithFallback(_component_up_text, "6113a6d0", {
            text: "错误文本",
            type: "error",
            class: "mb-10px"
          });
          _setSharedData(__sharedData, 5, n5?.sharedData);
          const n6 = _createSharedDataComponentWithFallback(_component_up_text, "6113a00a", {
            text: "常规文本",
            type: "info"
          });
          _setSharedData(__sharedData, 6, n6?.sharedData);
          const n9 = _createSharedDataComponentWithFallback(_component_up_text, "61139788", {
            text: "13888888888",
            mode: "phone",
            format: "encrypt",
            class: "mb-10px"
          ...
          const n10 = _createSharedDataComponentWithFallback(_component_up_text, "6113903e", {
            text: "张三疯",
            mode: "name",
            format: "encrypt",
            class: "mb-10px"
          ...
          const n11 = _createSharedDataComponentWithFallback(_component_up_text, "61138906", {
