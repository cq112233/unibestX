    ...
    return () => {
      ...
      const n16 = _createSharedDataComponent(_sfc_main$1, "317f74fb", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n15 = _createSharedDataComponent(_sfc_main$2, "0321ab4a", {
            "navigation-style": "custom",
            "navigation-bar-title-text": "up-text 文本"
          }, {
            "default": _withSharedDataVaporCtx(() => {
              const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "6113bcd4", {
                title: "Text 文本",
                "auto-back": true
              });
              _setSharedData(__sharedData, 2, n0?.sharedData);
              const n2 = _createSharedDataComponentWithFallback(_component_up_text, "6113aed0", {
                text: "主色文本",
                type: "primary",
                class: "mb-10px"
              });
              _setSharedData(__sharedData, 3, n2?.sharedData);
              const n3 = _createSharedDataComponentWithFallback(_component_up_text, "6113a806", {
                text: "成功文本",
                type: "success",
                class: "mb-10px"
              });
              _setSharedData(__sharedData, 4, n3?.sharedData);
              const n4 = _createSharedDataComponentWithFallback(_component_up_text, "6113a652", {
                text: "警告文本",
                type: "warning",
                class: "mb-10px"
              });
              _setSharedData(__sharedData, 5, n4?.sharedData);
              const n5 = _createSharedDataComponentWithFallback(_component_up_text, "61139f88", {
                text: "错误文本",
                type: "error",
                class: "mb-10px"
              });
              _setSharedData(__sharedData, 6, n5?.sharedData);
              const n6 = _createSharedDataComponentWithFallback(_component_up_text, "611398c2", {
                text: "常规文本",
                type: "info"
              });
              _setSharedData(__sharedData, 7, n6?.sharedData);
              const n9 = _createSharedDataComponentWithFallback(_component_up_text, "61139040", {
                text: "13888888888",
                mode: "phone",
                format: "encrypt",
                class: "mb-10px"
              ...
              const n10 = _createSharedDataComponentWithFallback(_component_up_text, "611388f6", {
                text: "张三疯",
                mode: "name",
                format: "encrypt",
                class: "mb-10px"
              ...
              const n11 = _createSharedDataComponentWithFallback(_component_up_text, "611381be", {
...
const _style_0 = {};
const _style_1 = {};
const text = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0, _style_1]]]);
export {
  text as default
};
