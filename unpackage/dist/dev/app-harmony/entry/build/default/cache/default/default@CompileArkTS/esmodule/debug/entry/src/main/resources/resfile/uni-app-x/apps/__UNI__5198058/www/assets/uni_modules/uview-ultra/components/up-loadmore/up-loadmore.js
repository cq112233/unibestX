  ...
  setup(__props, _a) {
    ...
    return () => {
      ...
      _renderSharedDataEffect(() => {
        ...
        _setSharedDataStyle(__sharedData, 7, [
          _unref(addStyle)(__props.customStyle),
          {
            ...
            marginBottom: _addUnit(__props.marginBottom),
            marginTop: _addUnit(__props.marginTop),
      ...
      _createSharedDataIf(() => {
        ...
        const n2 = _createSharedDataComponentWithFallback(_component_up_line, "657f6e5a", {
          length: "140rpx",
          color: () => {
      ...
      _createSharedDataIf(() => {
        ...
        const n5 = _createSharedDataComponentWithFallback(_component_up_loading_icon, "657f7a41", {
          color: () => {
      ...
      _createSharedDataIf(() => {
        ...
        const n11 = _createSharedDataComponentWithFallback(_component_up_line, "657f891e", {
          length: "140rpx",
          color: () => {
            return __props.lineColor;
          },
