...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n22 = _createSharedDataComponent(_sfc_main$1, "2bd82232", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "5869eee4", {
          ...
          const n1 = _createSharedDataFor(_setSharedDataScoped(__sharedData, 4, _createSharedDataVFor(__sharedDataScope, () => {
          ...
          const n20 = _createSharedDataComponentWithFallback(_component_z_paging_x, "9658241c", {
            "model-value": () => {
          ...
          _setSharedData(__sharedData, 2, n20?.sharedData);
