import { i as isObject } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/lime-i18n/common/util&";
...
class BaseFormatter {
  ...
  interpolate(message, values = null) {
    ...
    let tokens = UTS.mapGet(this._caches, message);
    if (tokens == null) {
