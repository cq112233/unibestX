...
import { camelize, hyphenate } from "@normalized:N&&&@dcloudio/uni-runtime-harmony/helper/utils&1.0.0";
import type { UniCustomElement, CustomElementOptions } from './CustomElement';
...
export class NamedNodeMap extends NativeMap<string, ESObject> {
     ...
     * @internal
     */
    attributeChangedCallback(name: string, oldValue: Object | null, newValue: Object | null, camelizeName?: string) {
