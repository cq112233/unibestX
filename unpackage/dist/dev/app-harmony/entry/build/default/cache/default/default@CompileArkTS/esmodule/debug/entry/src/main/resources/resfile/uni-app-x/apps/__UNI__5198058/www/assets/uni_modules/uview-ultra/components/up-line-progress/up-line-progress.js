...
import { h as range, a as addUnit, b as addStyle, s as sleep, u as upGetRect } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/libs/function/index&";
import { d as defProps } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/components/up-line-progress/lineProgress&";
    ...
    [
      _createElementVNode(
        "view",
        {
          ...
          style: _normalizeStyle([$options.backgroundStyle])
        },
        null,
        4
        /* STYLE */
      ...
      _createElementVNode(
        ...
        [
          _renderSlot(_ctx.$slots, "default", {}, () => [
            $props.showText && $options.percentageValue >= 10 ? (_openBlock(), _createElementBlock(
              "text",
              {
                key: 0,
                class: "up-line-progress__text"
              },
              _toDisplayString($options.innerPercentage + "%"),
              1
              /* TEXT */
