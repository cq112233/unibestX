...
import { MiniCanvasAttribute, CanvasImpl } from "@normalized:N&&&@ohos/svg/src/main/ets/components/utils/mini_canvas&2.2.3";
import type { ICanvas } from "@normalized:N&&&@ohos/svg/src/main/ets/components/utils/mini_canvas&2.2.3";
