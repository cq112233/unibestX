...
import { _ as __easycom_1 } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/components/up-switch/up-switch&";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, _a) {
    ...
    const __returned__ = { switchValue, get AppKu() {
      return AppKu;
    }, get LayoutComponent() {
...
const _style_0 = { "bg-__f8fafc_": { "": { "backgroundImage": "none", "backgroundColor": "#f8fafc" } }, "flex-row": { "": { "flexDirection": "row" } }, "items-center": { "": { "alignItems": "center" } }, "ml-10px": { "": { "marginLeft": 10 } }, "mt-12px": { "": { "marginTop": 12 } }, "p-16px": { "": { "paddingTop": 16, "paddingRight": 16, "paddingBottom": 16, "paddingLeft": 16 } }, "pb-30px": { "": { "paddingBottom": 30 } }, "text-14px": { "": { "fontSize": 14 } } };
              ...
              createElementVNode("view", { class: "demo-block" }, [
                ...
                createElementVNode("view", { class: "flex-row items-center" }, [
                  createVNode(_component_up_switch, {
                    modelValue: $setup.switchValue,
                    "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => $setup.switchValue = $event),
                    "active-color": "#2979ff"
                  }, null, 8, ["modelValue"]),
                  createElementVNode(
                    "text",
                    { class: "text-14px ml-10px" },
                    toDisplayString($setup.switchValue ? "已开启" : "已关闭"),
                    1
                    /* TEXT */
                  )
                ])
