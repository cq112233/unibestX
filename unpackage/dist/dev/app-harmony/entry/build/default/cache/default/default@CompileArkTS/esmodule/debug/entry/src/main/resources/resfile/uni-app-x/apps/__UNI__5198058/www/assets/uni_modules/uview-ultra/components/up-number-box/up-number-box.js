  ...
  return _openBlock(), _createElementBlock("view", { class: "up-number-box" }, [
    $props.showMinus && !$setup.hideMinus && _ctx.$slots["minus"] != null ? (_openBlock(), _createElementBlock(
      "view",
      {
        ...
        onTouchend: _cache[2] || (_cache[2] = _withModifiers((...args) => _ctx.clearTimeout && _ctx.clearTimeout(...args), ["stop"]))
      },
      [
      ...
      "view",
      {
        ...
        onClick: _cache[3] || (_cache[3] = _withModifiers(($event) => $setup.clickHandler("minus"), ["stop"])),
        onTouchstart: _cache[4] || (_cache[4] = ($event) => $setup.onTouchStart("minus")),
        onTouchend: _cache[5] || (_cache[5] = _withModifiers((...args) => _ctx.clearTimeout && _ctx.clearTimeout(...args), ["stop"])),
    ...
    !$setup.hideMinus ? _renderSlot(_ctx.$slots, "input", { key: 2 }, () => [
      _withDirectives(_createElementVNode("input", {
        ...
        "onUpdate:modelValue": _cache[6] || (_cache[6] = ($event) => $setup.currentValue = $event),
        onBlur: $setup.onBlur,
    ...
    $props.showPlus && _ctx.$slots["plus"] != null ? (_openBlock(), _createElementBlock(
      "view",
      {
        ...
        onTouchend: _cache[9] || (_cache[9] = _withModifiers((...args) => _ctx.clearTimeout && _ctx.clearTimeout(...args), ["stop"]))
      },
      [
      ...
      "view",
      {
        ...
        onClick: _cache[10] || (_cache[10] = _withModifiers(($event) => $setup.clickHandler("plus"), ["stop"])),
        onTouchstart: _cache[11] || (_cache[11] = ($event) => $setup.onTouchStart("plus")),
        onTouchend: _cache[12] || (_cache[12] = _withModifiers((...args) => _ctx.clearTimeout && _ctx.clearTimeout(...args), ["stop"])),
