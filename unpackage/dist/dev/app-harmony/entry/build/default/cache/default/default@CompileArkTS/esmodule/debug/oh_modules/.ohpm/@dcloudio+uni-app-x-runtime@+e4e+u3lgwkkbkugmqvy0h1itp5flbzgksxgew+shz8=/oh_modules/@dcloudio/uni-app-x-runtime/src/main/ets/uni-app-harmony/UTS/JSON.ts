import type { UTSJSONObject } from '../uts-polyfill';
import { getType, isPlainObject } from "@normalized:N&&&@dcloudio/uni-app-harmony/UTS/utils/index&1.0.0";
...
const UTSJSON = {
    parse<T = UTSJSONObject>(text: string, reviver?: (this: any, key: string, value: any) => any): T | null {
        try {
