...
import { _ as __easycom_1 } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/rice-ui/components/rice-navbar/rice-navbar&";
...
const __className = "GenSrcSubRiceUiDemosNavbarNavbar";
const { computed } = globalThis.Vue;
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  __dynamicSharedData: true,
  __hash: "694f3b9e",
  __className,
  __filename: "src/sub/rice-ui/demos/navbar/navbar.uvue",
  __name: "navbar",
  setup(__props) {
    const __sharedDataRenderer = _useSharedDataRenderer();
    const __sharedData = __sharedDataRenderer == "component" ? _withSharedDataComponent(new UniDynamicSharedDataComponent(_useSharedDataScope(), _useSharedDataComponentOptions({ bundleKey: "GenSrcSubRiceUiDemosNavbarNavbarSharedData", sharedDataClassId: 0 }))) : _withSharedDataPage(new UniDynamicSharedDataPage(_useSharedDataPageId(), _useSharedDataPageOptions({ bundleKey: "GenSrcSubRiceUiDemosNavbarNavbarSharedData", sharedDataClassId: 0 })));
    ...
    return () => {
      ...
      const _component_rice_navbar = __easycom_1;
      const n17 = _createSharedDataComponent(_sfc_main$1, "2d617ec6", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "7ece5ac7", {
            title: "Navbar 导航栏",
            "auto-back": true,
          ...
          const n2 = _createSharedDataComponentWithFallback(_component_rice_navbar, "5afcefc7", {
            title: "标题",
            "left-arrow": true,
            "left-text": "返回",
            fixed: false
          ...
          const n6 = _createSharedDataComponentWithFallback(_component_rice_navbar, "5afcfe6a", {
            title: "商品详情",
            "left-arrow": true,
            "right-text": "分享",
            fixed: false,
          ...
          const n12 = _createSharedDataComponentWithFallback(_component_rice_navbar, "049fa031", {
            title: "品牌主页",
            "left-arrow": true,
            "arrow-color": "#ffffff",
            "bg-color": () => {
