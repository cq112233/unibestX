...
import { _ as __easycom_1 } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/rice-ui/components/rice-color-picker/rice-color-picker&";
...
import "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/rice-ui/components/rice-slider/rice-slider&";
...
import "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/rice-ui/components/rice-slider/type&";
...
import "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/rice-ui/components/rice-color-picker/type&";
import "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/rice-ui/components/rice-color-picker/utils&";
...
const __className = "GenSrcSubRiceUiDemosColorPickerColorPicker";
...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  __hash: "3d38e083",
  __className,
  __filename: "src/sub/rice-ui/demos/color-picker/color-picker.uvue",
  __name: "color-picker",
  setup(__props) {
    const __sharedDataRenderer = _useSharedDataRenderer();
    const __sharedData = __sharedDataRenderer == "component" ? _withSharedDataComponent(new UniDynamicSharedDataComponent(_useSharedDataScope(), _useSharedDataComponentOptions({ bundleKey: "GenSrcSubRiceUiDemosColorPickerColorPickerSharedData", sharedDataClassId: 0 }))) : _withSharedDataPage(new UniDynamicSharedDataPage(_useSharedDataPageId(), _useSharedDataPageOptions({ bundleKey: "GenSrcSubRiceUiDemosColorPickerColorPickerSharedData", sharedDataClassId: 0 })));
    _useSharedDataScope(__sharedData);
    const appStore = useAppStore();
    const currentTheme = computed(() => {
      return appStore.state.theme;
    });
    const selectedColor = ref(appStore.state.theme);
    ...
    return () => {
      ...
      const _component_rice_color_picker = __easycom_1;
      const n10 = _createSharedDataComponent(_sfc_main$1, "f25d14f4", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "535d3c07", {
          ...
          const n2 = _createSharedDataComponentWithFallback(_component_rice_color_picker, "184a36a4", {
            modelValue: () => {
              return _unref(selectedColor);
            },
            "onUpdate:modelValue": () => {
              return (_value) => {
                return _isRef(selectedColor) ? selectedColor.value = _value : null;
              };
            },
            "show-alpha": true
          });
          ...
          _renderSharedDataEffect(() => {
            const _selectedColor = _unref(selectedColor);
            _setSharedData(__sharedData, 4, _toDisplayString(_selectedColor));
            _setSharedDataStyle(__sharedData, 5, { backgroundColor: _selectedColor });
          });
        })
      });
