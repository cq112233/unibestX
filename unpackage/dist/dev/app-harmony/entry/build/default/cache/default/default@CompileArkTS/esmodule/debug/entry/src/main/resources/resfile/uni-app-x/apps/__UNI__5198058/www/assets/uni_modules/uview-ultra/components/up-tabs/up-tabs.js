...
import { a as addUnit, g as getPx, e as getWindowInfo, u as upGetRect, s as sleep, b as addStyle, d as deepMerge } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/libs/function/index&";
...
const _sfc_main = /* @__PURE__ */ _defineComponent({
  ...
  setup(__props, _a) {
    ...
    const __returned__ = { props, emit, instance, firstTime, scrollLeft, scrollViewWidth, lineOffsetLeft, tabsRect, innerCurrent, retryCount, itemRects, propsBadge, lineStyle, getShowValue, getBadgePropValue, textStyle, isListEqual, setLineLeft, setScrollLeft, clickHandler, longPressHandler, resize, getTabsRect, getAllItemRect, init, get addUnit() {
      return addUnit;
    }, get addStyle() {
      return addStyle;
    } };
                ...
                (_openBlock(true), _createElementBlock(
                  ...
                  _renderList($props.list, (item, index) => {
                    return _openBlock(), _createElementBlock("view", {
                      ...
                      style: _normalizeStyle([$setup.addStyle($props.itemStyle), { flex: $props.scrollable ? "none" : "1" }])
                    }, [
                        ...
                        [
                          item["icon"] != null ? (_openBlock(), _createElementBlock("view", {
                            ...
                            _createVNode(_component_up_icon, {
                              name: item["icon"],
                              customStyle: $setup.addStyle($props.iconStyle)
