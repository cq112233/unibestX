...
import { _ as __easycom_1 } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/rice-ui/components/rice-progress-circle/rice-progress-circle&";
...
import "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/rice-ui/components/rice-progress-circle/type&";
...
const __className = "GenSrcSubRiceUiDemosProgressCircleProgressCircle";
const { computed } = globalThis.Vue;
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  __dynamicSharedData: true,
  __hash: "66b35d10",
  __className,
  __filename: "src/sub/rice-ui/demos/progress-circle/progress-circle.uvue",
  __name: "progress-circle",
  setup(__props) {
    const __sharedDataRenderer = _useSharedDataRenderer();
    const __sharedData = __sharedDataRenderer == "component" ? _withSharedDataComponent(new UniDynamicSharedDataComponent(_useSharedDataScope(), _useSharedDataComponentOptions({ bundleKey: "GenSrcSubRiceUiDemosProgressCircleProgressCircleSharedData", sharedDataClassId: 0 }))) : _withSharedDataPage(new UniDynamicSharedDataPage(_useSharedDataPageId(), _useSharedDataPageOptions({ bundleKey: "GenSrcSubRiceUiDemosProgressCircleProgressCircleSharedData", sharedDataClassId: 0 })));
    ...
    return () => {
      ...
      const _component_rice_progress_circle = __easycom_1;
      const n15 = _createSharedDataComponent(_sfc_main$1, "3a012e20", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "062496ad", {
          ...
          const n2 = _createSharedDataComponentWithFallback(_component_rice_progress_circle, "83239e10", {
            percentage: 65,
            color: () => {
          ...
          const n5 = _createSharedDataComponentWithFallback(_component_rice_progress_circle, "832389b8", {
            percentage: 80,
            color: "#07c160"
          });
          _setSharedData(__sharedData, 3, n5?.sharedData);
          const n8 = _createSharedDataComponentWithFallback(_component_rice_progress_circle, "83237aac", {
            percentage: 100,
            color: "#e6a23c"
          });
...
const _style_0 = {};
const _style_1 = {};
const progressCircle = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0, _style_1]]]);
export {
