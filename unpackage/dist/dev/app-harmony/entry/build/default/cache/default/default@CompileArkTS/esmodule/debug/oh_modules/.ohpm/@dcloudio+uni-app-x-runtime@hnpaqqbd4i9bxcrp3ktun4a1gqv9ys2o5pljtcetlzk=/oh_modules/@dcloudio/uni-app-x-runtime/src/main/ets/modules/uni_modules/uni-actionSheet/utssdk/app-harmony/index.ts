import { UTSObject, UniError, uni, UTS, getCurrentPages } from "@normalized:N&&&@dcloudio/uni-app-framework/index&1.0.0";
import type { IUniError, string, OpenDialogPageOptions, CloseDialogPageOptions } from "@normalized:N&&&@dcloudio/uni-app-framework/index&1.0.0";
...
export { Popover as Popover, ShowActionSheetOptions as ShowActionSheetOptions, ShowActionSheetSuccessImpl as ShowActionSheetSuccessImpl, ShowActionSheetFailImpl as ShowActionSheetFailImpl };
export type { ShowActionSheetErrorCode as ShowActionSheetErrorCode, ShowActionSheetSuccess as ShowActionSheetSuccess, ShowActionSheetFail as ShowActionSheetFail, ShowActionSheetComplete as ShowActionSheetComplete, ShowActionSheet as ShowActionSheet, HideActionSheet as HideActionSheet };
