import ohos_vibrator from '@ohos:vibrator';import { C as Card } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/src/pages/basic/components/Card&";
  ...
  return _openBlock(), _createBlock($setup["Card"], { title: "触感与工具" }, {
    default: _withCtx(() => [
      _createElementVNode("view", { class: "rounded-12px p-16px mb-16px border-width-1px border-style-solid border-color-__e2e8f0_" }, [
        _createElementVNode("text", { class: "text-12px text-__94a3b8_ mb-8px" }, "剪贴板测试文本"),
        ...
        _createElementVNode("view", {
          ...
          _createElementVNode("text", { class: "text-__ffffff_ text-14px font-bold" }, "复制测试文本")
        ])
      ]),
      _createElementVNode("view", {
        ...
        _createElementVNode("text", { class: "text-__ffffff_ text-14px font-bold" }, "短震动反馈")
      ])
    ]),
    _: 1
    /* STABLE */
