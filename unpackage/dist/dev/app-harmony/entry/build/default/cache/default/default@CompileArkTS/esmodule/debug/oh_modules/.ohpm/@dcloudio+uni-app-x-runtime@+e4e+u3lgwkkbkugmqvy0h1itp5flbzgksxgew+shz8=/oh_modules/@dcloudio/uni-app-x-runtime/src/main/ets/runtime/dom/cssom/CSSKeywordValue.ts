import type { CSSKeywordValue as ICSSKeywordValue } from './types';
import { CSSStyleValue } from "@normalized:N&&&@dcloudio/uni-runtime-harmony/dom/cssom/CSSStyleValue&1.0.0";
import { KeywordValues, Property } from "@normalized:N&&&@dcloudio/uni-runtime-harmony/dom/cssom/constants&1.0.0";
