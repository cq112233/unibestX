...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  const _component_up_tag = resolveEasycom(resolveDynamicComponent("up-tag"), __easycom_1);
          ...
          createElementVNode("view", { class: "page-container bg-__f8fafc_ min-h-screen pb-30px" }, [
            ...
            createElementVNode("view", { class: "p-16px" }, [
              ...
              createElementVNode("view", { class: "demo-block mt-12px" }, [
                createElementVNode("text", { class: "demo-label" }, "镂空标签"),
                createElementVNode("view", { class: "flex-row items-center flex-wrap" }, [
                  createVNode(_component_up_tag, {
                    text: "镂空",
                    type: "primary",
              ...
              createElementVNode("view", { class: "demo-block mt-12px" }, [
                createElementVNode("text", { class: "demo-label" }, "不同形状"),
                createElementVNode("view", { class: "flex-row items-center flex-wrap" }, [
                  createVNode(_component_up_tag, {
                    text: "半圆角",
                    shape: "circle",
              ...
              createElementVNode("view", { class: "demo-block mt-12px" }, [
                createElementVNode("text", { class: "demo-label" }, "可关闭标签"),
                createElementVNode("view", { class: "flex-row items-center flex-wrap" }, [
                  $setup.showTag ? (openBlock(), createBlock(_component_up_tag, {
                    key: 0,
                    text: "点击关闭",
                    type: "primary",
                    closable: "",
