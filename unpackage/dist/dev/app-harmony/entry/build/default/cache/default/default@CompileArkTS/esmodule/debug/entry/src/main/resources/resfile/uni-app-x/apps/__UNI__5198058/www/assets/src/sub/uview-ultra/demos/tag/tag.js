...
import { _ as __easycom_1 } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/components/up-tag/up-tag&";
    ...
    return () => {
      ...
      const n33 = _createSharedDataComponent(_sfc_main$1, "584b9f21", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n32 = _createSharedDataComponent(_sfc_main$2, "9daf7616", {
            ...
            "default": _withSharedDataVaporCtx(() => {
              ...
              const n9 = _createSharedDataComponentWithFallback(_component_up_tag, "73e07860", {
                text: "镂空",
                type: "primary",
                plain: true,
                size: "normal",
              ...
              const n10 = _createSharedDataComponentWithFallback(_component_up_tag, "082ad392", {
                text: "镂空",
                type: "success",
                plain: true,
                size: "normal",
              ...
              const n14 = _createSharedDataComponentWithFallback(_component_up_tag, "082ade76", {
                text: "大尺寸",
                size: "large",
                type: "primary",
                class: "mr-10px"
              ...
              const n15 = _createSharedDataComponentWithFallback(_component_up_tag, "082ae1fc", {
                text: "普通",
                size: "normal",
                type: "success",
                class: "mr-10px"
              ...
              const n16 = _createSharedDataComponentWithFallback(_component_up_tag, "082ae597", {
                text: "迷你",
                size: "mini",
                type: "warning",
                class: "mr-10px"
              ...
              const n20 = _createSharedDataComponentWithFallback(_component_up_tag, "082aedb6", {
                text: "半圆角",
                shape: "circle",
                type: "primary",
                class: "mr-10px"
              ...
              const n21 = _createSharedDataComponentWithFallback(_component_up_tag, "082af13e", {
                text: "直角",
                shape: "square",
                type: "primary",
                class: "mr-10px"
              ...
              _createSharedDataIf(() => {
                ...
                const n27 = _createSharedDataComponentWithFallback(_component_up_tag, "082b4ad6", {
                  text: "点击关闭",
                  type: "primary",
                  closable: "",
                  onClose: () => {
