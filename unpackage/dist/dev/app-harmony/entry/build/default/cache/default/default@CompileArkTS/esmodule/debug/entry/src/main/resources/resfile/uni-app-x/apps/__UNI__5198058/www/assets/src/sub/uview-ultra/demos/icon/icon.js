...
const __className = "GenSrcSubUviewUltraDemosIconIcon";
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    const __sharedData = __sharedDataRenderer == "component" ? _withSharedDataComponent(new UniDynamicSharedDataComponent(_useSharedDataScope(), _useSharedDataComponentOptions({ bundleKey: "GenSrcSubUviewUltraDemosIconIconSharedData", sharedDataClassId: 0 }))) : _withSharedDataPage(new UniDynamicSharedDataPage(_useSharedDataPageId(), _useSharedDataPageOptions({ bundleKey: "GenSrcSubUviewUltraDemosIconIconSharedData", sharedDataClassId: 0 })));
    _useSharedDataScope(__sharedData);
    return () => {
      "raw js";
      const _component_NavBar = __easycom_0;
      const _component_up_icon = __easycom_0$1;
      const n16 = _createSharedDataComponent(_sfc_main$1, "dacdd0da", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n15 = _createSharedDataComponent(_sfc_main$2, "7eec4a7a", {
            "navigation-style": "custom",
            "navigation-bar-title-text": "up-icon 图标"
          }, {
            "default": _withSharedDataVaporCtx(() => {
              const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "50b17e2e", {
                title: "Icon 图标",
                "auto-back": true
              });
              _setSharedData(__sharedData, 2, n0?.sharedData);
              const n2 = _createSharedDataComponentWithFallback(_component_up_icon, "50b185b0", {
                name: "photo",
                size: "28",
                class: "mr-15px mb-15px"
              });
              _setSharedData(__sharedData, 3, n2?.sharedData);
              const n3 = _createSharedDataComponentWithFallback(_component_up_icon, "50b18930", {
                name: "lock",
                size: "28",
                class: "mr-15px mb-15px"
              });
              _setSharedData(__sharedData, 4, n3?.sharedData);
              const n4 = _createSharedDataComponentWithFallback(_component_up_icon, "50b18c9a", {
                name: "star",
                size: "28",
                class: "mr-15px mb-15px"
              });
              _setSharedData(__sharedData, 5, n4?.sharedData);
              const n8 = _createSharedDataComponentWithFallback(_component_up_icon, "50b19475", {
                name: "heart-fill",
                color: "#fa3534",
                size: "28",
                class: "mr-15px mb-15px"
              ...
              const n9 = _createSharedDataComponentWithFallback(_component_up_icon, "50b19834", {
              ...
              const n10 = _createSharedDataComponentWithFallback(_component_up_icon, "50b19bfb", {
