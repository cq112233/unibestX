...
import { _ as __easycom_1 } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/rice-ui/components/rice-picker/rice-picker&";
...
import { P as PickerOption } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/rice-ui/components/rice-picker/type&";
...
const __className = "GenSrcSubRiceUiDemosPickerPicker";
...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  __hash: "08cb2d55",
  __className,
  __filename: "src/sub/rice-ui/demos/picker/picker.uvue",
  __name: "picker",
  setup(__props) {
    const __sharedDataRenderer = _useSharedDataRenderer();
    const __sharedData = __sharedDataRenderer == "component" ? _withSharedDataComponent(new UniDynamicSharedDataComponent(_useSharedDataScope(), _useSharedDataComponentOptions({ bundleKey: "GenSrcSubRiceUiDemosPickerPickerSharedData", sharedDataClassId: 0 }))) : _withSharedDataPage(new UniDynamicSharedDataPage(_useSharedDataPageId(), _useSharedDataPageOptions({ bundleKey: "GenSrcSubRiceUiDemosPickerPickerSharedData", sharedDataClassId: 0 })));
    ...
    return () => {
      ...
      const n9 = _createSharedDataComponent(_sfc_main$1, "373ed242", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "9ec9126a", {
            title: "Picker 选择器",
            "auto-back": true,
          ...
          const n2 = _createSharedDataComponentWithFallback(_component_rice_picker, "62d35443", {
            columns: () => {
              return columns;
            },
            "use-popup": false,
          ...
          _renderSharedDataEffect(() => {
            return _setSharedData(__sharedData, 4, _toDisplayString(_unref(selectedCity)));
          });
        })
      });
