...
import { _ as __easycom_1 } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/rice-ui/components/rice-avatar/rice-avatar&";
...
import "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/rice-ui/components/rice-avatar/type&";
...
const __className = "GenSrcSubRiceUiDemosAvatarAvatar";
const { computed } = globalThis.Vue;
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  __dynamicSharedData: true,
  __hash: "a34b26b4",
  __className,
  __filename: "src/sub/rice-ui/demos/avatar/avatar.uvue",
  __name: "avatar",
  setup(__props) {
    const __sharedDataRenderer = _useSharedDataRenderer();
    const __sharedData = __sharedDataRenderer == "component" ? _withSharedDataComponent(new UniDynamicSharedDataComponent(_useSharedDataScope(), _useSharedDataComponentOptions({ bundleKey: "GenSrcSubRiceUiDemosAvatarAvatarSharedData", sharedDataClassId: 0 }))) : _withSharedDataPage(new UniDynamicSharedDataPage(_useSharedDataPageId(), _useSharedDataPageOptions({ bundleKey: "GenSrcSubRiceUiDemosAvatarAvatarSharedData", sharedDataClassId: 0 })));
    ...
    return () => {
      ...
      const _component_rice_avatar = __easycom_1;
      const n25 = _createSharedDataComponent(_sfc_main$1, "09fb4218", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "356d01b5", {
            title: "Avatar 头像",
            "auto-back": true,
          ...
          const n2 = _createSharedDataComponentWithFallback(_component_rice_avatar, "783326b8", {
            src: "/static/logo.png",
            size: "50px",
            round: true
          });
          _setSharedData(__sharedData, 2, n2?.sharedData);
          const n5 = _createSharedDataComponentWithFallback(_component_rice_avatar, "78332e76", {
            src: "/static/logo.png",
            size: "50px",
            round: false,
            radius: "8px"
          ...
          const n11 = _createSharedDataComponentWithFallback(_component_rice_avatar, "e39f878c", {
            src: "/static/logo.png",
            size: "32px"
          });
          _setSharedData(__sharedData, 4, n11?.sharedData);
          const n12 = _createSharedDataComponentWithFallback(_component_rice_avatar, "e39f8616", {
            src: "/static/logo.png",
            size: "44px"
          });
          _setSharedData(__sharedData, 5, n12?.sharedData);
          const n13 = _createSharedDataComponentWithFallback(_component_rice_avatar, "e39f7f8a", {
            src: "/static/logo.png",
            size: "56px"
          });
          _setSharedData(__sharedData, 6, n13?.sharedData);
          const n14 = _createSharedDataComponentWithFallback(_component_rice_avatar, "e39f7e14", {
            src: "/static/logo.png",
            size: "68px"
          });
          ...
          const n18 = _createSharedDataComponentWithFallback(_component_rice_avatar, "e39f6786", {
            text: "UN",
            "bg-color": () => {
          ...
          const n19 = _createSharedDataComponentWithFallback(_component_rice_avatar, "e39f6044", {
            icon: "user",
            "bg-color": () => {
              return currentTheme.value;
            },
          ...
          const n20 = _createSharedDataComponentWithFallback(_component_rice_avatar, "e39f58fe", {
            text: "RICE",
            "bg-color": "#334155",
            color: "#ffffff",
            size: "48px"
...
const _style_0 = {};
const _style_1 = {};
const avatar = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0, _style_1]]]);
export {
  avatar as default
};
