...
const __className = "GenSrcPagesBasicComponentsCryptoDemoCard";
...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    const __sharedData = _withSharedDataComponent(new UniDynamicSharedDataComponent(__sharedDataScope, _useSharedDataComponentOptions({ bundleKey: "GenSrcPagesBasicComponentsCryptoDemoCardSharedData", sharedDataClassId: 0 })));
      ...
      const n97 = _createSharedDataComponent(
        ...
        { title: "加密解密工具 (crypto)" },
        {
          "default": _withSharedDataVaporCtx(() => {
            const n1 = _createSharedDataComponentWithFallback(_component_input, "08aaf3b1", {
              value: () => {
            ...
            const n14 = _createSharedDataComponentWithFallback(_component_input, "0cb30ea4", {
              value: () => {
            ...
            const n27 = _createSharedDataComponentWithFallback(_component_input, "0cb38edb", {
              value: () => {
            ...
            const n28 = _createSharedDataComponentWithFallback(_component_input, "0cb3e7ff", {
              value: () => {
            ...
            const n35 = _createSharedDataComponentWithFallback(_component_input, "0cb454fb", {
              value: () => {
            ...
            const n36 = _createSharedDataComponentWithFallback(_component_input, "0cb45cbe", {
              value: () => {
                return aesKey.value;
              },
              "onUpdate:value": () => {
            ...
            const n49 = _createSharedDataComponentWithFallback(_component_input, "0cb4dfbc", {
              value: () => {
            ...
            const n50 = _createSharedDataComponentWithFallback(_component_input, "0cb4e77f", {
              value: () => {
                return desKey.value;
              },
              "onUpdate:value": () => {
            ...
            const n63 = _createSharedDataComponentWithFallback(_component_input, "0cb5b979", {
              value: () => {
            ...
            const n69 = _createSharedDataComponentWithFallback(_component_input, "0cb5d43e", {
              value: () => {
            ...
            const n70 = _createSharedDataComponentWithFallback(_component_input, "0cb62dbe", {
              value: () => {
