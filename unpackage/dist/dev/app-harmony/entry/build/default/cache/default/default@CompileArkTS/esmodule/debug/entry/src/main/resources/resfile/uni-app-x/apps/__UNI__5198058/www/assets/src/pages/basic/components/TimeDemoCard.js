  ...
  return _openBlock(), _createBlock($setup["Card"], { title: "时间日期操作 (lime-dayuts)" }, {
    default: _withCtx(() => [
      _createElementVNode("view", { class: "rounded-12px p-16px mb-16px border-width-1px border-style-solid border-color-__e2e8f0_" }, [
        _createElementVNode("text", { class: "text-13px font-bold text-__1e293b_ mb-8px" }, "实时高精度时钟 (更新于每一百毫秒)"),
        _createElementVNode(
          "text",
          {
        ...
        _createElementVNode("text", { class: "text-12px text-__94a3b8_" }, " 格式模板: YYYY-MM-DD HH:mm:ss.SSS dddd ")
      ]),
      _createElementVNode("view", { class: "rounded-12px p-16px mb-16px border-width-1px border-style-solid border-color-__e2e8f0_" }, [
        _createElementVNode("text", { class: "text-13px font-bold text-__1e293b_ mb-12px" }, "日期偏移操作"),
        _createElementVNode("view", { class: "flex-row items-center justify-between mb-12px" }, [
          _createElementVNode("text", { class: "text-14px text-__64748b_" }, "当前偏移天数:"),
          _createElementVNode(
            "text",
        ...
        _createElementVNode("view", { class: "flex-row justify-between mb-12px" }, [
          _createElementVNode("view", { class: "flex-1 mr-8px" }, [
            _createElementVNode("view", {
              ...
              _createElementVNode("text", { class: "text-__3b82f6_ text-12px font-bold" }, "-7 天")
            ])
          ]),
          _createElementVNode("view", { class: "flex-1 mr-8px" }, [
            _createElementVNode("view", {
              ...
              _createElementVNode("text", { class: "text-__3b82f6_ text-12px font-bold" }, "-1 天")
            ])
          ]),
          _createElementVNode("view", { class: "flex-1 mr-8px" }, [
            _createElementVNode("view", {
        ...
        _createElementVNode("view", { class: "border-top-width-1px border-top-style-solid border-top-color-__e2e8f0_ pt-8px mt-8px" }, [
          _createElementVNode("text", { class: "text-12px text-__94a3b8_ mb-4px" }, "计算得到的目标时间:"),
          _createElementVNode(
            "text",
      ...
      _createElementVNode("view", { class: "rounded-12px p-16px border-width-1px border-style-solid border-color-__e2e8f0_" }, [
        _createElementVNode("text", { class: "text-13px font-bold text-__1e293b_ mb-12px" }, "常用日期边界与区间计算"),
        _createElementVNode("view", { class: "flex-row justify-between mb-8px" }, [
          _createElementVNode("text", { class: "text-14px text-__64748b_" }, "本月第一天"),
          _createElementVNode(
            "text",
        ...
        _createElementVNode("view", { class: "flex-row justify-between mb-8px" }, [
          _createElementVNode("text", { class: "text-14px text-__64748b_" }, "本月最后一天"),
          _createElementVNode(
            "text",
            { class: "text-14px font-medium text-__334155_" },
        ...
        _createElementVNode("view", { class: "flex-row justify-between mb-8px" }, [
          _createElementVNode("text", { class: "text-14px text-__64748b_" }, "今年天数"),
          _createElementVNode(
            "text",
            { class: "text-14px font-medium text-__334155_" },
        ...
        _createElementVNode("view", { class: "flex-row justify-between" }, [
          _createElementVNode("text", { class: "text-14px text-__64748b_" }, "距离今年底倒计时"),
          _createElementVNode(
            "text",
