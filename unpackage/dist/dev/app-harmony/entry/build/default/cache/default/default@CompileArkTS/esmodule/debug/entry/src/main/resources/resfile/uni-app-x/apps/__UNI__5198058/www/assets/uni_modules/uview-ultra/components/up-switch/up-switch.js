...
import { p as propsSwitch } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/components/up-switch/props&";
...
import { f as error, a as addUnit, g as getPx, b as addStyle } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/libs/function/index&";
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return _openBlock(), _createElementBlock(
    "view",
    {
      class: _normalizeClass($options.switchClass),
      style: _normalizeStyle([$options.switchStyle, $options.addStyle(_ctx.customStyle)]),
      onClick: _cache[0] || (_cache[0] = (...args) => $options.clickHandler && $options.clickHandler(...args))
    },
    [
      $options.isActive ? (_openBlock(), _createElementBlock(
        "view",
        {
          key: 0,
          class: "up-switch__bg-active",
          style: _normalizeStyle([$options.bgActiveStyle])
        },
        null,
        4
        /* STYLE */
      ...
      _createElementVNode(
        "view",
        {
          class: _normalizeClass(["up-switch__node", [_ctx.modelValue == _ctx.activeValue ? "up-switch__node--on" : ""]]),
