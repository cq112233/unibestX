...
import { o as getDeviceInfo, t as toast } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/libs/function/index&";
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return _openBlock(), _createBlock(_component_up_overlay, {
    ...
    zIndex: _ctx.zIndex,
    onTouchmove: _withModifiers(_ctx.noop, ["stop", "prevent"]),
    customStyle: {
      backgroundColor: "#fff",
      display: "flex",
