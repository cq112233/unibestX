...
import { _ as __easycom_1 } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/components/up-navbar-mini/up-navbar-mini&";
...
const __className = "GenSrcSubUviewUltraDemosNavbarMiniNavbarMini";
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    const __sharedData = __sharedDataRenderer == "component" ? _withSharedDataComponent(new UniDynamicSharedDataComponent(_useSharedDataScope(), _useSharedDataComponentOptions({ bundleKey: "GenSrcSubUviewUltraDemosNavbarMiniNavbarMiniSharedData", sharedDataClassId: 0 }))) : _withSharedDataPage(new UniDynamicSharedDataPage(_useSharedDataPageId(), _useSharedDataPageOptions({ bundleKey: "GenSrcSubUviewUltraDemosNavbarMiniNavbarMiniSharedData", sharedDataClassId: 0 })));
    _useSharedDataScope(__sharedData);
    return () => {
      "raw js";
      const _component_NavBar = __easycom_0;
      const _component_up_navbar_mini = __easycom_1;
      const n16 = _createSharedDataComponent(_sfc_main$1, "c5065722", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n15 = _createSharedDataComponent(_sfc_main$2, "121db967", {
            "navigation-style": "custom",
            "navigation-bar-title-text": "up-navbar-mini 迷你导航栏"
          }, {
            "default": _withSharedDataVaporCtx(() => {
              const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "31997429", {
                title: "Navbar Mini 迷你导航栏",
                "auto-back": true
              });
              _setSharedData(__sharedData, 2, n0?.sharedData);
              const n2 = _createSharedDataComponentWithFallback(_component_up_navbar_mini, "31997e73", {
              ...
              const n6 = _createSharedDataComponentWithFallback(_component_up_navbar_mini, "31998711", {
                "safe-area-inset-top": false,
                fixed: false,
              ...
              const n10 = _createSharedDataComponentWithFallback(_component_up_navbar_mini, "0194f325", {
                "safe-area-inset-top": false,
                fixed: false,
                "bg-color": "#fa3534",
                "icon-color": "#ffffff"
...
const _style_0 = {};
const _style_1 = {};
const navbarMini = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0, _style_1]]]);
export {
  navbarMini as default
};
//# sourceMappingURL=navbar-mini.js.map
