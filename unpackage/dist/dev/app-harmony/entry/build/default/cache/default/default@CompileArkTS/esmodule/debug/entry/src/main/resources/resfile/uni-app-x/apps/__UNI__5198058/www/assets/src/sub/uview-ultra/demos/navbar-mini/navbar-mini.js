...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  const _component_up_navbar_mini = resolveEasycom(__resolveDynamicComponent("up-navbar-mini"), __easycom_1);
          ...
          _createElementVNode("view", { class: "page-container bg-__f8fafc_ min-h-screen pb-30px" }, [
            ...
            _createElementVNode("view", { class: "p-16px" }, [
              _createElementVNode("view", { class: "demo-block" }, [
                ...
                _createElementVNode("view", { class: "flex-row items-center p-8px" }, [
                  _createVNode(_component_up_navbar_mini, {
