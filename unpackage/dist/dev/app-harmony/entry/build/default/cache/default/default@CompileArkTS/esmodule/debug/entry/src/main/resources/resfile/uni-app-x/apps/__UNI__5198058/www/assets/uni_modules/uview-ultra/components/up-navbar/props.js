...
import { d as defProps } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/components/up-navbar/navbar&";
let crtProp = defProps["navbar"];
const propsNavbar = {
  props: {
    // 是否开启顶部安全区适配
    safeAreaInsetTop: {
