...
import { _ as __easycom_1$2 } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/components/up-radio/up-radio&";
...
import { _ as __easycom_6 } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/components/up-checkbox/up-checkbox&";
import { _ as __easycom_7 } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/components/up-checkbox-group/up-checkbox-group&";
...
import { _ as __easycom_2$2 } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/components/up-button/up-button&";
import { _ as __easycom_16 } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/components/up-calendar/up-calendar&";
import { _ as __easycom_2$3 } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/components/up-picker/up-picker&";
import { _ as __easycom_18 } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/components/up-datetime-picker/up-datetime-picker&";
import { _ as __easycom_19 } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/components/up-action-sheet/up-action-sheet&";
...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    function submitForm() {
      ...
      if (form2 != null) {
        form2.$callMethod("validate").then((res = null) => {
          ...
          uni.__f__("log", "at src/sub/uview-ultra/demos/form/form.uvue:262", "提交的数据：", formModel);
        }).catch((err = null) => {
          uni.__f__("log", "at src/sub/uview-ultra/demos/form/form.uvue:264", "验证失败:", err);
          uni.showToast({
            title: "请检查必填项",
            icon: "error"
          });
    ...
    return () => {
      ...
      const _component_up_radio = __easycom_1$2;
      ...
      const _component_up_button = __easycom_2$2;
      const _component_up_calendar = __easycom_16;
      const _component_up_picker = __easycom_2$3;
      const _component_up_datetime_picker = __easycom_18;
      ...
      const n67 = _createSharedDataComponent(AppKu, "b189a5ae", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n66 = _createSharedDataComponent(LayoutComponent, "402a77ed", {
            ...
            "default": _withSharedDataVaporCtx(() => {
              const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "75b6f340", {
                title: "Form 表单",
                "auto-back": true,
              ...
              const n46 = _createSharedDataComponentWithFallback(_component_up_form, "75b6e3f0", {
                model: () => {
                  return formModel;
                },
                rules: () => {
                ...
                "default": _withSharedDataVaporCtx(() => {
                  const n3 = _createSharedDataComponentWithFallback(_component_up_form_item, "75b6d5ac", {
                    label: "姓名",
                    prop: "name",
                    "border-bottom": true,
                    required: ""
                    ...
                    "default": _withSharedDataVaporCtx(() => {
                      const n2 = _createSharedDataComponentWithFallback(_component_up_input, "75b6cea4", {
                        modelValue: () => {
                  ...
                  const n7 = _createSharedDataComponentWithFallback(_component_up_form_item, "75b6c66c", {
                    label: "性别",
                    prop: "gender",
                    "border-bottom": true,
                    required: "",
                    ...
                    "right": _withSharedDataVaporCtx(() => {
                      const n5 = _createSharedDataComponentWithFallback(_component_up_icon, "4127a86a", {
                        name: "arrow-right",
                        color: "#c0c4cc",
                        size: "16"
                      });
                    ...
                    "default": _withSharedDataVaporCtx(() => {
                      const n4 = _createSharedDataComponentWithFallback(_component_up_input, "75b6be76", {
                        modelValue: () => {
                  ...
                  const n11 = _createSharedDataComponentWithFallback(_component_up_form_item, "4127a036", {
                    label: "出生日期",
                    prop: "birthday",
                    "border-bottom": true,
                    required: "",
                    ...
                    "right": _withSharedDataVaporCtx(() => {
                      const n9 = _createSharedDataComponentWithFallback(_component_up_icon, "412782e8", {
                        name: "arrow-right",
                        color: "#c0c4cc",
                        size: "16"
                      });
                    ...
                    "default": _withSharedDataVaporCtx(() => {
                      const n8 = _createSharedDataComponentWithFallback(_component_up_input, "41279834", {
                        modelValue: () => {
                  ...
                  const n15 = _createSharedDataComponentWithFallback(_component_up_form_item, "41277ade", {
                    label: "国籍",
                    prop: "country",
                    "border-bottom": true,
                    onClick: () => {
                    ...
                    "right": _withSharedDataVaporCtx(() => {
                      const n13 = _createSharedDataComponentWithFallback(_component_up_icon, "4126c068", {
                        name: "arrow-right",
                        color: "#c0c4cc",
                        size: "16"
                      });
                    ...
                    "default": _withSharedDataVaporCtx(() => {
                      const n12 = _createSharedDataComponentWithFallback(_component_up_input, "41277358", {
                        modelValue: () => {
                  ...
                  const n19 = _createSharedDataComponentWithFallback(_component_up_form_item, "4126b85e", {
                    label: "行程时间",
                    prop: "stayTime",
                    "border-bottom": true,
                    onClick: () => {
                    ...
                    "right": _withSharedDataVaporCtx(() => {
                      const n17 = _createSharedDataComponentWithFallback(_component_up_icon, "4126a06e", {
                        name: "arrow-right",
                        color: "#c0c4cc",
                        size: "16"
                      });
                    ...
                    "default": _withSharedDataVaporCtx(() => {
                      const n16 = _createSharedDataComponentWithFallback(_component_up_input, "4126b0a4", {
                        modelValue: () => {
                  ...
                  const n26 = _createSharedDataComponentWithFallback(_component_up_form_item, "41269324", {
                    label: "水果最爱",
                    prop: "fruit",
                    "border-bottom": true
                  }, {
                    "default": _withSharedDataVaporCtx(() => {
                      const n25 = _createSharedDataComponentWithFallback(_component_up_radio_group, "41269168", {
                        modelValue: () => {
                        ...
                        "default": _withSharedDataVaporCtx(() => {
                          const n20 = _createSharedDataComponentWithFallback(_component_up_radio, "41268a9a", {
                            name: "apple",
                            label: "苹果"
                          });
                          _setSharedData(__sharedData, 24, n20?.sharedData);
                          const n22 = _createSharedDataComponentWithFallback(_component_up_radio, "412682e0", {
                            name: "banana",
                            label: "香蕉"
                          });
                          _setSharedData(__sharedData, 25, n22?.sharedData);
                          const n24 = _createSharedDataComponentWithFallback(_component_up_radio, "4125dd7a", {
                            name: "orange",
                            label: "橘子"
                          });
                  ...
                  const n33 = _createSharedDataComponentWithFallback(_component_up_form_item, "4125d5b2", {
                    label: "兴趣爱好",
                    prop: "hobbies",
                    "border-bottom": true
                  }, {
                    "default": _withSharedDataVaporCtx(() => {
                      const n32 = _createSharedDataComponentWithFallback(_component_up_checkbox_group, "4125ceb2", {
                        modelValue: () => {
                        ...
                        "default": _withSharedDataVaporCtx(() => {
                          const n27 = _createSharedDataComponentWithFallback(_component_up_checkbox, "4125c7b0", {
                            name: "reading",
                            label: "阅读"
                          });
                          _setSharedData(__sharedData, 29, n27?.sharedData);
                          const n29 = _createSharedDataComponentWithFallback(_component_up_checkbox, "4125bfe6", {
                            name: "sports",
                            label: "运动"
                          });
                          _setSharedData(__sharedData, 30, n29?.sharedData);
                          const n31 = _createSharedDataComponentWithFallback(_component_up_checkbox, "4125b7f4", {
                            name: "music",
                            label: "音乐"
                          });
                  ...
                  const n35 = _createSharedDataComponentWithFallback(_component_up_form_item, "4125aff2", {
                    label: "通知开关",
                    prop: "notification",
                    "border-bottom": true
                  }, {
                    "default": _withSharedDataVaporCtx(() => {
                      const n34 = _createSharedDataComponentWithFallback(_component_up_switch, "4125a8e8", {
                        modelValue: () => {
                  ...
                  const n37 = _createSharedDataComponentWithFallback(_component_up_form_item, "4125a0f0", {
                    label: "服务评分",
                    prop: "rate",
                    "border-bottom": true
                  }, {
                    "default": _withSharedDataVaporCtx(() => {
                      const n36 = _createSharedDataComponentWithFallback(_component_up_rate, "41259a20", {
                        modelValue: () => {
                  ...
                  const n39 = _createSharedDataComponentWithFallback(_component_up_form_item, "4124f52c", {
                    label: "购买数量",
                    prop: "count",
                    "border-bottom": true
                  }, {
                    "default": _withSharedDataVaporCtx(() => {
                      const n38 = _createSharedDataComponentWithFallback(_component_up_number_box, "4124ee30", {
                        modelValue: () => {
                  ...
                  const n41 = _createSharedDataComponentWithFallback(_component_up_form_item, "4124e666", {
                    label: "满意度",
                    prop: "satisfaction",
                    "border-bottom": true
                  }, {
                    "default": _withSharedDataVaporCtx(() => {
                      const n40 = _createSharedDataComponentWithFallback(_component_up_slider, "4124df34", {
                        modelValue: () => {
                  ...
                  const n43 = _createSharedDataComponentWithFallback(_component_up_form_item, "4124d674", {
                    label: "个人简介",
                    prop: "intro",
                    "border-bottom": true,
                    "label-position": "top"
                    ...
                    "default": _withSharedDataVaporCtx(() => {
                      const n42 = _createSharedDataComponentWithFallback(_component_up_textarea, "4124cefa", {
                        modelValue: () => {
                  ...
                  const n45 = _createSharedDataComponentWithFallback(_component_up_form_item, "4124c19c", {
                    label: "相关照片",
                    prop: "photos",
                    "border-bottom": true,
                    "label-position": "top"
                    ...
                    "default": _withSharedDataVaporCtx(() => {
                      const n44 = _createSharedDataComponentWithFallback(_component_up_upload, "4124ba20", {
                        "file-list": () => {
              ...
              const n53 = _createSharedDataComponentWithFallback(_component_up_form, "4123fdee", {
                model: () => {
                  return formModel2;
                },
                "label-position": "top",
                ...
                "default": _withSharedDataVaporCtx(() => {
                  const n50 = _createSharedDataComponentWithFallback(_component_up_form_item, "4123f6e6", {
                    label: "活动名称",
                    prop: "name",
                    "border-bottom": true
                  }, {
                    "default": _withSharedDataVaporCtx(() => {
                      const n49 = _createSharedDataComponentWithFallback(_component_up_input, "4123f502", {
                        modelValue: () => {
                  ...
                  const n52 = _createSharedDataComponentWithFallback(_component_up_form_item, "4123e7ee", {
                    label: "活动详情",
                    prop: "detail",
                    "border-bottom": true
                  }, {
                    "default": _withSharedDataVaporCtx(() => {
                      const n51 = _createSharedDataComponentWithFallback(_component_up_textarea, "4123e630", {
                        modelValue: () => {
              ...
              const n55 = _createSharedDataComponentWithFallback(_component_up_button, "4123d09e", {
                type: "primary",
                text: "提交表单",
                onClick: () => {
                  return submitForm;
              ...
              const n57 = _createSharedDataComponentWithFallback(_component_up_button, "4123c826", {
                type: "info",
                text: "重置表单",
                onClick: () => {
                  return resetForm;
              ...
              const n61 = _createSharedDataComponentWithFallback(_component_up_calendar, "41231c72", {
                show: () => {
              ...
              const n62 = _createSharedDataComponentWithFallback(_component_up_picker, "41230dea", {
                show: () => {
              ...
              const n63 = _createSharedDataComponentWithFallback(_component_up_datetime_picker, "4122fe36", {
                modelValue: () => {
              ...
              const n64 = _createSharedDataComponentWithFallback(_component_up_action_sheet, "4122e768", {
                show: () => {
...
const _style_0 = {};
const form = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0]]]);
export {
  form as default
};
