...
import { _ as _sfc_main$3 } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/components/up-form/up-form&";
...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const _component_up_form = _sfc_main$3;
      ...
      const n67 = _createSharedDataComponent(_sfc_main$1, "b189a5ae", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n66 = _createSharedDataComponent(_sfc_main$2, "402a77ed", {
            ...
            "default": _withSharedDataVaporCtx(() => {
              ...
              const n53 = _createSharedDataComponentWithFallback(_component_up_form, "4123fea0", {
                model: () => {
                  return formModel2;
                },
                "label-position": "top",
                ...
                "default": _withSharedDataVaporCtx(() => {
                  const n50 = _createSharedDataComponentWithFallback(_component_up_form_item, "4123fc84", {
                    label: "活动名称",
                    prop: "name",
                    "border-bottom": true
                  }, {
                    "default": _withSharedDataVaporCtx(() => {
                      const n49 = _createSharedDataComponentWithFallback(_component_up_input, "4123f5b4", {
                        modelValue: () => {
                  ...
                  const n52 = _createSharedDataComponentWithFallback(_component_up_form_item, "4123edb6", {
                    label: "活动详情",
                    prop: "detail",
                    "border-bottom": true
                  }, {
                    "default": _withSharedDataVaporCtx(() => {
                      const n51 = _createSharedDataComponentWithFallback(_component_up_textarea, "4123e6b8", {
                        modelValue: () => {
              ...
              const n55 = _createSharedDataComponentWithFallback(_component_up_button, "4123d160", {
                type: "primary",
                text: "提交表单",
                onClick: () => {
                  return submitForm;
              ...
              const n57 = _createSharedDataComponentWithFallback(_component_up_button, "4123c91a", {
                type: "info",
                text: "重置表单",
                onClick: () => {
                  return resetForm;
              ...
              const n61 = _createSharedDataComponentWithFallback(_component_up_calendar, "41231d66", {
                show: () => {
              ...
              const n62 = _createSharedDataComponentWithFallback(_component_up_picker, "412313f4", {
                show: () => {
              ...
              const n63 = _createSharedDataComponentWithFallback(_component_up_datetime_picker, "4122ff2a", {
                modelValue: () => {
              ...
              const n64 = _createSharedDataComponentWithFallback(_component_up_action_sheet, "4122e85c", {
                show: () => {
