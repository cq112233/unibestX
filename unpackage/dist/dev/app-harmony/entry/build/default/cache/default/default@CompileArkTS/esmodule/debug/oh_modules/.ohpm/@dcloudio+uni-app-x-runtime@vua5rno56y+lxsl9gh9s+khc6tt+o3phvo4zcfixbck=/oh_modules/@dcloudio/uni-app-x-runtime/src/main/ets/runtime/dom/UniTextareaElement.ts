...
export function TextareaBuilder(options: TextareaOptions, parent = null) {
    const __options__ = options;
    {
        (parent ? parent : this).observeComponentCreation2((elmtId, isInitialRender, options = __options__) => {
            if (isInitialRender) {
                let componentCall = new Textarea(parent ? parent : this, options, undefined, elmtId, () => { }, { page: "oh_modules/.ohpm/@dcloudio+uni-app-x-runtime@vua5rno56y+lxsl9gh9s+khc6tt+o3phvo4zcfixbck=/oh_modules/@dcloudio/uni-app-x-runtime/src/main/ets/runtime/dom/UniTextareaElement.ets", line: 22, col: 3 });
...
export class UniTextareaElementImpl extends UniInputFileElementImpl {
    ...
    * TODO 临时供 call input 使用
    ...
    protected override createFrameNode(): TextareaFrameNode {
        ...
        this.textarea.componentInstance.handleTextSelectionChange = (selectionStart, selectionEnd) => {
    ...
    override updateNativeAttribute(key: string, value: any) {
        ...
        switch (key) {
            ...
            case 'cursor':
                ...
                setTimeout(() => {
                    this.controller.caretPosition(this.getCursorPosition());
                }, 0);
                break;
            case 'cursorColor':
    ...
    override dispose(): void {
        if (this.textarea) {
            ...
            this.textarea.componentInstance.handleTextSelectionChange = undefined;
