...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n9 = _createSharedDataComponent(_sfc_main$1, "9110568a", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "3782c372", {
            title: "Skeleton 骨架屏",
            "auto-back": true
          });
          _setSharedData(__sharedData, 1, n0?.sharedData);
          const n2 = _createSharedDataComponentWithFallback(_component_up_skeleton, "8e54d68e", {
            loading: true,
            animate: true,
            rows: 3,
            title: ""
          ...
          const n5 = _createSharedDataComponentWithFallback(_component_up_skeleton, "8e54c83a", {
            loading: true,
            animate: true,
            rows: 2,
            title: "",
