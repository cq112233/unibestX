...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n10 = _createSharedDataComponent(AppKu, "9110568a", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n9 = _createSharedDataComponent(LayoutComponent, "3782c29b", {
            ...
            "default": _withSharedDataVaporCtx(() => {
              const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "8e54dd12", {
                title: "Skeleton 骨架屏",
                "auto-back": true
              });
              _setSharedData(__sharedData, 2, n0?.sharedData);
              const n2 = _createSharedDataComponentWithFallback(_component_up_skeleton, "8e54ced2", {
                loading: true,
                animate: true,
                rows: 3,
                title: ""
              ...
              const n5 = _createSharedDataComponentWithFallback(_component_up_skeleton, "8e54c07e", {
                loading: true,
                animate: true,
                rows: 2,
                title: "",
...
const _style_0 = {};
const skeleton = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0]]]);
export {
  skeleton as default
};
