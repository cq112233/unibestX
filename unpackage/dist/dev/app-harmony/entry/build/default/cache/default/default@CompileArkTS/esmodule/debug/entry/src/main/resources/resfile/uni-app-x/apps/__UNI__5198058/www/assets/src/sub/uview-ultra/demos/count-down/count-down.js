      ...
      const n10 = _createSharedDataComponent(AppKu, "685ac6fe", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n9 = _createSharedDataComponent(LayoutComponent, "a2fe18d6", {
            ...
            "default": _withSharedDataVaporCtx(() => {
              const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "219d7fbf", {
                title: "CountDown 倒计时",
                "auto-back": true
              });
              _setSharedData(__sharedData, 2, n0?.sharedData);
              const n2 = _createSharedDataComponentWithFallback(_component_up_count_down, "219d86e0", {
                time: () => {
                  return 30 * 60 * 60 * 1e3;
                },
                format: "HH:mm:ss"
              ...
              const n5 = _createSharedDataComponentWithFallback(_component_up_count_down, "219d8e43", {
                time: () => {
                  return 30 * 60 * 60 * 1e3;
                },
                format: "DD天HH时mm分ss秒"
...
const _style_0 = {};
const countDown = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0]]]);
export {
