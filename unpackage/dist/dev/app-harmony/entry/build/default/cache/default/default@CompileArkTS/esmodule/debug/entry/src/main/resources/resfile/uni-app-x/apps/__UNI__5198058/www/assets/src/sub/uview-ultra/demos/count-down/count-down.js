...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n9 = _createSharedDataComponent(_sfc_main$1, "685ac6fe", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "a2fe1728", {
            title: "CountDown 倒计时",
            "auto-back": true
          });
          _setSharedData(__sharedData, 1, n0?.sharedData);
          const n2 = _createSharedDataComponentWithFallback(_component_up_count_down, "219d8300", {
            time: () => {
              return 30 * 60 * 60 * 1e3;
            },
            format: "HH:mm:ss"
          ...
          const n5 = _createSharedDataComponentWithFallback(_component_up_count_down, "219d8a5f", {
            time: () => {
              return 30 * 60 * 60 * 1e3;
            },
            format: "DD天HH时mm分ss秒"
