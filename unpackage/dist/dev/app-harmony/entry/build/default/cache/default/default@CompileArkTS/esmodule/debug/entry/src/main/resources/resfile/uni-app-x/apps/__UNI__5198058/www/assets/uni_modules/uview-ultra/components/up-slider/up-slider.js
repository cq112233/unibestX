...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock(), _createElementBlock(
    ...
    [
      !_ctx.useNative || _ctx.isRange ? (_openBlock(), _createElementBlock(
        _Fragment,
        { key: 0 },
        [
          _createElementVNode(
            ...
            {
              ref: "up-slider-inner",
              class: _normalizeClass(["up-slider-inner", [_ctx.disabled ? "up-slider--disabled" : ""]]),
              ...
              style: _normalizeStyle($options.innerStyleCpu)
            },
            [
              _createElementVNode(
                "view",
              ...
              _createElementVNode(
                "view",
                {
                  ...
                  style: _normalizeStyle($options.gapStyleCpu)
                },
                null,
                4
                /* STYLE */
              ),
              _ctx.isRange ? (_openBlock(), _createElementBlock(
                "view",
                {
                  key: 0,
              ...
              _ctx.isRange && _ctx.showValue ? (_openBlock(), _createElementBlock(
                "text",
                {
                  key: 1,
                  class: "up-slider__show-range-value",
                  style: _normalizeStyle({ left: parseFloat($options.getPx($data.barStyle0.width)) + parseFloat($options.getPx(_ctx.blockSize)) / 2 + "px" })
                },
                _toDisplayString(this.rangeValue[0] ?? ""),
                5
                /* TEXT, STYLE */
              )) : _createCommentVNode("v-if", true),
              _ctx.isRange && _ctx.showValue ? (_openBlock(), _createElementBlock(
                "text",
                {
                  key: 2,
                  class: "up-slider__show-range-value",
                  style: _normalizeStyle({ left: parseFloat($options.getPx($data.barStyle.width)) + parseFloat($options.getPx(_ctx.blockSize)) / 2 + "px" })
                },
                _toDisplayString(this.rangeValue[1] ?? ""),
                5
                /* TEXT, STYLE */
              )) : _createCommentVNode("v-if", true),
              _ctx.isRange ? (_openBlock(), _createElementBlock(
                "view",
                {
                  ...
                  style: _normalizeStyle({ left: (parseFloat($options.getPx($data.barStyle0.width)) + parseFloat($options.getPx(_ctx.blockSize)) / 2).toString() + "px" })
                },
                [
                  _ctx.$slots["min"] != null || _ctx.$slots["$min"] != null ? _renderSlot(_ctx.$slots, "min", { key: 0 }) : (_openBlock(), _createElementBlock(
                    "view",
                    {
                      key: 1,
                      class: "up-slider__button",
                      style: _normalizeStyle($options.blockStyleCpu)
                    },
                    null,
                    4
                    /* STYLE */
              ...
              _createElementVNode(
                ...
                [
                  _ctx.isRange && (_ctx.$slots["max"] != null || _ctx.$slots["$max"] != null) ? _renderSlot(_ctx.$slots, "max", { key: 0 }) : _ctx.$slots["default"] != null || _ctx.$slots["$default"] != null ? _renderSlot(_ctx.$slots, "default", { key: 1 }) : (_openBlock(), _createElementBlock(
                    "view",
                    {
                      key: 2,
                      class: "up-slider__button",
          ...
          _ctx.showValue && !_ctx.isRange ? (_openBlock(), _createElementBlock(
            "view",
            {
              key: 0,
              class: "up-slider__show-value"
            },
            _toDisplayString(_ctx.modelValue),
            1
            /* TEXT */
          )) : _createCommentVNode("v-if", true)
        ],
