import { g as getPx, b as addStyle, u as upGetRect } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/libs/function/index&";
  ...
  setup(__props, _a) {
    ...
    return () => {
      ...
      _renderSharedDataEffect(() => {
        return _setSharedDataStyle(__sharedData, 39, sliderCustomStyle.value);
      });
      _createSharedDataIf(() => {
        ...
        _renderSharedDataEffect(() => {
          ...
          _setSharedDataStyle(__sharedData, 35, baseStyleCpu.value);
        ...
        _createSharedDataIf(() => {
          ...
          _renderSharedDataEffect(() => {
            return _setSharedDataStyle(__sharedData, 4, rangeGap0StyleCpu.value);
          });
        });
        _createSharedDataIf(() => {
          ...
          _renderSharedDataEffect(() => {
            _setSharedDataStyle(__sharedData, 6, btnWrapStyle0.value);
        ...
        _createSharedDataIf(() => {
          ...
          _renderSharedDataEffect(() => {
            _setSharedDataStyle(__sharedData, 9, btnWrapStyle1.value);
        ...
        _createSharedDataIf(() => {
          ...
          _renderSharedDataEffect(() => {
            return _setSharedDataStyle(__sharedData, 18, btnWrapStyle0.value);
          });
          _createSharedDataIf(() => {
        ...
        _renderSharedDataEffect(() => {
          return _setSharedDataStyle(__sharedData, 37, btnWrapStyle1.value);
        });
        _createSharedDataIf(() => {
        ...
        const n35 = _createSharedDataComponentWithFallback(_component_slider, "8cda2ee4", {
          ...
          blockSize: () => {
            return computedBlockSize.value;
          },
          blockColor: () => {
