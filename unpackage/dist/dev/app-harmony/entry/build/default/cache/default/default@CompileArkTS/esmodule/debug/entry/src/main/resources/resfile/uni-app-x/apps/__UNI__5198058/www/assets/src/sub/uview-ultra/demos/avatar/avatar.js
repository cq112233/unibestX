...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n25 = _createSharedDataComponent(_sfc_main$1, "7aad1313", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "4a155fcc", {
            title: "up-avatar 头像",
            "auto-back": true,
          ...
          const n2 = _createSharedDataComponentWithFallback(_component_up_avatar, "f896be5a", {
            src: "/static/logo.png",
            size: "40",
            class: "mr-10px"
          });
          _setSharedData(__sharedData, 2, n2?.sharedData);
          const n3 = _createSharedDataComponentWithFallback(_component_up_avatar, "f896b74e", {
            text: "U",
            size: "40",
            "bg-color": "#2979ff",
            class: "mr-10px"
          ...
          const n7 = _createSharedDataComponentWithFallback(_component_up_avatar, "f896a6e0", {
            src: "/static/logo.png",
            shape: "circle",
            size: "40",
            class: "mr-10px"
          ...
          const n8 = _createSharedDataComponentWithFallback(_component_up_avatar, "f8969f62", {
            src: "/static/logo.png",
            shape: "square",
            size: "40"
          });
          _setSharedData(__sharedData, 5, n8?.sharedData);
          const n12 = _createSharedDataComponentWithFallback(_component_up_avatar, "1a42fc80", {
            src: "/static/logo.png",
            size: "50",
            class: "mr-10px"
          });
          _setSharedData(__sharedData, 6, n12?.sharedData);
          const n13 = _createSharedDataComponentWithFallback(_component_up_avatar, "1a42f574", {
            src: "/static/logo.png",
            size: "40",
            class: "mr-10px"
          });
          _setSharedData(__sharedData, 7, n13?.sharedData);
          const n14 = _createSharedDataComponentWithFallback(_component_up_avatar, "1a42f37e", {
            src: "/static/logo.png",
            size: "30",
            class: "mr-10px"
          });
          _setSharedData(__sharedData, 8, n14?.sharedData);
          const n18 = _createSharedDataComponentWithFallback(_component_up_avatar, "1a42de30", {
            icon: "level",
            size: "40",
            "bg-color": "#fa3534",
            class: "mr-10px"
          ...
          const n19 = _createSharedDataComponentWithFallback(_component_up_avatar, "1a42d6be", {
            icon: "photo",
            size: "40",
            "bg-color": "#ff9900",
            class: "mr-10px"
          ...
          const n20 = _createSharedDataComponentWithFallback(_component_up_avatar, "1a42cf76", {
            text: "张",
            size: "40",
            "bg-color": "#19be6b"
          });
