...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n26 = _createSharedDataComponent(_sfc_main$1, "7aad1313", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n25 = _createSharedDataComponent(_sfc_main$2, "4a15617a", {
            "navigation-style": "custom",
            "navigation-bar-title-text": "up-avatar 头像"
          }, {
            "default": _withSharedDataVaporCtx(() => {
              const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "f896cca0", {
                title: "up-avatar 头像",
                "auto-back": true,
              ...
              const n2 = _createSharedDataComponentWithFallback(_component_up_avatar, "f896b70e", {
                src: "/static/logo.png",
                size: "40",
                class: "mr-10px"
              });
              _setSharedData(__sharedData, 3, n2?.sharedData);
              const n3 = _createSharedDataComponentWithFallback(_component_up_avatar, "f896afd8", {
                text: "U",
                size: "40",
                "bg-color": "#2979ff",
                class: "mr-10px"
              ...
              const n7 = _createSharedDataComponentWithFallback(_component_up_avatar, "f8969f94", {
                src: "/static/logo.png",
                shape: "circle",
                size: "40",
                class: "mr-10px"
              ...
              const n8 = _createSharedDataComponentWithFallback(_component_up_avatar, "f8969816", {
                src: "/static/logo.png",
                shape: "square",
                size: "40"
              });
              _setSharedData(__sharedData, 6, n8?.sharedData);
              const n12 = _createSharedDataComponentWithFallback(_component_up_avatar, "1a42f534", {
                src: "/static/logo.png",
                size: "50",
                class: "mr-10px"
              });
              _setSharedData(__sharedData, 7, n12?.sharedData);
              const n13 = _createSharedDataComponentWithFallback(_component_up_avatar, "1a42edfe", {
                src: "/static/logo.png",
                size: "40",
                class: "mr-10px"
              });
              _setSharedData(__sharedData, 8, n13?.sharedData);
              const n14 = _createSharedDataComponentWithFallback(_component_up_avatar, "1a42ec08", {
                src: "/static/logo.png",
                size: "30",
                class: "mr-10px"
              });
              _setSharedData(__sharedData, 9, n14?.sharedData);
              const n18 = _createSharedDataComponentWithFallback(_component_up_avatar, "1a42d6ba", {
                icon: "level",
                size: "40",
                "bg-color": "#fa3534",
                class: "mr-10px"
              ...
              const n19 = _createSharedDataComponentWithFallback(_component_up_avatar, "1a42cf72", {
                icon: "photo",
                size: "40",
                "bg-color": "#ff9900",
                class: "mr-10px"
              ...
              const n20 = _createSharedDataComponentWithFallback(_component_up_avatar, "1a42c82a", {
                text: "张",
                size: "40",
                "bg-color": "#19be6b"
              });
