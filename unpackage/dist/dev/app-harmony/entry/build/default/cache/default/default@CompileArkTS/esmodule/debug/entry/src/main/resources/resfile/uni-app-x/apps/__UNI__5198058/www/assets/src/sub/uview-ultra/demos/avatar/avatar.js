        ...
        "default": _withSharedDataVaporCtx(() => {
          const n25 = _createSharedDataComponent(LayoutComponent, "4a15617a", {
            ...
            "default": _withSharedDataVaporCtx(() => {
              ...
              const n7 = _createSharedDataComponentWithFallback(_component_up_avatar, "f8969fa0", {
                src: "/static/logo.png",
                shape: "circle",
                size: "40",
                class: "mr-10px"
              ...
              const n8 = _createSharedDataComponentWithFallback(_component_up_avatar, "f896984c", {
                src: "/static/logo.png",
                shape: "square",
                size: "40"
              });
              _setSharedData(__sharedData, 6, n8?.sharedData);
              const n12 = _createSharedDataComponentWithFallback(_component_up_avatar, "1a42f540", {
                src: "/static/logo.png",
                size: "50",
                class: "mr-10px"
              });
              _setSharedData(__sharedData, 7, n12?.sharedData);
              const n13 = _createSharedDataComponentWithFallback(_component_up_avatar, "1a42f34a", {
                src: "/static/logo.png",
                size: "40",
                class: "mr-10px"
              });
              _setSharedData(__sharedData, 8, n13?.sharedData);
              const n14 = _createSharedDataComponentWithFallback(_component_up_avatar, "1a42ec3e", {
                src: "/static/logo.png",
                size: "30",
                class: "mr-10px"
              });
              _setSharedData(__sharedData, 9, n14?.sharedData);
              const n18 = _createSharedDataComponentWithFallback(_component_up_avatar, "1a42d6f0", {
                icon: "level",
                size: "40",
                "bg-color": "#fa3534",
                class: "mr-10px"
              ...
              const n19 = _createSharedDataComponentWithFallback(_component_up_avatar, "1a42cfa8", {
                icon: "photo",
                size: "40",
                "bg-color": "#ff9900",
                class: "mr-10px"
              ...
              const n20 = _createSharedDataComponentWithFallback(_component_up_avatar, "1a42c836", {
                text: "张",
                size: "40",
                "bg-color": "#19be6b"
              });
