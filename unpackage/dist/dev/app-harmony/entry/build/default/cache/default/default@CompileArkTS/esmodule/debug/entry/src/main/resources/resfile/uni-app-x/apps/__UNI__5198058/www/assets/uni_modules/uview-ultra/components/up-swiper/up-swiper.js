...
const _sfc_main = /* @__PURE__ */ _defineComponent({
  ...
  setup(__props, _a) {
    ...
    const __returned__ = { props, emit, currentIndex, itemStyle, getItemType, getSource, getItemTitle, pauseVideo, change, getPoster, clickHandler, get addUnit() {
      return addUnit;
    }, get addStyle() {
      return addStyle;
    }, get testObject() {
  ...
  return _openBlock(), _createElementBlock(
    "view",
    {
      ...
      style: _normalizeStyle({
        ...
        borderRadius: $setup.addUnit($props.radius)
      })
    },
    [
                ...
                _createElementVNode(
                  ...
                  [
                    ...
                    $setup.getItemType(item) === "video" ? (_openBlock(), _createBlock(_component_video, {
                      ...
                      title: $props.showTitle && $setup.testObject(item) && $setup.getItemTitle(item) != "" ? $setup.getItemTitle(item) : "",
                      style: _normalizeStyle({
                        height: $setup.addUnit($props.height)
                      }),
                      controls: "",
                    ...
                    $props.showTitle && $setup.getItemTitle(item) != "" && $setup.testImage($setup.getSource(item)) ? (_openBlock(), _createElementBlock("view", {
                      key: 2,
      ...
      _createElementVNode(
        "view",
        {
          ...
          style: _normalizeStyle([$setup.addStyle($props.indicatorStyle)])
        },
        [
