import type { CSSVariableReferenceValue as ICSSVariableReferenceValue, CSSUnparsedValue as ICSSUnparsedValue } from './types';
...
export class CSSVariableReferenceValue implements ICSSVariableReferenceValue {
    constructor(public readonly variable: string, public readonly fallback: ICSSUnparsedValue | null = null) {
