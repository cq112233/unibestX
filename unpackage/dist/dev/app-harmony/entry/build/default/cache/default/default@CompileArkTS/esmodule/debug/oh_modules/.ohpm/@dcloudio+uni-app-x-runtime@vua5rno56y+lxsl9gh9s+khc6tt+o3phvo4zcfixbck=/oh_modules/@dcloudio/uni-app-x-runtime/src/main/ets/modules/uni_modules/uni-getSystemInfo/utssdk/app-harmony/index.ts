...
import { UTSObject, defineSyncApi, UTSHarmony, defineAsyncApi } from "@normalized:N&&&@dcloudio/uni-app-framework/index&1.0.0";
import type { UniError, ApiExecutor } from "@normalized:N&&&@dcloudio/uni-app-framework/index&1.0.0";
import { getWindowInfo as internalGetWindowInfo, getDeviceId } from "@normalized:N&&&@dcloudio/uni-app-framework/index&1.0.0";
...
export { CutoutRect as CutoutRect, GetSystemInfoOptions as GetSystemInfoOptions, GetSystemInfoResult as GetSystemInfoResult, GetWindowInfoResult as GetWindowInfoResult, SafeArea as SafeArea, SafeAreaInsets as SafeAreaInsets };
export type { GetSystemInfo as GetSystemInfo, GetSystemInfoComplete as GetSystemInfoComplete, GetSystemInfoCompleteCallback as GetSystemInfoCompleteCallback, GetSystemInfoSuccessCallback as GetSystemInfoSuccessCallback, GetSystemInfoSync as GetSystemInfoSync, GetWindowInfo as GetWindowInfo };
export { getWindowInfo as getWindowInfo };
export { getSystemInfoSync as getSystemInfoSync };
