...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n24 = _createSharedDataComponent(AppKu, "5238a91d", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n23 = _createSharedDataComponent(LayoutComponent, "16470b0e", {
            "navigation-style": "custom",
            "navigation-bar-title-text": "up-calendar 日历"
          }, {
            "default": _withSharedDataVaporCtx(() => {
              const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "b29a5550", {
              ...
              const n2 = _createSharedDataComponentWithFallback(_component_up_button, "b29a3f88", {
                type: "primary",
                text: "单选模式",
                size: "mini",
                onClick: () => {
              ...
              const n6 = _createSharedDataComponentWithFallback(_component_up_button, "b29a29f8", {
                type: "success",
                text: "多选日期",
                size: "mini",
                onClick: () => {
              ...
              const n10 = _createSharedDataComponentWithFallback(_component_up_button, "b29a197e", {
                type: "warning",
                text: "范围选择",
                size: "mini",
                onClick: () => {
              ...
              const n14 = _createSharedDataComponentWithFallback(_component_up_button, "2fa7bf1d", {
                type: "error",
                text: "自定义颜色",
                size: "mini",
                onClick: () => {
              ...
              const n18 = _createSharedDataComponentWithFallback(_component_up_calendar, "2fa7c351", {
                show: () => {
              ...
              const n19 = _createSharedDataComponentWithFallback(_component_up_calendar, "2fa7c751", {
                show: () => {
              ...
              const n20 = _createSharedDataComponentWithFallback(_component_up_calendar, "2fa7cdde", {
                show: () => {
              ...
              const n21 = _createSharedDataComponentWithFallback(_component_up_calendar, "2fa7d1dd", {
                show: () => {
...
const _style_0 = {};
const calendar = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0]]]);
export {
  calendar as default
};
