...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n23 = _createSharedDataComponent(_sfc_main$1, "5238a91d", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "16470960", {
          ...
          const n2 = _createSharedDataComponentWithFallback(_component_up_button, "b29a4742", {
            type: "primary",
            text: "单选模式",
            size: "mini",
            onClick: () => {
          ...
          const n6 = _createSharedDataComponentWithFallback(_component_up_button, "b29a31ba", {
            type: "success",
            text: "多选日期",
            size: "mini",
            onClick: () => {
          ...
          const n10 = _createSharedDataComponentWithFallback(_component_up_button, "b29a2148", {
            type: "warning",
            text: "范围选择",
            size: "mini",
            onClick: () => {
          ...
          const n14 = _createSharedDataComponentWithFallback(_component_up_button, "2fa7bb34", {
            type: "error",
            text: "自定义颜色",
            size: "mini",
            onClick: () => {
          ...
          const n18 = _createSharedDataComponentWithFallback(_component_up_calendar, "2fa7bf53", {
            show: () => {
          ...
          const n19 = _createSharedDataComponentWithFallback(_component_up_calendar, "2fa7c353", {
            show: () => {
          ...
          const n20 = _createSharedDataComponentWithFallback(_component_up_calendar, "2fa7c755", {
            show: () => {
          ...
          const n21 = _createSharedDataComponentWithFallback(_component_up_calendar, "2fa7cddf", {
            show: () => {
