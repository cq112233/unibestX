      ...
      const n16 = _createSharedDataComponent(AppKu, "975571d6", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n15 = _createSharedDataComponent(LayoutComponent, "5358c8fe", {
            ...
            "default": _withSharedDataVaporCtx(() => {
              const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "17c0555c", {
              ...
              const n2 = _createSharedDataComponentWithFallback(_component_up_textarea, "17c04096", {
                modelValue: () => {
              ...
              const n5 = _createSharedDataComponentWithFallback(_component_up_textarea, "17c0318a", {
                modelValue: () => {
              ...
              const n8 = _createSharedDataComponentWithFallback(_component_up_textarea, "17c02286", {
                modelValue: () => {
              ...
              const n11 = _createSharedDataComponentWithFallback(_component_up_textarea, "e04a9346", {
                modelValue: () => {
...
const _style_0 = {};
const textarea = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0]]]);
export {
  textarea as default
};
