...
import { _ as __easycom_1 } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/components/up-textarea/up-textarea&";
...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n15 = _createSharedDataComponent(_sfc_main$1, "975571d6", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "5358c750", {
          ...
          const n2 = _createSharedDataComponentWithFallback(_component_up_textarea, "17c04854", {
            modelValue: () => {
          ...
          const n5 = _createSharedDataComponentWithFallback(_component_up_textarea, "17c03950", {
            modelValue: () => {
          ...
          const n8 = _createSharedDataComponentWithFallback(_component_up_textarea, "17c02f94", {
            modelValue: () => {
          ...
          const n11 = _createSharedDataComponentWithFallback(_component_up_textarea, "17c0209e", {
            modelValue: () => {
