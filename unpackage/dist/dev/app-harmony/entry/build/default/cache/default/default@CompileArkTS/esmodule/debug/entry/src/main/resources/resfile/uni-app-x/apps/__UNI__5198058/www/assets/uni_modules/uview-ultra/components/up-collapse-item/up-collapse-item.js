...
import { j as guid, a as addUnit, u as upGetRect, s as sleep, k as error } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/libs/function/index&";
...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props, _a) {
    ...
    return () => {
      ...
      _renderSharedDataEffect(() => {
        _setSharedDataStyle(__sharedData, 12, { height: _unref(addUnit)(height.value) });
      ...
      _createSharedDataIf(() => {
        ...
        const n31 = _createSharedDataComponentWithFallback(_component_up_line, "cb9c9e9e");
