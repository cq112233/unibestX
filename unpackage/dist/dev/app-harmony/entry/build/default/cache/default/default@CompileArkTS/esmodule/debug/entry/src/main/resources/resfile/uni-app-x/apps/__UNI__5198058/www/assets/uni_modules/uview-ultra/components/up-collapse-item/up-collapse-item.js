...
import { d as defProps } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/components/up-collapse-item/collapseItem&";
import { j as guid, u as upGetRect, s as sleep, f as error } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/libs/function/index&";
...
const { nextTick, ref, watch, computed } = globalThis.Vue;
const { getCurrentInstance, onMounted } = globalThis.Vue;
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return _openBlock(), _createElementBlock("view", { class: "up-collapse-item" }, [
    _createVNode(_component_up_cell, {
      ...
      icon: _withCtx(() => [
        _renderSlot(_ctx.$slots, "icon", {}, () => [
          _ctx.$slots["icon"] != null && $props.icon != "" ? (_openBlock(), _createBlock(_component_up_icon, {
            key: 0,
            size: 22,
            name: $props.icon
    ...
    _createElementVNode("view", {
      ...
      style: _normalizeStyle({ height: _ctx.$up.addUnit($setup.height) }),
    ...
    $setup.parentData["border"] ? (_openBlock(), _createBlock(_component_up_line, { key: 0 })) : _createCommentVNode("v-if", true)
  ]);
}
