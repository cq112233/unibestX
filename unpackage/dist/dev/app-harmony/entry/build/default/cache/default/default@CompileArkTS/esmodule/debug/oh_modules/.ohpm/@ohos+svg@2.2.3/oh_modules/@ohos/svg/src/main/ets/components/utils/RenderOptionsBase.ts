...
import { CSS } from "@normalized:N&&&@ohos/svg/src/main/ets/components/CSS&2.2.3";
import { Box } from "@normalized:N&&&@ohos/svg/src/main/ets/components/utils/SVGBase&2.2.3";
