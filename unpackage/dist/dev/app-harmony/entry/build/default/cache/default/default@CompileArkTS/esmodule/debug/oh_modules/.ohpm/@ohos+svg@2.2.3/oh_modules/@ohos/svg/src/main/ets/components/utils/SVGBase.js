 ...
 */
import MyRect from '@normalized:N&&&@ohos/svg/src/main/ets/components/utils/Rect&2.2.3';
import { Ruleset, Source } from '@normalized:N&&&@ohos/svg/src/main/ets/components/utils/CSSParser&2.2.3';
import { SVGParseException } from '@normalized:N&&&@ohos/svg/src/main/ets/components/SVGParseException&2.2.3';
import { SVGParserImpl } from '@normalized:N&&&@ohos/svg/src/main/ets/components/utils/SVGParserImpl&2.2.3';
import { SVGExternalFileResolver } from '@normalized:N&&&@ohos/svg/src/main/ets/components/SVGExternalFileResolver&2.2.3';
...
export class TextContainer extends SvgConditionalContainer {
    addChild(elem) {
        try {
            ...
            LogUtil.error(`TextContainer; addChild err: ${err}`);
        }
    }
}
