...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n15 = _createSharedDataComponent(_sfc_main$1, "e6fcc4be", null, {
        "default": _withSharedDataVaporCtx(() => {
          _renderSharedDataEffect(() => {
            return _setSharedDataStyle(__sharedData, 5, { height: `${windowHeight.value}px` });
          });
          const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "7290b804", {
            title: "Back Top 返回顶部",
            "auto-back": true
          });
          ...
          _renderSharedDataEffect(() => {
            ...
            _setSharedData(__sharedData, 7, _toDisplayString(currentScrollTop.value));
          });
          ...
          _setSharedDataEvent(__sharedData, 4, handleScroll);
          const n13 = _createSharedDataComponentWithFallback(_component_up_back_top, "40f36818", {
            "scroll-top": () => {
