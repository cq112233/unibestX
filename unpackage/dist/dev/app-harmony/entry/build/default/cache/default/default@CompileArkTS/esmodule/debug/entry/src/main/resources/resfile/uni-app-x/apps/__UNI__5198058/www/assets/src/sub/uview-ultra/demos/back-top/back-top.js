...
import { o as onPageScroll, A as AppKu, r as resolveEasycom } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/App.ku&";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, _a) {
    ...
    const __returned__ = { scrollTop, get AppKu() {
      return AppKu;
    }, get LayoutComponent() {
          ...
          createElementVNode("view", { class: "page-container bg-__f8fafc_ min-h-screen pb-30px" }, [
            ...
            createElementVNode("view", { class: "p-16px" }, [
              createElementVNode("view", { class: "demo-block" }, [
                ...
                createElementVNode("text", { style: { "font-size": "12px", "color": "#999" } }, "请向下滑动页面，右下角会出现返回顶部按钮"),
                createElementVNode("view", { style: { "height": "1000px", "display": "flex", "align-items": "center", "justify-content": "center", "background": "linear-gradient(to bottom, #f3f4f6, #e5e7eb)" } }, [
                  createElementVNode("text", { style: { "color": "#999" } }, "继续向下滚动")
                ]),
                createVNode(_component_up_back_top, { "scroll-top": $setup.scrollTop }, null, 8, ["scroll-top"])
              ])
            ])
          ])
        ]),
