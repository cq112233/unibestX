...
import { _ as __easycom_1 } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/rice-ui/components/rice-scroll-x/rice-scroll-x&";
...
const __className = "GenSrcSubRiceUiDemosScrollXScrollX";
const { computed } = globalThis.Vue;
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  __dynamicSharedData: true,
  __hash: "6bf0df30",
  __className,
  __filename: "src/sub/rice-ui/demos/scroll-x/scroll-x.uvue",
  __name: "scroll-x",
  setup(__props) {
    const __sharedDataRenderer = _useSharedDataRenderer();
    const __sharedData = __sharedDataRenderer == "component" ? _withSharedDataComponent(new UniDynamicSharedDataComponent(_useSharedDataScope(), _useSharedDataComponentOptions({ bundleKey: "GenSrcSubRiceUiDemosScrollXScrollXSharedData", sharedDataClassId: 0 }))) : _withSharedDataPage(new UniDynamicSharedDataPage(_useSharedDataPageId(), _useSharedDataPageOptions({ bundleKey: "GenSrcSubRiceUiDemosScrollXScrollXSharedData", sharedDataClassId: 0 })));
    ...
    return () => {
      ...
      const _component_rice_scroll_x = __easycom_1;
      const n11 = _createSharedDataComponent(_sfc_main$1, "027778c6", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "4c77a0c7", {
            title: "ScrollX 横向滚动",
            "auto-back": true,
          ...
          const n7 = _createSharedDataComponentWithFallback(_component_rice_scroll_x, "427c6608", { "indicator-active-color": () => {
            ...
            "default": () => {
              _createSharedDataFor(_setSharedDataScoped(__sharedData, 3, _createSharedDataVFor(__sharedDataScope, () => {
                ...
                _renderSharedDataEffect(() => {
                  _setSharedDataStyle(__sharedData_VFor0, 1, { backgroundColor: currentTheme.value });
...
const _style_0 = {};
const _style_1 = {};
const scrollX = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0, _style_1]]]);
export {
  scrollX as default
};
