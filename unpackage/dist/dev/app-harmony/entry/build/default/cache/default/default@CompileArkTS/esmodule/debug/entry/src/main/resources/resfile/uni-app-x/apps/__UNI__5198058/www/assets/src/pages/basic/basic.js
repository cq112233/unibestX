...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      "raw js";
      const n17 = _createSharedDataComponent(_sfc_main$1, "56ab5a5a", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n16 = _createSharedDataComponent(_sfc_main$2, "7ebff0fa", {
            "navigation-bar-title-text": "基础",
            "disable-scroll": true
          }, {
            "default": _withSharedDataVaporCtx(() => {
              const n0 = _createSharedDataComponent(UViewUltraDemoCard, "5360ec54");
              _setSharedData(__sharedData, 2, n0.sharedData);
              const n1 = _createSharedDataComponent(LodashDemoCard, "5360ed4e");
              _setSharedData(__sharedData, 3, n1.sharedData);
              const n2 = _createSharedDataComponent(CryptoDemoCard, "5360f0ae");
              _setSharedData(__sharedData, 4, n2.sharedData);
              const n3 = _createSharedDataComponent(PropsDemoCard, "5360f3f6");
              _setSharedData(__sharedData, 5, n3.sharedData);
              const n4 = _createSharedDataComponent(ZPagingDemoCard, "5360f4cd");
              _setSharedData(__sharedData, 6, n4.sharedData);
              const n5 = _createSharedDataComponent(SystemInfoDemoCard, "5360f7fb");
              _setSharedData(__sharedData, 7, n5.sharedData);
              const n6 = _createSharedDataComponent(IconDemoCard, "5360fb56");
              _setSharedData(__sharedData, 8, n6.sharedData);
              const n7 = _createSharedDataComponent(LangSwitchCard, "5360fbf7");
              _setSharedData(__sharedData, 9, n7.sharedData);
              const n8 = _createSharedDataComponent(ThemeSwitchCard, "5360ff39");
              _setSharedData(__sharedData, 10, n8.sharedData);
              const n9 = _createSharedDataComponent(TimeDemoCard, "53610014");
              _setSharedData(__sharedData, 11, n9.sharedData);
              const n10 = _createSharedDataComponent(RouterDemoCard, "53610356");
              _setSharedData(__sharedData, 12, n10.sharedData);
              const n11 = _createSharedDataComponent(HttpDemoCard, "5361069c");
              _setSharedData(__sharedData, 13, n11.sharedData);
              const n12 = _createSharedDataComponent(EchartsDemoCard, "53610754");
              _setSharedData(__sharedData, 14, n12.sharedData);
              const n13 = _createSharedDataComponent(SignatureCard, "18bc2a1d");
              _setSharedData(__sharedData, 15, n13.sharedData);
            })
          });
