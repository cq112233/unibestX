...
import { b as addStyle, a as addUnit, k as error } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/libs/function/index&";
  ...
  setup(__props, _a) {
    ...
    return () => {
      ...
      _renderSharedDataEffect(() => {
        ...
        _setSharedDataStyle(__sharedData, 16, [_unref(addStyle)(__props.customStyle), {
        ...
        _createSharedDataIf(() => {
          ...
          _renderSharedDataEffect(() => {
            ...
            _setSharedDataStyle(__sharedData, 9, {
              width: _unref(addUnit)(_labelWidth != "" ? _labelWidth : _parentData["labelWidth"]),
          ...
          _createSharedDataIf(() => {
            ...
            const n9 = _createSharedDataComponentWithFallback(_component_up_icon, "5543a486", {
              name: () => {
        ...
        _createSharedDataIf(() => {
          ...
          _renderSharedDataEffect(() => {
            ...
            _setSharedDataStyle(__sharedData, 1, {
              marginLeft: _unref(addUnit)((__props.labelPosition ?? _parentData["labelPosition"]) == "top" ? 0 : _labelWidth != null ? _labelWidth : _parentData["labelWidth"])
            });
      ...
      _createSharedDataIf(() => {
        ...
        const n31 = _createSharedDataComponentWithFallback(_component_up_line, "5542ab3e", {
          color: () => {
