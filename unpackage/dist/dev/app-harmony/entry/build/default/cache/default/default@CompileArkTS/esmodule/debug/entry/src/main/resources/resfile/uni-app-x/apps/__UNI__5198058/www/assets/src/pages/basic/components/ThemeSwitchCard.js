...
import { $ as $t, t } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/src/utils/i18n&";
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock(), _createBlock($setup["Card"], {
    title: $setup.$t("basic.themeTitle")
  }, {
    default: _withCtx(() => [
      _createElementVNode("view", { class: "rounded-12px p-16px mb-16px border-width-1px border-style-solid border-color-__e2e8f0_ items-center" }, [
        _createElementVNode(
          ...
          _toDisplayString($setup.$t("basic.themePreview")),
          1
          /* TEXT */
        ),
        _createElementVNode(
          ...
          [
            _createElementVNode(
              ...
              _toDisplayString($setup.$t("basic.themeButton")),
              1
              /* TEXT */
            )
          ],
