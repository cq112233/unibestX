      ...
      const n13 = _createSharedDataComponent(AppKu, "2c6a817e", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n12 = _createSharedDataComponent(LayoutComponent, "4f8d28d5", {
            ...
            "default": _withSharedDataVaporCtx(() => {
              const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "bbd01b08", {
                title: "Divider 分割线",
                "auto-back": true
              });
              _setSharedData(__sharedData, 2, n0?.sharedData);
              const n2 = _createSharedDataComponentWithFallback(_component_up_divider, "bbd00cf4", { text: "分割线" });
              _setSharedData(__sharedData, 3, n2?.sharedData);
              const n5 = _createSharedDataComponentWithFallback(_component_up_divider, "bbd00480", {
                text: "虚线分割",
                dashed: ""
              });
              _setSharedData(__sharedData, 4, n5?.sharedData);
              const n8 = _createSharedDataComponentWithFallback(_component_up_divider, "bbcff6ba", {
                text: "半截",
                "half-width": ""
              });
...
const _style_0 = {};
const divider = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0]]]);
export {
  divider as default
};
