...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  const _component_up_divider = resolveEasycom(resolveDynamicComponent("up-divider"), __easycom_1);
        ...
        default: withCtx(() => [
          createElementVNode("view", { class: "page-container bg-__f8fafc_ min-h-screen pb-30px" }, [
            ...
            createElementVNode("view", { class: "p-16px" }, [
              ...
              createElementVNode("view", { class: "demo-block" }, [
                createElementVNode("text", { class: "demo-label" }, "虚线类型"),
              ...
              createElementVNode("view", { class: "demo-block" }, [
                createElementVNode("text", { class: "demo-label" }, "半截分割线"),
                createVNode(_component_up_divider, {
                  text: "半截",
                  "half-width": ""
                })
