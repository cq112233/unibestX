...
import { p as propsNavbar } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/components/up-navbar/props&";
...
import { a as addUnit, g as getPx, b as addStyle } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/libs/function/index&";
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return _openBlock(), _createElementBlock(
    "view",
    {
      class: _normalizeClass(["up-navbar", [_ctx.customClass]])
    },
    [
      ...
      _createElementVNode(
        "view",
        {
          class: _normalizeClass([_ctx.fixed ? "up-navbar--fixed" : ""])
        },
        [
          _ctx.safeAreaInsetTop ? (_openBlock(), _createBlock(_component_up_status_bar, {
            key: 0,
          ...
          _createElementVNode(
            "view",
            {
              class: _normalizeClass(["up-navbar__content", [_ctx.border ? "up-border-bottom" : ""]]),
              style: _normalizeStyle({
            ...
            [
              _createElementVNode("view", {
                ...
                _renderSlot(_ctx.$slots, "left", {}, () => [
                  _ctx.leftIcon ? (_openBlock(), _createBlock(_component_up_icon, {
                    key: 0,
                    name: _ctx.leftIcon,
                    size: _ctx.leftIconSize,
                    color: _ctx.leftIconColor
                  }, null, 8, ["name", "size", "color"])) : _createCommentVNode("v-if", true),
                  _ctx.leftText ? (_openBlock(), _createElementBlock(
                    "text",
                    {
                      key: 1,
                      style: _normalizeStyle({
                    ...
                    _toDisplayString(_ctx.leftText),
                    5
                    /* TEXT, STYLE */
                  )) : _createCommentVNode("v-if", true)
                ])
              ...
              _ctx.$slots["right"] != null || _ctx.rightIcon != "" || _ctx.rightText != "" ? (_openBlock(), _createElementBlock("view", {
                key: 0,
                class: "up-navbar__content__right",
                onClick: _cache[1] || (_cache[1] = (...args) => $options.rightClick && $options.rightClick(...args))
              }, [
                _renderSlot(_ctx.$slots, "right", {}, () => [
                  _ctx.rightIcon ? (_openBlock(), _createBlock(_component_up_icon, {
                    key: 0,
                    name: _ctx.rightIcon,
                    size: "20"
                  }, null, 8, ["name"])) : _createCommentVNode("v-if", true),
                  _ctx.rightText ? (_openBlock(), _createElementBlock(
                    "text",
                    {
                      key: 1,
