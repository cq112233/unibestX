  ...
  setup(__props, _a) {
    ...
    return () => {
      ...
      _createSharedDataIf(() => {
        ...
        const n5 = _createSharedDataComponentWithFallback(_component_up_status_bar, "05520ce6", { bgColor: () => {
      ...
      _renderSharedDataEffect(() => {
        ...
        _setSharedDataStyle(__sharedData, 21, {
      ...
      _createSharedDataSlot("left", null, null, () => {
        _createSharedDataIf(() => {
          ...
          const n10 = _createSharedDataComponentWithFallback(_component_up_icon, "0551edae", {
            name: () => {
        ...
        _createSharedDataIf(() => {
          ...
          _renderSharedDataEffect(() => {
            _setSharedDataStyle(__sharedData, 15, {
      ...
      _createSharedDataSlot("center", null, null, () => {
        _renderSharedDataEffect(() => {
          _setSharedDataStyle(__sharedData, 4, [{
            width: _unref(addUnit)(__props.titleWidth)
          }, _unref(addStyle)(__props.titleStyle)]);
      ...
      _createSharedDataIf(() => {
        ...
        _createSharedDataSlot("right", null, null, () => {
          _createSharedDataIf(() => {
            ...
            const n24 = _createSharedDataComponentWithFallback(_component_up_icon, "a4f072a4", {
              name: () => {
