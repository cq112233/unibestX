...
import { _ as _sfc_main$2 } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/rice-ui/components/rice-datetime-picker/rice-datetime-picker&";
...
import "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/rice-ui/components/rice-picker/rice-picker&";
import "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/rice-ui/components/rice-overlay/rice-overlay&";
...
import "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/rice-ui/components/rice-picker/utils&";
import "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/rice-ui/components/rice-picker/style&";
import "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/rice-ui/libs/plugin/dateuts/index&";
import "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/rice-ui/libs/plugin/dateuts/utils&";
import "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/rice-ui/libs/plugin/dateuts/constant&";
import "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/rice-ui/components/rice-datetime-picker/utils&";
...
const __className = "GenSrcSubRiceUiDemosDatetimePickerDatetimePicker";
...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  __hash: "7a4e6745",
  __className,
  __filename: "src/sub/rice-ui/demos/datetime-picker/datetime-picker.uvue",
  __name: "datetime-picker",
  setup(__props) {
    const __sharedDataRenderer = _useSharedDataRenderer();
    const __sharedData = __sharedDataRenderer == "component" ? _withSharedDataComponent(new UniDynamicSharedDataComponent(_useSharedDataScope(), _useSharedDataComponentOptions({ bundleKey: "GenSrcSubRiceUiDemosDatetimePickerDatetimePickerSharedData", sharedDataClassId: 0 }))) : _withSharedDataPage(new UniDynamicSharedDataPage(_useSharedDataPageId(), _useSharedDataPageOptions({ bundleKey: "GenSrcSubRiceUiDemosDatetimePickerDatetimePickerSharedData", sharedDataClassId: 0 })));
    _useSharedDataScope(__sharedData);
    const appStore = useAppStore();
    const currentTheme = computed(() => {
      return appStore.state.theme;
    });
    const currentDate = ref("2026-08-15");
    ...
    return () => {
      ...
      const _component_rice_datetime_picker = _sfc_main$2;
      const n15 = _createSharedDataComponent(_sfc_main$1, "109d6f90", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "031080d6", {
          ...
          const n2 = _createSharedDataComponentWithFallback(_component_rice_datetime_picker, "5effb61a", {
            modelValue: () => {
              return _unref(currentDate);
            },
            "onUpdate:modelValue": () => {
              return (_value) => {
                return _isRef(currentDate) ? currentDate.value = _value : null;
              };
            },
            type: "date",
            "use-popup": false,
          ...
          _renderSharedDataEffect(() => {
            _setSharedData(__sharedData, 5, _toDisplayString(_unref(currentDate)));
            _setSharedDataStyle(__sharedData, 6, { borderLeftColor: currentTheme.value });
          });
          const n8 = _createSharedDataComponentWithFallback(_component_rice_datetime_picker, "3f82ff39", {
            modelValue: () => {
              return _unref(currentTime);
            },
            "onUpdate:modelValue": () => {
              return (_value) => {
                return _isRef(currentTime) ? currentTime.value = _value : null;
              };
            },
            type: "time",
            "use-popup": false,
          ...
          _renderSharedDataEffect(() => {
            return _setSharedData(__sharedData, 7, _toDisplayString(_unref(currentTime)));
          });
        })
      });
...
const _style_0 = {};
const _style_1 = {};
const datetimePicker = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0, _style_1]]]);
export {
