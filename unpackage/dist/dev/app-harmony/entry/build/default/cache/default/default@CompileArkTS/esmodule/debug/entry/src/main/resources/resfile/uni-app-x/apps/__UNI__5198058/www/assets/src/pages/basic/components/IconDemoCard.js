      ...
      const n26 = _createSharedDataComponent(
        ...
        } },
        {
          "default": _withSharedDataVaporCtx(() => {
            const n3 = _createSharedDataComponentWithFallback(_component_uni_icons, "f7cb05a0", {
              type: "contact",
              size: "26",
            ...
            const n14 = _createSharedDataComponentWithFallback(_component_l_icon, "01986faa", {
              name: "circle",
              size: "24",
              style: "color: #10b981; margin-right: 8px;"
            });
            _setSharedData(__sharedData, 2, n14?.sharedData);
            const n22 = _createSharedDataComponentWithFallback(_component_up_icon, "019841ec", {
              name: "setting",
              size: "24",
