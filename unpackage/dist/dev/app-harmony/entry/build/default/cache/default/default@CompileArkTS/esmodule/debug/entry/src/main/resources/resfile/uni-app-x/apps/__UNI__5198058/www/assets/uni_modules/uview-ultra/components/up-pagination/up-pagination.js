...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return $options.shouldShow ? (_openBlock(), _createElementBlock("view", {
    key: 0,
    class: "up-pagination"
  }, [
    _createElementVNode(
    ...
    $options.showPager ? (_openBlock(true), _createElementBlock(
      _Fragment,
      { key: 0 },
      _renderList($options.displayedPages, (page, index) => {
        return _openBlock(), _createElementBlock("view", {
          key: index,
          class: _normalizeClass(["up-pagination-item", { "item-active": page == $options.currentPageStr }]),
          onClick: ($event) => $options.goTo(page)
        }, [
          _createElementVNode(
            "text",
            {
              class: _normalizeClass(["up-pagination-text", { "text-active": page == $options.currentPageStr }])
            },
    ...
    $options.showTotal ? (_openBlock(), _createElementBlock("view", {
      key: 1,
    ...
    _createElementVNode(
      "view",
      {
        class: _normalizeClass(["up-pagination-btn", { "btn-disabled": $props.currentPage >= $options.totalPages }]),
        style: _normalizeStyle({ backgroundColor: $props.buttonBgColor, borderColor: $props.buttonBorderColor }),
