...
import { b as addStyle, a as addUnit, t as toast } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/libs/function/index&";
import { i as image, v as video, f as func } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/libs/function/test&";
  ...
  setup(__props, _a) {
    ...
    return () => {
      ...
      _renderSharedDataEffect(() => {
        return _setSharedDataStyle(__sharedData, 17, [_unref(addStyle)(__props.customStyle)]);
      });
      _createSharedDataIf(() => {
        ...
        _createSharedDataFor(_setSharedDataScoped(__sharedData, 4, _createSharedDataVFor(__sharedDataScope, () => {
          ...
          _createSharedDataIf(() => {
            ...
            _renderSharedDataEffect(() => {
              ...
              _setSharedDataStyle(__sharedData_VFor0, 5, [{
                width: _addUnit(__props.width),
                height: _addUnit(__props.height)
              }]);
            });
          }, () => {
            return _createSharedDataIf(() => {
              ...
              _renderSharedDataEffect(() => {
                const _addUnit = _unref(addUnit);
                _setSharedDataStyle(__sharedData_VFor0, 17, {
                  width: _addUnit(__props.width),
                  height: _addUnit(__props.height)
                });
              });
              _createSharedDataIf(() => {
                ...
                _renderSharedDataEffect(() => {
                  ...
                  _setSharedDataStyle(__sharedData_VFor0, 11, [{
                    width: _addUnit(__props.width),
                    height: _addUnit(__props.height)
                  }]);
                });
              }, () => {
                const n12 = _createSharedDataComponentWithFallback(_component_up_icon, "e86253b4-" + _for_key0.value, {
                  color: "#80CBF9",
                  size: "26",
                  name: () => {
              ...
              _createSharedDataIf(() => {
                ...
                _createSharedDataIf(() => {
                  ...
                  const n18 = _createSharedDataComponentWithFallback(_component_up_icon, "e86236a6-" + _for_key0.value, {
              ...
              _renderSharedDataEffect(() => {
                const _addUnit = _unref(addUnit);
                _setSharedDataStyle(__sharedData_VFor0, 20, [{
                  width: _addUnit(__props.width),
                  height: _addUnit(__props.height)
                }]);
              });
              const n22 = _createSharedDataComponentWithFallback(_component_up_icon, "e8621e2e-" + _for_key0.value, {
                color: "#80CBF9",
                size: "26",
                name: () => {
              ...
              _renderSharedDataEffect(() => {
                const _item = _for_item0.value;
                const _$t = _unref(t);
                const _item_type = _item.type;
                const _item_name = _item.name;
                _setSharedData(__sharedData_VFor0, 21, _toDisplayString(_item.isVideo || _item_type != null && _item_type === "video" ? _item_name != null ? _item_name : _$t("up.common.video") : _item_name != null ? _item_name : _$t("up.common.file")));
              });
            }, 517);
          }, 261);
          _createSharedDataIf(() => {
            ...
            _createSharedDataIf(() => {
              ...
              const n29 = _createSharedDataComponentWithFallback(_component_up_icon, "e8614de4-" + _for_key0.value, {
                name: "close-circle",
                color: "#ffffff",
                size: "25"
              });
              ...
              const n31 = _createSharedDataComponentWithFallback(_component_up_loading_icon, "e8614530-" + _for_key0.value, {
                size: "22",
                mode: "circle"
              });
            ...
            _createSharedDataIf(() => {
              return _setSharedData(__sharedData_VFor0, 23, _toSharedDataBoolean(_for_item0.value.message));
            }, () => {
              _renderSharedDataEffect(() => {
                return _setSharedData(__sharedData_VFor0, 24, _toDisplayString(_for_item0.value.message));
              });
            });
            const n36 = _createSharedDataComponentWithFallback(_component_up_gap, "e8613570-" + _for_key0.value, {
              class: "up-upload__progress",
              height: "3px",
              style: () => {
                return { width: (_for_item0.value.progress ?? 0) + "%" };
              }
            });
          ...
          _createSharedDataIf(() => {
            ...
            const n40 = _createSharedDataComponentWithFallback(_component_up_icon, "e8607af2-" + _for_key0.value, {
              name: "close",
              color: "#ffffff",
              size: "10"
            });
          ...
          _createSharedDataSlot("success", null, null, () => {
            _createSharedDataIf(() => {
              ...
              const n47 = _createSharedDataComponentWithFallback(_component_up_icon, "e8606466-" + _for_key0.value, {
                name: "checkmark",
                color: "#ffffff",
                size: "12"
              });
      ...
      _createSharedDataIf(() => {
        ...
        _createSharedDataIf(() => {
          ...
          return _createSharedDataIf(() => {
            ...
            const n62 = _createSharedDataComponentWithFallback(_component_up_icon, "e85f89ae", {
              name: () => {
      ...
      const n72 = _createSharedDataComponentWithFallback(_component_up_popup, "e85f741e", {
        mode: "center",
        show: () => {
        ...
        "default": _withSharedDataVaporCtx(() => {
          _createSharedDataIf(() => {
            ...
            const n71 = _createSharedDataComponentWithFallback(_component_video, "e85f72ac", {
              id: "myVideo",
              src: () => {
