...
const _sfc_main = /* @__PURE__ */ _defineComponent({
  ...
  setup(__props, _a) {
    ...
    const __returned__ = { props, emit, lists, isInCount, popupShow, currentItemIndex, formatFileList, videoErrorCallback, onChooseTap, chooseFileAction, convertFileToUTSJSON, getDetail, onBeforeRead, onAfterRead, deleteItem, onPreviewImage, onPreviewVideo, onClickPreview, get addStyle() {
      return addStyle;
    }, get addUnit() {
      return addUnit;
    }, get $t() {
            ...
            return _openBlock(), _createElementBlock("view", {
              ...
              item.isImage || item.type != null && item.type === "image" ? (_openBlock(), _createElementBlock("image", {
                ...
                style: _normalizeStyle([{
                  width: $setup.addUnit($props.width),
                ...
                _createElementVNode(
                  ...
                  _toDisplayString(item.isVideo || item.type != null && item.type === "video" ? item.name != null ? item.name : $setup.$t("up.common.video") : item.name != null ? item.name : $setup.$t("up.common.file")),
                  1
                  /* TEXT */
                )
              ], 12, ["onClick"])),
