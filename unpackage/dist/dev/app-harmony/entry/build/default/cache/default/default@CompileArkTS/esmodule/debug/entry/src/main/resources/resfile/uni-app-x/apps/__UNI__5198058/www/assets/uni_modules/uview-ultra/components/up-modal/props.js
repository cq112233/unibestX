...
import { d as defProps } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/components/up-modal/modal&";
let crtProp = defProps["modal"];
const propsModal = {
  props: {
    // 是否展示modal
    show: {
