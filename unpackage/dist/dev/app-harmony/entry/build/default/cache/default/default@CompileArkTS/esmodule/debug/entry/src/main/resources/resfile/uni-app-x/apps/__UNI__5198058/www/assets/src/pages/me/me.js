...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      "raw js";
      const n24 = _createSharedDataComponent(_sfc_main$1, "69b481fa", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n23 = _createSharedDataComponent(_sfc_main$2, "ccdbbd5a", { "navigation-bar-title-text": "我的" }, {
            "default": () => {
              _renderSharedDataEffect(() => {
                const _userStore = _unref(userStore);
                const _userStore_state = _userStore.state;
                _setSharedDataAttr(__sharedData, 7, _toSharedDataString(_unref(avatarUrl)));
              ...
              _renderSharedDataEffect(() => {
                ...
                _setSharedDataClass(__sharedData, 9, ["text-12px px-12px py-4px rounded-20px font-medium overflow-hidden", _tokenStore.hasValidLogin() ? "bg-__d1fae5_ text-__065f46_" : "bg-__f1f5f9_ text-__64748b_"]);
                _setSharedData(__sharedData, 10, _toDisplayString(_tokenStore.hasValidLogin() ? "已登录" : "未登录"));
                _setSharedData(__sharedData, 11, _toDisplayString(_unref(userInfoJson)));
              });
              _createSharedDataIf(() => {
