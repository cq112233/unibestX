          ...
          _createElementVNode("view", { class: "page-container bg-_b_hf8fafc_B min-h-screen pb-_b30px_B" }, [
            ...
            _createElementVNode("view", { class: "p-_b16px_B" }, [
                  ...
                  _createVNode(_component_up_transition, {
                    ...
                    default: _withCtx(() => [
                      _createElementVNode("view", { class: "transition-demo-box transition-demo-blue" }, [
                        _createElementVNode("text", { class: "text-_b14px_B text-white font-_b500_B" }, "fade 淡入淡出")
                      ])
                    ]),
                    _: 1
                    /* STABLE */
                  }, 8, ["show"]),
                  _createElementVNode("view", { class: "mt-_b10px_B" }, [
                  ...
                  _createVNode(_component_up_transition, {
                    ...
                    default: _withCtx(() => [
                      _createElementVNode("view", { class: "transition-demo-box bg-_b_h19be6b_B" }, [
                        _createElementVNode("text", { class: "text-_b14px_B text-white font-_b500_B" }, "zoom 缩放")
                      ])
                    ]),
                    _: 1
                    /* STABLE */
              ...
              _createElementVNode("view", { class: "demo-block mt-_b12px_B" }, [
                  ...
                  _createVNode(_component_up_transition, {
                    ...
                    default: _withCtx(() => [
                      _createElementVNode("view", { class: "transition-demo-box bg-_b_hf56c6c_B" }, [
                        _createElementVNode("text", { class: "text-_b14px_B text-white font-_b500_B" }, "slide 滑动")
                      ])
                    ]),
                    _: 1
                    /* STABLE */
                ...
                _createElementVNode("view", { class: "flex-row items-center justify-around mt-_b10px_B" }, [
                  _createVNode(_component_up_button, {
                    type: "primary",
                    text: "上滑",
                    size: "mini",
