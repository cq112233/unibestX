...
import { _ as __easycom_1 } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/components/up-checkbox/up-checkbox&";
import { _ as __easycom_2 } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/components/up-checkbox-group/up-checkbox-group&";
...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n22 = _createSharedDataComponent(_sfc_main$1, "53588ab2", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "17b8c9f4", {
          ...
          const n4 = _createSharedDataComponentWithFallback(_component_up_checkbox_group, "df609a32", {
            modelValue: () => {
            ...
            "default": _withSharedDataVaporCtx(() => {
              const n2 = _createSharedDataComponentWithFallback(_component_up_checkbox, "df609842", {
                name: "apple",
                label: "苹果",
                class: "mb-10px mr-20px"
              });
              _setSharedData(__sharedData, 3, n2?.sharedData);
              const n3 = _createSharedDataComponentWithFallback(_component_up_checkbox, "df609130", {
                name: "banana",
                label: "香蕉",
                class: "mb-10px mr-20px"
              });
          ...
          const n9 = _createSharedDataComponentWithFallback(_component_up_checkbox_group, "df6081bc", {
            modelValue: () => {
            ...
            "default": _withSharedDataVaporCtx(() => {
              const n7 = _createSharedDataComponentWithFallback(_component_up_checkbox, "df607b66", {
                name: "apple",
                label: "苹果(禁用)",
                disabled: true,
                class: "mb-10px mr-20px"
              ...
              const n8 = _createSharedDataComponentWithFallback(_component_up_checkbox, "df6073ac", {
                name: "banana",
                label: "香蕉(未禁用)",
                class: "mb-10px mr-20px"
              });
          ...
          const n14 = _createSharedDataComponentWithFallback(_component_up_checkbox_group, "79a5c22a", {
            modelValue: () => {
            ...
            "default": _withSharedDataVaporCtx(() => {
              const n12 = _createSharedDataComponentWithFallback(_component_up_checkbox, "79a5c56a", {
                name: "circle",
                label: "圆形",
                shape: "circle",
                "active-color": "#fa3534",
              ...
              const n13 = _createSharedDataComponentWithFallback(_component_up_checkbox, "79a5c96e", {
                name: "square",
                label: "方形",
                shape: "square",
                "active-color": "#ff9900",
          ...
          const n18 = _createSharedDataComponentWithFallback(_component_up_checkbox_group, "79a5d431", {
            modelValue: () => {
            ...
            "default": _withSharedDataVaporCtx(() => {
              const n17 = _createSharedDataComponentWithFallback(_component_up_checkbox, "79a5d4d1", {
                name: "label",
                label: "只能点框框",
                "label-disabled": true,
                class: "mb-10px mr-20px"
