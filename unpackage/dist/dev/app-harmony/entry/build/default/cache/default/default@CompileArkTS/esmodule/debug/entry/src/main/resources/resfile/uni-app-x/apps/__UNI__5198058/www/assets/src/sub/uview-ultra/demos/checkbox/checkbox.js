...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, _a) {
    ...
    function checkboxChange(n) {
      uni.__f__("log", "at src/sub/uview-ultra/demos/checkbox/checkbox.uvue:23", "checkbox change", n);
    }
    const __returned__ = { checkboxValue, checkboxChange, get AppKu() {
      return AppKu;
    }, get LayoutComponent() {
...
const _style_0 = { "bg-__f8fafc_": { "": { "backgroundImage": "none", "backgroundColor": "#f8fafc" } }, "mb-10px": { "": { "marginBottom": 10 } }, "mr-20px": { "": { "marginRight": 20 } }, "p-16px": { "": { "paddingTop": 16, "paddingRight": 16, "paddingBottom": 16, "paddingLeft": 16 } }, "pb-30px": { "": { "paddingBottom": 30 } } };
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  const _component_up_checkbox = resolveEasycom(resolveDynamicComponent("up-checkbox"), __easycom_1);
  const _component_up_checkbox_group = resolveEasycom(resolveDynamicComponent("up-checkbox-group"), __easycom_2);
...
const checkbox = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["styles", [_style_0, _style_1]], ["__file", "/Users/chenqi/Documents/chenqi-front/unibestX/src/sub/uview-ultra/demos/checkbox/checkbox.uvue"]]);
export {
  checkbox as default
};
