const { defineComponent, computed, ref, onMounted, nextTick, watchEffect, onUnmounted, openBlock, createElementBlock, normalizeStyle, createElementVNode } = globalThis.Vue
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock(
    "view",
    {
      class: "l-signature",
      ref: "signatureRef",
      style: normalizeStyle([$setup.drawableStyle])
    },
    [
      createElementVNode(
        "canvas",
