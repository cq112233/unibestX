import { p as propsTextarea } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/components/up-textarea/props&";
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock(), _createElementBlock(
    "view",
    {
      class: _normalizeClass(["up-textarea", $options.textareaClass]),
      style: _normalizeStyle($options.textareaStyle)
    },
    [
      ...
      _ctx.count ? (_openBlock(), _createElementBlock(
        "text",
        {
          key: 0,
        ...
        _toDisplayString($data.innerValue.length) + "/" + _toDisplayString(_ctx.maxlength),
        5
        /* TEXT, STYLE */
