import { d as deepMerge, b as addStyle, a as addUnit, i as formValidate } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/libs/function/index&";
  ...
  setup(__props, _a) {
    ...
    return () => {
      ...
      const n0 = _createSharedDataComponentWithFallback(_component_textarea, "53749956", {
        ...
        style: () => {
          return { height: _unref(addUnit)(__props.height) };
        },
        placeholder: () => {
