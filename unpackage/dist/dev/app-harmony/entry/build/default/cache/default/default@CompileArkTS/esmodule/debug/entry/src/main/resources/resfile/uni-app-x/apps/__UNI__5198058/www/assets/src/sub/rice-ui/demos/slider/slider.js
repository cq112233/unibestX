...
import { _ as __easycom_1 } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/rice-ui/components/rice-slider/rice-slider&";
...
const __className = "GenSrcSubRiceUiDemosSliderSlider";
...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  __hash: "56d28ea3",
  __className,
  __filename: "src/sub/rice-ui/demos/slider/slider.uvue",
  __name: "slider",
  setup(__props) {
    const __sharedDataRenderer = _useSharedDataRenderer();
    const __sharedData = __sharedDataRenderer == "component" ? _withSharedDataComponent(new UniDynamicSharedDataComponent(_useSharedDataScope(), _useSharedDataComponentOptions({ bundleKey: "GenSrcSubRiceUiDemosSliderSliderSharedData", sharedDataClassId: 0 }))) : _withSharedDataPage(new UniDynamicSharedDataPage(_useSharedDataPageId(), _useSharedDataPageOptions({ bundleKey: "GenSrcSubRiceUiDemosSliderSliderSharedData", sharedDataClassId: 0 })));
    ...
    return () => {
      ...
      const _component_rice_slider = __easycom_1;
      const n15 = _createSharedDataComponent(_sfc_main$1, "b70a31b0", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "2a3c02b6", {
            title: "Slider 滑块",
            "auto-back": true,
          ...
          const n2 = _createSharedDataComponentWithFallback(_component_rice_slider, "715dc446", {
            modelValue: () => {
              return _unref(val1);
            },
            "onUpdate:modelValue": () => {
              return (_value) => {
                return _isRef(val1) ? val1.value = _value : null;
              };
            },
            "active-color": () => {
          ...
          _renderSharedDataEffect(() => {
            _setSharedData(__sharedData, 5, _toDisplayString(_unref(val1)));
            _setSharedDataStyle(__sharedData, 6, { borderLeftColor: currentTheme.value });
          });
          const n8 = _createSharedDataComponentWithFallback(_component_rice_slider, "715dd60c", {
            modelValue: () => {
              return _unref(val2);
            },
            "onUpdate:modelValue": () => {
              return (_value) => {
                return _isRef(val2) ? val2.value = _value : null;
              };
            },
            step: 10,
            "active-color": () => {
          ...
          _renderSharedDataEffect(() => {
            return _setSharedData(__sharedData, 7, _toDisplayString(_unref(val2)));
          });
        })
      });
