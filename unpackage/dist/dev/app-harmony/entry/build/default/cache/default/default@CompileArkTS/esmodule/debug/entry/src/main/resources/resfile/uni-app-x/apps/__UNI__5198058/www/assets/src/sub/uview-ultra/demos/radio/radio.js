...
import { _ as __easycom_1 } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/components/up-radio/up-radio&";
import { _ as __easycom_2 } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/components/up-radio-group/up-radio-group&";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, _a) {
    ...
    function radioChange(n) {
      uni.__f__("log", "at src/sub/uview-ultra/demos/radio/radio.uvue:48", "radio change", n);
    }
    const __returned__ = { radioValue, radioValue2, radioValue3, radioValue4, radioChange, get AppKu() {
      return AppKu;
    }, get LayoutComponent() {
...
const _style_0 = { "bg-__f8fafc_": { "": { "backgroundImage": "none", "backgroundColor": "#f8fafc" } }, "mb-10px": { "": { "marginBottom": 10 } }, "mr-20px": { "": { "marginRight": 20 } }, "mt-12px": { "": { "marginTop": 12 } }, "p-16px": { "": { "paddingTop": 16, "paddingRight": 16, "paddingBottom": 16, "paddingLeft": 16 } }, "pb-30px": { "": { "paddingBottom": 30 } } };
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  const _component_up_radio = resolveEasycom(resolveDynamicComponent("up-radio"), __easycom_1);
  const _component_up_radio_group = resolveEasycom(resolveDynamicComponent("up-radio-group"), __easycom_2);
            ...
            createElementVNode("view", { class: "p-16px" }, [
              createElementVNode("view", { class: "demo-block" }, [
                ...
                createVNode(_component_up_radio_group, {
                  ...
                  "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => $setup.radioValue = $event),
              ...
              createElementVNode("view", { class: "demo-block mt-12px" }, [
                ...
                createVNode(_component_up_radio_group, {
                  modelValue: $setup.radioValue2,
                  "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => $setup.radioValue2 = $event)
                }, {
                  default: withCtx(() => [
                    createVNode(_component_up_radio, {
                      name: "apple",
              ...
              createElementVNode("view", { class: "demo-block mt-12px" }, [
                createElementVNode("text", { class: "demo-label" }, "自定义形状与颜色"),
                createVNode(_component_up_radio_group, {
                  modelValue: $setup.radioValue3,
                  "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => $setup.radioValue3 = $event)
                }, {
                  default: withCtx(() => [
                    createVNode(_component_up_radio, {
                      name: "square",
              ...
              createElementVNode("view", { class: "demo-block mt-12px" }, [
                createElementVNode("text", { class: "demo-label" }, "禁止点击标签切换"),
                createVNode(_component_up_radio_group, {
                  modelValue: $setup.radioValue4,
                  "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => $setup.radioValue4 = $event)
                }, {
                  default: withCtx(() => [
                    createVNode(_component_up_radio, {
                      name: "label",
...
const radio = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["styles", [_style_0, _style_1]], ["__file", "/Users/chenqi/Documents/chenqi-front/unibestX/src/sub/uview-ultra/demos/radio/radio.uvue"]]);
export {
  radio as default
};
