...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n23 = _createSharedDataComponent(_sfc_main$1, "511dc37e", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "16b2aaac", {
            title: "up-radio 单选框",
            "auto-back": true,
          ...
          const n4 = _createSharedDataComponentWithFallback(_component_up_radio_group, "80bad544", {
            modelValue: () => {
            ...
            "default": _withSharedDataVaporCtx(() => {
              const n2 = _createSharedDataComponentWithFallback(_component_up_radio, "80bace7c", {
                name: "apple",
                label: "苹果",
                class: "mb-10px mr-20px"
              });
              _setSharedData(__sharedData, 3, n2?.sharedData);
              const n3 = _createSharedDataComponentWithFallback(_component_up_radio, "80bac776", {
                name: "banana",
                label: "香蕉",
                class: "mb-10px mr-20px"
              });
          ...
          const n9 = _createSharedDataComponentWithFallback(_component_up_radio_group, "80bab83e", {
            modelValue: () => {
            ...
            "default": _withSharedDataVaporCtx(() => {
              const n7 = _createSharedDataComponentWithFallback(_component_up_radio, "80bab1f4", {
                name: "apple",
                label: "苹果(禁用)",
                disabled: true,
                class: "mb-10px mr-20px"
              ...
              const n8 = _createSharedDataComponentWithFallback(_component_up_radio, "80baaa70", {
                name: "banana",
                label: "香蕉(未禁用)",
                class: "mb-10px mr-20px"
              });
          ...
          const n14 = _createSharedDataComponentWithFallback(_component_up_radio_group, "34af7fb6", {
            modelValue: () => {
            ...
            "default": _withSharedDataVaporCtx(() => {
              const n12 = _createSharedDataComponentWithFallback(_component_up_radio, "34af8050", {
                name: "square",
                label: "方形",
                shape: "square",
                "active-color": "#fa3534",
              ...
              const n13 = _createSharedDataComponentWithFallback(_component_up_radio, "34af844e", {
                name: "circle",
                label: "圆形",
                shape: "circle",
                "active-color": "#ff9900",
          ...
          const n19 = _createSharedDataComponentWithFallback(_component_up_radio_group, "34af8ef3", {
            modelValue: () => {
            ...
            "default": _withSharedDataVaporCtx(() => {
              const n17 = _createSharedDataComponentWithFallback(_component_up_radio, "34af8f8d", {
                name: "1",
                label: "选项1(只能点圈圈)",
                "label-disabled": true,
                class: "mb-10px mr-20px"
              ...
              const n18 = _createSharedDataComponentWithFallback(_component_up_radio, "34af9355", {
                name: "2",
                label: "选项2(只能点圈圈)",
                "label-disabled": true,
                class: "mb-10px mr-20px"
