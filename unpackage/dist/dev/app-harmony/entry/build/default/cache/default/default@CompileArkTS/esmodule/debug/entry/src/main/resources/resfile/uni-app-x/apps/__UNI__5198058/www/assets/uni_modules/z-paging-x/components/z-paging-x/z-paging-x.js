...
import { z as zPagingXEmpty } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/z-paging-x/components/z-paging-x-empty/z-paging-x-empty&";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  props: {
    ...
    customNestedScroll: {
      type: Boolean,
      default: gc("custom-nested-scroll", false)
    },
    /**
    ...
    startNestedScroll: {
      type: Boolean,
      default: gc("start-nested-scroll", false)
    },
    /**
