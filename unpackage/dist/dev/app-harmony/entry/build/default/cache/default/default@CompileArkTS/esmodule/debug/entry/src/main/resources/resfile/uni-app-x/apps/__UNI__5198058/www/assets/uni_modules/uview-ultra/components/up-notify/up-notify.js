...
import { g as getPx, a as addUnit, b as addStyle, d as deepMerge } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/libs/function/index&";
    ...
    default: _withCtx(() => [
      _createElementVNode(
        "view",
        {
          ...
          style: _normalizeStyle($setup.notifyStyle)
        },
        [
          ...
          _createElementVNode("view", { class: "up-notify__warpper" }, [
            _renderSlot(_ctx.$slots, "icon", {}, () => [
              $setup.isIconVisible ? (_openBlock(), _createBlock(_component_up_icon, {
                key: 0,
            ...
            _createElementVNode(
              "text",
              {
                ...
                style: _normalizeStyle($setup.notifyTextStyle)
              },
