  ...
  return _openBlock(), _createBlock(_component_up_transition, {
    ...
    default: _withCtx(() => [
      _createElementVNode(
        "view",
        {
          class: _normalizeClass(["up-notify", [`up-notify--${$data.tmpConfig["type"]}`]]),
          style: _normalizeStyle([$options.backgroundColor, $options.addStyle(_ctx.customStyle)])
        },
        [
          $data.tmpConfig["safeAreaInsetTop"] ? (_openBlock(), _createBlock(_component_up_status_bar, { key: 0 })) : _createCommentVNode("v-if", true),
          _createElementVNode("view", { class: "up-notify__warpper" }, [
            _renderSlot(_ctx.$slots, "icon", {}, () => [
              ["success", "warning", "error"].includes($data.tmpConfig["type"].toString()) ? (_openBlock(), _createBlock(_component_up_icon, {
                key: 0,
