...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n10 = _createSharedDataComponent(_sfc_main$1, "6abd60be", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n9 = _createSharedDataComponent(_sfc_main$2, "eceeb716", {
            "navigation-style": "custom",
            "navigation-bar-title-text": "up-input 输入框"
          }, {
            "default": _withSharedDataVaporCtx(() => {
              const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "b0e82a84", {
                title: "up-input 输入框",
                "auto-back": true,
              ...
              const n2 = _createSharedDataComponentWithFallback(_component_up_input, "b0e81b0e", {
                placeholder: "请输入内容",
                border: "surround",
                modelValue: () => {
              ...
              const n5 = _createSharedDataComponentWithFallback(_component_up_input, "b0e80c0a", {
                placeholder: "请输入搜索内容",
                "prefix-icon": "search",
                "suffix-icon": "scan"
              });
