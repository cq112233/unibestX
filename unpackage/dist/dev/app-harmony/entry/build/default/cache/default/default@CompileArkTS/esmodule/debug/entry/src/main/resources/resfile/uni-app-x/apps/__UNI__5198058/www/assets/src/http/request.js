import { R as Request } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/lime-request/common/index&";
...
import { t as toLoginPage } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/src/utils/toLoginPage&";
import { C as ContentTypeEnum, R as ResultEnum, S as ShowMessage } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/src/http/tools/enum&";
...
requestInstance.interceptors.response.use((response) => {
  ...
  if (statusCode != 200) {
    ...
    uni.__f__("error", "at src/http/request.uts:115", "errorMessage===>", errorMessage);
  ...
  uni.__f__("error", "at src/http/request.uts:163", "request error ===>", error);
