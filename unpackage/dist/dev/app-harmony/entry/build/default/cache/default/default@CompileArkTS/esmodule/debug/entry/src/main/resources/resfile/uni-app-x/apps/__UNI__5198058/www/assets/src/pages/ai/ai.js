...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n37 = _createSharedDataComponent(_sfc_main$1, "9242dfba", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n36 = _createSharedDataComponent(_sfc_main$2, "24f37433", {
            "navigation-style": "custom",
            "navigation-bar-title-text": "AI助手"
          }, {
            "default": _withSharedDataVaporCtx(() => {
              const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "797b1266", {
                title: "AI 智能助手",
                "show-back": true
              });
              _setSharedData(__sharedData, 2, n0?.sharedData);
              _renderSharedDataEffect(() => {
                return _setSharedDataAttr(__sharedData, 8, _toSharedDataNumber(_unref(scrollTop)));
              });
              ...
              _createSharedDataIf(() => {
                return _setSharedData(__sharedData, 4, _toSharedDataBoolean(_unref(isTyping)));
              }, () => {
              });
              _renderSharedDataEffect(() => {
                const _safeAreaBottom = _unref(safeAreaBottom);
                _setSharedDataStyle(__sharedData, 9, { height: `${_safeAreaBottom + 70}px` });
                _setSharedDataStyle(__sharedData, 10, { paddingBottom: `${_safeAreaBottom + 10}px` });
              });
              const n30 = _createSharedDataComponentWithFallback(_component_input, "9430954a", {
                value: () => {
              ...
              _setSharedData(__sharedData, 5, n30?.sharedData);
              const n31 = _createSharedDataComponentWithFallback(_component_uni_icons, "94307cdc", {
                type: "paperplane-filled",
                size: "18",
                color: "#ffffff"
              });
              _setSharedData(__sharedData, 6, n31?.sharedData);
              _setSharedDataEvent(__sharedData, 7, sendMessage);
            })
          });
