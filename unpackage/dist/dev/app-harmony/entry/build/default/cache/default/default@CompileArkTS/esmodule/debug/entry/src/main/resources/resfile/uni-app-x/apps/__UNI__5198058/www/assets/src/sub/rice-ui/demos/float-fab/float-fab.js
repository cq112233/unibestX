...
import { _ as __easycom_1 } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/rice-ui/components/rice-float-fab/rice-float-fab&";
...
const __className = "GenSrcSubRiceUiDemosFloatFabFloatFab";
const { computed } = globalThis.Vue;
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  __dynamicSharedData: true,
  __hash: "8e9887ae",
  __className,
  __filename: "src/sub/rice-ui/demos/float-fab/float-fab.uvue",
  __name: "float-fab",
  setup(__props) {
    const __sharedDataRenderer = _useSharedDataRenderer();
    const __sharedData = __sharedDataRenderer == "component" ? _withSharedDataComponent(new UniDynamicSharedDataComponent(_useSharedDataScope(), _useSharedDataComponentOptions({ bundleKey: "GenSrcSubRiceUiDemosFloatFabFloatFabSharedData", sharedDataClassId: 0 }))) : _withSharedDataPage(new UniDynamicSharedDataPage(_useSharedDataPageId(), _useSharedDataPageOptions({ bundleKey: "GenSrcSubRiceUiDemosFloatFabFloatFabSharedData", sharedDataClassId: 0 })));
    ...
    return () => {
      ...
      const _component_rice_float_fab = __easycom_1;
      const n7 = _createSharedDataComponent(_sfc_main$1, "553afc88", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "522492de", {
            title: "FloatFab 悬浮按钮",
            "auto-back": true,
          ...
          const n5 = _createSharedDataComponentWithFallback(_component_rice_float_fab, "06c910dc", {
            icon: "plus",
            "bg-color": () => {
...
const _style_0 = {};
const _style_1 = {};
const floatFab = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0, _style_1]]]);
export {
  floatFab as default
};
//# sourceMappingURL=float-fab.js.map
