...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock(), _createElementBlock(
    ...
    {
      class: "up-link",
      onClick: _cache[0] || (_cache[0] = _withModifiers((...args) => $options.openLink && $options.openLink(...args), ["stop"])),
      style: _normalizeStyle([$options.linkStyle, $options.addStyle(_ctx.customStyle)])
    },
