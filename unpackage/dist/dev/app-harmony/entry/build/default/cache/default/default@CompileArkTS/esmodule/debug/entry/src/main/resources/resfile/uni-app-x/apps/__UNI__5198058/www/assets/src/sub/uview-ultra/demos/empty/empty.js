...
import { _ as __easycom_1 } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/components/up-empty/up-empty&";
...
const __className = "GenSrcSubUviewUltraDemosEmptyEmpty";
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    const __sharedData = __sharedDataRenderer == "component" ? _withSharedDataComponent(new UniDynamicSharedDataComponent(_useSharedDataScope(), _useSharedDataComponentOptions({ bundleKey: "GenSrcSubUviewUltraDemosEmptyEmptySharedData", sharedDataClassId: 0 }))) : _withSharedDataPage(new UniDynamicSharedDataPage(_useSharedDataPageId(), _useSharedDataPageOptions({ bundleKey: "GenSrcSubUviewUltraDemosEmptyEmptySharedData", sharedDataClassId: 0 })));
    _useSharedDataScope(__sharedData);
    return () => {
      "raw js";
      const _component_NavBar = __easycom_0;
      const _component_up_empty = __easycom_1;
      const n11 = _createSharedDataComponent(_sfc_main$1, "966d5cfe", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n10 = _createSharedDataComponent(_sfc_main$2, "373e42d6", {
            "navigation-style": "custom",
            "navigation-bar-title-text": "up-empty 空白页"
          }, {
            "default": _withSharedDataVaporCtx(() => {
              const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "b08a16c4", {
                title: "Empty 空白页",
                "auto-back": true
              });
              _setSharedData(__sharedData, 2, n0?.sharedData);
              const n2 = _createSharedDataComponentWithFallback(_component_up_empty, "b08a08bc", {
                mode: "data",
                class: "my-20px"
              });
              _setSharedData(__sharedData, 3, n2?.sharedData);
              const n5 = _createSharedDataComponentWithFallback(_component_up_empty, "b08a0004", {
                mode: "car",
                class: "my-20px"
              });
              _setSharedData(__sharedData, 4, n5?.sharedData);
              const n6 = _createSharedDataComponentWithFallback(_component_up_empty, "b089f980", {
                mode: "list",
                class: "my-20px"
              });
...
const _style_0 = {};
const _style_1 = {};
const empty = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0, _style_1]]]);
export {
  empty as default
};
