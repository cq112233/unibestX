...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n10 = _createSharedDataComponent(_sfc_main$1, "966d5cfe", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "373e4128", {
            title: "Empty 空白页",
            "auto-back": true
          });
          _setSharedData(__sharedData, 1, n0?.sharedData);
          const n2 = _createSharedDataComponentWithFallback(_component_up_empty, "b08a1008", {
            mode: "data",
            class: "my-20px"
          });
          _setSharedData(__sharedData, 2, n2?.sharedData);
          const n5 = _createSharedDataComponentWithFallback(_component_up_empty, "b08a0750", {
            mode: "car",
            class: "my-20px"
          });
          _setSharedData(__sharedData, 3, n5?.sharedData);
          const n6 = _createSharedDataComponentWithFallback(_component_up_empty, "b08a00f6", {
            mode: "list",
            class: "my-20px"
          });
