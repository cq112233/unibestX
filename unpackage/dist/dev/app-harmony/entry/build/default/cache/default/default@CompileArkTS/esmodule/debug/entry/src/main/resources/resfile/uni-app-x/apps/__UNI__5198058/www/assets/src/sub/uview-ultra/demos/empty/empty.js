...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n11 = _createSharedDataComponent(AppKu, "966d5cfe", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n10 = _createSharedDataComponent(LayoutComponent, "373e42d6", {
            "navigation-style": "custom",
            "navigation-bar-title-text": "up-empty 空白页"
          }, {
            "default": _withSharedDataVaporCtx(() => {
              const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "b08a168c", {
                title: "Empty 空白页",
                "auto-back": true
              });
              _setSharedData(__sharedData, 2, n0?.sharedData);
              const n2 = _createSharedDataComponentWithFallback(_component_up_empty, "b08a087c", {
                mode: "data",
                class: "my-_b20px_B"
              });
              _setSharedData(__sharedData, 3, n2?.sharedData);
              const n5 = _createSharedDataComponentWithFallback(_component_up_empty, "b089ffbc", {
                mode: "car",
                class: "my-_b20px_B"
              });
              _setSharedData(__sharedData, 4, n5?.sharedData);
              const n6 = _createSharedDataComponentWithFallback(_component_up_empty, "b089f906", {
                mode: "list",
                class: "my-_b20px_B"
              });
...
const _style_0 = {"my-_b20px_B":{"":{"marginBlock":20}}};
const empty = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0]]]);
export {
  empty as default
};
