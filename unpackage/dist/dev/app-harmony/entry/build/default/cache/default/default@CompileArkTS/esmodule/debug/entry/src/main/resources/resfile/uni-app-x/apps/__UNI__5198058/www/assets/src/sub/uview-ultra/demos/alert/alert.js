...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n24 = _createSharedDataComponent(_sfc_main$1, "7c1daae1", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "0797b20c", {
            title: "up-alert 警告提示",
            "auto-back": true,
          ...
          const n2 = _createSharedDataComponentWithFallback(_component_up_alert, "29430c02", {
            title: "成功提示",
            type: "success",
            "show-icon": true
          });
          _setSharedData(__sharedData, 2, n2?.sharedData);
          const n4 = _createSharedDataComponentWithFallback(_component_up_alert, "2942fefc", {
            title: "警告提示",
            type: "warning",
            "show-icon": true
          });
          _setSharedData(__sharedData, 3, n4?.sharedData);
          const n8 = _createSharedDataComponentWithFallback(_component_up_alert, "2942f5be", {
            title: "主要提示",
            type: "primary"
          });
          _setSharedData(__sharedData, 4, n8?.sharedData);
          const n10 = _createSharedDataComponentWithFallback(_component_up_alert, "2942ee46", {
            title: "错误提示",
            type: "error"
          });
          _setSharedData(__sharedData, 5, n10?.sharedData);
          const n12 = _createSharedDataComponentWithFallback(_component_up_alert, "2942e6fc", {
            title: "信息提示",
            type: "info"
          });
          _setSharedData(__sharedData, 6, n12?.sharedData);
          const n17 = _createSharedDataComponentWithFallback(_component_up_alert, "2942d8f2", {
            title: "成功",
            type: "success",
            description: "这是一段成功的描述信息",
            "show-icon": true
          });
          _setSharedData(__sharedData, 7, n17?.sharedData);
          const n20 = _createSharedDataComponentWithFallback(_component_up_alert, "ff1f99dc", {
            title: "带关闭按钮的提示",
            type: "warning",
            closable: true,
            "show-icon": true
