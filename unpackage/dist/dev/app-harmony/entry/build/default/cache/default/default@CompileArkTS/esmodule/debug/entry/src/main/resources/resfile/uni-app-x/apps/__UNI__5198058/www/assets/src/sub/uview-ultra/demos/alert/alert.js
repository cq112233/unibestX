...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n25 = _createSharedDataComponent(AppKu, "7c1daae1", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n24 = _createSharedDataComponent(LayoutComponent, "0797b135", {
            "navigation-style": "custom",
            "navigation-bar-title-text": "up-alert 警告提示"
          }, {
            "default": _withSharedDataVaporCtx(() => {
              const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "294313ca", {
                title: "up-alert 警告提示",
                "auto-back": true,
              ...
              const n2 = _createSharedDataComponentWithFallback(_component_up_alert, "2942ff34", {
                title: "成功提示",
                type: "success",
                "show-icon": true
              });
              _setSharedData(__sharedData, 3, n2?.sharedData);
              const n4 = _createSharedDataComponentWithFallback(_component_up_alert, "2942f73c", {
                title: "警告提示",
                type: "warning",
                "show-icon": true
              });
              _setSharedData(__sharedData, 4, n4?.sharedData);
              const n8 = _createSharedDataComponentWithFallback(_component_up_alert, "2942e8b6", {
                title: "主要提示",
                type: "primary"
              });
              _setSharedData(__sharedData, 5, n8?.sharedData);
              const n10 = _createSharedDataComponentWithFallback(_component_up_alert, "2942e676", {
                title: "错误提示",
                type: "error"
              });
              _setSharedData(__sharedData, 6, n10?.sharedData);
              const n12 = _createSharedDataComponentWithFallback(_component_up_alert, "2942defa", {
                title: "信息提示",
                type: "info"
              });
              _setSharedData(__sharedData, 7, n12?.sharedData);
              const n17 = _createSharedDataComponentWithFallback(_component_up_alert, "ff1fa0d6", {
                title: "成功",
                type: "success",
              ...
              const n20 = _createSharedDataComponentWithFallback(_component_up_alert, "ff1f91a0", {
                title: "带关闭按钮的提示",
                type: "warning",
                closable: true,
                "show-icon": true
...
const _style_0 = {};
const alert = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0]]]);
export {
  alert as default
};
