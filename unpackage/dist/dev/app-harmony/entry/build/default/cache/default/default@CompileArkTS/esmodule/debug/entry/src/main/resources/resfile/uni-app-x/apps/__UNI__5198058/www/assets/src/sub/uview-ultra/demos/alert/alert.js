...
import { _ as __easycom_1 } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/components/up-alert/up-alert&";
...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const _component_up_alert = __easycom_1;
      const n25 = _createSharedDataComponent(_sfc_main$1, "7c1daae1", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n24 = _createSharedDataComponent(_sfc_main$2, "0797b135", {
            "navigation-style": "custom",
            "navigation-bar-title-text": "up-alert 警告提示"
          }, {
            "default": _withSharedDataVaporCtx(() => {
              const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "29431402", {
                title: "up-alert 警告提示",
                "auto-back": true,
              ...
              const n2 = _createSharedDataComponentWithFallback(_component_up_alert, "2943048a", {
                title: "成功提示",
                type: "success",
                "show-icon": true
              });
              _setSharedData(__sharedData, 3, n2?.sharedData);
              const n4 = _createSharedDataComponentWithFallback(_component_up_alert, "2942f7ae", {
                title: "警告提示",
                type: "warning",
                "show-icon": true
              });
              _setSharedData(__sharedData, 4, n4?.sharedData);
              const n8 = _createSharedDataComponentWithFallback(_component_up_alert, "2942ee46", {
                title: "主要提示",
                type: "primary"
              });
              _setSharedData(__sharedData, 5, n8?.sharedData);
              const n10 = _createSharedDataComponentWithFallback(_component_up_alert, "2942e6f8", {
                title: "错误提示",
                type: "error"
              });
              _setSharedData(__sharedData, 6, n10?.sharedData);
              const n12 = _createSharedDataComponentWithFallback(_component_up_alert, "2942dfae", {
                title: "信息提示",
                type: "info"
              });
              _setSharedData(__sharedData, 7, n12?.sharedData);
              const n17 = _createSharedDataComponentWithFallback(_component_up_alert, "ff1fa192", {
                title: "成功",
                type: "success",
              ...
              const n20 = _createSharedDataComponentWithFallback(_component_up_alert, "ff1f928e", {
                title: "带关闭按钮的提示",
                type: "warning",
                closable: true,
                "show-icon": true
              });
              _setSharedData(__sharedData, 9, n20?.sharedData);
            })
          });
