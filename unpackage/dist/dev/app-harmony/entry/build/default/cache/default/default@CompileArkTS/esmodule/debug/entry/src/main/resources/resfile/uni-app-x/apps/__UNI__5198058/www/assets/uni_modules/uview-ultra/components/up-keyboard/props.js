...
import { d as defProps } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/components/up-keyboard/keyboard&";
let keyboardProp = defProps["keyboard"];
const propsKeyboard = {
  props: {
    // 键盘类型，见官网基本使用的说明
    mode: {
