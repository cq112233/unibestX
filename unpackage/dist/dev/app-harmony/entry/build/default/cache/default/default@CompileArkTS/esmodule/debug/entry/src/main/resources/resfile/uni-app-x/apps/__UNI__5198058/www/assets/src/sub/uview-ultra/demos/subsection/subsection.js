...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n6 = _createSharedDataComponent(_sfc_main$1, "5d6b202b", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "4ff8e602", {
            title: "Subsection 分段器",
            "auto-back": true
          });
          _setSharedData(__sharedData, 1, n0?.sharedData);
          const n2 = _createSharedDataComponentWithFallback(_component_up_subsection, "a1b877aa", {
            list: ["待付款", "待发货", "待收货"],
            current: 1
          });
