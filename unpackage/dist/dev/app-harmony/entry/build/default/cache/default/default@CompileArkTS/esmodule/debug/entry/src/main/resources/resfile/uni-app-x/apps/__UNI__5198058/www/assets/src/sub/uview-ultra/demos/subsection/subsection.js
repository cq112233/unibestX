...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n7 = _createSharedDataComponent(AppKu, "5d6b202b", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n6 = _createSharedDataComponent(LayoutComponent, "4ff8e52b", {
            "navigation-style": "custom",
            "navigation-bar-title-text": "up-subsection 分段器"
          }, {
            "default": _withSharedDataVaporCtx(() => {
              const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "a1b87e2e", {
                title: "Subsection 分段器",
                "auto-back": true
              });
              _setSharedData(__sharedData, 2, n0?.sharedData);
              const n2 = _createSharedDataComponentWithFallback(_component_up_subsection, "a1b86fea", {
                list: ["待付款", "待发货", "待收货"],
                current: 1
              });
...
const _style_0 = {};
const subsection = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0]]]);
export {
