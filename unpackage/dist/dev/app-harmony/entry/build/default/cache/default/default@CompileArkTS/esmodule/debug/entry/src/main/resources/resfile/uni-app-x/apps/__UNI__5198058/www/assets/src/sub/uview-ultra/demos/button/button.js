...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n30 = _createSharedDataComponent(_sfc_main$1, "5e96e385", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n29 = _createSharedDataComponent(_sfc_main$2, "74458d11", {
            "navigation-style": "custom",
            "navigation-bar-title-text": "up-button 按钮"
          }, {
            "default": _withSharedDataVaporCtx(() => {
              const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "146c15a2", {
                title: "up-button 按钮",
                "auto-back": true,
              ...
              const n2 = _createSharedDataComponentWithFallback(_component_up_button, "146c2028", {
                type: "primary",
                text: "主要按钮"
              });
              _setSharedData(__sharedData, 3, n2?.sharedData);
              const n4 = _createSharedDataComponentWithFallback(_component_up_button, "146c23c8", {
                type: "success",
                text: "成功按钮"
              });
              _setSharedData(__sharedData, 4, n4?.sharedData);
              const n6 = _createSharedDataComponentWithFallback(_component_up_button, "146c24c8", {
                type: "info",
                text: "信息按钮"
              });
              _setSharedData(__sharedData, 5, n6?.sharedData);
              const n8 = _createSharedDataComponentWithFallback(_component_up_button, "146c2865", {
                type: "warning",
                text: "警告按钮"
              });
              _setSharedData(__sharedData, 6, n8?.sharedData);
              const n10 = _createSharedDataComponentWithFallback(_component_up_button, "146c2c05", {
                type: "error",
                text: "危险按钮"
              });
              _setSharedData(__sharedData, 7, n10?.sharedData);
              const n14 = _createSharedDataComponentWithFallback(_component_up_button, "146c3347", {
                type: "primary",
                text: "主要按钮",
                plain: true
              });
              _setSharedData(__sharedData, 8, n14?.sharedData);
              const n18 = _createSharedDataComponentWithFallback(_component_up_button, "7916884f", {
                type: "primary",
                text: "大尺寸",
                size: "large"
              });
              _setSharedData(__sharedData, 9, n18?.sharedData);
              const n20 = _createSharedDataComponentWithFallback(_component_up_button, "79168f19", {
                type: "primary",
                text: "普通尺寸",
                size: "normal"
              });
              _setSharedData(__sharedData, 10, n20?.sharedData);
              const n22 = _createSharedDataComponentWithFallback(_component_up_button, "7916936f", {
                type: "primary",
                text: "小尺寸",
                size: "small"
              });
              _setSharedData(__sharedData, 11, n22?.sharedData);
              const n24 = _createSharedDataComponentWithFallback(_component_up_button, "791697ae", {
                type: "primary",
                text: "迷你尺寸",
                size: "mini"
              });
