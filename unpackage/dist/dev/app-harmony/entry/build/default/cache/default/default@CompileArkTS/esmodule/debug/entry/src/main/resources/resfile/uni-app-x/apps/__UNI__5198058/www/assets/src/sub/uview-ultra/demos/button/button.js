    ...
    return () => {
      ...
      const n30 = _createSharedDataComponent(_sfc_main$1, "5e96e385", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n29 = _createSharedDataComponent(LayoutComponent, "74458d11", {
            ...
            "default": _withSharedDataVaporCtx(() => {
              ...
              const n2 = _createSharedDataComponentWithFallback(_component_up_button, "146c2048", {
                type: "primary",
                text: "主要按钮"
              });
              _setSharedData(__sharedData, 3, n2?.sharedData);
              const n4 = _createSharedDataComponentWithFallback(_component_up_button, "146c2426", {
                type: "success",
                text: "成功按钮"
              });
              _setSharedData(__sharedData, 4, n4?.sharedData);
              const n6 = _createSharedDataComponentWithFallback(_component_up_button, "146c2804", {
                type: "info",
                text: "信息按钮"
              });
              _setSharedData(__sharedData, 5, n6?.sharedData);
              const n8 = _createSharedDataComponentWithFallback(_component_up_button, "146c2bca", {
                type: "warning",
                text: "警告按钮"
              });
              _setSharedData(__sharedData, 6, n8?.sharedData);
              const n10 = _createSharedDataComponentWithFallback(_component_up_button, "146c2fa8", {
                type: "error",
                text: "危险按钮"
              });
              _setSharedData(__sharedData, 7, n10?.sharedData);
              const n14 = _createSharedDataComponentWithFallback(_component_up_button, "79168469", {
                type: "primary",
                text: "主要按钮",
                plain: true
              });
              _setSharedData(__sharedData, 8, n14?.sharedData);
              const n18 = _createSharedDataComponentWithFallback(_component_up_button, "79168c4e", {
                type: "primary",
                text: "大尺寸",
                size: "large"
              });
              _setSharedData(__sharedData, 9, n18?.sharedData);
              const n20 = _createSharedDataComponentWithFallback(_component_up_button, "79169318", {
                type: "primary",
                text: "普通尺寸",
                size: "normal"
              });
              ...
              const n24 = _createSharedDataComponentWithFallback(_component_up_button, "79169e38", {
                type: "primary",
                text: "迷你尺寸",
                size: "mini"
              });
