...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  const _component_up_lazy_load = resolveEasycom(resolveDynamicComponent("up-lazy-load"), __easycom_1);
          ...
          createElementVNode("view", { class: "page-container bg-__f8fafc_ min-h-screen pb-30px" }, [
            ...
            createElementVNode("view", { class: "p-16px" }, [
              createElementVNode("view", { class: "demo-block" }, [
                ...
                createElementVNode("view", { style: { "height": "200px", "width": "100%" } }, [
                  createVNode(_component_up_lazy_load, { image: "https://cdn.uviewui.com/uview/swiper/1.jpg" })
                ])
              ]),
              createElementVNode("view", { class: "demo-block mt-12px" }, [
                createElementVNode("text", { class: "demo-label" }, "图片淡入动画 (is-effect)"),
                createElementVNode("view", { style: { "height": "200px", "width": "100%" } }, [
              ...
              createElementVNode("view", { class: "demo-block mt-12px" }, [
                createElementVNode("text", { class: "demo-label" }, "圆角和特定大小"),
                createElementVNode("view", { style: { "height": "200px", "width": "100%", "display": "flex", "justify-content": "center" } }, [
                  createVNode(_component_up_lazy_load, {
              ...
              createElementVNode("view", { class: "demo-block mt-12px" }, [
                createElementVNode("text", { class: "demo-label" }, "加载失败占位图"),
                createElementVNode("view", { style: { "height": "200px", "width": "100%" } }, [
                  createVNode(_component_up_lazy_load, {
