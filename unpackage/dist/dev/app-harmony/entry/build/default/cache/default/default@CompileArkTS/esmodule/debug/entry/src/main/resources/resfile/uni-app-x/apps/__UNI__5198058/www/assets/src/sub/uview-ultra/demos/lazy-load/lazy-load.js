...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n19 = _createSharedDataComponent(_sfc_main$1, "40ca44d6", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "13c0d5d8", {
            title: "Lazy Load 懒加载",
            "auto-back": true
          });
          _setSharedData(__sharedData, 1, n0?.sharedData);
          const n2 = _createSharedDataComponentWithFallback(_component_up_lazy_load, "6459cfb2", { image: "https://cdn.uviewui.com/uview/swiper/1.jpg" });
          _setSharedData(__sharedData, 2, n2?.sharedData);
          const n6 = _createSharedDataComponentWithFallback(_component_up_lazy_load, "6459da99", {
            image: "https://cdn.uviewui.com/uview/swiper/2.jpg",
            "is-effect": true,
            duration: "300"
          });
          _setSharedData(__sharedData, 3, n6?.sharedData);
          const n10 = _createSharedDataComponentWithFallback(_component_up_lazy_load, "6459e8dc", {
          ...
          const n14 = _createSharedDataComponentWithFallback(_component_up_lazy_load, "26df9744", {
