...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const _component_up_lazy_load = __easycom_1;
      const n20 = _createSharedDataComponent(_sfc_main$1, "40ca44d6", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n19 = _createSharedDataComponent(_sfc_main$2, "13c0d501", {
            "navigation-style": "custom",
            "navigation-bar-title-text": "up-lazy-load 懒加载"
          }, {
            "default": _withSharedDataVaporCtx(() => {
              const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "6459cbcb", {
                title: "Lazy Load 懒加载",
                "auto-back": true
              });
              _setSharedData(__sharedData, 2, n0?.sharedData);
              const n2 = _createSharedDataComponentWithFallback(_component_up_lazy_load, "6459d371", { image: "https://cdn.uviewui.com/uview/swiper/1.jpg" });
              _setSharedData(__sharedData, 3, n2?.sharedData);
              const n6 = _createSharedDataComponentWithFallback(_component_up_lazy_load, "6459de58", {
                image: "https://cdn.uviewui.com/uview/swiper/2.jpg",
                "is-effect": true,
                duration: "300"
              });
              _setSharedData(__sharedData, 4, n6?.sharedData);
              const n10 = _createSharedDataComponentWithFallback(_component_up_lazy_load, "6459e9fb", {
              ...
              const n14 = _createSharedDataComponentWithFallback(_component_up_lazy_load, "26df9b03", {
          ...
          _setSharedData(__sharedData, 1, n19.sharedData);
        })
      });
