...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n20 = _createSharedDataComponent(AppKu, "40ca44d6", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n19 = _createSharedDataComponent(LayoutComponent, "13c0d501", {
            "navigation-style": "custom",
            "navigation-bar-title-text": "up-lazy-load 懒加载"
          }, {
            "default": _withSharedDataVaporCtx(() => {
              const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "6459cbd2", {
                title: "Lazy Load 懒加载",
                "auto-back": true
              });
              _setSharedData(__sharedData, 2, n0?.sharedData);
              const n2 = _createSharedDataComponentWithFallback(_component_up_lazy_load, "6459d61c", { image: "https://cdn.uviewui.com/uview/swiper/1.jpg" });
              _setSharedData(__sharedData, 3, n2?.sharedData);
              const n6 = _createSharedDataComponentWithFallback(_component_up_lazy_load, "6459de91", {
                image: "https://cdn.uviewui.com/uview/swiper/2.jpg",
                "is-effect": true,
                duration: "300"
              });
              _setSharedData(__sharedData, 4, n6?.sharedData);
              const n10 = _createSharedDataComponentWithFallback(_component_up_lazy_load, "26df8fe4", {
              ...
              const n14 = _createSharedDataComponentWithFallback(_component_up_lazy_load, "26df9b44", {
...
const _style_0 = {};
const lazyLoad = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0]]]);
export {
  lazyLoad as default
};
