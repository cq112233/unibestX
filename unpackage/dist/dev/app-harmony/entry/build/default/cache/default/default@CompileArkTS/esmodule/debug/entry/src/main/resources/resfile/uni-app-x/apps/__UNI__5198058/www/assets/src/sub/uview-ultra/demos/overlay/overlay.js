...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n14 = _createSharedDataComponent(_sfc_main$1, "57f1bb61", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "b3749ce8", {
          ...
          const n2 = _createSharedDataComponentWithFallback(_component_up_button, "22706da3", {
            type: "primary",
            text: "显示遮罩",
            size: "mini",
            onClick: () => {
          ...
          const n4 = _createSharedDataComponentWithFallback(_component_up_button, "227071e0", {
            type: "warning",
            text: "半透明遮罩",
            size: "mini",
            onClick: () => {
          ...
          const n12 = _createSharedDataComponentWithFallback(_component_up_overlay, "227078e6", {
            show: () => {
            ...
            "default": _withSharedDataVaporCtx(() => {
              const n8 = _createSharedDataComponentWithFallback(_component_up_loading_icon, "227080c8", { mode: "circle" });
