...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n15 = _createSharedDataComponent(_sfc_main$1, "57f1bb61", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n14 = _createSharedDataComponent(_sfc_main$2, "b3749e96", {
            "navigation-style": "custom",
            "navigation-bar-title-text": "up-overlay 遮罩层"
          }, {
            "default": _withSharedDataVaporCtx(() => {
              const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "22706680", {
              ...
              const n2 = _createSharedDataComponentWithFallback(_component_up_button, "22707160", {
                type: "primary",
                text: "显示遮罩",
                size: "mini",
                onClick: () => {
              ...
              const n4 = _createSharedDataComponentWithFallback(_component_up_button, "2270759d", {
                type: "warning",
                text: "半透明遮罩",
                size: "mini",
                onClick: () => {
              ...
              const n12 = _createSharedDataComponentWithFallback(_component_up_overlay, "22707ca3", {
                show: () => {
                ...
                "default": _withSharedDataVaporCtx(() => {
                  const n8 = _createSharedDataComponentWithFallback(_component_up_loading_icon, "22708485", { mode: "circle" });
