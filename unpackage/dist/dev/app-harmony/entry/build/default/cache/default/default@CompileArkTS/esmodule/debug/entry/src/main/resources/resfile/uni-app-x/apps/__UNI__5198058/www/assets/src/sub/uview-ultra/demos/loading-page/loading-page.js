...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n8 = _createSharedDataComponent(_sfc_main$1, "acd436fe", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "edb2a728", {
          ...
          const n2 = _createSharedDataComponentWithFallback(_component_up_button, "c8a26246", {
            type: "primary",
            text: "触发全屏加载",
            size: "mini",
            onClick: () => {
          ...
          const n6 = _createSharedDataComponentWithFallback(_component_up_loading_page, "c8a259ce", {
            loading: () => {
