...
const _sfc_main = /* @__PURE__ */ _defineComponent({
  ...
  setup(__props, _a) {
    ...
    const __returned__ = { loadingPageShow, triggerLoadingPage, get AppKu() {
      return AppKu;
    }, get LayoutComponent() {
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  const _component_up_loading_page = resolveEasycom(__resolveDynamicComponent("up-loading-page"), __easycom_2$1);
      ...
      _createVNode($setup["LayoutComponent"], {
        ...
        default: _withCtx(() => [
          _createElementVNode("view", { class: "page-container bg-__f8fafc_ min-h-screen pb-30px" }, [
            ...
            _createVNode(_component_up_loading_page, {
...
const loadingPage = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["styles", [_style_0, _style_1]], ["__file", "/Users/chenqi/Documents/chenqi-front/unibestX/src/sub/uview-ultra/demos/loading-page/loading-page.uvue"]]);
export {
