      ...
      const n9 = _createSharedDataComponent(AppKu, "acd436fe", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n8 = _createSharedDataComponent(LayoutComponent, "edb2a8d6", {
            ...
            "default": _withSharedDataVaporCtx(() => {
              const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "c8a27054", {
              ...
              const n2 = _createSharedDataComponentWithFallback(_component_up_button, "c8a25a82", {
                type: "primary",
                text: "触发全屏加载",
                size: "mini",
                onClick: () => {
              ...
              const n6 = _createSharedDataComponentWithFallback(_component_up_loading_page, "c8a24cf4", {
                loading: () => {
...
const _style_0 = {};
const loadingPage = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0]]]);
export {
