...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n16 = _createSharedDataComponent(_sfc_main$1, "fbd28c7e", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "7e7f01a8", {
            title: "up-toast 消息提示",
            "auto-back": true,
          ...
          const n2 = _createSharedDataComponentWithFallback(_component_up_button, "574f5402", {
            type: "primary",
            text: "成功提示",
            size: "mini",
            onClick: () => {
          ...
          const n4 = _createSharedDataComponentWithFallback(_component_up_button, "574f5841", {
            type: "error",
            text: "错误提示",
            size: "mini",
            onClick: () => {
          ...
          const n8 = _createSharedDataComponentWithFallback(_component_up_button, "574f6307", {
            type: "warning",
            text: "警告提示",
            size: "mini",
            onClick: () => {
          ...
          const n10 = _createSharedDataComponentWithFallback(_component_up_button, "574f6746", {
            type: "default",
            text: "默认提示",
            size: "mini",
            onClick: () => {
          ...
          const n14 = _createSharedDataComponentWithFallback(_component_up_toast, "dacb9754");
