      ...
      const n17 = _createSharedDataComponent(AppKu, "fbd28c7e", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n16 = _createSharedDataComponent(LayoutComponent, "7e7f0356", {
            ...
            "default": _withSharedDataVaporCtx(() => {
              const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "574f4cfb", {
                title: "up-toast 消息提示",
                "auto-back": true,
              ...
              const n2 = _createSharedDataComponentWithFallback(_component_up_button, "574f57de", {
                type: "primary",
                text: "成功提示",
                size: "mini",
                onClick: () => {
              ...
              const n4 = _createSharedDataComponentWithFallback(_component_up_button, "574f5c21", {
                type: "error",
                text: "错误提示",
                size: "mini",
                onClick: () => {
              ...
              const n8 = _createSharedDataComponentWithFallback(_component_up_button, "574f6700", {
                type: "warning",
                text: "警告提示",
                size: "mini",
                onClick: () => {
              ...
              const n10 = _createSharedDataComponentWithFallback(_component_up_button, "dacb97d2", {
                type: "default",
                text: "默认提示",
                size: "mini",
                onClick: () => {
              ...
              const n14 = _createSharedDataComponentWithFallback(_component_up_toast, "dacb8f5a");
...
const _style_0 = {};
const toast = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0]]]);
export {
  toast as default
};
