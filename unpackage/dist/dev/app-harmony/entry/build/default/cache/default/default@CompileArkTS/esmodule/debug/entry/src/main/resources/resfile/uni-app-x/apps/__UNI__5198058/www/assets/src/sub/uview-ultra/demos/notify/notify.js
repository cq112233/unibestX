...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n17 = _createSharedDataComponent(_sfc_main$1, "60fc12f3", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n16 = _createSharedDataComponent(_sfc_main$2, "82f3693a", {
            "navigation-style": "custom",
            "navigation-bar-title-text": "up-notify 消息通知"
          }, {
            "default": _withSharedDataVaporCtx(() => {
              const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "12432192", {
              ...
              const n2 = _createSharedDataComponentWithFallback(_component_up_button, "12432c72", {
                type: "primary",
                text: "主要通知",
                size: "mini",
                onClick: () => {
              ...
              const n4 = _createSharedDataComponentWithFallback(_component_up_button, "124330b2", {
                type: "success",
                text: "成功通知",
                size: "mini",
                onClick: () => {
              ...
              const n8 = _createSharedDataComponentWithFallback(_component_up_button, "12433b7d", {
                type: "warning",
                text: "警告通知",
                size: "mini",
                onClick: () => {
              ...
              const n10 = _createSharedDataComponentWithFallback(_component_up_button, "12433fd2", {
                type: "error",
                text: "错误通知",
                size: "mini",
                onClick: () => {
              ...
              const n14 = _createSharedDataComponentWithFallback(_component_up_notify, "3620f9a6");
...
const _style_0 = {};
const _style_1 = {};
const notify = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0, _style_1]]]);
export {
  notify as default
};
