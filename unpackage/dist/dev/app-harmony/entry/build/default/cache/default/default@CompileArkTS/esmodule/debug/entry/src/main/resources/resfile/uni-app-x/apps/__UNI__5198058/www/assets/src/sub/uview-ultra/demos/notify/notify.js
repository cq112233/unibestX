...
import { _ as __easycom_2$1 } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/components/up-notify/up-notify&";
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  const _component_up_notify = resolveEasycom(__resolveDynamicComponent("up-notify"), __easycom_2$1);
          ...
          _createElementVNode("view", { class: "page-container bg-__f8fafc_ min-h-screen pb-30px" }, [
            ...
            _createElementVNode("view", { class: "p-16px" }, [
              ...
              _createElementVNode("view", { class: "demo-block mt-12px" }, [
                _createElementVNode("text", { class: "demo-label" }, "其他类型"),
                _createElementVNode("view", { class: "flex-row items-center" }, [
                  _createVNode(_component_up_button, {
                    type: "warning",
                    text: "警告通知",
                    size: "mini",
                    onClick: _cache[2] || (_cache[2] = ($event) => $setup.showNotify("warning"))
                  }),
                  _createElementVNode("view", { class: "w-10px" }),
                  _createVNode(_component_up_button, {
                    type: "error",
                    text: "错误通知",
                    size: "mini",
                    onClick: _cache[3] || (_cache[3] = ($event) => $setup.showNotify("error"))
                  })
                ])
              ])
            ]),
