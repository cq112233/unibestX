...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n16 = _createSharedDataComponent(_sfc_main$1, "60fc12f3", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "82f3678c", {
          ...
          const n2 = _createSharedDataComponentWithFallback(_component_up_button, "124328b5", {
            type: "primary",
            text: "主要通知",
            size: "mini",
            onClick: () => {
          ...
          const n4 = _createSharedDataComponentWithFallback(_component_up_button, "12432cf5", {
            type: "success",
            text: "成功通知",
            size: "mini",
            onClick: () => {
          ...
          const n8 = _createSharedDataComponentWithFallback(_component_up_button, "124337d5", {
            type: "warning",
            text: "警告通知",
            size: "mini",
            onClick: () => {
          ...
          const n10 = _createSharedDataComponentWithFallback(_component_up_button, "12433c15", {
            type: "error",
            text: "错误通知",
            size: "mini",
            onClick: () => {
          ...
          const n14 = _createSharedDataComponentWithFallback(_component_up_notify, "3620f5fe");
