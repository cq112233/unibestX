...
import { _ as __easycom_2 } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/components/up-notify/up-notify&";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, _a) {
    ...
    const __returned__ = { uNotify, showNotify, get AppKu() {
      return AppKu;
    }, get LayoutComponent() {
...
const _style_0 = { "bg-__f8fafc_": { "": { "backgroundImage": "none", "backgroundColor": "#f8fafc" } }, "flex-row": { "": { "flexDirection": "row" } }, "items-center": { "": { "alignItems": "center" } }, "p-16px": { "": { "paddingTop": 16, "paddingRight": 16, "paddingBottom": 16, "paddingLeft": 16 } }, "pb-30px": { "": { "paddingBottom": 30 } }, "w-10px": { "": { "width": 10 } } };
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  const _component_up_notify = resolveEasycom(resolveDynamicComponent("up-notify"), __easycom_2);
              ...
              createElementVNode("view", { class: "demo-block" }, [
                ...
                createElementVNode("view", { class: "flex-row items-center" }, [
                  createVNode(_component_up_button, {
                    ...
                    text: "主要通知",
                    size: "mini",
                    onClick: _cache[0] || (_cache[0] = ($event) => $setup.showNotify("primary"))
                  }),
                  ...
                  createVNode(_component_up_button, {
                    ...
                    text: "成功通知",
                    size: "mini",
                    onClick: _cache[1] || (_cache[1] = ($event) => $setup.showNotify("success"))
                  })
                ])
              ])
            ]),
...
const notify = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["styles", [_style_0, _style_1]], ["__file", "/Users/chenqi/Documents/chenqi-front/unibestX/src/sub/uview-ultra/demos/notify/notify.uvue"]]);
export {
  notify as default
};
