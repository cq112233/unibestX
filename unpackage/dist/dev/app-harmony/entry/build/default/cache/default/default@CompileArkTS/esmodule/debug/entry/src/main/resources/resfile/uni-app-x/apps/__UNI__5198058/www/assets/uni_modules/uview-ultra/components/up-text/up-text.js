...
import { a as addUnit, d as deepMerge, b as addStyle, k as error, w as priceFormat, x as timeFormat } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/libs/function/index&";
    ...
    return () => {
      ...
      _createSharedDataIf(() => {
        ...
        _createSharedDataIf(() => {
          ...
          const n7 = _createSharedDataComponentWithFallback(_component_up_icon, "4eee4906", {
            name: () => {
        ...
        _createSharedDataIf(() => {
          ...
          const n11 = _createSharedDataComponentWithFallback(_component_up_link, "4eee4d46", {
            class: () => {
          ...
          return _createSharedDataIf(() => {
            ...
            const n14 = _createSharedDataComponentWithFallback(_component_button, "e24e08de", {
        ...
        _createSharedDataIf(() => {
          ...
          const n19 = _createSharedDataComponentWithFallback(_component_up_icon, "e24d119c", {
            name: () => {
