...
import { b as addStyle, a as addUnit, g as getPx } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/libs/function/index&";
...
const { useCssVars: _useCssVars } = globalThis.Vue;
const __injectCSSVars__ = () => {
  _useCssVars((_ctx = null) => {
...
const { renderList: _renderList, Fragment: _Fragment, openBlock: _openBlock, createElementBlock: _createElementBlock, normalizeStyle: _normalizeStyle, createCommentVNode: _createCommentVNode, normalizeClass: _normalizeClass, toDisplayString: _toDisplayString } = globalThis.Vue;
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return _ctx.show ? (_openBlock(), _createElementBlock(
    "view",
    {
      key: 0,
      class: _normalizeClass(["up-loading-icon", [_ctx.vertical ? "up-loading-icon--vertical" : ""]]),
      style: _normalizeStyle([$options.addStyle(_ctx.customStyle)])
    },
    [
      !$data.webviewHide ? (_openBlock(), _createElementBlock(
        "view",
        {
          key: 0,
          class: _normalizeClass(["up-loading-icon__spinner", [`up-loading-icon__spinner--${_ctx.mode}`]]),
          ref: "ani",
        ...
        [
          _ctx.mode === "spinner" ? (_openBlock(true), _createElementBlock(
            _Fragment,
            { key: 0 },
            _renderList($data.array12, (item, index) => {
              return _openBlock(), _createElementBlock(
                "view",
                {
                  key: index,
                  class: "up-loading-icon__dot",
                  style: _normalizeStyle([$data.spinnerStyle[index], $options.getSpinnerDotStyle(index)])
                },
                null,
                4
                /* STYLE */
      ...
      _ctx.text != "" ? (_openBlock(), _createElementBlock(
        "text",
        {
          key: 1,
