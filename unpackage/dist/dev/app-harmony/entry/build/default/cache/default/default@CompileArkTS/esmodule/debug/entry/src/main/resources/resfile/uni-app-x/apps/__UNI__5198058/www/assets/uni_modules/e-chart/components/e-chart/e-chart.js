...
const _sfc_main = defineComponent({
  ...
  methods: {
    ...
    initAPP(option) {
      ...
      if (ctx == null) {
        uni.__f__("error", "at uni_modules/e-chart/components/e-chart/e-chart.uvue:176", "初始化echart的webview失败");
        return null;
      }
    ...
    // webview加载失败的回调
    onWebviewError(e) {
      uni.__f__("error", "at uni_modules/e-chart/components/e-chart/e-chart.uvue:457", "onWebviewError:", e);
    }
  }
});
