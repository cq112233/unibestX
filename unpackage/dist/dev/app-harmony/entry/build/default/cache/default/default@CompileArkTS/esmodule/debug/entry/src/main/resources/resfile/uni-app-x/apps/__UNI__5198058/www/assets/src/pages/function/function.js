...
import { E as EnvCard } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/src/pages/function/components/EnvCard&";
...
import { T as ToastCard } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/src/pages/function/components/ToastCard&";
...
import { L as LodashDemoCard } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/src/pages/function/components/LodashDemoCard&";
import { C as CryptoDemoCard } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/src/pages/function/components/CryptoDemoCard&";
import { T as TimeDemoCard } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/src/pages/function/components/TimeDemoCard&";
import { S as SignatureCard } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/src/pages/function/components/SignatureCard&";
import { E as EchartsDemoCard } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/src/pages/function/components/EchartsDemoCard&";
import { Z as ZPagingDemoCard } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/src/pages/function/components/ZPagingDemoCard&";
    ...
    return () => {
      ...
      const n15 = _createSharedDataComponent(AppKu, "13021a83", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n3 = _createSharedDataComponent(EnvCard, "5ae58c64");
          _setSharedData(__sharedData, 1, n3.sharedData);
          const n4 = _createSharedDataComponent(ZPagingDemoCard, "5ae58fa3");
          _setSharedData(__sharedData, 2, n4.sharedData);
          const n5 = _createSharedDataComponent(SystemInfoCard, "5ae59024");
          _setSharedData(__sharedData, 3, n5.sharedData);
          const n6 = _createSharedDataComponent(HapticsCard, "5ae59345");
          _setSharedData(__sharedData, 4, n6.sharedData);
          const n7 = _createSharedDataComponent(ToastCard, "5ae593e0");
          _setSharedData(__sharedData, 5, n7.sharedData);
          const n8 = _createSharedDataComponent(MediaCard, "5ae5945d");
          _setSharedData(__sharedData, 6, n8.sharedData);
          const n9 = _createSharedDataComponent(LodashDemoCard, "5ae597a7");
          _setSharedData(__sharedData, 7, n9.sharedData);
          const n10 = _createSharedDataComponent(CryptoDemoCard, "5ae59aea");
          _setSharedData(__sharedData, 8, n10.sharedData);
          const n11 = _createSharedDataComponent(TimeDemoCard, "5ae59ba7");
          _setSharedData(__sharedData, 9, n11.sharedData);
          const n12 = _createSharedDataComponent(SignatureCard, "5ae59eeb");
          _setSharedData(__sharedData, 10, n12.sharedData);
          const n13 = _createSharedDataComponent(EchartsDemoCard, "5ae59f87");
