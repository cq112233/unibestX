...
import { _ as __easycom_1 } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/components/up-card/up-card&";
...
const _style_0 = {"demo-block":{"":{"marginBottom":12,"paddingTop":12,"paddingRight":12,"paddingBottom":12,"paddingLeft":12,"backgroundColor":"#ffffff","borderTopLeftRadius":8,"borderTopRightRadius":8,"borderBottomRightRadius":8,"borderBottomLeftRadius":8}},"demo-label":{"":{"fontSize":14,"fontWeight":"bold","color":"#606266","marginBottom":10,"paddingLeft":4,"borderLeftWidth":3,"borderLeftStyle":"solid","borderLeftColor":"#2979ff"}},"bg-_b_hf8fafc_B":{"":{"backgroundColor":"#f8fafc"}},"pb-_b30px_B":{"":{"paddingBottom":30}},"p-_b16px_B":{"":{"paddingTop":16,"paddingRight":16,"paddingBottom":16,"paddingLeft":16,"padding":16}},"text-_b13px_B":{"":{"fontSize":13}},"text-_b_h606266_B":{"":{"color":"#606266"}},"leading-_b20px_B":{"":{"--tw-leading":"20px","lineHeight":20,"-TwLeading":20}},"h-_b10px_B":{"":{"height":10}},"flex-row":{"":{"flexDirection":"row"}},"justify-between":{"":{"justifyContent":"space-between"}},"w-full":{"":{"width":"100%"}},"text-_b12px_B":{"":{"fontSize":12}},"text-_b_h909399_B":{"":{"color":"#909399"}},"text-_b_h2979ff_B":{"":{"color":"#2979ff"}},"mt-_b12px_B":{"":{"marginTop":12}},"text-_b14px_B":{"":{"fontSize":14}},"text-_b_h333_B":{"":{"color":"#333"}},"leading-_b24px_B":{"":{"--tw-leading":"24px","lineHeight":24,"-TwLeading":24}},"justify-end":{"":{"justifyContent":"flex-end"}},"mr-_b10px_B":{"":{"marginRight":10}},"min-h-screen":{"":{"minHeight":"100vh"}}};
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  const _component_up_card = resolveEasycom(__resolveDynamicComponent("up-card"), __easycom_1);
          ...
          _createElementVNode("view", { class: "page-container bg-_b_hf8fafc_B min-h-screen pb-_b30px_B" }, [
            ...
            _createElementVNode("view", { class: "p-_b16px_B" }, [
              _createElementVNode("view", { class: "demo-block" }, [
                _createElementVNode("text", { class: "demo-label" }, "基础卡片"),
                _createVNode(_component_up_card, {
                  title: "基础卡片",
                  "sub-title": "副标题",
                  margin: "0",
                  "show-foot": false
                  ...
                  body: _withCtx(() => [
                    _createElementVNode("text", { class: "text-_b13px_B text-_b_h606266_B leading-_b20px_B" }, "这是卡片主体内容区域，可以放置任意内容。")
                  ]),
                  _: 1
                  /* STABLE */
                }),
                _createElementVNode("view", { class: "h-_b10px_B" }),
                _createVNode(_component_up_card, {
                  title: "带缩略图",
                  thumb: $setup.logoImg,
                  "thumb-circle": true,
                  ...
                  body: _withCtx(() => [
                    _createElementVNode("text", { class: "text-_b13px_B text-_b_h606266_B leading-_b20px_B" }, "左侧缩略图为圆形，适合展示头像或图标。")
                  ]),
                  foot: _withCtx(() => [
                    _createElementVNode("view", { class: "flex-row justify-between w-full" }, [
                      _createElementVNode("text", { class: "text-_b12px_B text-_b_h909399_B" }, "底部区域"),
                      _createElementVNode("text", { class: "text-_b12px_B text-_b_h2979ff_B" }, "查看详情")
                    ])
                  ]),
                  _: 1
                  /* STABLE */
              ...
              _createElementVNode("view", { class: "demo-block mt-_b12px_B" }, [
                _createElementVNode("text", { class: "demo-label" }, "完整卡片(含头部和尾部)"),
                _createVNode(_component_up_card, {
                  title: "订单信息",
                  "sub-title": "已完成",
                  thumb: $setup.logoImg,
                  ...
                  body: _withCtx(() => [
                    _createElementVNode("text", { class: "text-_b14px_B text-_b_h333_B leading-_b24px_B" }, "订单编号：2023080112345678\n商品名称：某某精美商品一件\n购买时间：2023-08-01 12:34:56")
                  ]),
                  foot: _withCtx(() => [
                    _createElementVNode("view", { class: "flex-row justify-end w-full" }, [
              ...
              _createElementVNode("view", { class: "demo-block mt-_b12px_B" }, [
                _createElementVNode("text", { class: "demo-label" }, "自定义阴影与边框"),
                _createVNode(_component_up_card, {
                  title: "带明显阴影",
                  "sub-title": "自定义",
                  margin: "0",
                  ...
                  body: _withCtx(() => [
                    _createElementVNode("text", { class: "text-_b13px_B text-_b_h606266_B" }, "这个卡片去掉了边框，并自定义了较深的阴影效果。")
                  ]),
                  _: 1
                  /* STABLE */
                })
...
const card = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["styles", [_style_0]], ["__file", "/Users/chenqi/Documents/chenqi-front/unibestX/src/sub/uview-ultra/demos/card/card.uvue"]]);
export {
  card as default
};
