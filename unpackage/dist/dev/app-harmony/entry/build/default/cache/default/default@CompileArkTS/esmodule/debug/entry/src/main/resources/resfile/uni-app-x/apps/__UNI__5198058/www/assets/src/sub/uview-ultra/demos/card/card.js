...
const _style_0 = {"demo-block":{"":{"marginBottom":12,"paddingTop":12,"paddingRight":12,"paddingBottom":12,"paddingLeft":12,"backgroundColor":"#ffffff","borderTopLeftRadius":8,"borderTopRightRadius":8,"borderBottomRightRadius":8,"borderBottomLeftRadius":8}},"demo-label":{"":{"fontSize":14,"fontWeight":"bold","color":"#606266","marginBottom":10,"paddingLeft":4,"borderLeftWidth":3,"borderLeftStyle":"solid","borderLeftColor":"#2979ff"}},"bg-_b_hf8fafc_B":{"":{"backgroundColor":"#f8fafc"}},"flex-row":{"":{"flexDirection":"row"}},"justify-between":{"":{"justifyContent":"space-between"}},"w-full":{"":{"width":"100%"}}};
            ...
            _createElementVNode("view", { class: "p-16px" }, [
              _createElementVNode("view", { class: "demo-block" }, [
                ...
                _createVNode(_component_up_card, {
                  ...
                  body: _withCtx(() => [
                    _createElementVNode("text", { class: "text-13px text-_b_h606266_B leading-20px" }, "这是卡片主体内容区域，可以放置任意内容。")
                  ]),
                  _: 1
                  /* STABLE */
                }),
                _createElementVNode("view", { class: "h-10px" }),
                _createVNode(_component_up_card, {
                  title: "带缩略图",
                  thumb: $setup.logoImg,
                  "thumb-circle": true,
                  ...
                  body: _withCtx(() => [
                    _createElementVNode("text", { class: "text-13px text-_b_h606266_B leading-20px" }, "左侧缩略图为圆形，适合展示头像或图标。")
                  ]),
                  foot: _withCtx(() => [
                    _createElementVNode("view", { class: "flex-row justify-between w-full" }, [
                      _createElementVNode("text", { class: "text-12px text-_b_h909399_B" }, "底部区域"),
                      _createElementVNode("text", { class: "text-12px text-_b_h2979ff_B" }, "查看详情")
                    ])
                  ]),
                  _: 1
                  /* STABLE */
              ...
              _createElementVNode("view", { class: "demo-block mt-12px" }, [
                ...
                _createVNode(_component_up_card, {
                  ...
                  body: _withCtx(() => [
                    _createElementVNode("text", { class: "text-14px text-_b_h333_B leading-24px" }, "订单编号：2023080112345678\n商品名称：某某精美商品一件\n购买时间：2023-08-01 12:34:56")
                  ]),
                  foot: _withCtx(() => [
              ...
              _createElementVNode("view", { class: "demo-block mt-12px" }, [
                ...
                _createVNode(_component_up_card, {
                  ...
                  body: _withCtx(() => [
                    _createElementVNode("text", { class: "text-13px text-_b_h606266_B" }, "这个卡片去掉了边框，并自定义了较深的阴影效果。")
                  ]),
                  _: 1
                  /* STABLE */
                })
