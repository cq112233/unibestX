...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n31 = _createSharedDataComponent(_sfc_main$1, "66b6847e", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "701a09a8", {
            title: "up-card 卡片",
            "auto-back": true,
          ...
          const n4 = _createSharedDataComponentWithFallback(_component_up_card, "366c54dc", {
            title: "基础卡片",
            "sub-title": "副标题",
            margin: "0",
            "show-foot": false
          ...
          const n12 = _createSharedDataComponentWithFallback(_component_up_card, "366c5fc6", {
            title: "带缩略图",
            thumb: () => {
              return logoImg;
            },
          ...
          const n22 = _createSharedDataComponentWithFallback(_component_up_card, "d1c4962a", {
            title: "订单信息",
            "sub-title": "已完成",
            thumb: () => {
              return logoImg;
            ...
            "foot": _withSharedDataVaporCtx(() => {
              const n18 = _createSharedDataComponentWithFallback(_component_up_button, "d1c47990", {
                text: "评价",
                type: "primary",
                size: "mini",
                plain: true,
              ...
              const n19 = _createSharedDataComponentWithFallback(_component_up_button, "d1c471da", {
                text: "再次购买",
                type: "primary",
                size: "mini"
              });
          ...
          _setSharedData(__sharedData, 4, n22?.sharedData);
          const n27 = _createSharedDataComponentWithFallback(_component_up_card, "d1c46212", {
            title: "带明显阴影",
            "sub-title": "自定义",
            margin: "0",
