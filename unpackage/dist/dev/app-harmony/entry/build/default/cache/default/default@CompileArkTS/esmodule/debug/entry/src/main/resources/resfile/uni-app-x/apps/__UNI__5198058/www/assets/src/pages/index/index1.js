      ...
      _createVNode($setup["LayoutComponent"], null, {
        default: _withCtx(() => [
          _createElementVNode("view", null, [
            ...
            _createElementVNode("view", { class: "content-container pb-20px" }, [
              _createElementVNode("image", {
                class: "w-100px h-100px wtu-9c7mkn-0 mt-20px rounded-20px",
                src: _imports_0
              }),
              _createElementVNode("text", { class: "text-32px text-bold wtu-9c7mkn-0 mt-10px wtu-zk2y1r-1" }, " unibestX "),
              _createElementVNode("text", { class: "wtu-1kxknsj-2 text-25px mt-10px" }, " 最好用的 uni-appX 开发模板 "),
              _createElementVNode("text", { class: "mt-10px wtu-1mffext-3 px-30px text-16px text-bold" }, " 　　unibestX 是一个集成了多种工具与技术的 uni-appX 开发模板，由 uni-appX + Vue3 + Ts + UnoCss + VSCode 构建，模板具有代码提示、自动格式化、统一配置、代码片段等功能，并内置了许多常用的基本组件和基本功能，让你编写 uni-appX 拥有 best 体验。 "),
...
const index1 = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["styles", [_style_0]], ["__file", "/Users/chenqi/Documents/chenqi-front/unibestX/src/pages/index/index1.uvue"]]);
export {
  index1 as default
};
