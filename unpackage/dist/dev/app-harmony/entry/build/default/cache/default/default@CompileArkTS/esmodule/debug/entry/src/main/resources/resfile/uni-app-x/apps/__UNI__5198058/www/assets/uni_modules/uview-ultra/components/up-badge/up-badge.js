    ...
    return () => {
      ...
      _createSharedDataIf(() => {
        ...
        _renderSharedDataEffect(() => {
          ...
          _setSharedDataStyle(__sharedData, 2, [_unref(addStyle)(__props.customStyle), badgeStyle.value]);
