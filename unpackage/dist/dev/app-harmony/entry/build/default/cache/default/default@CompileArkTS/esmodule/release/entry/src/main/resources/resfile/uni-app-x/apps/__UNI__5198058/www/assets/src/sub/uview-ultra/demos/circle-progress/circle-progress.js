...
import { _ as __easycom_1 } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/components/up-circle-progress/up-circle-progress&";
...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    const __sharedData = __sharedDataRenderer == "component" ? _withSharedDataComponent(new UniDynamicSharedDataComponent(_useSharedDataScope(), _useSharedDataComponentOptions({ bundleKey: "GenSrcSubUviewUltraDemosCircleProgressCircleProgressSharedData", sharedDataClassId: 0 }))) : _withSharedDataPage(new UniDynamicSharedDataPage(_useSharedDataPageId(), _useSharedDataPageOptions({ bundleKey: "GenSrcSubUviewUltraDemosCircleProgressCircleProgressSharedData", sharedDataClassId: 0 })));
    _useSharedDataScope(__sharedData);
    return () => {
      "raw js";
      const _component_NavBar = __easycom_0;
      const _component_up_circle_progress = __easycom_1;
      const n16 = _createSharedDataComponent(_sfc_main$1, "27c596ca", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n15 = _createSharedDataComponent(LayoutComponent, "d0ed428a", null, {
            "default": _withSharedDataVaporCtx(() => {
              const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "59a2785c", {
                title: "CircleProgress 圆形进度条",
                "auto-back": true
              });
              _setSharedData(__sharedData, 2, n0?.sharedData);
              const n2 = _createSharedDataComponentWithFallback(_component_up_circle_progress, "59a27cf5");
              _setSharedData(__sharedData, 3, n2?.sharedData);
              const n5 = _createSharedDataComponentWithFallback(_component_up_circle_progress, "59a2845f", {
                percentage: "30",
                "active-color": "#19be6b"
              });
              _setSharedData(__sharedData, 4, n5?.sharedData);
              const n7 = _createSharedDataComponentWithFallback(_component_up_circle_progress, "59a2887d", {
                percentage: "60",
                "active-color": "#ffaa33",
                "inactive-color": "#f3f4f6"
              });
              _setSharedData(__sharedData, 5, n7?.sharedData);
              const n11 = _createSharedDataComponentWithFallback(_component_up_circle_progress, "59a292ff", {
                percentage: "80",
                "active-color": "#2979ff",
                width: "100"
              });
...
const _style_0 = {};
const _style_1 = {};
const circleProgress = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0, _style_1]]]);
export {
