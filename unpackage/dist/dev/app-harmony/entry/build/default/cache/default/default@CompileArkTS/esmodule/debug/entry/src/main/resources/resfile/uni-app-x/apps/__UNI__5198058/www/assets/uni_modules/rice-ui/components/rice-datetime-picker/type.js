...
class DateTimePickerExtend extends UTS.UTSType {
...
class DateTimePickerEvent extends UTS.UTSType {
  static get$UTSMetadata$() {
    return {
      kind: 2,
      get fields() {
...
class DateTimePickerProps extends UTS.UTSType {
  static get$UTSMetadata$() {
    return {
      kind: 2,
      get fields() {
