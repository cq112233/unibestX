          ...
          _createElementVNode("view", { class: "page-container bg-__f8fafc_ min-h-screen pb-30px" }, [
            ...
            _createElementVNode("view", { class: "p-16px" }, [
              _createElementVNode("view", { class: "demo-block" }, [
                _createElementVNode("text", { class: "demo-label" }, "基本使用"),
                _createVNode(_component_up_link, {
                  href: "https://uniapp.dcloud.io/",
                  text: "打开 uni-app 官网"
                })
              ]),
              _createElementVNode("view", { class: "demo-block" }, [
                _createElementVNode("text", { class: "demo-label" }, "显示下划线"),
                _createVNode(_component_up_link, {
              ...
              _createElementVNode("view", { class: "demo-block" }, [
                _createElementVNode("text", { class: "demo-label" }, "自定义颜色与大小"),
                _createVNode(_component_up_link, {
...
const link = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["styles", [_style_0, _style_1]], ["__file", "/Users/chenqi/Documents/chenqi-front/unibestX/src/sub/uview-ultra/demos/link/link.uvue"]]);
export {
  link as default
};
