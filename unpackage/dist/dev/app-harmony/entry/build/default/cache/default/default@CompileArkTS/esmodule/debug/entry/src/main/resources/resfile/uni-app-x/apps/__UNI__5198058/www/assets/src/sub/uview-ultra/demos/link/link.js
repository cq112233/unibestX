      ...
      const n13 = _createSharedDataComponent(AppKu, "302284d6", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n12 = _createSharedDataComponent(LayoutComponent, "15e8f501", {
            ...
            "default": _withSharedDataVaporCtx(() => {
              const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "b194a866", {
                title: "Link 超链接",
                "auto-back": true
              });
              _setSharedData(__sharedData, 2, n0?.sharedData);
              const n2 = _createSharedDataComponentWithFallback(_component_up_link, "b1949a58", {
                href: "https://uniapp.dcloud.io/",
                text: "打开 uni-app 官网"
              });
              _setSharedData(__sharedData, 3, n2?.sharedData);
              const n5 = _createSharedDataComponentWithFallback(_component_up_link, "b1948c04", {
                href: "https://uview-plus.jiangruyi.com/",
                text: "带下划线的超链接",
                "under-line": true
              });
              _setSharedData(__sharedData, 4, n5?.sharedData);
              const n8 = _createSharedDataComponentWithFallback(_component_up_link, "b1947d00", {
...
const _style_0 = {};
const link = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0]]]);
export {
  link as default
};
