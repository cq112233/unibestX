...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n12 = _createSharedDataComponent(_sfc_main$1, "302284d6", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "15e8f5d8", {
            title: "Link 超链接",
            "auto-back": true
          });
          _setSharedData(__sharedData, 1, n0?.sharedData);
          const n2 = _createSharedDataComponentWithFallback(_component_up_link, "b194a20c", {
            href: "https://uniapp.dcloud.io/",
            text: "打开 uni-app 官网"
          });
          _setSharedData(__sharedData, 2, n2?.sharedData);
          const n5 = _createSharedDataComponentWithFallback(_component_up_link, "b194938e", {
            href: "https://uview-plus.jiangruyi.com/",
            text: "带下划线的超链接",
            "under-line": true
          });
          _setSharedData(__sharedData, 3, n5?.sharedData);
          const n8 = _createSharedDataComponentWithFallback(_component_up_link, "b194848a", {
