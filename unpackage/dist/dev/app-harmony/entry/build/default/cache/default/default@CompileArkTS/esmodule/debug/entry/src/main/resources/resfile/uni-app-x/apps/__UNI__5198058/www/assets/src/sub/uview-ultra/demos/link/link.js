...
const __className = "GenSrcSubUviewUltraDemosLinkLink";
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    const __sharedData = __sharedDataRenderer == "component" ? _withSharedDataComponent(new UniDynamicSharedDataComponent(_useSharedDataScope(), _useSharedDataComponentOptions({ bundleKey: "GenSrcSubUviewUltraDemosLinkLinkSharedData", sharedDataClassId: 0 }))) : _withSharedDataPage(new UniDynamicSharedDataPage(_useSharedDataPageId(), _useSharedDataPageOptions({ bundleKey: "GenSrcSubUviewUltraDemosLinkLinkSharedData", sharedDataClassId: 0 })));
    _useSharedDataScope(__sharedData);
    return () => {
      "raw js";
      const _component_NavBar = __easycom_0;
      const _component_up_link = __easycom_1;
      const n13 = _createSharedDataComponent(_sfc_main$1, "302284d6", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n12 = _createSharedDataComponent(_sfc_main$2, "15e8f501", {
            "navigation-style": "custom",
            "navigation-bar-title-text": "up-link 超链接"
          }, {
            "default": _withSharedDataVaporCtx(() => {
              const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "b194a89e", {
                title: "Link 超链接",
                "auto-back": true
              });
              _setSharedData(__sharedData, 2, n0?.sharedData);
              const n2 = _createSharedDataComponentWithFallback(_component_up_link, "b1949a98", {
                href: "https://uniapp.dcloud.io/",
                text: "打开 uni-app 官网"
              });
              _setSharedData(__sharedData, 3, n2?.sharedData);
              const n5 = _createSharedDataComponentWithFallback(_component_up_link, "b1948c44", {
                href: "https://uview-plus.jiangruyi.com/",
                text: "带下划线的超链接",
                "under-line": true
              });
              _setSharedData(__sharedData, 4, n5?.sharedData);
              const n8 = _createSharedDataComponentWithFallback(_component_up_link, "b1947d40", {
...
const _style_0 = {};
const _style_1 = {};
const link = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0, _style_1]]]);
export {
  link as default
};
