...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n12 = _createSharedDataComponent(_sfc_main$1, "51abafa6", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n11 = _createSharedDataComponent(_sfc_main$2, "0e1add69", {
              ...
              const n7 = _createSharedDataComponentWithFallback(_component_up_grid, "957e516c", { border: true }, {
                "default": _withSharedDataVaporCtx(() => {
                  _createSharedDataFor(_setSharedDataScoped(__sharedData, 4, _createSharedDataVFor(__sharedDataScope, () => {
                    ...
                    const n6 = _createSharedDataComponentWithFallback(_component_up_grid_item, "957e50e8-" + _for_item0.value, null, {
                      "default": _withSharedDataVaporCtx(() => {
                        const n4 = _createSharedDataComponentWithFallback(_component_up_icon, "957e4ff4-" + _for_item0.value, {
                          name: "photo",
                          size: 30
                        });
