...
const { defineComponent, resolveDynamicComponent, openBlock, createBlock, withCtx, createVNode, createElementVNode, createElementBlock, Fragment, renderList } = globalThis.Vue
...
import { _ as __easycom_2 } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/components/up-grid-item/up-grid-item&";
import { _ as __easycom_3 } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/components/up-grid/up-grid&";
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  const _component_up_grid_item = resolveEasycom(resolveDynamicComponent("up-grid-item"), __easycom_2);
  const _component_up_grid = resolveEasycom(resolveDynamicComponent("up-grid"), __easycom_3);
          ...
          createElementVNode("view", { class: "page-container bg-__f8fafc_ min-h-screen pb-30px" }, [
            ...
            createElementVNode("view", { class: "p-16px" }, [
              createElementVNode("view", { class: "demo-block" }, [
                ...
                createVNode(_component_up_grid, { border: true }, {
                  default: withCtx(() => [
                        ...
                        return createVNode(
                          ...
                          { key: i },
                          {
                            default: withCtx(() => [
                              ...
                              createElementVNode("text", { style: { "margin-top": "10px", "font-size": "14px", "color": "#333" } }, "宫格")
                            ]),
                            _: 2
                            /* DYNAMIC */
                          },
