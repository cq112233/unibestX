      ...
      const n12 = _createSharedDataComponent(AppKu, "51abafa6", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n11 = _createSharedDataComponent(LayoutComponent, "0e1add69", {
            ...
            "default": _withSharedDataVaporCtx(() => {
              const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "957e5f38", {
                title: "Grid 宫格",
                "auto-back": true
              });
              _setSharedData(__sharedData, 2, n0?.sharedData);
              const n7 = _createSharedDataComponentWithFallback(_component_up_grid, "957e512c", { border: true }, {
                "default": _withSharedDataVaporCtx(() => {
                  _createSharedDataFor(_setSharedDataScoped(__sharedData, 4, _createSharedDataVFor(__sharedDataScope, () => {
                    ...
                    const n6 = _createSharedDataComponentWithFallback(_component_up_grid_item, "957e5068-" + _for_item0.value, null, {
                      "default": _withSharedDataVaporCtx(() => {
                        const n4 = _createSharedDataComponentWithFallback(_component_up_icon, "957e4a1a-" + _for_item0.value, {
                          name: "photo",
                          size: 30
                        });
...
const _style_0 = {};
const grid = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0]]]);
export {
  grid as default
};
