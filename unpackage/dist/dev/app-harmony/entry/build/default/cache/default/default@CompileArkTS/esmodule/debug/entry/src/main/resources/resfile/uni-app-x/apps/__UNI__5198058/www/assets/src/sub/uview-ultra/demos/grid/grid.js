...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n11 = _createSharedDataComponent(_sfc_main$1, "51abafa6", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "0e1ade40", {
            title: "Grid 宫格",
            "auto-back": true
          });
          _setSharedData(__sharedData, 1, n0?.sharedData);
          const n7 = _createSharedDataComponentWithFallback(_component_up_grid, "957e58de", { border: true }, {
            "default": _withSharedDataVaporCtx(() => {
              _createSharedDataFor(_setSharedDataScoped(__sharedData, 3, _createSharedDataVFor(__sharedDataScope, () => {
                ...
                const n6 = _createSharedDataComponentWithFallback(_component_up_grid_item, "957e5830-" + _for_item0.value, null, {
                  "default": _withSharedDataVaporCtx(() => {
                    const n4 = _createSharedDataComponentWithFallback(_component_up_icon, "957e5226-" + _for_item0.value, {
                      name: "photo",
                      size: 30
                    });
