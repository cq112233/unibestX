      ...
      const n16 = _createSharedDataComponent(AppKu, "678edda1", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n15 = _createSharedDataComponent(LayoutComponent, "eb665316", {
            ...
            "default": _withSharedDataVaporCtx(() => {
              const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "81640e44", {
                title: "Waterfall 瀑布流",
                "auto-back": true
              });
              _setSharedData(__sharedData, 2, n0?.sharedData);
              const n11 = _createSharedDataComponentWithFallback(_component_up_waterfall, "8163fff6", {
                modelValue: () => {
                  return list.value;
                },
                "onUpdate:modelValue": () => {
...
const _style_0 = {};
const waterfall = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0]]]);
export {
