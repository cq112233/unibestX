...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n15 = _createSharedDataComponent(_sfc_main$1, "678edda1", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "eb665168", {
            title: "Waterfall 瀑布流",
            "auto-back": true
          });
          _setSharedData(__sharedData, 1, n0?.sharedData);
          const n11 = _createSharedDataComponentWithFallback(_component_up_waterfall, "8164078a", {
            modelValue: () => {
              return list.value;
            },
            "onUpdate:modelValue": () => {
