...
import { _ as __easycom_1 } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/components/up-waterfall/up-waterfall&";
...
const _style_0 = {"demo-block":{"":{"marginBottom":12,"paddingTop":12,"paddingRight":12,"paddingBottom":12,"paddingLeft":12,"backgroundColor":"#ffffff","borderTopLeftRadius":8,"borderTopRightRadius":8,"borderBottomRightRadius":8,"borderBottomLeftRadius":8}},"demo-label":{"":{"fontSize":14,"fontWeight":"bold","color":"#606266","marginBottom":10,"paddingLeft":4,"borderLeftWidth":3,"borderLeftStyle":"solid","borderLeftColor":"#2979ff"}},"bg-_b_hf8fafc_B":{"":{"backgroundColor":"#f8fafc"}},"bg-_b_hf1f5f9_B":{"":{"backgroundColor":"#f1f5f9"}},"overflow-hidden":{"":{"overflow":"hidden"}},"font-bold":{"":{"--tw-font-weight":"700","fontWeight":700}},"text-_b_h334155_B":{"":{"color":"#334155"}},"text-_b_h94a3b8_B":{"":{"color":"#94a3b8"}}};
                    ...
                    (_openBlock(true), _createElementBlock(
                      ...
                      _renderList(colList, (item, idx) => {
                        return _openBlock(), _createElementBlock("view", {
                          ...
                          _createElementVNode("view", { class: "bg-_b_hf1f5f9_B rounded-8px overflow-hidden p-8px mb-8px" }, [
                            _createElementVNode(
                              "image",
                              {
                                src: _imports_0,
                            ...
                            _createElementVNode(
                              "text",
                              { class: "text-14px font-bold text-_b_h334155_B mt-6px" },
                            ...
                            _createElementVNode(
                              "text",
                              { class: "text-12px text-_b_h94a3b8_B mt-2px" },
                            ...
                            _createElementVNode(
                              "text",
                              { class: "text-14px text-_b_he11d48_B mt-4px font-bold" },
