  ...
  return _openBlock(), _createElementBlock("view", { class: "up-calendar-header up-border-bottom" }, [
    ...
    _createElementVNode("view", { class: "up-calendar-header__weekdays" }, [
      _createElementVNode(
        ...
        _toDisplayString($options.t("up_week_one")),
        1
        /* TEXT */
      ),
      _createElementVNode(
        "text",
        { class: "up-calendar-header__weekdays__weekday" },
        _toDisplayString($options.t("up_week_two")),
        1
        /* TEXT */
      ),
      _createElementVNode(
        "text",
        { class: "up-calendar-header__weekdays__weekday" },
        _toDisplayString($options.t("up_week_three")),
        1
        /* TEXT */
      ),
      _createElementVNode(
        "text",
        { class: "up-calendar-header__weekdays__weekday" },
        _toDisplayString($options.t("up_week_four")),
        1
        /* TEXT */
      ),
      _createElementVNode(
        "text",
        { class: "up-calendar-header__weekdays__weekday" },
        _toDisplayString($options.t("up_week_five")),
        1
        /* TEXT */
      ),
      _createElementVNode(
        "text",
        { class: "up-calendar-header__weekdays__weekday" },
        _toDisplayString($options.t("up_week_six")),
        1
        /* TEXT */
      ),
      _createElementVNode(
        "text",
        { class: "up-calendar-header__weekdays__weekday" },
        _toDisplayString($options.t("up_week_seven")),
        1
        /* TEXT */
      )
    ])
