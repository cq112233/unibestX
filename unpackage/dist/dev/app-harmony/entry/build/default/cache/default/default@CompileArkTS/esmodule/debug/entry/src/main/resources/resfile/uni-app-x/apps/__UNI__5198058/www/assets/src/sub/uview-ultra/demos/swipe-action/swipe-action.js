...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  const _component_up_swipe_action_item = resolveEasycom(resolveDynamicComponent("up-swipe-action-item"), __easycom_1);
  const _component_up_swipe_action = resolveEasycom(resolveDynamicComponent("up-swipe-action"), __easycom_2);
