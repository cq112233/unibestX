...
import { _ as _sfc_main$1 } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/components/up-swipe-action/up-swipe-action&";
      ...
      const n14 = _createSharedDataComponent(AppKu, "a989d93e", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n13 = _createSharedDataComponent(LayoutComponent, "87b14e96", {
            ...
            "default": _withSharedDataVaporCtx(() => {
              const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "6e788292", {
                title: "SwipeAction 滑动操作",
                "auto-back": true
              });
              _setSharedData(__sharedData, 2, n0?.sharedData);
              const n4 = _createSharedDataComponentWithFallback(_component_up_swipe_action, "6e78744a", null, {
                "default": _withSharedDataVaporCtx(() => {
                  const n3 = _createSharedDataComponentWithFallback(_component_up_swipe_action_item, "6e7873be", { options: () => {
              ...
              const n9 = _createSharedDataComponentWithFallback(_component_up_swipe_action, "6e785738", null, {
                "default": _withSharedDataVaporCtx(() => {
                  const n8 = _createSharedDataComponentWithFallback(_component_up_swipe_action_item, "6e7856ac", { options: () => {
...
const _style_0 = {};
const swipeAction = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0]]]);
export {
