...
import type { NativeLoadFontFaceOptions, UniKeyEvent } from '@dcloudio/uni-app-x/types/native';
import { UniPageManagerImpl } from "@normalized:N&&&@dcloudio/uni-runtime-harmony/dom/UniPageManager&1.0.0";
import { GlobalDocument, UniCallbackWrapper } from "@normalized:N&&&@dcloudio/uni-runtime-harmony/libs/dom&1.0.0";
...
import { getPrivacyAgree, setPrivacyAgree, getAppTheme } from "@normalized:N&&&@dcloudio/uni-runtime-harmony/UTSHarmony/index&1.0.0";
import { clearApp, genApp } from "@normalized:N&&&@dcloudio/uni-runtime-harmony/UniApp&1.0.0";
import type { BusinessError } from "@ohos:base";
import errorManager from "@ohos:app.ability.errorManager";
import { getUniApp as getUniAppBase, setUniApp } from "@normalized:N&&&@dcloudio/uni-runtime-harmony/UniNativeAppManager&1.0.0";
