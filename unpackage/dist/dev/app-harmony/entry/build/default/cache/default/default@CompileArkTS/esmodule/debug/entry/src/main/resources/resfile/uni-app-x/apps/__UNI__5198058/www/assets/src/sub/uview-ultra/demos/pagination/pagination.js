...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n6 = _createSharedDataComponent(_sfc_main$1, "12236d55", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "324a3e18", {
          ...
          const n2 = _createSharedDataComponentWithFallback(_component_up_pagination, "16fd721d", {
            "current-page": () => {
