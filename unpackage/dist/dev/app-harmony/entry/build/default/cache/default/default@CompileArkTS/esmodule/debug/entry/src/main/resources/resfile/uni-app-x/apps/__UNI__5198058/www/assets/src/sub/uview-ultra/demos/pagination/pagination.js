...
import { _ as __easycom_1 } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/components/up-pagination/up-pagination&";
...
const _sfc_main = /* @__PURE__ */ _defineComponent({
  ...
  setup(__props, _a) {
    ...
    const __returned__ = { paginationCurrentPage, paginationPageSize, paginationTotal, onPaginationCurrentChange, get AppKu() {
      return AppKu;
    }, get LayoutComponent() {
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  const _component_up_pagination = resolveEasycom(__resolveDynamicComponent("up-pagination"), __easycom_1);
          ...
          _createElementVNode("view", { class: "page-container bg-__f8fafc_ min-h-screen pb-30px" }, [
            ...
            _createElementVNode("view", { class: "p-16px" }, [
              _createElementVNode("view", { class: "demo-block" }, [
                _createElementVNode("text", { class: "demo-label" }, "up-pagination"),
                _createVNode(_component_up_pagination, {
...
const pagination = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["styles", [_style_0, _style_1]], ["__file", "/Users/chenqi/Documents/chenqi-front/unibestX/src/sub/uview-ultra/demos/pagination/pagination.uvue"]]);
export {
