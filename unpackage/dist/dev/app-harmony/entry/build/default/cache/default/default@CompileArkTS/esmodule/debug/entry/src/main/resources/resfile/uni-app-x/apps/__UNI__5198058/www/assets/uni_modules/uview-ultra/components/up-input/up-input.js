  ...
  setup(__props, _a) {
    ...
    return () => {
      ...
      _renderSharedDataEffect(() => {
        ...
        _setSharedDataStyle(__sharedData, 11, [wrapperStyle.value, _unref(addStyle)(__props.customStyle)]);
      });
      _createSharedDataIf(() => {
        ...
        _createSharedDataSlot("prefix", null, null, () => {
          const n4 = _createSharedDataComponentWithFallback(_component_up_icon, "3788ad12", {
            name: () => {
      ...
      const n6 = _createSharedDataComponentWithFallback(_component_input, "3788884c", {
      ...
      _createSharedDataIf(() => {
        ...
        const n10 = _createSharedDataComponentWithFallback(_component_up_icon, "b98ded76", {
          name: "close",
          size: "11",
          color: "#ffffff",
      ...
      _createSharedDataIf(() => {
        ...
        _createSharedDataSlot("suffix", null, null, () => {
          const n16 = _createSharedDataComponentWithFallback(_component_up_icon, "b98dcef2", {
            name: () => {
