...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n14 = _createSharedDataComponent(_sfc_main$1, "2060b37a", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n13 = _createSharedDataComponent(_sfc_main$2, "0a252213", {
            "navigation-style": "custom",
            "navigation-bar-title-text": "up-dropdown 下拉菜单"
          }, {
            "default": _withSharedDataVaporCtx(() => {
              const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "3a7f20f9", {
                title: "Dropdown 下拉菜单",
                "auto-back": true
              });
              _setSharedData(__sharedData, 2, n0?.sharedData);
              const n4 = _createSharedDataComponentWithFallback(_component_up_dropdown, "3a7f2801", null, {
                "default": _withSharedDataVaporCtx(() => {
                  const n2 = _createSharedDataComponentWithFallback(_component_up_dropdown_item, "3a7f2843", {
                    modelValue: () => {
                      return value1.value;
                    },
                    "onUpdate:modelValue": () => {
                  ...
                  const n3 = _createSharedDataComponentWithFallback(_component_up_dropdown_item, "3a7f2c00", {
                    modelValue: () => {
                      return value2.value;
                    },
                    "onUpdate:modelValue": () => {
              ...
              const n9 = _createSharedDataComponentWithFallback(_component_up_dropdown, "3a7f33bf", { "active-color": "#fa3534" }, {
                "default": _withSharedDataVaporCtx(() => {
                  const n7 = _createSharedDataComponentWithFallback(_component_up_dropdown_item, "3a7f36cd", {
                    modelValue: () => {
                      return value3.value;
                    },
                    "onUpdate:modelValue": () => {
                  ...
                  const n8 = _createSharedDataComponentWithFallback(_component_up_dropdown_item, "3a7f3a8a", {
                    modelValue: () => {
                      return value4.value;
                    },
                    "onUpdate:modelValue": () => {
