...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  const _component_up_dropdown_item = resolveEasycom(resolveDynamicComponent("up-dropdown-item"), __easycom_1);
  const _component_up_dropdown = resolveEasycom(resolveDynamicComponent("up-dropdown"), __easycom_2);
          ...
          createElementVNode("view", { class: "page-container bg-__f8fafc_ min-h-screen pb-30px" }, [
            ...
            createElementVNode("view", { class: "p-16px" }, [
              ...
              createElementVNode("view", { class: "demo-block mt-12px" }, [
                createElementVNode("text", { class: "demo-label" }, "自定义选中颜色"),
                createVNode(_component_up_dropdown, { "active-color": "#fa3534" }, {
                  default: withCtx(() => [
                    createVNode(_component_up_dropdown_item, {
