...
import { j as guid, s as sleep, a as addUnit, b as addStyle, u as upGetRect, f as range, v as os } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/libs/function/index&";
...
const _sfc_main = /* @__PURE__ */ _defineComponent({
  ...
  setup(__props, _a) {
    ...
    const __returned__ = { props, emit, instance, elId, elClass, rateBoxLeft, activeIndex, rateWidth, moving, toNumber, getMinCountValue, getCountValue, normalizeActiveIndex, getFallbackRateWidth, ensureRateMetrics, getRateItemRect, getRateIconWrapRect, emitEvent, getActiveIndex, touchMove, touchEnd, clickHandler, init, get addUnit() {
      return addUnit;
    }, get addStyle() {
      return addStyle;
    } };
              ...
              [
                _createElementVNode("view", {
                  ...
                  _createVNode(_component_up_icon, {
                    ...
                    "custom-style": {
                      padding: `0 ${$setup.addUnit(parseInt($props.gutter.toString()) / 2)}`
                    },
                    size: $props.size
                ...
                $props.allowHalf ? (_openBlock(), _createElementBlock("view", {
                  ...
                  style: _normalizeStyle([{
                    width: $setup.addUnit($setup.rateWidth / 2)
                  }])
                }, [
                  _createVNode(_component_up_icon, {
                    name: Math.floor(parseFloat($setup.activeIndex.toString())) > index ? $props.activeIcon : $props.inactiveIcon,
