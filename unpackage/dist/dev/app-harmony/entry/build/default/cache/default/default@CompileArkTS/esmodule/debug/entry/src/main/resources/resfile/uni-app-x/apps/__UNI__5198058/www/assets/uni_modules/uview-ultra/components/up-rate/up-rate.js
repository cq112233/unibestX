...
import { j as guid, b as addStyle, a as addUnit, v as os, s as sleep, u as upGetRect, f as range } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/libs/function/index&";
...
const { ref, watch, onMounted, getCurrentInstance } = globalThis.Vue;
  ...
  setup(__props, _a) {
    ...
    return () => {
      ...
      _createSharedDataFor(_setSharedDataScoped(__sharedData, 0, _createSharedDataVFor(__sharedDataScope, () => {
        ...
        const n2 = _createSharedDataComponentWithFallback(_component_up_icon, "4df78727-" + _for_key0.value, {
          name: () => {
          ...
          "custom-style": () => {
            return {
              padding: `0 ${_unref(addUnit)(parseInt(__props.gutter.toString()) / 2)}`
            };
          },
          size: () => {
            return __props.size;
        ...
        _createSharedDataIf(() => {
          ...
          _renderSharedDataEffect(() => {
            return _setSharedDataStyle(__sharedData_VFor0, 4, [{
              width: _unref(addUnit)(rateWidth.value / 2)
            }]);
          });
          const n6 = _createSharedDataComponentWithFallback(_component_up_icon, "70f7242a-" + _for_key0.value, {
            name: () => {
              return Math.floor(parseFloat(activeIndex.value.toString())) > _for_key0.value ? __props.activeIcon : __props.inactiveIcon;
            },
            color: () => {
