import type { RequestFullscreenOptions, UniViewElement as IUniViewElement, ExitFullscreenOptions } from '@dcloudio/uni-app-x/types/native';
import window from "@ohos:window";
import { UniElementImpl } from "@normalized:N&&&@dcloudio/uni-runtime-harmony/libs/dom&1.0.0";
import { getUniApp } from "@normalized:N&&&@dcloudio/uni-runtime-harmony/UniNativeAppManager&1.0.0";
import { getFullscreenError } from "@normalized:N&&&@dcloudio/uni-runtime-harmony/libs/dom&1.0.0";
