...
const _sfc_main = /* @__PURE__ */ _defineComponent({
  ...
  setup(__props, _a) {
    ...
    const __returned__ = { props, emit, bemClass, textColorCom, loadingColor, iconColorCom, baseColor, textSize, clickHandler, getphonenumber, getuserinfo, error, opensetting, launchapp, get addStyle() {
      return addStyle;
    }, get addUnit() {
      return addUnit;
    }, get getPx() {
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return _openBlock(), _createElementBlock("view", {
    style: _normalizeStyle([{ "position": "relative" }, [$setup.baseColor, $setup.addStyle($props.customStyle)]]),
    ...
    $props.loading ? (_openBlock(), _createElementBlock(
      ...
      [
        _createVNode(_component_up_loading_icon, {
          ...
          size: $setup.addUnit($props.loadingSize * 1.15),
        ...
        _createElementVNode(
          "text",
          {
            ...
            style: _normalizeStyle([{ fontSize: $setup.textSize + "px", color: $setup.textColorCom }])
          },
      ...
      [
        $props.icon != "" ? (_openBlock(), _createBlock(_component_up_icon, {
          ...
          size: $setup.addUnit(parseInt($setup.getPx($setup.textSize)) * 1.35),
