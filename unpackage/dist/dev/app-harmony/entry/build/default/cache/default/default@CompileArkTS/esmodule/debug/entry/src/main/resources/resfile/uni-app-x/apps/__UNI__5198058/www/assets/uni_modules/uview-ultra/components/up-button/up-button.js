...
import { c as bem, b as addStyle, a as addUnit, g as getPx } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/libs/function/index&";
  ...
  setup(__props, _a) {
    ...
    return () => {
      ...
      _renderSharedDataEffect(() => {
        _setSharedDataStyle(__sharedData, 9, ["position: relative", [baseColor.value, _unref(addStyle)(__props.customStyle)]]);
      ...
      _createSharedDataIf(() => {
        ...
        const n2 = _createSharedDataComponentWithFallback(_component_up_loading_icon, "64250bab", {
          mode: () => {
            return __props.loadingMode;
          },
          size: () => {
            return _unref(addUnit)(__props.loadingSize * 1.15);
          },
          color: () => {
        ...
        _renderSharedDataEffect(() => {
          ...
          _setSharedDataStyle(__sharedData, 2, [{ fontSize: textSize.value + "px", color: textColorCom.value }]);
        ...
        _createSharedDataIf(() => {
          ...
          const n7 = _createSharedDataComponentWithFallback(_component_up_icon, "64251a92", {
            ...
            size: () => {
              return _unref(addUnit)(parseInt(_unref(getPx)(textSize.value)) * 1.35);
            },
        ...
        _createSharedDataSlot("default", null, null, () => {
          _renderSharedDataEffect(() => {
            _setSharedDataStyle(__sharedData, 6, [{ fontSize: textSize.value + "px", color: textColorCom.value }]);
