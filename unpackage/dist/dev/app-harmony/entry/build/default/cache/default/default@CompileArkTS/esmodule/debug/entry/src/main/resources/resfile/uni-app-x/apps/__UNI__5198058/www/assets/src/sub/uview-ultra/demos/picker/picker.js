...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n19 = _createSharedDataComponent(_sfc_main$1, "b01eb986", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n18 = _createSharedDataComponent(_sfc_main$2, "5623c459", {
            ...
            "default": _withSharedDataVaporCtx(() => {
              ...
              const n14 = _createSharedDataComponentWithFallback(_component_up_picker, "5c440a13", {
                show: () => {
              ...
              const n15 = _createSharedDataComponentWithFallback(_component_up_picker, "5c44109d", {
                show: () => {
              ...
              const n16 = _createSharedDataComponentWithFallback(_component_up_picker, "5c44149c", {
                show: () => {
