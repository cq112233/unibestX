...
import { _ as __easycom_2 } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/components/up-picker/up-picker&";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, _a) {
    ...
    function onPickerConfirm(e) {
      uni.__f__("log", "at src/sub/uview-ultra/demos/picker/picker.uvue:30", "picker confirm", e);
      pickerShow.value = false;
    }
    const __returned__ = { pickerShow, columns, onPickerConfirm, get AppKu() {
      return AppKu;
    }, get LayoutComponent() {
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  const _component_up_picker = resolveEasycom(resolveDynamicComponent("up-picker"), __easycom_2);
        ...
        default: withCtx(() => [
          createElementVNode("view", { class: "page-container bg-__f8fafc_ min-h-screen pb-30px" }, [
              ...
              createElementVNode("view", { class: "demo-block" }, [
                ...
                createElementVNode("view", { class: "flex-row items-center" }, [
                  createVNode(_component_up_button, {
                    ...
                    text: "打开选择器",
                    size: "mini",
                    onClick: _cache[0] || (_cache[0] = ($event) => $setup.pickerShow = true)
                  })
                ])
              ])
            ]),
            createVNode(_component_up_picker, {
              ...
              onCancel: _cache[1] || (_cache[1] = ($event) => $setup.pickerShow = false)
            }, null, 8, ["show", "columns"])
          ])
        ]),
        _: 1
