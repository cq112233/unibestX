...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n28 = _createSharedDataComponent(_sfc_main$1, "84297ec6", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n27 = _createSharedDataComponent(LayoutComponent, "01065a0e", {
            ...
            "default": _withSharedDataVaporCtx(() => {
              const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "1fc4e68e", {
                title: "Tabs 标签页",
                "auto-back": true
              });
              _setSharedData(__sharedData, 2, n0?.sharedData);
              const n2 = _createSharedDataComponentWithFallback(_component_up_tabs, "1fc4d794", {
                current: () => {
              ...
              const n8 = _createSharedDataComponentWithFallback(_component_up_tabs, "1fc4b3aa", {
                current: () => {
              ...
              const n14 = _createSharedDataComponentWithFallback(_component_up_tabs, "1393f77a", {
                current: () => {
              ...
              const n17 = _createSharedDataComponentWithFallback(_component_up_tabs, "1393ff5d", {
                current: () => {
              ...
              const n20 = _createSharedDataComponentWithFallback(_component_up_tabs, "13940a02", {
                current: () => {
              ...
              const n23 = _createSharedDataComponentWithFallback(_component_up_tabs, "13946b9b", {
                current: () => {
