...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  const _component_up_tabs = resolveEasycom(resolveDynamicComponent("up-tabs"), __easycom_1);
          ...
          createElementVNode("view", { class: "page-container bg-__f8fafc_ min-h-screen pb-30px" }, [
            ...
            createElementVNode("view", { class: "p-16px" }, [
              createElementVNode("view", { class: "demo-block" }, [
                ...
                createVNode(_component_up_tabs, { list: [{ name: "关注" }, { name: "推荐" }, { name: "科技" }] })
              ]),
              createElementVNode("view", { class: "demo-block mt-12px" }, [
                createElementVNode("text", { class: "demo-label" }, "滑块主题"),
                createVNode(_component_up_tabs, {
                  list: [{ name: "关注" }, { name: "推荐" }, { name: "科技" }],
                  "line-color": "#fa3534",
                  "active-style": { color: "#fa3534" }
                })
              ])
            ])
          ])
