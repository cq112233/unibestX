...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n10 = _createSharedDataComponent(_sfc_main$1, "84297ec6", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n9 = _createSharedDataComponent(_sfc_main$2, "01065a0e", {
            ...
            "default": _withSharedDataVaporCtx(() => {
              ...
              const n2 = _createSharedDataComponentWithFallback(_component_up_tabs, "1fc4d888", { list: [{ name: "关注" }, { name: "推荐" }, { name: "科技" }] });
              _setSharedData(__sharedData, 3, n2?.sharedData);
              const n5 = _createSharedDataComponentWithFallback(_component_up_tabs, "1fc4ca38", {
