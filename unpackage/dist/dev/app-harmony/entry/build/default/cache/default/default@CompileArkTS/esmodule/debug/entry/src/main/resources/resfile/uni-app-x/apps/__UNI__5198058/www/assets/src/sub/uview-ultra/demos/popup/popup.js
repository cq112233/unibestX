...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n22 = _createSharedDataComponent(_sfc_main$1, "69dd3ce1", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n21 = _createSharedDataComponent(_sfc_main$2, "5c6b4196", {
            "navigation-style": "custom",
            "navigation-bar-title-text": "up-popup 弹出层"
          }, {
            "default": _withSharedDataVaporCtx(() => {
              const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "678187fe", {
                title: "up-popup 弹出层",
                "auto-back": true,
              ...
              const n2 = _createSharedDataComponentWithFallback(_component_up_button, "678192c7", {
                type: "primary",
                text: "顶部弹出",
                size: "mini",
                onClick: () => {
              ...
              const n4 = _createSharedDataComponentWithFallback(_component_up_button, "67819702", {
                type: "primary",
                text: "底部弹出",
                size: "mini",
                onClick: () => {
              ...
              const n8 = _createSharedDataComponentWithFallback(_component_up_button, "6781a1e2", {
                type: "success",
                text: "左侧弹出",
                size: "mini",
                onClick: () => {
              ...
              const n10 = _createSharedDataComponentWithFallback(_component_up_button, "6781a609", {
                type: "success",
                text: "右侧弹出",
                size: "mini",
                onClick: () => {
              ...
              const n12 = _createSharedDataComponentWithFallback(_component_up_button, "eea13e4c", {
                type: "success",
                text: "居中弹出",
                size: "mini",
                onClick: () => {
              ...
              const n19 = _createSharedDataComponentWithFallback(_component_up_popup, "eea135d6", {
                show: () => {
