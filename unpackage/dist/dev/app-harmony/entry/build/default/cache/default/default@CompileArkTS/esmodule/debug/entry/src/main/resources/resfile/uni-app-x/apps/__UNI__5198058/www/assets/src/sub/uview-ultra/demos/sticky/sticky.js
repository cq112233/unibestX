...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n17 = _createSharedDataComponent(_sfc_main$1, "631e8033", null, {
        "default": _withSharedDataVaporCtx(() => {
          _renderSharedDataEffect(() => {
            return _setSharedDataStyle(__sharedData, 6, { height: `${windowHeight.value}px` });
          });
          const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "157f3df3", {
            title: "Sticky 吸顶",
            "auto-back": true
          });
          _setSharedData(__sharedData, 1, n0?.sharedData);
          const n9 = _createSharedDataComponentWithFallback(_component_up_sticky, "157f5533", {
            "offset-top": 0,
            "custom-nav-height": () => {
            ...
            "default": _withSharedDataVaporCtx(() => {
              const n7 = _createSharedDataComponentWithFallback(_component_up_button, "cb2efe76", {
                size: "small",
                type: "warning",
                text: "立即体验",
                class: "w-90px"
