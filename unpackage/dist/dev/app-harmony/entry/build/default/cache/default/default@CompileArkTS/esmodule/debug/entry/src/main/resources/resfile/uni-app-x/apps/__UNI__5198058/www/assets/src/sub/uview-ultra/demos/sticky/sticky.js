...
import "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/libs/config/zIndex&";
...
const _style_0 = {"page-container":{"":{"display":"flex","flexDirection":"column"}},"flex":{"":{"display":"flex"}},"bg-_b_hf8fafc_B":{"":{"backgroundColor":"#f8fafc"}},"bg-white":{"":{"backgroundColor":"var(--color-white)"}},"flex-row":{"":{"flexDirection":"row"}},"items-center":{"":{"alignItems":"center"}},"font-bold":{"":{"--tw-font-weight":"700","fontWeight":"var(--font-weight-bold)","-TwFontWeight":"var(--font-weight-bold)"}},"text-_b_h1e293b_B":{"":{"color":"#1e293b"}},"text-_b_h64748b_B":{"":{"color":"#64748b"}},"justify-between":{"":{"justifyContent":"space-between"}},"shadow-sm":{"":{"--tw-inset-shadow":"0 0 #0000","--tw-inset-ring-shadow":"0 0 #0000","--tw-ring-offset-shadow":"0 0 #0000","--tw-ring-shadow":"0 0 #0000","--tw-shadow":"0 1px 3px 0 rgba(0, 0, 0, 0.1), 0 1px 2px -1px rgba(0, 0, 0, 0.1)","boxShadow":"var(--tw-inset-shadow),var(--tw-inset-ring-shadow),var(--tw-ring-offset-shadow),var(--tw-ring-shadow),var(--tw-shadow)","-TwShadow":"0 1px 3px 0 var(--tw-shadow-color,rgba(0,0,0,0.1)),0 1px 2px -1px var(--tw-shadow-color,rgba(0,0,0,0.1))"}},"text-white":{"":{"color":"var(--color-white)"}},"text-_b_h334155_B":{"":{"color":"#334155"}},"text-_b_h94a3b8_B":{"":{"color":"#94a3b8"}}};
                ...
                [
                  _createElementVNode("view", { class: "bg-white rounded-8px p-12px mb-12px shadow-xs" }, [
                    _createElementVNode("view", { class: "flex-row items-center mb-10px" }, [
                      ...
                      _createElementVNode("text", { class: "text-14px font-bold text-_b_h1e293b_B" }, "吸顶效果说明")
                    ]),
                    _createElementVNode("text", { class: "text-13px text-_b_h64748b_B leading-20px" }, " 向上滑动页面，当下面的操作栏滚动到顶部时，会触发 up-sticky 组件吸顶悬浮固定。 ")
                  ]),
                  _createVNode(_component_up_sticky, {
                    ...
                    default: _withCtx(() => [
                      _createElementVNode("view", { class: "bg-_b_h2979ff_B p-12px rounded-8px flex-row items-center justify-between shadow-sm mb-10px" }, [
                        _createElementVNode("text", { class: "text-white font-bold text-14px" }, "📌 悬浮吸顶操作栏"),
                  ...
                  (_openBlock(), _createElementBlock(
                    ...
                    _renderList(25, (i) => {
                      return _createElementVNode("view", {
                        ...
                        _createElementVNode("text", { class: "text-12px text-_b_h94a3b8_B mt-4px" }, "向下滑动页面查看吸顶保持效果...")
                      ]);
                    }),
                    64
                    /* STABLE_FRAGMENT */
