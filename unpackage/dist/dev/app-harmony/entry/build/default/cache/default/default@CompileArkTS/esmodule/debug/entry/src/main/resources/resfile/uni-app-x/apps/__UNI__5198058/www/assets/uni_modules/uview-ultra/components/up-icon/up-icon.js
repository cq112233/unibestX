    ...
    return () => {
      ...
      _createSharedDataIf(() => {
        ...
        _renderSharedDataEffect(() => {
          ...
          _setSharedDataStyle(__sharedData, 3, [imgStyle.value, _unref(addStyle)(__props.customStyle)]);
        });
      }, () => {
        _renderSharedDataEffect(() => {
          _setSharedDataClass(__sharedData, 4, ["up-icon__icon", uClasses.value]);
          _setSharedDataStyle(__sharedData, 5, [iconStyle.value, _unref(addStyle)(__props.customStyle)]);
      ...
      _createSharedDataIf(() => {
        ...
        _renderSharedDataEffect(() => {
          ...
          const _labelPos = __props.labelPos;
          const _space = __props.space;
          _setSharedDataStyle(__sharedData, 9, {
            color: __props.labelColor,
            fontSize: _addUnit(__props.labelSize),
            marginLeft: _labelPos == "right" ? _addUnit(_space) : 0,
            marginTop: _labelPos == "bottom" ? _addUnit(_space) : 0,
            marginRight: _labelPos == "left" ? _addUnit(_space) : 0,
            marginBottom: _labelPos == "top" ? _addUnit(_space) : 0
          });
