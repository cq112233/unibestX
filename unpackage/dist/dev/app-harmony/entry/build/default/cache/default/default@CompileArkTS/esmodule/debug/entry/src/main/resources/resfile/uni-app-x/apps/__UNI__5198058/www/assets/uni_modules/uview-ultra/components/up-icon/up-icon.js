    ...
    return () => {
      ...
      _createSharedDataIf(() => {
        ...
        _renderSharedDataEffect(() => {
          ...
          _setSharedDataStyle(__sharedData, 3, [imgStyle.value, $up.addStyle(customStyle)]);
        });
      }, () => {
        _renderSharedDataEffect(() => {
          _setSharedDataClass(__sharedData, 4, ["up-icon__icon", uClasses.value]);
          _setSharedDataStyle(__sharedData, 5, [iconStyle.value, $up.addStyle(customStyle)]);
      ...
      _createSharedDataIf(() => {
        ...
        _renderSharedDataEffect(() => {
          ...
          _setSharedDataStyle(__sharedData, 9, {
            ...
            fontSize: _$up.addUnit(__props.labelSize),
            marginLeft: _labelPos == "right" ? _$up.addUnit(_space) : 0,
            marginTop: _labelPos == "bottom" ? _$up.addUnit(_space) : 0,
            marginRight: _labelPos == "left" ? _$up.addUnit(_space) : 0,
            marginBottom: _labelPos == "top" ? _$up.addUnit(_space) : 0
          });
