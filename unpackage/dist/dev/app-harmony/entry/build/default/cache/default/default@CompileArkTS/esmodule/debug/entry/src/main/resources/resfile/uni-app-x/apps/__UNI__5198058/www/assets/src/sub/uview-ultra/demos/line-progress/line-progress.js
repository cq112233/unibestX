      ...
      const n7 = _createSharedDataComponent(AppKu, "014b5a23", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n6 = _createSharedDataComponent(LayoutComponent, "281fea33", {
            ...
            "default": _withSharedDataVaporCtx(() => {
              const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "4845460a", {
                title: "LineProgress 线型进度条",
                "auto-back": true
              });
              _setSharedData(__sharedData, 2, n0?.sharedData);
              const n2 = _createSharedDataComponentWithFallback(_component_up_line_progress, "484537be", {
                percentage: 50,
                "active-color": "#2979ff"
              });
...
const _style_0 = {};
const lineProgress = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0]]]);
export {
