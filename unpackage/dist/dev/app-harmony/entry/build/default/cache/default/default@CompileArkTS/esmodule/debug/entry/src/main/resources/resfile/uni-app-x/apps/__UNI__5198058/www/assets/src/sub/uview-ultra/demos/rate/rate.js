...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n19 = _createSharedDataComponent(AppKu, "3b349161", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n18 = _createSharedDataComponent(LayoutComponent, "2b5d9ab5", {
            "navigation-style": "custom",
            "navigation-bar-title-text": "up-rate 评分"
          }, {
            "default": _withSharedDataVaporCtx(() => {
              const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "4055bc98", {
                title: "up-rate 评分",
                "auto-back": true,
              ...
              const n2 = _createSharedDataComponentWithFallback(_component_up_rate, "4055c440", {
                modelValue: () => {
              ...
              const n5 = _createSharedDataComponentWithFallback(_component_up_rate, "4055cb63", {
                modelValue: () => {
              ...
              const n8 = _createSharedDataComponentWithFallback(_component_up_rate, "4055d5e6", {
                modelValue: () => {
              ...
              const n11 = _createSharedDataComponentWithFallback(_component_up_rate, "4055daa2", {
                modelValue: () => {
              ...
              const n14 = _createSharedDataComponentWithFallback(_component_up_rate, "6b3c8620", {
                modelValue: () => {
...
const _style_0 = {};
const rate = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0]]]);
export {
  rate as default
};
