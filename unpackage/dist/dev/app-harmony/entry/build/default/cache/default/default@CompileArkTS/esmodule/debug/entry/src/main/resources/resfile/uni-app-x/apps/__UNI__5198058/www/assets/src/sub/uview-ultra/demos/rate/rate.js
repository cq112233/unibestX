...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n18 = _createSharedDataComponent(_sfc_main$1, "3b349161", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "2b5d9b8c", {
            title: "up-rate 评分",
            "auto-back": true,
          ...
          const n2 = _createSharedDataComponentWithFallback(_component_up_rate, "4055c07c", {
            modelValue: () => {
          ...
          const n5 = _createSharedDataComponentWithFallback(_component_up_rate, "4055c786", {
            modelValue: () => {
          ...
          const n8 = _createSharedDataComponentWithFallback(_component_up_rate, "4055cf65", {
            modelValue: () => {
          ...
          const n11 = _createSharedDataComponentWithFallback(_component_up_rate, "4055d6a8", {
            modelValue: () => {
          ...
          const n14 = _createSharedDataComponentWithFallback(_component_up_rate, "6b3c8e1c", {
            modelValue: () => {
