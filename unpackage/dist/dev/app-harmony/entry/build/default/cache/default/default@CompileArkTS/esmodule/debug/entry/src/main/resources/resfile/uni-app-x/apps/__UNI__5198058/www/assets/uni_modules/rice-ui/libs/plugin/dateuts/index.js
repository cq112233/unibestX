import { p as parseDate, a as absFloor, b as padStart, g as getH, c as getShort, m as monthDiff } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/rice-ui/libs/plugin/dateuts/utils&";
import { l as local } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/rice-ui/libs/plugin/dateuts/locale&";
import { Y, M, Q, D, W, a as DATE, H, b as MIN, S, I as INVALID_DATE_STRING, R as REGEX_FORMAT, c as MS, d as MILLISECONDS_A_MINUTE, e as MILLISECONDS_A_HOUR, f as MILLISECONDS_A_SECOND, g as MILLISECONDS_A_DAY, h as MILLISECONDS_A_WEEK } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/rice-ui/libs/plugin/dateuts/constant&";
import { D as DateParams, a as DateObject } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/rice-ui/libs/plugin/dateuts/type&";
const wrapper = (d) => {
  return dateuts(d);
};
const isDateuts = (d = null) => {
  return UTS.isInstanceOf(d, Dateuts);
};
class Dateuts {
  constructor(params) {
    this.$y = 0;
  ...
  format(formatStr) {
    ...
    return formatStr.replace(REGEX_FORMAT, (match, p1 = null, offset, str) => {
      if (p1 == null) {
  ...
  add(num, unit) {
    ...
    const step = (_a = UTS.mapGet(stepMap, unit)) !== null && _a !== void 0 ? _a : 1;
