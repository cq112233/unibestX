...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  const _component_up_no_network = resolveEasycom(resolveDynamicComponent("up-no-network"), __easycom_1);
          ...
          createElementVNode("view", { class: "page-container bg-__f8fafc_ min-h-screen pb-30px" }, [
            ...
            createElementVNode("view", { class: "p-16px" }, [
              createElementVNode("view", { class: "demo-block" }, [
                createElementVNode("text", { class: "demo-label" }, "无网络提示"),
                createElementVNode("text", { class: "text-12px text-__909399_" }, "引入该组件即自动监听网络状态，断网时全屏展示遮罩提示。")
              ])
            ]),
