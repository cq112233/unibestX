...
const _style_0 = { "bg-__f8fafc_": { "": { "backgroundImage": "none", "backgroundColor": "#f8fafc" } }, "p-16px": { "": { "paddingTop": 16, "paddingRight": 16, "paddingBottom": 16, "paddingLeft": 16 } }, "pb-30px": { "": { "paddingBottom": 30 } }, "text-__909399_": { "": { "color": "#909399" } }, "text-12px": { "": { "fontSize": 12 } } };
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  const _component_up_no_network = resolveEasycom(__resolveDynamicComponent("up-no-network"), __easycom_1);
          ...
          _createElementVNode("view", { class: "page-container bg-__f8fafc_ min-h-screen pb-30px" }, [
            ...
            _createElementVNode("view", { class: "p-16px" }, [
              _createElementVNode("view", { class: "demo-block" }, [
                _createElementVNode("text", { class: "demo-label" }, "无网络提示"),
                _createElementVNode("text", { class: "text-12px text-__909399_" }, "引入该组件即自动监听网络状态，断网时全屏展示遮罩提示。")
              ])
            ]),
            _createVNode(_component_up_no_network)
          ])
        ]),
        _: 1
        /* STABLE */
...
const noNetwork = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["styles", [_style_0, _style_1]], ["__file", "/Users/chenqi/Documents/chenqi-front/unibestX/src/sub/uview-ultra/demos/no-network/no-network.uvue"]]);
export {
