...
import { _ as __easycom_1 } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/components/up-no-network/up-no-network&";
...
import "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/components/up-button/up-button&";
...
const __className = "GenSrcSubUviewUltraDemosNoNetworkNoNetwork";
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    const __sharedData = __sharedDataRenderer == "component" ? _withSharedDataComponent(new UniDynamicSharedDataComponent(_useSharedDataScope(), _useSharedDataComponentOptions({ bundleKey: "GenSrcSubUviewUltraDemosNoNetworkNoNetworkSharedData", sharedDataClassId: 0 }))) : _withSharedDataPage(new UniDynamicSharedDataPage(_useSharedDataPageId(), _useSharedDataPageOptions({ bundleKey: "GenSrcSubUviewUltraDemosNoNetworkNoNetworkSharedData", sharedDataClassId: 0 })));
    _useSharedDataScope(__sharedData);
    return () => {
      "raw js";
      const _component_NavBar = __easycom_0;
      const _component_up_no_network = __easycom_1;
      const n8 = _createSharedDataComponent(_sfc_main$1, "c3b097fe", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n7 = _createSharedDataComponent(_sfc_main$2, "26cecc15", {
            "navigation-style": "custom",
            "navigation-bar-title-text": "up-no-network 无网络"
          }, {
            "default": _withSharedDataVaporCtx(() => {
              const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "99ea9190", {
              ...
              const n5 = _createSharedDataComponentWithFallback(_component_up_no_network, "99ea756a");
...
const _style_0 = {};
const _style_1 = {};
const noNetwork = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0, _style_1]]]);
export {
