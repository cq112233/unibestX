...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n7 = _createSharedDataComponent(_sfc_main$1, "c3b097fe", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "26ceccec", {
          ...
          const n5 = _createSharedDataComponentWithFallback(_component_up_no_network, "99ea7cea");
