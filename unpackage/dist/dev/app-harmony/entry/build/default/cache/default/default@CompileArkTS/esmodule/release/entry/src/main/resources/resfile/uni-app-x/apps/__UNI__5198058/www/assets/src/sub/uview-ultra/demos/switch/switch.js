...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n26 = _createSharedDataComponent(_sfc_main$1, "369ee909", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n25 = _createSharedDataComponent(LayoutComponent, "c5838fe6", {
            ...
            "default": _withSharedDataVaporCtx(() => {
              const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "0a88ca26", {
                title: "up-switch 开关",
                "auto-back": true,
              ...
              const n2 = _createSharedDataComponentWithFallback(_component_up_switch, "0a88d4ef", {
                modelValue: () => {
              ...
              const n7 = _createSharedDataComponentWithFallback(_component_up_switch, "0a88e049", {
                modelValue: () => {
              ...
              const n11 = _createSharedDataComponentWithFallback(_component_up_switch, "0a88e82d", {
                modelValue: () => {
              ...
              const n15 = _createSharedDataComponentWithFallback(_component_up_switch, "4690674d", {
                modelValue: () => {
              ...
              const n19 = _createSharedDataComponentWithFallback(_component_up_switch, "46906f8f", {
                modelValue: () => {
              ...
              const n20 = _createSharedDataComponentWithFallback(_component_up_switch, "4690732a", {
                modelValue: () => {
                  return switchValue5.value;
                },
                "onUpdate:modelValue": () => {
