...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n30 = _createSharedDataComponent(_sfc_main$1, "15f49221", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "aec49a68", {
            title: "Table 表格",
            "auto-back": true,
          ...
          const n14 = _createSharedDataComponentWithFallback(_component_up_table, "6b18913a", null, {
            "default": _withSharedDataVaporCtx(() => {
              const n5 = _createSharedDataComponentWithFallback(_component_up_tr, "6b189404", null, {
                "default": _withSharedDataVaporCtx(() => {
                  const n2 = _createSharedDataComponentWithFallback(_component_up_th, "6b189442", { text: "学校" });
                  _setSharedData(__sharedData, 4, n2?.sharedData);
                  const n3 = _createSharedDataComponentWithFallback(_component_up_th, "6b1894bc", { text: "班级" });
                  _setSharedData(__sharedData, 5, n3?.sharedData);
                  const n4 = _createSharedDataComponentWithFallback(_component_up_th, "6b1897c1", { text: "年龄" });
                  _setSharedData(__sharedData, 6, n4?.sharedData);
                })
              });
              _setSharedData(__sharedData, 3, n5?.sharedData);
              const n9 = _createSharedDataComponentWithFallback(_component_up_tr, "6b189861", null, {
                "default": _withSharedDataVaporCtx(() => {
                  const n6 = _createSharedDataComponentWithFallback(_component_up_td, "6b18989f", { text: "浙江大学" });
                  _setSharedData(__sharedData, 8, n6?.sharedData);
                  const n7 = _createSharedDataComponentWithFallback(_component_up_td, "6b189ba6", { text: "二年级" });
                  _setSharedData(__sharedData, 9, n7?.sharedData);
                  const n8 = _createSharedDataComponentWithFallback(_component_up_td, "6b189c21", { text: "22" });
                  _setSharedData(__sharedData, 10, n8?.sharedData);
                })
              });
              _setSharedData(__sharedData, 7, n9?.sharedData);
              const n13 = _createSharedDataComponentWithFallback(_component_up_tr, "6b189f4c", null, {
                "default": _withSharedDataVaporCtx(() => {
                  const n10 = _createSharedDataComponentWithFallback(_component_up_td, "6b189f8a", { text: "清华大学" });
                  _setSharedData(__sharedData, 12, n10?.sharedData);
                  const n11 = _createSharedDataComponentWithFallback(_component_up_td, "6b18a006", { text: "05班" });
                  _setSharedData(__sharedData, 13, n11?.sharedData);
                  const n12 = _createSharedDataComponentWithFallback(_component_up_td, "6b18a30c", { text: "24" });
                  _setSharedData(__sharedData, 14, n12?.sharedData);
                })
              });
          ...
          const n26 = _createSharedDataComponentWithFallback(_component_up_table, "6b18a7a7", { border: false }, {
            "default": _withSharedDataVaporCtx(() => {
              const n19 = _createSharedDataComponentWithFallback(_component_up_tr, "6b18aaab", null, {
                "default": _withSharedDataVaporCtx(() => {
                  const n17 = _createSharedDataComponentWithFallback(_component_up_th, "6b18aae9", { text: "名称" });
                  _setSharedData(__sharedData, 17, n17?.sharedData);
                  const n18 = _createSharedDataComponentWithFallback(_component_up_th, "6b18ab63", { text: "类型" });
                  _setSharedData(__sharedData, 18, n18?.sharedData);
                })
              });
              _setSharedData(__sharedData, 16, n19?.sharedData);
              const n22 = _createSharedDataComponentWithFallback(_component_up_tr, "100dffd2", null, {
                "default": _withSharedDataVaporCtx(() => {
                  const n20 = _createSharedDataComponentWithFallback(_component_up_td, "100dff56", { text: "uview-ultra" });
                  _setSharedData(__sharedData, 20, n20?.sharedData);
                  const n21 = _createSharedDataComponentWithFallback(_component_up_td, "100df910", { text: "UI库" });
                  _setSharedData(__sharedData, 21, n21?.sharedData);
                })
              });
              _setSharedData(__sharedData, 19, n22?.sharedData);
              const n25 = _createSharedDataComponentWithFallback(_component_up_tr, "100df7a4", null, {
                "default": _withSharedDataVaporCtx(() => {
                  const n23 = _createSharedDataComponentWithFallback(_component_up_td, "100df728", { text: "uni-app X" });
                  _setSharedData(__sharedData, 23, n23?.sharedData);
                  const n24 = _createSharedDataComponentWithFallback(_component_up_td, "100df110", { text: "框架" });
                  _setSharedData(__sharedData, 24, n24?.sharedData);
                })
              });
