...
const { defineComponent, resolveDynamicComponent, openBlock, createBlock, withCtx, createVNode, createElementVNode, createTextVNode } = globalThis.Vue
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  const _component_up_th = resolveEasycom(resolveDynamicComponent("up-th"), __easycom_1);
  const _component_up_tr = resolveEasycom(resolveDynamicComponent("up-tr"), __easycom_2);
  const _component_up_td = resolveEasycom(resolveDynamicComponent("up-td"), __easycom_3);
  const _component_up_table = resolveEasycom(resolveDynamicComponent("up-table"), __easycom_4);
          ...
          createElementVNode("view", { class: "page-container bg-__f8fafc_ min-h-screen pb-30px" }, [
            ...
            createElementVNode("view", { class: "p-16px" }, [
              createElementVNode("view", { class: "demo-block" }, [
                createElementVNode("text", { class: "demo-label" }, "基础表格"),
              ...
              createElementVNode("view", { class: "demo-block mt-12px" }, [
                createElementVNode("text", { class: "demo-label" }, "无边框"),
                createVNode(_component_up_table, { border: false }, {
                  default: withCtx(() => [
                    createVNode(_component_up_tr, null, {
                      default: withCtx(() => [
                        createVNode(_component_up_th, null, {
