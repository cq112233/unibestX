  ...
  setup(__props, _a) {
    ...
    return () => {
      ...
      _renderSharedDataEffect(() => {
        ...
        _setSharedDataStyle(__sharedData, 23, [_unref(addStyle)(__props.customStyle)]);
      ...
      _createSharedDataIf(() => {
        ...
        _createSharedDataIf(() => {
          ...
          const n6 = _createSharedDataComponentWithFallback(_component_up_icon, "50dbb0cc", {
            name: () => {
              return __props.icon;
            },
            "custom-style": () => {
      ...
      _createSharedDataIf(() => {
        ...
        _createSharedDataSlot("right-icon", null, null, () => {
          _createSharedDataIf(() => {
            ...
            const n31 = _createSharedDataComponentWithFallback(_component_up_icon, "6acec0ec", {
              name: () => {
      ...
      _createSharedDataIf(() => {
        ...
        const n40 = _createSharedDataComponentWithFallback(_component_up_line, "6ace04c6");
