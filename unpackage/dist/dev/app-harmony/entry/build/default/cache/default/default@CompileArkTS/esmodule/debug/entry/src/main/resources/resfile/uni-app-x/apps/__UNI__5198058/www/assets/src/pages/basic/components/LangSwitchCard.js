...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n25 = _createSharedDataComponent(
        Card,
        "2b814c75",
        { title: () => {
        ...
        } },
        {
          "default": _withSharedDataVaporCtx(() => {
            ...
            _createSharedDataIf(() => {
              ...
              const n14 = _createSharedDataComponentWithFallback(_component_uni_icons, "88bf6ebe", {
                type: "checkmarkempty",
                size: "20",
                style: "color: #3b82f6;"
              });
            ...
            _createSharedDataIf(() => {
              ...
              const n22 = _createSharedDataComponentWithFallback(_component_uni_icons, "88beabcc", {
                type: "checkmarkempty",
                size: "20",
                style: "color: #3b82f6;"
              });
