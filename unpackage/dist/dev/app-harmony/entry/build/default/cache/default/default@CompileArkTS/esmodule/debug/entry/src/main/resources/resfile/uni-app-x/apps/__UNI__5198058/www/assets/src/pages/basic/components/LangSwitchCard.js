...
import { s as setTabbarItem, t as t$1 } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/src/utils/i18n&";
    ...
    default: _withCtx(() => [
      _createElementVNode("view", { class: "rounded-12px p-16px mb-16px border-width-1px border-style-solid border-color-__e2e8f0_" }, [
        _createElementVNode(
          ...
          _toDisplayString(_ctx.$t("basic.langPreview")),
          1
          /* TEXT */
        ),
        _createElementVNode(
          ...
          _toDisplayString(_ctx.$t("message.welcome")),
          1
          /* TEXT */
        ),
        _createElementVNode(
          ...
          _toDisplayString(_ctx.$t("message.hello", { msg: "hi" })),
          1
          /* TEXT */
        ),
        _createElementVNode("view", { class: "mt-12px pt-12px border-top-width-1px border-top-style-solid border-top-color-__f1f5f9_" }, [
          _createElementVNode(
            "text",
            { class: "text-12px text-__94a3b8_ mb-6px" },
            _toDisplayString(_ctx.$t("basic.uviewPreview")),
            1
            /* TEXT */
          ),
