...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n16 = _createSharedDataComponent(AppKu, "152cb823", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n15 = _createSharedDataComponent(LayoutComponent, "df2b679a", {
            "navigation-style": "custom",
            "navigation-bar-title-text": "up-slider 滑块"
          }, {
            "default": _withSharedDataVaporCtx(() => {
              const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "7cdf3adc", {
                title: "up-slider 滑块",
                "auto-back": true,
              ...
              const n2 = _createSharedDataComponentWithFallback(_component_up_slider, "7cdf4526", {
                modelValue: () => {
              ...
              const n5 = _createSharedDataComponentWithFallback(_component_up_slider, "7cdf49de", {
                modelValue: () => {
              ...
              const n8 = _createSharedDataComponentWithFallback(_component_up_slider, "7cdf5104", {
                modelValue: () => {
              ...
              const n11 = _createSharedDataComponentWithFallback(_component_up_slider, "7cdf588d", {
                modelValue: () => {
...
const _style_0 = {};
const slider = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0]]]);
export {
  slider as default
};
