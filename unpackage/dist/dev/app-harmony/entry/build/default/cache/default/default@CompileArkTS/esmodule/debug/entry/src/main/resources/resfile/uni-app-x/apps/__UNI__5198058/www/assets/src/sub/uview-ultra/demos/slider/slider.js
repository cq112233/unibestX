...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n15 = _createSharedDataComponent(_sfc_main$1, "152cb823", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "df2b65ec", {
            title: "up-slider 滑块",
            "auto-back": true,
          ...
          const n2 = _createSharedDataComponentWithFallback(_component_up_slider, "7cdf3ec0", {
            modelValue: () => {
          ...
          const n5 = _createSharedDataComponentWithFallback(_component_up_slider, "7cdf45ff", {
            modelValue: () => {
          ...
          const n8 = _createSharedDataComponentWithFallback(_component_up_slider, "7cdf4d0c", {
            modelValue: () => {
          ...
          const n11 = _createSharedDataComponentWithFallback(_component_up_slider, "7cdf54a6", {
            modelValue: () => {
