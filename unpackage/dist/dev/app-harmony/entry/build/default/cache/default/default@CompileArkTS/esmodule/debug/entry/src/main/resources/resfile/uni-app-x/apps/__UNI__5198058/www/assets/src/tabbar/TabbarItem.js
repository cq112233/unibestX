...
const { createElementVNode: _createElementVNode, openBlock: _openBlock, createElementBlock: _createElementBlock, createCommentVNode: _createCommentVNode, resolveComponent: _resolveComponent, normalizeStyle: _normalizeStyle, createVNode: _createVNode, toDisplayString: _toDisplayString } = globalThis.Vue;
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_uni_icons = resolveEasycom(__resolveDynamicComponent("uni-icons"), __easycom_1);
  return $setup.props.isBulge ? (_openBlock(), _createElementBlock("view", {
    key: 0,
    class: "bulge-item"
  }, [
    ...
    _createElementVNode(
      ...
      _toDisplayString(_ctx.$t($setup.tabbarItem.text)),
      5
      /* TEXT, STYLE */
    ),
