...
const _sfc_main = /* @__PURE__ */ _defineComponent({
  ...
  setup(__props, _a) {
    ...
    const __returned__ = { props, inactiveColor, tabbarItem, getIcon, getActiveColor, isDotBadge, isNumberBadge, getBadgeText, get $t() {
      return $t;
    } };
  ...
  return _openBlock(), _createElementBlock("view", {
    ...
    $setup.props.isBulge ? (_openBlock(), _createElementBlock("view", {
      ...
      _createElementVNode(
        ...
        _toDisplayString($setup.$t($setup.tabbarItem.text)),
        5
        /* TEXT, STYLE */
      ),
