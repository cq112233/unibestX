...
`);
    return () => {
      ...
      const n23 = _createSharedDataComponent(_sfc_main$1, "2a02d9fd", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "16586670", {
            title: "mp-html 富文本组件",
            "auto-back": true
          });
          _setSharedData(__sharedData, 1, n0?.sharedData);
          const n2 = _createSharedDataComponentWithFallback(_component_mp_html, "96975648", { content: () => {
            return content1.value;
          } });
          _setSharedData(__sharedData, 2, n2?.sharedData);
          const n6 = _createSharedDataComponentWithFallback(_component_mp_html, "969746b6", { content: () => {
            return contentTable.value;
          } });
          _setSharedData(__sharedData, 3, n6?.sharedData);
          const n10 = _createSharedDataComponentWithFallback(_component_mp_html, "969736f8", { content: () => {
            return contentList.value;
          } });
          _setSharedData(__sharedData, 4, n10?.sharedData);
          const n14 = _createSharedDataComponentWithFallback(_component_mp_html, "96972742", { content: () => {
            return contentCode.value;
          } });
          _setSharedData(__sharedData, 5, n14?.sharedData);
          const n18 = _createSharedDataComponentWithFallback(_component_mp_html, "3c553c02", { content: () => {
