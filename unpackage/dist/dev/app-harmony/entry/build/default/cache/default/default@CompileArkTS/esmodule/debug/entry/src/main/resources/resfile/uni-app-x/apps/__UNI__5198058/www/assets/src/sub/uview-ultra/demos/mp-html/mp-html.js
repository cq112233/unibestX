      ...
      const n24 = _createSharedDataComponent(AppKu, "2a02d9fd", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n23 = _createSharedDataComponent(LayoutComponent, "16586599", {
            ...
            "default": _withSharedDataVaporCtx(() => {
              const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "96976392", {
                title: "mp-html 富文本组件",
                "auto-back": true
              });
              _setSharedData(__sharedData, 2, n0?.sharedData);
              const n2 = _createSharedDataComponentWithFallback(_component_mp_html, "96974eba", { content: () => {
                return content1.value;
              } });
              _setSharedData(__sharedData, 3, n2?.sharedData);
              const n6 = _createSharedDataComponentWithFallback(_component_mp_html, "96973ef6", { content: () => {
                return contentTable.value;
              } });
              _setSharedData(__sharedData, 4, n6?.sharedData);
              const n10 = _createSharedDataComponentWithFallback(_component_mp_html, "96972f06", { content: () => {
                return contentList.value;
              } });
              _setSharedData(__sharedData, 5, n10?.sharedData);
              const n14 = _createSharedDataComponentWithFallback(_component_mp_html, "3c554390", { content: () => {
                return contentCode.value;
              } });
              _setSharedData(__sharedData, 6, n14?.sharedData);
              const n18 = _createSharedDataComponentWithFallback(_component_mp_html, "3c5533d6", { content: () => {
...
const _style_0 = {};
const mpHtml = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0]]]);
export {
  mpHtml as default
};
