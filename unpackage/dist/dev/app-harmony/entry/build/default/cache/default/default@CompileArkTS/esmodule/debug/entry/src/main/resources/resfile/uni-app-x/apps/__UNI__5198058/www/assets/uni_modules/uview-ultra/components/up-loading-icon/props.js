...
import { d as defProps } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/components/up-loading-icon/loadingIcon&";
let crtProp = defProps["loadingIcon"];
const propsLoadicon = {
  props: {
    // 是否显示组件
    show: {
