...
const { defineComponent, ref, resolveDynamicComponent, openBlock, createBlock, withCtx, createVNode, createElementVNode, createElementBlock, Fragment, renderList, toDisplayString, createCommentVNode } = globalThis.Vue
...
const _style_0 = { "bg-__f8fafc_": { "": { "backgroundImage": "none", "backgroundColor": "#f8fafc" } }, "font-500": { "": { "fontWeight": 500 } }, "ml-8px": { "": { "marginLeft": 8 } }, "mt-12px": { "": { "marginTop": 12 } }, "mt-4px": { "": { "marginTop": 4 } }, "none": { "": { "display": "none" } }, "p-16px": { "": { "paddingTop": 16, "paddingRight": 16, "paddingBottom": 16, "paddingLeft": 16 } }, "pb-30px": { "": { "paddingBottom": 30 } }, "text-__303133_": { "": { "color": "#303133" } }, "text-__909399_": { "": { "color": "#909399" } }, "text-12px": { "": { "fontSize": 12 } }, "text-14px": { "": { "fontSize": 14 } } };
          ...
          createElementVNode("view", { class: "page-container bg-__f8fafc_ min-h-screen pb-30px" }, [
            ...
            createElementVNode("view", { class: "p-16px" }, [
              createElementVNode("view", { class: "demo-block" }, [
                createElementVNode("text", { class: "demo-label" }, "高性能列表"),
              ...
              createElementVNode("view", { class: "demo-block mt-12px" }, [
                createElementVNode("text", { class: "demo-label" }, "简单静态列表"),
                createVNode(_component_up_list, { height: 200 }, {
                  default: withCtx(() => [
                    (openBlock(), createElementBlock(
                      Fragment,
                      null,
                      renderList(10, (item, idx) => {
