  ...
  return openBlock(), createBlock($setup["AppKu"], null, {
    default: withCtx(() => [
      createVNode($setup["LayoutComponent"], {
        ...
        default: withCtx(() => [
          createElementVNode("view", { class: "page-container bg-__f8fafc_ flex flex-col flex-1 h-full" }, [
            ...
            createCommentVNode(" 嵌套滚动外层容器 "),
            createElementVNode("scroll-view", {
              type: "nested",
              direction: "vertical",
              class: "flex-1 h-0"
            }, [
              createCommentVNode(" 列表 1：nested-scroll-header 1 (调高高度至 380px) "),
              createElementVNode("nested-scroll-header", null, [
                createElementVNode("view", { class: "p-12px pb-0" }, [
              ...
              createCommentVNode(" 列表 2：nested-scroll-header 2 (高度 280px) "),
              createElementVNode("nested-scroll-header", null, [
                createElementVNode("view", { class: "p-12px pb-24px" }, [
