...
import { _ as __easycom_3 } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/components/up-list/up-list&";
...
const _style_0 = {"demo-list-cell":{"":{"display":"flex","flexDirection":"row","alignItems":"center","paddingTop":16,"paddingRight":16,"paddingBottom":16,"paddingLeft":16,"backgroundColor":"#ffffff","borderBottomWidth":1,"borderBottomStyle":"solid","borderBottomColor":"#f5f5f5"}},"demo-list-cell-avatar":{"":{"width":40,"height":40,"borderTopLeftRadius":4,"borderTopRightRadius":4,"borderBottomRightRadius":4,"borderBottomLeftRadius":4,"marginRight":12,"backgroundColor":"#2979ff","display":"flex","justifyContent":"center","alignItems":"center"}},"demo-list-cell-content":{"":{"flexGrow":1,"flexShrink":1,"flexBasis":"0%"}},"list-loading":{"":{"display":"flex","flexDirection":"row","justifyContent":"center","alignItems":"center","paddingTop":15,"paddingRight":0,"paddingBottom":15,"paddingLeft":0}},"flex":{"":{"display":"flex"}},"bg-_b_hf8fafc_B":{"":{"backgroundColor":"#f8fafc"}},"flex-col":{"":{"flexDirection":"column"}},"flex-1":{"":{"flexGrow":1,"flexShrink":1,"flexBasis":"0%","flex":"1"}},"h-full":{"":{"height":"100%"}},"h-0":{"":{"height":0}},"p-_b12px_B":{"":{"paddingTop":12,"paddingRight":12,"paddingBottom":12,"paddingLeft":12,"padding":12}},"pb-0":{"":{"paddingBottom":0}},"text-_b14px_B":{"":{"fontSize":14}},"font-bold":{"":{"--tw-font-weight":"700","fontWeight":"var(--font-weight-bold)","-TwFontWeight":"var(--font-weight-bold)"}},"text-_b_h2979ff_B":{"":{"color":"#2979ff"}},"mb-_b8px_B":{"":{"marginBottom":8}},"bg-white":{"":{"backgroundColor":"var(--color-white)"}},"rounded-_b8px_B":{"":{"borderTopLeftRadius":8,"borderTopRightRadius":8,"borderBottomRightRadius":8,"borderBottomLeftRadius":8,"borderRadius":8}},"shadow-xs":{"":{"--tw-inset-shadow":"0 0 #0000","--tw-inset-ring-shadow":"0 0 #0000","--tw-ring-offset-shadow":"0 0 #0000","--tw-ring-shadow":"0 0 #0000","--tw-shadow":"0 1px 2px 0 rgba(0, 0, 0, 0.05)","boxShadow":"var(--tw-inset-shadow),var(--tw-inset-ring-shadow),var(--tw-ring-offset-shadow),var(--tw-ring-shadow),var(--tw-shadow)","-TwShadow":"0 1px 2px 0 var(--tw-shadow-color,rgba(0,0,0,0.05))"}},"font-_b500_B":{"":{"--tw-font-weight":"500","fontWeight":"500","-TwFontWeight":"500"}},"text-_b_h303133_B":{"":{"color":"#303133"}},"text-_b12px_B":{"":{"fontSize":12}},"text-_b_h909399_B":{"":{"color":"#909399"}},"mt-_b4px_B":{"":{"marginTop":4}},"ml-_b8px_B":{"":{"marginLeft":8}},"pb-_b24px_B":{"":{"paddingBottom":24}},"text-_b_h19be6b_B":{"":{"color":"#19be6b"}},"w-_b8px_B":{"":{"width":8}},"h-_b8px_B":{"":{"height":8}},"rounded-_b4px_B":{"":{"borderTopLeftRadius":4,"borderTopRightRadius":4,"borderBottomRightRadius":4,"borderBottomLeftRadius":4,"borderRadius":4}},"bg-_b_h19be6b_B":{"":{"backgroundColor":"#19be6b"}},"mr-_b10px_B":{"":{"marginRight":10}}};
          ...
          _createElementVNode("view", { class: "page-container bg-_b_hf8fafc_B flex flex-col flex-1 h-full" }, [
            ...
            _createElementVNode("scroll-view", {
              ...
              _createElementVNode("nested-scroll-header", null, [
                _createElementVNode("view", { class: "p-_b12px_B pb-0" }, [
                  _createElementVNode("text", { class: "text-_b14px_B font-bold text-_b_h2979ff_B mb-_b8px_B" }, "列表 1：动态加载列表 (高度 380px)"),
                  _createVNode(_component_up_list, {
                    ...
                    default: _withCtx(() => [
                        ...
                        _renderList($setup.listItems, (item, idx) => {
                          return _openBlock(), _createElementBlock("view", {
                            ...
                            _createElementVNode("view", { class: "demo-list-cell-content" }, [
                              _createElementVNode(
                                "text",
                                { class: "text-_b14px_B font-_b500_B text-_b_h303133_B" },
                              ...
                              _createElementVNode(
                                "text",
                                { class: "text-_b12px_B text-_b_h909399_B mt-_b4px_B" },
                      ...
                      $setup.listLoading ? (_openBlock(), _createElementBlock("view", {
                        ...
                        _createElementVNode("text", { class: "text-_b12px_B text-_b_h909399_B ml-_b8px_B" }, "加载中...")
              ...
              _createElementVNode("nested-scroll-header", null, [
                _createElementVNode("view", { class: "p-_b12px_B pb-_b24px_B" }, [
                  _createElementVNode("text", { class: "text-_b14px_B font-bold text-_b_h19be6b_B mb-_b8px_B" }, "列表 2：静态展示列表 (高度 280px)"),
                  _createVNode(_component_up_list, {
                    height: 280,
                    class: "bg-white rounded-_b8px_B shadow-xs"
                  }, {
                      ...
                      (_openBlock(true), _createElementBlock(
                        ...
                        _renderList($setup.staticListItems, (item, idx) => {
                          return _openBlock(), _createElementBlock("view", {
                            ...
                            _createElementVNode("view", { class: "w-_b8px_B h-_b8px_B rounded-_b4px_B bg-_b_h19be6b_B mr-_b10px_B" }),
                            _createElementVNode("view", { class: "demo-list-cell-content" }, [
                              _createElementVNode(
                                "text",
                                { class: "text-_b14px_B font-_b500_B text-_b_h303133_B" },
