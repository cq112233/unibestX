...
import { _ as __easycom_0$1 } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/components/up-loading-icon/up-loading-icon&";
...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n30 = _createSharedDataComponent(AppKu, "6921ca46", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n29 = _createSharedDataComponent(LayoutComponent, "bb177e8e", {
            ...
            "default": _withSharedDataVaporCtx(() => {
              const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "a7d84c3a", {
                title: "up-list 双列表嵌套",
                "auto-back": true,
              ...
              const n15 = _createSharedDataComponentWithFallback(_component_up_list, "a7d82d36", {
                height: 580,
                "lower-threshold": 20,
                ...
                "default": _withSharedDataVaporCtx(() => {
                  _createSharedDataFor(_setSharedDataScoped(__sharedData, 4, _createSharedDataVFor(__sharedDataScope, () => {
                    ...
                    const n4 = _createSharedDataComponentWithFallback(_component_up_icon, "53321d4a-" + _for_key0.value, {
                      name: "account",
                      size: "20",
                      color: "#ffffff"
                    });
                  ...
                  _createSharedDataIf(() => {
                    ...
                    const n12 = _createSharedDataComponentWithFallback(_component_up_loading_icon, "5331fd9a", {
                      mode: "circle",
                      size: "20"
                    });
              ...
              const n25 = _createSharedDataComponentWithFallback(_component_up_list, "53313ae4", {
                height: 280,
                class: "bg-white rounded-_b8px_B shadow-xs"
              }, {
                "default": () => {
