...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n29 = _createSharedDataComponent(_sfc_main$1, "6921ca46", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "bb177cd2", {
            title: "up-list 双列表嵌套",
            "auto-back": true,
          ...
          const n15 = _createSharedDataComponentWithFallback(_component_up_list, "a7d83578", {
            height: 580,
            "lower-threshold": 20,
            ...
            "default": _withSharedDataVaporCtx(() => {
              _createSharedDataFor(_setSharedDataScoped(__sharedData, 3, _createSharedDataVFor(__sharedDataScope, () => {
                ...
                const n4 = _createSharedDataComponentWithFallback(_component_up_icon, "a7d815f6-" + _for_key0.value, {
                  name: "account",
                  size: "20",
                  color: "#ffffff"
                });
              ...
              _createSharedDataIf(() => {
                ...
                const n12 = _createSharedDataComponentWithFallback(_component_up_loading_icon, "5332068e", {
                  mode: "circle",
                  size: "20"
                });
          ...
          const n25 = _createSharedDataComponentWithFallback(_component_up_list, "5331e752", {
            height: 280,
            class: "bg-white rounded-8px shadow-xs"
          }, {
            "default": () => {
          ...
          _setSharedData(__sharedData, 6, n25?.sharedData);
        })
      });
