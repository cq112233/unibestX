  ...
  return _openBlock(), _createBlock($setup["AppKu"], null, {
    default: _withCtx(() => [
      _createVNode($setup["LayoutComponent"], {
        ...
        default: _withCtx(() => [
          _createElementVNode("view", { class: "page-container bg-__f8fafc_ flex flex-col flex-1 h-full" }, [
            ...
            _createElementVNode("scroll-view", {
              ...
              _createElementVNode("nested-scroll-header", null, [
                _createElementVNode("view", { class: "p-12px pb-0" }, [
                  _createElementVNode("text", { class: "text-14px font-bold text-__2979ff_ mb-8px" }, "列表 1：动态加载列表 (高度 380px)"),
                  _createVNode(_component_up_list, {
                    ...
                    default: _withCtx(() => [
                      ...
                      $setup.listLoading ? (_openBlock(), _createElementBlock("view", {
                        ...
                        _createElementVNode("text", { class: "text-12px text-__909399_ ml-8px" }, "加载中...")
              ...
              _createElementVNode("nested-scroll-header", null, [
                _createElementVNode("view", { class: "p-12px pb-24px" }, [
                  _createElementVNode("text", { class: "text-14px font-bold text-__19be6b_ mb-8px" }, "列表 2：静态展示列表 (高度 280px)"),
                  _createVNode(_component_up_list, {
                    height: 280,
                    class: "bg-white rounded-8px shadow-xs"
                  }, {
                      ...
                      (_openBlock(true), _createElementBlock(
                        ...
                        _renderList($setup.staticListItems, (item, idx) => {
                          return _openBlock(), _createElementBlock("view", {
                            ...
                            _createElementVNode("view", { class: "w-8px h-8px rounded-4px bg-__19be6b_ mr-10px" }),
                            _createElementVNode("view", { class: "demo-list-cell-content" }, [
                              _createElementVNode(
                                "text",
                                { class: "text-14px font-500 text-__303133_" },
