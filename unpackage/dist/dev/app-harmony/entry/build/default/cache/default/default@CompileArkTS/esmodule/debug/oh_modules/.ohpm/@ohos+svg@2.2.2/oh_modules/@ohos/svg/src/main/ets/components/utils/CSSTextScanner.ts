...
import { IntegerParser } from "@normalized:N&&&@ohos/svg/src/main/ets/components/utils/IntegerParser&2.2.2";
import { AttribOp, Combinator, CSSParser, PseudoClassAnPlusB, PseudoClassEmpty, PseudoClassIdents, PseudoClassNot, PseudoClassNotSupported, PseudoClassOnlyChild, PseudoClassRoot, PseudoClassTarget, Selector, SimpleSelector } from "@normalized:N&&&@ohos/svg/src/main/ets/components/utils/CSSParser&2.2.2";
import type { PseudoClass } from "@normalized:N&&&@ohos/svg/src/main/ets/components/utils/CSSParser&2.2.2";
