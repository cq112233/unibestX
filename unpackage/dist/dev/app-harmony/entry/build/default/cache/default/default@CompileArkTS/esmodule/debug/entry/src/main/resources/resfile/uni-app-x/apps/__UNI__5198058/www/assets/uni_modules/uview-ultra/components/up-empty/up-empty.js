...
import { d as defProps } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/components/up-empty/empty&";
    ...
    return () => {
      ...
      _createSharedDataIf(() => {
        ...
        _renderSharedDataEffect(() => {
          return _setSharedDataStyle(__sharedData, 6, [emptyStyle.value, _unref(addStyle)(__props.customStyle)]);
        });
        _createSharedDataIf(() => {
          return _setSharedData(__sharedData, 1, _toSharedDataBoolean(!isSrc.value));
        }, () => {
          const n4 = _createSharedDataComponentWithFallback(_component_up_icon, "fca6afdc", {
            name: () => {
