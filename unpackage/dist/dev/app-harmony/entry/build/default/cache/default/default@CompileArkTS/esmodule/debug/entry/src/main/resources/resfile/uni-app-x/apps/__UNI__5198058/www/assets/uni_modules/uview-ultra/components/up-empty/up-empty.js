...
const _sfc_main = /* @__PURE__ */ _defineComponent({
  ...
  setup(__props, _a) {
    ...
    const __returned__ = { instance, props, emit, icons, emptyStyle, textStyle, isSrc, get addUnit() {
      return addUnit;
    }, get addStyle() {
      return addStyle;
    } };
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return $props.show ? (_openBlock(), _createElementBlock(
    "view",
    {
      key: 0,
      class: "up-empty",
      style: _normalizeStyle([$setup.emptyStyle, $setup.addStyle($props.customStyle)])
    },
    [
