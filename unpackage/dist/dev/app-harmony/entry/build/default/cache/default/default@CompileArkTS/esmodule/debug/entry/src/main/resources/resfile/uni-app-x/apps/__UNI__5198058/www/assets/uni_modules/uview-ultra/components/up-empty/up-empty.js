    ...
    return () => {
      ...
      _createSharedDataIf(() => {
        ...
        _renderSharedDataEffect(() => {
          return _setSharedDataStyle(__sharedData, 6, [emptyStyle.value, $up.addStyle(customStyle)]);
        });
        _createSharedDataIf(() => {
          return _setSharedData(__sharedData, 1, _toSharedDataBoolean(!isSrc.value));
        }, () => {
          const n4 = _createSharedDataComponentWithFallback(_component_up_icon, "fca6afd4", {
            name: () => {
          ...
          _renderSharedDataEffect(() => {
            ...
            _setSharedDataStyle(__sharedData, 3, {
              width: _$up.addUnit(__props.width),
