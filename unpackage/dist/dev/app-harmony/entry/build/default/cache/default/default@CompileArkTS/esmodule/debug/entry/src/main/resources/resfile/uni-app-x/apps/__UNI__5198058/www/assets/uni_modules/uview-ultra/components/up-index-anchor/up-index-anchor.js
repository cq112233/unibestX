import { k as error, o as getParentFunc, a as addUnit } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/libs/function/index&";
...
const _sfc_main = /* @__PURE__ */ _defineComponent({
  ...
  setup(__props, _a) {
    ...
    const __returned__ = { parent, parentData, getParent, instance, props, emit, textName, parentSticky, init, get addUnit() {
      return addUnit;
    } };
    ...
    [
      _createElementVNode(
        "text",
        {
          ...
          style: _normalizeStyle({
            fontSize: $setup.addUnit($props.size),
            color: $props.color
          })
        },
