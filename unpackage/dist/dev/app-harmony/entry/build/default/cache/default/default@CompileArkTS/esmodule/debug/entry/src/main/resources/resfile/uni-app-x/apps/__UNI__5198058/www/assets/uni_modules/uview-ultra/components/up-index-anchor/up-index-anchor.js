import { a as addUnit, k as error, o as getParentFunc } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/libs/function/index&";
    ...
    return () => {
      ...
      _renderSharedDataEffect(() => {
        ...
        _setSharedDataStyle(__sharedData, 2, {
          fontSize: _addUnit(__props.size),
          color: __props.color
        });
