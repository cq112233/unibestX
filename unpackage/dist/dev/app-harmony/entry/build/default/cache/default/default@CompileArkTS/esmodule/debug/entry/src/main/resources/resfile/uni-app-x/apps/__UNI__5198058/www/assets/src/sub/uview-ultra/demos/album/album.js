...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  const _component_up_album = resolveEasycom(resolveDynamicComponent("up-album"), __easycom_1);
          ...
          createElementVNode("view", { class: "page-container bg-__f8fafc_ min-h-screen pb-30px" }, [
            ...
            createElementVNode("view", { class: "p-16px" }, [
              createElementVNode("view", { class: "demo-block" }, [
                ...
                createVNode(_component_up_album, { urls: ["https://cdn.uviewui.com/uview/album/1.jpg", "https://cdn.uviewui.com/uview/album/2.jpg"] }, null, 8, ["urls"])
              ]),
              createElementVNode("view", { class: "demo-block mt-12px" }, [
                createElementVNode("text", { class: "demo-label" }, "单图模式"),
                createVNode(_component_up_album, { urls: ["https://cdn.uviewui.com/uview/album/1.jpg"] }, null, 8, ["urls"])
              ]),
              createElementVNode("view", { class: "demo-block mt-12px" }, [
                createElementVNode("text", { class: "demo-label" }, "指定列数 (4列)"),
              ...
              createElementVNode("view", { class: "demo-block mt-12px" }, [
                createElementVNode("text", { class: "demo-label" }, "自定义圆角与间隔"),
                createVNode(_component_up_album, {
                  urls: $setup.albumUrls,
                  radius: "8",
                  space: "10"
