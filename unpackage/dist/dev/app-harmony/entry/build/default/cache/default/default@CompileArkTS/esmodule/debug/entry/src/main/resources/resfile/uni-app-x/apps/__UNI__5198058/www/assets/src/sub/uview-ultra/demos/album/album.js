...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n16 = _createSharedDataComponent(AppKu, "f685327e", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n15 = _createSharedDataComponent(LayoutComponent, "12ef7155", {
            "navigation-style": "custom",
            "navigation-bar-title-text": "up-album 相册"
          }, {
            "default": _withSharedDataVaporCtx(() => {
              const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "4afeb9f9", {
                title: "Album 相册",
                "auto-back": true
              });
              _setSharedData(__sharedData, 2, n0?.sharedData);
              const n2 = _createSharedDataComponentWithFallback(_component_up_album, "4afec100", { urls: ["https://cdn.uviewui.com/uview/album/1.jpg", "https://cdn.uviewui.com/uview/album/2.jpg"] });
              _setSharedData(__sharedData, 3, n2?.sharedData);
              const n5 = _createSharedDataComponentWithFallback(_component_up_album, "4afec8e1", { urls: ["https://cdn.uviewui.com/uview/album/1.jpg"] });
              _setSharedData(__sharedData, 4, n5?.sharedData);
              const n8 = _createSharedDataComponentWithFallback(_component_up_album, "4afed046", {
                urls: () => {
              ...
              const n11 = _createSharedDataComponentWithFallback(_component_up_album, "4afed7a3", {
                urls: () => {
                  return albumUrls.value;
                },
                radius: "8",
...
const _style_0 = {};
const album = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0]]]);
export {
  album as default
};
