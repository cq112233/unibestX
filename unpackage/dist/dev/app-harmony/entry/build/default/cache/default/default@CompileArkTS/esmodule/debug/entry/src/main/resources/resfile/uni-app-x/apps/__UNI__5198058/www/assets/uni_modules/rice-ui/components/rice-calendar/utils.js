...
import { a as CalendarData } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/rice-ui/components/rice-calendar/type&";
import { L as Lunar } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/rice-ui/components/rice-calendar/lunar&";
...
const createCalendarDay = (year, month, date, formatter = null, min = null, max = null) => {
  ...
  const disabled = !dateuts(fullDate).isBetween(min !== null && min !== void 0 ? min : "1900-01-01", max !== null && max !== void 0 ? max : "2099-12-31", "date", "[]");
  let config = new CalendarData({
    text: null,
    topInfo: null,
    topInfoColor: null,
    bottomInfo: null,
