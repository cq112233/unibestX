...
import { _ as __easycom_1 } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/rice-ui/components/rice-count-down/rice-count-down&";
...
import "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/rice-ui/components/rice-count-down/utils&";
...
const __className = "GenSrcSubRiceUiDemosCountDownCountDown";
const { computed } = globalThis.Vue;
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  __dynamicSharedData: true,
  __hash: "ac434598",
  __className,
  __filename: "src/sub/rice-ui/demos/count-down/count-down.uvue",
  __name: "count-down",
  setup(__props) {
    const __sharedDataRenderer = _useSharedDataRenderer();
    const __sharedData = __sharedDataRenderer == "component" ? _withSharedDataComponent(new UniDynamicSharedDataComponent(_useSharedDataScope(), _useSharedDataComponentOptions({ bundleKey: "GenSrcSubRiceUiDemosCountDownCountDownSharedData", sharedDataClassId: 0 }))) : _withSharedDataPage(new UniDynamicSharedDataPage(_useSharedDataPageId(), _useSharedDataPageOptions({ bundleKey: "GenSrcSubRiceUiDemosCountDownCountDownSharedData", sharedDataClassId: 0 })));
    ...
    return () => {
      ...
      const _component_rice_count_down = __easycom_1;
      const n15 = _createSharedDataComponent(_sfc_main$1, "7600b3c6", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "4a15c5c7", {
            title: "CountDown 倒计时",
            "auto-back": true,
          ...
          const n2 = _createSharedDataComponentWithFallback(_component_rice_count_down, "0eba376e", { time: () => {
            return 30 * 1e3;
          } });
          ...
          const n6 = _createSharedDataComponentWithFallback(_component_rice_count_down, "0eba2126", {
            time: () => {
              return 2 * 60 * 60 * 1e3;
            },
            format: "HH:mm:ss"
          ...
          const n10 = _createSharedDataComponentWithFallback(_component_rice_count_down, "1bb84031", {
            time: () => {
              return 30 * 1e3;
            },
            millisecond: true,
...
const _style_0 = {};
const _style_1 = {};
const countDown = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0, _style_1]]]);
export {
