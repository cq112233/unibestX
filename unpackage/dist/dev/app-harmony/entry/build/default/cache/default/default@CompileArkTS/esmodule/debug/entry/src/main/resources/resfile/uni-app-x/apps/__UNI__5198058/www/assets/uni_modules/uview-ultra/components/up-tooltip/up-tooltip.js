...
import { j as guid, s as sleep, b as addStyle, a as addUnit, y as sys, t as toast } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/libs/function/index&";
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return _openBlock(), _createElementBlock(
    ...
    {
      class: "up-tooltip",
      style: _normalizeStyle([$options.rootStyle])
    },
    [
      ...
      _createElementVNode("view", { class: "up-tooltip__wrapper" }, [
        $options.hasText ? (_openBlock(), _createElementBlock("text", {
          key: 0,
          ...
          userSelect: false,
          selectable: false,
          onLongpress: _cache[0] || (_cache[0] = _withModifiers((...args) => $options.longpressHandler && $options.longpressHandler(...args), ["stop"])),
          onClick: _cache[1] || (_cache[1] = _withModifiers((...args) => $options.clickHandler && $options.clickHandler(...args), ["stop"])),
          style: _normalizeStyle([$options.textStyle])
        }, _toDisplayString($options.displayText), 45, ["id"])) : (_openBlock(), _createElementBlock("view", {
          key: 1,
          class: "up-tooltip__wrapper__trigger",
          id: $data.textId,
          ref: $data.textId,
          onLongpress: _cache[2] || (_cache[2] = _withModifiers((...args) => $options.longpressHandler && $options.longpressHandler(...args), ["stop"])),
          onClick: _cache[3] || (_cache[3] = _withModifiers((...args) => $options.clickHandler && $options.clickHandler(...args), ["stop"]))
        }, [
        ...
        _createVNode(_component_up_transition, {
          ...
          default: _withCtx(() => [
            _createElementVNode("view", {
              ...
              $options.showIndicator ? (_openBlock(), _createElementBlock(
                "view",
                {
                  key: 0,
                  class: "up-tooltip__wrapper__popup__indicator",
                  "hover-class": "up-tooltip__wrapper__popup__indicator--hover",
                  style: _normalizeStyle([$options.indicatorMergedStyle])
                },
                null,
                4
                /* STYLE */
              ...
              _renderSlot(_ctx.$slots, "content", {}, () => [
                _createElementVNode(
                  "view",
                  {
                    ...
                    style: _normalizeStyle([$options.popupListStyle])
                  },
                  [
                    $options.showCopyButton ? (_openBlock(), _createElementBlock("view", {
                      key: 0,
                    ...
                    $options.showCopyLine ? (_openBlock(), _createBlock(_component_up_line, {
                      key: 1,
                      direction: "column",
                      color: "#8d8e90",
                      length: "18"
                    ...
                    (_openBlock(true), _createElementBlock(
                      _Fragment,
                      null,
                      _renderList($options.buttonItems, (item, index) => {
                        return _openBlock(), _createElementBlock(
                          _Fragment,
                          { key: index },
                          [
                            ...
                            index < $options.buttonCount - 1 ? (_openBlock(), _createBlock(_component_up_line, {
                              key: 0,
                              direction: "column",
                              color: "#8d8e90",
                              length: "18"
