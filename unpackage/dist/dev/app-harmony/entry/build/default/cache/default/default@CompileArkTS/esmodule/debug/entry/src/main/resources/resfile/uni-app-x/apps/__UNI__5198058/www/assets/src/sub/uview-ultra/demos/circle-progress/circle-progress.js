    ...
    return () => {
      ...
      const n16 = _createSharedDataComponent(_sfc_main$1, "27c596ca", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n15 = _createSharedDataComponent(LayoutComponent, "d0ed428a", {
            "navigation-bar-title-text": "CircleProgress 圆形进度条",
            "navigation-style": "custom"
          }, {
            "default": _withSharedDataVaporCtx(() => {
              const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "59a27955", {
                title: "CircleProgress 圆形进度条",
                "auto-back": true
              });
              _setSharedData(__sharedData, 2, n0?.sharedData);
              const n2 = _createSharedDataComponentWithFallback(_component_up_circle_progress, "59a28079");
              _setSharedData(__sharedData, 3, n2?.sharedData);
              const n5 = _createSharedDataComponentWithFallback(_component_up_circle_progress, "59a287f8", {
                percentage: "30",
                "active-color": "#19be6b"
              });
              _setSharedData(__sharedData, 4, n5?.sharedData);
              const n7 = _createSharedDataComponentWithFallback(_component_up_circle_progress, "59a28c16", {
                percentage: "60",
                "active-color": "#ffaa33",
                "inactive-color": "#f3f4f6"
              });
              _setSharedData(__sharedData, 5, n7?.sharedData);
              const n11 = _createSharedDataComponentWithFallback(_component_up_circle_progress, "59a29683", {
                percentage: "80",
                width: "100"
              });
