      ...
      const n16 = _createSharedDataComponent(AppKu, "27c596ca", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n15 = _createSharedDataComponent(LayoutComponent, "d0ed428a", {
            ...
            "default": _withSharedDataVaporCtx(() => {
              const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "59a27971", {
                title: "CircleProgress 圆形进度条",
                "auto-back": true
              });
              _setSharedData(__sharedData, 2, n0?.sharedData);
              const n2 = _createSharedDataComponentWithFallback(_component_up_circle_progress, "59a28099");
              _setSharedData(__sharedData, 3, n2?.sharedData);
              const n5 = _createSharedDataComponentWithFallback(_component_up_circle_progress, "59a2881c", {
                percentage: "30",
                "active-color": "#19be6b"
              });
              _setSharedData(__sharedData, 4, n5?.sharedData);
              const n7 = _createSharedDataComponentWithFallback(_component_up_circle_progress, "59a28c3e", {
                percentage: "60",
                "active-color": "#ffaa33",
                "inactive-color": "#f3f4f6"
              });
              _setSharedData(__sharedData, 5, n7?.sharedData);
              const n11 = _createSharedDataComponentWithFallback(_component_up_circle_progress, "59a296c4", {
                percentage: "80",
                width: "100"
              });
...
const _style_0 = {};
const circleProgress = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0]]]);
export {
