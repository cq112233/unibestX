...
const _sfc_main = /* @__PURE__ */ _defineComponent({
  ...
  setup(__props, _a) {
    ...
    const __returned__ = { instance, props, emit, menuList, active, current, contentStyle, highlightIndexList, contentHeight, dropdownStyle, menuStyle, contentWrapStyle, menuIconSizeUnit, getMenuIconColor, popupStyle, getContentHeight, open, close, menuClick, maskClick, highlight, getContentTextStyle, registerItem, updateItemTitle };
