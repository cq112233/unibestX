...
import { _ as __easycom_1 } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/components/up-badge/up-badge&";
...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n25 = _createSharedDataComponent(_sfc_main$1, "52c5317e", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n24 = _createSharedDataComponent(_sfc_main$2, "05e0fe56", {
            "navigation-style": "custom",
            "navigation-bar-title-text": "up-badge 徽标"
          }, {
            "default": _withSharedDataVaporCtx(() => {
              const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "b63ecb46", {
                title: "up-badge 徽标",
                "auto-back": true,
              ...
              const n2 = _createSharedDataComponentWithFallback(_component_up_badge, "b63eb5b6", {
                type: "error",
                value: 9,
                class: "mr-20px"
              });
              _setSharedData(__sharedData, 3, n2?.sharedData);
              const n3 = _createSharedDataComponentWithFallback(_component_up_badge, "b63eaeea", {
                type: "warning",
                value: 99,
                class: "mr-20px"
              });
              _setSharedData(__sharedData, 4, n3?.sharedData);
              const n4 = _createSharedDataComponentWithFallback(_component_up_badge, "b63ead04", {
                type: "success",
                value: 100,
                max: "99"
              });
              _setSharedData(__sharedData, 5, n4?.sharedData);
              const n8 = _createSharedDataComponentWithFallback(_component_up_badge, "b63e9826", {
                type: "error",
                "is-dot": true
              });
              _setSharedData(__sharedData, 6, n8?.sharedData);
              const n12 = _createSharedDataComponentWithFallback(_component_up_badge, "119ad1e6", {
                value: "新",
                "bg-color": "#8a2be2",
                color: "#ffffff",
                class: "mr-20px"
              ...
              const n13 = _createSharedDataComponentWithFallback(_component_up_badge, "119aca9c", {
                value: "热",
                "bg-color": "#ff9900",
                color: "#ffffff",
                class: "mr-20px"
              ...
              const n14 = _createSharedDataComponentWithFallback(_component_up_badge, "119ac352", {
                "is-dot": true,
                "bg-color": "#000000",
                class: "mr-20px"
              });
              _setSharedData(__sharedData, 9, n14?.sharedData);
              const n18 = _createSharedDataComponentWithFallback(_component_up_badge, "119aac54", {
                type: "error",
                value: 5,
                absolute: "",
                offset: () => {
