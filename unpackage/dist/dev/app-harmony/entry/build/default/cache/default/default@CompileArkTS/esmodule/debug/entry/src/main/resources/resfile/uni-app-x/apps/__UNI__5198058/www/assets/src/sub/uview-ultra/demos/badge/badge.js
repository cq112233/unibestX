...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n25 = _createSharedDataComponent(AppKu, "52c5317e", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n24 = _createSharedDataComponent(LayoutComponent, "05e0fe56", {
            "navigation-style": "custom",
            "navigation-bar-title-text": "up-badge 徽标"
          }, {
            "default": _withSharedDataVaporCtx(() => {
              const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "b63ecb0e", {
                title: "up-badge 徽标",
                "auto-back": true,
              ...
              const n2 = _createSharedDataComponentWithFallback(_component_up_badge, "b63eb576", {
                type: "error",
                value: 9,
                class: "mr-_b20px_B"
              });
              _setSharedData(__sharedData, 3, n2?.sharedData);
              const n3 = _createSharedDataComponentWithFallback(_component_up_badge, "b63eae78", {
                type: "warning",
                value: 99,
                class: "mr-_b20px_B"
              });
              _setSharedData(__sharedData, 4, n3?.sharedData);
              const n4 = _createSharedDataComponentWithFallback(_component_up_badge, "b63ea774", {
                type: "success",
                value: 100,
                max: "99"
              });
              _setSharedData(__sharedData, 5, n4?.sharedData);
              const n8 = _createSharedDataComponentWithFallback(_component_up_badge, "b63e97b0", {
                type: "error",
                "is-dot": true
              });
              _setSharedData(__sharedData, 6, n8?.sharedData);
              const n12 = _createSharedDataComponentWithFallback(_component_up_badge, "119ad168", {
                value: "新",
                "bg-color": "#8a2be2",
                color: "#ffffff",
                class: "mr-_b20px_B"
              ...
              const n13 = _createSharedDataComponentWithFallback(_component_up_badge, "119aca16", {
                value: "热",
                "bg-color": "#ff9900",
                color: "#ffffff",
                class: "mr-_b20px_B"
              ...
              const n14 = _createSharedDataComponentWithFallback(_component_up_badge, "119ac29a", {
                "is-dot": true,
                "bg-color": "#000000",
                class: "mr-_b20px_B"
              });
              _setSharedData(__sharedData, 9, n14?.sharedData);
              const n18 = _createSharedDataComponentWithFallback(_component_up_badge, "119aab1a", {
                type: "error",
                value: 5,
                absolute: "",
                offset: () => {
...
const badge = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0]]]);
export {
  badge as default
};
