...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n12 = _createSharedDataComponent(_sfc_main$1, "1e43093e", null, {
        "default": _withSharedDataVaporCtx(() => {
          _renderSharedDataEffect(() => {
            return _setSharedDataStyle(__sharedData, 4, { height: `${windowHeight.value}px` });
          });
          const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "332d25a1", {
            title: "IndexList 索引列表",
            "auto-back": true
          });
          _setSharedData(__sharedData, 1, n0?.sharedData);
          const n9 = _createSharedDataComponentWithFallback(_component_up_index_list, "332d2981", {
            style: "flex: 1",
            "index-list": () => {
            ...
            "default": _withSharedDataVaporCtx(() => {
              _createSharedDataFor(_setSharedDataScoped(__sharedData, 3, _createSharedDataVFor(__sharedDataScope, () => {
                ...
                const n8 = _createSharedDataComponentWithFallback(_component_up_index_item, "332d2da0-" + _for_key0.value, null, {
                  "default": _withSharedDataVaporCtx(() => {
                    const n3 = _createSharedDataComponentWithFallback(_component_up_index_anchor, "332d2dfb-" + _for_key0.value, { text: () => {
          ...
          _setSharedData(__sharedData, 2, n9?.sharedData);
        })
      });
