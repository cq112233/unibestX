    ...
    return () => {
      ...
      const n13 = _createSharedDataComponent(AppKu, "1e43093e", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n12 = _createSharedDataComponent(LayoutComponent, "2af0f0b5", null, {
            "default": _withSharedDataVaporCtx(() => {
              _renderSharedDataEffect(() => {
                return _setSharedDataStyle(__sharedData, 5, { height: `${windowHeight.value}px` });
              });
              const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "332d25e3", {
                title: "IndexList 索引列表",
                "auto-back": true
              });
              _setSharedData(__sharedData, 2, n0?.sharedData);
              const n9 = _createSharedDataComponentWithFallback(_component_up_index_list, "332d29c3", {
                style: "flex: 1",
                "index-list": () => {
                ...
                "default": _withSharedDataVaporCtx(() => {
                  _createSharedDataFor(_setSharedDataScoped(__sharedData, 4, _createSharedDataVFor(__sharedDataScope, () => {
                    ...
                    const n8 = _createSharedDataComponentWithFallback(_component_up_index_item, "332d2de2-" + _for_key0.value, null, {
                      "default": _withSharedDataVaporCtx(() => {
                        const n3 = _createSharedDataComponentWithFallback(_component_up_index_anchor, "332d2e3d-" + _for_key0.value, { text: () => {
