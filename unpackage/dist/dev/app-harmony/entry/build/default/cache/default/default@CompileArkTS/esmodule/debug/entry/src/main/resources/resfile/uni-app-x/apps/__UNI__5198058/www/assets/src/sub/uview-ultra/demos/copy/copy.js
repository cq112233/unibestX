...
import { _ as _sfc_main$1 } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/components/up-copy/up-copy&";
...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const _component_up_copy = _sfc_main$1;
      const n8 = _createSharedDataComponent(AppKu, "7048018b", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n7 = _createSharedDataComponent(LayoutComponent, "ce8fa06a", {
            ...
            "default": _withSharedDataVaporCtx(() => {
              const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "7e4dca44", {
                title: "Copy 复制",
                "auto-back": true,
              ...
              const n3 = _createSharedDataComponentWithFallback(_component_up_copy, "7e4dd48c", {
                ...
                "default": _withSharedDataVaporCtx(() => {
                  const n2 = _createSharedDataComponentWithFallback(_component_up_button, "7e4dd56d", {
                    type: "primary",
                    text: "点击复制文本",
                    size: "mini"
                  });
...
const _style_0 = {};
const copy = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0]]]);
export {
  copy as default
};
