...
import { _ as _sfc_main$2 } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/components/up-copy/up-copy&";
...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n7 = _createSharedDataComponent(_sfc_main$1, "7048018b", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "ce8f9ebc", {
            title: "Copy 复制",
            "auto-back": true,
          ...
          const n3 = _createSharedDataComponentWithFallback(_component_up_copy, "7e4dce26", {
            ...
            "default": _withSharedDataVaporCtx(() => {
              const n2 = _createSharedDataComponentWithFallback(_component_up_button, "7e4dd1a7", {
                type: "primary",
                text: "点击复制文本",
                size: "mini"
              });
