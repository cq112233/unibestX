...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n15 = _createSharedDataComponent(_sfc_main$1, "59d01b7b", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "3f99569c", {
          ...
          const n6 = _createSharedDataComponentWithFallback(_component_up_collapse, "26372ebc", {
            value: () => {
            ...
            "default": _withSharedDataVaporCtx(() => {
              const n3 = _createSharedDataComponentWithFallback(_component_up_collapse_item, "26372f7b", {
                title: "第一项",
                name: "1"
              }, {
                "default": () => {
              ...
              const n5 = _createSharedDataComponentWithFallback(_component_up_collapse_item, "263736a1", {
                title: "第二项",
                name: "2"
              }, {
                "default": () => {
          ...
          const n11 = _createSharedDataComponentWithFallback(_component_up_collapse, "2637419f", { value: ["1"] }, {
            "default": _withSharedDataVaporCtx(() => {
              const n10 = _createSharedDataComponentWithFallback(_component_up_collapse_item, "26374205", {
                title: "第一项",
                name: "1",
                icon: "star"
              }, {
