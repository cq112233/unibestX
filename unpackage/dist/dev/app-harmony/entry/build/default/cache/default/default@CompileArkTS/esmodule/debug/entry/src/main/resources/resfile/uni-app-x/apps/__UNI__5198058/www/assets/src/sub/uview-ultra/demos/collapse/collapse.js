...
import { _ as __easycom_1 } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/components/up-collapse-item/up-collapse-item&";
import { _ as __easycom_2 } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/components/up-collapse/up-collapse&";
...
const _style_1 = { "demo-block": { "": { "marginBottom": 12, "paddingTop": 12, "paddingRight": 12, "paddingBottom": 12, "paddingLeft": 12, "backgroundColor": "#ffffff", "borderTopLeftRadius": 8, "borderTopRightRadius": 8, "borderBottomRightRadius": 8, "borderBottomLeftRadius": 8 } }, "demo-label": { "": { "fontSize": 14, "fontWeight": "bold", "color": "#606266", "marginBottom": 10, "paddingLeft": 4, "borderLeftWidth": 3, "borderLeftStyle": "solid", "borderLeftColor": "#2979ff" } }, "collapse-text": { "": { "fontSize": 13, "color": "#909399", "lineHeight": "20px" } } };
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_NavBar = resolveEasycom(resolveDynamicComponent("NavBar"), __easycom_0);
  const _component_up_collapse_item = resolveEasycom(resolveDynamicComponent("up-collapse-item"), __easycom_1);
  const _component_up_collapse = resolveEasycom(resolveDynamicComponent("up-collapse"), __easycom_2);
          ...
          createElementVNode("view", { class: "page-container bg-__f8fafc_ min-h-screen pb-30px" }, [
            ...
            createElementVNode("view", { class: "p-16px" }, [
              ...
              createElementVNode("view", { class: "demo-block mt-12px" }, [
                createElementVNode("text", { class: "demo-label" }, "自定义图标"),
                createVNode(_component_up_collapse, { value: ["1"] }, {
                  default: withCtx(() => [
                    createVNode(_component_up_collapse_item, {
                      title: "第一项",
                      name: "1",
                      ...
                      default: withCtx(() => [
                        createElementVNode("text", { class: "collapse-text" }, "带有星星图标的面板")
                      ]),
                      _: 1
                      /* STABLE */
                    })
...
const collapse = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["styles", [_style_0, _style_1]], ["__file", "/Users/chenqi/Documents/chenqi-front/unibestX/src/sub/uview-ultra/demos/collapse/collapse.uvue"]]);
export {
  collapse as default
};
