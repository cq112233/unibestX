...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n10 = _createSharedDataComponent(AppKu, "d3d7f2de", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n9 = _createSharedDataComponent(LayoutComponent, "2c6ccb85", {
            "navigation-style": "custom",
            "navigation-bar-title-text": "up-swiper 轮播图"
          }, {
            "default": _withSharedDataVaporCtx(() => {
              const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "612ca5cb", {
                title: "Swiper 轮播图",
                "auto-back": true,
              ...
              const n2 = _createSharedDataComponentWithFallback(_component_up_swiper, "612cb014", {
                list: () => {
              ...
              const n5 = _createSharedDataComponentWithFallback(_component_up_swiper, "612cbc71", {
                list: () => {
                  return swiperList.value;
                },
                "key-name": "image",
...
const _style_0 = {};
const swiper = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0]]]);
export {
  swiper as default
};
