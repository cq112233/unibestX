...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n10 = _createSharedDataComponent(_sfc_main$1, "d3d7f2de", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n9 = _createSharedDataComponent(_sfc_main$2, "2c6ccb85", {
            "navigation-style": "custom",
            "navigation-bar-title-text": "up-swiper 轮播图"
          }, {
            "default": _withSharedDataVaporCtx(() => {
              const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "612ca5af", {
                title: "Swiper 轮播图",
                "auto-back": true,
              ...
              const n2 = _createSharedDataComponentWithFallback(_component_up_swiper, "612cad69", {
                list: () => {
              ...
              const n5 = _createSharedDataComponentWithFallback(_component_up_swiper, "612cbc4d", {
                list: () => {
                  return swiperList.value;
                },
                "key-name": "image",
