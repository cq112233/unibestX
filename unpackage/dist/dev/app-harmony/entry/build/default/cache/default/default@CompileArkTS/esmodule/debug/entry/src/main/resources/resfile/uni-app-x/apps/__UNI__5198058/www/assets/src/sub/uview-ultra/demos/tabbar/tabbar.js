...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  const _component_up_tabbar_item = resolveEasycom(resolveDynamicComponent("up-tabbar-item"), __easycom_1);
  const _component_up_tabbar = resolveEasycom(resolveDynamicComponent("up-tabbar"), __easycom_2);
