...
import { _ as __easycom_1 } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/components/up-tabbar-item/up-tabbar-item&";
import { _ as __easycom_2 } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/components/up-tabbar/up-tabbar&";
      ...
      const n23 = _createSharedDataComponent(AppKu, "c6e98246", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n22 = _createSharedDataComponent(LayoutComponent, "1646c68e", {
            ...
            "default": _withSharedDataVaporCtx(() => {
              const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "b29209d0", {
                title: "Tabbar 底部导航",
                "auto-back": true,
              ...
              const n6 = _createSharedDataComponentWithFallback(_component_up_tabbar, "b291fa8c", {
                value: () => {
                  return value1.value;
                },
                fixed: false,
                ...
                "default": _withSharedDataVaporCtx(() => {
                  const n2 = _createSharedDataComponentWithFallback(_component_up_tabbar_item, "b291f304", {
                    text: "首页",
                    icon: "home"
                  });
                  _setSharedData(__sharedData, 4, n2?.sharedData);
                  const n3 = _createSharedDataComponentWithFallback(_component_up_tabbar_item, "b291ec44", {
                    text: "放映厅",
                    icon: "photo"
                  });
                  _setSharedData(__sharedData, 5, n3?.sharedData);
                  const n4 = _createSharedDataComponentWithFallback(_component_up_tabbar_item, "b291e580", {
                    text: "直播",
                    icon: "play-right"
                  });
                  _setSharedData(__sharedData, 6, n4?.sharedData);
                  const n5 = _createSharedDataComponentWithFallback(_component_up_tabbar_item, "b291deb4", {
                    text: "我的",
                    icon: "account"
                  });
              ...
              const n12 = _createSharedDataComponentWithFallback(_component_up_tabbar, "b291cfb8", {
                value: () => {
                  return value2.value;
                },
                fixed: false,
                ...
                "default": _withSharedDataVaporCtx(() => {
                  const n9 = _createSharedDataComponentWithFallback(_component_up_tabbar_item, "30284979", {
                    text: "首页",
                    icon: "home",
                    badge: "5"
                  });
                  _setSharedData(__sharedData, 9, n9?.sharedData);
                  const n10 = _createSharedDataComponentWithFallback(_component_up_tabbar_item, "30284a6d", {
                    text: "消息",
                    icon: "chat",
                    dot: true
                  });
                  _setSharedData(__sharedData, 10, n10?.sharedData);
                  const n11 = _createSharedDataComponentWithFallback(_component_up_tabbar_item, "30284dd9", {
                    text: "我的",
                    icon: "account"
                  });
              ...
              const n18 = _createSharedDataComponentWithFallback(_component_up_tabbar, "30285554", {
                value: () => {
                  return value3.value;
                },
                fixed: false,
                ...
                "default": _withSharedDataVaporCtx(() => {
                  const n15 = _createSharedDataComponentWithFallback(_component_up_tabbar_item, "30285c3c", {
                    text: "发现",
                    icon: "search"
                  });
                  _setSharedData(__sharedData, 13, n15?.sharedData);
                  const n16 = _createSharedDataComponentWithFallback(_component_up_tabbar_item, "30285d13", {
                    text: "购物车",
                    icon: "shopping-cart"
                  });
                  _setSharedData(__sharedData, 14, n16?.sharedData);
                  const n17 = _createSharedDataComponentWithFallback(_component_up_tabbar_item, "3028607d", {
                    text: "我的",
                    icon: "account"
                  });
