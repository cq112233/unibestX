import { defineAsyncApi as originalDefineAsyncApi, defineOffApi as originalDefineOffApi, defineOnApi as originalDefineOnApi, defineSyncApi as originalDefineSyncApi, defineTaskApi as originalDefineTaskApi } from "@normalized:N&&&@dcloudio/uni-runtime-harmony/api-shared&1.0.0";
...
interface AsyncApiSuccessResult extends AsyncApiResult {
}
interface ApiError {
    errMsg?: string | null;
    errCode?: number | null;
