...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n18 = _createSharedDataComponent(_sfc_main$1, "2080e5a1", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "20c86168", {
            title: "Gap 间隔槽",
            "auto-back": true
          });
          _setSharedData(__sharedData, 1, n0?.sharedData);
          const n2 = _createSharedDataComponentWithFallback(_component_up_gap, "03de0405", {
            height: "30",
            "bg-color": "#f3f4f6"
          });
          _setSharedData(__sharedData, 2, n2?.sharedData);
          const n5 = _createSharedDataComponentWithFallback(_component_up_gap, "03de087d", {
            height: "50",
            "bg-color": "#f3f4f6"
          });
          _setSharedData(__sharedData, 3, n5?.sharedData);
          const n8 = _createSharedDataComponentWithFallback(_component_up_gap, "03de0f81", {
            height: "30",
            "bg-color": "#fa3534"
          });
          _setSharedData(__sharedData, 4, n8?.sharedData);
          const n12 = _createSharedDataComponentWithFallback(_component_up_gap, "03de173e", {
            height: "20",
            "bg-color": "#f3f4f6",
            "margin-top": "10",
            "margin-bottom": "10"
