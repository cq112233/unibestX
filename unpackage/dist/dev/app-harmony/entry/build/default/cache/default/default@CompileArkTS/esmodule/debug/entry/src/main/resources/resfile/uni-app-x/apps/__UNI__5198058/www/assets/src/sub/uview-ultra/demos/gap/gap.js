...
const _style_0 = {"demo-block":{"":{"marginBottom":12,"paddingTop":12,"paddingRight":12,"paddingBottom":12,"paddingLeft":12,"backgroundColor":"#ffffff","borderTopLeftRadius":8,"borderTopRightRadius":8,"borderBottomRightRadius":8,"borderBottomLeftRadius":8}},"demo-label":{"":{"fontSize":14,"fontWeight":"bold","color":"#606266","marginBottom":10,"paddingLeft":4,"borderLeftWidth":3,"borderLeftStyle":"solid","borderLeftColor":"#2979ff"}},"bg-_b_hf8fafc_B":{"":{"backgroundColor":"#f8fafc"}},"pb-_b30px_B":{"":{"paddingBottom":30}},"p-_b16px_B":{"":{"paddingTop":16,"paddingRight":16,"paddingBottom":16,"paddingLeft":16,"padding":16}},"mt-_b12px_B":{"":{"marginTop":12}},"bg-_b_h2979ff_B":{"":{"backgroundColor":"#2979ff"}},"h-_b10px_B":{"":{"height":10}},"w-full":{"":{"width":"100%"}},"min-h-screen":{"":{"minHeight":"100vh"}}};
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  const _component_up_gap = resolveEasycom(__resolveDynamicComponent("up-gap"), __easycom_1);
          ...
          _createElementVNode("view", { class: "page-container bg-_b_hf8fafc_B min-h-screen pb-_b30px_B" }, [
            ...
            _createElementVNode("view", { class: "p-_b16px_B" }, [
              ...
              _createElementVNode("view", { class: "demo-block mt-_b12px_B" }, [
                _createElementVNode("text", { class: "demo-label" }, "自定义高度"),
                _createVNode(_component_up_gap, {
                  height: "50",
                  "bg-color": "#f3f4f6"
                })
              ...
              _createElementVNode("view", { class: "demo-block mt-_b12px_B" }, [
                _createElementVNode("text", { class: "demo-label" }, "自定义背景色"),
                _createVNode(_component_up_gap, {
                  height: "30",
                  "bg-color": "#fa3534"
                })
              ...
              _createElementVNode("view", { class: "demo-block mt-_b12px_B" }, [
                _createElementVNode("text", { class: "demo-label" }, "自定义上下外边距"),
                _createElementVNode("view", { class: "bg-_b_h2979ff_B h-_b10px_B w-full" }),
                _createVNode(_component_up_gap, {
                  height: "20",
                  "bg-color": "#f3f4f6",
                  "margin-top": "10",
...
const gap = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["styles", [_style_0]], ["__file", "/Users/chenqi/Documents/chenqi-front/unibestX/src/sub/uview-ultra/demos/gap/gap.uvue"]]);
export {
  gap as default
};
