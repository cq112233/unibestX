...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  const _component_up_gap = resolveEasycom(resolveDynamicComponent("up-gap"), __easycom_1);
          ...
          createElementVNode("view", { class: "page-container bg-__f8fafc_ min-h-screen pb-30px" }, [
            ...
            createElementVNode("view", { class: "p-16px" }, [
              ...
              createElementVNode("view", { class: "demo-block mt-12px" }, [
                createElementVNode("text", { class: "demo-label" }, "自定义高度"),
                createVNode(_component_up_gap, {
                  height: "50",
                  "bg-color": "#f3f4f6"
                })
              ...
              createElementVNode("view", { class: "demo-block mt-12px" }, [
                createElementVNode("text", { class: "demo-label" }, "自定义背景色"),
                createVNode(_component_up_gap, {
                  height: "30",
                  "bg-color": "#fa3534"
                })
              ...
              createElementVNode("view", { class: "demo-block mt-12px" }, [
                createElementVNode("text", { class: "demo-label" }, "自定义上下外边距"),
                createElementVNode("view", { class: "bg-__2979ff_ h-10px w-full" }),
                createVNode(_component_up_gap, {
                  height: "20",
                  "bg-color": "#f3f4f6",
                  "margin-top": "10",
