      ...
      const n19 = _createSharedDataComponent(AppKu, "2080e5a1", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n18 = _createSharedDataComponent(LayoutComponent, "20c86316", {
            ...
            "default": _withSharedDataVaporCtx(() => {
              const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "03de00d8", {
                title: "Gap 间隔槽",
                "auto-back": true
              });
              _setSharedData(__sharedData, 2, n0?.sharedData);
              const n2 = _createSharedDataComponentWithFallback(_component_up_gap, "03de07de", {
                height: "30",
                "bg-color": "#f3f4f6"
              });
              _setSharedData(__sharedData, 3, n2?.sharedData);
              const n5 = _createSharedDataComponentWithFallback(_component_up_gap, "03de0ee5", {
                height: "50",
                "bg-color": "#f3f4f6"
              });
              _setSharedData(__sharedData, 4, n5?.sharedData);
              const n8 = _createSharedDataComponentWithFallback(_component_up_gap, "03de1362", {
                height: "30",
                "bg-color": "#fa3534"
              });
              _setSharedData(__sharedData, 5, n8?.sharedData);
              const n12 = _createSharedDataComponentWithFallback(_component_up_gap, "03de1b3f", {
                height: "20",
                "bg-color": "#f3f4f6",
                "margin-top": "10",
                "margin-bottom": "10"
...
const _style_0 = {};
const gap = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0]]]);
export {
  gap as default
};
