...
import { _ as __easycom_1 } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/components/up-gap/up-gap&";
...
const __className = "GenSrcSubUviewUltraDemosGapGap";
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    const __sharedData = __sharedDataRenderer == "component" ? _withSharedDataComponent(new UniDynamicSharedDataComponent(_useSharedDataScope(), _useSharedDataComponentOptions({ bundleKey: "GenSrcSubUviewUltraDemosGapGapSharedData", sharedDataClassId: 0 }))) : _withSharedDataPage(new UniDynamicSharedDataPage(_useSharedDataPageId(), _useSharedDataPageOptions({ bundleKey: "GenSrcSubUviewUltraDemosGapGapSharedData", sharedDataClassId: 0 })));
    _useSharedDataScope(__sharedData);
    return () => {
      "raw js";
      const _component_NavBar = __easycom_0;
      const _component_up_gap = __easycom_1;
      const n19 = _createSharedDataComponent(_sfc_main$1, "2080e5a1", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n18 = _createSharedDataComponent(_sfc_main$2, "20c86316", {
            "navigation-style": "custom",
            "navigation-bar-title-text": "up-gap 间隔槽"
          }, {
            "default": _withSharedDataVaporCtx(() => {
              const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "03de00bc", {
                title: "Gap 间隔槽",
                "auto-back": true
              });
              _setSharedData(__sharedData, 2, n0?.sharedData);
              const n2 = _createSharedDataComponentWithFallback(_component_up_gap, "03de07be", {
                height: "30",
                "bg-color": "#f3f4f6"
              });
              _setSharedData(__sharedData, 3, n2?.sharedData);
              const n5 = _createSharedDataComponentWithFallback(_component_up_gap, "03de0c21", {
                height: "50",
                "bg-color": "#f3f4f6"
              });
              _setSharedData(__sharedData, 4, n5?.sharedData);
              const n8 = _createSharedDataComponentWithFallback(_component_up_gap, "03de1325", {
                height: "30",
                "bg-color": "#fa3534"
              });
              _setSharedData(__sharedData, 5, n8?.sharedData);
              const n12 = _createSharedDataComponentWithFallback(_component_up_gap, "03de1ae2", {
                height: "20",
                "bg-color": "#f3f4f6",
                "margin-top": "10",
                "margin-bottom": "10"
...
const _style_0 = {};
const _style_1 = {};
const gap = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0, _style_1]]]);
export {
  gap as default
};
