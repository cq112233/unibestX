...
import { b as addUnit, s as sleep, h as getWindowInfo, g as getPx, u as upGetRect } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/libs/function/index&";
  ...
  setup(__props, _a) {
    ...
    const setValueForTouch = async (currentIndex) => {
      ...
      if (currentIndex !== activeIndex.value) {
        ...
        uni.__f__("log", "at uni_modules/uview-ultra/components/up-index-list/up-index-list.uvue:340", scrollIntoView.value);
