...
import { s as sleep, e as getWindowInfo, a as addUnit, g as getPx, u as upGetRect } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/libs/function/index&";
...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props, _a) {
    ...
    return () => {
      ...
      _renderSharedDataEffect(() => {
        return _setSharedDataStyle(__sharedData, 20, { top: _unref(addUnit)(letterInfo.value["top"] ?? ""), transform: "translateY(-50%)" });
      });
      ...
      const n21 = _createSharedDataComponentWithFallback(_component_up_transition, "bdcb46b2", {
        mode: "fade",
        show: () => {
        ...
        customStyle: () => {
          return {
            position: "absolute",
            right: "30px",
            top: _unref(addUnit)(indicatorTop.value, "px"),
            width: _unref(addUnit)(indicatorHeight.value + 10),
            zIndex: 3
          };
        }
      }, {
        "default": () => {
          ...
          _renderSharedDataEffect(() => {
            ...
            _setSharedDataStyle(__sharedData, 4, {
              height: _addUnit(_indicatorHeight),
              width: _addUnit(_indicatorHeight)
            });
