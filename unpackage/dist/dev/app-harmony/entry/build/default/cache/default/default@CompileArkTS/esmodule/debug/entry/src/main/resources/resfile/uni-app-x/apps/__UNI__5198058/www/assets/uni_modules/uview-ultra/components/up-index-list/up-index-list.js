...
import { s as sleep, e as getWindowInfo, g as getPx, a as addUnit, u as upGetRect } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/libs/function/index&";
    ...
    [
      ...
      _createElementVNode(
        "view",
        {
          ...
          style: _normalizeStyle({ top: $setup.addUnit($setup.letterInfo["top"] ?? ""), transform: "translateY(-50%)" }),
                ...
                [
                  _createElementVNode(
                    "text",
                    {
                      ...
                      style: _normalizeStyle({ color: $setup.activeIndex === index ? "#fff" : $props.inactiveColor })
                    },
      ...
      _createVNode(_component_up_transition, {
        ...
        customStyle: {
          position: "absolute",
          right: "30px",
          top: $setup.addUnit($setup.indicatorTop, "px"),
          width: $setup.addUnit($setup.indicatorHeight + 10),
          zIndex: 3
        }
      }, {
        default: _withCtx(() => [
          _createElementVNode(
            "view",
            {
              ...
              style: _normalizeStyle({
                height: $setup.addUnit($setup.indicatorHeight),
                width: $setup.addUnit($setup.indicatorHeight)
              })
            },
            [
              _createElementVNode(
