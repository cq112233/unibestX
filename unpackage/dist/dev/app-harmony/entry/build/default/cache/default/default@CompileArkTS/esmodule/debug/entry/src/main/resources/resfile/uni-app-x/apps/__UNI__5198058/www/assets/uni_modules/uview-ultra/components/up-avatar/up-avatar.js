...
import { a as addUnit, b as addStyle, r as random } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/libs/function/index&";
    ...
    return () => {
      ...
      _createSharedDataSlot("default", null, null, () => {
        _createSharedDataIf(() => {
          ...
          const n4 = _createSharedDataComponentWithFallback(_component_up_icon, "64edd273", {
            name: () => {
              return __props.icon;
            },
            size: () => {
          ...
          return _createSharedDataIf(() => {
            ...
            const n6 = _createSharedDataComponentWithFallback(_component_up_text, "64edd93c", {
              text: () => {
                return __props.text;
              },
              size: () => {
