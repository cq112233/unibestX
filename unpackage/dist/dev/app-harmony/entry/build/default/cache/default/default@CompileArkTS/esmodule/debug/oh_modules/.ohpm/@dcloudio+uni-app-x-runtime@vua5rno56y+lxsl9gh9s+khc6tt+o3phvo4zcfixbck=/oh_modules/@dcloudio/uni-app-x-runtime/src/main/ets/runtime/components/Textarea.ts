...
interface Textarea_Params {
    ...
    handleTextSelectionChange?: (selectionStart: number, selectionEnd: number) => void;
    handleFocus?: () => void;
    handleBlur?: () => void;
...
export class Textarea extends ViewPU {
    constructor(parent, params, __localStorage, elmtId = -1, paramsLambda = undefined, extraInfo) {
        ...
        this.handleTextSelectionChange = undefined;
    ...
    setInitiallyProvidedValue(params: Textarea_Params) {
        ...
        if (params.handleTextSelectionChange !== undefined) {
            this.handleTextSelectionChange = params.handleTextSelectionChange;
        }
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            TextArea.onTextSelectionChange((selectionStart: number, selectionEnd: number) => {
