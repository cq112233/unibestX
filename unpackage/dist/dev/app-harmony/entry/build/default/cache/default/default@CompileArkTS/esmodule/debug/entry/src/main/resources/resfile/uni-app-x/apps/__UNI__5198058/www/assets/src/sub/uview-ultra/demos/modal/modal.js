...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n18 = _createSharedDataComponent(_sfc_main$1, "0b14ad81", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "5781036c", {
            title: "up-modal 模态框",
            "auto-back": true,
          ...
          const n2 = _createSharedDataComponentWithFallback(_component_up_button, "cec1507e", {
            type: "primary",
            text: "弹窗提示",
            size: "mini",
            onClick: () => {
          ...
          const n4 = _createSharedDataComponentWithFallback(_component_up_button, "cec14840", {
            type: "warning",
            text: "确认弹窗",
            size: "mini",
            onClick: () => {
          ...
          const n8 = _createSharedDataComponentWithFallback(_component_up_button, "cec132b2", {
            type: "success",
            text: "无标题",
            size: "mini",
            onClick: () => {
          ...
          const n12 = _createSharedDataComponentWithFallback(_component_up_button, "cec1223c", {
            type: "error",
            text: "长内容",
            size: "mini",
            onClick: () => {
          ...
          const n16 = _createSharedDataComponentWithFallback(_component_up_modal, "7b4aac53", {
            show: () => {
