      ...
      const n19 = _createSharedDataComponent(AppKu, "0b14ad81", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n18 = _createSharedDataComponent(LayoutComponent, "57810295", {
            ...
            "default": _withSharedDataVaporCtx(() => {
              const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "cec15e8c", {
                title: "up-modal 模态框",
                "auto-back": true,
              ...
              const n2 = _createSharedDataComponentWithFallback(_component_up_button, "cec148f2", {
                type: "primary",
                text: "弹窗提示",
                size: "mini",
                onClick: () => {
              ...
              const n4 = _createSharedDataComponentWithFallback(_component_up_button, "cec14082", {
                type: "warning",
                text: "确认弹窗",
                size: "mini",
                onClick: () => {
              ...
              const n8 = _createSharedDataComponentWithFallback(_component_up_button, "cec12aec", {
                type: "success",
                text: "无标题",
                size: "mini",
                onClick: () => {
              ...
              const n12 = _createSharedDataComponentWithFallback(_component_up_button, "7b4aac32", {
                type: "error",
                text: "长内容",
                size: "mini",
                onClick: () => {
              ...
              const n16 = _createSharedDataComponentWithFallback(_component_up_modal, "7b4ab04f", {
                show: () => {
...
const _style_0 = {};
const modal = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0]]]);
export {
  modal as default
};
