...
const _style_0 = { "bg-__f8fafc_": { "": { "backgroundImage": "none", "backgroundColor": "#f8fafc" } }, "flex-column": { "": { "flexDirection": "column" } }, "items-center": { "": { "alignItems": "center" } }, "mt-12px": { "": { "marginTop": 12 } }, "p-16px": { "": { "paddingTop": 16, "paddingRight": 16, "paddingBottom": 16, "paddingLeft": 16 } }, "pb-30px": { "": { "paddingBottom": 30 } }, "w-full": { "": { "width": "100%" } } };
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  const _component_up_qrcode = resolveEasycom(resolveDynamicComponent("up-qrcode"), __easycom_1);
        ...
        default: withCtx(() => [
          createElementVNode("view", { class: "page-container bg-__f8fafc_ min-h-screen pb-30px" }, [
            ...
            createElementVNode("view", { class: "p-16px" }, [
              createElementVNode("view", { class: "demo-block flex-column items-center" }, [
                createElementVNode("text", { class: "demo-label w-full" }, "基础用法"),
                createVNode(_component_up_qrcode, {
                  size: "200",
                  val: "https://uview-ultra.lingyun.net"
                })
              ]),
              createElementVNode("view", { class: "demo-block flex-column items-center mt-12px" }, [
                createElementVNode("text", { class: "demo-label w-full" }, "自定义颜色"),
                createVNode(_component_up_qrcode, {
                  size: "200",
                  background: "#f3f4f6",
                  foreground: "#2979ff",
              ...
              createElementVNode("view", { class: "demo-block flex-column items-center mt-12px" }, [
                createElementVNode("text", { class: "demo-label w-full" }, "包含Logo"),
                createVNode(_component_up_qrcode, {
                  size: "200",
...
const qrcode = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["styles", [_style_0, _style_1]], ["__file", "/Users/chenqi/Documents/chenqi-front/unibestX/src/sub/uview-ultra/demos/qrcode/qrcode.uvue"]]);
export {
  qrcode as default
};
