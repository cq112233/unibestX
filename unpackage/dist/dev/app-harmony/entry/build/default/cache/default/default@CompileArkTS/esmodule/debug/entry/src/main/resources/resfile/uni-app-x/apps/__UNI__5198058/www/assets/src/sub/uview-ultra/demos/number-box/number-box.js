...
import { _ as __easycom_1 } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/components/up-number-box/up-number-box&";
...
const __className = "GenSrcSubUviewUltraDemosNumberBoxNumberBox";
...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    const __sharedData = __sharedDataRenderer == "component" ? _withSharedDataComponent(new UniDynamicSharedDataComponent(_useSharedDataScope(), _useSharedDataComponentOptions({ bundleKey: "GenSrcSubUviewUltraDemosNumberBoxNumberBoxSharedData", sharedDataClassId: 0 }))) : _withSharedDataPage(new UniDynamicSharedDataPage(_useSharedDataPageId(), _useSharedDataPageOptions({ bundleKey: "GenSrcSubUviewUltraDemosNumberBoxNumberBoxSharedData", sharedDataClassId: 0 })));
    ...
    return () => {
      ...
      const _component_up_number_box = __easycom_1;
      const n16 = _createSharedDataComponent(_sfc_main$1, "ed49b8be", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n15 = _createSharedDataComponent(_sfc_main$2, "bbed5f16", {
            "navigation-style": "custom",
            "navigation-bar-title-text": "up-number-box 步进器"
          }, {
            "default": _withSharedDataVaporCtx(() => {
              const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "c1be8250", {
              ...
              const n2 = _createSharedDataComponentWithFallback(_component_up_number_box, "c1be6dba", {
                modelValue: () => {
              ...
              const n5 = _createSharedDataComponentWithFallback(_component_up_number_box, "c1be64be", {
                modelValue: () => {
              ...
              const n8 = _createSharedDataComponentWithFallback(_component_up_number_box, "c1be563c", {
                modelValue: () => {
              ...
              const n11 = _createSharedDataComponentWithFallback(_component_up_number_box, "c1be47b0", {
                modelValue: () => {
...
const _style_0 = {};
const _style_1 = {};
const numberBox = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0, _style_1]]]);
export {
