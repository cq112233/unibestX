      ...
      const n16 = _createSharedDataComponent(AppKu, "ed49b8be", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n15 = _createSharedDataComponent(LayoutComponent, "bbed5f16", {
            ...
            "default": _withSharedDataVaporCtx(() => {
              const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "c1be8242", {
              ...
              const n2 = _createSharedDataComponentWithFallback(_component_up_number_box, "c1be6d7a", {
                modelValue: () => {
              ...
              const n5 = _createSharedDataComponentWithFallback(_component_up_number_box, "c1be6476", {
                modelValue: () => {
              ...
              const n8 = _createSharedDataComponentWithFallback(_component_up_number_box, "c1be55c2", {
                modelValue: () => {
              ...
              const n11 = _createSharedDataComponentWithFallback(_component_up_number_box, "c1be472e", {
                modelValue: () => {
...
const _style_0 = {};
const numberBox = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0]]]);
export {
