...
class CollapseItemProps extends UTS.UTSType {
    ...
    return {
      ...
      get fields() {
        return {
          ...
          titleTextStyle: { type: "Unknown", optional: true },
          valueStyle: { type: "Unknown", optional: true },
          valueTextStyle: { type: "Unknown", optional: true },
          contentStyle: { type: "Unknown", optional: true },
          contentTextStyle: { type: "Unknown", optional: true },
  ...
  constructor(options, metadata = CollapseItemProps.get$UTSMetadata$(), isJSONParse = false) {
    ...
    this.titleTextStyle = this.__props__.titleTextStyle;
    this.valueStyle = this.__props__.valueStyle;
    this.valueTextStyle = this.__props__.valueTextStyle;
    this.contentStyle = this.__props__.contentStyle;
    this.contentTextStyle = this.__props__.contentTextStyle;
