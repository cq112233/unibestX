...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n18 = _createSharedDataComponent(_sfc_main$1, "319014ef", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "007289be", {
            title: "Keyboard 键盘",
            "auto-back": true
          });
          ...
          _renderSharedDataEffect(() => {
            ...
            _setSharedDataClass(__sharedData, 8, _valNumber ? "mock-input-text" : "mock-input-placeholder");
          ...
          const n4 = _createSharedDataComponentWithFallback(_component_up_keyboard, "0ddea2b2", {
            mode: "number",
            show: () => {
          ...
          _renderSharedDataEffect(() => {
            ...
            _setSharedDataClass(__sharedData, 10, _valCard ? "mock-input-text" : "mock-input-placeholder");
          ...
          const n9 = _createSharedDataComponentWithFallback(_component_up_keyboard, "a4183430", {
            mode: "card",
            show: () => {
          ...
          _renderSharedDataEffect(() => {
            ...
            _setSharedDataClass(__sharedData, 12, _valCar ? "mock-input-text" : "mock-input-placeholder");
          ...
          const n14 = _createSharedDataComponentWithFallback(_component_up_keyboard, "a4180c80", {
            mode: "car",
            show: () => {
