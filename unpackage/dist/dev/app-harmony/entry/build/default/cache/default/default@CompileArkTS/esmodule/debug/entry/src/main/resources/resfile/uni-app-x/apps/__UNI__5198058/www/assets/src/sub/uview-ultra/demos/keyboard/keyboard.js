...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n19 = _createSharedDataComponent(AppKu, "319014ef", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n18 = _createSharedDataComponent(LayoutComponent, "007288e7", {
            "navigation-style": "custom",
            "navigation-bar-title-text": "up-keyboard 键盘"
          }, {
            "default": _withSharedDataVaporCtx(() => {
              const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "0dde94aa", {
                title: "Keyboard 键盘",
                "auto-back": true
              });
              ...
              const n4 = _createSharedDataComponentWithFallback(_component_up_keyboard, "0ddea673", {
                mode: "number",
                show: () => {
              ...
              const n9 = _createSharedDataComponentWithFallback(_component_up_keyboard, "a41831f8", {
                mode: "card",
                show: () => {
              ...
              const n14 = _createSharedDataComponentWithFallback(_component_up_keyboard, "a418053c", {
                mode: "car",
                show: () => {
...
const _style_0 = {};
const keyboard = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0]]]);
export {
  keyboard as default
};
