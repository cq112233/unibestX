        ...
        "default": _withSharedDataVaporCtx(() => {
          const n18 = _createSharedDataComponent(LayoutComponent, "007288e7", {
            ...
            "default": _withSharedDataVaporCtx(() => {
              ...
              const n4 = _createSharedDataComponentWithFallback(_component_up_keyboard, "0ddea3c8", {
                mode: "number",
                show: () => {
              ...
              const n9 = _createSharedDataComponentWithFallback(_component_up_keyboard, "a4183238", {
                mode: "card",
                show: () => {
              ...
              const n14 = _createSharedDataComponentWithFallback(_component_up_keyboard, "a41805a6", {
                mode: "car",
                show: () => {
