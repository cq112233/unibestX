...
import { _ as __easycom_2 } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/components/up-action-sheet/up-action-sheet&";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, _a) {
    ...
    function onActionSelect(e) {
      uni.__f__("log", "at src/sub/uview-ultra/demos/action-sheet/action-sheet.uvue:32", "action select", e);
      actionSheetShow.value = false;
    }
    const __returned__ = { actionSheetShow, actionList, onActionSelect, get AppKu() {
      return AppKu;
    }, get LayoutComponent() {
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  const _component_up_action_sheet = resolveEasycom(resolveDynamicComponent("up-action-sheet"), __easycom_2);
        ...
        default: withCtx(() => [
          createElementVNode("view", { class: "page-container bg-__f8fafc_ min-h-screen pb-30px" }, [
            ...
            createVNode(_component_up_action_sheet, {
              ...
              title: "请选择操作",
              onClose: _cache[1] || (_cache[1] = ($event) => $setup.actionSheetShow = false),
...
const actionSheet = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["styles", [_style_0, _style_1]], ["__file", "/Users/chenqi/Documents/chenqi-front/unibestX/src/sub/uview-ultra/demos/action-sheet/action-sheet.uvue"]]);
export {
