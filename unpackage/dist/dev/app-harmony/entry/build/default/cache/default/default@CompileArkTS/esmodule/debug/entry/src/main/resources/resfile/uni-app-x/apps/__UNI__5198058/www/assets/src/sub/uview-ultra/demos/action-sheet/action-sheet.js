...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n18 = _createSharedDataComponent(_sfc_main$1, "038b847e", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "6de509a8", {
          ...
          const n2 = _createSharedDataComponentWithFallback(_component_up_button, "58a1d81e", {
            type: "primary",
            text: "弹出面板",
            size: "mini",
            onClick: () => {
          ...
          const n6 = _createSharedDataComponentWithFallback(_component_up_button, "58a1e2ec", {
            type: "success",
            text: "带取消按钮",
            size: "mini",
            onClick: () => {
          ...
          const n10 = _createSharedDataComponentWithFallback(_component_up_button, "58a1eb5e", {
            type: "warning",
            text: "复杂面板",
            size: "mini",
            onClick: () => {
          ...
          const n14 = _createSharedDataComponentWithFallback(_component_up_action_sheet, "88cf9f1e", {
            show: () => {
          ...
          const n15 = _createSharedDataComponentWithFallback(_component_up_action_sheet, "88cf9052", {
            show: () => {
          ...
          const n16 = _createSharedDataComponentWithFallback(_component_up_action_sheet, "88cf80d6", {
            show: () => {
          ...
          _setSharedData(__sharedData, 4, n16?.sharedData);
        })
      });
