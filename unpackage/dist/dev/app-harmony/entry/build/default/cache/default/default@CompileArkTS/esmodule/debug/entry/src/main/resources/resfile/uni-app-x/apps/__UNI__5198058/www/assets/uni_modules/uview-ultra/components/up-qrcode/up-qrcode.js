...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return _openBlock(), _createElementBlock(
    ...
    [
      $data.error.length > 0 ? (_openBlock(), _createElementBlock(
        "view",
        {
          key: 0,
          class: "up-qrcode__error",
          style: _normalizeStyle($options.matrixStyle)
        },
        [
          _createElementVNode(
            "text",
            { class: "up-qrcode__error-text" },
            _toDisplayString($data.error),
            1
            /* TEXT */
          )
        ],
        ...
        [
          _createElementVNode("canvas", {
            ...
            style: _normalizeStyle($options.canvasStyle)
          ...
          $props.icon.length > 0 ? (_openBlock(), _createElementBlock("image", {
            ...
            src: $props.icon,
            mode: "aspectFill",
            style: _normalizeStyle($options.iconStyle)
          }, null, 12, ["src"])) : _createCommentVNode("v-if", true),
          $props.showLoading && $data.loading ? (_openBlock(), _createElementBlock("view", {
            key: 1,
