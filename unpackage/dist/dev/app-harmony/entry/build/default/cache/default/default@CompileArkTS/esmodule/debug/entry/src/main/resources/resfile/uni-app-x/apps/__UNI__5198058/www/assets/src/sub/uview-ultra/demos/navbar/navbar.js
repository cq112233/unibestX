...
import { _ as __easycom_1 } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/components/up-navbar/up-navbar&";
...
const _style_0 = {"demo-block":{"":{"marginBottom":12,"paddingTop":12,"paddingRight":12,"paddingBottom":12,"paddingLeft":12,"backgroundColor":"#ffffff","borderTopLeftRadius":8,"borderTopRightRadius":8,"borderBottomRightRadius":8,"borderBottomLeftRadius":8}},"demo-label":{"":{"fontSize":14,"fontWeight":"bold","color":"#606266","marginBottom":10,"paddingLeft":4,"borderLeftWidth":3,"borderLeftStyle":"solid","borderLeftColor":"#2979ff"}},"bg-_b_hf8fafc_B":{"":{"backgroundColor":"#f8fafc"}},"pb-_b30px_B":{"":{"paddingBottom":30}},"p-_b16px_B":{"":{"paddingTop":16,"paddingRight":16,"paddingBottom":16,"paddingLeft":16,"padding":16}},"overflow-hidden":{"":{"overflow":"hidden"}},"rounded-md":{"":{"borderTopLeftRadius":"12rpx","borderTopRightRadius":"12rpx","borderBottomRightRadius":"12rpx","borderBottomLeftRadius":"12rpx","borderRadius":"var(--radius-md)"}},"border-_b1px_B":{"":{"--tw-border-style":"solid","borderTopStyle":"var(--tw-border-style)","borderRightStyle":"var(--tw-border-style)","borderBottomStyle":"var(--tw-border-style)","borderLeftStyle":"var(--tw-border-style)","borderTopWidth":1,"borderRightWidth":1,"borderBottomWidth":1,"borderLeftWidth":1,"borderStyle":"var(--tw-border-style)","borderWidth":1}},"border-_b_heee_B":{"":{"borderTopColor":"#eeeeee","borderRightColor":"#eeeeee","borderBottomColor":"#eeeeee","borderLeftColor":"#eeeeee","borderColor":"#eee"}},"border-solid":{"":{"--tw-border-style":"solid","borderTopStyle":"solid","borderRightStyle":"solid","borderBottomStyle":"solid","borderLeftStyle":"solid","-TwBorderStyle":"solid","borderStyle":"solid"}},"mt-_b12px_B":{"":{"marginTop":12}},"min-h-screen":{"":{"minHeight":"100vh"}}};
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  const _component_up_navbar = resolveEasycom(__resolveDynamicComponent("up-navbar"), __easycom_1);
          ...
          _createElementVNode("view", { class: "page-container bg-_b_hf8fafc_B min-h-screen pb-_b30px_B" }, [
            ...
            _createElementVNode("view", { class: "p-_b16px_B" }, [
              _createElementVNode("view", { class: "demo-block" }, [
                ...
                _createElementVNode("view", { class: "overflow-hidden rounded-md border-_b1px_B border-_b_heee_B border-solid" }, [
                  _createVNode(_component_up_navbar, {
                    title: "自定义标题",
              ...
              _createElementVNode("view", { class: "demo-block mt-_b12px_B" }, [
                _createElementVNode("text", { class: "demo-label" }, "自定义插槽"),
                _createElementVNode("view", { class: "overflow-hidden rounded-md border-_b1px_B border-_b_heee_B border-solid" }, [
                  _createVNode(_component_up_navbar, {
                    "safe-area-inset-top": false,
                    fixed: false,
                    ...
                    center: _withCtx(() => [
                      _createElementVNode("view", { style: { "flex-direction": "row", "align-items": "center", "justify-content": "center", "background-color": "#f3f4f6", "border-radius": "15px", "padding": "0 10px", "height": "30px", "width": "100px" } }, [
                        _createVNode(_component_up_icon, {
                          name: "search",
                          size: "14",
                          color: "#909399"
                        }),
                        _createElementVNode("text", { style: { "font-size": "12px", "color": "#909399", "margin-left": "4px" } }, "搜索")
                      ])
                    ]),
                    _: 1
                    /* STABLE */
...
const navbar = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["styles", [_style_0]], ["__file", "/Users/chenqi/Documents/chenqi-front/unibestX/src/sub/uview-ultra/demos/navbar/navbar.uvue"]]);
export {
  navbar as default
};
