...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n14 = _createSharedDataComponent(_sfc_main$1, "c3d9607e", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "2456a92c", {
            title: "Navbar 导航栏",
            "auto-back": true
          });
          _setSharedData(__sharedData, 1, n0?.sharedData);
          const n2 = _createSharedDataComponentWithFallback(_component_up_navbar, "667e6a00", {
            title: "自定义标题",
          ...
          const n9 = _createSharedDataComponentWithFallback(_component_up_navbar, "667e75c1", {
            "safe-area-inset-top": false,
            fixed: false,
            "left-text": "返回",
            "right-text": "设置",
            ...
            "center": _withSharedDataVaporCtx(() => {
              const n6 = _createSharedDataComponentWithFallback(_component_up_icon, "694dde56", {
                name: "search",
                size: "14",
                color: "#909399"
              });
