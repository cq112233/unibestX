      ...
      const n15 = _createSharedDataComponent(AppKu, "c3d9607e", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n14 = _createSharedDataComponent(LayoutComponent, "2456a855", {
            ...
            "default": _withSharedDataVaporCtx(() => {
              const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "667e62fb", {
                title: "Navbar 导航栏",
                "auto-back": true
              });
              _setSharedData(__sharedData, 2, n0?.sharedData);
              const n2 = _createSharedDataComponentWithFallback(_component_up_navbar, "667e6dc2", {
                title: "自定义标题",
              ...
              const n9 = _createSharedDataComponentWithFallback(_component_up_navbar, "667e7982", {
                "safe-area-inset-top": false,
                fixed: false,
                "left-text": "返回",
                "right-text": "设置",
                ...
                "center": _withSharedDataVaporCtx(() => {
                  const n6 = _createSharedDataComponentWithFallback(_component_up_icon, "694de217", {
                    name: "search",
                    size: "14",
                    color: "#909399"
                  });
...
const _style_0 = {};
const navbar = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0]]]);
export {
  navbar as default
};
