...
import { _ as __easycom_1 } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/components/up-image/up-image&";
...
const __className = "GenSrcSubUviewUltraDemosImageImage";
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    const __sharedData = __sharedDataRenderer == "component" ? _withSharedDataComponent(new UniDynamicSharedDataComponent(_useSharedDataScope(), _useSharedDataComponentOptions({ bundleKey: "GenSrcSubUviewUltraDemosImageImageSharedData", sharedDataClassId: 0 }))) : _withSharedDataPage(new UniDynamicSharedDataPage(_useSharedDataPageId(), _useSharedDataPageOptions({ bundleKey: "GenSrcSubUviewUltraDemosImageImageSharedData", sharedDataClassId: 0 })));
    _useSharedDataScope(__sharedData);
    return () => {
      "raw js";
      const _component_NavBar = __easycom_0;
      const _component_up_image = __easycom_1;
      const n16 = _createSharedDataComponent(_sfc_main$1, "9e1f0b7e", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n15 = _createSharedDataComponent(_sfc_main$2, "6d1ecdd5", {
            "navigation-style": "custom",
            "navigation-bar-title-text": "up-image 图片"
          }, {
            "default": _withSharedDataVaporCtx(() => {
              const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "36baed5d", {
                title: "Image 图片",
                "auto-back": true,
              ...
              const n2 = _createSharedDataComponentWithFallback(_component_up_image, "36baf822", {
                src: "/static/logo.png",
                width: "60px",
                height: "60px"
              });
              _setSharedData(__sharedData, 3, n2?.sharedData);
              const n4 = _createSharedDataComponentWithFallback(_component_up_image, "36bafc22", {
                src: "/static/logo.png",
                width: "60px",
                height: "60px",
                shape: "circle"
              ...
              const n8 = _createSharedDataComponentWithFallback(_component_up_image, "36bb06e8", {
                src: "/static/logo.png",
                width: "80px",
                height: "60px",
                mode: "aspectFit"
              ...
              const n10 = _createSharedDataComponentWithFallback(_component_up_image, "36bb0b23", {
                src: "/static/logo.png",
                width: "80px",
                height: "60px",
                mode: "scaleToFill"
