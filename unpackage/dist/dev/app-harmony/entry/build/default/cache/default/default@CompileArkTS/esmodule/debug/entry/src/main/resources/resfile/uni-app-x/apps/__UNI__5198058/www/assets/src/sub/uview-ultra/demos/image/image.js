      ...
      const n16 = _createSharedDataComponent(AppKu, "9e1f0b7e", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n15 = _createSharedDataComponent(LayoutComponent, "6d1ecdd5", {
            ...
            "default": _withSharedDataVaporCtx(() => {
              const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "36baed79", {
                title: "Image 图片",
                "auto-back": true,
              ...
              const n2 = _createSharedDataComponentWithFallback(_component_up_image, "36baf842", {
                src: "/static/logo.png",
                width: "60px",
                height: "60px"
              });
              _setSharedData(__sharedData, 3, n2?.sharedData);
              const n4 = _createSharedDataComponentWithFallback(_component_up_image, "36bafc46", {
                src: "/static/logo.png",
                width: "60px",
                height: "60px",
                shape: "circle"
              ...
              const n8 = _createSharedDataComponentWithFallback(_component_up_image, "36bb0725", {
                src: "/static/logo.png",
                width: "80px",
                height: "60px",
                mode: "aspectFit"
              ...
              const n10 = _createSharedDataComponentWithFallback(_component_up_image, "36bb0b64", {
                src: "/static/logo.png",
                width: "80px",
                height: "60px",
                mode: "scaleToFill"
...
const _style_0 = {};
const image = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0]]]);
export {
  image as default
};
