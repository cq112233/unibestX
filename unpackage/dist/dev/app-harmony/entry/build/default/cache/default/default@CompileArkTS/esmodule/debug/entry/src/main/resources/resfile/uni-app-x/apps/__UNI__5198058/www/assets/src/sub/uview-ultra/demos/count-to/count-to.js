...
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    return () => {
      ...
      const n9 = _createSharedDataComponent(_sfc_main$1, "549b2a21", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "3eca1acc", {
            title: "CountTo 数字滚动",
            "auto-back": true
          });
          _setSharedData(__sharedData, 1, n0?.sharedData);
          const n2 = _createSharedDataComponentWithFallback(_component_up_count_to, "cb0daec2", {
            "end-val": 1e3,
            color: "#2979ff",
            "font-size": 30
          });
          _setSharedData(__sharedData, 2, n2?.sharedData);
          const n5 = _createSharedDataComponentWithFallback(_component_up_count_to, "cb0da000", {
            "end-val": 1234.56,
            decimals: 2,
            separator: ",",
            color: "#fa3534",
