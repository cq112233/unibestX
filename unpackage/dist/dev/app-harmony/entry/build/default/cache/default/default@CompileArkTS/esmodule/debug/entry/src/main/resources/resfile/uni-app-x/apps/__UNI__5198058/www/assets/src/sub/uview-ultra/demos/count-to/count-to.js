...
import { _ as __easycom_1 } from "@normalized:N&&&entry/src/main/resources/resfile/uni-app-x/apps/__UNI__5198058/www/assets/uni_modules/uview-ultra/components/up-count-to/up-count-to&";
...
const __className = "GenSrcSubUviewUltraDemosCountToCountTo";
const _sfc_main = /* @__PURE__ */ _defineVaporSharedDataComponent({
  ...
  setup(__props) {
    ...
    const __sharedData = __sharedDataRenderer == "component" ? _withSharedDataComponent(new UniDynamicSharedDataComponent(_useSharedDataScope(), _useSharedDataComponentOptions({ bundleKey: "GenSrcSubUviewUltraDemosCountToCountToSharedData", sharedDataClassId: 0 }))) : _withSharedDataPage(new UniDynamicSharedDataPage(_useSharedDataPageId(), _useSharedDataPageOptions({ bundleKey: "GenSrcSubUviewUltraDemosCountToCountToSharedData", sharedDataClassId: 0 })));
    _useSharedDataScope(__sharedData);
    return () => {
      "raw js";
      const _component_NavBar = __easycom_0;
      const _component_up_count_to = __easycom_1;
      const n10 = _createSharedDataComponent(_sfc_main$1, "549b2a21", null, {
        "default": _withSharedDataVaporCtx(() => {
          const n9 = _createSharedDataComponent(_sfc_main$2, "3eca19f5", {
            "navigation-style": "custom",
            "navigation-bar-title-text": "up-count-to 数字滚动"
          }, {
            "default": _withSharedDataVaporCtx(() => {
              const n0 = _createSharedDataComponentWithFallback(_component_NavBar, "cb0db552", {
                title: "CountTo 数字滚动",
                "auto-back": true
              });
              _setSharedData(__sharedData, 2, n0?.sharedData);
              const n2 = _createSharedDataComponentWithFallback(_component_up_count_to, "cb0da744", {
                "end-val": 1e3,
                color: "#2979ff",
                "font-size": 30
              });
              _setSharedData(__sharedData, 3, n2?.sharedData);
              const n5 = _createSharedDataComponentWithFallback(_component_up_count_to, "cb0d98ac", {
                "end-val": 1234.56,
                decimals: 2,
                separator: ",",
                color: "#fa3534",
