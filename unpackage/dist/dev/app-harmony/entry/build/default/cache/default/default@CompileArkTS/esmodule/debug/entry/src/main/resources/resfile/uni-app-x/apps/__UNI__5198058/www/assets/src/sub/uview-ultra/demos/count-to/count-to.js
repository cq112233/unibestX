...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  const _component_up_count_to = resolveEasycom(__resolveDynamicComponent("up-count-to"), __easycom_1);
          ...
          _createElementVNode("view", { class: "page-container bg-__f8fafc_ min-h-screen pb-30px" }, [
            ...
            _createElementVNode("view", { class: "p-16px" }, [
              _createElementVNode("view", { class: "demo-block" }, [
                ...
                _createVNode(_component_up_count_to, {
                  "end-val": 1e3,
                  color: "#2979ff",
                  "font-size": 30
                })
              ...
              _createElementVNode("view", { class: "demo-block mt-12px" }, [
                _createElementVNode("text", { class: "demo-label" }, "指定小数位与分隔符"),
                _createVNode(_component_up_count_to, {
                  "end-val": 1234.56,
                  decimals: 2,
                  separator: ",",
...
const countTo = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["styles", [_style_0, _style_1]], ["__file", "/Users/chenqi/Documents/chenqi-front/unibestX/src/sub/uview-ultra/demos/count-to/count-to.uvue"]]);
export {
  countTo as default
};
