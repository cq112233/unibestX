...
export type UniIntersectionObserverObserveCallback = (result: UniIntersectionObserverObserveCallbackResult) => void;
...
export interface UniIntersectionObserver {
    ...
    /** 监听相交状态变化的回调函数 */
    callback: UniIntersectionObserverObserveCallback): void;
    /**
    ...
    selector: string, 
    /** 用来扩展（或收缩）参照节点布局区域的边界 */
    margins?: UniIntersectionObserverMargins | null): UniIntersectionObserver;
    /**
     * 指定页面显示区域作为参照区域之一
     */
    relativeToViewport(
...
component: any, 
/** 选项 */
options?: CreateIntersectionObserverOptions | null) => UniIntersectionObserver;
