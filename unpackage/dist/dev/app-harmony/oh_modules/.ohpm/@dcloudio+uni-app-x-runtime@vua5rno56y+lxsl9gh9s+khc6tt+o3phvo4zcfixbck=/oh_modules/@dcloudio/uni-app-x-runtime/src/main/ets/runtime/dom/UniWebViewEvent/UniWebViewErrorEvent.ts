import {
  UniWebViewErrorEvent as IUniWebViewErrorEvent,
  UniWebViewErrorEventDetail as IUniWebViewErrorEventDetail,
...
export class UniWebViewErrorEvent
  extends UniCustomEvent<UniWebViewErrorEventDetail>
implements IUniWebViewErrorEvent {
