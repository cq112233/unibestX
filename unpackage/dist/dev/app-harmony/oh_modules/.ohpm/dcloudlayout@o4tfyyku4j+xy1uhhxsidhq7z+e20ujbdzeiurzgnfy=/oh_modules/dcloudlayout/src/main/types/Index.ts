...
export enum UniCssFlexJustify {
  FlexStart = UniCssFlexAlign.FlexStart,
  Center = UniCssFlexAlign.Center,
  FlexEnd = UniCssFlexAlign.FlexEnd,
  SpaceBetween = UniCssFlexAlign.SpaceBetween,
  SpaceAround = UniCssFlexAlign.SpaceAround,
  SpaceEvenly = UniCssFlexAlign.SpaceEvenly
}
...
export enum UniCssFlexEdge {
  Left = 0, Top = 1, Right = 2, Bottom = 3, Start = 4, End = 5, Horizontal = 6, Vertical = 7, All = 8, None = -1
}
